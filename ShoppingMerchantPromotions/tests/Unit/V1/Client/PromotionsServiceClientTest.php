...
namespace Google\Shopping\Merchant\Promotions\Tests\Unit\V1\Client;
...
use Google\Shopping\Merchant\Promotions\V1\ListPromotionsResponse;
...
class PromotionsServiceClientTest extends GeneratedTest
{
    ...
    public function getPromotionTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.promotions.v1.PromotionsService/GetPromotion', $actualFuncCall);
    ...
    public function insertPromotionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.promotions.v1.PromotionsService/InsertPromotion', $actualFuncCall);
    ...
    public function listPromotionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.promotions.v1.PromotionsService/ListPromotions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
