 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.promotions.v1.Promotion</code>
 */
class Promotion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.Attributes attributes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * asynchronously.
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.PromotionStatus promotion_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           This is useful for submitting attributes not explicitly exposed by the
     *           API.
     *     @type \Google\Shopping\Merchant\Promotions\V1\PromotionStatus $promotion_status
     *           Output only. The [status of a
     *           promotion](https://support.google.com/merchants/answer/3398326?ref_topic=7322924&sjid=5155774230887277618-NC),
     *           data validation issues, that is, information about a promotion computed
     *           asynchronously.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Shopping\Merchant\Promotions\V1\RedemptionChannel::class);
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.Attributes attributes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Shopping\Merchant\Promotions\V1\Attributes|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.Attributes attributes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\Promotions\V1\Attributes $var
     * @return $this
     */
    public function setAttributes($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Promotions\V1\Attributes::class);
        $this->attributes = $var;
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.PromotionStatus promotion_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Shopping\Merchant\Promotions\V1\PromotionStatus|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.promotions.v1.PromotionStatus promotion_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Shopping\Merchant\Promotions\V1\PromotionStatus $var
     * @return $this
     */
    public function setPromotionStatus($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Promotions\V1\PromotionStatus::class);
