 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListLineItemsRequest</code>
 */
class ListLineItemsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of LineItems.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see LineItemServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListLineItemsRequest
     *
     * @experimental
     */
