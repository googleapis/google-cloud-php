 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchApproveSuggestedAdUnitsRequest</code>
 */
class BatchApproveSuggestedAdUnitsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. Resource names for the `SuggestedAdUnit` objects to approve.
     *                         Format: `networks/{network_code}/suggestedAdUnits/{suggested_ad_unit_id}`
     *                         Please see {@see SuggestedAdUnitServiceClient::suggestedAdUnitName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchApproveSuggestedAdUnitsRequest
     *
     * @experimental
     */
