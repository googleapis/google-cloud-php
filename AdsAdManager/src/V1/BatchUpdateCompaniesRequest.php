...
class BatchUpdateCompaniesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.UpdateCompanyRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $requests;
     ...
     *                                                                  A maximum of 100 objects can be updated in a batch.
     *
     * @return \Google\Ads\AdManager\V1\BatchUpdateCompaniesRequest
     *
     * @experimental
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.UpdateCompanyRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\AdManager\V1\UpdateCompanyRequest>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.UpdateCompanyRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\AdManager\V1\UpdateCompanyRequest[] $var
     * @return $this
     */
    public function setRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\UpdateCompanyRequest::class);
        $this->requests = $arr;
