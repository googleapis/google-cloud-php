 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListTargetingPresetsRequest</code>
 */
class ListTargetingPresetsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of TargetingPresets.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see TargetingPresetServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListTargetingPresetsRequest
     *
     * @experimental
     */
