...
class ReportDefinition extends \Google\Protobuf\Internal\Message
{
     ...
     * zone.
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.Report.TimeZoneSource time_zone_source = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\AdManager\V1\Report\TimeZoneSource::class);
