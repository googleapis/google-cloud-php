 ...
 */
class BatchCreateViewabilityProvidersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.CreateViewabilityProviderRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $requests;
     ...
     * @param \Google\Ads\AdManager\V1\CreateViewabilityProviderRequest[] $requests Required. The
     *                                                                              [ViewabilityProvider][google.ads.admanager.v1.ViewabilityProvider] objects
     *                                                                              to create. A maximum of 100 objects can be created in a batch.
     *
     * @return \Google\Ads\AdManager\V1\BatchCreateViewabilityProvidersRequest
     *
     * @experimental
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.CreateViewabilityProviderRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Ads\AdManager\V1\CreateViewabilityProviderRequest>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.admanager.v1.CreateViewabilityProviderRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\AdManager\V1\CreateViewabilityProviderRequest[] $var
     * @return $this
     */
    public function setRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\CreateViewabilityProviderRequest::class);
        $this->requests = $arr;
