 ...
 * objects.
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListReportsResponse</code>
 */
class ListReportsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\Report::class);
        $this->reports = $arr;
