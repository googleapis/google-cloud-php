 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetSiteRequest</code>
 */
class GetSiteRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Site.
     *                     Format: `networks/{network_code}/sites/{site_id}`
     *                     Please see {@see SiteServiceClient::siteName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\GetSiteRequest
     *
     * @experimental
     */
