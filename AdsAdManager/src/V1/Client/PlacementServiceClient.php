 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/placement_service.proto
...
final class PlacementServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.PlacementService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/placement_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/placement_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/placement_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\PlacementServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new PlacementServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/PlacementServiceClient/get_placement.php
     *
     * @param GetPlacementRequest $request     A request to house fields associated with the call.
     ...
     */
    public function getPlacement(GetPlacementRequest $request, array $callOptions = []): Placement
    {
        return $this->startApiCall('GetPlacement', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/PlacementServiceClient/list_placements.php
     *
     * @param ListPlacementsRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
