 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/content_bundle_service.proto
 ...
 */
final class ContentBundleServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.ContentBundleService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/content_bundle_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/content_bundle_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/content_bundle_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\ContentBundleServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ContentBundleServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * .
     *
     * @example samples/V1/ContentBundleServiceClient/get_content_bundle.php
     *
     * @param GetContentBundleRequest $request     A request to house fields associated with the call.
     ...
     */
    public function getContentBundle(GetContentBundleRequest $request, array $callOptions = []): ContentBundle
    {
        return $this->startApiCall('GetContentBundle', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/ContentBundleServiceClient/list_content_bundles.php
     *
     * @param ListContentBundlesRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listContentBundles(ListContentBundlesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListContentBundles', $request, $callOptions);
    }
}
