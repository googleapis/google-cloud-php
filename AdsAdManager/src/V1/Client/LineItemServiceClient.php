 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/line_item_service.proto
...
final class LineItemServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.LineItemService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/line_item_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/line_item_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/line_item_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * @return string The formatted line_item resource.
     */
    public static function lineItemName(string $networkCode, string $lineItem): string
    {
     ...
     *           use Google\Ads\AdManager\V1\LineItemServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new LineItemServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/LineItemServiceClient/get_line_item.php
     *
     * @param GetLineItemRequest $request     A request to house fields associated with the call.
     ...
     */
    public function getLineItem(GetLineItemRequest $request, array $callOptions = []): LineItem
    {
        return $this->startApiCall('GetLineItem', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/LineItemServiceClient/list_line_items.php
     *
     * @param ListLineItemsRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
