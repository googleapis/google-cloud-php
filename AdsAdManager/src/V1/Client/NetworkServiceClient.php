 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/network_service.proto
...
final class NetworkServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.NetworkService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/network_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/network_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/network_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\NetworkServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new NetworkServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/NetworkServiceClient/get_network.php
     *
     ...
     *
     * @example samples/V1/NetworkServiceClient/list_networks.php
     *
