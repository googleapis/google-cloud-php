 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/role_service.proto
...
final class RoleServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.RoleService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/role_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/role_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/role_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\RoleServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new RoleServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/RoleServiceClient/get_role.php
     *
     * @param GetRoleRequest $request     A request to house fields associated with the call.
     ...
     */
    public function getRole(GetRoleRequest $request, array $callOptions = []): Role
    {
        return $this->startApiCall('GetRole', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/RoleServiceClient/list_roles.php
     *
     * @param ListRolesRequest $request     A request to house fields associated with the call.
     * @param array            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listRoles(ListRolesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListRoles', $request, $callOptions);
    }
}
