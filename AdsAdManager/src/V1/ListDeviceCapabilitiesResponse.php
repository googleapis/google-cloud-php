 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListDeviceCapabilitiesResponse</code>
 */
class ListDeviceCapabilitiesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\DeviceCapability::class);
