 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateTeamsRequest</code>
 */
class BatchDeactivateTeamsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `Team`s to deactivate.
     *                         Format: `networks/{network_code}/teams/{team_id}`
     *                         Please see {@see TeamServiceClient::teamName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateTeamsRequest
     *
     * @experimental
     */
