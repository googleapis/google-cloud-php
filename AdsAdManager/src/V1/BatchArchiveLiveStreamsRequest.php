 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchArchiveLiveStreamsRequest</code>
 */
class BatchArchiveLiveStreamsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `LiveStream`s to archive.
     *                         Format: `networks/{network_code}/liveStreams/{live_stream_id}`
     *                         Please see {@see LiveStreamServiceClient::liveStreamName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchArchiveLiveStreamsRequest
     *
     * @experimental
     */
