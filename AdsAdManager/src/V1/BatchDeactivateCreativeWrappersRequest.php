 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateCreativeWrappersRequest</code>
 */
class BatchDeactivateCreativeWrappersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `CreativeWrapper` objects to
     *                         deactivate. Format:
     *                         `networks/{network_code}/creativeWrappers/{creative_wrapper_id}`
     *                         Please see {@see CreativeWrapperServiceClient::creativeWrapperName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateCreativeWrappersRequest
     *
     * @experimental
     */
