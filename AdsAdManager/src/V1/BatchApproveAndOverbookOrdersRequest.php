 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchApproveAndOverbookOrdersRequest</code>
 */
class BatchApproveAndOverbookOrdersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>bool skip_inventory_check = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $skip_inventory_check = false;
     ...
     * @param string[] $names  Required. The resource names of the orders to approve and overbook.
     *                         Format: `networks/{network_code}/orders/{order_id}`
     *                         Please see {@see OrderServiceClient::orderName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchApproveAndOverbookOrdersRequest
     *
     * @experimental
     */
    ...
    {
        return $this->skip_inventory_check;
    }
