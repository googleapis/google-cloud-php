 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListCmsMetadataValuesRequest</code>
 */
class ListCmsMetadataValuesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of CmsMetadataValues.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see CmsMetadataValueServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListCmsMetadataValuesRequest
     *
     * @experimental
     */
