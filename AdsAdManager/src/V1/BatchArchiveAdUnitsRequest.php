 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchArchiveAdUnitsRequest</code>
 */
class BatchArchiveAdUnitsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `AdUnit`s to archive.
     *                         Format: `networks/{network_code}/adUnits/{ad_unit_id}`
     *                         Please see {@see AdUnitServiceClient::adUnitName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchArchiveAdUnitsRequest
     *
     * @experimental
     */
