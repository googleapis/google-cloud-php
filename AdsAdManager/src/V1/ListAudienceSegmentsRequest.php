 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListAudienceSegmentsRequest</code>
 */
class ListAudienceSegmentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent publisher network associated with these audience
     *                       segments. Format: `networks/{network_code}`
     *                       Please see {@see AudienceSegmentServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListAudienceSegmentsRequest
     *
     * @experimental
     */
