 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchArchiveOrdersRequest</code>
 */
class BatchArchiveOrdersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the orders to archive.
     *                         Format: `networks/{network_code}/orders/{order_id}`
     *                         Please see {@see OrderServiceClient::orderName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchArchiveOrdersRequest
     *
     * @experimental
     */
