 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateCreativeWrappersRequest</code>
 */
class BatchActivateCreativeWrappersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `CreativeWrapper` objects to activate.
     *                         Format: `networks/{network_code}/creativeWrappers/{creative_wrapper_id}`
     *                         Please see {@see CreativeWrapperServiceClient::creativeWrapperName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateCreativeWrappersRequest
     *
     * @experimental
     */
