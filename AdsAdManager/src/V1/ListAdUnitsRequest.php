 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListAdUnitsRequest</code>
 */
class ListAdUnitsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of AdUnits.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see AdUnitServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListAdUnitsRequest
     *
     * @experimental
     */
