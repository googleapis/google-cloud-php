 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchSubmitOrdersForApprovalRequest</code>
 */
class BatchSubmitOrdersForApprovalRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the orders to submit for approval.
     *                         Format: `networks/{network_code}/orders/{order_id}`
     *                         Please see {@see OrderServiceClient::orderName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchSubmitOrdersForApprovalRequest
     *
     * @experimental
     */
