 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchResumeOrdersRequest</code>
 */
class BatchResumeOrdersRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the orders to resume.
     *                         Format: `networks/{network_code}/orders/{order_id}`
     *                         Please see {@see OrderServiceClient::orderName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchResumeOrdersRequest
     *
     * @experimental
     */
