 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateCdnConfigsRequest</code>
 */
class BatchActivateCdnConfigsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `CdnConfig` objects to activate.
     *                         Format: `networks/{network_code}/cdnConfigs/{cdn_config_id}`
     *                         Please see {@see CdnConfigServiceClient::cdnConfigName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateCdnConfigsRequest
     *
     * @experimental
     */
