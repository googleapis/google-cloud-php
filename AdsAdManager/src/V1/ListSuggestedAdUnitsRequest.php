 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListSuggestedAdUnitsRequest</code>
 */
class ListSuggestedAdUnitsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of SuggestedAdUnits.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see SuggestedAdUnitServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListSuggestedAdUnitsRequest
     *
     * @experimental
     */
