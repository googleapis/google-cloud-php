 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateNativeStylesRequest</code>
 */
class BatchDeactivateNativeStylesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. Resource names for the `NativeStyle`s.
     *                         Format: `networks/{network_code}/nativeStyles/{native_style_id}`
     *                         Please see {@see NativeStyleServiceClient::nativeStyleName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateNativeStylesRequest
     *
     * @experimental
     */
