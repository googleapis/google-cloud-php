 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListLabelsRequest</code>
 */
class ListLabelsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Labels.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see LabelServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListLabelsRequest
     *
     * @experimental
     */
