 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListPrivateAuctionDealsRequest</code>
 */
class ListPrivateAuctionDealsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of PrivateAuctionDeals.
     *                       Format:
     *                       `networks/{network_code}`
     *                       Please see {@see PrivateAuctionDealServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListPrivateAuctionDealsRequest
     *
     * @experimental
     */
