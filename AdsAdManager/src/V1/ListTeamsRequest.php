 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListTeamsRequest</code>
 */
class ListTeamsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Teams.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see TeamServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListTeamsRequest
     *
     * @experimental
     */
