 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateContentBundlesRequest</code>
 */
class BatchDeactivateContentBundlesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string   $parent Required. The parent resource where `ContentBundles` will be
     *                         deactivated.
     *                         Format: `networks/{network_code}`
     *                         Please see {@see ContentBundleServiceClient::networkName()} for help formatting this field.
     * @param string[] $names  Required. The resource names of the `ContentBundle`s to deactivate.
     *                         Format: `networks/{network_code}/contentBundles/{content_bundle_id}`
     *                         Please see {@see ContentBundleServiceClient::contentBundleName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateContentBundlesRequest
     *
     * @experimental
     */
