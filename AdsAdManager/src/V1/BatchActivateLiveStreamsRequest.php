 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateLiveStreamsRequest</code>
 */
class BatchActivateLiveStreamsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `LiveStream`s to activate.
     *                         Format: `networks/{network_code}/liveStreams/{live_stream_id}`
     *                         Please see {@see LiveStreamServiceClient::liveStreamName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateLiveStreamsRequest
     *
     * @experimental
     */
