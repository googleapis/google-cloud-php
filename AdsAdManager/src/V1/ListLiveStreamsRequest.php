 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListLiveStreamsRequest</code>
 */
class ListLiveStreamsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of LiveStreams.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see LiveStreamServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListLiveStreamsRequest
     *
     * @experimental
     */
