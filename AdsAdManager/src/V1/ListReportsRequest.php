 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListReportsRequest</code>
 */
class ListReportsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of reports.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see ReportServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListReportsRequest
     *
     * @experimental
     */
