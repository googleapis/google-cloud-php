 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetAdBreakRequest</code>
 */
class GetAdBreakRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the AdBreak using the asset key or custom
     *                     asset key.
     *
     *                     Format:
     *                     `networks/{network_code}/liveStreamEventsByAssetKey/{asset_key}/adBreaks/{ad_break_id}`
     ...
     *
     * @return \Google\Ads\AdManager\V1\GetAdBreakRequest
     *
     * @experimental
     */
