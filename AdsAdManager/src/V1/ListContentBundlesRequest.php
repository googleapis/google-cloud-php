 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListContentBundlesRequest</code>
 */
class ListContentBundlesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of ContentBundles.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see ContentBundleServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListContentBundlesRequest
     *
     * @experimental
     */
