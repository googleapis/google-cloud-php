 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateAdRulesRequest</code>
 */
class BatchDeactivateAdRulesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. Resource names for the AdRule.
     *                         Format:
     *                         `networks/{network_code}/adRules/{ad_rule}`
     *                         Please see {@see AdRuleServiceClient::adRuleName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateAdRulesRequest
     *
     * @experimental
     */
