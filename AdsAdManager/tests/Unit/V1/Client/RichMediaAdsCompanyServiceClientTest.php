...
class RichMediaAdsCompanyServiceClientTest extends GeneratedTest
{
    ...
    public function getRichMediaAdsCompanyTest()
    {
        ...
        $request = (new GetRichMediaAdsCompanyRequest())->setName($formattedName);
    ...
    public function listRichMediaAdsCompaniesTest()
    {
        ...
        $richMediaAdsCompanies = [$richMediaAdsCompaniesElement];
        ...
        $request = (new ListRichMediaAdsCompaniesRequest())->setParent($formattedParent);
