...
class TeamServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateTeamsTest()
    {
        ...
        $formattedNames = [$gapicClient->teamName('[NETWORK_CODE]', '[TEAM]')];
        $request = (new BatchActivateTeamsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchCreateTeamsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchCreateTeamsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function batchDeactivateTeamsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $formattedNames = [$gapicClient->teamName('[NETWORK_CODE]', '[TEAM]')];
        $request = (new BatchDeactivateTeamsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchUpdateTeamsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchUpdateTeamsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function createTeamTest()
    {
        ...
        $request = (new CreateTeamRequest())->setParent($formattedParent)->setTeam($team);
    ...
    public function listTeamsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListTeamsRequest())->setParent($formattedParent);
