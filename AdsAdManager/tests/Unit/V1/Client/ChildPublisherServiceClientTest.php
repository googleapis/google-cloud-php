...
class ChildPublisherServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateChildPublishersTest()
    {
        ...
        $requests = [];
        $request = (new BatchCreateChildPublishersRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function createChildPublisherTest()
    {
        ...
        $expectedResponse->setApprovedManageAccountRevenueShareMillipercent(
        ...
        $request = (new CreateChildPublisherRequest())->setParent($formattedParent)->setChildPublisher($childPublisher);
    ...
    public function listChildPublishersTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListChildPublishersRequest())->setParent($formattedParent);
    ...
    public function updateChildPublisherTest()
    {
        ...
        $childPublisherDelegationType = DelegationType::DELEGATION_TYPE_UNSPECIFIED;
        $childPublisher->setDelegationType($childPublisherDelegationType);
        $request = (new UpdateChildPublisherRequest())->setChildPublisher($childPublisher);
