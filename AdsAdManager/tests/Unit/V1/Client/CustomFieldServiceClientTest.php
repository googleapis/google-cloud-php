...
class CustomFieldServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateCustomFieldsTest()
    {
        ...
        $formattedNames = [$gapicClient->customFieldName('[NETWORK_CODE]', '[CUSTOM_FIELD]')];
        $request = (new BatchActivateCustomFieldsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchCreateCustomFieldsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchCreateCustomFieldsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function batchDeactivateCustomFieldsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $formattedNames = [$gapicClient->customFieldName('[NETWORK_CODE]', '[CUSTOM_FIELD]')];
        $request = (new BatchDeactivateCustomFieldsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchUpdateCustomFieldsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchUpdateCustomFieldsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function createCustomFieldTest()
    {
        ...
        $request = (new CreateCustomFieldRequest())->setParent($formattedParent)->setCustomField($customField);
    ...
    public function getCustomFieldTest()
    {
        ...
        $request = (new GetCustomFieldRequest())->setName($formattedName);
    ...
    public function listCustomFieldsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListCustomFieldsRequest())->setParent($formattedParent);
