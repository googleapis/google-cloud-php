...
class AdUnitServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateAdUnitsTest()
    {
        ...
        $formattedNames = [$gapicClient->adUnitName('[NETWORK_CODE]', '[AD_UNIT]')];
        $request = (new BatchActivateAdUnitsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchArchiveAdUnitsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $formattedNames = [$gapicClient->adUnitName('[NETWORK_CODE]', '[AD_UNIT]')];
        $request = (new BatchArchiveAdUnitsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchCreateAdUnitsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchCreateAdUnitsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function batchDeactivateAdUnitsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $formattedNames = [$gapicClient->adUnitName('[NETWORK_CODE]', '[AD_UNIT]')];
        $request = (new BatchDeactivateAdUnitsRequest())->setParent($formattedParent)->setNames($formattedNames);
    ...
    public function batchUpdateAdUnitsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchUpdateAdUnitsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function createAdUnitTest()
    {
        ...
        $request = (new CreateAdUnitRequest())->setParent($formattedParent)->setAdUnit($adUnit);
