...
class ContactServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateContactsTest()
    {
        ...
        $requests = [];
        $request = (new BatchCreateContactsRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function batchUpdateContactsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchUpdateContactsRequest())->setParent($formattedParent)->setRequests($requests);
