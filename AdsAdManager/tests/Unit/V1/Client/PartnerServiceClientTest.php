...
class PartnerServiceClientTest extends GeneratedTest
{
    ...
    public function batchUpdatePartnersTest()
    {
        ...
        $requests = [];
        $request = (new BatchUpdatePartnersRequest())->setParent($formattedParent)->setRequests($requests);
    ...
    public function listPartnersTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListPartnersRequest())->setParent($formattedParent);
    ...
    public function updatePartnerTest()
    {
        ...
        $request = (new UpdatePartnerRequest())->setPartner($partner);
