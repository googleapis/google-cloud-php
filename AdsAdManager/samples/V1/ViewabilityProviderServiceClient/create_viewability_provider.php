 ...
 *                                                         [ViewabilityProvider][google.ads.admanager.v1.ViewabilityProvider].
 */
function create_viewability_provider_sample(
    ...
    try {
        ...
        $response = $viewabilityProviderServiceClient->createViewabilityProvider($request);
...
function callSample(): void
{
    ...
    create_viewability_provider_sample(
        $formattedParent,
