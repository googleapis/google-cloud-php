 ...
 */
function get_viewability_provider_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $viewabilityProviderServiceClient->getViewabilityProvider($request);
...
{
    $formattedName = ViewabilityProviderServiceClient::viewabilityProviderName(
        '[NETWORK_CODE]',
        '[VIEWABILITY_PROVIDER]'
    );

    get_viewability_provider_sample($formattedName);
}
