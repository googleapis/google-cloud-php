...
// [START admanager_v1_generated_ViewabilityProviderService_ListViewabilityProviders_sync]
 ...
 */
function list_viewability_providers_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $viewabilityProviderServiceClient->listViewabilityProviders($request);
...
function callSample(): void
{
    ...
    list_viewability_providers_sample($formattedParent);
}
// [END admanager_v1_generated_ViewabilityProviderService_ListViewabilityProviders_sync]
