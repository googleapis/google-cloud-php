 ...
 *
 * @param string $formattedParent                    The parent resource where `TargetingPresets` will be updated.
 ...
 */
function batch_update_targeting_presets_sample(
    ...
    $updateTargetingPresetRequest = (new UpdateTargetingPresetRequest())
        ->setTargetingPreset($requestsTargetingPreset);
    $requests = [$updateTargetingPresetRequest,];
    ...
    try {
        /** @var BatchUpdateTargetingPresetsResponse $response */
        $response = $targetingPresetServiceClient->batchUpdateTargetingPresets($request);
...
function callSample(): void
{
    ...
    batch_update_targeting_presets_sample($formattedParent, $requestsTargetingPresetDisplayName);
}
