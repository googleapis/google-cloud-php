...
// [START admanager_v1_generated_SlateService_ListSlates_sync]
 ...
 * Lists `Slate` objects.
 *
 * @param string $formattedParent The parent resource containing the Slates.
...
function list_slates_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $slateServiceClient->listSlates($request);
...
// [END admanager_v1_generated_SlateService_ListSlates_sync]
