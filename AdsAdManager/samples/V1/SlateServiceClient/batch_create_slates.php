 ...
 *
 * @param string $formattedParent          The parent resource where `Slates` will be created.
 ...
 * @param string $formattedRequestsParent  The parent resource where this `Slate` will be created.
 *                                         Format: `networks/{network_code}`
 ...
 *                                         characters.
 */
function batch_create_slates_sample(
    ...
    $createSlateRequest = (new CreateSlateRequest())
        ->setParent($formattedRequestsParent)
        ->setSlate($requestsSlate);
    $requests = [$createSlateRequest,];
    ...
    try {
        /** @var BatchCreateSlatesResponse $response */
        $response = $slateServiceClient->batchCreateSlates($request);
...
function callSample(): void
{
    ...
    $formattedRequestsParent = SlateServiceClient::networkName('[NETWORK_CODE]');
    $requestsSlateDisplayName = '[DISPLAY_NAME]';

    batch_create_slates_sample($formattedParent, $formattedRequestsParent, $requestsSlateDisplayName);
}
