 ...
 * @param string $formattedNamesElement The resource names of the `CmsMetadataValue`s to activate.
 *                                      Format:
 ...
 */
function batch_activate_cms_metadata_values_sample(
    ...
    try {
        /** @var BatchActivateCmsMetadataValuesResponse $response */
        $response = $cmsMetadataValueServiceClient->batchActivateCmsMetadataValues($request);
...
function callSample(): void
{
    ...
    batch_activate_cms_metadata_values_sample($formattedParent, $formattedNamesElement);
}
