...
use Google\Ads\AdManager\V1\CreateOrderRequest;
 ...
 *
 * @param string $formattedParent                  The parent resource where `Orders` will be created.
 ...
 * @param string $formattedRequestsParent          The parent resource where this Order will be created.
 *                                                 Format: `networks/{network_code}`
 ...
 */
function batch_create_orders_sample(
    ...
    try {
        /** @var BatchCreateOrdersResponse $response */
        $response = $orderServiceClient->batchCreateOrders($request);
...
function callSample(): void
{
    ...
    $formattedRequestsParent = OrderServiceClient::networkName('[NETWORK_CODE]');
