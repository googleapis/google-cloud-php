 ...
 *                              Please see {@see PartnerServiceClient::partnerName()} for help formatting this field.
 */
function get_partner_sample(string $formattedName): void
{
    ...
    try {
        ...
        $response = $partnerServiceClient->getPartner($request);
...
{
    $formattedName = PartnerServiceClient::partnerName('[NETWORK_CODE]', '[PARTNER]');
