...
// [START admanager_v1_generated_ContentBundleService_BatchActivateContentBundles_sync]
 ...
 *
 * @param string $formattedParent       The parent resource where `ContentBundles` will be activated.
 *                                      Format: `networks/{network_code}`
 *                                      Please see {@see ContentBundleServiceClient::networkName()} for help formatting this field.
 * @param string $formattedNamesElement The resource names of the `ContentBundle`s to activate.
 ...
 */
function batch_activate_content_bundles_sample(
    ...
    $request = (new BatchActivateContentBundlesRequest())
        ->setParent($formattedParent)
        ->setNames($formattedNames);

    // Call the API and handle any network failures.
    try {
        /** @var BatchActivateContentBundlesResponse $response */
        $response = $contentBundleServiceClient->batchActivateContentBundles($request);
...
function callSample(): void
{
    ...
    batch_activate_content_bundles_sample($formattedParent, $formattedNamesElement);
}
// [END admanager_v1_generated_ContentBundleService_BatchActivateContentBundles_sync]
