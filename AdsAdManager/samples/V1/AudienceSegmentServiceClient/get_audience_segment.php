 ...
 */
function get_audience_segment_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $audienceSegmentServiceClient->getAudienceSegment($request);
...
{
    $formattedName = AudienceSegmentServiceClient::audienceSegmentName(
        '[NETWORK_CODE]',
        '[AUDIENCE_SEGMENT]'
    );

    get_audience_segment_sample($formattedName);
}
