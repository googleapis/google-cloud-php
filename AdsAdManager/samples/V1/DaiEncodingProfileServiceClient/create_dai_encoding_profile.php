...
// [START admanager_v1_generated_DaiEncodingProfileService_CreateDaiEncodingProfile_sync]
 ...
 *
 * @param string $formattedParent                 The parent resource where this `DaiEncodingProfile` will be
 ...
 */
function create_dai_encoding_profile_sample(
    ...
    try {
        ...
        $response = $daiEncodingProfileServiceClient->createDaiEncodingProfile($request);
...
function callSample(): void
{
    ...
    create_dai_encoding_profile_sample(
        $formattedParent,
...
// [END admanager_v1_generated_DaiEncodingProfileService_CreateDaiEncodingProfile_sync]
