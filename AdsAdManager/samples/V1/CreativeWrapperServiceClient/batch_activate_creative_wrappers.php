...
// [START admanager_v1_generated_CreativeWrapperService_BatchActivateCreativeWrappers_sync]
 ...
 * @param string $formattedNamesElement The resource names of the `CreativeWrapper` objects to activate.
 ...
 */
function batch_activate_creative_wrappers_sample(
    ...
    $request = (new BatchActivateCreativeWrappersRequest())
        ->setParent($formattedParent)
        ->setNames($formattedNames);

    // Call the API and handle any network failures.
    try {
        /** @var BatchActivateCreativeWrappersResponse $response */
        $response = $creativeWrapperServiceClient->batchActivateCreativeWrappers($request);
...
function callSample(): void
{
    ...
    $formattedNamesElement = CreativeWrapperServiceClient::creativeWrapperName(
        '[NETWORK_CODE]',
        '[CREATIVE_WRAPPER]'
    );

    batch_activate_creative_wrappers_sample($formattedParent, $formattedNamesElement);
}
// [END admanager_v1_generated_CreativeWrapperService_BatchActivateCreativeWrappers_sync]
