 ...
 * @param string $formattedNamesElement The resource names of the `CreativeWrapper` objects to
 *                                      deactivate. Format:
 ...
 */
function batch_deactivate_creative_wrappers_sample(
    ...
    try {
        /** @var BatchDeactivateCreativeWrappersResponse $response */
        $response = $creativeWrapperServiceClient->batchDeactivateCreativeWrappers($request);
...
function callSample(): void
{
    ...
    batch_deactivate_creative_wrappers_sample($formattedParent, $formattedNamesElement);
}
