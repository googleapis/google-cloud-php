 ...
 */
function batch_activate_native_styles_sample(
    ...
    $request = (new BatchActivateNativeStylesRequest())
        ->setParent($formattedParent)
        ->setNames($formattedNames);

    // Call the API and handle any network failures.
    try {
        /** @var BatchActivateNativeStylesResponse $response */
        $response = $nativeStyleServiceClient->batchActivateNativeStyles($request);
...
function callSample(): void
{
    ...
    batch_activate_native_styles_sample($formattedParent, $formattedNamesElement);
}
