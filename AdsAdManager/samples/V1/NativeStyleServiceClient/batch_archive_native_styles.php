 ...
 */
function batch_archive_native_styles_sample(
    ...
    $request = (new BatchArchiveNativeStylesRequest())
        ->setParent($formattedParent)
        ->setNames($formattedNames);

    // Call the API and handle any network failures.
    try {
        /** @var BatchArchiveNativeStylesResponse $response */
        $response = $nativeStyleServiceClient->batchArchiveNativeStyles($request);
...
function callSample(): void
{
    ...
    batch_archive_native_styles_sample($formattedParent, $formattedNamesElement);
}
