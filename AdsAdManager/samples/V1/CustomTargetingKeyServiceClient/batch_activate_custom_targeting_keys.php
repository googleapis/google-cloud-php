 ...
 * @param string $formattedNamesElement The resource names of the `CustomTargetingKey`s to activate.
 *                                      Format:
 *                                      `networks/{network_code}/customTargetingKeys/{custom_targeting_key_id}`
 *                                      Please see {@see CustomTargetingKeyServiceClient::customTargetingKeyName()} for help formatting this field.
 */
function batch_activate_custom_targeting_keys_sample(
    ...
    try {
        /** @var BatchActivateCustomTargetingKeysResponse $response */
        $response = $customTargetingKeyServiceClient->batchActivateCustomTargetingKeys($request);
...
function callSample(): void
{
    ...
    batch_activate_custom_targeting_keys_sample($formattedParent, $formattedNamesElement);
}
