...
// [START admanager_v1_generated_CustomTargetingKeyService_CreateCustomTargetingKey_sync]
 ...
 *
 * @param string $formattedParent                  The parent resource where this `CustomTargetingKey` will be
 ...
 */
function create_custom_targeting_key_sample(
    ...
    try {
        ...
        $response = $customTargetingKeyServiceClient->createCustomTargetingKey($request);
...
// [END admanager_v1_generated_CustomTargetingKeyService_CreateCustomTargetingKey_sync]
