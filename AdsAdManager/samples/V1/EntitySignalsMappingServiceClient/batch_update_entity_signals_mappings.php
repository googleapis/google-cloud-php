...
// [START admanager_v1_generated_EntitySignalsMappingService_BatchUpdateEntitySignalsMappings_sync]
...
function batch_update_entity_signals_mappings_sample(string $formattedParent): void
{
    ...
    try {
        /** @var BatchUpdateEntitySignalsMappingsResponse $response */
        $response = $entitySignalsMappingServiceClient->batchUpdateEntitySignalsMappings($request);
