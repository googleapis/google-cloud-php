 ...
 */
function list_child_publishers_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $childPublisherServiceClient->listChildPublishers($request);
...
function callSample(): void
{
    ...
    list_child_publishers_sample($formattedParent);
}
