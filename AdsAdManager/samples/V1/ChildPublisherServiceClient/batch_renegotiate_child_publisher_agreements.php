...
// [START admanager_v1_generated_ChildPublisherService_BatchRenegotiateChildPublisherAgreements_sync]
...
use Google\Ads\AdManager\V1\RenegotiateChildPublisherAgreementRequest;
 ...
 * @param string $formattedRequestsName Resource name of the
 ...
 */
function batch_renegotiate_child_publisher_agreements_sample(
    ...
    $renegotiateChildPublisherAgreementRequest = (new RenegotiateChildPublisherAgreementRequest())
        ->setName($formattedRequestsName);
    $requests = [$renegotiateChildPublisherAgreementRequest,];
    ...
    try {
        /** @var BatchRenegotiateChildPublisherAgreementsResponse $response */
        $response = $childPublisherServiceClient->batchRenegotiateChildPublisherAgreements($request);
...
function callSample(): void
{
    ...
    $formattedRequestsName = ChildPublisherServiceClient::childPublisherName(
        '[NETWORK_CODE]',
        '[CHILD_PUBLISHER]'
    );

    batch_renegotiate_child_publisher_agreements_sample($formattedParent, $formattedRequestsName);
}
// [END admanager_v1_generated_ChildPublisherService_BatchRenegotiateChildPublisherAgreements_sync]
