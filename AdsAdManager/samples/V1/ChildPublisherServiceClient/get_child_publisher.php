 ...
 */
function get_child_publisher_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $childPublisherServiceClient->getChildPublisher($request);
...
{
    $formattedName = ChildPublisherServiceClient::childPublisherName(
        '[NETWORK_CODE]',
        '[CHILD_PUBLISHER]'
    );

    get_child_publisher_sample($formattedName);
}
