...
namespace Google\Cloud\Container\V1alpha1\SetMasterAuthRequest;

/**
 * Operation type: what type update to perform.
 *
 * Protobuf type <code>google.container.v1alpha1.SetMasterAuthRequest.Action</code>
 */
class Action
{
    /**
...
class_alias(Action::class, \Google\Cloud\Container\V1alpha1\SetMasterAuthRequest_Action::class);
