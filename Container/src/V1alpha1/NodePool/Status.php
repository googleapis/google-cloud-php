...
namespace Google\Cloud\Container\V1alpha1\NodePool;

/**
 * The current status of the node pool instance.
 *
 * Protobuf type <code>google.container.v1alpha1.NodePool.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Google\Cloud\Container\V1alpha1\NodePool_Status::class);
