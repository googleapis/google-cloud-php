...
class NodePool extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.StatusCondition conditions = 105;</code>
     */
    private $conditions;
     ...
     *     @type string $name
     *           The name of the node pool.
     *     @type \Google\Cloud\Container\V1alpha1\NodeConfig $config
     *           The node configuration of the pool.
     ...
     *           is sufficient for this number of instances. You must also have available
     *           firewall and routes quota.
     *     @type \Google\Cloud\Container\V1alpha1\NodePoolAutoscaling $autoscaling
     *           Autoscaler configuration for this NodePool. Autoscaler is enabled
     *           only if a valid configuration is present.
     *     @type \Google\Cloud\Container\V1alpha1\NodeManagement $management
     *           NodeManagement configuration for this NodePool.
