 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.ListClustersResponse</code>
 */
class ListClustersResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * across all ones.
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.Cluster clusters = 1;</code>
     */
    private $clusters;
    /**
     ...
     *
     *     @type \Google\Cloud\Container\V1alpha1\Cluster[]|\Google\Protobuf\Internal\RepeatedField $clusters
     *           A list of clusters in the project in the specified zone, or
     *           across all ones.
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.Cluster clusters = 1;</code>
     * @param \Google\Cloud\Container\V1alpha1\Cluster[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setClusters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Container\V1alpha1\Cluster::class);
        $this->clusters = $arr;
