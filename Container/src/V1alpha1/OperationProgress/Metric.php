...
namespace Google\Cloud\Container\V1alpha1\OperationProgress;
 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.OperationProgress.Metric</code>
 */
...
class_alias(Metric::class, \Google\Cloud\Container\V1alpha1\OperationProgress_Metric::class);
