 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.CreateNodePoolRequest</code>
 */
class CreateNodePoolRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.NodePool node_pool = 4;</code>
     */
     ...
     *           Deprecated. The name of the cluster.
     *           This field has been deprecated and replaced by the parent field.
     *     @type \Google\Cloud\Container\V1alpha1\NodePool $node_pool
     *           The node pool to create.
     *     @type string $parent
     *           The parent (project, location, cluster id) where the node pool will be
     *           created. Specified in the format
     ...
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.NodePool node_pool = 4;</code>
     * @return \Google\Cloud\Container\V1alpha1\NodePool
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.NodePool node_pool = 4;</code>
     * @param \Google\Cloud\Container\V1alpha1\NodePool $var
     * @return $this
     */
    public function setNodePool($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1alpha1\NodePool::class);
        $this->node_pool = $var;
