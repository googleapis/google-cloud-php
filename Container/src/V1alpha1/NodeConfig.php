 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.NodeConfig</code>
 */
class NodeConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * support for GPUs.
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.AcceleratorConfig accelerators = 11;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.NodeTaint taints = 15;</code>
     */
    private $taints;
     ...
     *           https://cloud.google.com/compute/docs/instances/preemptible for more
     *           inforamtion about preemptible VM instances.
     *     @type \Google\Cloud\Container\V1alpha1\AcceleratorConfig[]|\Google\Protobuf\Internal\RepeatedField $accelerators
     *           A list of hardware accelerators to be attached to each node.
     *           See https://cloud.google.com/compute/docs/gpus for more information about
     *           support for GPUs.
     ...
     *           information, read [how to specify min CPU
     *           platform](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform)
     *     @type \Google\Cloud\Container\V1alpha1\NodeTaint[]|\Google\Protobuf\Internal\RepeatedField $taints
     *           List of kubernetes taints to be applied to each node.
     *           For more information, including usage and the valid values, see:
     *           https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.AcceleratorConfig accelerators = 11;</code>
     * @param \Google\Cloud\Container\V1alpha1\AcceleratorConfig[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAccelerators($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Container\V1alpha1\AcceleratorConfig::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1alpha1.NodeTaint taints = 15;</code>
     * @param \Google\Cloud\Container\V1alpha1\NodeTaint[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTaints($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Container\V1alpha1\NodeTaint::class);
        $this->taints = $arr;
