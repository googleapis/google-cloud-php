...
namespace Google\Cloud\Container\V1alpha1\MasterAuthorizedNetworksConfig;
...
class_alias(CidrBlock::class, \Google\Cloud\Container\V1alpha1\MasterAuthorizedNetworksConfig_CidrBlock::class);
