...
class ClusterUpdate extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.ClusterAutoscaling desired_cluster_autoscaling = 15;</code>
     */
    private $desired_cluster_autoscaling = null;
    /**
     * The desired configuration options for the Binary Authorization feature.
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.BinaryAuthorization desired_binary_authorization = 16;</code>
     */
     ...
     *           * "monitoring.googleapis.com" - the Google Cloud Monitoring service
     *           * "none" - no metrics will be exported from the cluster
     *     @type \Google\Cloud\Container\V1alpha1\AddonsConfig $desired_addons_config
     *           Configurations for the various addons available to run in the cluster.
     ...
     *           The desired image type for the node pool.
     *           NOTE: Set the "desired_node_pool" field as well.
     *     @type \Google\Cloud\Container\V1alpha1\NodePoolAutoscaling $desired_node_pool_autoscaling
     *           Autoscaler configuration for the node pool specified in
     *           desired_node_pool_id. If there is only one pool in the
     *           cluster and desired_node_pool_id is not provided then
     *           the change applies to that single node pool.
     ...
     *           whether locations are being added or removed.
     *           This list must always include the cluster's primary zone.
     *     @type \Google\Cloud\Container\V1alpha1\MasterAuthorizedNetworksConfig $desired_master_authorized_networks_config
     *           The desired configuration options for master authorized networks feature.
     *     @type \Google\Cloud\Container\V1alpha1\PodSecurityPolicyConfig $desired_pod_security_policy_config
     *           The desired configuration options for the PodSecurityPolicy feature.
     *     @type \Google\Cloud\Container\V1alpha1\ClusterAutoscaling $desired_cluster_autoscaling
     *           The desired cluster-level autoscaling configuration.
     *     @type \Google\Cloud\Container\V1alpha1\BinaryAuthorization $desired_binary_authorization
     *           The desired configuration options for the Binary Authorization feature.
