...
namespace Google\Cloud\Container\V1alpha1\Operation;

/**
 * Operation type.
 *
 * Protobuf type <code>google.container.v1alpha1.Operation.Type</code>
 */
class Type
{
    /**
     ...
     *
     * Generated from protobuf enum <code>UPDATE_IP_ALLOCATION_POLICY = 17;</code>
     */
    const UPDATE_IP_ALLOCATION_POLICY = 17;
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Type::class, \Google\Cloud\Container\V1alpha1\Operation_Type::class);
