...
namespace Google\Cloud\Container\V1alpha1\NodeTaint;

/**
 * Possible values for Effect in taint.
 *
 * Protobuf type <code>google.container.v1alpha1.NodeTaint.Effect</code>
 */
class Effect
{
    /**
...
class_alias(Effect::class, \Google\Cloud\Container\V1alpha1\NodeTaint_Effect::class);
