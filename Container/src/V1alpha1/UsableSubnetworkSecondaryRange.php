 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.UsableSubnetworkSecondaryRange</code>
 */
class UsableSubnetworkSecondaryRange extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.UsableSubnetworkSecondaryRange.Status status = 3;</code>
     */
    private $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1alpha1\UsableSubnetworkSecondaryRange_Status::class);
        $this->status = $var;
