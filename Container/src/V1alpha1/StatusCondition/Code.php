...
namespace Google\Cloud\Container\V1alpha1\StatusCondition;

/**
 * Code for each condition
 *
 * Protobuf type <code>google.container.v1alpha1.StatusCondition.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\Container\V1alpha1\StatusCondition_Code::class);
