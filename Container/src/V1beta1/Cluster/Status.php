...
namespace Google\Cloud\Container\V1beta1\Cluster;

/**
 * The current status of the cluster.
 *
 * Protobuf type <code>google.container.v1beta1.Cluster.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Google\Cloud\Container\V1beta1\Cluster_Status::class);
