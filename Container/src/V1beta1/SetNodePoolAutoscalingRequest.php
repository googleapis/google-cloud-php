 ...
 *
 * Generated from protobuf message <code>google.container.v1beta1.SetNodePoolAutoscalingRequest</code>
 */
class SetNodePoolAutoscalingRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NodePoolAutoscaling autoscaling = 5;</code>
     */
     ...
     *           Deprecated. The name of the node pool to upgrade.
     *           This field has been deprecated and replaced by the name field.
     *     @type \Google\Cloud\Container\V1beta1\NodePoolAutoscaling $autoscaling
     *           Autoscaling configuration for the node pool.
     *     @type string $name
     *           The name (project, location, cluster, node pool) of the node pool to set
     *           autoscaler settings. Specified in the format
