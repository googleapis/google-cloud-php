...
class Cluster extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.LegacyAbac legacy_abac = 18;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.BinaryAuthorization binary_authorization = 24;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.ClusterAutoscaling autoscaling = 26;</code>
     */
    private $autoscaling = null;
    /**
     * Configuration for cluster networking.
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NetworkConfig network_config = 27;</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool private_cluster = 28 [deprecated = true];</code>
     */
    private $private_cluster = false;
    /**
     ...
     *
     * Generated from protobuf field <code>string master_ipv4_cidr_block = 29 [deprecated = true];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaxPodsConstraint default_max_pods_constraint = 30;</code>
     */
    private $default_max_pods_constraint = null;
    /**
     * Configuration for private cluster.
     *
     * Generated from protobuf field <code>.google.container.v1beta1.PrivateClusterConfig private_cluster_config = 37;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.container.v1beta1.StatusCondition conditions = 118;</code>
     */
    private $conditions;
     ...
     *           "node_config") will be used to create a "NodePool" object with an
     *           auto-generated name. Do not use this and a node_pool at the same time.
     *     @type \Google\Cloud\Container\V1beta1\NodeConfig $node_config
     *           Parameters used in creating the cluster's nodes.
     *           See `nodeConfig` for the description of its properties.
     *           For requests, this field should only be used in lieu of a
     *           "node_pool" object, since this configuration (along with the
     ...
     *           the first node pool.
     *           If unspecified, the defaults are used.
     *     @type \Google\Cloud\Container\V1beta1\MasterAuth $master_auth
     *           The authentication information for accessing the master endpoint.
     ...
     *           notation (e.g. `10.96.0.0/14`). Leave blank to have
     *           one automatically chosen or specify a `/14` block in `10.0.0.0/8`.
     *     @type \Google\Cloud\Container\V1beta1\AddonsConfig $addons_config
     *           Configurations for the various addons available to run in the cluster.
     ...
     *           cluster is connected. On output this shows the subnetwork ID instead of
     *           the name.
     *     @type \Google\Cloud\Container\V1beta1\NodePool[]|\Google\Protobuf\Internal\RepeatedField $node_pools
     *           The node pools associated with this cluster.
     *           This field should not be set if "node_config" or "initial_node_count" are
     *           specified.
     ...
     *           The fingerprint of the set of labels for this cluster.
     *     @type \Google\Cloud\Container\V1beta1\LegacyAbac $legacy_abac
     *           Configuration for the legacy ABAC authorization mode.
     *     @type \Google\Cloud\Container\V1beta1\NetworkPolicy $network_policy
     *           Configuration options for the NetworkPolicy feature.
     *     @type \Google\Cloud\Container\V1beta1\IPAllocationPolicy $ip_allocation_policy
     *           Configuration for cluster IP allocation.
     *     @type \Google\Cloud\Container\V1beta1\MasterAuthorizedNetworksConfig $master_authorized_networks_config
     *           The configuration options for master authorized networks feature.
     *     @type \Google\Cloud\Container\V1beta1\MaintenancePolicy $maintenance_policy
     *           Configure the maintenance policy for this cluster.
     *     @type \Google\Cloud\Container\V1beta1\BinaryAuthorization $binary_authorization
     *           Configuration for Binary Authorization.
     *     @type \Google\Cloud\Container\V1beta1\PodSecurityPolicyConfig $pod_security_policy_config
     *           Configuration for the PodSecurityPolicy feature.
     *     @type \Google\Cloud\Container\V1beta1\ClusterAutoscaling $autoscaling
     *           Cluster-level autoscaling configuration.
     *     @type \Google\Cloud\Container\V1beta1\NetworkConfig $network_config
     *           Configuration for cluster networking.
     *     @type bool $private_cluster
     *           If this is a private cluster setup. Private clusters are clusters that, by
     *           default have no external IP addresses on the nodes and where nodes and the
     *           master communicate over private IP addresses.
     *           This field is deprecated, use private_cluster_config.enabled instead.
     ...
     *           This field is deprecated, use
     *           private_cluster_config.master_ipv4_cidr_block instead.
     *     @type \Google\Cloud\Container\V1beta1\MaxPodsConstraint $default_max_pods_constraint
     *           The default constraint on the maximum number of pods that can be run
     *           simultaneously on a node in the node pool of this cluster. Only honored
     *           if cluster created with IP Alias support.
     *     @type \Google\Cloud\Container\V1beta1\PrivateClusterConfig $private_cluster_config
     *           Configuration for private cluster.
     ...
     *           [CIDR](http://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing)
     *           notation (e.g. `1.2.3.4/29`).
     *     @type \Google\Cloud\Container\V1beta1\StatusCondition[]|\Google\Protobuf\Internal\RepeatedField $conditions
     *           Which conditions caused the current cluster state.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.LegacyAbac legacy_abac = 18;</code>
     * @param \Google\Cloud\Container\V1beta1\LegacyAbac $var
     * @return $this
     */
    public function setLegacyAbac($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\LegacyAbac::class);
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.NetworkConfig network_config = 27;</code>
     * @param \Google\Cloud\Container\V1beta1\NetworkConfig $var
     * @return $this
     */
    public function setNetworkConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\NetworkConfig::class);
     ...
     * @return $this
     */
    public function setPrivateCluster($var)
    {
        GPBUtil::checkBool($var);
        $this->private_cluster = $var;
     ...
     *
     * Generated from protobuf field <code>.google.container.v1beta1.MaxPodsConstraint default_max_pods_constraint = 30;</code>
     * @param \Google\Cloud\Container\V1beta1\MaxPodsConstraint $var
     * @return $this
     */
    public function setDefaultMaxPodsConstraint($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Container\V1beta1\MaxPodsConstraint::class);
