...
namespace Google\Cloud\Container\V1beta1\Operation;

/**
 * Operation type.
 *
 * Protobuf type <code>google.container.v1beta1.Operation.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Container\V1beta1\Operation_Type::class);
