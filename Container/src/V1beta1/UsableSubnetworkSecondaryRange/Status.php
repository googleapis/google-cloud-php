...
namespace Google\Cloud\Container\V1beta1\UsableSubnetworkSecondaryRange;

/**
 * Status shows the current usage of a secondary IP range.
 *
 * Protobuf type <code>google.container.v1beta1.UsableSubnetworkSecondaryRange.Status</code>
 */
class Status
{
    /**
...
class_alias(Status::class, \Google\Cloud\Container\V1beta1\UsableSubnetworkSecondaryRange_Status::class);
