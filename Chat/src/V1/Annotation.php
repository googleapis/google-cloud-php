...
class Annotation extends \Google\Protobuf\Internal\Message
{
     ...
     *           Length of the substring in the plain-text message body this annotation
     *           corresponds to.
     *     @type \Google\Chat\V1\UserMentionMetadata $user_mention
     *           The metadata of user mention.
     *     @type \Google\Chat\V1\SlashCommandMetadata $slash_command
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\AnnotationType::class);
        $this->type = $var;
     ...
     * @return \Google\Chat\V1\UserMentionMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.UserMentionMetadata user_mention = 4;</code>
     * @param \Google\Chat\V1\UserMentionMetadata $var
     * @return $this
     */
    public function setUserMention($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\UserMentionMetadata::class);
     ...
     * @return \Google\Chat\V1\SlashCommandMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.SlashCommandMetadata slash_command = 5;</code>
     * @param \Google\Chat\V1\SlashCommandMetadata $var
     * @return $this
     */
    public function setSlashCommand($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\SlashCommandMetadata::class);
