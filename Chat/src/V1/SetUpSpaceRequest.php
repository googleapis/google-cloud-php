...
class SetUpSpaceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Specifying an existing request ID from the same Chat app with a different
     *           authenticated user returns an error.
     *     @type array<\Google\Chat\V1\Membership>|\Google\Protobuf\Internal\RepeatedField $memberships
     *           Optional. The Google Chat users to invite to join the space. Omit the
     *           calling user, as they are added automatically.
     *           The set currently allows up to 20 memberships (in addition to the caller).
     *           The `Membership.member` field must contain a `user` with `name` populated
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.Membership memberships = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param array<\Google\Chat\V1\Membership>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMemberships($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\Membership::class);
