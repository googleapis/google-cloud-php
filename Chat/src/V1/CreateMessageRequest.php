...
class CreateMessageRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The resource name of the space in which to create a message.
     *           Format: `spaces/{space}`
     *     @type \Google\Chat\V1\Message $message
     *           Required. Message body.
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Message message = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Chat\V1\Message|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Message message = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Chat\V1\Message $var
     * @return $this
     */
    public function setMessage($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Message::class);
        $this->message = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\CreateMessageRequest\MessageReplyOption::class);
