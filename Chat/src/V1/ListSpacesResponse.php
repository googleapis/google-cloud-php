...
class ListSpacesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Google\Chat\V1\Space>|\Google\Protobuf\Internal\RepeatedField $spaces
     *           List of spaces in the requested (or first) page.
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.Space spaces = 1;</code>
     * @param array<\Google\Chat\V1\Space>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSpaces($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\Space::class);
        $this->spaces = $arr;
