...
class ListMessagesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Google\Chat\V1\Message>|\Google\Protobuf\Internal\RepeatedField $messages
     *           List of messages.
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.Message messages = 1;</code>
     * @param array<\Google\Chat\V1\Message>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMessages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\Message::class);
        $this->messages = $arr;
