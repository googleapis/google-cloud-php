...
class CreateMembershipRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           membership.
     *           Format: spaces/{space}
     *     @type \Google\Chat\V1\Membership $membership
     *           Required. The membership relation to create.
     *           The `memberType` field must contain a user with the `user.name` and
     *           `user.type` fields populated. The server will assign a resource name
     *           and overwrite anything specified.
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Membership membership = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Chat\V1\Membership|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Membership membership = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Chat\V1\Membership $var
     * @return $this
     */
    public function setMembership($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Membership::class);
        $this->membership = $var;
