...
namespace Google\Chat\V1\ContextualAddOnMarkup\Card;
...
class Section extends \Google\Protobuf\Internal\Message
{
     ...
     *           text in Google Workspace
     *           Add-ons](https://developers.google.com/apps-script/add-ons/concepts/widgets#text_formatting).
     *     @type array<\Google\Chat\V1\WidgetMarkup>|\Google\Protobuf\Internal\RepeatedField $widgets
     *           A section must contain at least one widget.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.WidgetMarkup widgets = 2;</code>
     * @param array<\Google\Chat\V1\WidgetMarkup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWidgets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\WidgetMarkup::class);
        $this->widgets = $arr;
