...
class Message extends \Google\Protobuf\Internal\Message
{
     ...
     *           a
     *           message](https://developers.google.com/chat/api/guides/v1/messages/create#name_a_created_message).
     *     @type \Google\Chat\V1\User $sender
     *           Output only. The user who created the message.
     *           If your Chat app [authenticates as a
     *           user](https://developers.google.com/chat/api/guides/auth/users), the output
     *           populates the
     ...
     *           For more information, see [View text formatting sent in a
     *           message](https://developers.google.com/chat/format-messages#view_text_formatting_sent_in_a_message)
     *     @type array<\Google\Chat\V1\ContextualAddOnMarkup\Card>|\Google\Protobuf\Internal\RepeatedField $cards
     *           Deprecated: Use `cards_v2` instead.
     *           Rich, formatted, and interactive cards that you can use to display UI
     *           elements such as: formatted texts, buttons, and clickable images. Cards are
     *           normally displayed below the plain-text body of the message. `cards` and
     *           `cards_v2` can have a maximum size of 32 KB.
     *     @type array<\Google\Chat\V1\CardWithId>|\Google\Protobuf\Internal\RepeatedField $cards_v2
     *           An array of
     *           [cards](https://developers.google.com/chat/api/reference/rest/v1/cards).
     *           Only Chat apps can create cards. If your Chat app [authenticates as a
     *           user](https://developers.google.com/chat/api/guides/auth/users), the
     ...
     *           cards](https://developers.google.com/chat/ui).
     *           [Card builder](https://addons.gsuite.google.com/uikit/builder)
     *     @type array<\Google\Chat\V1\Annotation>|\Google\Protobuf\Internal\RepeatedField $annotations
     *           Output only. Annotations associated with the `text` in this message.
     *     @type \Google\Chat\V1\Thread $thread
     *           The thread the message belongs to. For example usage, see
     *           [Start or reply to a message
     *           thread](https://developers.google.com/chat/api/guides/v1/messages/create#create-message-thread).
     *     @type \Google\Chat\V1\Space $space
     *           If your Chat app [authenticates as a
     *           user](https://developers.google.com/chat/api/guides/auth/users), the output
     *           populates the
     *           [space](https://developers.google.com/chat/api/reference/rest/v1/spaces)
     ...
     *           A plain-text description of the message's cards, used when the actual cards
     *           can't be displayed—for example, mobile notifications.
     *     @type \Google\Chat\V1\ActionResponse $action_response
     *           Input only. Parameters that a Chat app can use to configure how its
     *           response is posted.
     *     @type string $argument_text
     *           Output only. Plain-text body of the message with all Chat app mentions
     *           stripped out.
     *     @type \Google\Chat\V1\SlashCommand $slash_command
     *           Output only. Slash command information, if applicable.
     *     @type array<\Google\Chat\V1\Attachment>|\Google\Protobuf\Internal\RepeatedField $attachment
     *           User-uploaded attachment.
     *     @type \Google\Chat\V1\MatchedUrl $matched_url
     *           Output only. A URL in `spaces.messages.text` that matches a link preview
     *           pattern. For more information, see [Preview
     *           links](https://developers.google.com/chat/how-tos/preview-links).
     ...
     *           field when you create the message. For details, see [Name a
     *           message](https://developers.google.com/chat/api/guides/v1/messages/create#name_a_created_message).
     *     @type array<\Google\Chat\V1\EmojiReactionSummary>|\Google\Protobuf\Internal\RepeatedField $emoji_reaction_summaries
     *           Output only. The list of emoji reaction summaries on the message.
     *     @type \Google\Chat\V1\User $private_message_viewer
     *           Immutable. Input for creating a message, otherwise output only. The user
     *           that can view the message. When set, the message is private and only
     *           visible to the specified user and the Chat app. Link previews and
     *           attachments aren't supported for private messages.
     ...
     *           For details, see [Send private messages to Google Chat
     *           users](https://developers.google.com/chat/api/guides/v1/messages/private).
     *     @type \Google\Chat\V1\DeletionMetadata $deletion_metadata
     *           Output only. Information about a deleted message. A message is deleted when
     *           `delete_time` is set.
     *     @type \Google\Chat\V1\QuotedMessageMetadata $quoted_message_metadata
     *           Output only. Information about a message that's quoted by a Google Chat
     *           user in a space. Google Chat users can quote a message to reply to it.
     *     @type array<\Google\Chat\V1\AttachedGif>|\Google\Protobuf\Internal\RepeatedField $attached_gifs
     *           Output only. GIF images that are attached to the message.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.User sender = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Chat\V1\User|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.User sender = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\User $var
     * @return $this
     */
    public function setSender($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\User::class);
        $this->sender = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.ContextualAddOnMarkup.Card cards = 5 [deprecated = true];</code>
     * @param array<\Google\Chat\V1\ContextualAddOnMarkup\Card>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     * @deprecated
     */
    ...
    {
        @trigger_error('cards is deprecated.', E_USER_DEPRECATED);
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\ContextualAddOnMarkup\Card::class);
        $this->cards = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.CardWithId cards_v2 = 22;</code>
     * @param array<\Google\Chat\V1\CardWithId>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCardsV2($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\CardWithId::class);
        $this->cards_v2 = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.Annotation annotations = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Chat\V1\Annotation>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAnnotations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\Annotation::class);
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Thread thread = 11;</code>
     * @return \Google\Chat\V1\Thread|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Thread thread = 11;</code>
     * @param \Google\Chat\V1\Thread $var
     * @return $this
     */
    public function setThread($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Thread::class);
        $this->thread = $var;
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Space space = 12;</code>
     * @return \Google\Chat\V1\Space|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Space space = 12;</code>
     * @param \Google\Chat\V1\Space $var
     * @return $this
     */
    public function setSpace($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Space::class);
        $this->space = $var;
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.ActionResponse action_response = 14 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     * @return \Google\Chat\V1\ActionResponse|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.ActionResponse action_response = 14 [(.google.api.field_behavior) = INPUT_ONLY];</code>
     * @param \Google\Chat\V1\ActionResponse $var
     * @return $this
     */
    public function setActionResponse($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\ActionResponse::class);
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.SlashCommand slash_command = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Chat\V1\SlashCommand|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.SlashCommand slash_command = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\SlashCommand $var
     * @return $this
     */
    public function setSlashCommand($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\SlashCommand::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.Attachment attachment = 18;</code>
     * @param array<\Google\Chat\V1\Attachment>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttachment($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\Attachment::class);
        $this->attachment = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.MatchedUrl matched_url = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Chat\V1\MatchedUrl|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.MatchedUrl matched_url = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\MatchedUrl $var
     * @return $this
     */
    public function setMatchedUrl($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\MatchedUrl::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.EmojiReactionSummary emoji_reaction_summaries = 33 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Chat\V1\EmojiReactionSummary>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEmojiReactionSummaries($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\EmojiReactionSummary::class);
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.DeletionMetadata deletion_metadata = 38 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Chat\V1\DeletionMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.DeletionMetadata deletion_metadata = 38 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\DeletionMetadata $var
     * @return $this
     */
    public function setDeletionMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\DeletionMetadata::class);
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.QuotedMessageMetadata quoted_message_metadata = 39 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Chat\V1\QuotedMessageMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.QuotedMessageMetadata quoted_message_metadata = 39 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\QuotedMessageMetadata $var
     * @return $this
     */
    public function setQuotedMessageMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\QuotedMessageMetadata::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.chat.v1.AttachedGif attached_gifs = 42 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Chat\V1\AttachedGif>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttachedGifs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Chat\V1\AttachedGif::class);
