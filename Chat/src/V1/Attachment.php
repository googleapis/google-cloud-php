...
class Attachment extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The content type (MIME type) of the file.
     *     @type \Google\Chat\V1\AttachmentDataRef $attachment_data_ref
     *           A reference to the attachment data. This field is used with the media API
     *           to download the attachment data.
     *     @type \Google\Chat\V1\DriveDataRef $drive_data_ref
     ...
     * @return \Google\Chat\V1\AttachmentDataRef|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.AttachmentDataRef attachment_data_ref = 4;</code>
     * @param \Google\Chat\V1\AttachmentDataRef $var
     * @return $this
     */
    public function setAttachmentDataRef($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\AttachmentDataRef::class);
     ...
     * @return \Google\Chat\V1\DriveDataRef|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.DriveDataRef drive_data_ref = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Chat\V1\DriveDataRef $var
     * @return $this
     */
    public function setDriveDataRef($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\DriveDataRef::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\Attachment\Source::class);
        $this->source = $var;
