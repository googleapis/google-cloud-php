...
class KeyValue extends \Google\Protobuf\Internal\Message
{
     ...
     *           The `onclick` action. Only the top label, bottom label, and content
     *           region are clickable.
     *     @type \Google\Chat\V1\WidgetMarkup\Button $button
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\WidgetMarkup\Icon::class);
     ...
     * @return \Google\Chat\V1\WidgetMarkup\Button|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.WidgetMarkup.Button button = 7;</code>
     * @param \Google\Chat\V1\WidgetMarkup\Button $var
     * @return $this
     */
    public function setButton($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\WidgetMarkup\Button::class);
