...
class Membership extends \Google\Protobuf\Internal\Message
{
     ...
     *           [Developer Preview](https://developers.google.com/workspace/preview):
     *           This field can only be used as input in `UpdateMembership`.
     *     @type \Google\Chat\V1\User $member
     ...
     *           `name` and `type`.
     *     @type \Google\Chat\V1\Group $group_member
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\Membership\MembershipState::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\Membership\MembershipRole::class);
        $this->role = $var;
     ...
     * @return \Google\Chat\V1\Group|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Group group_member = 5;</code>
     * @param \Google\Chat\V1\Group $var
     * @return $this
     */
    public function setGroupMember($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Group::class);
