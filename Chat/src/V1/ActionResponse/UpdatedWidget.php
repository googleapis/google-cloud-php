...
namespace Google\Chat\V1\ActionResponse;
...
class UpdatedWidget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Chat\V1\ActionResponse\SelectionItems $suggestions
     ...
     * @return \Google\Chat\V1\ActionResponse\SelectionItems|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.ActionResponse.SelectionItems suggestions = 1;</code>
     * @param \Google\Chat\V1\ActionResponse\SelectionItems $var
     * @return $this
     */
    public function setSuggestions($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\ActionResponse\SelectionItems::class);
