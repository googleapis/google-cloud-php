...
class Space extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The threading state in the Chat space.
     *     @type \Google\Chat\V1\Space\SpaceDetails $space_details
     *           Details about the space including description and rules.
    ...
    {
        @trigger_error('type is deprecated.', E_USER_DEPRECATED);
        GPBUtil::checkEnum($var, \Google\Chat\V1\Space\Type::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\Space\SpaceType::class);
        $this->space_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\Space\SpaceThreadingState::class);
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Space.SpaceDetails space_details = 11;</code>
     * @return \Google\Chat\V1\Space\SpaceDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.Space.SpaceDetails space_details = 11;</code>
     * @param \Google\Chat\V1\Space\SpaceDetails $var
     * @return $this
     */
    public function setSpaceDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Chat\V1\Space\SpaceDetails::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Chat\V1\HistoryState::class);
