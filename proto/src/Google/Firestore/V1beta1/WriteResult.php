 ...
 *
 * Generated from protobuf message <code>google.firestore.v1beta1.WriteResult</code>
 */
class WriteResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.v1beta1.Value transform_results = 2;</code>
     * @param \Google\Firestore\V1beta1\Value[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTransformResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Firestore\V1beta1\Value::class);
