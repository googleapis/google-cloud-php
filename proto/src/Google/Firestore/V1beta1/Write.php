...
class Write extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string verify = 5;</code>
     * @return string
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.DocumentTransform transform = 6;</code>
     * @param \Google\Firestore\V1beta1\DocumentTransform $var
     * @return $this
     */
    public function setTransform($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\DocumentTransform::class);
