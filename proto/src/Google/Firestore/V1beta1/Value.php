...
class Value extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.ArrayValue array_value = 9;</code>
     * @param \Google\Firestore\V1beta1\ArrayValue $var
     * @return $this
     */
    public function setArrayValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\ArrayValue::class);
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.MapValue map_value = 6;</code>
     * @param \Google\Firestore\V1beta1\MapValue $var
     * @return $this
     */
    public function setMapValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\MapValue::class);
