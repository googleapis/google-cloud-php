...
class StructuredQuery_Projection extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.v1beta1.StructuredQuery.FieldReference fields = 2;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_FieldReference[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Firestore\V1beta1\StructuredQuery_FieldReference::class);
        $this->fields = $arr;
