...
class StructuredQuery_Order extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.FieldReference field = 1;</code>
     * @return \Google\Firestore\V1beta1\StructuredQuery_FieldReference
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.FieldReference field = 1;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_FieldReference $var
     * @return $this
     */
    public function setField($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_FieldReference::class);
        $this->field = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Firestore\V1beta1\StructuredQuery_Direction::class);
        $this->direction = $var;
