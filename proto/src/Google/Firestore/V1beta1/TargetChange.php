...
class TargetChange extends \Google\Protobuf\Internal\Message
{
     ...
     * Set only when the stream reflects a the same `read_time` for the given
     * `target_ids`. The stream is guaranteed to send a `read_time` with
     * `target_ids` empty once the stream reaches a consistent snapshot.
     *
    ...
    {
        GPBUtil::checkEnum($var, \Google\Firestore\V1beta1\TargetChange_TargetChangeType::class);
