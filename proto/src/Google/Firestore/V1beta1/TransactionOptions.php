...
class TransactionOptions extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Firestore\V1beta1\TransactionOptions_ReadOnly
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.TransactionOptions.ReadOnly read_only = 2;</code>
     * @param \Google\Firestore\V1beta1\TransactionOptions_ReadOnly $var
     * @return $this
     */
    public function setReadOnly($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\TransactionOptions_ReadOnly::class);
     ...
     * @return \Google\Firestore\V1beta1\TransactionOptions_ReadWrite
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.TransactionOptions.ReadWrite read_write = 3;</code>
     * @param \Google\Firestore\V1beta1\TransactionOptions_ReadWrite $var
     * @return $this
     */
    public function setReadWrite($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\TransactionOptions_ReadWrite::class);
