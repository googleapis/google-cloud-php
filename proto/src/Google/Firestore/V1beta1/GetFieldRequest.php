...
/**
 * The request for [FirestoreAdmin.GetField][google.firestore.v1beta1.FirestoreAdmin.GetField].
 *
 * Generated from protobuf message <code>google.firestore.v1beta1.GetFieldRequest</code>
 */
class GetFieldRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * The field resource name. For example:
