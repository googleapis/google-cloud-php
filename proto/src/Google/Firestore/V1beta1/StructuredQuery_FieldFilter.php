...
class StructuredQuery_FieldFilter extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Firestore\V1beta1\StructuredQuery_FieldFilter_Operator::class);
        $this->op = $var;
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.Value value = 3;</code>
     * @param \Google\Firestore\V1beta1\Value $var
     * @return $this
     */
    public function setValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\Value::class);
        $this->value = $var;
