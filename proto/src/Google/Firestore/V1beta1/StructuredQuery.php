...
class StructuredQuery extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Projection select = 1;</code>
     * @return \Google\Firestore\V1beta1\StructuredQuery_Projection
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Projection select = 1;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_Projection $var
     * @return $this
     */
    public function setSelect($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_Projection::class);
        $this->select = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.v1beta1.StructuredQuery.CollectionSelector from = 2;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_CollectionSelector[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFrom($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Firestore\V1beta1\StructuredQuery_CollectionSelector::class);
        $this->from = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Filter where = 3;</code>
     * @return \Google\Firestore\V1beta1\StructuredQuery_Filter
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.Filter where = 3;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_Filter $var
     * @return $this
     */
    public function setWhere($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_Filter::class);
        $this->where = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.v1beta1.StructuredQuery.Order order_by = 4;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_Order[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOrderBy($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Firestore\V1beta1\StructuredQuery_Order::class);
        $this->order_by = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.Cursor start_at = 7;</code>
     * @param \Google\Firestore\V1beta1\Cursor $var
     * @return $this
     */
    public function setStartAt($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\Cursor::class);
        $this->start_at = $var;
