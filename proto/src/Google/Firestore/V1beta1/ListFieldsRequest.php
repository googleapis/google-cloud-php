...
/**
 * The request for [FirestoreAdmin.ListFields][google.firestore.v1beta1.FirestoreAdmin.ListFields].
 *
 * Generated from protobuf message <code>google.firestore.v1beta1.ListFieldsRequest</code>
 */
class ListFieldsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    private $page_size = 0;
    /**
     * A page token. Must be from a [ListFieldsResponse][google.firestore.v1beta1.ListFieldsResponse].
     * May be empty.
     *
