...
class StructuredQuery_Filter extends \Google\Protobuf\Internal\Message
{
     ...
     * @return \Google\Firestore\V1beta1\StructuredQuery_CompositeFilter
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.CompositeFilter composite_filter = 1;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_CompositeFilter $var
     * @return $this
     */
    public function setCompositeFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_CompositeFilter::class);
     ...
     * @return \Google\Firestore\V1beta1\StructuredQuery_FieldFilter
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.FieldFilter field_filter = 2;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_FieldFilter $var
     * @return $this
     */
    public function setFieldFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_FieldFilter::class);
     ...
     * @return \Google\Firestore\V1beta1\StructuredQuery_UnaryFilter
     */
     ...
     *
     * Generated from protobuf field <code>.google.firestore.v1beta1.StructuredQuery.UnaryFilter unary_filter = 3;</code>
     * @param \Google\Firestore\V1beta1\StructuredQuery_UnaryFilter $var
     * @return $this
     */
    public function setUnaryFilter($var)
    {
        GPBUtil::checkMessage($var, \Google\Firestore\V1beta1\StructuredQuery_UnaryFilter::class);
