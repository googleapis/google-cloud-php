...
class SingleProductOffer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.commerceproducer.v1beta.PrivateOffer.SingleProductOffer.AdditionalContractValue additional_contract_value = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $additional_contract_value = null;
     ...
     *           Output only. Revenue share information for this Private Offer.
     *           Not included for `PRIVATE_OFFER_VIEW_BASIC`.
     *     @type \Google\Cloud\CommerceProducer\V1beta\PrivateOffer\SingleProductOffer\AdditionalContractValue $additional_contract_value
     *           Optional. Additional contract value that the customer is legally
     *           obligated to spend on the product over the duration of the offer.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.commerceproducer.v1beta.PrivateOffer.SingleProductOffer.AdditionalContractValue additional_contract_value = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\CommerceProducer\V1beta\PrivateOffer\SingleProductOffer\AdditionalContractValue|null
     */
    public function getAdditionalContractValue()
    {
        return $this->additional_contract_value;
    }

    public function hasAdditionalContractValue()
    {
        return isset($this->additional_contract_value);
    }

    public function clearAdditionalContractValue()
    {
        unset($this->additional_contract_value);
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.commerceproducer.v1beta.PrivateOffer.SingleProductOffer.AdditionalContractValue additional_contract_value = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\CommerceProducer\V1beta\PrivateOffer\SingleProductOffer\AdditionalContractValue $var
     * @return $this
     */
    public function setAdditionalContractValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\CommerceProducer\V1beta\PrivateOffer\SingleProductOffer\AdditionalContractValue::class);
        $this->additional_contract_value = $var;
