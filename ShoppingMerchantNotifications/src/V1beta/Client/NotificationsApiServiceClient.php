 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/notifications/v1beta/notificationsapi.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Shopping\Merchant\Notifications\V1beta\Client;
...
final class NotificationsApiServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.notifications.v1beta.NotificationsApiService';
     ...
     *
     * @example samples/V1beta/NotificationsApiServiceClient/create_notification_subscription.php
     *
     ...
     *
     * @example samples/V1beta/NotificationsApiServiceClient/delete_notification_subscription.php
     *
     ...
     *
     * @example samples/V1beta/NotificationsApiServiceClient/get_notification_subscription.php
     *
     ...
     *
     * @example samples/V1beta/NotificationsApiServiceClient/list_notification_subscriptions.php
     *
     ...
     *
     * @example samples/V1beta/NotificationsApiServiceClient/update_notification_subscription.php
     *
