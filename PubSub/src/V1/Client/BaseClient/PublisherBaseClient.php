 ...
 */
abstract class PublisherBaseClient
{
     ...
     *
     * The async variant is {@see self::createTopicAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteTopicAsync()} .
     *
     ...
     *
     * The async variant is {@see self::detachSubscriptionAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getTopicAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listTopicSnapshotsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listTopicSubscriptionsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listTopicsAsync()} .
     *
     ...
     * does not exist.
     *
     * The async variant is {@see self::publishAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateTopicAsync()} .
     *
