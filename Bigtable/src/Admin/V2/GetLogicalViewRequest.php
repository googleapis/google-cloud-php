 ...
 *
 * Generated from protobuf message <code>google.bigtable.admin.v2.GetLogicalViewRequest</code>
 */
class GetLogicalViewRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The unique name of the requested logical view. Values are of the
     ...
     *
     * @return \Google\Cloud\Bigtable\Admin\V2\GetLogicalViewRequest
     *
     * @experimental
     */
