 ...
 *
 * Generated from protobuf message <code>google.bigtable.admin.v2.ListLogicalViewsRequest</code>
 */
class ListLogicalViewsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The unique name of the instance for which the list of logical
     *                       views is requested. Values are of the form
     ...
     *
     * @return \Google\Cloud\Bigtable\Admin\V2\ListLogicalViewsRequest
     *
     * @experimental
     */
