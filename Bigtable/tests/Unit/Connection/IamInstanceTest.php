...
class IamInstanceTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->iam = \Google\Cloud\Core\Testing\TestHelpers::stub(IamInstance::class,
    ...
    public function methodProvider()
    {
        ...
        return [
            ['getPolicy', 'getIamPolicy', $args],
            ['setPolicy', 'setIamPolicy', $args],
            ['testPermissions', 'testIamPermissions', $args]
        ];
    }
}
