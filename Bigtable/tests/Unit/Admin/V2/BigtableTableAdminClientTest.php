...
class BigtableTableAdminClientTest extends GeneratedTest
{
    ...
    public function createAuthorizedViewTest()
    {
        ...
        $response = $gapicClient->createAuthorizedView($formattedParent, $authorizedViewId, $authorizedView);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function deleteAuthorizedViewTest()
    {
        ...
        $gapicClient->deleteAuthorizedView($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function getAuthorizedViewTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->authorizedViewName('[PROJECT]', '[INSTANCE]', '[TABLE]', '[AUTHORIZED_VIEW]');
        $response = $gapicClient->getAuthorizedView($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getAuthorizedViewExceptionTest()
    {
        ...
        $formattedName = $gapicClient->authorizedViewName('[PROJECT]', '[INSTANCE]', '[TABLE]', '[AUTHORIZED_VIEW]');
        try {
            $gapicClient->getAuthorizedView($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listAuthorizedViewsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->tableName('[PROJECT]', '[INSTANCE]', '[TABLE]');
        $response = $gapicClient->listAuthorizedViews($formattedParent);
    ...
    public function listAuthorizedViewsExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->tableName('[PROJECT]', '[INSTANCE]', '[TABLE]');
        try {
            $gapicClient->listAuthorizedViews($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateAuthorizedViewTest()
    {
        ...
        // Mock request
        $authorizedView = new AuthorizedView();
        $response = $gapicClient->updateAuthorizedView($authorizedView);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
