...
use Google\Shopping\Merchant\Quota\V1\ListAccountLimitsResponse;
use stdClass;
 ...
 * @group gapic
 */
class AccountLimitsServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new AccountLimitsServiceClient($options);
    }

    /** @test */
    public function getAccountLimitTest()
    {
        ...
        $expectedResponse = new AccountLimit();
        ...
        $this->assertSame('/google.shopping.merchant.quota.v1.AccountLimitsService/GetAccountLimit', $actualFuncCall);
    ...
    /** @test */
    public function getAccountLimitExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listAccountLimitsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertEquals($expectedResponse->getAccountLimits()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.quota.v1.AccountLimitsService/ListAccountLimits', $actualFuncCall);
    ...
    /** @test */
    public function listAccountLimitsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getAccountLimitAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
