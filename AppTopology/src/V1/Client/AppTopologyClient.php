 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/apptopology/v1/service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\AppTopology\V1\Client;
 ...
 */
final class AppTopologyClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.apptopology.v1.AppTopology';
     ...
     */
    private const SERVICE_ADDRESS = 'apptopology.googleapis.com';

    /** The address template of the service. */
    private const SERVICE_ADDRESS_TEMPLATE = 'apptopology.UNIVERSE_DOMAIN';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/app_topology_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/app_topology_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/app_topology_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/app_topology_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * discovered_resources_topology resource.
     *
     * @param string $project
     * @param string $location
     *
     * @return string The formatted discovered_resources_topology resource.
     */
    public static function discoveredResourcesTopologyName(string $project, string $location): string
    {
        return self::getPathTemplate('discoveredResourcesTopology')->render([
            'project' => $project,
            'location' => $location,
        ]);
    }
     ...
     */
    public static function schemaName(string $project, string $location, string $domain): string
    {
     ...
     *           as "<uri>:<port>". Default 'apptopology.googleapis.com:443'.
     ...
     *           use Google\Cloud\AppTopology\V1\AppTopologyClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AppTopologyClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AppTopologyClient::generateDiscoveredResourcesTopologyAsync()} .
     *
     * @example samples/V1/AppTopologyClient/generate_discovered_resources_topology.php
     *
     * @param GenerateDiscoveredResourcesTopologyRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return GenerateDiscoveredResourcesTopologyResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateDiscoveredResourcesTopology(
        GenerateDiscoveredResourcesTopologyRequest $request,
        array $callOptions = []
    ): GenerateDiscoveredResourcesTopologyResponse {
        return $this->startApiCall('GenerateDiscoveredResourcesTopology', $request, $callOptions)->wait();
    }

    /**
     * Retrieves the specified topology domain.
     *
     * The async variant is {@see AppTopologyClient::getDomainAsync()} .
     *
     * @example samples/V1/AppTopologyClient/get_domain.php
     *
     ...
     * domain.
     *
     * The async variant is {@see AppTopologyClient::getSchemaAsync()} .
     *
     * @example samples/V1/AppTopologyClient/get_schema.php
     *
     ...
     *
     * The async variant is {@see AppTopologyClient::listDomainsAsync()} .
     *
     * @example samples/V1/AppTopologyClient/list_domains.php
     *
     ...
     *
     * The async variant is {@see AppTopologyClient::getLocationAsync()} .
     *
     * @example samples/V1/AppTopologyClient/get_location.php
     *
     ...
     *
     * The async variant is {@see AppTopologyClient::listLocationsAsync()} .
     *
     * @example samples/V1/AppTopologyClient/list_locations.php
     *
