 ...
 *
 * Generated from protobuf message <code>google.cloud.apptopology.v1.GetDomainRequest</code>
 */
class GetDomainRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the domain to retrieve.
     *                     Format: `projects/{project}/locations/{location}/domains/{domain}`
     *                     Please see {@see AppTopologyClient::domainName()} for help formatting this field.
     *
     * @return \Google\Cloud\AppTopology\V1\GetDomainRequest
     *
     * @experimental
     */
