...
namespace Google\Shopping\Merchant\Inventories\Tests\Unit\V1beta;
...
class RegionalInventoryServiceClientTest extends GeneratedTest
{
    ...
    public function deleteRegionalInventoryTest()
    {
        ...
        $gapicClient->deleteRegionalInventory($formattedName);
    ...
    public function insertRegionalInventoryTest()
    {
        ...
        $response = $gapicClient->insertRegionalInventory($parent, $regionalInventory);
    ...
    public function insertRegionalInventoryExceptionTest()
    {
        ...
        $regionalInventory->setRegion($regionalInventoryRegion);
        try {
            $gapicClient->insertRegionalInventory($parent, $regionalInventory);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listRegionalInventoriesTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $response = $gapicClient->listRegionalInventories($parent);
    ...
    public function listRegionalInventoriesExceptionTest()
    {
        ...
        $parent = 'parent-995424086';
        try {
            $gapicClient->listRegionalInventories($parent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
