 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.inventories.v1.ListLocalInventoriesResponse</code>
 */
class ListLocalInventoriesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Inventories\V1\LocalInventory::class);
