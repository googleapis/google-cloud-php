    ...
    'interfaces' => [
        'google.shopping.merchant.inventories.v1.RegionalInventoryService' => [
            ...
            'InsertRegionalInventory' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Shopping\Merchant\Inventories\V1\RegionalInventory',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListRegionalInventories' => [
                ...
                'responseType' => 'Google\Shopping\Merchant\Inventories\V1\ListRegionalInventoriesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
