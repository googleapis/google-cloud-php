 ...
 * @experimental
 */
class RegionalInventoryServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.shopping.merchant.inventories.v1beta.RegionalInventoryService';
    ...
    private static $regionalInventoryNameTemplate;
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../resources/regional_inventory_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/regional_inventory_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../resources/regional_inventory_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/regional_inventory_service_rest_client_config.php',
                ],
            ],
        ];
    }

    private static function getRegionalInventoryNameTemplate()
    {
        if (self::$regionalInventoryNameTemplate == null) {
            self::$regionalInventoryNameTemplate = new PathTemplate(
                'accounts/{account}/products/{product}/regionalInventories/{region}'
            );
        }

        return self::$regionalInventoryNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                'regionalInventory' => self::getRegionalInventoryNameTemplate(),
            ];
        }
     ...
     * @experimental
     */
    public static function regionalInventoryName($account, $product, $region)
    {
        return self::getRegionalInventoryNameTemplate()->render([
            'account' => $account,
            'product' => $product,
            'region' => $region,
        ]);
     ...
     * @experimental
     */
    public function deleteRegionalInventory($name, array $optionalArgs = [])
    {
     ...
     * @param RegionalInventory $regionalInventory Required. Regional inventory information to add to the product. If the
    ...
    public function insertRegionalInventory(
        ...
        $request->setRegionalInventory($regionalInventory);
     ...
     *     $pagedResponse = $regionalInventoryServiceClient->listRegionalInventories($parent);
     ...
     * @experimental
     */
    public function listRegionalInventories($parent, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse(
            ...
            $optionalArgs,
            ListRegionalInventoriesResponse::class,
            $request
        );
    }
}
