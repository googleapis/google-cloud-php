 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.GetDatabaseRequest</code>
 */
class GetDatabaseRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the Database resource in the following format:
     *                     projects/{project}/locations/{region}/databases/{database}
     *                     Please see {@see OracleDatabaseClient::databaseName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\GetDatabaseRequest
     *
     * @experimental
     */
