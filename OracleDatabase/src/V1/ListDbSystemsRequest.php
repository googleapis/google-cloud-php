 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListDbSystemsRequest</code>
 */
class ListDbSystemsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent value for DbSystems in the following format:
     *                       projects/{project}/locations/{location}. Please see
     *                       {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListDbSystemsRequest
     *
     * @experimental
     */
