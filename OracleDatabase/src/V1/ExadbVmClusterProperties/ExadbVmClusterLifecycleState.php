 ...
 *
 * Protobuf type <code>google.cloud.oracledatabase.v1.ExadbVmClusterProperties.ExadbVmClusterLifecycleState</code>
 */
class ExadbVmClusterLifecycleState
{
    /**
     * Default unspecified value.
     *
     * Generated from protobuf enum <code>EXADB_VM_CLUSTER_LIFECYCLE_STATE_UNSPECIFIED = 0;</code>
     */
    const EXADB_VM_CLUSTER_LIFECYCLE_STATE_UNSPECIFIED = 0;
    /**
    ...
    private static $valueToName = [
        self::EXADB_VM_CLUSTER_LIFECYCLE_STATE_UNSPECIFIED => 'EXADB_VM_CLUSTER_LIFECYCLE_STATE_UNSPECIFIED',
