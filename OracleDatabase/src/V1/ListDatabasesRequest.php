 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListDatabasesRequest</code>
 */
class ListDatabasesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent resource name in the following format:
     *                       projects/{project}/locations/{region}
     *                       Please see {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListDatabasesRequest
     *
     * @experimental
     */
