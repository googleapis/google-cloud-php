 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListGoldengateConnectionAssignmentsRequest</code>
 */
class ListGoldengateConnectionAssignmentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent value for the GoldengateConnectionAssignments.
     *                       Format: projects/{project}/locations/{location}
     *                       Please see {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListGoldengateConnectionAssignmentsRequest
     *
     * @experimental
     */
