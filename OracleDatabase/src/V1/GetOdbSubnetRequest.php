 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.GetOdbSubnetRequest</code>
 */
class GetOdbSubnetRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the OdbSubnet in the following format:
     ...
     *
     * @return \Google\Cloud\OracleDatabase\V1\GetOdbSubnetRequest
     *
     * @experimental
     */
