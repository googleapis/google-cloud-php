 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListExadbVmClustersRequest</code>
 */
class ListExadbVmClustersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent value for ExadbVmClusters in the following format:
     *                       projects/{project}/locations/{location}. Please see
     *                       {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListExadbVmClustersRequest
     *
     * @experimental
     */
