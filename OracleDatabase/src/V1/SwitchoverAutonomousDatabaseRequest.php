 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.SwitchoverAutonomousDatabaseRequest</code>
 */
class SwitchoverAutonomousDatabaseRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string $peerAutonomousDatabase Required. The peer database name to switch over to. Please see
     *                                       {@see OracleDatabaseClient::autonomousDatabaseName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\SwitchoverAutonomousDatabaseRequest
     *
     * @experimental
     */
