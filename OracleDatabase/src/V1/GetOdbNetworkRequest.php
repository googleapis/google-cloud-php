 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.GetOdbNetworkRequest</code>
 */
class GetOdbNetworkRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the OdbNetwork in the following format:
     ...
     *
     * @return \Google\Cloud\OracleDatabase\V1\GetOdbNetworkRequest
     *
     * @experimental
     */
