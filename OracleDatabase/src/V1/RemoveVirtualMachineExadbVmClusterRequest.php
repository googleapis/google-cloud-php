 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.RemoveVirtualMachineExadbVmClusterRequest</code>
 */
class RemoveVirtualMachineExadbVmClusterRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $hostnames Required. The list of host names of db nodes to be removed from the
     *                            ExadbVmCluster.
     *
     * @return \Google\Cloud\OracleDatabase\V1\RemoveVirtualMachineExadbVmClusterRequest
     *
     * @experimental
     */
    public static function build(string $name, array $hostnames): self
    {
        return (new self())
            ->setName($name)
