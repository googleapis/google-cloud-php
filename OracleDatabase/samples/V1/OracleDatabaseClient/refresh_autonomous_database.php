 ...
 *
 * @param string $formattedName The name of the AutonomousDatabase resource.
 *                              Format:
 ...
 */
function refresh_autonomous_database_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $oracleDatabaseClient->refreshAutonomousDatabase($request);
...
function callSample(): void
{
    ...
    refresh_autonomous_database_sample($formattedName);
}
