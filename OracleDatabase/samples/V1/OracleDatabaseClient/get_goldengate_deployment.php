 ...
 *
 * @param string $formattedName The name of the GoldengateDeployment in the following format:
 ...
 */
function get_goldengate_deployment_sample(string $formattedName): void
{
    // Create a client.
    $oracleDatabaseClient = new OracleDatabaseClient();

    // Prepare the request message.
    $request = (new GetGoldengateDeploymentRequest())
        ->setName($formattedName);

    // Call the API and handle any network failures.
    try {
        /** @var GoldengateDeployment $response */
        $response = $oracleDatabaseClient->getGoldengateDeployment($request);
...
function callSample(): void
{
    ...
    get_goldengate_deployment_sample($formattedName);
}
