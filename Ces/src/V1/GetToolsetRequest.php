 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetToolsetRequest</code>
 */
class GetToolsetRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the toolset to retrieve. Please see
     *                     {@see AgentServiceClient::toolsetName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetToolsetRequest
     *
     * @experimental
     */
