 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.DataStoreTool.BoostSpec.ConditionBoostSpec.BoostControlSpec</code>
 */
class BoostControlSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.ces.v1.DataStoreTool.BoostSpec.ConditionBoostSpec.BoostControlSpec.AttributeType attribute_type = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * points listed below.
     *
     * Generated from protobuf field <code>.google.cloud.ces.v1.DataStoreTool.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationType interpolation_type = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Ces\V1\DataStoreTool\BoostSpec\ConditionBoostSpec\BoostControlSpec\AttributeType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Ces\V1\DataStoreTool\BoostSpec\ConditionBoostSpec\BoostControlSpec\InterpolationType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Ces\V1\DataStoreTool\BoostSpec\ConditionBoostSpec\BoostControlSpec\ControlPoint::class);
