 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.RestoreAppVersionRequest</code>
 */
class RestoreAppVersionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the app version to restore. Please see
     *                     {@see AgentServiceClient::appVersionName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\RestoreAppVersionRequest
     *
     * @experimental
     */
