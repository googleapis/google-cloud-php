 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetExampleRequest</code>
 */
class GetExampleRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the example to retrieve. Please see
     *                     {@see AgentServiceClient::exampleName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetExampleRequest
     *
     * @experimental
     */
