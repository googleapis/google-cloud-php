 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetAppRequest</code>
 */
class GetAppRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the app to retrieve. Please see
     *                     {@see AgentServiceClient::appName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetAppRequest
     *
     * @experimental
     */
