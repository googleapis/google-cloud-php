 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListChangelogsResponse</code>
 */
class ListChangelogsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.ces.v1.Changelog changelogs = 1;</code>
     */
    private $changelogs;
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Ces\V1\Changelog::class);
        $this->changelogs = $arr;
