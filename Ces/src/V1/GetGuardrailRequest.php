 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetGuardrailRequest</code>
 */
class GetGuardrailRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the guardrail to retrieve. Please see
     *                     {@see AgentServiceClient::guardrailName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetGuardrailRequest
     *
     * @experimental
     */
