 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListAppVersionsRequest</code>
 */
class ListAppVersionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The resource name of the app to list app versions from. Please see
     *                       {@see AgentServiceClient::appName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\ListAppVersionsRequest
     *
     * @experimental
     */
