 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetToolRequest</code>
 */
class GetToolRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the tool to retrieve. Please see
     *                     {@see AgentServiceClient::toolName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetToolRequest
     *
     * @experimental
     */
