 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetChangelogRequest</code>
 */
class GetChangelogRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the changelog to retrieve. Please see
     *                     {@see AgentServiceClient::changelogName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetChangelogRequest
     *
     * @experimental
     */
