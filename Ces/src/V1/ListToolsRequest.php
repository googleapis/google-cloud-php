 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListToolsRequest</code>
 */
class ListToolsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The resource name of the app to list tools from. Please see
     *                       {@see AgentServiceClient::appName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\ListToolsRequest
     *
     * @experimental
     */
