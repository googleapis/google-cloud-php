 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetAgentRequest</code>
 */
class GetAgentRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the agent to retrieve. Please see
     *                     {@see AgentServiceClient::agentName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetAgentRequest
     *
     * @experimental
     */
