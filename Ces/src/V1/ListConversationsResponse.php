 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListConversationsResponse</code>
 */
class ListConversationsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Ces\V1\Conversation::class);
