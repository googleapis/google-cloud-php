 ...
 */
abstract class TranslationServiceBaseClient
{
     ...
     *
     * The async variant is {@see self::batchTranslateDocumentAsync()} .
     *
     ...
     *
     * The async variant is {@see self::batchTranslateTextAsync()} .
     *
     ...
     *
     * The async variant is {@see self::createGlossaryAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteGlossaryAsync()} .
     *
     ...
     *
     * The async variant is {@see self::detectLanguageAsync()} .
     *
     ...
     * exist.
     *
     * The async variant is {@see self::getGlossaryAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getSupportedLanguagesAsync()} .
     *
     ...
     * exist.
     *
     * The async variant is {@see self::listGlossariesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::translateDocumentAsync()} .
     *
     ...
     *
     * The async variant is {@see self::translateTextAsync()} .
     *
