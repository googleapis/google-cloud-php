...
// [START visionai_v1_generated_AppPlatform_UpdateApplication_sync]
...
function update_application_sample(string $applicationDisplayName): void
{
    ...
    try {
        ...
        $response = $appPlatformClient->updateApplication($application);
...
// [END visionai_v1_generated_AppPlatform_UpdateApplication_sync]
