 ...
 *
 * Generated from protobuf message <code>google.cloud.visionai.v1.DedicatedResources</code>
 */
class DedicatedResources extends \Google\Protobuf\Internal\Message
{
     ...
     * prediction.
     *
     * Generated from protobuf field <code>.google.cloud.visionai.v1.MachineSpec machine_spec = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
     ...
     *
     *     @type \Google\Cloud\VisionAI\V1\MachineSpec $machine_spec
     *           Required. Immutable. The specification of a single machine used by the
     *           prediction.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.visionai.v1.MachineSpec machine_spec = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Google\Cloud\VisionAI\V1\MachineSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.visionai.v1.MachineSpec machine_spec = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Google\Cloud\VisionAI\V1\MachineSpec $var
     * @return $this
     */
    public function setMachineSpec($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\VisionAI\V1\MachineSpec::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\VisionAI\V1\AutoscalingMetricSpec::class);
