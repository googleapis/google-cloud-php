 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/visionai/v1/health_service.proto
...
final class HealthCheckServiceClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/health_check_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/health_check_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/health_check_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/health_check_service_rest_client_config.php',
                ],
            ],
        ];
    }
