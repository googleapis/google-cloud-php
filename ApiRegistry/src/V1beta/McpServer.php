 ...
 *
 * Generated from protobuf message <code>google.cloud.apiregistry.v1beta.McpServer</code>
 */
class McpServer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.apiregistry.v1beta.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
