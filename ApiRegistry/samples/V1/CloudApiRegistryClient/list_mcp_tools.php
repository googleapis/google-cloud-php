 ...
 *
 * @param string $formattedParent Parent value for ListMcpToolsRequest
 *                                Please see {@see CloudApiRegistryClient::mcpServerName()} for help formatting this field.
 */
function list_mcp_tools_sample(string $formattedParent): void
{
    // Create a client.
    $cloudApiRegistryClient = new CloudApiRegistryClient();

    // Prepare the request message.
    $request = (new ListMcpToolsRequest())
