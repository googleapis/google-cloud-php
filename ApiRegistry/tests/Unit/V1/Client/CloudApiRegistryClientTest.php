...
namespace Google\Cloud\ApiRegistry\Tests\Unit\V1\Client;
...
use Google\Cloud\ApiRegistry\V1\GetMcpServerRequest;
use Google\Cloud\ApiRegistry\V1\GetMcpToolRequest;
use Google\Cloud\ApiRegistry\V1\ListMcpServersRequest;
use Google\Cloud\ApiRegistry\V1\ListMcpServersResponse;
use Google\Cloud\ApiRegistry\V1\ListMcpToolsRequest;
use Google\Cloud\ApiRegistry\V1\ListMcpToolsResponse;
use Google\Cloud\ApiRegistry\V1\McpServer;
...
class CloudApiRegistryClientTest extends GeneratedTest
{
    ...
    public function getMcpServerTest()
    {
        ...
        $this->assertSame('/google.cloud.apiregistry.v1.CloudApiRegistry/GetMcpServer', $actualFuncCall);
    ...
    public function getMcpToolTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.apiregistry.v1.CloudApiRegistry/GetMcpTool', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMcpServersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.apiregistry.v1.CloudApiRegistry/ListMcpServers', $actualFuncCall);
    ...
    public function listMcpToolsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.apiregistry.v1.CloudApiRegistry/ListMcpTools', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
