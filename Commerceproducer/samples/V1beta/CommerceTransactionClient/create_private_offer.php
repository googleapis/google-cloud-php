 ...
 *                                {@see CommerceTransactionClient::locationName()} for help formatting this field.
 */
function create_private_offer_sample(string $formattedParent): void
{
    // Create a client.
    ...
    $request = (new CreatePrivateOfferRequest())
