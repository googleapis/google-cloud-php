...
// [START commerceproducer_v1beta_generated_CommerceTransaction_GetSkuGroup_sync]
 ...
 */
function get_sku_group_sample(string $formattedName): void
{
    // Create a client.
    $commerceTransactionClient = new CommerceTransactionClient();

    // Prepare the request message.
    $request = (new GetSkuGroupRequest())
