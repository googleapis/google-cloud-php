...
// [START commerceproducer_v1beta_generated_CommerceTransaction_GetPrivateOffer_sync]
 ...
 */
function get_private_offer_sample(string $formattedName): void
{
    // Create a client.
    $commerceTransactionClient = new CommerceTransactionClient();

    // Prepare the request message.
    $request = (new GetPrivateOfferRequest())
