 ...
 *
 * @param string $formattedParent Parent value for ListStandardOffersRequest
 *                                Please see {@see CommerceTransactionClient::serviceName()} for help formatting this field.
 */
function list_standard_offers_sample(string $formattedParent): void
{
    // Create a client.
    $commerceTransactionClient = new CommerceTransactionClient();

    // Prepare the request message.
    $request = (new ListStandardOffersRequest())
