 ...
 *
 * @param string $formattedParent Parent value for ListPrivateOfferDocumentsRequest. Please see
 *                                {@see CommerceTransactionClient::privateOfferName()} for help formatting this field.
 */
function list_private_offer_documents_sample(string $formattedParent): void
{
    // Create a client.
    $commerceTransactionClient = new CommerceTransactionClient();

    // Prepare the request message.
    $request = (new ListPrivateOfferDocumentsRequest())
