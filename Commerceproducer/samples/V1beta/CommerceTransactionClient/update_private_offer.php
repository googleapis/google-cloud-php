...
// [START commerceproducer_v1beta_generated_CommerceTransaction_UpdatePrivateOffer_sync]
 ...
 */
function update_private_offer_sample(): void
{
    // Create a client.
    ...
    $request = (new UpdatePrivateOfferRequest())
