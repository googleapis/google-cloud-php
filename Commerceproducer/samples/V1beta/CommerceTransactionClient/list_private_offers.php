 ...
 *
 * @param string $formattedParent Parent value for ListPrivateOffersRequest
 *                                Please see {@see CommerceTransactionClient::locationName()} for help formatting this field.
 */
function list_private_offers_sample(string $formattedParent): void
{
    // Create a client.
    $commerceTransactionClient = new CommerceTransactionClient();

    // Prepare the request message.
    $request = (new ListPrivateOffersRequest())
