...
namespace Google\Cloud\GSuiteAddOns\Tests\Unit\V1\Client;
...
class GSuiteAddOnsClientTest extends GeneratedTest
{
    ...
    public function getInstallStatusTest()
    {
        ...
        $request = (new GetInstallStatusRequest())->setName($formattedName);
    ...
    public function replaceDeploymentTest()
    {
        ...
        // Mock request
        $deployment = new Deployment();
        $request = (new ReplaceDeploymentRequest())->setDeployment($deployment);
