 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.ListUserGroupsRequest</code>
 */
class ListUserGroupsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent org where this UserGroup will be listed.
     *                       Format: organizations/{org_id}
     *                       Please see {@see MarketingplatformAdminServiceClient::organizationName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\ListUserGroupsRequest
     *
     * @experimental
     */
