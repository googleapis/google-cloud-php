 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.ListUserGroupMembersRequest</code>
 */
class ListUserGroupMembersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent user group where this UserGroupMember will be listed.
     *                       Format: organizations/{org_id}/userGroups/{user_group_id}
     *                       Please see {@see MarketingplatformAdminServiceClient::userGroupName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\ListUserGroupMembersRequest
     *
     * @experimental
     */
