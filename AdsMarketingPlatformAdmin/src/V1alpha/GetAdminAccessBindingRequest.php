 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.GetAdminAccessBindingRequest</code>
 */
class GetAdminAccessBindingRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *                     Format:
     *                     organizations/{org_id}/adminAccessBindings/{admin_access_binding_id}
     *                     Please see {@see MarketingplatformAdminServiceClient::adminAccessBindingName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\GetAdminAccessBindingRequest
     *
     * @experimental
     */
