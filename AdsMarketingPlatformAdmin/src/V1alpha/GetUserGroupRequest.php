 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.GetUserGroupRequest</code>
 */
class GetUserGroupRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the UserGroup to retrieve.
     *                     Format: organizations/{org_id}/userGroups/{user_group_id}
     *                     Please see {@see MarketingplatformAdminServiceClient::userGroupName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\GetUserGroupRequest
     *
     * @experimental
     */
