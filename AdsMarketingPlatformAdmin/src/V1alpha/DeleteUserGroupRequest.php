 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.DeleteUserGroupRequest</code>
 */
class DeleteUserGroupRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the user group to delete.
     *                     Format: organizations/{org_id}/userGroups/{user_group_id}
     *                     Please see {@see MarketingplatformAdminServiceClient::userGroupName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\DeleteUserGroupRequest
     *
     * @experimental
     */
