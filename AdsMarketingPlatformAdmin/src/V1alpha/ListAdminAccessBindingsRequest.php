 ...
 *
 * Generated from protobuf message <code>google.marketingplatform.admin.v1alpha.ListAdminAccessBindingsRequest</code>
 */
class ListAdminAccessBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent organization, which owns this collection of Admin
     *                       Access Bindings. Format: organizations/{org_id}
     *                       Please see {@see MarketingplatformAdminServiceClient::organizationName()} for help formatting this field.
     *
     * @return \Google\Ads\MarketingPlatform\Admin\V1alpha\ListAdminAccessBindingsRequest
     *
     * @experimental
     */
