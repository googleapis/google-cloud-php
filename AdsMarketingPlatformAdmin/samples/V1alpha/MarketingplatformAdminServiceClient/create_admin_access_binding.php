 ...
 *
 * @param string $formattedParent The parent organization, which owns this Admin Access Binding.
 *                                Format: organizations/{org_id}
 *                                Please see {@see MarketingplatformAdminServiceClient::organizationName()} for help formatting this field.
 */
function create_admin_access_binding_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $marketingplatformAdminServiceClient->createAdminAccessBinding($request);
...
function callSample(): void
{
    ...
    create_admin_access_binding_sample($formattedParent);
}
