 ...
 *
 * @param string $formattedParent The parent resource where this UserGroup will be created.
 *                                Format: organizations/{org_id}
 *                                Please see {@see MarketingplatformAdminServiceClient::organizationName()} for help formatting this field.
 */
function create_user_group_sample(string $formattedParent): void
{
    // Create a client.
    ...
    $request = (new CreateUserGroupRequest())
    ...
    try {
        ...
        $response = $marketingplatformAdminServiceClient->createUserGroup($request);
...
function callSample(): void
{
    ...
    create_user_group_sample($formattedParent);
}
