 ...
 *
 * @param string $formattedParent The parent user group where this UserGroupMember will be listed.
 ...
 */
function list_user_group_members_sample(string $formattedParent): void
{
    // Create a client.
    $marketingplatformAdminServiceClient = new MarketingplatformAdminServiceClient();

    // Prepare the request message.
    $request = (new ListUserGroupMembersRequest())
        ->setParent($formattedParent);

    // Call the API and handle any network failures.
    try {
        /** @var PagedListResponse $response */
        $response = $marketingplatformAdminServiceClient->listUserGroupMembers($request);

        /** @var UserGroupMember $element */
...
function callSample(): void
{
    ...
    list_user_group_members_sample($formattedParent);
}
