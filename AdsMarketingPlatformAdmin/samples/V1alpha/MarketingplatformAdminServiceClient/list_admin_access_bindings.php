 ...
 *
 * @param string $formattedParent The parent organization, which owns this collection of Admin
 ...
 */
function list_admin_access_bindings_sample(string $formattedParent): void
{
    // Create a client.
    $marketingplatformAdminServiceClient = new MarketingplatformAdminServiceClient();

    // Prepare the request message.
    $request = (new ListAdminAccessBindingsRequest())
        ->setParent($formattedParent);

    // Call the API and handle any network failures.
    try {
        /** @var PagedListResponse $response */
        $response = $marketingplatformAdminServiceClient->listAdminAccessBindings($request);

        /** @var AdminAccessBinding $element */
...
function callSample(): void
{
    ...
    list_admin_access_bindings_sample($formattedParent);
}
