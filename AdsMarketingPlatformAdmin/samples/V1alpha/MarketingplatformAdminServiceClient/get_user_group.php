 ...
 *
 * @param string $formattedName The name of the UserGroup to retrieve.
 ...
 */
function get_user_group_sample(string $formattedName): void
{
    // Create a client.
    $marketingplatformAdminServiceClient = new MarketingplatformAdminServiceClient();

    // Prepare the request message.
    $request = (new GetUserGroupRequest())
        ->setName($formattedName);

    // Call the API and handle any network failures.
    try {
        /** @var UserGroup $response */
        $response = $marketingplatformAdminServiceClient->getUserGroup($request);
...
function callSample(): void
{
    ...
    get_user_group_sample($formattedName);
}
