 ...
 *
 * @param string $formattedName The name of the user group member to retrieve.
 *                              Format:
 ...
 */
function get_user_group_member_sample(string $formattedName): void
{
    // Create a client.
    $marketingplatformAdminServiceClient = new MarketingplatformAdminServiceClient();

    // Prepare the request message.
    $request = (new GetUserGroupMemberRequest())
        ->setName($formattedName);

    // Call the API and handle any network failures.
    try {
        /** @var UserGroupMember $response */
        $response = $marketingplatformAdminServiceClient->getUserGroupMember($request);
...
function callSample(): void
{
    ...
    get_user_group_member_sample($formattedName);
}
