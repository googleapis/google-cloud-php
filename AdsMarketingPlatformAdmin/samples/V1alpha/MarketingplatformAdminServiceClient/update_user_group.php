...
// [START marketingplatformadmin_v1alpha_generated_MarketingplatformAdminService_UpdateUserGroup_sync]
 ...
 */
function update_user_group_sample(): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $marketingplatformAdminServiceClient->updateUserGroup($request);
        printf('Response data: %s' . PHP_EOL, $response->serializeToJsonString());
    } catch (ApiException $ex) {
        printf('Call failed with message: %s' . PHP_EOL, $ex->getMessage());
    }
}
// [END marketingplatformadmin_v1alpha_generated_MarketingplatformAdminService_UpdateUserGroup_sync]
