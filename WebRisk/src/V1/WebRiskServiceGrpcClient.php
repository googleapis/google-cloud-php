...
class WebRiskServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * allowlisted projects can use this method during Early Access. Please reach
     * out to Sales or your customer engineer to obtain access.
     * @param \Google\Cloud\WebRisk\V1\SubmitUriRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SubmitUri(\Google\Cloud\WebRisk\V1\SubmitUriRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.webrisk.v1.WebRiskService/SubmitUri',
        $argument,
