 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.GetIssueRequest</code>
 */
class GetIssueRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Name of the issue to retrieve.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\GetIssueRequest
     *
     * @experimental
     */
