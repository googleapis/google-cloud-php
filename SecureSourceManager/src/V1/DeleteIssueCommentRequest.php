 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.DeleteIssueCommentRequest</code>
 */
class DeleteIssueCommentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the issue comment to delete.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\DeleteIssueCommentRequest
     *
     * @experimental
     */
