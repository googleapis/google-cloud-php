 ...
 * cannot be deleted.
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.DeletePullRequestCommentRequest</code>
 */
class DeletePullRequestCommentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the pull request comment to delete.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\DeletePullRequestCommentRequest
     *
     * @experimental
     */
