 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.CloseIssueRequest</code>
 */
class CloseIssueRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the issue to close.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\CloseIssueRequest
     *
     * @experimental
     */
