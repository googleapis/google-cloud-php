 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.ListHooksResponse</code>
 */
class ListHooksResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * The list of hooks.
     *
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecureSourceManager\V1\Hook::class);
        $this->hooks = $arr;
