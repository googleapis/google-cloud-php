 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.OpenIssueRequest</code>
 */
class OpenIssueRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the issue to open.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\OpenIssueRequest
     *
     * @experimental
     */
