 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.ListPullRequestCommentsRequest</code>
 */
class ListPullRequestCommentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The pull request in which to list pull request comments. Format:
     *                       `projects/{project_number}/locations/{location_id}/repositories/{repository_id}/pullRequests/{pull_request_id}`
     *                       Please see {@see SecureSourceManagerClient::pullRequestName()} for help formatting this field.
     *
     * @return \Google\Cloud\SecureSourceManager\V1\ListPullRequestCommentsRequest
     *
     * @experimental
     */
