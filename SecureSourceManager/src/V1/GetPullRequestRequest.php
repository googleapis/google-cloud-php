 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.GetPullRequestRequest</code>
 */
class GetPullRequestRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the pull request to retrieve.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\GetPullRequestRequest
     *
     * @experimental
     */
