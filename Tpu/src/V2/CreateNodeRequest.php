 ...
 *
 * Generated from protobuf message <code>google.cloud.tpu.v2.CreateNodeRequest</code>
 */
class CreateNodeRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\Tpu\V2\Node $node   Required. The node.
     * @param string                    $nodeId The unqualified resource name.
     *
     * @return \Google\Cloud\Tpu\V2\CreateNodeRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Tpu\V2\Node $node, string $nodeId): self
    {
        return (new self())
            ->setParent($parent)
            ->setNode($node)
