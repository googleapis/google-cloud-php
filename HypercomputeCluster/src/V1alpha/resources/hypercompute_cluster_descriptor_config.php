...
return [
    'interfaces' => [
        'google.cloud.hypercomputecluster.v1alpha.HypercomputeCluster' => [
            'CreateCluster' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\HypercomputeCluster\V1alpha\Cluster',
                    'metadataReturnType' => '\Google\Cloud\HypercomputeCluster\V1alpha\OperationMetadata',
            ...
            'GetCluster' => [
                ...
                'responseType' => 'Google\Cloud\HypercomputeCluster\V1alpha\Cluster',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListClusters' => [
                ...
                'responseType' => 'Google\Cloud\HypercomputeCluster\V1alpha\ListClustersResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
