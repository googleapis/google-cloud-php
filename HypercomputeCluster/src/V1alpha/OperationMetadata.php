 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1alpha.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Hypercomputecluster\V1Alpha\OperationMetadata::initOnce();
