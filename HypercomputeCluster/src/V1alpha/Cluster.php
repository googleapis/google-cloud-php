 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1alpha.Cluster</code>
 */
class Cluster extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1alpha.NetworkResource> network_resources = 11 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1alpha.StorageResource> storage_resources = 12 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * (lower-case, alphanumeric, and at most 63 characters).
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1alpha.ComputeResource> compute_resources = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * on the cluster.
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $orchestrator = null;
    /**
     * Optional. Deprecated. Use network_resources instead.
     *
     * Generated from protobuf field <code>repeated .google.cloud.hypercomputecluster.v1alpha.Network networks = 5 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @deprecated
     */
    private $networks;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.hypercomputecluster.v1alpha.Storage storages = 6 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @deprecated
     */
    private $storages;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Compute compute = 7 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @deprecated
     */
     ...
     *           conform to [RFC-1034](https://datatracker.ietf.org/doc/html/rfc1034)
     *           (lower-case, alphanumeric, and at most 63 characters).
     *     @type \Google\Cloud\HypercomputeCluster\V1alpha\Orchestrator $orchestrator
     *           Optional. Orchestrator that is responsible for scheduling and running jobs
     *           on the cluster.
     *     @type array<\Google\Cloud\HypercomputeCluster\V1alpha\Network>|\Google\Protobuf\Internal\RepeatedField $networks
     *           Optional. Deprecated. Use network_resources instead.
     *     @type array<\Google\Cloud\HypercomputeCluster\V1alpha\Storage>|\Google\Protobuf\Internal\RepeatedField $storages
     *           Optional. Deprecated. Use storage_resources instead.
     *     @type \Google\Cloud\HypercomputeCluster\V1alpha\Compute $compute
     *           Optional. Deprecated. Use compute_resources instead.
     * }
     */
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1alpha\NetworkResource::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1alpha\StorageResource::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1alpha\ComputeResource::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1alpha\Orchestrator|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\HypercomputeCluster\V1alpha\Orchestrator $var
     * @return $this
     */
    public function setOrchestrator($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1alpha\Orchestrator::class);
    ...
    public function getNetworks()
    {
        if ($this->networks->count() !== 0) {
            @trigger_error('networks is deprecated.', E_USER_DEPRECATED);
        }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.hypercomputecluster.v1alpha.Network networks = 5 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @param array<\Google\Cloud\HypercomputeCluster\V1alpha\Network>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     * @deprecated
     */
    public function setNetworks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1alpha\Network::class);
        if ($arr->count() !== 0) {
            @trigger_error('networks is deprecated.', E_USER_DEPRECATED);
        }
        $this->networks = $arr;
    ...
    {
        if ($this->storages->count() !== 0) {
            @trigger_error('storages is deprecated.', E_USER_DEPRECATED);
        }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.hypercomputecluster.v1alpha.Storage storages = 6 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @param array<\Google\Cloud\HypercomputeCluster\V1alpha\Storage>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     * @deprecated
     */
    public function setStorages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1alpha\Storage::class);
        if ($arr->count() !== 0) {
            @trigger_error('storages is deprecated.', E_USER_DEPRECATED);
        }
        $this->storages = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Compute compute = 7 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1alpha\Compute|null
     * @deprecated
     */
    public function getCompute()
    {
        if (isset($this->compute)) {
            @trigger_error('compute is deprecated.', E_USER_DEPRECATED);
        }
        return $this->compute;
    }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1alpha.Compute compute = 7 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\HypercomputeCluster\V1alpha\Compute $var
     * @return $this
     * @deprecated
     */
    ...
    {
        @trigger_error('compute is deprecated.', E_USER_DEPRECATED);
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1alpha\Compute::class);
        $this->compute = $var;
