 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1alpha.BootDisk</code>
 */
class BootDisk extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string image = 3 [(.google.api.field_behavior) = OPTIONAL, (.google.api.field_behavior) = IMMUTABLE, (.google.api.resource_reference) = {</code>
     */
    protected $image = '';
    /**
     * Output only. The specific image that will be used for new VM instances.
     *
     * Generated from protobuf field <code>string effective_image = 4 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = {</code>
     */
    protected $effective_image = '';
     ...
     * @return string
     */
    public function getEffectiveImage()
    {
        return $this->effective_image;
    }
     ...
     * @return $this
     */
    public function setEffectiveImage($var)
    {
        GPBUtil::checkString($var, True);
        $this->effective_image = $var;
