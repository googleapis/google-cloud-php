...
namespace Google\Cloud\HypercomputeCluster\V1alpha\NewBucketConfig;
 ...
 *
 * Protobuf type <code>google.cloud.hypercomputecluster.v1alpha.NewBucketConfig.StorageClass</code>
 */
class StorageClass
{
    /**
