 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1.Cluster</code>
 */
class Cluster extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1.NetworkResource> network_resources = 11 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1.StorageResource> storage_resources = 12 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * (lower-case, alphanumeric, and at most 63 characters).
     *
     * Generated from protobuf field <code>map<string, .google.cloud.hypercomputecluster.v1.ComputeResource> compute_resources = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * on the cluster.
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           conform to [RFC-1034](https://datatracker.ietf.org/doc/html/rfc1034)
     *           (lower-case, alphanumeric, and at most 63 characters).
     *     @type \Google\Cloud\HypercomputeCluster\V1\Orchestrator $orchestrator
     *           Optional. Orchestrator that is responsible for scheduling and running jobs
     *           on the cluster.
     * }
     */
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1\NetworkResource::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1\StorageResource::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1\ComputeResource::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1\Orchestrator|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.Orchestrator orchestrator = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\HypercomputeCluster\V1\Orchestrator $var
     * @return $this
     */
    public function setOrchestrator($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1\Orchestrator::class);
