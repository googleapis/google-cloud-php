...
return [
    'interfaces' => [
        'google.cloud.hypercomputecluster.v1.HypercomputeCluster' => [
            'CreateCluster' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\HypercomputeCluster\V1\Cluster',
                    'metadataReturnType' => '\Google\Cloud\HypercomputeCluster\V1\OperationMetadata',
            ...
            'GetCluster' => [
                ...
                'responseType' => 'Google\Cloud\HypercomputeCluster\V1\Cluster',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListClusters' => [
                ...
                'responseType' => 'Google\Cloud\HypercomputeCluster\V1\ListClustersResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
