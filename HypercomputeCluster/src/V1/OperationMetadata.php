 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.OperationProgress progress = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. API version used to start the operation.
     *     @type \Google\Cloud\HypercomputeCluster\V1\OperationProgress $progress
     *           Output only. Progress of the operation.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.OperationProgress progress = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1\OperationProgress|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.OperationProgress progress = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\HypercomputeCluster\V1\OperationProgress $var
     * @return $this
     */
    public function setProgress($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1\OperationProgress::class);
        $this->progress = $var;
