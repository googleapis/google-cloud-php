 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1.SlurmNodeSet</code>
 */
class SlurmNodeSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.hypercomputecluster.v1.StorageConfig storage_configs = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Cloud\HypercomputeCluster\V1\ComputeInstanceSlurmNodeSet $compute_instance
     ...
     * Engine instances.
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.ComputeInstanceSlurmNodeSet compute_instance = 17 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1\ComputeInstanceSlurmNodeSet|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1.ComputeInstanceSlurmNodeSet compute_instance = 17 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\HypercomputeCluster\V1\ComputeInstanceSlurmNodeSet $var
     * @return $this
     */
    public function setComputeInstance($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1\ComputeInstanceSlurmNodeSet::class);
