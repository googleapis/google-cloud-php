 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1beta.ListClustersResponse</code>
 */
class ListClustersResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\HypercomputeCluster\V1beta\Cluster::class);
        $this->clusters = $arr;
