...
namespace Google\Cloud\HypercomputeCluster\Tests\Unit\V1beta\Client;
...
use Google\Cloud\HypercomputeCluster\V1beta\ListClustersResponse;
...
class HypercomputeClusterClientTest extends GeneratedTest
{
    ...
    public function getClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.hypercomputecluster.v1beta.HypercomputeCluster/GetCluster', $actualFuncCall);
    ...
    public function listClustersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.hypercomputecluster.v1beta.HypercomputeCluster/ListClusters', $actualFuncCall);
