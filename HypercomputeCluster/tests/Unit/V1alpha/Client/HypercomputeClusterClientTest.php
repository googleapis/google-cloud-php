...
use Google\Cloud\HypercomputeCluster\V1alpha\CreateClusterRequest;
...
use Google\Cloud\HypercomputeCluster\V1alpha\ListClustersResponse;
use Google\Cloud\HypercomputeCluster\V1alpha\UpdateClusterRequest;
...
class HypercomputeClusterClientTest extends GeneratedTest
{
    ...
    public function getClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.hypercomputecluster.v1alpha.HypercomputeCluster/GetCluster', $actualFuncCall);
