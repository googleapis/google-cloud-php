...
v1_library = gapic.php_library(
    ...
    artman_output_name='google-cloud-recaptchaenterprise-v1beta1')

s.copy(v1_library / f'src/')
s.copy(v1_library / f'proto/src/GPBMetadata/Google/Cloud/RecaptchaEnterprise', f'metadata')
s.copy(v1_library / f'proto/src/Google/Cloud/RecaptchaEnterprise', f'src')
