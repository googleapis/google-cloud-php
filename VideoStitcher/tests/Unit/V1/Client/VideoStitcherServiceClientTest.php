...
namespace Google\Cloud\Video\Stitcher\Tests\Unit\V1\Client;
...
class VideoStitcherServiceClientTest extends GeneratedTest
{
    ...
    public function createCdnKeyTest()
    {
        ...
        $response = $gapicClient->createCdnKey($request);
    ...
    public function createLiveConfigTest()
    {
        ...
        $response = $gapicClient->createLiveConfig($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    /** @test */
    public function createCdnKeyAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $request = (new CreateCdnKeyRequest())
            ...
            ->setCdnKey($cdnKey)
            ->setCdnKeyId($cdnKeyId);
        $response = $gapicClient->createCdnKeyAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
