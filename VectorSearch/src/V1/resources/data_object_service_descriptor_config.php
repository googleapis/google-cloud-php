    ...
    'interfaces' => [
        'google.cloud.vectorsearch.v1.DataObjectService' => [
            'BatchCreateDataObjects' => [
                ...
                'responseType' => 'Google\Cloud\VectorSearch\V1\BatchCreateDataObjectsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'BatchUpdateDataObjects' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\VectorSearch\V1\BatchUpdateDataObjectsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'CreateDataObject' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\VectorSearch\V1\DataObject',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
