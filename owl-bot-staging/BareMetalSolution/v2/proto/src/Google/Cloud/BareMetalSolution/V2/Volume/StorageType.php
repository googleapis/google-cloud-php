 ...
 *
 * Protobuf type <code>google.cloud.baremetalsolution.v2.Volume.StorageType</code>
 */
class StorageType
{
    /**
...
class_alias(StorageType::class, \Google\Cloud\BareMetalSolution\V2\Volume_StorageType::class);
