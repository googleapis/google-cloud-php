...
class BareMetalSolutionGapicClient
{
    ...
    private static function getInstanceConfigNameTemplate()
    {
        if (self::$instanceConfigNameTemplate == null) {
            self::$instanceConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/instanceConfigs/{instance_config}');
        }
    ...
    private static function getInterconnectAttachmentNameTemplate()
    {
        if (self::$interconnectAttachmentNameTemplate == null) {
            self::$interconnectAttachmentNameTemplate = new PathTemplate('projects/{project}/regions/{region}/interconnectAttachments/{interconnect_attachment}');
        }
    ...
    private static function getNFSShareNameTemplate()
    {
        if (self::$nFSShareNameTemplate == null) {
            self::$nFSShareNameTemplate = new PathTemplate('projects/{project}/locations/{location}/nfsShares/{nfs_share}');
        }
    ...
    private static function getNetworkConfigNameTemplate()
    {
        if (self::$networkConfigNameTemplate == null) {
            self::$networkConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/networkConfigs/{network_config}');
        }
    ...
    private static function getProvisioningConfigNameTemplate()
    {
        if (self::$provisioningConfigNameTemplate == null) {
            self::$provisioningConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/provisioningConfigs/{provisioning_config}');
        }
    ...
    private static function getServerNetworkTemplateNameTemplate()
    {
        if (self::$serverNetworkTemplateNameTemplate == null) {
            self::$serverNetworkTemplateNameTemplate = new PathTemplate('projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}');
        }
    ...
    private static function getSshKeyNameTemplate()
    {
        if (self::$sshKeyNameTemplate == null) {
            self::$sshKeyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sshKeys/{ssh_key}');
        }
    ...
    private static function getVolumeConfigNameTemplate()
    {
        if (self::$volumeConfigNameTemplate == null) {
            self::$volumeConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/volumeConfigs/{volume_config}');
        }
     ...
     */
    public static function instanceConfigName($project, $location, $instanceConfig)
    {
     ...
     */
    public static function interconnectAttachmentName($project, $region, $interconnectAttachment)
    {
     ...
     */
    public static function networkConfigName($project, $location, $networkConfig)
    {
     ...
     */
    public static function provisioningConfigName($project, $location, $provisioningConfig)
    {
     ...
     */
    public static function serverNetworkTemplateName($project, $location, $serverNetworkTemplate)
    {
    ...
    public function createNfsShare($parent, $nfsShare, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateNfsShare', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createProvisioningConfig($parent, $provisioningConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateProvisioningConfig', ProvisioningConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createSSHKey($parent, $sshKey, $sshKeyId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateSSHKey', SSHKey::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteNfsShare($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteNfsShare', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSSHKey($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteSSHKey', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function detachLun($instance, $lun, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DetachLun', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function disableInteractiveSerialConsole($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DisableInteractiveSerialConsole', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function enableInteractiveSerialConsole($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('EnableInteractiveSerialConsole', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function evictLun($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('EvictLun', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function evictVolume($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('EvictVolume', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getNfsShare($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNfsShare', NfsShare::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getProvisioningConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetProvisioningConfig', ProvisioningConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listNetworkUsage($location, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListNetworkUsage', ListNetworkUsageResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listNfsShares($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNfsShares', $optionalArgs, ListNfsSharesResponse::class, $request);
    }
    ...
    public function listOSImages($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListOSImages', $optionalArgs, ListOSImagesResponse::class, $request);
    }
    ...
    public function listProvisioningQuotas($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListProvisioningQuotas', $optionalArgs, ListProvisioningQuotasResponse::class, $request);
    }
    ...
    public function listSSHKeys($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSSHKeys', $optionalArgs, ListSSHKeysResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function renameInstance($name, $newInstanceId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RenameInstance', Instance::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function renameNetwork($name, $newNetworkId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RenameNetwork', Network::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function renameNfsShare($name, $newNfsshareId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RenameNfsShare', NfsShare::class, $optionalArgs, $request)->wait();
    }
    ...
    public function renameVolume($name, $newVolumeId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RenameVolume', Volume::class, $optionalArgs, $request)->wait();
    }
    ...
    public function resizeVolume($volume, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ResizeVolume', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function submitProvisioningConfig($parent, $provisioningConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SubmitProvisioningConfig', SubmitProvisioningConfigResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateNetwork($network, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateNetwork', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateNfsShare($nfsShare, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateNfsShare', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateProvisioningConfig($provisioningConfig, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateProvisioningConfigRequest();
        $requestParamHeaders = [];
        $request->setProvisioningConfig($provisioningConfig);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['provisioning_config.name'] = $provisioningConfig->getName();
        if (isset($optionalArgs['email'])) {
            $request->setEmail($optionalArgs['email']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateProvisioningConfig', ProvisioningConfig::class, $optionalArgs, $request)->wait();
    }
