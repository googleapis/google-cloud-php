 ...
 *
 * Generated from protobuf message <code>google.cloud.tasks.v2beta3.UriOverride</code>
 */
class UriOverride extends \Google\Protobuf\Internal\Message
{
     ...
     * or HTTPS).
     *
     * Generated from protobuf field <code>optional .google.cloud.tasks.v2beta3.UriOverride.Scheme scheme = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.PathOverride path_override = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.QueryOverride query_override = 5;</code>
     */
    protected $query_override = null;
    /**
     * URI Override Enforce Mode
     * When specified, determines the Target UriOverride mode. If not specified,
     * it defaults to ALWAYS.
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.UriOverride.UriOverrideEnforceMode uri_override_enforce_mode = 6;</code>
     */
    protected $uri_override_enforce_mode = 0;
     ...
     *           becomes http://www.google.com:123/foo. Note that the port value must be a
     *           positive integer. Setting the port to 0 (Zero) clears the URI port.
     *     @type \Google\Cloud\Tasks\V2beta3\PathOverride $path_override
     *           URI path.
     *           When specified, replaces the existing path of the task URL. Setting the
     *           path value to an empty string clears the URI path segment.
     *     @type \Google\Cloud\Tasks\V2beta3\QueryOverride $query_override
     *           URI Query.
     *           When specified, replaces the query part of the task URI. Setting the
     *           query value to an empty string clears the URI query segment.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Tasks\V2beta3\UriOverride\Scheme::class);
        $this->scheme = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.PathOverride path_override = 4;</code>
     * @return \Google\Cloud\Tasks\V2beta3\PathOverride|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.PathOverride path_override = 4;</code>
     * @param \Google\Cloud\Tasks\V2beta3\PathOverride $var
     * @return $this
     */
    public function setPathOverride($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2beta3\PathOverride::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.QueryOverride query_override = 5;</code>
     * @return \Google\Cloud\Tasks\V2beta3\QueryOverride|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta3.QueryOverride query_override = 5;</code>
     * @param \Google\Cloud\Tasks\V2beta3\QueryOverride $var
     * @return $this
     */
    public function setQueryOverride($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2beta3\QueryOverride::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Tasks\V2beta3\UriOverride\UriOverrideEnforceMode::class);
