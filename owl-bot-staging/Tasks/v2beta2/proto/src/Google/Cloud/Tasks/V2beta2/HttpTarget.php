 ...
 *
 * Generated from protobuf message <code>google.cloud.tasks.v2beta2.HttpTarget</code>
 */
class HttpTarget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.UriOverride uri_override = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.HttpMethod http_method = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.tasks.v2beta2.HttpTarget.HeaderOverride header_overrides = 3;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Tasks\V2beta2\UriOverride $uri_override
     *           Uri override.
     *           When specified, overrides the execution Uri for all the tasks in the queue.
     ...
     *           task. Note that if the value is set to [HttpMethod][GET] the
     *           [HttpRequest][body] of the task will be ignored at execution time.
     *     @type array<\Google\Cloud\Tasks\V2beta2\HttpTarget\HeaderOverride>|\Google\Protobuf\Internal\RepeatedField $header_overrides
     *           HTTP target headers.
     *           This map contains the header field names and values.
     *           Headers will be set when running the
     *           [task is created][google.cloud.tasks.v2beta2.CloudTasks.CreateTask] and/or
     ...
     *           The size of the headers must be less than 80KB.
     *           Queue-level headers to override headers of all the tasks in the queue.
     *     @type \Google\Cloud\Tasks\V2beta2\OAuthToken $oauth_token
     *           If specified, an
     ...
     *     @type \Google\Cloud\Tasks\V2beta2\OidcToken $oidc_token
     *           If specified, an
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.UriOverride uri_override = 1;</code>
     * @return \Google\Cloud\Tasks\V2beta2\UriOverride|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.UriOverride uri_override = 1;</code>
     * @param \Google\Cloud\Tasks\V2beta2\UriOverride $var
     * @return $this
     */
    public function setUriOverride($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2beta2\UriOverride::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.tasks.v2beta2.HttpTarget.HeaderOverride header_overrides = 3;</code>
     * @param array<\Google\Cloud\Tasks\V2beta2\HttpTarget\HeaderOverride>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setHeaderOverrides($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Tasks\V2beta2\HttpTarget\HeaderOverride::class);
     ...
     * Google APIs hosted on *.googleapis.com.
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.OAuthToken oauth_token = 5;</code>
     * @return \Google\Cloud\Tasks\V2beta2\OAuthToken|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.OAuthToken oauth_token = 5;</code>
     * @param \Google\Cloud\Tasks\V2beta2\OAuthToken $var
     * @return $this
     */
    public function setOauthToken($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2beta2\OAuthToken::class);
     ...
     * yourself.
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.OidcToken oidc_token = 6;</code>
     * @return \Google\Cloud\Tasks\V2beta2\OidcToken|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.tasks.v2beta2.OidcToken oidc_token = 6;</code>
     * @param \Google\Cloud\Tasks\V2beta2\OidcToken $var
     * @return $this
     */
    public function setOidcToken($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Tasks\V2beta2\OidcToken::class);
