 ...
 * project.
 *
 * Generated from protobuf message <code>google.storage.control.v2.GetIntelligenceFindingRequest</code>
 */
class GetIntelligenceFindingRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the `IntelligenceFinding` resource.
     *
     *                     Format:
     *                     `projects/{project}/locations/{location}/intelligenceFindings/{intelligence_finding}`
     *                     Please see {@see StorageControlClient::intelligenceFindingName()} for help formatting this field.
     *
     * @return \Google\Cloud\Storage\Control\V2\GetIntelligenceFindingRequest
     *
     * @experimental
     */
