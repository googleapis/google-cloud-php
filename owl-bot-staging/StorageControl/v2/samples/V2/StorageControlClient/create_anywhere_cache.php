 ...
 * @param string $anywhereCacheId System generated Anywhere Cache ID.
 */
function create_anywhere_cache_sample(string $formattedParent, string $anywhereCacheId): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    create_anywhere_cache_sample($formattedParent, $anywhereCacheId);
}
