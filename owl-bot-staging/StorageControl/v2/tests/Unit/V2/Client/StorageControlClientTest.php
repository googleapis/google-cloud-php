...
class StorageControlClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function deleteFolderRecursiveTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteFolderRecursiveTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteFolderRecursiveTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $request = (new DeleteFolderRecursiveRequest())
            ->setName($formattedName);
        $response = $gapicClient->deleteFolderRecursive($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/DeleteFolderRecursive', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deleteFolderRecursiveTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function deleteFolderRecursiveExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function getFolderIntelligenceConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $name2 = 'name2-1052831874';
        $expectedResponse = new IntelligenceConfig();
        $expectedResponse->setName($name2);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->intelligenceConfigName('[FOLDER]', '[LOCATION]');
        $request = (new GetFolderIntelligenceConfigRequest())
            ->setName($formattedName);
        $response = $gapicClient->getFolderIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/GetFolderIntelligenceConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getFolderIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetFolderIntelligenceConfigRequest())
            ->setName($formattedName);
        try {
            $gapicClient->getFolderIntelligenceConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/GetIamPolicy', $actualFuncCall);
    ...
    public function getIntelligenceFindingRevisionTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->intelligenceFindingRevisionName('[PROJECT]', '[LOCATION]', '[INTELLIGENCE_FINDING]', '[REVISION]');
    ...
    /** @test */
    public function getOrganizationIntelligenceConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetOrganizationIntelligenceConfigRequest())
            ->setName($formattedName);
        $response = $gapicClient->getOrganizationIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/GetOrganizationIntelligenceConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getOrganizationIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetOrganizationIntelligenceConfigRequest())
            ->setName($formattedName);
        try {
            $gapicClient->getOrganizationIntelligenceConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function getProjectIntelligenceConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetProjectIntelligenceConfigRequest())
            ->setName($formattedName);
        $response = $gapicClient->getProjectIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    /** @test */
    public function getProjectIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function listIntelligenceFindingRevisionsTest()
    {
        ...
        $intelligenceFindingRevisions = [
            $intelligenceFindingRevisionsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/ListIntelligenceFindingRevisions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/SetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function summarizeIntelligenceFindingsTest()
    {
        ...
        $request = (new SummarizeIntelligenceFindingsRequest())
            ->setParent($parent);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    /** @test */
    public function updateFolderIntelligenceConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateFolderIntelligenceConfigRequest())
            ...
            ->setUpdateMask($updateMask);
        $response = $gapicClient->updateFolderIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/UpdateFolderIntelligenceConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getIntelligenceConfig();
        $this->assertProtobufEquals($intelligenceConfig, $actualValue);
    ...
    /** @test */
    public function updateFolderIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateFolderIntelligenceConfigRequest())
            ...
            ->setUpdateMask($updateMask);
        try {
            $gapicClient->updateFolderIntelligenceConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateOrganizationIntelligenceConfigTest()
    {
        ...
        $request = (new UpdateOrganizationIntelligenceConfigRequest())
            ->setIntelligenceConfig($intelligenceConfig)
            ->setUpdateMask($updateMask);
        $response = $gapicClient->updateOrganizationIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/UpdateOrganizationIntelligenceConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getIntelligenceConfig();
        $this->assertProtobufEquals($intelligenceConfig, $actualValue);
        $actualValue = $actualRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
    ...
    /** @test */
    public function updateOrganizationIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateOrganizationIntelligenceConfigRequest())
            ...
            ->setUpdateMask($updateMask);
        try {
            $gapicClient->updateOrganizationIntelligenceConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function updateProjectIntelligenceConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateProjectIntelligenceConfigRequest())
            ->setIntelligenceConfig($intelligenceConfig)
            ->setUpdateMask($updateMask);
        $response = $gapicClient->updateProjectIntelligenceConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.storage.control.v2.StorageControl/UpdateProjectIntelligenceConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getIntelligenceConfig();
        $this->assertProtobufEquals($intelligenceConfig, $actualValue);
        $actualValue = $actualRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
    ...
    /** @test */
    public function updateProjectIntelligenceConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateProjectIntelligenceConfigRequest())
            ...
            ->setUpdateMask($updateMask);
        try {
            $gapicClient->updateProjectIntelligenceConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
