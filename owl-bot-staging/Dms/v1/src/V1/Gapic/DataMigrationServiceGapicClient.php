...
class DataMigrationServiceGapicClient
{
     ...
     *     $pagedResponse = $dataMigrationServiceClient->describeDatabaseEntities($formattedConversionWorkspace, $tree);
     ...
     *                                    projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
     * @param int    $tree                Required. The tree to fetch.
     ...
     * @throws ApiException if the remote call fails
     */
    public function describeDatabaseEntities($conversionWorkspace, $tree, array $optionalArgs = [])
    {
