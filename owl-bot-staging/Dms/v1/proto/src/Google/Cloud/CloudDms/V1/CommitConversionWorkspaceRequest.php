 ...
 *
 * Generated from protobuf message <code>google.cloud.clouddms.v1.CommitConversionWorkspaceRequest</code>
 */
class CommitConversionWorkspaceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @return $this
     */
    public function setCommitName($var)
    {
        GPBUtil::checkString($var, True);
        $this->commit_name = $var;
