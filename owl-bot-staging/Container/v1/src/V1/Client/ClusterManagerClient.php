...
final class ClusterManagerClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function completeControlPlaneUpgrade(CompleteControlPlaneUpgradeRequest $request, array $callOptions = []): Operation
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function fetchClusterUpgradeInfo(FetchClusterUpgradeInfoRequest $request, array $callOptions = []): ClusterUpgradeInfo
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function fetchNodePoolUpgradeInfo(FetchNodePoolUpgradeInfoRequest $request, array $callOptions = []): NodePoolUpgradeInfo
    {
