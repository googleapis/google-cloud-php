...
namespace Google\Cloud\Kms\Inventory\V1\Client\BaseClient;
 ...
 */
abstract class KeyTrackingServiceBaseClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/key_tracking_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/key_tracking_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../../resources/key_tracking_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/key_tracking_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * }
     *
     * @return ProtectedResourcesSummary
     *
