 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/kms/inventory/v1/key_dashboard_service.proto
 ...
 *     }
 * } finally {
 *     $keyDashboardServiceClient->close();
 * }
 * ```
 *
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Kms\Inventory\V1\Client\KeyDashboardServiceClient}.
 */
class KeyDashboardServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.kms.inventory.v1.KeyDashboardService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/key_dashboard_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/key_dashboard_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/key_dashboard_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/key_dashboard_service_rest_client_config.php',
                ],
            ],
        ];
    }
