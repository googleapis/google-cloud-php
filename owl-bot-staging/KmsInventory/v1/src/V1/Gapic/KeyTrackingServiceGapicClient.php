...
class KeyTrackingServiceGapicClient
{
    ...
    {
        if (self::$projectLocationKeyRingCryptoKeyCryptoKeyVersionProtectedResourcesSummaryNameTemplate == null) {
            self::$projectLocationKeyRingCryptoKeyCryptoKeyVersionProtectedResourcesSummaryNameTemplate = new PathTemplate('projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/protectedResourcesSummary');
        }
    ...
    {
        if (self::$projectLocationKeyRingCryptoKeyProtectedResourcesSummaryNameTemplate == null) {
            self::$projectLocationKeyRingCryptoKeyProtectedResourcesSummaryNameTemplate = new PathTemplate('projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary');
        }
    ...
    private static function getProtectedResourcesSummaryNameTemplate()
    {
        if (self::$protectedResourcesSummaryNameTemplate == null) {
            self::$protectedResourcesSummaryNameTemplate = new PathTemplate('projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary');
        }
     ...
     */
    public static function projectLocationKeyRingCryptoKeyCryptoKeyVersionProtectedResourcesSummaryName($project, $location, $keyRing, $cryptoKey, $cryptoKeyVersion)
    {
     ...
     */
    public static function projectLocationKeyRingCryptoKeyProtectedResourcesSummaryName($project, $location, $keyRing, $cryptoKey)
    {
     ...
     */
    public static function protectedResourcesSummaryName($project, $location, $keyRing, $cryptoKey)
    {
     ...
     */
    public function getProtectedResourcesSummary($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetProtectedResourcesSummary', ProtectedResourcesSummary::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchProtectedResources($scope, $cryptoKey, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('SearchProtectedResources', $optionalArgs, SearchProtectedResourcesResponse::class, $request);
    }
}
