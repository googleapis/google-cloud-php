...
class UserListDirectLicenseServiceClientTest extends GeneratedTest
{
    ...
    public function createUserListDirectLicenseTest()
    {
        ...
        $this->assertSame('/google.ads.datamanager.v1.UserListDirectLicenseService/CreateUserListDirectLicense', $actualFuncCall);
    ...
    public function getUserListDirectLicenseTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->userListDirectLicenseName('[ACCOUNT_TYPE]', '[ACCOUNT]', '[USER_LIST_DIRECT_LICENSE]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.datamanager.v1.UserListDirectLicenseService/GetUserListDirectLicense', $actualFuncCall);
    ...
    public function listUserListDirectLicensesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.datamanager.v1.UserListDirectLicenseService/ListUserListDirectLicenses', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateUserListDirectLicenseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.datamanager.v1.UserListDirectLicenseService/UpdateUserListDirectLicense', $actualFuncCall);
        $actualValue = $actualRequestObject->getUserListDirectLicense();
        $this->assertProtobufEquals($userListDirectLicense, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
