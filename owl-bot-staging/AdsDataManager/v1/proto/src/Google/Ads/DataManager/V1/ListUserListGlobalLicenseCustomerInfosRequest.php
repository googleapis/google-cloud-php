 ...
 *
 * Generated from protobuf message <code>google.ads.datamanager.v1.ListUserListGlobalLicenseCustomerInfosRequest</code>
 */
class ListUserListGlobalLicenseCustomerInfosRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The global license whose customer info are being queried. Should
     *                       be in the format
     *                       `accountTypes/{ACCOUNT_TYPE}/accounts/{ACCOUNT_ID}/userListGlobalLicenses/{USER_LIST_GLOBAL_LICENSE_ID}`.
     *                       To list all global license customer info under an account, replace the user
     *                       list global license id with a '-' (for example,
     ...
     *
     * @return \Google\Ads\DataManager\V1\ListUserListGlobalLicenseCustomerInfosRequest
     *
     * @experimental
     */
