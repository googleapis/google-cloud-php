...
class DocumentProcessorServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\DocumentAI\V1\GetProcessorTypeRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetProcessorType(\Google\Cloud\DocumentAI\V1\GetProcessorTypeRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.documentai.v1.DocumentProcessorService/GetProcessorType',
        $argument,
        ['\Google\Cloud\DocumentAI\V1\ProcessorType', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Cloud\DocumentAI\V1\TrainProcessorVersionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function TrainProcessorVersion(\Google\Cloud\DocumentAI\V1\TrainProcessorVersionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.documentai.v1.DocumentProcessorService/TrainProcessorVersion',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
     ...
     * Evaluation.
     * @param \Google\Cloud\DocumentAI\V1\EvaluateProcessorVersionRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function EvaluateProcessorVersion(\Google\Cloud\DocumentAI\V1\EvaluateProcessorVersionRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.documentai.v1.DocumentProcessorService/EvaluateProcessorVersion',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Cloud\DocumentAI\V1\GetEvaluationRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetEvaluation(\Google\Cloud\DocumentAI\V1\GetEvaluationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.documentai.v1.DocumentProcessorService/GetEvaluation',
        $argument,
        ['\Google\Cloud\DocumentAI\V1\Evaluation', 'decode'],
        $metadata, $options);
    }

    /**
     * Retrieves a set of evaluations for a given processor version.
     * @param \Google\Cloud\DocumentAI\V1\ListEvaluationsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListEvaluations(\Google\Cloud\DocumentAI\V1\ListEvaluationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.documentai.v1.DocumentProcessorService/ListEvaluations',
        $argument,
        ['\Google\Cloud\DocumentAI\V1\ListEvaluationsResponse', 'decode'],
        $metadata, $options);
    }
