...
class PublicCertificateAuthorityServiceGapicClient
{
    ...
    private static function getExternalAccountKeyNameTemplate()
    {
        if (self::$externalAccountKeyNameTemplate == null) {
            self::$externalAccountKeyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/externalAccountKeys/{external_account_key}');
        }
     ...
     * @experimental
     */
    public static function externalAccountKeyName($project, $location, $externalAccountKey)
    {
     ...
     * @experimental
     */
    public function createExternalAccountKey($parent, $externalAccountKey, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateExternalAccountKey', ExternalAccountKey::class, $optionalArgs, $request)->wait();
    }
}
