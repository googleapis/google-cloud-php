 ...
 * \Google\Cloud\ApigeeRegistry\V1\Client\RegistryClient} to use the new surface.
 */
class RegistryGapicClient
{
    ...
    private static function getApiNameTemplate()
    {
        if (self::$apiNameTemplate == null) {
            self::$apiNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}');
        }
    ...
    private static function getApiDeploymentNameTemplate()
    {
        if (self::$apiDeploymentNameTemplate == null) {
            self::$apiDeploymentNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/deployments/{deployment}');
        }
    ...
    private static function getApiSpecNameTemplate()
    {
        if (self::$apiSpecNameTemplate == null) {
            self::$apiSpecNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}');
        }
    ...
    private static function getApiVersionNameTemplate()
    {
        if (self::$apiVersionNameTemplate == null) {
            self::$apiVersionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/versions/{version}');
        }
    ...
    private static function getArtifactNameTemplate()
    {
        if (self::$artifactNameTemplate == null) {
            self::$artifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/artifacts/{artifact}');
        }
    ...
    private static function getProjectLocationApiArtifactNameTemplate()
    {
        if (self::$projectLocationApiArtifactNameTemplate == null) {
            self::$projectLocationApiArtifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/artifacts/{artifact}');
        }
    ...
    private static function getProjectLocationApiDeploymentArtifactNameTemplate()
    {
        if (self::$projectLocationApiDeploymentArtifactNameTemplate == null) {
            self::$projectLocationApiDeploymentArtifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/deployments/{deployment}/artifacts/{artifact}');
        }
    ...
    private static function getProjectLocationApiVersionArtifactNameTemplate()
    {
        if (self::$projectLocationApiVersionArtifactNameTemplate == null) {
            self::$projectLocationApiVersionArtifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/versions/{version}/artifacts/{artifact}');
        }
    ...
    private static function getProjectLocationApiVersionSpecArtifactNameTemplate()
    {
        if (self::$projectLocationApiVersionSpecArtifactNameTemplate == null) {
            self::$projectLocationApiVersionSpecArtifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}/artifacts/{artifact}');
        }
    ...
    private static function getProjectLocationArtifactNameTemplate()
    {
        if (self::$projectLocationArtifactNameTemplate == null) {
            self::$projectLocationArtifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/artifacts/{artifact}');
        }
     ...
     */
    public static function apiDeploymentName($project, $location, $api, $deployment)
    {
     ...
     */
    public static function apiSpecName($project, $location, $api, $version, $spec)
    {
     ...
     */
    public static function projectLocationApiArtifactName($project, $location, $api, $artifact)
    {
     ...
     */
    public static function projectLocationApiDeploymentArtifactName($project, $location, $api, $deployment, $artifact)
    {
     ...
     */
    public static function projectLocationApiVersionArtifactName($project, $location, $api, $version, $artifact)
    {
     ...
     */
    public static function projectLocationApiVersionSpecArtifactName($project, $location, $api, $version, $spec, $artifact)
    {
     ...
     */
    public static function projectLocationArtifactName($project, $location, $artifact)
    {
    ...
    public function createApi($parent, $api, $apiId, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateApi', Api::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createApiDeployment($parent, $apiDeployment, $apiDeploymentId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateApiDeployment', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createApiSpec($parent, $apiSpec, $apiSpecId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateApiSpec', ApiSpec::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createApiVersion($parent, $apiVersion, $apiVersionId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateApiVersion', ApiVersion::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createArtifact($parent, $artifact, $artifactId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateArtifact', Artifact::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApi($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApi', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApiDeployment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApiDeployment', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApiDeploymentRevision($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApiDeploymentRevision', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApiSpec($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApiSpec', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApiSpecRevision($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApiSpecRevision', ApiSpec::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteApiVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteApiVersion', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteArtifact($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteArtifact', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getApiDeployment($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetApiDeployment', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getApiSpec($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetApiSpec', ApiSpec::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getApiSpecContents($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetApiSpecContents', HttpBody::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getApiVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetApiVersion', ApiVersion::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getArtifact($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetArtifact', Artifact::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getArtifactContents($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetArtifactContents', HttpBody::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listApiDeploymentRevisions($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListApiDeploymentRevisions', $optionalArgs, ListApiDeploymentRevisionsResponse::class, $request);
    }
    ...
    public function listApiDeployments($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListApiDeployments', $optionalArgs, ListApiDeploymentsResponse::class, $request);
    }
    ...
    public function listApiSpecRevisions($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListApiSpecRevisions', $optionalArgs, ListApiSpecRevisionsResponse::class, $request);
    }
    ...
    public function listApiSpecs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListApiSpecs', $optionalArgs, ListApiSpecsResponse::class, $request);
    }
    ...
    public function listApiVersions($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListApiVersions', $optionalArgs, ListApiVersionsResponse::class, $request);
    }
    ...
    public function listArtifacts($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListArtifacts', $optionalArgs, ListArtifactsResponse::class, $request);
    }
    ...
    public function replaceArtifact($artifact, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ReplaceArtifact', Artifact::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function rollbackApiDeployment($name, $revisionId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RollbackApiDeployment', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function rollbackApiSpec($name, $revisionId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RollbackApiSpec', ApiSpec::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function tagApiDeploymentRevision($name, $tag, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('TagApiDeploymentRevision', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function tagApiSpecRevision($name, $tag, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('TagApiSpecRevision', ApiSpec::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateApi($api, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateApi', Api::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateApiDeployment($apiDeployment, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateApiDeployment', ApiDeployment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateApiSpec($apiSpec, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateApiSpec', ApiSpec::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateApiVersion($apiVersion, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateApiVersion', ApiVersion::class, $optionalArgs, $request)->wait();
    }
