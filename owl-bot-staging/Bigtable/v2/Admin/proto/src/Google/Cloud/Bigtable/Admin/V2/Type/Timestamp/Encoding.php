 ...
 *
 * Generated from protobuf message <code>google.bigtable.admin.v2.Type.Timestamp.Encoding</code>
 */
class Encoding extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Bigtable\Admin\V2\Type\Int64\Encoding $unix_micros_int64
     ...
     *  - Java `Instant.truncatedTo()` with `ChronoUnit.MICROS`
     *
     * Generated from protobuf field <code>.google.bigtable.admin.v2.Type.Int64.Encoding unix_micros_int64 = 1;</code>
