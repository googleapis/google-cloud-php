 ...
 *
 * Generated from protobuf message <code>google.bigtable.admin.v2.GetMaterializedViewRequest</code>
 */
class GetMaterializedViewRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The unique name of the requested materialized view. Values are of
     *                     the form
     ...
     *
     * @return \Google\Cloud\Bigtable\Admin\V2\GetMaterializedViewRequest
     *
     * @experimental
     */
