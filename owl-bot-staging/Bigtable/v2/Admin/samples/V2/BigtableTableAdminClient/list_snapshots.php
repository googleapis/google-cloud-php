 ...
 * policy.
 *
 * @param string $formattedParent The unique name of the cluster for which snapshots should be listed.
...
function list_snapshots_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $bigtableTableAdminClient->listSnapshots($formattedParent);
