 ...
 * enabled.
 *
 * @param string $formattedParent The unique name of the instance in which to create the new cluster.
...
function create_cluster_sample(string $formattedParent, string $clusterId): void
{
    ...
    try {
        ...
        $response = $bigtableInstanceAdminClient->createCluster($formattedParent, $clusterId, $cluster);
