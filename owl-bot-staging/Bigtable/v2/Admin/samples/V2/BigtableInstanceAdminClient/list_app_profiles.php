 ...
 *
 * @param string $formattedParent The unique name of the instance for which a list of app profiles is
...
function list_app_profiles_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $bigtableInstanceAdminClient->listAppProfiles($formattedParent);
