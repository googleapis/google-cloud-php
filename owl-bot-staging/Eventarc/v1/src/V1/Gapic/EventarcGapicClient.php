...
class EventarcGapicClient
{
    ...
    private static function getChannelConnectionNameTemplate()
    {
        if (self::$channelConnectionNameTemplate == null) {
            self::$channelConnectionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/channelConnections/{channel_connection}');
        }
    ...
    private static function getGoogleChannelConfigNameTemplate()
    {
        if (self::$googleChannelConfigNameTemplate == null) {
            self::$googleChannelConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/googleChannelConfig');
        }
    ...
    private static function getProviderNameTemplate()
    {
        if (self::$providerNameTemplate == null) {
            self::$providerNameTemplate = new PathTemplate('projects/{project}/locations/{location}/providers/{provider}');
        }
     ...
     */
    public static function channelConnectionName($project, $location, $channelConnection)
    {
     ...
     */
    public function createChannel($parent, $channel, $channelId, $validateOnly, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createChannelConnection($parent, $channelConnection, $channelConnectionId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateChannelConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteChannel($name, $validateOnly, array $optionalArgs = [])
    {
    ...
    public function deleteChannelConnection($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteChannelConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getChannelConnection($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetChannelConnection', ChannelConnection::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getGoogleChannelConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetGoogleChannelConfig', GoogleChannelConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getProvider($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetProvider', Provider::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listChannelConnections($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListChannelConnections', $optionalArgs, ListChannelConnectionsResponse::class, $request);
    }
    ...
    public function listProviders($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListProviders', $optionalArgs, ListProvidersResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateGoogleChannelConfig($googleChannelConfig, array $optionalArgs = [])
    {
        $request = new UpdateGoogleChannelConfigRequest();
        $requestParamHeaders = [];
        $request->setGoogleChannelConfig($googleChannelConfig);
        $requestParamHeaders['google_channel_config.name'] = $googleChannelConfig->getName();
        if (isset($optionalArgs['updateMask'])) {
            $request->setUpdateMask($optionalArgs['updateMask']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateGoogleChannelConfig', GoogleChannelConfig::class, $optionalArgs, $request)->wait();
    }
