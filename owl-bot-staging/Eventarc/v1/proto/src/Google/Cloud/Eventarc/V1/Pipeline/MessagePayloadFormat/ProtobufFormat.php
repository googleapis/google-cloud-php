 ...
 *
 * Generated from protobuf message <code>google.cloud.eventarc.v1.Pipeline.MessagePayloadFormat.ProtobufFormat</code>
 */
...
class_alias(ProtobufFormat::class, \Google\Cloud\Eventarc\V1\Pipeline_MessagePayloadFormat_ProtobufFormat::class);
