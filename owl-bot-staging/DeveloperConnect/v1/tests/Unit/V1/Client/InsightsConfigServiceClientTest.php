 ...
 * @group gapic
 */
class InsightsConfigServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new InsightsConfigServiceClient($options);
    }

    /** @test */
    public function createInsightsConfigTest()
    {
        ...
        $incompleteOperation->setName('operations/createInsightsConfigTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $appHubApplication = 'appHubApplication772644584';
        $name = 'name3373707';
        $reconciling = false;
        $expectedResponse = new InsightsConfig();
        $expectedResponse->setAppHubApplication($appHubApplication);
        $expectedResponse->setName($name);
        $expectedResponse->setReconciling($reconciling);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/createInsightsConfigTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $insightsConfigId = 'insightsConfigId341339092';
        ...
        $response = $gapicClient->createInsightsConfig($request);
        ...
        $this->assertProtobufEquals($insightsConfigId, $actualValue);
        $actualValue = $actualApiRequestObject->getInsightsConfig();
        $this->assertProtobufEquals($insightsConfig, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/createInsightsConfigTest');
    ...
    /** @test */
    public function createInsightsConfigExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function deleteInsightsConfigTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteInsightsConfigTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteInsightsConfigTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deleteInsightsConfigTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function deleteInsightsConfigExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    public function getDeploymentEventTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->deploymentEventName('[PROJECT]', '[LOCATION]', '[INSIGHTS_CONFIG]', '[DEPLOYMENT_EVENT]');
        ...
        $this->assertSame('/google.cloud.developerconnect.v1.InsightsConfigService/GetDeploymentEvent', $actualFuncCall);
    ...
    public function getInsightsConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.developerconnect.v1.InsightsConfigService/GetInsightsConfig', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getInsightsConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function listDeploymentEventsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.developerconnect.v1.InsightsConfigService/ListDeploymentEvents', $actualFuncCall);
    ...
    /** @test */
    public function listInsightsConfigsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getInsightsConfigs()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listInsightsConfigsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function updateInsightsConfigTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateInsightsConfigTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $appHubApplication = 'appHubApplication772644584';
        $name = 'name3373707';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateInsightsConfigTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $this->assertProtobufEquals($insightsConfig, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/updateInsightsConfigTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function updateInsightsConfigExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function createInsightsConfigAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $request = (new CreateInsightsConfigRequest())
            ...
            ->setInsightsConfigId($insightsConfigId)
            ->setInsightsConfig($insightsConfig);
        $response = $gapicClient->createInsightsConfigAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
