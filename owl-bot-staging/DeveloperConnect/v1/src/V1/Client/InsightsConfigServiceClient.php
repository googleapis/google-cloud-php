...
final class InsightsConfigServiceClient
{
     ...
     */
    public static function deploymentEventName(string $project, string $location, string $insightsConfig, string $deploymentEvent): string
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listDeploymentEvents(ListDeploymentEventsRequest $request, array $callOptions = []): PagedListResponse
    {
