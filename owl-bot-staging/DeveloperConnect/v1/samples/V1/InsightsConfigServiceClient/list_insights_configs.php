 ...
 *
 * @param string $formattedParent Parent value for ListInsightsConfigsRequest. Please see
 *                                {@see InsightsConfigServiceClient::locationName()} for help formatting this field.
 */
function list_insights_configs_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $insightsConfigServiceClient->listInsightsConfigs($request);

        /** @var InsightsConfig $element */
...
function callSample(): void
{
    ...
    list_insights_configs_sample($formattedParent);
}
