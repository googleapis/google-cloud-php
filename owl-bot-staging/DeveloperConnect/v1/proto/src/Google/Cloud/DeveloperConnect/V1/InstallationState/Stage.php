...
namespace Google\Cloud\DeveloperConnect\V1\InstallationState;
 ...
 *
 * Protobuf type <code>google.cloud.developerconnect.v1.InstallationState.Stage</code>
 */
class Stage
{
    /**
...
class_alias(Stage::class, \Google\Cloud\DeveloperConnect\V1\InstallationState_Stage::class);
