 ...
 *
 * Generated from protobuf message <code>google.cloud.developerconnect.v1.DeleteInsightsConfigRequest</code>
 */
class DeleteInsightsConfigRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Value for parent. Please see
     *                     {@see InsightsConfigServiceClient::insightsConfigName()} for help formatting this field.
     *
     * @return \Google\Cloud\DeveloperConnect\V1\DeleteInsightsConfigRequest
     *
     * @experimental
     */
