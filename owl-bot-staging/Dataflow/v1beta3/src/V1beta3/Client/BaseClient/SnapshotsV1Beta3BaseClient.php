 ...
 */
abstract class SnapshotsV1Beta3BaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.dataflow.v1beta3.SnapshotsV1Beta3';
     ...
     * @experimental
     */
    public function deleteSnapshot(DeleteSnapshotRequest $request, array $callOptions = []): DeleteSnapshotResponse
    {
     ...
     * @experimental
     */
    public function listSnapshots(ListSnapshotsRequest $request, array $callOptions = []): ListSnapshotsResponse
    {
        return $this->startApiCall('ListSnapshots', $request, $callOptions)->wait();
    }
}
