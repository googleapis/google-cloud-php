...
namespace Google\Cloud\Dataflow\V1beta3\Client\BaseClient;
 ...
 */
abstract class TemplatesServiceBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.dataflow.v1beta3.TemplatesService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/templates_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/templates_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../../resources/templates_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/templates_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @experimental
     */
    public function createJobFromTemplate(CreateJobFromTemplateRequest $request, array $callOptions = []): Job
    {
        return $this->startApiCall('CreateJobFromTemplate', $request, $callOptions)->wait();
    }
     ...
     * @experimental
     */
    public function getTemplate(GetTemplateRequest $request, array $callOptions = []): GetTemplateResponse
    {
     ...
     * @experimental
     */
    public function launchTemplate(LaunchTemplateRequest $request, array $callOptions = []): LaunchTemplateResponse
    {
        return $this->startApiCall('LaunchTemplate', $request, $callOptions)->wait();
    }
}
