 ...
 * @experimental
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Dataflow\V1beta3\Client\FlexTemplatesServiceClient}.
 */
class FlexTemplatesServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/flex_templates_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/flex_templates_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/flex_templates_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/flex_templates_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function launchFlexTemplate(array $optionalArgs = [])
    {
        ...
        return $this->startCall('LaunchFlexTemplate', LaunchFlexTemplateResponse::class, $optionalArgs, $request)->wait();
    }
}
