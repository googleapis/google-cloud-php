 ...
 * @experimental
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Dataflow\V1beta3\Client\JobsV1Beta3Client}.
 */
class JobsV1Beta3GapicClient
{
    ...
    public function aggregatedListJobs(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedListJobs', $optionalArgs, ListJobsResponse::class, $request);
    }
    ...
    public function checkActiveJobs(array $optionalArgs = [])
    {
        ...
        return $this->startCall('CheckActiveJobs', CheckActiveJobsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function snapshotJob(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SnapshotJob', Snapshot::class, $optionalArgs, $request)->wait();
    }
