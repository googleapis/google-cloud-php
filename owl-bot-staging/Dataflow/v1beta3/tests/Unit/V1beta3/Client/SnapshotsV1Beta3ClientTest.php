...
namespace Google\Cloud\Dataflow\Tests\Unit\V1beta3\Client;
...
class SnapshotsV1Beta3ClientTest extends GeneratedTest
{
    ...
    public function deleteSnapshotTest()
    {
        ...
        $this->assertSame('/google.dataflow.v1beta3.SnapshotsV1Beta3/DeleteSnapshot', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getSnapshotTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.dataflow.v1beta3.SnapshotsV1Beta3/GetSnapshot', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSnapshotsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.dataflow.v1beta3.SnapshotsV1Beta3/ListSnapshots', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteSnapshotAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        $request = new DeleteSnapshotRequest();
        $response = $gapicClient->deleteSnapshotAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
