...
namespace Google\Cloud\Language\V2\Entity;
 ...
 * metadata.
 *
 * Protobuf type <code>google.cloud.language.v2.Entity.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Language\V2\Entity_Type::class);
