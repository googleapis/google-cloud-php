 ...
 *
 * Generated from protobuf message <code>google.cloud.language.v2.AnalyzeSentimentRequest</code>
 */
class AnalyzeSentimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.language.v2.EncodingType encoding_type = 2;</code>
     */
     ...
     *
     * @return \Google\Cloud\Language\V2\AnalyzeSentimentRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Language\V2\Document $document, int $encodingType): self
    {
        return (new self())
     ...
     * @experimental
     */
    public static function buildFromDocument(\Google\Cloud\Language\V2\Document $document): self
    {
        return (new self())
            ->setDocument($document);
    }
