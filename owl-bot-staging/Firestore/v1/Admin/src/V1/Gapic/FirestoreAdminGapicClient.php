...
class FirestoreAdminGapicClient
{
     ...
     * $firestoreAdminClient = new FirestoreAdminClient();
     * try {
     *     $operationResponse = $firestoreAdminClient->createIndex();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *         // doSomethingWith($result)
     ...
     * $firestoreAdminClient = new FirestoreAdminClient();
     * try {
     *     $operationResponse = $firestoreAdminClient->exportDocuments();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *         // doSomethingWith($result)
     ...
     * @throws ApiException if the remote call fails
     */
    public function exportDocuments(array $optionalArgs = [])
    {
     ...
     * $firestoreAdminClient = new FirestoreAdminClient();
     * try {
     *     $operationResponse = $firestoreAdminClient->importDocuments();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     ...
     * $firestoreAdminClient = new FirestoreAdminClient();
     * try {
     *     $operationResponse = $firestoreAdminClient->updateField();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         $result = $operationResponse->getResult();
     *         // doSomethingWith($result)
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateField(array $optionalArgs = [])
    {
