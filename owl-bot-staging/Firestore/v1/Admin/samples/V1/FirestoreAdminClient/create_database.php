 ...
 */
function create_database_sample(string $formattedParent, string $databaseId): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $firestoreAdminClient->createDatabase($formattedParent, $database, $databaseId);
