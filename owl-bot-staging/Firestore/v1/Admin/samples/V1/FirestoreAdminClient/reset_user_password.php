 ...
 */
function reset_user_password_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $firestoreAdminClient->resetUserPassword($request);
...
function callSample(): void
{
    ...
    reset_user_password_sample($formattedName);
}
