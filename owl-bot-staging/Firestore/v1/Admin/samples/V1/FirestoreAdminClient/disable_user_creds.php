 ...
 */
function disable_user_creds_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $firestoreAdminClient->disableUserCreds($request);
...
function callSample(): void
{
    ...
    disable_user_creds_sample($formattedName);
}
