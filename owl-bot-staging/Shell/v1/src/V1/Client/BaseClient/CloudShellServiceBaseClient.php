...
namespace Google\Cloud\Shell\V1\Client\BaseClient;
 ...
 */
abstract class CloudShellServiceBaseClient
{
     ...
     *
     * The async variant is {@see self::addPublicKeyAsync()} .
     *
     ...
     * authenticate.
     *
     * The async variant is {@see self::authorizeEnvironmentAsync()} .
     *
     ...
     * NOT_FOUND.
     *
     * The async variant is {@see self::removePublicKeyAsync()} .
     *
     ...
     *
     * The async variant is {@see self::startEnvironmentAsync()} .
     *
