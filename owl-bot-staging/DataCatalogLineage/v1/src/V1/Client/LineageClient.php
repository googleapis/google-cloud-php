...
final class LineageClient
{
     ...
     *           $options = new LineageClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchLineageStreaming(SearchLineageStreamingRequest $request, array $callOptions = []): ServerStream
    {
