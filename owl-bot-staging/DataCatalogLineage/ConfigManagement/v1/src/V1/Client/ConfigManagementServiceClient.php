 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/datacatalog/lineage/configmanagement/v1/configmanagement.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\DataCatalog\Lineage\ConfigManagement\V1\Client;
 ...
 */
final class ConfigManagementServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.datacatalog.lineage.configmanagement.v1.ConfigManagementService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/config_management_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/config_management_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/config_management_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/config_management_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * folder_location_config resource.
     *
     * @param string $folder
     * @param string $location
     *
     * @return string The formatted folder_location_config resource.
     */
    public static function folderLocationConfigName(string $folder, string $location): string
    {
        return self::getPathTemplate('folderLocationConfig')->render([
            'folder' => $folder,
            'location' => $location,
        ]);
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * organization_location_config resource.
     *
     * @param string $organization
     * @param string $location
     *
     * @return string The formatted organization_location_config resource.
     */
    public static function organizationLocationConfigName(string $organization, string $location): string
    {
        return self::getPathTemplate('organizationLocationConfig')->render([
     ...
     */
    public static function projectLocationConfigName(string $project, string $location): string
    {
        return self::getPathTemplate('projectLocationConfig')->render([
            'project' => $project,
            'location' => $location,
        ]);
    }
     ...
     *           use
     *           Google\Cloud\DataCatalog\Lineage\ConfigManagement\V1\ConfigManagementServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ConfigManagementServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ConfigManagementServiceClient::getConfigAsync()} .
     *
     * @example samples/V1/ConfigManagementServiceClient/get_config.php
     *
     ...
     *
     * The async variant is {@see ConfigManagementServiceClient::updateConfigAsync()} .
     *
     * @example samples/V1/ConfigManagementServiceClient/update_config.php
     *
