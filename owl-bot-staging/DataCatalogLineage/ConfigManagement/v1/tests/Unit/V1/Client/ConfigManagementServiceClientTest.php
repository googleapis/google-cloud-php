...
namespace Google\Cloud\DataCatalog\Lineage\ConfigManagement\Tests\Unit\V1\Client;
...
/**
 * @group configmanagement
 *
 * @group gapic
 */
class ConfigManagementServiceClientTest extends GeneratedTest
{
    ...
    /** @return ConfigManagementServiceClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new ConfigManagementServiceClient($options);
    }
    ...
    public function getConfigTest()
    {
        ...
        $this->assertSame('/google.cloud.datacatalog.lineage.configmanagement.v1.ConfigManagementService/GetConfig', $actualFuncCall);
    ...
    public function updateConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.datacatalog.lineage.configmanagement.v1.ConfigManagementService/UpdateConfig', $actualFuncCall);
    ...
    /** @test */
    public function getConfigAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetConfigRequest())
            ->setName($formattedName);
        $response = $gapicClient->getConfigAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
