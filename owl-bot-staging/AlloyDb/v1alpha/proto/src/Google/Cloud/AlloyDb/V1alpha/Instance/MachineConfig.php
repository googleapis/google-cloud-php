 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.Instance.MachineConfig</code>
 */
...
class_alias(MachineConfig::class, \Google\Cloud\AlloyDb\V1alpha\Instance_MachineConfig::class);
