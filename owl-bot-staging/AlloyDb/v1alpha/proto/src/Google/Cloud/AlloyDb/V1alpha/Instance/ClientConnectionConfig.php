 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.Instance.ClientConnectionConfig</code>
 */
class ClientConnectionConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SslConfig ssl_config = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
...
class_alias(ClientConnectionConfig::class, \Google\Cloud\AlloyDb\V1alpha\Instance_ClientConnectionConfig::class);
