 ...
 * Type of an Instance
 *
 * Protobuf type <code>google.cloud.alloydb.v1alpha.Instance.InstanceType</code>
 */
class InstanceType
{
    /**
...
class_alias(InstanceType::class, \Google\Cloud\AlloyDb\V1alpha\Instance_InstanceType::class);
