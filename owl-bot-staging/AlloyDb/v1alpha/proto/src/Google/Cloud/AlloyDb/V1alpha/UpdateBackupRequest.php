 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.UpdateBackupRequest</code>
 */
class UpdateBackupRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.Backup backup = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           the full request. A field will be overwritten if it is in the mask. If the
     *           user does not provide a mask then all fields will be overwritten.
     *     @type \Google\Cloud\AlloyDb\V1alpha\Backup $backup
     *           Required. The resource being updated
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.Backup backup = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AlloyDb\V1alpha\Backup|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.Backup backup = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AlloyDb\V1alpha\Backup $var
     * @return $this
     */
    public function setBackup($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1alpha\Backup::class);
        $this->backup = $var;
