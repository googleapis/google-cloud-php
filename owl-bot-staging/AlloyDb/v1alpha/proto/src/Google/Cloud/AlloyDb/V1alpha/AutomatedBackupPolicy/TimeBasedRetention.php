 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.AutomatedBackupPolicy.TimeBasedRetention</code>
 */
...
class_alias(TimeBasedRetention::class, \Google\Cloud\AlloyDb\V1alpha\AutomatedBackupPolicy_TimeBasedRetention::class);
