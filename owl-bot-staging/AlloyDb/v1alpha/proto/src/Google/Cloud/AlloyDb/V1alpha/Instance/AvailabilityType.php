 ...
 *
 * Protobuf type <code>google.cloud.alloydb.v1alpha.Instance.AvailabilityType</code>
 */
...
class_alias(AvailabilityType::class, \Google\Cloud\AlloyDb\V1alpha\Instance_AvailabilityType::class);
