...
namespace Google\Cloud\AlloyDb\V1alpha\User;
 ...
 *
 * Protobuf type <code>google.cloud.alloydb.v1alpha.User.UserType</code>
 */
class UserType
{
    /**
...
class_alias(UserType::class, \Google\Cloud\AlloyDb\V1alpha\User_UserType::class);
