 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\AlloyDb\V1alpha\BatchCreateInstancesMetadata $batch_create_instances_metadata
     ...
     * Output only. BatchCreateInstances related metadata.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.BatchCreateInstancesMetadata batch_create_instances_metadata = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\AlloyDb\V1alpha\BatchCreateInstancesMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.BatchCreateInstancesMetadata batch_create_instances_metadata = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\AlloyDb\V1alpha\BatchCreateInstancesMetadata $var
     * @return $this
     */
    public function setBatchCreateInstancesMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1alpha\BatchCreateInstancesMetadata::class);
