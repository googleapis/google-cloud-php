 ...
 * done via LDTM.
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.Instance.PscInterfaceConfig</code>
 */
...
class_alias(PscInterfaceConfig::class, \Google\Cloud\AlloyDb\V1alpha\Instance_PscInterfaceConfig::class);
