...
namespace Google\Cloud\AlloyDb\V1alpha\Instance\UpdatePolicy;
 ...
 *
 * Protobuf type <code>google.cloud.alloydb.v1alpha.Instance.UpdatePolicy.Mode</code>
 */
class Mode
{
    /**
...
class_alias(Mode::class, \Google\Cloud\AlloyDb\V1alpha\Instance_UpdatePolicy_Mode::class);
