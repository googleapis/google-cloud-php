...
namespace Google\Cloud\AlloyDb\V1alpha\BatchCreateInstanceStatus;
 ...
 * metadata.
 *
 * Protobuf type <code>google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\AlloyDb\V1alpha\BatchCreateInstanceStatus_State::class);
