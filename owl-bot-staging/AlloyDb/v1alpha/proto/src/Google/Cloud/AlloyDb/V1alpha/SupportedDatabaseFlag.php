 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.SupportedDatabaseFlag</code>
 */
class SupportedDatabaseFlag extends \Google\Protobuf\Internal\Message
{
    ...
    protected $flag_name = '';
    /**
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.ValueType value_type = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.alloydb.v1alpha.DatabaseVersion supported_db_versions = 5;</code>
     */
     ...
     *
     *     @type \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\StringRestrictions $string_restrictions
     *           Restriction on STRING type value.
     *     @type \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\IntegerRestrictions $integer_restrictions
     ...
     * Restriction on STRING type value.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.StringRestrictions string_restrictions = 7;</code>
     * @return \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\StringRestrictions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.StringRestrictions string_restrictions = 7;</code>
     * @param \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\StringRestrictions $var
     * @return $this
     */
    public function setStringRestrictions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\StringRestrictions::class);
     ...
     * Restriction on INTEGER type value.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.IntegerRestrictions integer_restrictions = 8;</code>
     * @return \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\IntegerRestrictions|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.IntegerRestrictions integer_restrictions = 8;</code>
     * @param \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\IntegerRestrictions $var
     * @return $this
     */
    public function setIntegerRestrictions($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\IntegerRestrictions::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AlloyDb\V1alpha\SupportedDatabaseFlag\ValueType::class);
        $this->value_type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\AlloyDb\V1alpha\DatabaseVersion::class);
