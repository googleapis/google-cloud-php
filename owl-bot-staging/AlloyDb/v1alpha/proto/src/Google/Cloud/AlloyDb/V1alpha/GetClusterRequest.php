 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.GetClusterRequest</code>
 */
class GetClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * not set.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.ClusterView view = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AlloyDb\V1alpha\ClusterView::class);
        $this->view = $var;
