 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/alloydb/v1beta/service.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\AlloyDb\V1beta\Gapic;
...
use Google\Cloud\AlloyDb\V1beta\BackupSource;
use Google\Cloud\AlloyDb\V1beta\BatchCreateInstancesRequest;
use Google\Cloud\AlloyDb\V1beta\Cluster;
use Google\Cloud\AlloyDb\V1beta\ConnectionInfo;
use Google\Cloud\AlloyDb\V1beta\ContinuousBackupSource;
use Google\Cloud\AlloyDb\V1beta\CreateBackupRequest;
use Google\Cloud\AlloyDb\V1beta\CreateClusterRequest;
use Google\Cloud\AlloyDb\V1beta\CreateInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\CreateInstanceRequests;
use Google\Cloud\AlloyDb\V1beta\CreateSecondaryClusterRequest;
use Google\Cloud\AlloyDb\V1beta\CreateSecondaryInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\CreateUserRequest;
use Google\Cloud\AlloyDb\V1beta\DeleteBackupRequest;
use Google\Cloud\AlloyDb\V1beta\DeleteClusterRequest;
use Google\Cloud\AlloyDb\V1beta\DeleteInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\DeleteUserRequest;
use Google\Cloud\AlloyDb\V1beta\FailoverInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\GenerateClientCertificateRequest;
use Google\Cloud\AlloyDb\V1beta\GenerateClientCertificateResponse;
use Google\Cloud\AlloyDb\V1beta\GetBackupRequest;
use Google\Cloud\AlloyDb\V1beta\GetClusterRequest;
use Google\Cloud\AlloyDb\V1beta\GetConnectionInfoRequest;
use Google\Cloud\AlloyDb\V1beta\GetInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\GetUserRequest;
use Google\Cloud\AlloyDb\V1beta\InjectFaultRequest;
use Google\Cloud\AlloyDb\V1beta\InjectFaultRequest\FaultType;
use Google\Cloud\AlloyDb\V1beta\Instance;
use Google\Cloud\AlloyDb\V1beta\ListBackupsRequest;
...
use Google\Cloud\AlloyDb\V1beta\ListUsersRequest;
use Google\Cloud\AlloyDb\V1beta\ListUsersResponse;
use Google\Cloud\AlloyDb\V1beta\PromoteClusterRequest;
use Google\Cloud\AlloyDb\V1beta\RestartInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\RestoreClusterRequest;
use Google\Cloud\AlloyDb\V1beta\UpdateBackupRequest;
use Google\Cloud\AlloyDb\V1beta\UpdateClusterRequest;
use Google\Cloud\AlloyDb\V1beta\UpdateInstanceRequest;
use Google\Cloud\AlloyDb\V1beta\UpdateUserRequest;
...
class AlloyDBAdminGapicClient
{
    ...
    private static function getInstanceNameTemplate()
    {
        if (self::$instanceNameTemplate == null) {
            self::$instanceNameTemplate = new PathTemplate('projects/{project}/locations/{location}/clusters/{cluster}/instances/{instance}');
        }
    ...
    private static function getUserNameTemplate()
    {
        if (self::$userNameTemplate == null) {
            self::$userNameTemplate = new PathTemplate('projects/{project}/locations/{location}/clusters/{cluster}/users/{user}');
        }
     ...
     * @experimental
     */
    public static function instanceName($project, $location, $cluster, $instance)
    {
     ...
     * @experimental
     */
    public function batchCreateInstances($parent, $requests, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('BatchCreateInstances', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createSecondaryCluster($parent, $clusterId, $cluster, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateSecondaryCluster', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createSecondaryInstance($parent, $instanceId, $instance, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateSecondaryInstance', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function createUser($parent, $userId, $user, array $optionalArgs = [])
    {
    ...
    public function generateClientCertificate($parent, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['useMetadataExchange'])) {
            $request->setUseMetadataExchange($optionalArgs['useMetadataExchange']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GenerateClientCertificate', GenerateClientCertificateResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *           not set.
     *           For allowed values, use constants defined on {@see \Google\Cloud\AlloyDb\V1beta\ClusterView}
     *     @type RetrySettings|array $retrySettings
     *           Retry settings to use for this call. Can be a {@see RetrySettings} object, or an
     *           associative array of retry settings parameters. See the documentation on
     *           {@see RetrySettings} for example usage.
    ...
    public function getConnectionInfo($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetConnectionInfo', ConnectionInfo::class, $optionalArgs, $request)->wait();
    }
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\AlloyDb\V1beta\InstanceView}
     *     @type RetrySettings|array $retrySettings
     *           Retry settings to use for this call. Can be a {@see RetrySettings} object, or an
     *           associative array of retry settings parameters. See the documentation on
     *           {@see RetrySettings} for example usage.
     ...
     *                             For allowed values, use constants defined on {@see \Google\Cloud\AlloyDb\V1beta\InjectFaultRequest\FaultType}
     * @param string $name         Required. The name of the resource. For the required format, see the
     *                             comment on the Instance.name field.
     * @param array  $optionalArgs {
     *     Optional.
    ...
    public function injectFault($faultType, $name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('InjectFault', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function listSupportedDatabaseFlags($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSupportedDatabaseFlags', $optionalArgs, ListSupportedDatabaseFlagsResponse::class, $request);
    }
    ...
    public function promoteCluster($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('PromoteCluster', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @experimental
     */
    public function restoreCluster($parent, $clusterId, $cluster, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['continuousBackupSource'])) {
            $request->setContinuousBackupSource($optionalArgs['continuousBackupSource']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RestoreCluster', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
