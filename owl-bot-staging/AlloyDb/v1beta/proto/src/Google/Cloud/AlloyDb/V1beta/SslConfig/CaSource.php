...
namespace Google\Cloud\AlloyDb\V1beta\SslConfig;
 ...
 *
 * Protobuf type <code>google.cloud.alloydb.v1beta.SslConfig.CaSource</code>
 */
class CaSource
{
    /**
...
class_alias(CaSource::class, \Google\Cloud\AlloyDb\V1beta\SslConfig_CaSource::class);
