...
namespace Google\Cloud\AlloyDb\V1beta\EncryptionInfo;
 ...
 *
 * Protobuf type <code>google.cloud.alloydb.v1beta.EncryptionInfo.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\AlloyDb\V1beta\EncryptionInfo_Type::class);
