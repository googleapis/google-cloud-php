 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.UpdateInstanceRequest</code>
 */
class UpdateInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           the full request. A field will be overwritten if it is in the mask. If the
     *           user does not provide a mask then all fields will be overwritten.
     *     @type \Google\Cloud\AlloyDb\V1beta\Instance $instance
     *           Required. The resource being updated
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AlloyDb\V1beta\Instance|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AlloyDb\V1beta\Instance $var
     * @return $this
     */
    public function setInstance($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1beta\Instance::class);
        $this->instance = $var;
