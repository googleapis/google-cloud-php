 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.SupportedDatabaseFlag.IntegerRestrictions</code>
 */
...
class_alias(IntegerRestrictions::class, \Google\Cloud\AlloyDb\V1beta\SupportedDatabaseFlag_IntegerRestrictions::class);
