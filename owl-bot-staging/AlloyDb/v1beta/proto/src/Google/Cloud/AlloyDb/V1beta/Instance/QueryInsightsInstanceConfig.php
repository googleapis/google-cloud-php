 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.Instance.QueryInsightsInstanceConfig</code>
 */
...
class_alias(QueryInsightsInstanceConfig::class, \Google\Cloud\AlloyDb\V1beta\Instance_QueryInsightsInstanceConfig::class);
