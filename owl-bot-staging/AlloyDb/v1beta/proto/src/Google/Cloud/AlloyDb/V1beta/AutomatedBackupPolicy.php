 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.AutomatedBackupPolicy</code>
 */
class AutomatedBackupPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.EncryptionConfig encryption_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\WeeklySchedule $weekly_schedule
     *           Weekly schedule for the Backup.
     *     @type \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\TimeBasedRetention $time_based_retention
     *           Time-based Backup retention policy.
     *     @type \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\QuantityBasedRetention $quantity_based_retention
     ...
     * Weekly schedule for the Backup.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.WeeklySchedule weekly_schedule = 2;</code>
     * @return \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\WeeklySchedule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.WeeklySchedule weekly_schedule = 2;</code>
     * @param \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\WeeklySchedule $var
     * @return $this
     */
    public function setWeeklySchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\WeeklySchedule::class);
     ...
     * Time-based Backup retention policy.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.TimeBasedRetention time_based_retention = 4;</code>
     * @return \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\TimeBasedRetention|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.TimeBasedRetention time_based_retention = 4;</code>
     * @param \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\TimeBasedRetention $var
     * @return $this
     */
    public function setTimeBasedRetention($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\TimeBasedRetention::class);
     ...
     * Quantity-based Backup retention policy to retain recent backups.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.QuantityBasedRetention quantity_based_retention = 5;</code>
     * @return \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\QuantityBasedRetention|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.AutomatedBackupPolicy.QuantityBasedRetention quantity_based_retention = 5;</code>
     * @param \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\QuantityBasedRetention $var
     * @return $this
     */
    public function setQuantityBasedRetention($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1beta\AutomatedBackupPolicy\QuantityBasedRetention::class);
