 ...
 * Type of Cluster
 *
 * Protobuf type <code>google.cloud.alloydb.v1beta.Cluster.ClusterType</code>
 */
class ClusterType
{
    /**
...
class_alias(ClusterType::class, \Google\Cloud\AlloyDb\V1beta\Cluster_ClusterType::class);
