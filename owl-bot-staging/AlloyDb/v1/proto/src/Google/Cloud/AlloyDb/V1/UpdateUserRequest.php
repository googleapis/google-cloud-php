 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1.UpdateUserRequest</code>
 */
class UpdateUserRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1.User user = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $user = null;
    /**
    ...
    /**
     * @param \Google\Cloud\AlloyDb\V1\User $user       Required. The resource being updated
     ...
     *                                                  user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\AlloyDb\V1\UpdateUserRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\AlloyDb\V1\User $user, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
            ->setUser($user)
