 ...
 * Upgrades a cluster.
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1.UpgradeClusterRequest</code>
 */
class UpgradeClusterRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1.DatabaseVersion version = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $version = 0;
    /**
     ...
     * @param int    $version Required. The version the cluster is going to be upgraded to.
     *                        For allowed values, use constants defined on {@see \Google\Cloud\AlloyDb\V1\DatabaseVersion}
     *
     * @return \Google\Cloud\AlloyDb\V1\UpgradeClusterRequest
     *
     * @experimental
     */
    public static function build(string $name, int $version): self
    {
        return (new self())
            ->setName($name)
            ->setVersion($version);
