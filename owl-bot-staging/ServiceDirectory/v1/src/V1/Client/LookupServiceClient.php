 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/servicedirectory/v1/lookup_service.proto
 ...
 *
 * @method PromiseInterface<ResolveServiceResponse> resolveServiceAsync(ResolveServiceRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Location> getLocationAsync(GetLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listLocationsAsync(ListLocationsRequest $request, array $optionalArgs = [])
 */
final class LookupServiceClient
{
     ...
     *           $options = new LookupServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
