 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\ServiceDirectory\V1\Client\RegistrationServiceClient}.
 */
class RegistrationServiceGapicClient
{
    ...
    private static function getNetworkNameTemplate()
    {
        if (self::$networkNameTemplate == null) {
            self::$networkNameTemplate = new PathTemplate('projects/{project}/locations/global/networks/{network}');
        }
