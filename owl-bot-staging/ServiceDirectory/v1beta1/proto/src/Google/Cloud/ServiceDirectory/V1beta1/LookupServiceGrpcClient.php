...
class LookupServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function ResolveService(\Google\Cloud\ServiceDirectory\V1beta1\ResolveServiceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.servicedirectory.v1beta1.LookupService/ResolveService',
        $argument,
        ['\Google\Cloud\ServiceDirectory\V1beta1\ResolveServiceResponse', 'decode'],
        $metadata, $options);
    }
