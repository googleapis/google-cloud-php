 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Datastream\V1\Client\DatastreamClient}.
 */
class DatastreamGapicClient
{
    ...
    private static function getStreamObjectNameTemplate()
    {
        if (self::$streamObjectNameTemplate == null) {
            self::$streamObjectNameTemplate = new PathTemplate('projects/{project}/locations/{location}/streams/{stream}/objects/{object}');
        }
     ...
     */
    public static function streamObjectName($project, $location, $stream, $object)
    {
    ...
    public function getStreamObject($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetStreamObject', StreamObject::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listStreamObjects($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListStreamObjects', $optionalArgs, ListStreamObjectsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function lookupStreamObject($parent, $sourceObjectIdentifier, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('LookupStreamObject', StreamObject::class, $optionalArgs, $request)->wait();
    }
    ...
    public function startBackfillJob($object, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('StartBackfillJob', StartBackfillJobResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function stopBackfillJob($object, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('StopBackfillJob', StopBackfillJobResponse::class, $optionalArgs, $request)->wait();
    }
