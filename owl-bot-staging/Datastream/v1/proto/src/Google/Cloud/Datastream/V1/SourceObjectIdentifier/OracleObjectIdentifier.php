 ...
 *
 * Generated from protobuf message <code>google.cloud.datastream.v1.SourceObjectIdentifier.OracleObjectIdentifier</code>
 */
class OracleObjectIdentifier extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(OracleObjectIdentifier::class, \Google\Cloud\Datastream\V1\SourceObjectIdentifier_OracleObjectIdentifier::class);
