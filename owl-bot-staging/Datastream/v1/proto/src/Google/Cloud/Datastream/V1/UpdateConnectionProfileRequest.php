...
class UpdateConnectionProfileRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param \Google\Cloud\Datastream\V1\ConnectionProfile $connectionProfile Required. The connection profile to update.
     ...
     *                                                                         user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\Datastream\V1\UpdateConnectionProfileRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Datastream\V1\ConnectionProfile $connectionProfile, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
