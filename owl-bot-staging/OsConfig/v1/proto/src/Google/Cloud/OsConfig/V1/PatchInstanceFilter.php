...
class PatchInstanceFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *           Target all VM instances in the project. If true, no other criteria is
     *           permitted.
     *     @type \Google\Cloud\OsConfig\V1\PatchInstanceFilter\GroupLabel[] $group_labels
     *           Targets VM instances matching ANY of these GroupLabels. This allows
     *           targeting of disparate groups of VM instances.
     *     @type string[] $zones
     *           Targets VM instances in ANY of these zones. Leave empty to target VM
     ...
     *           `projects/[PROJECT_ID]/zones/[ZONE]/instances/[INSTANCE_NAME]`, or
     *           `https://www.googleapis.com/compute/v1/projects/[PROJECT_ID]/zones/[ZONE]/instances/[INSTANCE_NAME]`
     *     @type string[] $instance_name_prefixes
     *           Targets VMs whose name starts with one of these prefixes. Similar to
     *           labels, this is another way to group VMs when targeting configs, for
     *           example prefix="prod-".
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1.PatchInstanceFilter.GroupLabel group_labels = 2;</code>
     * @return RepeatedField<\Google\Cloud\OsConfig\V1\PatchInstanceFilter\GroupLabel>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.osconfig.v1.PatchInstanceFilter.GroupLabel group_labels = 2;</code>
     * @param \Google\Cloud\OsConfig\V1\PatchInstanceFilter\GroupLabel[] $var
     * @return $this
     */
