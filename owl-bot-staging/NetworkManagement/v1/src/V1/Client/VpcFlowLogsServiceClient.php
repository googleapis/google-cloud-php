...
final class VpcFlowLogsServiceClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function queryOrgVpcFlowLogsConfigs(QueryOrgVpcFlowLogsConfigsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function showEffectiveFlowLogsConfigs(ShowEffectiveFlowLogsConfigsRequest $request, array $callOptions = []): PagedListResponse
    {
