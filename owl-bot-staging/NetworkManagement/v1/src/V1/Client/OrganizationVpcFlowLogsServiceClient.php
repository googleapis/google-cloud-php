 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/networkmanagement/v1/vpc_flow_logs.proto
...
/**
 * Service Description: The VPC Flow Logs organization service in the Google Cloud Network Management
 ...
 *
 * @method PromiseInterface<OperationResponse> createVpcFlowLogsConfigAsync(CreateVpcFlowLogsConfigRequest $request, array $optionalArgs = [])
 ...
 */
final class OrganizationVpcFlowLogsServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.networkmanagement.v1.OrganizationVpcFlowLogsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/organization_vpc_flow_logs_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/organization_vpc_flow_logs_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/organization_vpc_flow_logs_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/organization_vpc_flow_logs_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function organizationLocationVpcFlowLogsConfigName(string $organization, string $location, string $vpcFlowLogsConfig): string
    {
     ...
     */
    public static function projectLocationVpcFlowLogsConfigName(string $project, string $location, string $vpcFlowLogsConfig): string
    {
     ...
     * @param string $vpcFlowLogsConfig
     *
     * @return string The formatted vpc_flow_logs_config resource.
     */
    public static function vpcFlowLogsConfigName(string $project, string $location, string $vpcFlowLogsConfig): string
    {
        return self::getPathTemplate('vpcFlowLogsConfig')->render([
            'project' => $project,
            'location' => $location,
            'vpc_flow_logs_config' => $vpcFlowLogsConfig,
        ]);
     ...
     *           use Google\Cloud\NetworkManagement\V1\OrganizationVpcFlowLogsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new OrganizationVpcFlowLogsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see OrganizationVpcFlowLogsServiceClient::createVpcFlowLogsConfigAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/create_vpc_flow_logs_config.php
     *
     * @param CreateVpcFlowLogsConfigRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::deleteVpcFlowLogsConfigAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/delete_vpc_flow_logs_config.php
     *
     * @param DeleteVpcFlowLogsConfigRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::getVpcFlowLogsConfigAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/get_vpc_flow_logs_config.php
     *
     * @param GetVpcFlowLogsConfigRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::listVpcFlowLogsConfigsAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/list_vpc_flow_logs_configs.php
     *
     * @param ListVpcFlowLogsConfigsRequest $request     A request to house fields associated with the call.
     * @param array                         $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::updateVpcFlowLogsConfigAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/update_vpc_flow_logs_config.php
     *
     * @param UpdateVpcFlowLogsConfigRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/get_location.php
     *
     ...
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/list_locations.php
     *
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::getIamPolicyAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/get_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::setIamPolicyAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see OrganizationVpcFlowLogsServiceClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/OrganizationVpcFlowLogsServiceClient/test_iam_permissions.php
     *
