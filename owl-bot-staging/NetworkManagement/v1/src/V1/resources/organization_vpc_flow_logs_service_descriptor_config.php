    ...
    'interfaces' => [
        'google.cloud.networkmanagement.v1.OrganizationVpcFlowLogsService' => [
            'CreateVpcFlowLogsConfig' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkManagement\V1\VpcFlowLogsConfig',
            ...
            'UpdateVpcFlowLogsConfig' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'vpc_flow_logs_config.name',
                        'fieldAccessors' => [
            ...
            'GetVpcFlowLogsConfig' => [
                ...
                'responseType' => 'Google\Cloud\NetworkManagement\V1\VpcFlowLogsConfig',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListVpcFlowLogsConfigs' => [
                ...
                'responseType' => 'Google\Cloud\NetworkManagement\V1\ListVpcFlowLogsConfigsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
