 ...
 *
 * Protobuf type <code>google.cloud.networkmanagement.v1.DeliverInfo.GoogleServiceType</code>
 */
class GoogleServiceType
{
     ...
     *
     * Generated from protobuf enum <code>PRIVATE_GOOGLE_ACCESS = 4;</code>
     */
    const PRIVATE_GOOGLE_ACCESS = 4;
    /**
     ...
     *
     * Generated from protobuf enum <code>SERVERLESS_VPC_ACCESS = 5;</code>
     */
    const SERVERLESS_VPC_ACCESS = 5;
...
class_alias(GoogleServiceType::class, \Google\Cloud\NetworkManagement\V1\DeliverInfo_GoogleServiceType::class);
