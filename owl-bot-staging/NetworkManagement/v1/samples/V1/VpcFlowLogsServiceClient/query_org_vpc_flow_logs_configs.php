 ...
 */
function query_org_vpc_flow_logs_configs_sample(string $formattedParent): void
{
    // Create a client.
    $vpcFlowLogsServiceClient = new VpcFlowLogsServiceClient();

    // Prepare the request message.
    $request = (new QueryOrgVpcFlowLogsConfigsRequest())
        ->setParent($formattedParent);

    // Call the API and handle any network failures.
    try {
        /** @var PagedListResponse $response */
        $response = $vpcFlowLogsServiceClient->queryOrgVpcFlowLogsConfigs($request);
...
function callSample(): void
{
    ...
    query_org_vpc_flow_logs_configs_sample($formattedParent);
}
