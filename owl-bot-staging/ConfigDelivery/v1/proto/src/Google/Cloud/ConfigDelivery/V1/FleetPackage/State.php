 ...
 * be scheduled.
 *
 * Protobuf type <code>google.cloud.configdelivery.v1.FleetPackage.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\ConfigDelivery\V1\FleetPackage_State::class);
