...
namespace Google\Cloud\ConfigDelivery\V1\Release;
 ...
 * immutable.
 *
 * Protobuf type <code>google.cloud.configdelivery.v1.Release.Lifecycle</code>
 */
class Lifecycle
{
    /**
...
class_alias(Lifecycle::class, \Google\Cloud\ConfigDelivery\V1\Release_Lifecycle::class);
