...
final class ConfigDeliveryClient
{
     ...
     * @experimental
     */
    public static function releaseName(string $project, string $location, string $resourceBundle, string $release): string
    {
     ...
     * @experimental
     */
    public static function variantName(string $project, string $location, string $resourceBundle, string $release, string $variant): string
    {
     ...
     *           use Google\Cloud\ConfigDelivery\V1beta\ConfigDeliveryClient;
     ...
     * @experimental
     */
    public function createResourceBundle(CreateResourceBundleRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @experimental
     */
    public function deleteResourceBundle(DeleteResourceBundleRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @experimental
     */
    public function updateResourceBundle(UpdateResourceBundleRequest $request, array $callOptions = []): OperationResponse
    {
