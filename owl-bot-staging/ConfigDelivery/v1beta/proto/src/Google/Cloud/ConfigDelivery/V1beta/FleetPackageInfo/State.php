...
namespace Google\Cloud\ConfigDelivery\V1beta\FleetPackageInfo;
 ...
 *
 * Protobuf type <code>google.cloud.configdelivery.v1beta.FleetPackageInfo.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\ConfigDelivery\V1beta\FleetPackageInfo_State::class);
