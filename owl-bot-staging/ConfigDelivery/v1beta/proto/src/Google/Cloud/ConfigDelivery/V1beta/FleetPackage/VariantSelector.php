 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1beta.FleetPackage.VariantSelector</code>
 */
...
class_alias(VariantSelector::class, \Google\Cloud\ConfigDelivery\V1beta\FleetPackage_VariantSelector::class);
