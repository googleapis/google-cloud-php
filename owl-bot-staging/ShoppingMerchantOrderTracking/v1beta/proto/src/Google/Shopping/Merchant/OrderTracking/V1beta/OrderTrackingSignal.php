...
class OrderTrackingSignal extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The ID of the order on the businesses side. This field will be
     *           hashed in returned OrderTrackingSignal creation response.
     *     @type \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShippingInfo[] $shipping_info
     *           Required. The shipping information for the order.
     *     @type \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\LineItemDetails[] $line_items
     *           Required. Information about line items in the order.
     *     @type \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShipmentLineItemMapping[] $shipment_line_item_mapping
     *           Optional. The mapping of the line items to the shipment information.
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.ShippingInfo shipping_info = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShippingInfo>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.ShippingInfo shipping_info = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShippingInfo[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.LineItemDetails line_items = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\LineItemDetails>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.LineItemDetails line_items = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\LineItemDetails[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.ShipmentLineItemMapping shipment_line_item_mapping = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShipmentLineItemMapping>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.ordertracking.v1beta.OrderTrackingSignal.ShipmentLineItemMapping shipment_line_item_mapping = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\OrderTracking\V1beta\OrderTrackingSignal\ShipmentLineItemMapping[] $var
     * @return $this
     */
