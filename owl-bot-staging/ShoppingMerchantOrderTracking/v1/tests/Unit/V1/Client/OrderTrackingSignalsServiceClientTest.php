...
namespace Google\Shopping\Merchant\OrderTracking\Tests\Unit\V1\Client;
...
class OrderTrackingSignalsServiceClientTest extends GeneratedTest
{
    ...
    public function createOrderTrackingSignalTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService/CreateOrderTrackingSignal', $actualFuncCall);
