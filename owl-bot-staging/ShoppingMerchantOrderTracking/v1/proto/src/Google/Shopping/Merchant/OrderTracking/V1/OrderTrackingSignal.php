 ...
 * shipping.
 *
 * Generated from protobuf message <code>google.shopping.merchant.ordertracking.v1.OrderTrackingSignal</code>
 */
class OrderTrackingSignal extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\OrderTracking\V1\OrderTrackingSignal\ShippingInfo::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\OrderTracking\V1\OrderTrackingSignal\LineItemDetails::class);
        $this->line_items = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\OrderTracking\V1\OrderTrackingSignal\ShipmentLineItemMapping::class);
