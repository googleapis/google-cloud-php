...
use Google\Cloud\CloudSecurityCompliance\V1\ListControlComplianceSummariesResponse;
use Google\Cloud\CloudSecurityCompliance\V1\ListFindingSummariesRequest;
use Google\Cloud\CloudSecurityCompliance\V1\ListFindingSummariesResponse;
use Google\Cloud\CloudSecurityCompliance\V1\ListFrameworkComplianceSummariesRequest;
use Google\Cloud\CloudSecurityCompliance\V1\ListFrameworkComplianceSummariesResponse;
 ...
 * @group gapic
 */
class MonitoringClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new MonitoringClient($options);
    }

    /** @test */
    public function aggregateFrameworkComplianceReportTest()
    {
    ...
    /** @test */
    public function aggregateFrameworkComplianceReportExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function fetchFrameworkComplianceReportTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $framework = 'framework546173438';
        $frameworkDescription = 'frameworkDescription676251451';
        $frameworkDisplayName = 'frameworkDisplayName-1269602167';
        $name2 = 'name2-1052831874';
        $majorRevisionId = 612576889;
        $minorRevisionId = 1736456587;
        $expectedResponse = new FrameworkComplianceReport();
        $expectedResponse->setFramework($framework);
    ...
    /** @test */
    public function fetchFrameworkComplianceReportExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listControlComplianceSummariesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertEquals($expectedResponse->getControlComplianceSummaries()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listControlComplianceSummariesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listFindingSummariesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.cloudsecuritycompliance.v1.Monitoring/ListFindingSummaries', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listFindingSummariesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listFrameworkComplianceSummariesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getFrameworkComplianceSummaries()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listFrameworkComplianceSummariesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function aggregateFrameworkComplianceReportAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
