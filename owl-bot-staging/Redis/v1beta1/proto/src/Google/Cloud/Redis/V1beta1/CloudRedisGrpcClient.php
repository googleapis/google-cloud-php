...
class CloudRedisGrpcClient extends \Grpc\BaseStub {
    ...
    public function ListInstances(\Google\Cloud\Redis\V1beta1\ListInstancesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.redis.v1beta1.CloudRedis/ListInstances',
        $argument,
        ['\Google\Cloud\Redis\V1beta1\ListInstancesResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function GetInstance(\Google\Cloud\Redis\V1beta1\GetInstanceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.redis.v1beta1.CloudRedis/GetInstance',
        $argument,
        ['\Google\Cloud\Redis\V1beta1\Instance', 'decode'],
        $metadata, $options);
    }
    ...
    public function CreateInstance(\Google\Cloud\Redis\V1beta1\CreateInstanceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.redis.v1beta1.CloudRedis/CreateInstance',
        $argument,
    ...
    public function ImportInstance(\Google\Cloud\Redis\V1beta1\ImportInstanceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.redis.v1beta1.CloudRedis/ImportInstance',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
