 ...
 *
 * Generated from protobuf message <code>google.cloud.redis.v1beta1.RescheduleMaintenanceRequest</code>
 */
class RescheduleMaintenanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.v1beta1.RescheduleMaintenanceRequest.RescheduleType reschedule_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Redis\V1beta1\RescheduleMaintenanceRequest\RescheduleType::class);
