 ...
 * The input content
 *
 * Generated from protobuf message <code>google.cloud.redis.v1beta1.InputConfig</code>
 */
class InputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Redis\V1beta1\GcsSource $gcs_source
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.v1beta1.GcsSource gcs_source = 1;</code>
     * @param \Google\Cloud\Redis\V1beta1\GcsSource $var
     * @return $this
     */
    public function setGcsSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Redis\V1beta1\GcsSource::class);
