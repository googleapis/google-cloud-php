...
class AppConnectionsServiceGapicClient
{
    ...
    private static function getAppConnectionNameTemplate()
    {
        if (self::$appConnectionNameTemplate == null) {
            self::$appConnectionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/appConnections/{app_connection}');
        }
    ...
    private static function getAppGatewayNameTemplate()
    {
        if (self::$appGatewayNameTemplate == null) {
            self::$appGatewayNameTemplate = new PathTemplate('projects/{project}/locations/{location}/appGateways/{app_gateway}');
        }
     ...
     */
    public static function appConnectionName($project, $location, $appConnection)
    {
     ...
     */
    public function createAppConnection($parent, $appConnection, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateAppConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteAppConnection($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteAppConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getAppConnection($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAppConnection', AppConnection::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listAppConnections($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListAppConnections', $optionalArgs, ListAppConnectionsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function resolveAppConnections($parent, $appConnectorId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ResolveAppConnections', $optionalArgs, ResolveAppConnectionsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateAppConnection($updateMask, $appConnection, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateAppConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
