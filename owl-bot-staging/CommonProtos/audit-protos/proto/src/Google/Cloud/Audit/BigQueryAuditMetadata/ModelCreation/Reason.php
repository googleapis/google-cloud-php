...
namespace Google\Cloud\Audit\BigQueryAuditMetadata\ModelCreation;
 ...
 *
 * Protobuf type <code>google.cloud.audit.BigQueryAuditMetadata.ModelCreation.Reason</code>
 */
class Reason
{
    /**
...
class_alias(Reason::class, \Google\Cloud\Audit\BigQueryAuditMetadata_ModelCreation_Reason::class);
