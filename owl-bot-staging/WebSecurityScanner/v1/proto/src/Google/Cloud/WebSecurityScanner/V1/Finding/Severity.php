...
namespace Google\Cloud\WebSecurityScanner\V1\Finding;
 ...
 *
 * Protobuf type <code>google.cloud.websecurityscanner.v1.Finding.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Cloud\WebSecurityScanner\V1\Finding_Severity::class);
