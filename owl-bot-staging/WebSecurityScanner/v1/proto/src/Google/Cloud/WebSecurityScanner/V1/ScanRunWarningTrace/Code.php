...
class Code
{
     ...
     *
     * Generated from protobuf enum <code>NO_STARTING_URL_FOUND_FOR_MANAGED_SCAN = 5;</code>
     */
    const NO_STARTING_URL_FOUND_FOR_MANAGED_SCAN = 5;
    ...
    private static $valueToName = [
        ...
        self::NO_STARTING_URL_FOUND_FOR_MANAGED_SCAN => 'NO_STARTING_URL_FOUND_FOR_MANAGED_SCAN',
    ];
