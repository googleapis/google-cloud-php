 ...
 *
 * Protobuf type <code>google.cloud.websecurityscanner.v1.ScanRun.ExecutionState</code>
 */
...
class_alias(ExecutionState::class, \Google\Cloud\WebSecurityScanner\V1\ScanRun_ExecutionState::class);
