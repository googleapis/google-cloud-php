 ...
 *
 * Protobuf type <code>google.cloud.websecurityscanner.v1.ScanConfig.UserAgent</code>
 */
class UserAgent
{
    /**
...
class_alias(UserAgent::class, \Google\Cloud\WebSecurityScanner\V1\ScanConfig_UserAgent::class);
