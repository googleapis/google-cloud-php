...
namespace Google\Cloud\WebSecurityScanner\V1\ScanConfigError;
 ...
 * Next id: 44
 *
 * Protobuf type <code>google.cloud.websecurityscanner.v1.ScanConfigError.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\WebSecurityScanner\V1\ScanConfigError_Code::class);
