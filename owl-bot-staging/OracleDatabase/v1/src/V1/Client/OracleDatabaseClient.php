...
final class OracleDatabaseClient
{
     ...
     */
    public static function autonomousDatabaseBackupName(string $project, string $location, string $autonomousDatabaseBackup): string
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getAutonomousDatabaseRefreshableClones(GetAutonomousDatabaseRefreshableClonesRequest $request, array $callOptions = []): AutonomousDatabaseRefreshableClones
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function refreshAutonomousDatabase(RefreshAutonomousDatabaseRequest $request, array $callOptions = []): OperationResponse
    {
