 ...
 *
 * @param string $formattedName Name of the connection assignment for which to test connection.
 ...
 */
function test_goldengate_connection_assignment_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var TestGoldengateConnectionAssignmentResponse $response */
        $response = $oracleDatabaseClient->testGoldengateConnectionAssignment($request);
...
function callSample(): void
{
    ...
    test_goldengate_connection_assignment_sample($formattedName);
}
