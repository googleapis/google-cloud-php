...
class OracleDatabaseClientTest extends GeneratedTest
{
    ...
    public function configureExascaleCloudExadataInfrastructureTest()
    {
        ...
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ConfigureExascaleCloudExadataInfrastructure', $actualApiFuncCall);
    ...
    public function getAutonomousDatabaseRefreshableClonesTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->autonomousDatabaseName('[PROJECT]', '[LOCATION]', '[AUTONOMOUS_DATABASE]');
        $request = (new GetAutonomousDatabaseRefreshableClonesRequest())
            ->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetAutonomousDatabaseRefreshableClones', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function refreshAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/RefreshAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
