...
class OracleDatabaseClientTest extends GeneratedTest
{
    ...
    public function createCloudExadataInfrastructureTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/CreateCloudExadataInfrastructure', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createCloudVmClusterTest()
    {
        ...
        $cloudVmClusterExadataInfrastructure = $gapicClient->cloudExadataInfrastructureName('[PROJECT]', '[LOCATION]', '[CLOUD_EXADATA_INFRASTRUCTURE]');
    ...
    public function createExadbVmClusterTest()
    {
        ...
        $propertiesExascaleDbStorageVault = $gapicClient->exascaleDbStorageVaultName('[PROJECT]', '[LOCATION]', '[EXASCALE_DB_STORAGE_VAULT]');
        ...
        $exadbVmClusterOdbSubnet = $gapicClient->odbSubnetName('[PROJECT]', '[LOCATION]', '[ODB_NETWORK]', '[ODB_SUBNET]');
        $exadbVmCluster->setOdbSubnet($exadbVmClusterOdbSubnet);
        $exadbVmClusterBackupOdbSubnet = $gapicClient->odbSubnetName('[PROJECT]', '[LOCATION]', '[ODB_NETWORK]', '[ODB_SUBNET]');
    ...
    public function createExascaleDbStorageVaultTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/CreateExascaleDbStorageVault', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createGoldengateConnectionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/CreateGoldengateConnection', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createGoldengateConnectionAssignmentTest()
    {
        ...
        $propertiesGoldengateConnection = $gapicClient->goldengateConnectionName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_CONNECTION]');
        $goldengateConnectionAssignmentProperties->setGoldengateConnection($propertiesGoldengateConnection);
        $propertiesGoldengateDeployment = $gapicClient->goldengateDeploymentName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_DEPLOYMENT]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/CreateGoldengateConnectionAssignment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createGoldengateDeploymentTest()
    {
        ...
        $goldengateDeploymentOdbSubnet = $gapicClient->odbSubnetName('[PROJECT]', '[LOCATION]', '[ODB_NETWORK]', '[ODB_SUBNET]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/CreateGoldengateDeployment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deleteAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteAutonomousDatabase', $actualApiFuncCall);
    ...
    public function deleteCloudExadataInfrastructureTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->cloudExadataInfrastructureName('[PROJECT]', '[LOCATION]', '[CLOUD_EXADATA_INFRASTRUCTURE]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteCloudExadataInfrastructure', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteExascaleDbStorageVaultTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->exascaleDbStorageVaultName('[PROJECT]', '[LOCATION]', '[EXASCALE_DB_STORAGE_VAULT]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteExascaleDbStorageVault', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteGoldengateConnectionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteGoldengateConnection', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteGoldengateConnectionAssignmentTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->goldengateConnectionAssignmentName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_CONNECTION_ASSIGNMENT]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteGoldengateConnectionAssignment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteGoldengateDeploymentTest()
    {
        ...
        $request = (new DeleteGoldengateDeploymentRequest())
            ->setName($formattedName);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/DeleteGoldengateDeployment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function failoverAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/FailoverAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function generateAutonomousDatabaseWalletTest()
    {
        ...
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GenerateAutonomousDatabaseWallet', $actualFuncCall);
    ...
    public function getCloudExadataInfrastructureTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetCloudExadataInfrastructure', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGoldengateConnectionTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->goldengateConnectionName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_CONNECTION]');
        $request = (new GetGoldengateConnectionRequest())
            ->setName($formattedName);
    ...
    public function getGoldengateConnectionAssignmentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetGoldengateConnectionAssignment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGoldengateConnectionTypeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->goldengateConnectionTypeName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_CONNECTION_TYPE]');
        $request = (new GetGoldengateConnectionTypeRequest())
            ->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetGoldengateConnectionType', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGoldengateDeploymentEnvironmentTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->goldengateDeploymentEnvironmentName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_DEPLOYMENT_ENVIRONMENT]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetGoldengateDeploymentEnvironment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGoldengateDeploymentTypeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->goldengateDeploymentTypeName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_DEPLOYMENT_TYPE]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetGoldengateDeploymentType', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getGoldengateDeploymentVersionTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->goldengateDeploymentVersionName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_DEPLOYMENT_VERSION]');
        $request = (new GetGoldengateDeploymentVersionRequest())
            ->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/GetGoldengateDeploymentVersion', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listAutonomousDatabaseBackupsTest()
    {
        ...
        $autonomousDatabaseBackups = [
            $autonomousDatabaseBackupsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListAutonomousDatabaseBackups', $actualFuncCall);
    ...
    public function listAutonomousDatabaseCharacterSetsTest()
    {
        ...
        $autonomousDatabaseCharacterSets = [
            $autonomousDatabaseCharacterSetsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListAutonomousDatabaseCharacterSets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listCloudExadataInfrastructuresTest()
    {
        ...
        $cloudExadataInfrastructures = [
            $cloudExadataInfrastructuresElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListCloudExadataInfrastructures', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listDbServersTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->cloudExadataInfrastructureName('[PROJECT]', '[LOCATION]', '[CLOUD_EXADATA_INFRASTRUCTURE]');
    ...
    public function listDbSystemInitialStorageSizesTest()
    {
        ...
        $dbSystemInitialStorageSizes = [
            $dbSystemInitialStorageSizesElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListDbSystemInitialStorageSizes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listExascaleDbStorageVaultsTest()
    {
        ...
        $exascaleDbStorageVaults = [
            $exascaleDbStorageVaultsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListExascaleDbStorageVaults', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGoldengateConnectionAssignmentsTest()
    {
        ...
        $goldengateConnectionAssignments = [
            $goldengateConnectionAssignmentsElement,
        ];
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListGoldengateConnectionAssignmentsRequest())
            ->setParent($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListGoldengateConnectionAssignments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGoldengateConnectionTypesTest()
    {
        ...
        $goldengateConnectionTypes = [
            $goldengateConnectionTypesElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListGoldengateConnectionTypes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGoldengateDeploymentEnvironmentsTest()
    {
        ...
        $goldengateDeploymentEnvironments = [
            $goldengateDeploymentEnvironmentsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListGoldengateDeploymentEnvironments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGoldengateDeploymentTypesTest()
    {
        ...
        $goldengateDeploymentTypes = [
            $goldengateDeploymentTypesElement,
        ];
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListGoldengateDeploymentTypesRequest())
            ->setParent($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListGoldengateDeploymentTypes', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGoldengateDeploymentVersionsTest()
    {
        ...
        $goldengateDeploymentVersions = [
            $goldengateDeploymentVersionsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/ListGoldengateDeploymentVersions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeVirtualMachineExadbVmClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/RemoveVirtualMachineExadbVmCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function restartAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/RestartAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function restoreAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/RestoreAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function startGoldengateDeploymentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/StartGoldengateDeployment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function stopGoldengateDeploymentTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/StopGoldengateDeployment', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function switchoverAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/SwitchoverAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function testGoldengateConnectionAssignmentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->goldengateConnectionAssignmentName('[PROJECT]', '[LOCATION]', '[GOLDENGATE_CONNECTION_ASSIGNMENT]');
        $request = (new TestGoldengateConnectionAssignmentRequest())
            ->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/TestGoldengateConnectionAssignment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateAutonomousDatabaseTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.oracledatabase.v1.OracleDatabase/UpdateAutonomousDatabase', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getAutonomousDatabase();
        $this->assertProtobufEquals($autonomousDatabase, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
