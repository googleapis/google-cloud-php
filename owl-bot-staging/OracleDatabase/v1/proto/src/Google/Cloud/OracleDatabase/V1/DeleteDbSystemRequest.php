 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.DeleteDbSystemRequest</code>
 */
class DeleteDbSystemRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the DbSystem in the following format:
     ...
     *
     * @return \Google\Cloud\OracleDatabase\V1\DeleteDbSystemRequest
     *
     * @experimental
     */
