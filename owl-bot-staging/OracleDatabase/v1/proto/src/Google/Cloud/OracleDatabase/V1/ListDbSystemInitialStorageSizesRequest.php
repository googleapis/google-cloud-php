 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListDbSystemInitialStorageSizesRequest</code>
 */
class ListDbSystemInitialStorageSizesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent value for the DbSystemInitialStorageSize resource with
     *                       the format: projects/{project}/locations/{location}
     *                       Please see {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListDbSystemInitialStorageSizesRequest
     *
     * @experimental
     */
