 ...
 *
 * Generated from protobuf message <code>google.cloud.oracledatabase.v1.ListDbVersionsRequest</code>
 */
class ListDbVersionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent value for the DbVersion resource with the
     *                       format: projects/{project}/locations/{location}
     *                       Please see {@see OracleDatabaseClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\OracleDatabase\V1\ListDbVersionsRequest
     *
     * @experimental
     */
