 ...
 * Type of the backup.
 *
 * Protobuf type <code>google.cloud.redis.cluster.v1.Backup.BackupType</code>
 */
class BackupType
{
    /**
...
class_alias(BackupType::class, \Google\Cloud\Redis\Cluster\V1\Backup_BackupType::class);
