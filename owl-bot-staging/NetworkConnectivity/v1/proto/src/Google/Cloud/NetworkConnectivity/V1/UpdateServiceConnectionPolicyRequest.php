 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.UpdateServiceConnectionPolicyRequest</code>
 */
class UpdateServiceConnectionPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkconnectivity.v1.ServiceConnectionPolicy service_connection_policy = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\NetworkConnectivity\V1\ServiceConnectionPolicy $serviceConnectionPolicy Required. New values to be patched into the resource.
     ...
     *                                                                                              user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\UpdateServiceConnectionPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkConnectivity\V1\ServiceConnectionPolicy $serviceConnectionPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
