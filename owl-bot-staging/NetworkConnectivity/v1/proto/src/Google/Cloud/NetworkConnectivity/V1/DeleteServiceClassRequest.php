 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.DeleteServiceClassRequest</code>
 */
class DeleteServiceClassRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the ServiceClass to delete. Please see
     *                     {@see CrossNetworkAutomationServiceClient::serviceClassName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\DeleteServiceClassRequest
     *
     * @experimental
     */
