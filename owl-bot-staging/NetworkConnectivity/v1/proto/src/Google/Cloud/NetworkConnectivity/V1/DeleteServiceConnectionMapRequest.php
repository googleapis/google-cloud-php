 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.DeleteServiceConnectionMapRequest</code>
 */
class DeleteServiceConnectionMapRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the ServiceConnectionMap to delete. Please see
     *                     {@see CrossNetworkAutomationServiceClient::serviceConnectionMapName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\DeleteServiceConnectionMapRequest
     *
     * @experimental
     */
