 ...
 */
function list_multicloud_data_transfer_configs_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $dataTransferServiceClient->listMulticloudDataTransferConfigs($request);

        /** @var MulticloudDataTransferConfig $element */
...
function callSample(): void
{
    ...
    list_multicloud_data_transfer_configs_sample($formattedParent);
}
