 ...
 *
 * @param string $formattedName The name of the `MulticloudDataTransferConfig` resource to get. Please see
 *                              {@see DataTransferServiceClient::multicloudDataTransferConfigName()} for help formatting this field.
 */
function get_multicloud_data_transfer_config_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var MulticloudDataTransferConfig $response */
        $response = $dataTransferServiceClient->getMulticloudDataTransferConfig($request);
...
function callSample(): void
{
    ...
    get_multicloud_data_transfer_config_sample($formattedName);
}
