...
class PolicyBasedRoutingServiceGapicClient
{
    ...
    private static function getPolicyBasedRouteNameTemplate()
    {
        if (self::$policyBasedRouteNameTemplate == null) {
            self::$policyBasedRouteNameTemplate = new PathTemplate('projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}');
        }
     ...
     */
    public static function policyBasedRouteName($project, $location, $policyBasedRoute)
    {
     ...
     */
    public function createPolicyBasedRoute($parent, $policyBasedRoute, array $optionalArgs = [])
    {
