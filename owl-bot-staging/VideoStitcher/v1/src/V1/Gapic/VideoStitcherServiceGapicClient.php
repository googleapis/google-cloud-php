...
class VideoStitcherServiceGapicClient
{
    ...
    private static function getCdnKeyNameTemplate()
    {
        if (self::$cdnKeyNameTemplate == null) {
            self::$cdnKeyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/cdnKeys/{cdn_key}');
        }
    ...
    private static function getLiveAdTagDetailNameTemplate()
    {
        if (self::$liveAdTagDetailNameTemplate == null) {
            self::$liveAdTagDetailNameTemplate = new PathTemplate('projects/{project}/locations/{location}/liveSessions/{live_session}/liveAdTagDetails/{live_ad_tag_detail}');
        }
    ...
    private static function getLiveConfigNameTemplate()
    {
        if (self::$liveConfigNameTemplate == null) {
            self::$liveConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/liveConfigs/{live_config}');
        }
    ...
    private static function getLiveSessionNameTemplate()
    {
        if (self::$liveSessionNameTemplate == null) {
            self::$liveSessionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/liveSessions/{live_session}');
        }
    ...
    private static function getSlateNameTemplate()
    {
        if (self::$slateNameTemplate == null) {
            self::$slateNameTemplate = new PathTemplate('projects/{project}/locations/{location}/slates/{slate}');
        }
    ...
    private static function getVodAdTagDetailNameTemplate()
    {
        if (self::$vodAdTagDetailNameTemplate == null) {
            self::$vodAdTagDetailNameTemplate = new PathTemplate('projects/{project}/locations/{location}/vodSessions/{vod_session}/vodAdTagDetails/{vod_ad_tag_detail}');
        }
    ...
    private static function getVodConfigNameTemplate()
    {
        if (self::$vodConfigNameTemplate == null) {
            self::$vodConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/vodConfigs/{vod_config}');
        }
    ...
    private static function getVodSessionNameTemplate()
    {
        if (self::$vodSessionNameTemplate == null) {
            self::$vodSessionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/vodSessions/{vod_session}');
        }
    ...
    private static function getVodStitchDetailNameTemplate()
    {
        if (self::$vodStitchDetailNameTemplate == null) {
            self::$vodStitchDetailNameTemplate = new PathTemplate('projects/{project}/locations/{location}/vodSessions/{vod_session}/vodStitchDetails/{vod_stitch_detail}');
        }
     ...
     */
    public static function liveAdTagDetailName($project, $location, $liveSession, $liveAdTagDetail)
    {
     ...
     */
    public static function vodAdTagDetailName($project, $location, $vodSession, $vodAdTagDetail)
    {
     ...
     */
    public static function vodStitchDetailName($project, $location, $vodSession, $vodStitchDetail)
    {
     ...
     */
    public function createCdnKey($parent, $cdnKey, $cdnKeyId, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateCdnKey', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createLiveConfig($parent, $liveConfigId, $liveConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateLiveConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createLiveSession($parent, $liveSession, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateLiveSession', LiveSession::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createSlate($parent, $slateId, $slate, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateSlate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createVodConfig($parent, $vodConfigId, $vodConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateVodConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createVodSession($parent, $vodSession, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateVodSession', VodSession::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteCdnKey($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCdnKey', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteLiveConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteLiveConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSlate($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSlate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteVodConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteVodConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getCdnKey($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCdnKey', CdnKey::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getLiveAdTagDetail($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetLiveAdTagDetail', LiveAdTagDetail::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getLiveConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetLiveConfig', LiveConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getLiveSession($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetLiveSession', LiveSession::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getSlate($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetSlate', Slate::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getVodAdTagDetail($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetVodAdTagDetail', VodAdTagDetail::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getVodConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetVodConfig', VodConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getVodSession($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetVodSession', VodSession::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getVodStitchDetail($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetVodStitchDetail', VodStitchDetail::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listCdnKeys($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCdnKeys', $optionalArgs, ListCdnKeysResponse::class, $request);
    }
    ...
    public function listLiveAdTagDetails($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListLiveAdTagDetails', $optionalArgs, ListLiveAdTagDetailsResponse::class, $request);
    }
    ...
    public function listLiveConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListLiveConfigs', $optionalArgs, ListLiveConfigsResponse::class, $request);
    }
    ...
    public function listSlates($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSlates', $optionalArgs, ListSlatesResponse::class, $request);
    }
    ...
    public function listVodAdTagDetails($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListVodAdTagDetails', $optionalArgs, ListVodAdTagDetailsResponse::class, $request);
    }
    ...
    public function listVodConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListVodConfigs', $optionalArgs, ListVodConfigsResponse::class, $request);
    }
    ...
    public function listVodStitchDetails($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListVodStitchDetails', $optionalArgs, ListVodStitchDetailsResponse::class, $request);
    }
    ...
    public function updateCdnKey($cdnKey, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateCdnKey', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateLiveConfig($liveConfig, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateLiveConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateSlate($slate, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateSlate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateVodConfig($vodConfig, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateVodConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
