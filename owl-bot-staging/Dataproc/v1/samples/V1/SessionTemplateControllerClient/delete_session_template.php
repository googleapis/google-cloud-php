 ...
 *
 * @param string $formattedName The name of the session template resource to delete. Please see
 *                              {@see SessionTemplateControllerClient::sessionTemplateName()} for help formatting this field.
 */
function delete_session_template_sample(string $formattedName): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    delete_session_template_sample($formattedName);
}
// [END dataproc_v1_generated_SessionTemplateController_DeleteSessionTemplate_sync]
