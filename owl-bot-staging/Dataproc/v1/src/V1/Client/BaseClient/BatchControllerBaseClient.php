 ...
 */
abstract class BatchControllerBaseClient
{
     ...
     */
    public static function batchName(string $project, string $location, string $batch): string
    {
        return self::getPathTemplate('batch')->render([
            'project' => $project,
            'location' => $location,
            'batch' => $batch,
        ]);
     ...
     *
     * The async variant is {@see self::createBatchAsync()} .
     *
     ...
     */
    public function createBatch(CreateBatchRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateBatch', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see self::deleteBatchAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteBatch(DeleteBatchRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteBatch', $request, $callOptions)->wait();
    }

    /**
     * Gets the batch workload resource representation.
     *
     * The async variant is {@see self::getBatchAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getBatch(GetBatchRequest $request, array $callOptions = []): Batch
    {
        return $this->startApiCall('GetBatch', $request, $callOptions)->wait();
    }

    /**
     * Lists batch workloads.
     *
     * The async variant is {@see self::listBatchesAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listBatches(ListBatchesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListBatches', $request, $callOptions);
    }
}
