...
final class NodeGroupControllerClient
{
     ...
     *           $options = new NodeGroupControllerClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<NodeGroup>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function createNodeGroup(CreateNodeGroupRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateNodeGroup', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getNodeGroup(GetNodeGroupRequest $request, array $callOptions = []): NodeGroup
    {
        return $this->startApiCall('GetNodeGroup', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function resizeNodeGroup(ResizeNodeGroupRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ResizeNodeGroup', $request, $callOptions)->wait();
    }
