...
class BatchServiceGapicClient
{
    ...
    private static function getTaskNameTemplate()
    {
        if (self::$taskNameTemplate == null) {
            self::$taskNameTemplate = new PathTemplate('projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}/tasks/{task}');
        }
    ...
    private static function getTaskGroupNameTemplate()
    {
        if (self::$taskGroupNameTemplate == null) {
            self::$taskGroupNameTemplate = new PathTemplate('projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}');
        }
     ...
     */
    public static function taskName($project, $location, $job, $taskGroup, $task)
    {
