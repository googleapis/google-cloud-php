...
namespace Google\Cloud\Spanner\Admin\Instance\V1\Client\BaseClient;
 ...
 */
abstract class InstanceAdminBaseClient
{
     ...
     *
     * The async variant is {@see self::createInstanceConfigAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteInstanceConfigAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getInstanceConfigAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listInstanceConfigOperationsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listInstanceConfigsAsync()} .
     *
