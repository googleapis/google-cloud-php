 ...
 *
 * @param string $formattedName The name of the requested instance configuration. Values are of
 ...
 */
function get_instance_config_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var InstanceConfig $response */
        $response = $instanceAdminClient->getInstanceConfig($request);
...
function callSample(): void
{
    ...
    get_instance_config_sample($formattedName);
}
