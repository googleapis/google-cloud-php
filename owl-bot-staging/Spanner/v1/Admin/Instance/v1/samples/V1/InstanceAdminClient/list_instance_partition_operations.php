 ...
 *
 * @param string $formattedParent The parent instance of the instance partition operations.
 ...
 */
function list_instance_partition_operations_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $instanceAdminClient->listInstancePartitionOperations($request);
...
function callSample(): void
{
    ...
    list_instance_partition_operations_sample($formattedParent);
}
