 ...
 *
 * @param string $formattedName The name of the requested instance partition. Values are of
 *                              the form
 ...
 */
function get_instance_partition_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var InstancePartition $response */
        $response = $instanceAdminClient->getInstancePartition($request);
...
function callSample(): void
{
    ...
    get_instance_partition_sample($formattedName);
}
