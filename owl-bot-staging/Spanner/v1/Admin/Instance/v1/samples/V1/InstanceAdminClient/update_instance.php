 ...
 * @param string $formattedConfig     The name of the instance's configuration. Values are of the form
...
function update_instance_sample(
    ...
    try {
        ...
        $response = $instanceAdminClient->updateInstance($instance, $formattedConfig, $fieldMask);
...
{
    $instanceName = '[NAME]';
    $formattedConfig = InstanceAdminClient::instanceConfigName('[PROJECT]', '[INSTANCE_CONFIG]');
    $instanceDisplayName = '[DISPLAY_NAME]';

    update_instance_sample($instanceName, $formattedConfig, $instanceDisplayName);
}
