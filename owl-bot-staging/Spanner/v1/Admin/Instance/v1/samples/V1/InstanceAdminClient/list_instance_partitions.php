 ...
 *
 * @param string $formattedParent The instance whose instance partitions should be listed. Values
 ...
 */
function list_instance_partitions_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $instanceAdminClient->listInstancePartitions($request);

        /** @var InstancePartition $element */
...
function callSample(): void
{
    ...
    list_instance_partitions_sample($formattedParent);
}
