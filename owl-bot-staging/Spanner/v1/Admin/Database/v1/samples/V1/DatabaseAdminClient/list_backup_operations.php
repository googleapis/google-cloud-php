 ...
 *
 * @param string $formattedParent The instance of the backup operations. Values are of
 ...
 */
function list_backup_operations_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $databaseAdminClient->listBackupOperations($formattedParent);
...
function callSample(): void
{
    ...
    list_backup_operations_sample($formattedParent);
}
