 ...
 *
 * @param string $formattedParent Database is the parent resource whose backup schedules should be
 *                                listed. Values are of the form
 *                                projects/<project>/instances/<instance>/databases/<database>
 *                                Please see {@see DatabaseAdminClient::databaseName()} for help formatting this field.
 */
function list_backup_schedules_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $databaseAdminClient->listBackupSchedules($request);

        /** @var BackupSchedule $element */
