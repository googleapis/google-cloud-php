...
class SpannerGapicClient
{
     ...
     * @throws ApiException if the remote call fails
     */
    public function batchWrite($session, $mutationGroups, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['excludeTxnFromChangeStreams'])) {
            $request->setExcludeTxnFromChangeStreams($optionalArgs['excludeTxnFromChangeStreams']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('BatchWrite', BatchWriteResponse::class, $optionalArgs, $request, Call::SERVER_STREAMING_CALL);
    }
    ...
    public function executeSql($session, $sql, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['directedReadOptions'])) {
            $request->setDirectedReadOptions($optionalArgs['directedReadOptions']);
        }
