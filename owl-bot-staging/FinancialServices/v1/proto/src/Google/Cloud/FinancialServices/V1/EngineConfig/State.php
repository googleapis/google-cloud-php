 ...
 *
 * Protobuf type <code>google.cloud.financialservices.v1.EngineConfig.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\FinancialServices\V1\EngineConfig_State::class);
