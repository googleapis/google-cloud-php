 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.PredictionResult</code>
 */
class PredictionResult extends \Google\Protobuf\Internal\Message
{
     ...
     * etc.)
     *
     * Generated from protobuf field <code>.google.cloud.financialservices.v1.PredictionResult.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>int32 prediction_periods = 10;</code>
     */
    protected $prediction_periods = 0;
    /**
     * Required. Where to write the output of the predictions.
     *
     * Generated from protobuf field <code>.google.cloud.financialservices.v1.PredictionResult.Outputs outputs = 11 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           [date_range][google.cloud.financialservices.v1.Dataset.date_range] of the
     *           dataset.
     *     @type int $prediction_periods
     *           The number of consecutive months to produce predictions for, ending with
     *           the last full month prior to
     *           [end_time][google.cloud.financialservices.v1.PredictionResult.end_time]
     *           according to the dataset's timezone.
     *     @type \Google\Cloud\FinancialServices\V1\PredictionResult\Outputs $outputs
     *           Required. Where to write the output of the predictions.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\FinancialServices\V1\PredictionResult\State::class);
        $this->state = $var;
     ...
     * @return int
     */
    public function getPredictionPeriods()
    {
        return $this->prediction_periods;
    }
     ...
     * @return $this
     */
    public function setPredictionPeriods($var)
    {
        GPBUtil::checkInt32($var);
        $this->prediction_periods = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.financialservices.v1.PredictionResult.Outputs outputs = 11 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\FinancialServices\V1\PredictionResult\Outputs|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.financialservices.v1.PredictionResult.Outputs outputs = 11 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\FinancialServices\V1\PredictionResult\Outputs $var
     * @return $this
     */
    public function setOutputs($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\FinancialServices\V1\PredictionResult\Outputs::class);
        $this->outputs = $var;
