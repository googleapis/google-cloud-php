...
namespace Google\Cloud\FinancialServices\V1\Dataset;
 ...
 *
 * Protobuf type <code>google.cloud.financialservices.v1.Dataset.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\FinancialServices\V1\Dataset_State::class);
