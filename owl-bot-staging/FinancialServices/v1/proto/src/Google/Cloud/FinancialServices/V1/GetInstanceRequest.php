 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.GetInstanceRequest</code>
 */
class GetInstanceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Instance. Please see
     *                     {@see AMLClient::instanceName()} for help formatting this field.
     *
     * @return \Google\Cloud\FinancialServices\V1\GetInstanceRequest
     *
     * @experimental
     */
