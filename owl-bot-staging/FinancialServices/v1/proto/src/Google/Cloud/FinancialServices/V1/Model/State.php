...
namespace Google\Cloud\FinancialServices\V1\Model;
 ...
 *
 * Protobuf type <code>google.cloud.financialservices.v1.Model.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\FinancialServices\V1\Model_State::class);
