 ...
 *
 * Protobuf type <code>google.cloud.financialservices.v1.BacktestResult.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\FinancialServices\V1\BacktestResult_State::class);
