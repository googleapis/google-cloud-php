 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchResponse.Summary.SummaryWithMetadata</code>
 */
class SummaryWithMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationMetadata citation_metadata = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationMetadata citation_metadata = 2;</code>
     * @return \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\CitationMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationMetadata citation_metadata = 2;</code>
     * @param \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\CitationMetadata $var
     * @return $this
     */
    public function setCitationMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\CitationMetadata::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\Reference::class);
        $this->references = $arr;
...
class_alias(SummaryWithMetadata::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_Summary_SummaryWithMetadata::class);
