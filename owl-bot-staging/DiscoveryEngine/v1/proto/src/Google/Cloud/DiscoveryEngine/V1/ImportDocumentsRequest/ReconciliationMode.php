 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1.ImportDocumentsRequest.ReconciliationMode</code>
 */
...
class_alias(ReconciliationMode::class, \Google\Cloud\DiscoveryEngine\V1\ImportDocumentsRequest_ReconciliationMode::class);
