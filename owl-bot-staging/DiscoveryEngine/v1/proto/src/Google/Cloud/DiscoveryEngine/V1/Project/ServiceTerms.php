 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.Project.ServiceTerms</code>
 */
class ServiceTerms extends \Google\Protobuf\Internal\Message
{
     ...
     * still pending.
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Project.ServiceTerms.State state = 4;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DiscoveryEngine\V1\Project\ServiceTerms\State::class);
        $this->state = $var;
...
class_alias(ServiceTerms::class, \Google\Cloud\DiscoveryEngine\V1\Project_ServiceTerms::class);
