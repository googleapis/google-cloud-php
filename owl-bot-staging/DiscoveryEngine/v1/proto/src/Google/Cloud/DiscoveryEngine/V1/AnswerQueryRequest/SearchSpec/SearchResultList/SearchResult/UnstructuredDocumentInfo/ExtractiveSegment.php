...
class_alias(ExtractiveSegment::class, \Google\Cloud\DiscoveryEngine\V1\AnswerQueryRequest_SearchSpec_SearchResultList_SearchResult_UnstructuredDocumentInfo_ExtractiveSegment::class);
