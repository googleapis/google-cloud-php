 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1.AssistAnswer.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DiscoveryEngine\V1\AssistAnswer_State::class);
