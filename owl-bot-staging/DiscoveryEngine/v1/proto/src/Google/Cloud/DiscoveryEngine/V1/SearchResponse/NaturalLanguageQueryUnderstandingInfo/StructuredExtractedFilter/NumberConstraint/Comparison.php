...
class_alias(Comparison::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_NumberConstraint_Comparison::class);
