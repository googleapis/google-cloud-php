...
namespace Google\Cloud\DiscoveryEngine\V1\SuggestionDenyListEntry;
 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1.SuggestionDenyListEntry.MatchOperator</code>
 */
class MatchOperator
{
    /**
...
class_alias(MatchOperator::class, \Google\Cloud\DiscoveryEngine\V1\SuggestionDenyListEntry_MatchOperator::class);
