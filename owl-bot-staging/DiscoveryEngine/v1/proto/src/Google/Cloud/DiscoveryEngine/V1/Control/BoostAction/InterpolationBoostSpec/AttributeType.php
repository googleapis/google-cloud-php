 ...
 * applied.
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1.Control.BoostAction.InterpolationBoostSpec.AttributeType</code>
 */
class AttributeType
{
    /**
...
class_alias(AttributeType::class, \Google\Cloud\DiscoveryEngine\V1\Control_BoostAction_InterpolationBoostSpec_AttributeType::class);
