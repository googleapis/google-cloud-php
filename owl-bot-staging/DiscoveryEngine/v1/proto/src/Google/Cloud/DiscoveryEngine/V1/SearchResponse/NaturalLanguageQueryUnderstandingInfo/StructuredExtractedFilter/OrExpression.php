 ...
 * Logical `Or` operator.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchResponse.NaturalLanguageQueryUnderstandingInfo.StructuredExtractedFilter.OrExpression</code>
 */
class OrExpression extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(OrExpression::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_NaturalLanguageQueryUnderstandingInfo_StructuredExtractedFilter_OrExpression::class);
