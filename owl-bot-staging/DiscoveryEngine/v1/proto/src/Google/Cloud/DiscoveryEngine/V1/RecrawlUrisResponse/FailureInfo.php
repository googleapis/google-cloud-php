 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.RecrawlUrisResponse.FailureInfo</code>
 */
class FailureInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\RecrawlUrisResponse\FailureInfo\FailureReason::class);
...
class_alias(FailureInfo::class, \Google\Cloud\DiscoveryEngine\V1\RecrawlUrisResponse_FailureInfo::class);
