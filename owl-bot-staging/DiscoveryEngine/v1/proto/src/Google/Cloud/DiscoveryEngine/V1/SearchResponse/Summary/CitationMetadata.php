 ...
 * Citation metadata.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchResponse.Summary.CitationMetadata</code>
 */
class CitationMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\Citation::class);
        $this->citations = $arr;
...
class_alias(CitationMetadata::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_Summary_CitationMetadata::class);
