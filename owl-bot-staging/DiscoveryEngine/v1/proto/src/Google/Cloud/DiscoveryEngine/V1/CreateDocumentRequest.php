 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.CreateDocumentRequest</code>
 */
class CreateDocumentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * create.
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Document document = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\DiscoveryEngine\V1\Document $document, string $documentId): self
    {
        return (new self())
            ->setParent($parent)
