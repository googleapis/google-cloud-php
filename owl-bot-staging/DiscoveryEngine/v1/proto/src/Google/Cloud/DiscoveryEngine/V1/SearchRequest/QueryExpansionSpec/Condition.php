...
namespace Google\Cloud\DiscoveryEngine\V1\SearchRequest\QueryExpansionSpec;
 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1.SearchRequest.QueryExpansionSpec.Condition</code>
 */
class Condition
{
    /**
...
class_alias(Condition::class, \Google\Cloud\DiscoveryEngine\V1\SearchRequest_QueryExpansionSpec_Condition::class);
