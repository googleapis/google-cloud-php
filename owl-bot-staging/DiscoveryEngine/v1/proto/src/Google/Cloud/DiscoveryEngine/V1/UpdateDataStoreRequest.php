 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.UpdateDataStoreRequest</code>
 */
class UpdateDataStoreRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.DataStore data_store = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                               is returned.
     *
     * @return \Google\Cloud\DiscoveryEngine\V1\UpdateDataStoreRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\DiscoveryEngine\V1\DataStore $dataStore, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
