 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchResponse.Summary.Citation</code>
 */
class Citation extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\SearchResponse\Summary\CitationSource::class);
        $this->sources = $arr;
...
class_alias(Citation::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_Summary_Citation::class);
