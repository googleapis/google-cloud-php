 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchResponse.Facet.FacetValue</code>
 */
class FacetValue extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Google\Cloud\DiscoveryEngine\V1\Interval $interval
     ...
     * [SearchRequest.FacetSpec.FacetKey.intervals][google.cloud.discoveryengine.v1.SearchRequest.FacetSpec.FacetKey.intervals].
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Interval interval = 2;</code>
     * @return \Google\Cloud\DiscoveryEngine\V1\Interval|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DiscoveryEngine\V1\Interval::class);
...
class_alias(FacetValue::class, \Google\Cloud\DiscoveryEngine\V1\SearchResponse_Facet_FacetValue::class);
