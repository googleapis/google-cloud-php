...
class_alias(UnstructuredDocumentInfo::class, \Google\Cloud\DiscoveryEngine\V1\AnswerQueryRequest_SearchSpec_SearchResultList_SearchResult_UnstructuredDocumentInfo::class);
