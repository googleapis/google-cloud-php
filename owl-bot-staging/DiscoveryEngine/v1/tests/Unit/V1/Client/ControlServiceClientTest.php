...
use Google\Cloud\DiscoveryEngine\V1\ListControlsResponse;
...
class ControlServiceClientTest extends GeneratedTest
{
    ...
    public function createControlTest()
    {
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1.ControlService/CreateControl', $actualFuncCall);
    ...
    public function deleteControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.ControlService/DeleteControl', $actualFuncCall);
    ...
    public function getControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.ControlService/GetControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listControlsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.ControlService/ListControls', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.ControlService/UpdateControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getControl();
        $this->assertProtobufEquals($control, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
