...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1.ControlService' => [
            'CreateControl' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/dataStores/*}/controls',
                'body' => 'control',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{parent=projects/*/locations/*/collections/*/dataStores/*}/controls',
                        'body' => 'control',
                        'queryParams' => [
                            'control_id',
                        ],
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{parent=projects/*/locations/*/collections/*/engines/*}/controls',
                        'body' => 'control',
                        'queryParams' => [
                            'control_id',
                        ],
            ...
            'DeleteControl' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/dataStores/*/controls/*}',
                'additionalBindings' => [
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1/{name=projects/*/locations/*/collections/*/dataStores/*/controls/*}',
                    ],
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1/{name=projects/*/locations/*/collections/*/engines/*/controls/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'UpdateControl' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{control.name=projects/*/locations/*/dataStores/*/controls/*}',
                'body' => 'control',
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{control.name=projects/*/locations/*/collections/*/dataStores/*/controls/*}',
                        'body' => 'control',
                    ],
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{control.name=projects/*/locations/*/collections/*/engines/*/controls/*}',
                        'body' => 'control',
                    ],
                ],
                'placeholders' => [
