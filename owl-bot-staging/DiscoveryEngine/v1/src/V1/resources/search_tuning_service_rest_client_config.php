...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1.SearchTuningService' => [
            'ListCustomModels' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{data_store=projects/*/locations/*/collections/*/dataStores/*}/customModels',
                'placeholders' => [
                    'data_store' => [
                        'getters' => [
                            'getDataStore',
            ...
            'TrainCustomModel' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{data_store=projects/*/locations/*/collections/*/dataStores/*}:trainCustomModel',
                'body' => '*',
                'placeholders' => [
                    'data_store' => [
                        'getters' => [
