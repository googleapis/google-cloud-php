 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/recommendation_service.proto
 ...
 *
 * @method PromiseInterface<RecommendResponse> recommendAsync(RecommendRequest $request, array $optionalArgs = [])
 */
final class RecommendationServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.RecommendationService';
     ...
     *
     * @example samples/V1/RecommendationServiceClient/recommend.php
     *
