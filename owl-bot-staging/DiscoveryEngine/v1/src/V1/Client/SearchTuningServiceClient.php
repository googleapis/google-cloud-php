 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/search_tuning_service.proto
...
final class SearchTuningServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.SearchTuningService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/search_tuning_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/search_tuning_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/search_tuning_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/search_tuning_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\SearchTuningServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SearchTuningServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/SearchTuningServiceClient/list_custom_models.php
     *
     ...
     *
     * The async variant is {@see SearchTuningServiceClient::trainCustomModelAsync()} .
     *
     * @example samples/V1/SearchTuningServiceClient/train_custom_model.php
     *
     * @param TrainCustomModelRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return OperationResponse<TrainCustomModelResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function trainCustomModel(TrainCustomModelRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('TrainCustomModel', $request, $callOptions)->wait();
    }
}
