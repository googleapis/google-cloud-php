 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/session_service.proto
...
final class SessionServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.SessionService';
     ...
     */
    public static function assistAnswerName(string $project, string $location, string $collection, string $engine, string $session, string $assistAnswer): string
    {
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\SessionServiceClient;
