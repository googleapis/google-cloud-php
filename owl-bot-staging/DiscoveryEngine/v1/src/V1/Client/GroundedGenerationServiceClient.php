 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/grounded_generation_service.proto
...
final class GroundedGenerationServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.GroundedGenerationService';
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\GroundedGenerationServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new GroundedGenerationServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/GroundedGenerationServiceClient/check_grounding.php
     *
