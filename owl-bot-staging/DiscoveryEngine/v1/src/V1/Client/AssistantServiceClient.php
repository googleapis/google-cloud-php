 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/assistant_service.proto
 ...
 */
final class AssistantServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.AssistantService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/assistant_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/assistant_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/assistant_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/assistant_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a assistant
     * resource.
     *
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\AssistantServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AssistantServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/AssistantServiceClient/stream_assist.php
     *
     * @param StreamAssistRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return ServerStream<StreamAssistResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function streamAssist(StreamAssistRequest $request, array $callOptions = []): ServerStream
    {
        return $this->startApiCall('StreamAssist', $request, $callOptions);
    }
}
