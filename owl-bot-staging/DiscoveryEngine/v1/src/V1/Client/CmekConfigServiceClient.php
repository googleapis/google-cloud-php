 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/cmek_config_service.proto
 ...
 *
 * @method PromiseInterface<OperationResponse> deleteCmekConfigAsync(DeleteCmekConfigRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<CmekConfig> getCmekConfigAsync(GetCmekConfigRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<ListCmekConfigsResponse> listCmekConfigsAsync(ListCmekConfigsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> updateCmekConfigAsync(UpdateCmekConfigRequest $request, array $optionalArgs = [])
 */
final class CmekConfigServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.CmekConfigService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/cmek_config_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/cmek_config_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/cmek_config_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/cmek_config_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\CmekConfigServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CmekConfigServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see CmekConfigServiceClient::deleteCmekConfigAsync()} .
     *
     * @example samples/V1/CmekConfigServiceClient/delete_cmek_config.php
     *
     * @param DeleteCmekConfigRequest $request     A request to house fields associated with the call.
     ...
     */
    public function deleteCmekConfig(DeleteCmekConfigRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteCmekConfig', $request, $callOptions)->wait();
    }

    /**
     * Gets the [CmekConfig][google.cloud.discoveryengine.v1.CmekConfig].
     *
     * The async variant is {@see CmekConfigServiceClient::getCmekConfigAsync()} .
     *
     * @example samples/V1/CmekConfigServiceClient/get_cmek_config.php
     *
     ...
     * with the project.
     *
     * The async variant is {@see CmekConfigServiceClient::listCmekConfigsAsync()} .
     *
     * @example samples/V1/CmekConfigServiceClient/list_cmek_configs.php
     *
     * @param ListCmekConfigsRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return ListCmekConfigsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function listCmekConfigs(ListCmekConfigsRequest $request, array $callOptions = []): ListCmekConfigsResponse
    {
        return $this->startApiCall('ListCmekConfigs', $request, $callOptions)->wait();
    }
     ...
     * selected location.
     *
     * The async variant is {@see CmekConfigServiceClient::updateCmekConfigAsync()} .
     *
     * @example samples/V1/CmekConfigServiceClient/update_cmek_config.php
     *
     ...
     * }
     *
     * @return OperationResponse<CmekConfig>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateCmekConfig(UpdateCmekConfigRequest $request, array $callOptions = []): OperationResponse
    {
