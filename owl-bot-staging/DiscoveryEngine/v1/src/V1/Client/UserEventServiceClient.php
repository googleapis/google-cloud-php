 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/user_event_service.proto
...
final class UserEventServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.UserEventService';
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\UserEventServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new UserEventServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
