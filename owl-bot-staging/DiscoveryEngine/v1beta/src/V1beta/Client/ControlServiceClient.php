 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1beta/control_service.proto
...
final class ControlServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1beta.ControlService';
     ...
     * @experimental
     */
    public static function controlName(string $project, string $location, string $dataStore, string $control): string
    {
        return self::getPathTemplate('control')->render([
            'project' => $project,
            'location' => $location,
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * project_location_collection_data_store_control resource.
     *
     * @param string $project
     * @param string $location
     * @param string $collection
     ...
     * @param string $control
     *
     * @return string The formatted project_location_collection_data_store_control resource.
     *
     * @experimental
     */
    public static function projectLocationCollectionDataStoreControlName(string $project, string $location, string $collection, string $dataStore, string $control): string
    {
        return self::getPathTemplate('projectLocationCollectionDataStoreControl')->render([
            'project' => $project,
            'location' => $location,
            'collection' => $collection,
            'data_store' => $dataStore,
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * project_location_collection_engine_control resource.
     *
     * @param string $project
     * @param string $location
     * @param string $collection
     ...
     * @param string $control
     *
     * @return string The formatted project_location_collection_engine_control resource.
     *
     * @experimental
     */
    public static function projectLocationCollectionEngineControlName(string $project, string $location, string $collection, string $engine, string $control): string
    {
        return self::getPathTemplate('projectLocationCollectionEngineControl')->render([
            'project' => $project,
            'location' => $location,
            'collection' => $collection,
            'engine' => $engine,
     ...
     * @param string $control
     *
     * @return string The formatted project_location_data_store_control resource.
     *
     * @experimental
     */
    public static function projectLocationDataStoreControlName(string $project, string $location, string $dataStore, string $control): string
    {
        return self::getPathTemplate('projectLocationDataStoreControl')->render([
            'project' => $project,
            'location' => $location,
            'data_store' => $dataStore,
            'control' => $control,
     ...
     *
     * @example samples/V1beta/ControlServiceClient/create_control.php
     *
     ...
     * @experimental
     */
    public function createControl(CreateControlRequest $request, array $callOptions = []): Control
    {
        return $this->startApiCall('CreateControl', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1beta/ControlServiceClient/delete_control.php
     *
     ...
     * @experimental
     */
    public function deleteControl(DeleteControlRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteControl', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1beta/ControlServiceClient/get_control.php
     *
     ...
     * @experimental
     */
    public function getControl(GetControlRequest $request, array $callOptions = []): Control
    {
        return $this->startApiCall('GetControl', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1beta/ControlServiceClient/list_controls.php
     *
     ...
     *
     * @example samples/V1beta/ControlServiceClient/update_control.php
     *
     ...
     * @experimental
     */
    public function updateControl(UpdateControlRequest $request, array $callOptions = []): Control
    {
        return $this->startApiCall('UpdateControl', $request, $callOptions)->wait();
    }
}
