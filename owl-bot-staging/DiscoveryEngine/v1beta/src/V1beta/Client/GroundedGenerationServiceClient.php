 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1beta/grounded_generation_service.proto
...
final class GroundedGenerationServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1beta.GroundedGenerationService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/grounded_generation_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/grounded_generation_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/grounded_generation_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     * @param string $groundingConfig
     *
     * @return string The formatted grounding_config resource.
     *
     * @experimental
     */
    public static function groundingConfigName(string $project, string $location, string $groundingConfig): string
    {
        return self::getPathTemplate('groundingConfig')->render([
            'project' => $project,
            'location' => $location,
     ...
     * {@see GroundedGenerationServiceClient::checkGroundingAsync()} .
     *
     * @example samples/V1beta/GroundedGenerationServiceClient/check_grounding.php
     *
     * @param CheckGroundingRequest $request     A request to house fields associated with the call.
