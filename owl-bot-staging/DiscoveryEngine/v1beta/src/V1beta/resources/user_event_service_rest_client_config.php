...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1beta.UserEventService' => [
            'CollectUserEvent' => [
                'method' => 'get',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*}/userEvents:collect',
                'additionalBindings' => [
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*}/userEvents:collect',
                    ],
                ],
                'placeholders' => [
                    'parent' => [
            ...
            'ImportUserEvents' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*}/userEvents:import',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*}/userEvents:import',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'WriteUserEvent' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*}/userEvents:write',
                'body' => 'user_event',
                'additionalBindings' => [
                    [
                        'method' => 'post',
