 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason</code>
 */
...
class_alias(AnswerSkippedReason::class, \Google\Cloud\DiscoveryEngine\V1beta\Answer_AnswerSkippedReason::class);
