 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.Condition.QueryTerm</code>
 */
...
class_alias(QueryTerm::class, \Google\Cloud\DiscoveryEngine\V1beta\Condition_QueryTerm::class);
