 ...
 * the config.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.DocumentProcessingConfig</code>
 */
class DocumentProcessingConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * parsing.
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.DocumentProcessingConfig.ParsingConfig default_parsing_config = 4;</code>
     */
     ...
     * or layout parsing are supported.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.discoveryengine.v1beta.DocumentProcessingConfig.ParsingConfig> parsing_config_overrides = 5;</code>
     */
     ...
     *           Format:
     *           `projects/&#42;&#47;locations/&#42;&#47;collections/&#42;&#47;dataStores/&#42;&#47;documentProcessingConfig`.
     *     @type \Google\Cloud\DiscoveryEngine\V1beta\DocumentProcessingConfig\ParsingConfig $default_parsing_config
     *           Configurations for default Document parser.
     *           If not specified, we will configure it as default DigitalParsingConfig, and
     *           the default parsing config will be applied to all file types for Document
     *           parsing.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.DocumentProcessingConfig.ParsingConfig default_parsing_config = 4;</code>
     * @return \Google\Cloud\DiscoveryEngine\V1beta\DocumentProcessingConfig\ParsingConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.DocumentProcessingConfig.ParsingConfig default_parsing_config = 4;</code>
     * @param \Google\Cloud\DiscoveryEngine\V1beta\DocumentProcessingConfig\ParsingConfig $var
     * @return $this
     */
    public function setDefaultParsingConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DiscoveryEngine\V1beta\DocumentProcessingConfig\ParsingConfig::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1beta\DocumentProcessingConfig\ParsingConfig::class);
