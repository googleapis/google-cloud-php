 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.AnswerQueryRequest.SafetySpec</code>
 */
...
class_alias(SafetySpec::class, \Google\Cloud\DiscoveryEngine\V1beta\AnswerQueryRequest_SafetySpec::class);
