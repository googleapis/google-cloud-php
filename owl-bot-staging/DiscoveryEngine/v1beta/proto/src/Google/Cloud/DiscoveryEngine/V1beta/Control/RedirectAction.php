 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.Control.RedirectAction</code>
 */
...
class_alias(RedirectAction::class, \Google\Cloud\DiscoveryEngine\V1beta\Control_RedirectAction::class);
