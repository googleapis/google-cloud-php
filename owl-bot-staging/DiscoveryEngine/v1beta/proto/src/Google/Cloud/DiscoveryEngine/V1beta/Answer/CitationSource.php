 ...
 * Citation source.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.Answer.CitationSource</code>
 */
...
class_alias(CitationSource::class, \Google\Cloud\DiscoveryEngine\V1beta\Answer_CitationSource::class);
