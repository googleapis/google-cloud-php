 ...
 * Chunk information.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo</code>
 */
class ChunkInfo extends \Google\Protobuf\Internal\Message
{
     ...
     * Document metadata.
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata document_metadata = 4;</code>
     */
     ...
     *           Relevance score.
     *     @type \Google\Cloud\DiscoveryEngine\V1beta\Answer\Reference\ChunkInfo\DocumentMetadata $document_metadata
     *           Document metadata.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata document_metadata = 4;</code>
     * @return \Google\Cloud\DiscoveryEngine\V1beta\Answer\Reference\ChunkInfo\DocumentMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Answer.Reference.ChunkInfo.DocumentMetadata document_metadata = 4;</code>
     * @param \Google\Cloud\DiscoveryEngine\V1beta\Answer\Reference\ChunkInfo\DocumentMetadata $var
     * @return $this
     */
    public function setDocumentMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DiscoveryEngine\V1beta\Answer\Reference\ChunkInfo\DocumentMetadata::class);
...
class_alias(ChunkInfo::class, \Google\Cloud\DiscoveryEngine\V1beta\Answer_Reference_ChunkInfo::class);
