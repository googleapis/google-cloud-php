 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1beta.TargetSite.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\DiscoveryEngine\V1beta\TargetSite_Type::class);
