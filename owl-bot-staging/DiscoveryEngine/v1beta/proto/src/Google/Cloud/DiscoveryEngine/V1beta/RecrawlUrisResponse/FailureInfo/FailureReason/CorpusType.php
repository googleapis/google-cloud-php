...
namespace Google\Cloud\DiscoveryEngine\V1beta\RecrawlUrisResponse\FailureInfo\FailureReason;
 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1beta.RecrawlUrisResponse.FailureInfo.FailureReason.CorpusType</code>
 */
class CorpusType
{
    /**
...
class_alias(CorpusType::class, \Google\Cloud\DiscoveryEngine\V1beta\RecrawlUrisResponse_FailureInfo_FailureReason_CorpusType::class);
