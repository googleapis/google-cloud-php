...
use Google\Cloud\DiscoveryEngine\V1beta\Client\RankServiceClient;
use Google\Cloud\DiscoveryEngine\V1beta\RankRequest;
use Google\Cloud\DiscoveryEngine\V1beta\RankResponse;
use Google\Rpc\Code;
use stdClass;
...
class RankServiceClientTest extends GeneratedTest
{
    ...
    public function rankTest()
    {
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1beta.RankService/Rank', $actualFuncCall);
