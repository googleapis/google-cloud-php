...
use Google\Cloud\DiscoveryEngine\V1beta\DeleteControlRequest;
use Google\Cloud\DiscoveryEngine\V1beta\GetControlRequest;
use Google\Cloud\DiscoveryEngine\V1beta\ListControlsRequest;
use Google\Cloud\DiscoveryEngine\V1beta\ListControlsResponse;
...
class ControlServiceClientTest extends GeneratedTest
{
    ...
    public function createControlTest()
    {
        ...
        $control->setSolutionType($controlSolutionType);
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ControlService/CreateControl', $actualFuncCall);
    ...
    public function deleteControlTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->controlName('[PROJECT]', '[LOCATION]', '[DATA_STORE]', '[CONTROL]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ControlService/DeleteControl', $actualFuncCall);
    ...
    public function getControlTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ControlService/GetControl', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listControlsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ControlService/ListControls', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
