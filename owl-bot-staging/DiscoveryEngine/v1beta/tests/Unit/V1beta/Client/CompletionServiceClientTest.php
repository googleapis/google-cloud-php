...
class CompletionServiceClientTest extends GeneratedTest
{
    ...
    public function importSuggestionDenyListEntriesTest()
    {
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1beta.CompletionService/ImportSuggestionDenyListEntries', $actualApiFuncCall);
    ...
    public function purgeSuggestionDenyListEntriesTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.CompletionService/PurgeSuggestionDenyListEntries', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
