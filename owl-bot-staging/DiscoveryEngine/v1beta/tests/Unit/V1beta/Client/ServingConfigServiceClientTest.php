...
class ServingConfigServiceClientTest extends GeneratedTest
{
    ...
    public function getServingConfigTest()
    {
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ServingConfigService/GetServingConfig', $actualFuncCall);
    ...
    public function listServingConfigsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ServingConfigService/ListServingConfigs', $actualFuncCall);
    ...
    public function updateServingConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1beta.ServingConfigService/UpdateServingConfig', $actualFuncCall);
