 ...
 *
 * Protobuf type <code>google.cloud.workflows.v1.Workflow.CallLogLevel</code>
 */
class CallLogLevel
{
    /**
...
class_alias(CallLogLevel::class, \Google\Cloud\Workflows\V1\Workflow_CallLogLevel::class);
