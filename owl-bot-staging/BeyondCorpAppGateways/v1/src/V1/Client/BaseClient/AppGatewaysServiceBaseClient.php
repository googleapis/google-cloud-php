 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/beyondcorp/appgateways/v1/app_gateways_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\BeyondCorp\AppGateways\V1\Client\BaseClient;
 ...
 * @internal
 *
 * @method PromiseInterface createAppGatewayAsync(CreateAppGatewayRequest $request, array $optionalArgs = [])
 * @method PromiseInterface deleteAppGatewayAsync(DeleteAppGatewayRequest $request, array $optionalArgs = [])
 * @method PromiseInterface getAppGatewayAsync(GetAppGatewayRequest $request, array $optionalArgs = [])
 * @method PromiseInterface listAppGatewaysAsync(ListAppGatewaysRequest $request, array $optionalArgs = [])
 ...
 */
abstract class AppGatewaysServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.beyondcorp.appgateways.v1.AppGatewaysService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/app_gateways_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/app_gateways_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../../resources/app_gateways_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/app_gateways_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    {
        return $this->startApiCall('CreateAppGateway', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('DeleteAppGateway', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('GetAppGateway', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('ListAppGateways', $request, $callOptions);
    }
