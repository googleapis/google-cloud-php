...
class CloudBuildGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\Build\V1\ApproveBuildRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ApproveBuild(\Google\Cloud\Build\V1\ApproveBuildRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.devtools.cloudbuild.v1.CloudBuild/ApproveBuild',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
