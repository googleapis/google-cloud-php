...
class NetworkConfig extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $peered_network_ip_range = '';
...
class_alias(NetworkConfig::class, \Google\Cloud\Build\V1\PrivatePoolV1Config_NetworkConfig::class);
