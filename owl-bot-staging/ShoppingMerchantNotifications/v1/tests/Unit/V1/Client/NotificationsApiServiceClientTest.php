...
class NotificationsApiServiceClientTest extends GeneratedTest
{
    ...
    public function createNotificationSubscriptionTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/CreateNotificationSubscription', $actualFuncCall);
    ...
    public function deleteNotificationSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/DeleteNotificationSubscription', $actualFuncCall);
    ...
    public function getNotificationSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/GetNotificationSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getNotificationSubscriptionHealthMetricsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->notificationSubscriptionHealthMetricsName('[ACCOUNT]', '[NOTIFICATION_SUBSCRIPTION]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/GetNotificationSubscriptionHealthMetrics', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listNotificationSubscriptionsTest()
    {
        ...
        $notificationSubscriptions = [
            $notificationSubscriptionsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/ListNotificationSubscriptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateNotificationSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.notifications.v1.NotificationsApiService/UpdateNotificationSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getNotificationSubscription();
        $this->assertProtobufEquals($notificationSubscription, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
