 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/notifications/v1/notificationsapi.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Shopping\Merchant\Notifications\V1\Client;
 ...
 * @method PromiseInterface<NotificationSubscriptionHealthMetrics> getNotificationSubscriptionHealthMetricsAsync(GetNotificationSubscriptionHealthMetricsRequest $request, array $optionalArgs = [])
...
final class NotificationsApiServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.notifications.v1.NotificationsApiService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/notifications_api_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/notifications_api_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/notifications_api_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     *
     * @param string $account
     * @param string $notificationSubscription
     *
     * @return string The formatted notification_subscription resource.
     */
    public static function notificationSubscriptionName(string $account, string $notificationSubscription): string
    {
        return self::getPathTemplate('notificationSubscription')->render([
            'account' => $account,
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * notification_subscription_health_metrics resource.
     *
     * @param string $account
     * @param string $notificationSubscription
     *
     * @return string The formatted notification_subscription_health_metrics resource.
     */
    public static function notificationSubscriptionHealthMetricsName(string $account, string $notificationSubscription): string
    {
        return self::getPathTemplate('notificationSubscriptionHealthMetrics')->render([
            'account' => $account,
            'notification_subscription' => $notificationSubscription,
        ]);
    }
     ...
     * - notificationSubscriptionHealthMetrics: accounts/{account}/notificationsubscriptions/{notification_subscription}
     *
     ...
     *           use Google\Shopping\Merchant\Notifications\V1\NotificationsApiServiceClient;
     ...
     * {@see NotificationsApiServiceClient::createNotificationSubscriptionAsync()} .
     *
     * @example samples/V1/NotificationsApiServiceClient/create_notification_subscription.php
     *
     * @param CreateNotificationSubscriptionRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see NotificationsApiServiceClient::deleteNotificationSubscriptionAsync()} .
     *
     * @example samples/V1/NotificationsApiServiceClient/delete_notification_subscription.php
     *
     * @param DeleteNotificationSubscriptionRequest $request     A request to house fields associated with the call.
     * @param array                                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see NotificationsApiServiceClient::getNotificationSubscriptionAsync()} .
     *
     * @example samples/V1/NotificationsApiServiceClient/get_notification_subscription.php
     *
     * @param GetNotificationSubscriptionRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see NotificationsApiServiceClient::getNotificationSubscriptionHealthMetricsAsync()}
     * .
     *
     * @example samples/V1/NotificationsApiServiceClient/get_notification_subscription_health_metrics.php
     *
     * @param GetNotificationSubscriptionHealthMetricsRequest $request     A request to house fields associated with the call.
     * @param array                                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return NotificationSubscriptionHealthMetrics
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function getNotificationSubscriptionHealthMetrics(GetNotificationSubscriptionHealthMetricsRequest $request, array $callOptions = []): NotificationSubscriptionHealthMetrics
    {
        return $this->startApiCall('GetNotificationSubscriptionHealthMetrics', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see NotificationsApiServiceClient::listNotificationSubscriptionsAsync()} .
     *
     * @example samples/V1/NotificationsApiServiceClient/list_notification_subscriptions.php
     *
     * @param ListNotificationSubscriptionsRequest $request     A request to house fields associated with the call.
     * @param array                                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see NotificationsApiServiceClient::updateNotificationSubscriptionAsync()} .
     *
     * @example samples/V1/NotificationsApiServiceClient/update_notification_subscription.php
     *
     * @param UpdateNotificationSubscriptionRequest $request     A request to house fields associated with the call.
     * @param array                                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
