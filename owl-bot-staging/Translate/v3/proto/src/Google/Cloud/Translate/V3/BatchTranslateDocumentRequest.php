...
class BatchTranslateDocumentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           are listed in [Language
     *           Support](https://cloud.google.com/translate/docs/languages).
     *     @type \Google\Cloud\Translate\V3\BatchDocumentInputConfig[] $input_configs
     *           Required. Input configurations.
     *           The total number of files matched should be <= 100.
     *           The total content size to translate should be <= 100M Unicode codepoints.
     *           The files must use UTF-8 encoding.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.translation.v3.BatchDocumentInputConfig input_configs = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Cloud\Translate\V3\BatchDocumentInputConfig>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.translation.v3.BatchDocumentInputConfig input_configs = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Translate\V3\BatchDocumentInputConfig[] $var
     * @return $this
     */
