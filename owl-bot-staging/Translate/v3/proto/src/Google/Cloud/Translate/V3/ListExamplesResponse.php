 ...
 *
 * Generated from protobuf message <code>google.cloud.translation.v3.ListExamplesResponse</code>
 */
class ListExamplesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Translate\V3\Example[] $examples
     *           The sentence pairs.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.translation.v3.Example examples = 1;</code>
     * @return RepeatedField<\Google\Cloud\Translate\V3\Example>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.translation.v3.Example examples = 1;</code>
     * @param \Google\Cloud\Translate\V3\Example[] $var
     * @return $this
     */
    public function setExamples($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Translate\V3\Example::class);
        $this->examples = $arr;
