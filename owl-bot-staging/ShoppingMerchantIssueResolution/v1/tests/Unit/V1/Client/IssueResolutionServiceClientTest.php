...
class IssueResolutionServiceClientTest extends GeneratedTest
{
    ...
    public function renderAccountIssuesTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.issueresolution.v1.IssueResolutionService/RenderAccountIssues', $actualFuncCall);
    ...
    public function renderProductIssuesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.issueresolution.v1.IssueResolutionService/RenderProductIssues', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function triggerActionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.issueresolution.v1.IssueResolutionService/TriggerAction', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
