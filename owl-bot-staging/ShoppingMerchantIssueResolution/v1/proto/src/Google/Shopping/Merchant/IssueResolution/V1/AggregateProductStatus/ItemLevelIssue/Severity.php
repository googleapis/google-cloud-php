 ...
 *
 * Protobuf type <code>google.shopping.merchant.issueresolution.v1.AggregateProductStatus.ItemLevelIssue.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Shopping\Merchant\IssueResolution\V1\AggregateProductStatus_ItemLevelIssue_Severity::class);
