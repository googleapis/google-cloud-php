 ...
 * account issues.
 *
 * Generated from protobuf message <code>google.shopping.merchant.issueresolution.v1.RenderAccountIssuesRequest</code>
 */
class RenderAccountIssuesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The account to fetch issues for.
     *                     Format: `accounts/{account}`
     *                     Please see {@see IssueResolutionServiceClient::accountName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\IssueResolution\V1\RenderAccountIssuesRequest
     *
     * @experimental
     */
