 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.issueresolution.v1.ListAggregateProductStatusesRequest</code>
 */
class ListAggregateProductStatusesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The account to list aggregate product statuses for.
     *                       Format: `accounts/{account}`
     *                       Please see {@see AggregateProductStatusesServiceClient::accountName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\IssueResolution\V1\ListAggregateProductStatusesRequest
     *
     * @experimental
     */
