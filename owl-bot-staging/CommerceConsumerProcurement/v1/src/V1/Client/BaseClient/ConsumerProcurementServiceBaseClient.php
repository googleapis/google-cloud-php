...
namespace Google\Cloud\Commerce\Consumer\Procurement\V1\Client\BaseClient;
 ...
 */
abstract class ConsumerProcurementServiceBaseClient
{
     ...
     *
     * The async variant is {@see self::getOrderAsync()} .
     *
     ...
     * resource.
     *
     * The async variant is {@see self::listOrdersAsync()} .
     *
     ...
     *
     * The async variant is {@see self::placeOrderAsync()} .
     *
