...
namespace Google\Cloud\SecurityCenter\V1\SensitivityScore;
 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v1.SensitivityScore.SensitivityScoreLevel</code>
 */
class SensitivityScoreLevel
{
     ...
     * Unused.
     *
     * Generated from protobuf enum <code>SENSITIVITY_SCORE_LEVEL_UNSPECIFIED = 0;</code>
     */
    const SENSITIVITY_SCORE_LEVEL_UNSPECIFIED = 0;
    /**
    ...
    private static $valueToName = [
        self::SENSITIVITY_SCORE_LEVEL_UNSPECIFIED => 'SENSITIVITY_SCORE_LEVEL_UNSPECIFIED',
