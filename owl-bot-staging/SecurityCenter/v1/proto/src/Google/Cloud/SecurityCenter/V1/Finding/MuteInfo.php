...
class MuteInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *           If set, the static mute applied to this finding. Static mutes override
     *           dynamic mutes. If unset, there is no static mute.
     *     @type \Google\Cloud\SecurityCenter\V1\Finding\MuteInfo\DynamicMuteRecord[] $dynamic_mute_records
     *           The list of dynamic mute rules that currently match the finding.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.Finding.MuteInfo.DynamicMuteRecord dynamic_mute_records = 2;</code>
     * @return RepeatedField<\Google\Cloud\SecurityCenter\V1\Finding\MuteInfo\DynamicMuteRecord>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.Finding.MuteInfo.DynamicMuteRecord dynamic_mute_records = 2;</code>
     * @param \Google\Cloud\SecurityCenter\V1\Finding\MuteInfo\DynamicMuteRecord[] $var
     * @return $this
     */
