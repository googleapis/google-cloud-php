...
class SecurityPosture extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $policy
     *           The ID of the updated policy, for example, `compute-policy-1`.
     *     @type \Google\Cloud\SecurityCenter\V1\SecurityPosture\PolicyDriftDetails[] $policy_drift_details
     *           The details about a change in an updated policy that violates the deployed
     *           posture.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetails policy_drift_details = 8;</code>
     * @return RepeatedField<\Google\Cloud\SecurityCenter\V1\SecurityPosture\PolicyDriftDetails>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.SecurityPosture.PolicyDriftDetails policy_drift_details = 8;</code>
     * @param \Google\Cloud\SecurityCenter\V1\SecurityPosture\PolicyDriftDetails[] $var
     * @return $this
     */
