...
namespace Google\Cloud\SecurityCenter\V1\ValuedResource;
 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v1.ValuedResource.ResourceValue</code>
 */
class ResourceValue
{
    /**
...
class_alias(ResourceValue::class, \Google\Cloud\SecurityCenter\V1\ValuedResource_ResourceValue::class);
