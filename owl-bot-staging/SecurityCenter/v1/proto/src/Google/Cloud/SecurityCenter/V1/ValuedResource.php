 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1.ValuedResource</code>
 */
class ValuedResource extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V1\ValuedResource\ResourceValue::class);
