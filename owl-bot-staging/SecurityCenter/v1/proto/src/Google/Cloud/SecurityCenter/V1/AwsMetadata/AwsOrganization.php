 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1.AwsMetadata.AwsOrganization</code>
 */
...
class_alias(AwsOrganization::class, \Google\Cloud\SecurityCenter\V1\AwsMetadata_AwsOrganization::class);
