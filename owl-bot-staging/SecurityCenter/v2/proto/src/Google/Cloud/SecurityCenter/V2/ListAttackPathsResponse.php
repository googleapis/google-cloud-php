 ...
 * valued resource.
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.ListAttackPathsResponse</code>
 */
class ListAttackPathsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V2\AttackPath::class);
