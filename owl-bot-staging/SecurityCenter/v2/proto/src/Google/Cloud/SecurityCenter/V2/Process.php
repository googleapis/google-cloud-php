...
class Process extends \Google\Protobuf\Internal\Message
{
     ...
     *           File information for the process executable.
     *     @type \Google\Cloud\SecurityCenter\V2\File[] $libraries
     *           File information for libraries loaded by the process.
     ...
     *           True if `args` is incomplete.
     *     @type \Google\Cloud\SecurityCenter\V2\EnvironmentVariable[] $env_variables
     *           Process environment variables.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v2.EnvironmentVariable env_variables = 7;</code>
     * @return RepeatedField<\Google\Cloud\SecurityCenter\V2\EnvironmentVariable>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v2.EnvironmentVariable env_variables = 7;</code>
     * @param \Google\Cloud\SecurityCenter\V2\EnvironmentVariable[] $var
     * @return $this
     */
