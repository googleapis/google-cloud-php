 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Cvssv3.PrivilegesRequired</code>
 */
...
class_alias(PrivilegesRequired::class, \Google\Cloud\SecurityCenter\V2\Cvssv3_PrivilegesRequired::class);
