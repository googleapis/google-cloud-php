 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.MitreAttack.Tactic</code>
 */
class Tactic
{
    /**
...
class_alias(Tactic::class, \Google\Cloud\SecurityCenter\V2\MitreAttack_Tactic::class);
