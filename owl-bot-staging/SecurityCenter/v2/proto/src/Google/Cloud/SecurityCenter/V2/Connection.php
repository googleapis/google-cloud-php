 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.Connection</code>
 */
class Connection extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.Connection.Protocol protocol = 5;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V2\Connection\Protocol::class);
        $this->protocol = $var;
