 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.DeleteNotificationConfigRequest</code>
 */
class DeleteNotificationConfigRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Name of the notification config to delete. The following list
     *                     shows some examples of the format:
     *
     *                     +
     *                     `organizations/[organization_id]/locations/[location_id]/notificationConfigs/[config_id]`
     ...
     *
     * @return \Google\Cloud\SecurityCenter\V2\DeleteNotificationConfigRequest
     *
     * @experimental
     */
