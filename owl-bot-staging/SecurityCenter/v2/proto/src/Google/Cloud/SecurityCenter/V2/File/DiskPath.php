 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.File.DiskPath</code>
 */
...
class_alias(DiskPath::class, \Google\Cloud\SecurityCenter\V2\File_DiskPath::class);
