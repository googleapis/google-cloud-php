 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.UpdateBigQueryExportRequest</code>
 */
class UpdateBigQueryExportRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.BigQueryExport big_query_export = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\SecurityCenter\V2\BigQueryExport $bigQueryExport Required. The BigQuery export being updated.
     * @param \Google\Protobuf\FieldMask                     $updateMask     The list of fields to be updated.
     *                                                                       If empty all mutable fields will be updated.
     *
     * @return \Google\Cloud\SecurityCenter\V2\UpdateBigQueryExportRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\SecurityCenter\V2\BigQueryExport $bigQueryExport, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
