 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.Access</code>
 */
class Access extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.Geolocation caller_ip_geo = 3;</code>
     */
     ...
     * "iam.googleapis.com"
     *
     * Generated from protobuf field <code>string service_name = 6;</code>
     */
    protected $service_name = '';
    /**
     * The method that the service account called, e.g. "SetIamPolicy".
     *
     * Generated from protobuf field <code>string method_name = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>string service_account_key_name = 9;</code>
     */
     ...
     *           Caller's IP address, such as "1.1.1.1".
     *     @type \Google\Cloud\SecurityCenter\V2\Geolocation $caller_ip_geo
     *           The caller IP's geolocation, which identifies where the call came from.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.Geolocation caller_ip_geo = 3;</code>
     * @return \Google\Cloud\SecurityCenter\V2\Geolocation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.Geolocation caller_ip_geo = 3;</code>
     * @param \Google\Cloud\SecurityCenter\V2\Geolocation $var
     * @return $this
     */
    public function setCallerIpGeo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecurityCenter\V2\Geolocation::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V2\ServiceAccountDelegationInfo::class);
