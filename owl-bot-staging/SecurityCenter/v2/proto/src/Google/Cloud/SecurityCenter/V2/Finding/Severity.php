 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Finding.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Cloud\SecurityCenter\V2\Finding_Severity::class);
