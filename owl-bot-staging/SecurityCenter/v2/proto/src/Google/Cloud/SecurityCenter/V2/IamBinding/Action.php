...
namespace Google\Cloud\SecurityCenter\V2\IamBinding;
 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.IamBinding.Action</code>
 */
class Action
{
    /**
...
class_alias(Action::class, \Google\Cloud\SecurityCenter\V2\IamBinding_Action::class);
