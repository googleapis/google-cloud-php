 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.Indicator</code>
 */
class Indicator extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V2\Indicator\ProcessSignature::class);
        $this->signatures = $arr;
