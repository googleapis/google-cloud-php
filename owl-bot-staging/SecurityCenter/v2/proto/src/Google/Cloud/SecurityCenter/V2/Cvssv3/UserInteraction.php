 ...
 * component.
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Cvssv3.UserInteraction</code>
 */
...
class_alias(UserInteraction::class, \Google\Cloud\SecurityCenter\V2\Cvssv3_UserInteraction::class);
