 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.AttackPath.AttackPathNode.AttackStepNode</code>
 */
class AttackStepNode extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V2\AttackPath\AttackPathNode\NodeType::class);
        $this->type = $var;
