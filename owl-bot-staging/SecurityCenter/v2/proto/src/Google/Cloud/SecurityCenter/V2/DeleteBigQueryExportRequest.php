 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.DeleteBigQueryExportRequest</code>
 */
class DeleteBigQueryExportRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the BigQuery export to delete. The following list
     *                     shows some examples of the format:
     *
     *                     +
     *                     `organizations/{organization}/locations/{location}/bigQueryExports/{export_id}`
     ...
     *
     * @return \Google\Cloud\SecurityCenter\V2\DeleteBigQueryExportRequest
     *
     * @experimental
     */
