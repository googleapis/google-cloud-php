...
namespace Google\Cloud\SecurityCenter\V2\Kubernetes\Subject;
 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Kubernetes.Subject.AuthType</code>
 */
class AuthType
{
    /**
...
class_alias(AuthType::class, \Google\Cloud\SecurityCenter\V2\Kubernetes_Subject_AuthType::class);
