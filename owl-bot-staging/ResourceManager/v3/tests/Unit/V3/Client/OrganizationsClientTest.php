 ...
 * @group gapic
 */
class OrganizationsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new OrganizationsClient($options);
    }
    ...
    public function getIamPolicyTest()
    {
        ...
        $this->assertSame('/google.cloud.resourcemanager.v3.Organizations/GetIamPolicy', $actualFuncCall);
    ...
    public function getOrganizationTest()
    {
        ...
        $directoryCustomerId = 'directoryCustomerId813284938';
        $etag = 'etag3123477';
    ...
    /** @test */
    public function searchOrganizationsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $expectedResponse = new SearchOrganizationsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setOrganizations($organizations);
        $transport->addResponse($expectedResponse);
        $request = new SearchOrganizationsRequest();
        $response = $gapicClient->searchOrganizations($request);
    ...
    /** @test */
    public function searchOrganizationsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new SearchOrganizationsRequest();
        try {
            $gapicClient->searchOrganizations($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function setIamPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.Organizations/SetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.resourcemanager.v3.Organizations/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function getIamPolicyAsyncTest()
    {
        ...
        $request = (new GetIamPolicyRequest())
            ->setResource($resource);
        $response = $gapicClient->getIamPolicyAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
