 ...
 *
 * @param string $formattedName The name of the dashboardChart to retrieve.
 *                              Format:
 ...
 */
function get_dashboard_chart_sample(string $formattedName): void
{
    // Create a client.
    $dashboardChartServiceClient = new DashboardChartServiceClient();

    // Prepare the request message.
    $request = (new GetDashboardChartRequest())
