...
// [START chronicle_v1_generated_DashboardQueryService_GetDashboardQuery_sync]
 ...
 *
 * @param string $formattedName The name of the dashboardQuery to retrieve.
 *                              Format:
 ...
 */
function get_dashboard_query_sample(string $formattedName): void
{
    // Create a client.
