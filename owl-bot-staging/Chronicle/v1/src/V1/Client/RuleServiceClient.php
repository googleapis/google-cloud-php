...
final class RuleServiceClient
{
     ...
     */
    public static function referenceListName(string $project, string $location, string $instance, string $referenceList): string
    {
     ...
     */
    public static function retrohuntName(string $project, string $location, string $instance, string $rule, string $retrohunt): string
    {
