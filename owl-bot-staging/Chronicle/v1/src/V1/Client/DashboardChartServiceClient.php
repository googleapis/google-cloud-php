 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/chronicle/v1/dashboard_chart.proto
...
use Google\Cloud\Chronicle\V1\GetDashboardChartRequest;
 ...
 *
 * @method PromiseInterface<BatchGetDashboardChartsResponse> batchGetDashboardChartsAsync(BatchGetDashboardChartsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<DashboardChart> getDashboardChartAsync(GetDashboardChartRequest $request, array $optionalArgs = [])
 */
final class DashboardChartServiceClient
{
     ...
     */
    public function batchGetDashboardCharts(BatchGetDashboardChartsRequest $request, array $callOptions = []): BatchGetDashboardChartsResponse
    {
