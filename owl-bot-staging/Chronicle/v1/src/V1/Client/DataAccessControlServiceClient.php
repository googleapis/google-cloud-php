...
final class DataAccessControlServiceClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/data_access_control_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function dataAccessLabelName(string $project, string $location, string $instance, string $dataAccessLabel): string
    {
     ...
     *           use Google\Cloud\Chronicle\V1\DataAccessControlServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new DataAccessControlServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function createDataAccessLabel(CreateDataAccessLabelRequest $request, array $callOptions = []): DataAccessLabel
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createDataAccessScope(CreateDataAccessScopeRequest $request, array $callOptions = []): DataAccessScope
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listDataAccessLabels(ListDataAccessLabelsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listDataAccessScopes(ListDataAccessScopesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateDataAccessLabel(UpdateDataAccessLabelRequest $request, array $callOptions = []): DataAccessLabel
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateDataAccessScope(UpdateDataAccessScopeRequest $request, array $callOptions = []): DataAccessScope
    {
