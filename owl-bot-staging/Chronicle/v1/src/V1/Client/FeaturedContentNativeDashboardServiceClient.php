 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/chronicle/v1/featured_content_native_dashboard.proto
 ...
 *
 * @method PromiseInterface<FeaturedContentNativeDashboard> getFeaturedContentNativeDashboardAsync(GetFeaturedContentNativeDashboardRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<InstallFeaturedContentNativeDashboardResponse> installFeaturedContentNativeDashboardAsync(InstallFeaturedContentNativeDashboardRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listFeaturedContentNativeDashboardsAsync(ListFeaturedContentNativeDashboardsRequest $request, array $optionalArgs = [])
 */
final class FeaturedContentNativeDashboardServiceClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'descriptorsConfigPath' => __DIR__ . '/../resources/featured_content_native_dashboard_service_descriptor_config.php',
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/featured_content_native_dashboard_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function featuredContentNativeDashboardName(string $project, string $location, string $instance, string $featuredContentNativeDashboard): string
    {
     ...
     */
    public function getFeaturedContentNativeDashboard(GetFeaturedContentNativeDashboardRequest $request, array $callOptions = []): FeaturedContentNativeDashboard
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function installFeaturedContentNativeDashboard(InstallFeaturedContentNativeDashboardRequest $request, array $callOptions = []): InstallFeaturedContentNativeDashboardResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listFeaturedContentNativeDashboards(ListFeaturedContentNativeDashboardsRequest $request, array $callOptions = []): PagedListResponse
    {
