 ...
 *
 * Generated from protobuf message <code>google.cloud.chronicle.v1.GetDataAccessScopeRequest</code>
 */
class GetDataAccessScopeRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The ID of the data access scope to retrieve.
     *                     Format:
     *                     `projects/{project}/locations/{location}/instances/{instance}/dataAccessScopes/{data_access_scope}`
     *                     Please see {@see DataAccessControlServiceClient::dataAccessScopeName()} for help formatting this field.
     *
     * @return \Google\Cloud\Chronicle\V1\GetDataAccessScopeRequest
     *
     * @experimental
     */
