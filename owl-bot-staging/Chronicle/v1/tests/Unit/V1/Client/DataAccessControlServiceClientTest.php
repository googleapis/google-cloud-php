...
class DataAccessControlServiceClientTest extends GeneratedTest
{
    ...
    public function createDataAccessScopeTest()
    {
        ...
        $dataAccessScopeName = $gapicClient->dataAccessScopeName('[PROJECT]', '[LOCATION]', '[INSTANCE]', '[DATA_ACCESS_SCOPE]');
    ...
    public function deleteDataAccessLabelTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->dataAccessLabelName('[PROJECT]', '[LOCATION]', '[INSTANCE]', '[DATA_ACCESS_LABEL]');
    ...
    public function deleteDataAccessScopeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->dataAccessScopeName('[PROJECT]', '[LOCATION]', '[INSTANCE]', '[DATA_ACCESS_SCOPE]');
