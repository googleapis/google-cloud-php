...
class FeaturedContentNativeDashboardServiceClientTest extends GeneratedTest
{
    ...
    public function getFeaturedContentNativeDashboardTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->featuredContentNativeDashboardName('[PROJECT]', '[LOCATION]', '[INSTANCE]', '[FEATURED_CONTENT_NATIVE_DASHBOARD]');
        $request = (new GetFeaturedContentNativeDashboardRequest())
        ...
        $this->assertSame('/google.cloud.chronicle.v1.FeaturedContentNativeDashboardService/GetFeaturedContentNativeDashboard', $actualFuncCall);
    ...
    public function installFeaturedContentNativeDashboardTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.chronicle.v1.FeaturedContentNativeDashboardService/InstallFeaturedContentNativeDashboard', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFeaturedContentNativeDashboardsTest()
    {
        ...
        $featuredContentNativeDashboards = [
            $featuredContentNativeDashboardsElement,
        ];
        ...
        $request = (new ListFeaturedContentNativeDashboardsRequest())
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.chronicle.v1.FeaturedContentNativeDashboardService/ListFeaturedContentNativeDashboards', $actualFuncCall);
