 ...
 */
function update_subscription_sample(string $subscriptionName, string $formattedTopic): void
{
    // Create a client.
    ...
    $subscription = (new Subscription())
        ...
        ->setTopic($subscriptionTopic);
    $updateMask = new FieldMask();

    // Call the API and handle any network failures.
    try {
        /** @var Subscription $response */
        $response = $subscriberClient->updateSubscription($subscription, $formattedTopic, $updateMask);
...
function callSample(): void
{
    ...
    update_subscription_sample($subscriptionName, $formattedTopic);
}
