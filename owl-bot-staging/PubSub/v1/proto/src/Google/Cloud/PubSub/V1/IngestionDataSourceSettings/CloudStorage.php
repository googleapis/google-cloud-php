...
class CloudStorage extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $minimum_object_create_time = null;
    /**
...
class_alias(CloudStorage::class, \Google\Cloud\PubSub\V1\IngestionDataSourceSettings_CloudStorage::class);
