 ...
 *
 * Generated from protobuf message <code>google.pubsub.v1.IngestionFailureEvent.AwsMskFailureReason</code>
 */
class AwsMskFailureReason extends \Google\Protobuf\Internal\Message
{
    /**
     * Optional. The ARN of the cluster of the topic being ingested from.
     *
     * Generated from protobuf field <code>string cluster_arn = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
...
class_alias(AwsMskFailureReason::class, \Google\Cloud\PubSub\V1\IngestionFailureEvent_AwsMskFailureReason::class);
