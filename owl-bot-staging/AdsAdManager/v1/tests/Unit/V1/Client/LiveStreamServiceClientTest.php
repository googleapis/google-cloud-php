...
class LiveStreamServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateLiveStreamsTest()
    {
        ...
        $formattedNames = [
            $gapicClient->liveStreamName('[NETWORK_CODE]', '[LIVE_STREAM]'),
        ];
    ...
    public function createLiveStreamTest()
    {
        ...
        $expectedResponse->setEarlyBreakNotificationMultiBreakSchedulingEnabled($earlyBreakNotificationMultiBreakSchedulingEnabled);
