...
class CmsMetadataKeyServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateCmsMetadataKeysTest()
    {
        ...
        $formattedNames = [
            $gapicClient->cmsMetadataKeyName('[NETWORK_CODE]', '[CMS_METADATA_KEY]'),
        ];
        ...
        $this->assertSame('/google.ads.admanager.v1.CmsMetadataKeyService/BatchActivateCmsMetadataKeys', $actualFuncCall);
    ...
    public function batchDeactivateCmsMetadataKeysTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CmsMetadataKeyService/BatchDeactivateCmsMetadataKeys', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
