...
class EntitySignalsMappingServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateEntitySignalsMappingsTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/BatchCreateEntitySignalsMappings', $actualFuncCall);
    ...
    public function batchUpdateEntitySignalsMappingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/BatchUpdateEntitySignalsMappings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function createEntitySignalsMappingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/CreateEntitySignalsMapping', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function getEntitySignalsMappingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/GetEntitySignalsMapping', $actualFuncCall);
    ...
    public function listEntitySignalsMappingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/ListEntitySignalsMappings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateEntitySignalsMappingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.EntitySignalsMappingService/UpdateEntitySignalsMapping', $actualFuncCall);
        $actualValue = $actualRequestObject->getEntitySignalsMapping();
        $this->assertProtobufEquals($entitySignalsMapping, $actualValue);
