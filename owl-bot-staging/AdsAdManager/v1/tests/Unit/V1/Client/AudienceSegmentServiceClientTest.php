...
class AudienceSegmentServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateAudienceSegmentsTest()
    {
        ...
        $formattedNames = [
            $gapicClient->audienceSegmentName('[NETWORK_CODE]', '[AUDIENCE_SEGMENT]'),
        ];
        $request = (new BatchActivateAudienceSegmentsRequest())
        ...
        $this->assertSame('/google.ads.admanager.v1.AudienceSegmentService/BatchActivateAudienceSegments', $actualFuncCall);
    ...
    public function batchApproveAudienceSegmentsTest()
    {
        ...
        $request = (new BatchApproveAudienceSegmentsRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.AudienceSegmentService/BatchApproveAudienceSegments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchDeactivateAudienceSegmentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.AudienceSegmentService/BatchDeactivateAudienceSegments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchPopulateAudienceSegmentsTest()
    {
        ...
        $request = (new BatchPopulateAudienceSegmentsRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.AudienceSegmentService/BatchPopulateAudienceSegments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchRejectAudienceSegmentsTest()
    {
        ...
        $request = (new BatchRejectAudienceSegmentsRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.AudienceSegmentService/BatchRejectAudienceSegments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function getAudienceSegmentTest()
    {
        ...
        $request = (new GetAudienceSegmentRequest())
    ...
    public function listAudienceSegmentsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListAudienceSegmentsRequest())
            ->setParent($formattedParent);
