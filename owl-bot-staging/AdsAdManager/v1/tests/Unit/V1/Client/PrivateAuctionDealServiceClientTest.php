...
class PrivateAuctionDealServiceClientTest extends GeneratedTest
{
    ...
    public function createPrivateAuctionDealTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.PrivateAuctionDealService/CreatePrivateAuctionDeal', $actualFuncCall);
    ...
    public function listPrivateAuctionDealsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.PrivateAuctionDealService/ListPrivateAuctionDeals', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
