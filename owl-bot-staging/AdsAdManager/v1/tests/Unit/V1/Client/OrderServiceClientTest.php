...
class OrderServiceClientTest extends GeneratedTest
{
    ...
    public function batchApproveAndOverbookOrdersTest()
    {
        ...
        $formattedNames = [
            $gapicClient->orderName('[NETWORK_CODE]', '[ORDER]'),
        ];
        $request = (new BatchApproveAndOverbookOrdersRequest())
    ...
    public function batchApproveOrdersTest()
    {
        ...
        $request = (new BatchApproveOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchApproveOrdersWithoutReservationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.OrderService/BatchApproveOrdersWithoutReservation', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchArchiveOrdersTest()
    {
        ...
        $request = (new BatchArchiveOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchCreateOrdersTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchCreateOrdersRequest())
            ->setParent($formattedParent)
    ...
    public function batchDisapproveOrdersTest()
    {
        ...
        $request = (new BatchDisapproveOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchDisapproveOrdersWithoutReservationChangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.OrderService/BatchDisapproveOrdersWithoutReservationChanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchPauseOrdersTest()
    {
        ...
        $request = (new BatchPauseOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchResumeAndOverbookOrdersTest()
    {
        ...
        $request = (new BatchResumeAndOverbookOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchResumeOrdersTest()
    {
        ...
        $request = (new BatchResumeOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchRetractOrdersTest()
    {
        ...
        $request = (new BatchRetractOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchRetractOrdersWithoutReservationChangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.OrderService/BatchRetractOrdersWithoutReservationChanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchSubmitOrdersForApprovalTest()
    {
        ...
        $request = (new BatchSubmitOrdersForApprovalRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
    ...
    public function batchSubmitOrdersForApprovalAndOverbookTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.OrderService/BatchSubmitOrdersForApprovalAndOverbook', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchSubmitOrdersForApprovalWithoutReservationChangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.OrderService/BatchSubmitOrdersForApprovalWithoutReservationChanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchUnarchiveOrdersTest()
    {
        ...
        $request = (new BatchUnarchiveOrdersRequest())
            ->setParent($formattedParent)
            ->setNames($formattedNames);
