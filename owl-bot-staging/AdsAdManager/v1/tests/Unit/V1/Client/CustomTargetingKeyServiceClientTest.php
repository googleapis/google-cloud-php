...
class CustomTargetingKeyServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateCustomTargetingKeysTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/BatchActivateCustomTargetingKeys', $actualFuncCall);
    ...
    public function batchCreateCustomTargetingKeysTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/BatchCreateCustomTargetingKeys', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function batchDeactivateCustomTargetingKeysTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/BatchDeactivateCustomTargetingKeys', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getNames();
        $this->assertProtobufEquals($formattedNames, $actualValue);
    ...
    public function batchUpdateCustomTargetingKeysTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/BatchUpdateCustomTargetingKeys', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function createCustomTargetingKeyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/CreateCustomTargetingKey', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function listCustomTargetingKeysTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/ListCustomTargetingKeys', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateCustomTargetingKeyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingKeyService/UpdateCustomTargetingKey', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomTargetingKey();
        $this->assertProtobufEquals($customTargetingKey, $actualValue);
