...
class DaiEncodingProfileServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateDaiEncodingProfilesTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/BatchActivateDaiEncodingProfiles', $actualFuncCall);
    ...
    public function batchArchiveDaiEncodingProfilesTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchArchiveDaiEncodingProfilesRequest())
            ->setParent($formattedParent)
            ->setRequests($requests);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/BatchArchiveDaiEncodingProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchCreateDaiEncodingProfilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/BatchCreateDaiEncodingProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchUpdateDaiEncodingProfilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/BatchUpdateDaiEncodingProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function createDaiEncodingProfileTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/CreateDaiEncodingProfile', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function listDaiEncodingProfilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/ListDaiEncodingProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateDaiEncodingProfileTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.DaiEncodingProfileService/UpdateDaiEncodingProfile', $actualFuncCall);
        $actualValue = $actualRequestObject->getDaiEncodingProfile();
        $this->assertProtobufEquals($daiEncodingProfile, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
