...
class TargetingPresetServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateTargetingPresetsTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.TargetingPresetService/BatchCreateTargetingPresets', $actualFuncCall);
    ...
    public function batchDeactivateTargetingPresetsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.TargetingPresetService/BatchDeactivateTargetingPresets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchUpdateTargetingPresetsTest()
    {
        ...
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $requests = [];
        $request = (new BatchUpdateTargetingPresetsRequest())
            ->setParent($formattedParent)
            ->setRequests($requests);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.TargetingPresetService/BatchUpdateTargetingPresets', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
