...
class CreativeWrapperServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateCreativeWrappersTest()
    {
        ...
        $formattedNames = [
            $gapicClient->creativeWrapperName('[NETWORK_CODE]', '[CREATIVE_WRAPPER]'),
        ];
        ...
        $this->assertSame('/google.ads.admanager.v1.CreativeWrapperService/BatchActivateCreativeWrappers', $actualFuncCall);
    ...
    public function batchCreateCreativeWrappersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CreativeWrapperService/BatchCreateCreativeWrappers', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function batchUpdateCreativeWrappersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CreativeWrapperService/BatchUpdateCreativeWrappers', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function listCreativeWrappersTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->networkName('[NETWORK_CODE]');
        $request = (new ListCreativeWrappersRequest())
            ->setParent($formattedParent);
