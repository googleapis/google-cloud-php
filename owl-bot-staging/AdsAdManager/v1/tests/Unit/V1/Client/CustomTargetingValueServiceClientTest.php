...
class CustomTargetingValueServiceClientTest extends GeneratedTest
{
    ...
    public function batchActivateCustomTargetingValuesTest()
    {
        ...
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/BatchActivateCustomTargetingValues', $actualFuncCall);
    ...
    public function batchCreateCustomTargetingValuesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/BatchCreateCustomTargetingValues', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchDeactivateCustomTargetingValuesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/BatchDeactivateCustomTargetingValues', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function batchUpdateCustomTargetingValuesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/BatchUpdateCustomTargetingValues', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getRequests();
        $this->assertProtobufEquals($requests, $actualValue);
    ...
    public function createCustomTargetingValueTest()
    {
        ...
        $customTargetingValueCustomTargetingKey = $gapicClient->customTargetingKeyName('[NETWORK_CODE]', '[CUSTOM_TARGETING_KEY]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/CreateCustomTargetingValue', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function getCustomTargetingValueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/GetCustomTargetingValue', $actualFuncCall);
    ...
    public function listCustomTargetingValuesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/ListCustomTargetingValues', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateCustomTargetingValueTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.ads.admanager.v1.CustomTargetingValueService/UpdateCustomTargetingValue', $actualFuncCall);
        $actualValue = $actualRequestObject->getCustomTargetingValue();
        $this->assertProtobufEquals($customTargetingValue, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
