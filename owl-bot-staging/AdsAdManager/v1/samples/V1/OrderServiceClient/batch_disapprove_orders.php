 ...
 * @param string $formattedNamesElement The resource names of the orders to disapprove.
 *                                      Format: `networks/{network_code}/orders/{order_id}`
 *                                      Please see {@see OrderServiceClient::orderName()} for help formatting this field.
 */
function batch_disapprove_orders_sample(
    ...
    try {
        /** @var BatchDisapproveOrdersResponse $response */
        $response = $orderServiceClient->batchDisapproveOrders($request);
...
function callSample(): void
{
    ...
    batch_disapprove_orders_sample($formattedParent, $formattedNamesElement);
}
