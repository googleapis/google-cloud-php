 ...
 */
function batch_update_custom_targeting_keys_sample(
    ...
    try {
        /** @var BatchUpdateCustomTargetingKeysResponse $response */
        $response = $customTargetingKeyServiceClient->batchUpdateCustomTargetingKeys($request);
...
function callSample(): void
{
    ...
    batch_update_custom_targeting_keys_sample(
        $formattedParent,
