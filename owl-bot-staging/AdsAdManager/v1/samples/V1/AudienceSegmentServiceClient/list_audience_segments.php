 ...
 */
function list_audience_segments_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $audienceSegmentServiceClient->listAudienceSegments($request);
...
function callSample(): void
{
    ...
    list_audience_segments_sample($formattedParent);
}
