...
// [START admanager_v1_generated_ContentService_GetContent_sync]
...
{
    $formattedName = ContentServiceClient::contentName('[NETWORK_CODE]', '[CONTENT]');

    get_content_sample($formattedName);
}
// [END admanager_v1_generated_ContentService_GetContent_sync]
