...
use Google\Ads\AdManager\V1\ArchiveDaiEncodingProfileRequest;
 ...
 * @param string $formattedRequestsName The resource name of the DaiEncodingProfile to archive.
 *                                      Format:
 ...
 */
function batch_archive_dai_encoding_profiles_sample(
    ...
    $archiveDaiEncodingProfileRequest = (new ArchiveDaiEncodingProfileRequest())
        ->setName($formattedRequestsName);
    $requests = [$archiveDaiEncodingProfileRequest,];
    ...
    try {
        /** @var BatchArchiveDaiEncodingProfilesResponse $response */
        $response = $daiEncodingProfileServiceClient->batchArchiveDaiEncodingProfiles($request);
...
function callSample(): void
{
    ...
    batch_archive_dai_encoding_profiles_sample($formattedParent, $formattedRequestsName);
}
