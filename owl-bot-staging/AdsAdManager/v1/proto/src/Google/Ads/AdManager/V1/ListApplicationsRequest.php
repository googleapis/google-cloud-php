 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListApplicationsRequest</code>
 */
class ListApplicationsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Applications.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see ApplicationServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListApplicationsRequest
     *
     * @experimental
     */
