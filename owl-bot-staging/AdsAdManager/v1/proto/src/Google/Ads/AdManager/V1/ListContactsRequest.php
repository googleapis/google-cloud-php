 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListContactsRequest</code>
 */
class ListContactsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Contacts.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see ContactServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListContactsRequest
     *
     * @experimental
     */
