 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListSitesRequest</code>
 */
class ListSitesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Sites.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see SiteServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListSitesRequest
     *
     * @experimental
     */
