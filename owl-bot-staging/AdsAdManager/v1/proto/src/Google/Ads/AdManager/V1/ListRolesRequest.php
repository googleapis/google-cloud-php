 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListRolesRequest</code>
 */
class ListRolesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Roles.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see RoleServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListRolesRequest
     *
     * @experimental
     */
