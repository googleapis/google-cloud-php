 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListCustomTargetingKeysRequest</code>
 */
class ListCustomTargetingKeysRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of CustomTargetingKeys.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see CustomTargetingKeyServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListCustomTargetingKeysRequest
     *
     * @experimental
     */
