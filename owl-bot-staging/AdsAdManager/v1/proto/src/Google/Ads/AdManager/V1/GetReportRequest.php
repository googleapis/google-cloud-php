 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetReportRequest</code>
 */
class GetReportRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the report.
     *                     Format: `networks/{network_code}/reports/{report_id}`
     *                     Please see {@see ReportServiceClient::reportName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\GetReportRequest
     *
     * @experimental
     */
