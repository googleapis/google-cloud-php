 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateTeamsRequest</code>
 */
class BatchActivateTeamsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `Team`s to activate.
     *                         Format: `networks/{network_code}/teams/{team_id}`
     *                         Please see {@see TeamServiceClient::teamName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateTeamsRequest
     *
     * @experimental
     */
