 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ReportDataTable.Row</code>
 */
class Row extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\ReportDataTable\MetricValueGroup::class);
...
class_alias(Row::class, \Google\Ads\AdManager\V1\ReportDataTable_Row::class);
