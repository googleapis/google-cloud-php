 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListCustomFieldsRequest</code>
 */
class ListCustomFieldsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of CustomFields.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see CustomFieldServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListCustomFieldsRequest
     *
     * @experimental
     */
