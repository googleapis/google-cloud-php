 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateCustomTargetingKeysRequest</code>
 */
class BatchActivateCustomTargetingKeysRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `CustomTargetingKey`s to activate.
     *                         Format:
     *                         `networks/{network_code}/customTargetingKeys/{custom_targeting_key_id}`
     *                         Please see {@see CustomTargetingKeyServiceClient::customTargetingKeyName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateCustomTargetingKeysRequest
     *
     * @experimental
     */
