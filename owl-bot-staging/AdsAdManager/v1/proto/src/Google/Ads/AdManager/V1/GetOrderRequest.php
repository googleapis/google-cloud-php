 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetOrderRequest</code>
 */
class GetOrderRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Order.
     *                     Format: `networks/{network_code}/orders/{order_id}`
     *                     Please see {@see OrderServiceClient::orderName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\GetOrderRequest
     *
     * @experimental
     */
