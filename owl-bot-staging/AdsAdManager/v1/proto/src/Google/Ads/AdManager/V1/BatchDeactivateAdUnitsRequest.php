 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateAdUnitsRequest</code>
 */
class BatchDeactivateAdUnitsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `AdUnit`s to deactivate.
     *                         Format: `networks/{network_code}/adUnits/{ad_unit_id}`
     *                         Please see {@see AdUnitServiceClient::adUnitName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateAdUnitsRequest
     *
     * @experimental
     */
