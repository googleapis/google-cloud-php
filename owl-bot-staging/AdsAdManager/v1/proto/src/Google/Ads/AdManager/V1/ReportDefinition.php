...
class ReportDefinition extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.TimeZoneSource time_zone_source = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $time_zone_source = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.DateRange date_range = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.admanager.v1.ReportDefinition.DateRange comparison_date_range = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.ReportType report_type = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * quarter.
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.TimePeriodColumn time_period_column = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. The ISO 4217 currency code for this report. Defaults to publisher
     *           currency code if not specified.
     *     @type \Google\Ads\AdManager\V1\ReportDefinition\DateRange $date_range
     *           Required. The primary date range of this report.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\AdManager\V1\ReportDefinition\Dimension::class);
        $this->dimensions = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\AdManager\V1\ReportDefinition\Metric::class);
        $this->metrics = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\ReportDefinition\Filter::class);
        $this->filters = $arr;
     ...
     * @return $this
     */
    public function setTimeZoneSource($var)
    {
        GPBUtil::checkEnum($var, \Google\Ads\AdManager\V1\ReportDefinition\TimeZoneSource::class);
        $this->time_zone_source = $var;
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.DateRange date_range = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Ads\AdManager\V1\ReportDefinition\DateRange|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ReportDefinition.DateRange date_range = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Ads\AdManager\V1\ReportDefinition\DateRange $var
     * @return $this
     */
    public function setDateRange($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\AdManager\V1\ReportDefinition\DateRange::class);
        $this->date_range = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\AdManager\V1\ReportDefinition\ReportType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\AdManager\V1\ReportDefinition\TimePeriodColumn::class);
