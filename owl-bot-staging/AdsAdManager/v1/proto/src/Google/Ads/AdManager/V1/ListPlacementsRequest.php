 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListPlacementsRequest</code>
 */
class ListPlacementsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Placements.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see PlacementServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListPlacementsRequest
     *
     * @experimental
     */
