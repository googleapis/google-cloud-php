 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateSitesRequest</code>
 */
class BatchDeactivateSitesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `Site` objects to deactivate.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateSitesRequest
     *
     * @experimental
     */
