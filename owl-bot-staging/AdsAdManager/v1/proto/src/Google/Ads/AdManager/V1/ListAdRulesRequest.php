 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListAdRulesRequest</code>
 */
class ListAdRulesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of AdRules.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see AdRuleServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListAdRulesRequest
     *
     * @experimental
     */
