 ...
 *
 * Protobuf type <code>google.ads.admanager.v1.ReportDefinition.DateRange.RelativeDateRange</code>
 */
class RelativeDateRange
{
     ...
     *
     * Generated from protobuf enum <code>TOMORROW = 30;</code>
     */
    const TOMORROW = 30;
    /**
     * The 90 days following the day the report is run.
     *
     * Generated from protobuf enum <code>NEXT_90_DAYS = 31;</code>
     */
    const NEXT_90_DAYS = 31;
    /**
     * The entire calendar month following the calendar month the report is
     * run.
     *
     * Generated from protobuf enum <code>NEXT_MONTH = 32;</code>
     */
    const NEXT_MONTH = 32;
    /**
     ...
     * is run.
     *
     * Generated from protobuf enum <code>NEXT_3_MONTHS = 33;</code>
     */
    const NEXT_3_MONTHS = 33;
    /**
     * The entire 12 calendar months following the calendar month the report
     * is run.
     *
     * Generated from protobuf enum <code>NEXT_12_MONTHS = 34;</code>
     */
    const NEXT_12_MONTHS = 34;
    /**
     * The entire calendar week, Monday to Sunday (inclusive), following the
     * calendar week the report is run.
     *
     * Generated from protobuf enum <code>NEXT_WEEK = 35;</code>
     */
    const NEXT_WEEK = 35;
    /**
     ...
     * is run.
     *
     * Generated from protobuf enum <code>NEXT_QUARTER = 36;</code>
     */
    const NEXT_QUARTER = 36;
    /**
     ...
     *
     * Generated from protobuf enum <code>TO_END_OF_NEXT_MONTH = 37;</code>
     */
    const TO_END_OF_NEXT_MONTH = 37;
    /**
    ...
    private static $valueToName = [
        ...
        self::NEXT_90_DAYS => 'NEXT_90_DAYS',
        self::NEXT_MONTH => 'NEXT_MONTH',
        self::NEXT_3_MONTHS => 'NEXT_3_MONTHS',
        self::NEXT_12_MONTHS => 'NEXT_12_MONTHS',
        self::NEXT_WEEK => 'NEXT_WEEK',
        self::NEXT_QUARTER => 'NEXT_QUARTER',
        self::TO_END_OF_NEXT_MONTH => 'TO_END_OF_NEXT_MONTH',
...
class_alias(RelativeDateRange::class, \Google\Ads\AdManager\V1\ReportDefinition_DateRange_RelativeDateRange::class);
