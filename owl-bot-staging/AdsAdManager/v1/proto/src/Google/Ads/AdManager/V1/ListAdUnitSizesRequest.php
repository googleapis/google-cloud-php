 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListAdUnitSizesRequest</code>
 */
class ListAdUnitSizesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of AdUnitSizes.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see AdUnitServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListAdUnitSizesRequest
     *
     * @experimental
     */
