 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchDeactivateCustomFieldsRequest</code>
 */
class BatchDeactivateCustomFieldsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $names  Required. The resource names of the `CustomField` objects to deactivate.
     *                         Format: `networks/{network_code}/customFields/{custom_field_id}`
     *                         Please see {@see CustomFieldServiceClient::customFieldName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchDeactivateCustomFieldsRequest
     *
     * @experimental
     */
