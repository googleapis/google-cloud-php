 ...
 *
 * Protobuf type <code>google.ads.admanager.v1.ScheduleOptions.Schedule.Frequency</code>
 */
class Frequency
{
    /**
...
class_alias(Frequency::class, \Google\Ads\AdManager\V1\ScheduleOptions_Schedule_Frequency::class);
