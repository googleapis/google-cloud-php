 ...
 *
 * Protobuf type <code>google.ads.admanager.v1.ReportDefinition.Filter.Operation</code>
 */
class Operation
{
    /**
...
class_alias(Operation::class, \Google\Ads\AdManager\V1\ReportDefinition_Filter_Operation::class);
