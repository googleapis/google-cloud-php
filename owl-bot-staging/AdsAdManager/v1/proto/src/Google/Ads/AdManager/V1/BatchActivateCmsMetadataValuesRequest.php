 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchActivateCmsMetadataValuesRequest</code>
 */
class BatchActivateCmsMetadataValuesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string   $parent Required. The parent resource where `CmsMetadataValues` will be activated.
     *                         Format: `networks/{network_code}`
     *                         Please see {@see CmsMetadataValueServiceClient::networkName()} for help formatting this field.
     * @param string[] $names  Required. The resource names of the `CmsMetadataValue`s to activate.
     *                         Format:
     *                         `networks/{network_code}/cmsMetadataValues/{cms_metadata_value_id}`
     *                         Please see {@see CmsMetadataValueServiceClient::cmsMetadataValueName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\BatchActivateCmsMetadataValuesRequest
     *
     * @experimental
     */
