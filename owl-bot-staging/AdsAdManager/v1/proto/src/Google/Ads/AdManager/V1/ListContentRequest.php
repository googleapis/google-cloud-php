 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListContentRequest</code>
 */
class ListContentRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of Content.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see ContentServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListContentRequest
     *
     * @experimental
     */
