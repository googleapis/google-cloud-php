 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetApplicationRequest</code>
 */
class GetApplicationRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Application.
     *                     Format: `networks/{network_code}/applications/{application_id}`
     *                     Please see {@see ApplicationServiceClient::applicationName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\GetApplicationRequest
     *
     * @experimental
     */
