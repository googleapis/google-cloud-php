 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ScheduleOptions.Schedule</code>
 */
class Schedule extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ScheduleOptions.Schedule.Frequency frequency = 3;</code>
     */
     ...
     *
     *     @type \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\WeeklySchedule $weekly_schedule
     *           Days of week to schedule report run.
     *     @type \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\MonthlySchedule $monthly_schedule
     ...
     * Days of week to schedule report run.
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ScheduleOptions.Schedule.WeeklySchedule weekly_schedule = 6;</code>
     * @return \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\WeeklySchedule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ScheduleOptions.Schedule.WeeklySchedule weekly_schedule = 6;</code>
     * @param \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\WeeklySchedule $var
     * @return $this
     */
    public function setWeeklySchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\WeeklySchedule::class);
     ...
     * Days of month to schedule report run.
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ScheduleOptions.Schedule.MonthlySchedule monthly_schedule = 7;</code>
     * @return \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\MonthlySchedule|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.admanager.v1.ScheduleOptions.Schedule.MonthlySchedule monthly_schedule = 7;</code>
     * @param \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\MonthlySchedule $var
     * @return $this
     */
    public function setMonthlySchedule($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\MonthlySchedule::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\AdManager\V1\ScheduleOptions\Schedule\Frequency::class);
        $this->frequency = $var;
...
class_alias(Schedule::class, \Google\Ads\AdManager\V1\ScheduleOptions_Schedule::class);
