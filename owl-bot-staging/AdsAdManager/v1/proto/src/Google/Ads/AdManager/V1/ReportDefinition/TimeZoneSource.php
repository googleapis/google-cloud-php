 ...
 *
 * Protobuf type <code>google.ads.admanager.v1.ReportDefinition.TimeZoneSource</code>
 */
...
class_alias(TimeZoneSource::class, \Google\Ads\AdManager\V1\ReportDefinition_TimeZoneSource::class);
