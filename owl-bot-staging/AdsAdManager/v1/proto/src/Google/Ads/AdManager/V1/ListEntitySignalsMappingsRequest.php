 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListEntitySignalsMappingsRequest</code>
 */
class ListEntitySignalsMappingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of EntitySignalsMappings.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see EntitySignalsMappingServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListEntitySignalsMappingsRequest
     *
     * @experimental
     */
