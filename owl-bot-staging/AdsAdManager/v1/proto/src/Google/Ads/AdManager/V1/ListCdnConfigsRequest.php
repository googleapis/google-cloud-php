 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.ListCdnConfigsRequest</code>
 */
class ListCdnConfigsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of CdnConfigs.
     *                       Format: `networks/{network_code}`
     *                       Please see {@see CdnConfigServiceClient::networkName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\ListCdnConfigsRequest
     *
     * @experimental
     */
