 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.GetRoleRequest</code>
 */
class GetRoleRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Role.
     *                     Format: `networks/{network_code}/roles/{role_id}`
     *                     Please see {@see RoleServiceClient::roleName()} for help formatting this field.
     *
     * @return \Google\Ads\AdManager\V1\GetRoleRequest
     *
     * @experimental
     */
