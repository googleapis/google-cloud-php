 ...
 *
 * Generated from protobuf message <code>google.ads.admanager.v1.BatchCreateSitesRequest</code>
 */
class BatchCreateSitesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string                                       $parent   Required. The parent resource where `Sites` will be created.
     *                                                               Format: `networks/{network_code}`
     *                                                               The parent field in the CreateSiteRequest must match this
     *                                                               field. Please see
     *                                                               {@see SiteServiceClient::networkName()} for help formatting this field.
     * @param \Google\Ads\AdManager\V1\CreateSiteRequest[] $requests Required. The `Site` objects to create.
     *                                                               A maximum of 100 objects can be created in a batch.
     *
     * @return \Google\Ads\AdManager\V1\BatchCreateSitesRequest
     *
     * @experimental
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\AdManager\V1\CreateSiteRequest::class);
        $this->requests = $arr;
