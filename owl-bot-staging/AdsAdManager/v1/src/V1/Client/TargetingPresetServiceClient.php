 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/targeting_preset_service.proto
...
final class TargetingPresetServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.TargetingPresetService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/targeting_preset_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/targeting_preset_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/targeting_preset_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * targeting_preset resource.
     *
     * @param string $networkCode
     * @param string $targetingPreset
     *
     * @return string The formatted targeting_preset resource.
     */
    public static function targetingPresetName(string $networkCode, string $targetingPreset): string
    {
        return self::getPathTemplate('targetingPreset')->render([
            'network_code' => $networkCode,
     ...
     *           use Google\Ads\AdManager\V1\TargetingPresetServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new TargetingPresetServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see TargetingPresetServiceClient::batchCreateTargetingPresetsAsync()} .
     *
     * @example samples/V1/TargetingPresetServiceClient/batch_create_targeting_presets.php
     *
     * @param BatchCreateTargetingPresetsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return BatchCreateTargetingPresetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateTargetingPresets(BatchCreateTargetingPresetsRequest $request, array $callOptions = []): BatchCreateTargetingPresetsResponse
    {
        return $this->startApiCall('BatchCreateTargetingPresets', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see TargetingPresetServiceClient::batchDeactivateTargetingPresetsAsync()} .
     *
     * @example samples/V1/TargetingPresetServiceClient/batch_deactivate_targeting_presets.php
     *
     * @param BatchDeactivateTargetingPresetsRequest $request     A request to house fields associated with the call.
     * @param array                                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchDeactivateTargetingPresetsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateTargetingPresets(BatchDeactivateTargetingPresetsRequest $request, array $callOptions = []): BatchDeactivateTargetingPresetsResponse
    {
        return $this->startApiCall('BatchDeactivateTargetingPresets', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateTargetingPresets(BatchUpdateTargetingPresetsRequest $request, array $callOptions = []): BatchUpdateTargetingPresetsResponse
    {
     ...
     *
     * The async variant is
     * {@see TargetingPresetServiceClient::createTargetingPresetAsync()} .
     *
     * @example samples/V1/TargetingPresetServiceClient/create_targeting_preset.php
     *
     * @param CreateTargetingPresetRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createTargetingPreset(CreateTargetingPresetRequest $request, array $callOptions = []): TargetingPreset
    {
        return $this->startApiCall('CreateTargetingPreset', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see TargetingPresetServiceClient::getTargetingPresetAsync()} .
     *
     * @example samples/V1/TargetingPresetServiceClient/get_targeting_preset.php
     *
     * @param GetTargetingPresetRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getTargetingPreset(GetTargetingPresetRequest $request, array $callOptions = []): TargetingPreset
    {
        return $this->startApiCall('GetTargetingPreset', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see TargetingPresetServiceClient::listTargetingPresetsAsync()} .
     *
     * @example samples/V1/TargetingPresetServiceClient/list_targeting_presets.php
     *
     * @param ListTargetingPresetsRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listTargetingPresets(ListTargetingPresetsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateTargetingPreset(UpdateTargetingPresetRequest $request, array $callOptions = []): TargetingPreset
    {
