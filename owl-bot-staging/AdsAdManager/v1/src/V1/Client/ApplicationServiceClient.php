 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/application_service.proto
...
final class ApplicationServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.ApplicationService';
     ...
     *           use Google\Ads\AdManager\V1\ApplicationServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ApplicationServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchArchiveApplications(BatchArchiveApplicationsRequest $request, array $callOptions = []): BatchArchiveApplicationsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateApplications(BatchCreateApplicationsRequest $request, array $callOptions = []): BatchCreateApplicationsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUnarchiveApplications(BatchUnarchiveApplicationsRequest $request, array $callOptions = []): BatchUnarchiveApplicationsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateApplications(BatchUpdateApplicationsRequest $request, array $callOptions = []): BatchUpdateApplicationsResponse
    {
     ...
     *
     * @example samples/V1/ApplicationServiceClient/get_application.php
     *
     ...
     *
     * @example samples/V1/ApplicationServiceClient/list_applications.php
     *
