 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/cms_metadata_key_service.proto
 ...
 */
final class CmsMetadataKeyServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.CmsMetadataKeyService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/cms_metadata_key_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/cms_metadata_key_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/cms_metadata_key_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * cms_metadata_key resource.
     *
     * @param string $networkCode
     * @param string $cmsMetadataKey
     *
     * @return string The formatted cms_metadata_key resource.
     */
    public static function cmsMetadataKeyName(string $networkCode, string $cmsMetadataKey): string
    {
        return self::getPathTemplate('cmsMetadataKey')->render([
     ...
     *           use Google\Ads\AdManager\V1\CmsMetadataKeyServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CmsMetadataKeyServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateCmsMetadataKeys(BatchActivateCmsMetadataKeysRequest $request, array $callOptions = []): BatchActivateCmsMetadataKeysResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateCmsMetadataKeys(BatchDeactivateCmsMetadataKeysRequest $request, array $callOptions = []): BatchDeactivateCmsMetadataKeysResponse
    {
     ...
     *
     * @example samples/V1/CmsMetadataKeyServiceClient/get_cms_metadata_key.php
     *
     * @param GetCmsMetadataKeyRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getCmsMetadataKey(GetCmsMetadataKeyRequest $request, array $callOptions = []): CmsMetadataKey
    {
        return $this->startApiCall('GetCmsMetadataKey', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/CmsMetadataKeyServiceClient/list_cms_metadata_keys.php
     *
     * @param ListCmsMetadataKeysRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listCmsMetadataKeys(ListCmsMetadataKeysRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListCmsMetadataKeys', $request, $callOptions);
    }
}
