 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/cms_metadata_value_service.proto
 ...
 */
final class CmsMetadataValueServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.CmsMetadataValueService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/cms_metadata_value_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/cms_metadata_value_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/cms_metadata_value_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\CmsMetadataValueServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CmsMetadataValueServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateCmsMetadataValues(BatchActivateCmsMetadataValuesRequest $request, array $callOptions = []): BatchActivateCmsMetadataValuesResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateCmsMetadataValues(BatchDeactivateCmsMetadataValuesRequest $request, array $callOptions = []): BatchDeactivateCmsMetadataValuesResponse
    {
     ...
     *
     * @example samples/V1/CmsMetadataValueServiceClient/get_cms_metadata_value.php
     *
     * @param GetCmsMetadataValueRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getCmsMetadataValue(GetCmsMetadataValueRequest $request, array $callOptions = []): CmsMetadataValue
    {
        return $this->startApiCall('GetCmsMetadataValue', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/CmsMetadataValueServiceClient/list_cms_metadata_values.php
     *
     * @param ListCmsMetadataValuesRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listCmsMetadataValues(ListCmsMetadataValuesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListCmsMetadataValues', $request, $callOptions);
    }
}
