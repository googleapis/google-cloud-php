 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/content_service.proto
...
final class ContentServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.ContentService';
     ...
     *           use Google\Ads\AdManager\V1\ContentServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ContentServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
