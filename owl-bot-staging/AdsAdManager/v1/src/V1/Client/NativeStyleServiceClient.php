 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/native_style_service.proto
 ...
 *
 * @method PromiseInterface<BatchActivateNativeStylesResponse> batchActivateNativeStylesAsync(BatchActivateNativeStylesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<BatchArchiveNativeStylesResponse> batchArchiveNativeStylesAsync(BatchArchiveNativeStylesRequest $request, array $optionalArgs = [])
...
final class NativeStyleServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.NativeStyleService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/native_style_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/native_style_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/native_style_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * creative_template resource.
     *
     * @param string $networkCode
     * @param string $creativeTemplate
     *
     * @return string The formatted creative_template resource.
     */
    public static function creativeTemplateName(string $networkCode, string $creativeTemplate): string
    {
        return self::getPathTemplate('creativeTemplate')->render([
            'network_code' => $networkCode,
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a native_style
     * resource.
     *
     * @param string $networkCode
     * @param string $nativeStyle
     *
     * @return string The formatted native_style resource.
     */
    public static function nativeStyleName(string $networkCode, string $nativeStyle): string
    {
        return self::getPathTemplate('nativeStyle')->render([
            'network_code' => $networkCode,
     ...
     * - creativeTemplate: networks/{network_code}/creativeTemplates/{creative_template}
     ...
     * - nativeStyle: networks/{network_code}/nativeStyles/{native_style}
     ...
     *           use Google\Ads\AdManager\V1\NativeStyleServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new NativeStyleServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see NativeStyleServiceClient::batchActivateNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/batch_activate_native_styles.php
     *
     * @param BatchActivateNativeStylesRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return BatchActivateNativeStylesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchActivateNativeStyles(BatchActivateNativeStylesRequest $request, array $callOptions = []): BatchActivateNativeStylesResponse
    {
        return $this->startApiCall('BatchActivateNativeStyles', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see NativeStyleServiceClient::batchArchiveNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/batch_archive_native_styles.php
     *
     * @param BatchArchiveNativeStylesRequest $request     A request to house fields associated with the call.
     * @param array                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchArchiveNativeStylesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchArchiveNativeStyles(BatchArchiveNativeStylesRequest $request, array $callOptions = []): BatchArchiveNativeStylesResponse
    {
        return $this->startApiCall('BatchArchiveNativeStyles', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see NativeStyleServiceClient::batchCreateNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/batch_create_native_styles.php
     *
     * @param BatchCreateNativeStylesRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchCreateNativeStylesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateNativeStyles(BatchCreateNativeStylesRequest $request, array $callOptions = []): BatchCreateNativeStylesResponse
    {
        return $this->startApiCall('BatchCreateNativeStyles', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see NativeStyleServiceClient::batchDeactivateNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/batch_deactivate_native_styles.php
     *
     * @param BatchDeactivateNativeStylesRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchDeactivateNativeStylesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateNativeStyles(BatchDeactivateNativeStylesRequest $request, array $callOptions = []): BatchDeactivateNativeStylesResponse
    {
        return $this->startApiCall('BatchDeactivateNativeStyles', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see NativeStyleServiceClient::batchUpdateNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/batch_update_native_styles.php
     *
     * @param BatchUpdateNativeStylesRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchUpdateNativeStylesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateNativeStyles(BatchUpdateNativeStylesRequest $request, array $callOptions = []): BatchUpdateNativeStylesResponse
    {
        return $this->startApiCall('BatchUpdateNativeStyles', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/NativeStyleServiceClient/get_native_style.php
     *
     * @param GetNativeStyleRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getNativeStyle(GetNativeStyleRequest $request, array $callOptions = []): NativeStyle
    {
        return $this->startApiCall('GetNativeStyle', $request, $callOptions)->wait();
    }

    /**
     * Lists `NativeStyle` objects.
     *
     * The async variant is {@see NativeStyleServiceClient::listNativeStylesAsync()} .
     *
     * @example samples/V1/NativeStyleServiceClient/list_native_styles.php
     *
     * @param ListNativeStylesRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
