 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/contact_service.proto
 ...
 *
 * @method PromiseInterface<BatchCreateContactsResponse> batchCreateContactsAsync(BatchCreateContactsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<BatchUpdateContactsResponse> batchUpdateContactsAsync(BatchUpdateContactsRequest $request, array $optionalArgs = [])
 ...
 */
final class ContactServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.ContactService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/contact_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/contact_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/contact_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\ContactServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ContactServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ContactServiceClient/batch_create_contacts.php
     *
     * @param BatchCreateContactsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function batchCreateContacts(BatchCreateContactsRequest $request, array $callOptions = []): BatchCreateContactsResponse
    {
        return $this->startApiCall('BatchCreateContacts', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/ContactServiceClient/batch_update_contacts.php
     *
     * @param BatchUpdateContactsRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateContacts(BatchUpdateContactsRequest $request, array $callOptions = []): BatchUpdateContactsResponse
    {
        return $this->startApiCall('BatchUpdateContacts', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/ContactServiceClient/create_contact.php
     *
     ...
     *
     * @example samples/V1/ContactServiceClient/get_contact.php
     *
     ...
     *
     * @example samples/V1/ContactServiceClient/list_contacts.php
     *
     ...
     *
     * @example samples/V1/ContactServiceClient/update_contact.php
     *
