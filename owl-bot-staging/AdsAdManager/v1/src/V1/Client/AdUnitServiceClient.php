 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/ad_unit_service.proto
...
final class AdUnitServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.AdUnitService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_unit_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_unit_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_unit_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\AdUnitServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdUnitServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateAdUnits(BatchActivateAdUnitsRequest $request, array $callOptions = []): BatchActivateAdUnitsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchArchiveAdUnits(BatchArchiveAdUnitsRequest $request, array $callOptions = []): BatchArchiveAdUnitsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateAdUnits(BatchCreateAdUnitsRequest $request, array $callOptions = []): BatchCreateAdUnitsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateAdUnits(BatchDeactivateAdUnitsRequest $request, array $callOptions = []): BatchDeactivateAdUnitsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateAdUnits(BatchUpdateAdUnitsRequest $request, array $callOptions = []): BatchUpdateAdUnitsResponse
    {
     ...
     *
     * @example samples/V1/AdUnitServiceClient/get_ad_unit.php
     *
     * @param GetAdUnitRequest $request     A request to house fields associated with the call.
     * @param array            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getAdUnit(GetAdUnitRequest $request, array $callOptions = []): AdUnit
    {
        return $this->startApiCall('GetAdUnit', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/AdUnitServiceClient/list_ad_unit_sizes.php
     *
     * @param ListAdUnitSizesRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listAdUnitSizes(ListAdUnitSizesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListAdUnitSizes', $request, $callOptions);
    }
     ...
     *
     * @example samples/V1/AdUnitServiceClient/list_ad_units.php
     *
     * @param ListAdUnitsRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
