 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/ad_rule_service.proto
 ...
 *
 * @method PromiseInterface<BatchActivateAdRulesResponse> batchActivateAdRulesAsync(BatchActivateAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<BatchCreateAdRulesResponse> batchCreateAdRulesAsync(BatchCreateAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<BatchDeactivateAdRulesResponse> batchDeactivateAdRulesAsync(BatchDeactivateAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<void> batchDeleteAdRulesAsync(BatchDeleteAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<BatchUpdateAdRulesResponse> batchUpdateAdRulesAsync(BatchUpdateAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<AdRule> createAdRuleAsync(CreateAdRuleRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<AdRule> getAdRuleAsync(GetAdRuleRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAdRulesAsync(ListAdRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<AdRule> updateAdRuleAsync(UpdateAdRuleRequest $request, array $optionalArgs = [])
 */
final class AdRuleServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.AdRuleService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/ad_rule_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/ad_rule_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/ad_rule_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a ad_rule
     * resource.
     *
     * @param string $networkCode
     * @param string $adRule
     *
     * @return string The formatted ad_rule resource.
     */
    public static function adRuleName(string $networkCode, string $adRule): string
    {
        return self::getPathTemplate('adRule')->render([
     ...
     *           use Google\Ads\AdManager\V1\AdRuleServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AdRuleServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see AdRuleServiceClient::batchActivateAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/batch_activate_ad_rules.php
     *
     * @param BatchActivateAdRulesRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return BatchActivateAdRulesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchActivateAdRules(BatchActivateAdRulesRequest $request, array $callOptions = []): BatchActivateAdRulesResponse
    {
        return $this->startApiCall('BatchActivateAdRules', $request, $callOptions)->wait();
    }

    /**
     * Batch creates `AdRule` objects.
     *
     * The async variant is {@see AdRuleServiceClient::batchCreateAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/batch_create_ad_rules.php
     *
     * @param BatchCreateAdRulesRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchCreateAdRulesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateAdRules(BatchCreateAdRulesRequest $request, array $callOptions = []): BatchCreateAdRulesResponse
    {
        return $this->startApiCall('BatchCreateAdRules', $request, $callOptions)->wait();
    }

    /**
     * Deactivates a list of `AdRule` objects.
     *
     * The async variant is {@see AdRuleServiceClient::batchDeactivateAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/batch_deactivate_ad_rules.php
     *
     * @param BatchDeactivateAdRulesRequest $request     A request to house fields associated with the call.
     * @param array                         $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchDeactivateAdRulesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateAdRules(BatchDeactivateAdRulesRequest $request, array $callOptions = []): BatchDeactivateAdRulesResponse
    {
        return $this->startApiCall('BatchDeactivateAdRules', $request, $callOptions)->wait();
    }

    /**
     * Deletes a list of `AdRule` objects.
     *
     * The async variant is {@see AdRuleServiceClient::batchDeleteAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/batch_delete_ad_rules.php
     *
     * @param BatchDeleteAdRulesRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeleteAdRules(BatchDeleteAdRulesRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('BatchDeleteAdRules', $request, $callOptions)->wait();
    }

    /**
     * Batch updates `AdRule` objects.
     *
     * The async variant is {@see AdRuleServiceClient::batchUpdateAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/batch_update_ad_rules.php
     *
     * @param BatchUpdateAdRulesRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return BatchUpdateAdRulesResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateAdRules(BatchUpdateAdRulesRequest $request, array $callOptions = []): BatchUpdateAdRulesResponse
    {
        return $this->startApiCall('BatchUpdateAdRules', $request, $callOptions)->wait();
    }

    /**
     * Creates a `AdRule` object.
     *
     * The async variant is {@see AdRuleServiceClient::createAdRuleAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/create_ad_rule.php
     *
     * @param CreateAdRuleRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createAdRule(CreateAdRuleRequest $request, array $callOptions = []): AdRule
    {
        return $this->startApiCall('CreateAdRule', $request, $callOptions)->wait();
    }

    /**
     * Retrieves an `AdRule` object.
     *
     * The async variant is {@see AdRuleServiceClient::getAdRuleAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/get_ad_rule.php
     *
     * @param GetAdRuleRequest $request     A request to house fields associated with the call.
     * @param array            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getAdRule(GetAdRuleRequest $request, array $callOptions = []): AdRule
    {
        return $this->startApiCall('GetAdRule', $request, $callOptions)->wait();
    }

    /**
     * Lists `AdRule` objects.
     *
     * The async variant is {@see AdRuleServiceClient::listAdRulesAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/list_ad_rules.php
     *
     * @param ListAdRulesRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listAdRules(ListAdRulesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListAdRules', $request, $callOptions);
    }

    /**
     * Updates a `AdRule` object.
     *
     * The async variant is {@see AdRuleServiceClient::updateAdRuleAsync()} .
     *
     * @example samples/V1/AdRuleServiceClient/update_ad_rule.php
     *
     * @param UpdateAdRuleRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateAdRule(UpdateAdRuleRequest $request, array $callOptions = []): AdRule
    {
        return $this->startApiCall('UpdateAdRule', $request, $callOptions)->wait();
    }
}
