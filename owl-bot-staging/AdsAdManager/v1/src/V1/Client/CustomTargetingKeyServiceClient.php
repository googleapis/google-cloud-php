 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/custom_targeting_key_service.proto
...
final class CustomTargetingKeyServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.CustomTargetingKeyService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/custom_targeting_key_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/custom_targeting_key_service_descriptor_config.php',
            'credentialsConfig' => [
     ...
     *           use Google\Ads\AdManager\V1\CustomTargetingKeyServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomTargetingKeyServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateCustomTargetingKeys(BatchActivateCustomTargetingKeysRequest $request, array $callOptions = []): BatchActivateCustomTargetingKeysResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateCustomTargetingKeys(BatchCreateCustomTargetingKeysRequest $request, array $callOptions = []): BatchCreateCustomTargetingKeysResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateCustomTargetingKeys(BatchDeactivateCustomTargetingKeysRequest $request, array $callOptions = []): BatchDeactivateCustomTargetingKeysResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateCustomTargetingKeys(BatchUpdateCustomTargetingKeysRequest $request, array $callOptions = []): BatchUpdateCustomTargetingKeysResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createCustomTargetingKey(CreateCustomTargetingKeyRequest $request, array $callOptions = []): CustomTargetingKey
    {
     ...
     *
     * @example samples/V1/CustomTargetingKeyServiceClient/get_custom_targeting_key.php
     *
     * @param GetCustomTargetingKeyRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * @example samples/V1/CustomTargetingKeyServiceClient/list_custom_targeting_keys.php
     *
     * @param ListCustomTargetingKeysRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateCustomTargetingKey(UpdateCustomTargetingKeyRequest $request, array $callOptions = []): CustomTargetingKey
    {
