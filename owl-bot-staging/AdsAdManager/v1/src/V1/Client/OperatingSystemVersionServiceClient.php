 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/operating_system_version_service.proto
 ...
 *
 * @method PromiseInterface<OperatingSystemVersion> getOperatingSystemVersionAsync(GetOperatingSystemVersionRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listOperatingSystemVersionsAsync(ListOperatingSystemVersionsRequest $request, array $optionalArgs = [])
 */
final class OperatingSystemVersionServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.ads.admanager.v1.OperatingSystemVersionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/operating_system_version_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/operating_system_version_service_descriptor_config.php',
            'credentialsConfig' => [
     ...
     *           use Google\Ads\AdManager\V1\OperatingSystemVersionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new OperatingSystemVersionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/OperatingSystemVersionServiceClient/get_operating_system_version.php
     *
     * @param GetOperatingSystemVersionRequest $request     A request to house fields associated with the call.
     ...
     *
     * @example samples/V1/OperatingSystemVersionServiceClient/list_operating_system_versions.php
     *
     * @param ListOperatingSystemVersionsRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
