...
final class ContentBundleServiceClient
{
     ...
     */
    public function batchActivateContentBundles(BatchActivateContentBundlesRequest $request, array $callOptions = []): BatchActivateContentBundlesResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateContentBundles(BatchDeactivateContentBundlesRequest $request, array $callOptions = []): BatchDeactivateContentBundlesResponse
    {
