 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/company_service.proto
...
final class CompanyServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.CompanyService';
     ...
     *           use Google\Ads\AdManager\V1\CompanyServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CompanyServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchCreateCompanies(BatchCreateCompaniesRequest $request, array $callOptions = []): BatchCreateCompaniesResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateCompanies(BatchUpdateCompaniesRequest $request, array $callOptions = []): BatchUpdateCompaniesResponse
    {
     ...
     *
     * @example samples/V1/CompanyServiceClient/get_company.php
     *
     ...
     *
     * @example samples/V1/CompanyServiceClient/list_companies.php
     *
