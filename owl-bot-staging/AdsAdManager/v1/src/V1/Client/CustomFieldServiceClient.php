 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/custom_field_service.proto
...
final class CustomFieldServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.CustomFieldService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/custom_field_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/custom_field_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/custom_field_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\CustomFieldServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CustomFieldServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateCustomFields(BatchActivateCustomFieldsRequest $request, array $callOptions = []): BatchActivateCustomFieldsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchCreateCustomFields(BatchCreateCustomFieldsRequest $request, array $callOptions = []): BatchCreateCustomFieldsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateCustomFields(BatchDeactivateCustomFieldsRequest $request, array $callOptions = []): BatchDeactivateCustomFieldsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchUpdateCustomFields(BatchUpdateCustomFieldsRequest $request, array $callOptions = []): BatchUpdateCustomFieldsResponse
    {
     ...
     *
     * @example samples/V1/CustomFieldServiceClient/get_custom_field.php
     *
     * @param GetCustomFieldRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getCustomField(GetCustomFieldRequest $request, array $callOptions = []): CustomField
    {
        return $this->startApiCall('GetCustomField', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/CustomFieldServiceClient/list_custom_fields.php
     *
     * @param ListCustomFieldsRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
