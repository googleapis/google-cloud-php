 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/admanager/v1/audience_segment_service.proto
...
final class AudienceSegmentServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.admanager.v1.AudienceSegmentService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/audience_segment_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/audience_segment_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/audience_segment_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Ads\AdManager\V1\AudienceSegmentServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AudienceSegmentServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchActivateAudienceSegments(BatchActivateAudienceSegmentsRequest $request, array $callOptions = []): BatchActivateAudienceSegmentsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchApproveAudienceSegments(BatchApproveAudienceSegmentsRequest $request, array $callOptions = []): BatchApproveAudienceSegmentsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchDeactivateAudienceSegments(BatchDeactivateAudienceSegmentsRequest $request, array $callOptions = []): BatchDeactivateAudienceSegmentsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchPopulateAudienceSegments(BatchPopulateAudienceSegmentsRequest $request, array $callOptions = []): BatchPopulateAudienceSegmentsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchRejectAudienceSegments(BatchRejectAudienceSegmentsRequest $request, array $callOptions = []): BatchRejectAudienceSegmentsResponse
    {
     ...
     *
     * @example samples/V1/AudienceSegmentServiceClient/get_audience_segment.php
     *
     * @param GetAudienceSegmentRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getAudienceSegment(GetAudienceSegmentRequest $request, array $callOptions = []): AudienceSegment
    {
        return $this->startApiCall('GetAudienceSegment', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/AudienceSegmentServiceClient/list_audience_segments.php
     *
     * @param ListAudienceSegmentsRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listAudienceSegments(ListAudienceSegmentsRequest $request, array $callOptions = []): PagedListResponse
    {
