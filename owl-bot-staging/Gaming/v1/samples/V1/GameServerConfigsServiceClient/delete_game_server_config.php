 ...
 *
 * @param string $formattedName The name of the game server config to delete, in the following form:
 ...
 */
function delete_game_server_config_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $gameServerConfigsServiceClient->deleteGameServerConfig($formattedName);
...
function callSample(): void
{
    ...
    delete_game_server_config_sample($formattedName);
}
