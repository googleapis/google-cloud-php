...
class ListOrganizationEventsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.servicehealth.v1.OrganizationEventView view = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\ServiceHealth\V1\OrganizationEventView::class);
        $this->view = $var;
