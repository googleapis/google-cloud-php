 ...
 *
 * Protobuf type <code>google.cloud.servicehealth.v1.Event.DetailedState</code>
 */
class DetailedState
{
    /**
...
class_alias(DetailedState::class, \Google\Cloud\ServiceHealth\V1\Event_DetailedState::class);
