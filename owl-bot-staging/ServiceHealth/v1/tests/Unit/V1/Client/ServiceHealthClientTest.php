...
namespace Google\Cloud\ServiceHealth\Tests\Unit\V1\Client;
...
use Google\Cloud\ServiceHealth\V1\ListEventsResponse;
use Google\Cloud\ServiceHealth\V1\ListOrganizationEventsRequest;
use Google\Cloud\ServiceHealth\V1\ListOrganizationEventsResponse;
use Google\Cloud\ServiceHealth\V1\ListOrganizationImpactsRequest;
use Google\Cloud\ServiceHealth\V1\ListOrganizationImpactsResponse;
 ...
 * @group gapic
 */
class ServiceHealthClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new ServiceHealthClient($options);
    }
    ...
    public function getEventTest()
    {
        ...
        $parentEvent = 'parentEvent1393243845';
    ...
    /** @test */
    public function getOrganizationEventTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $description = 'description-1724546052';
        $parentEvent = 'parentEvent1393243845';
        $expectedResponse = new OrganizationEvent();
        $expectedResponse->setName($name2);
        $expectedResponse->setTitle($title);
        $expectedResponse->setDescription($description);
        $expectedResponse->setParentEvent($parentEvent);
    ...
    /** @test */
    public function getOrganizationEventExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getOrganizationImpactTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getOrganizationImpactExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listOrganizationEventsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $organizationEventsElement = new OrganizationEvent();
        $organizationEvents = [
            $organizationEventsElement,
        ];
        $expectedResponse = new ListOrganizationEventsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getOrganizationEvents()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listOrganizationEventsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listOrganizationImpactsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $organizationImpactsElement = new OrganizationImpact();
        $organizationImpacts = [
            $organizationImpactsElement,
        ];
        $expectedResponse = new ListOrganizationImpactsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getOrganizationImpacts()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listOrganizationImpactsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getEventAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
