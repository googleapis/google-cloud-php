...
class ReservationServiceGapicClient
{
    ...
    public function createCapacityCommitment(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['capacityCommitmentId'])) {
            $request->setCapacityCommitmentId($optionalArgs['capacityCommitmentId']);
        }
    ...
    public function searchAllAssignments(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('SearchAllAssignments', $optionalArgs, SearchAllAssignmentsResponse::class, $request);
    }
    ...
    public function updateAssignment(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateAssignment', Assignment::class, $optionalArgs, $request)->wait();
    }
