...
final class ReservationServiceClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createReservationGroup(CreateReservationGroupRequest $request, array $callOptions = []): ReservationGroup
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listReservationGroups(ListReservationGroupsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateReservationGroup(UpdateReservationGroupRequest $request, array $callOptions = []): ReservationGroup
    {
