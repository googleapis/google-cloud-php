...
use Google\Cloud\Functions\V2\Environment;
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Functions\V2\Client\FunctionServiceClient}.
 */
class FunctionServiceGapicClient
{
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\Functions\V2\Environment}
     *     @type RetrySettings|array $retrySettings
     *           Retry settings to use for this call. Can be a {@see RetrySettings} object, or an
     *           associative array of retry settings parameters. See the documentation on
     *           {@see RetrySettings} for example usage.
    ...
    public function getFunction($name, array $optionalArgs = [])
    {
        ...
        $request->setName($name);
        $requestParamHeaders['name'] = $name;
        if (isset($optionalArgs['revision'])) {
            $request->setRevision($optionalArgs['revision']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetFunction', PBFunction::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listRuntimes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListRuntimes', ListRuntimesResponse::class, $optionalArgs, $request)->wait();
    }
