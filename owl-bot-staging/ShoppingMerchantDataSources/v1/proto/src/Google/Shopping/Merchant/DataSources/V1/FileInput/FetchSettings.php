 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1.FileInput.FetchSettings</code>
 */
class FetchSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.datasources.v1.FileInput.FetchSettings.Frequency frequency = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Shopping\Merchant\Datasources\V1\Fileinputs::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\DataSources\V1\FileInput\FetchSettings\Frequency::class);
        $this->frequency = $var;
...
class_alias(FetchSettings::class, \Google\Shopping\Merchant\DataSources\V1\FileInput_FetchSettings::class);
