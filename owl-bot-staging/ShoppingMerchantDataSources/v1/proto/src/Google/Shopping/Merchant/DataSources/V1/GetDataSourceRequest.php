 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1.GetDataSourceRequest</code>
 */
class GetDataSourceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the data source to retrieve.
     *                     Format: `accounts/{account}/dataSources/{datasource}`
     *                     Please see {@see DataSourcesServiceClient::dataSourceName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\DataSources\V1\GetDataSourceRequest
     *
     * @experimental
     */
