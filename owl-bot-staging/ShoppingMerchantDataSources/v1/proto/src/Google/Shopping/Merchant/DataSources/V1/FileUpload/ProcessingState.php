 ...
 *
 * Protobuf type <code>google.shopping.merchant.datasources.v1.FileUpload.ProcessingState</code>
 */
...
class_alias(ProcessingState::class, \Google\Shopping\Merchant\DataSources\V1\FileUpload_ProcessingState::class);
