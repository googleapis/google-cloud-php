...
namespace Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.datasources.v1.FileUpload.Issue.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Shopping\Merchant\DataSources\V1\FileUpload_Issue_Severity::class);
