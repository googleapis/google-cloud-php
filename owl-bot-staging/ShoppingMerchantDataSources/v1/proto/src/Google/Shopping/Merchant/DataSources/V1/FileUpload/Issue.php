 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1.FileUpload.Issue</code>
 */
class Issue extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.datasources.v1.FileUpload.Issue.Severity severity = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue\Severity::class);
        $this->severity = $var;
...
class_alias(Issue::class, \Google\Shopping\Merchant\DataSources\V1\FileUpload_Issue::class);
