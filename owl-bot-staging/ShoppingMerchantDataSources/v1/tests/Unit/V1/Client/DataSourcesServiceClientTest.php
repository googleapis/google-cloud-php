...
class DataSourcesServiceClientTest extends GeneratedTest
{
    ...
    public function createDataSourceTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/CreateDataSource', $actualFuncCall);
    ...
    public function deleteDataSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/DeleteDataSource', $actualFuncCall);
    ...
    public function fetchDataSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/FetchDataSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listDataSourcesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/ListDataSources', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateDataSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/UpdateDataSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getDataSource();
        $this->assertProtobufEquals($dataSource, $actualValue);
