...
class DlpServiceGapicClient
{
    ...
    private static function getColumnDataProfileNameTemplate()
    {
        if (self::$columnDataProfileNameTemplate == null) {
            self::$columnDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/columnDataProfiles/{column_data_profile}');
        }
    ...
    private static function getConnectionNameTemplate()
    {
        if (self::$connectionNameTemplate == null) {
            self::$connectionNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/connections/{connection}');
        }
    ...
    private static function getDiscoveryConfigNameTemplate()
    {
        if (self::$discoveryConfigNameTemplate == null) {
            self::$discoveryConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/discoveryConfigs/{discovery_config}');
        }
    ...
    private static function getFileStoreDataProfileNameTemplate()
    {
        if (self::$fileStoreDataProfileNameTemplate == null) {
            self::$fileStoreDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/fileStoreDataProfiles/{file_store_data_profile}');
        }
    ...
    private static function getOrganizationLocationColumnDataProfileNameTemplate()
    {
        if (self::$organizationLocationColumnDataProfileNameTemplate == null) {
            self::$organizationLocationColumnDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/columnDataProfiles/{column_data_profile}');
        }
    ...
    private static function getOrganizationLocationConnectionNameTemplate()
    {
        if (self::$organizationLocationConnectionNameTemplate == null) {
            self::$organizationLocationConnectionNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/connections/{connection}');
        }
    ...
    {
        if (self::$organizationLocationFileStoreDataProfileNameTemplate == null) {
            self::$organizationLocationFileStoreDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/fileStoreDataProfiles/{file_store_data_profile}');
        }
    ...
    private static function getOrganizationLocationProjectDataProfileNameTemplate()
    {
        if (self::$organizationLocationProjectDataProfileNameTemplate == null) {
            self::$organizationLocationProjectDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/projectDataProfiles/{project_data_profile}');
        }
    ...
    private static function getOrganizationLocationTableDataProfileNameTemplate()
    {
        if (self::$organizationLocationTableDataProfileNameTemplate == null) {
            self::$organizationLocationTableDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/tableDataProfiles/{table_data_profile}');
        }
    ...
    private static function getProjectDataProfileNameTemplate()
    {
        if (self::$projectDataProfileNameTemplate == null) {
            self::$projectDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/projectDataProfiles/{project_data_profile}');
        }
    ...
    private static function getProjectLocationColumnDataProfileNameTemplate()
    {
        if (self::$projectLocationColumnDataProfileNameTemplate == null) {
            self::$projectLocationColumnDataProfileNameTemplate = new PathTemplate('projects/{project}/locations/{location}/columnDataProfiles/{column_data_profile}');
        }
    ...
    private static function getProjectLocationConnectionNameTemplate()
    {
        if (self::$projectLocationConnectionNameTemplate == null) {
            self::$projectLocationConnectionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/connections/{connection}');
        }
    ...
    private static function getProjectLocationFileStoreDataProfileNameTemplate()
    {
        if (self::$projectLocationFileStoreDataProfileNameTemplate == null) {
            self::$projectLocationFileStoreDataProfileNameTemplate = new PathTemplate('projects/{project}/locations/{location}/fileStoreDataProfiles/{file_store_data_profile}');
        }
    ...
    private static function getProjectLocationProjectDataProfileNameTemplate()
    {
        if (self::$projectLocationProjectDataProfileNameTemplate == null) {
            self::$projectLocationProjectDataProfileNameTemplate = new PathTemplate('projects/{project}/locations/{location}/projectDataProfiles/{project_data_profile}');
        }
    ...
    private static function getProjectLocationTableDataProfileNameTemplate()
    {
        if (self::$projectLocationTableDataProfileNameTemplate == null) {
            self::$projectLocationTableDataProfileNameTemplate = new PathTemplate('projects/{project}/locations/{location}/tableDataProfiles/{table_data_profile}');
        }
    ...
    private static function getTableDataProfileNameTemplate()
    {
        if (self::$tableDataProfileNameTemplate == null) {
            self::$tableDataProfileNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/tableDataProfiles/{table_data_profile}');
        }
     ...
     */
    public static function columnDataProfileName($organization, $location, $columnDataProfile)
    {
     ...
     */
    public static function discoveryConfigName($project, $location, $discoveryConfig)
    {
     ...
     */
    public static function fileStoreDataProfileName($organization, $location, $fileStoreDataProfile)
    {
     ...
     */
    public static function organizationLocationColumnDataProfileName($organization, $location, $columnDataProfile)
    {
     ...
     */
    public static function organizationLocationConnectionName($organization, $location, $connection)
    {
     ...
     */
    public static function organizationLocationFileStoreDataProfileName($organization, $location, $fileStoreDataProfile)
    {
     ...
     */
    public static function organizationLocationProjectDataProfileName($organization, $location, $projectDataProfile)
    {
     ...
     */
    public static function organizationLocationTableDataProfileName($organization, $location, $tableDataProfile)
    {
     ...
     */
    public static function projectDataProfileName($organization, $location, $projectDataProfile)
    {
     ...
     */
    public static function projectLocationColumnDataProfileName($project, $location, $columnDataProfile)
    {
     ...
     */
    public static function projectLocationConnectionName($project, $location, $connection)
    {
     ...
     */
    public static function projectLocationFileStoreDataProfileName($project, $location, $fileStoreDataProfile)
    {
     ...
     */
    public static function projectLocationProjectDataProfileName($project, $location, $projectDataProfile)
    {
     ...
     */
    public static function projectLocationTableDataProfileName($project, $location, $tableDataProfile)
    {
     ...
     */
    public static function tableDataProfileName($organization, $location, $tableDataProfile)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createDiscoveryConfig($parent, $discoveryConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateDiscoveryConfig', DiscoveryConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteDiscoveryConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteDiscoveryConfig', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteFileStoreDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteFileStoreDataProfile', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteTableDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteTableDataProfile', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getColumnDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetColumnDataProfile', ColumnDataProfile::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDiscoveryConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDiscoveryConfig', DiscoveryConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getFileStoreDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetFileStoreDataProfile', FileStoreDataProfile::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getProjectDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetProjectDataProfile', ProjectDataProfile::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTableDataProfile($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTableDataProfile', TableDataProfile::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listColumnDataProfiles($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListColumnDataProfiles', $optionalArgs, ListColumnDataProfilesResponse::class, $request);
    }
    ...
    public function listDiscoveryConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDiscoveryConfigs', $optionalArgs, ListDiscoveryConfigsResponse::class, $request);
    }
    ...
    public function listFileStoreDataProfiles($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListFileStoreDataProfiles', $optionalArgs, ListFileStoreDataProfilesResponse::class, $request);
    }
    ...
    public function listProjectDataProfiles($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListProjectDataProfiles', $optionalArgs, ListProjectDataProfilesResponse::class, $request);
    }
    ...
    public function listTableDataProfiles($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTableDataProfiles', $optionalArgs, ListTableDataProfilesResponse::class, $request);
    }
    ...
    public function searchConnections($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('SearchConnections', $optionalArgs, SearchConnectionsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateConnection($name, $connection, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateDiscoveryConfig($name, $discoveryConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateDiscoveryConfig', DiscoveryConfig::class, $optionalArgs, $request)->wait();
    }
