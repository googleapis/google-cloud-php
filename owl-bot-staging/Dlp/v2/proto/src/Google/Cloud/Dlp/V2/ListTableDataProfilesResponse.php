 ...
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2.ListTableDataProfilesResponse</code>
 */
class ListTableDataProfilesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->table_data_profiles;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dlp\V2\TableDataProfile::class);
        $this->table_data_profiles = $arr;
