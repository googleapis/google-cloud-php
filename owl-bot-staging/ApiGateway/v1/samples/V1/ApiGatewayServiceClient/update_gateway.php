 ...
 */
function update_gateway_sample(string $formattedApiConfig): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $apiGatewayServiceClient->updateGateway($gateway, $formattedApiConfig);
...
function callSample(): void
{
    ...
    update_gateway_sample($formattedApiConfig);
}
