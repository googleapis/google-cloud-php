...
namespace Google\Cloud\Support\V2beta\Escalation;
 ...
 *
 * Protobuf type <code>google.cloud.support.v2beta.Escalation.Reason</code>
 */
class Reason
{
    /**
...
class_alias(Reason::class, \Google\Cloud\Support\V2beta\Escalation_Reason::class);
