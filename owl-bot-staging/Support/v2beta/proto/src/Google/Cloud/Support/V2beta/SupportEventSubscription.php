 ...
 * for beta)
 *
 * Generated from protobuf message <code>google.cloud.support.v2beta.SupportEventSubscription</code>
 */
class SupportEventSubscription extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.SupportEventSubscription.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.SupportEventSubscription.FailureReason failure_reason = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Support\V2beta\SupportEventSubscription\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Support\V2beta\SupportEventSubscription\FailureReason::class);
