...
use Google\Cloud\Support\V2beta\CaseClassification;
use Google\Cloud\Support\V2beta\Client\CaseServiceClient;
use Google\Cloud\Support\V2beta\CloseCaseRequest;
use Google\Cloud\Support\V2beta\CreateCaseRequest;
use Google\Cloud\Support\V2beta\EscalateCaseRequest;
use Google\Cloud\Support\V2beta\GetCaseRequest;
use Google\Cloud\Support\V2beta\ListCasesRequest;
use Google\Cloud\Support\V2beta\ListCasesResponse;
use Google\Cloud\Support\V2beta\PBCase;
use Google\Cloud\Support\V2beta\SearchCaseClassificationsRequest;
use Google\Cloud\Support\V2beta\SearchCaseClassificationsResponse;
use Google\Cloud\Support\V2beta\SearchCasesRequest;
use Google\Cloud\Support\V2beta\SearchCasesResponse;
use Google\Cloud\Support\V2beta\UpdateCaseRequest;
use Google\Rpc\Code;
use stdClass;
...
class CaseServiceClientTest extends GeneratedTest
{
    ...
    public function closeCaseTest()
    {
        ...
        $this->assertSame('/google.cloud.support.v2beta.CaseService/CloseCase', $actualFuncCall);
    ...
    public function createCaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/CreateCase', $actualFuncCall);
    ...
    public function escalateCaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/EscalateCase', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getCaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/GetCase', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listCasesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/ListCases', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function searchCaseClassificationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/SearchCaseClassifications', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateCaseTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CaseService/UpdateCase', $actualFuncCall);
        $actualValue = $actualRequestObject->getCase();
        $this->assertProtobufEquals($case, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
