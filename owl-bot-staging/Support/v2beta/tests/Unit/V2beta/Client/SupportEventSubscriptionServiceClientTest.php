...
class SupportEventSubscriptionServiceClientTest extends GeneratedTest
{
    ...
    public function createSupportEventSubscriptionTest()
    {
        ...
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/CreateSupportEventSubscription', $actualFuncCall);
    ...
    public function deleteSupportEventSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/DeleteSupportEventSubscription', $actualFuncCall);
    ...
    public function expungeSupportEventSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/ExpungeSupportEventSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getSupportEventSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/GetSupportEventSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSupportEventSubscriptionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/ListSupportEventSubscriptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function undeleteSupportEventSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/UndeleteSupportEventSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateSupportEventSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.SupportEventSubscriptionService/UpdateSupportEventSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getSupportEventSubscription();
        $this->assertProtobufEquals($supportEventSubscription, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
