 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/geminidataanalytics/v1/data_chat_service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\GeminiDataAnalytics\V1\Client;
...
use Google\Cloud\GeminiDataAnalytics\V1\ChatRequest;
...
use Google\Cloud\GeminiDataAnalytics\V1\GetConversationRequest;
 ...
 */
final class DataChatServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.geminidataanalytics.v1.DataChatService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/data_chat_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/data_chat_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/data_chat_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/data_chat_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\GeminiDataAnalytics\V1\DataChatServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new DataChatServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/DataChatServiceClient/chat.php
     *
     ...
     * }
     *
     * @return ServerStream<Message>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function chat(ChatRequest $request, array $callOptions = []): ServerStream
    {
        return $this->startApiCall('Chat', $request, $callOptions);
    }
     ...
     *
     * The async variant is {@see DataChatServiceClient::createConversationAsync()} .
     *
     * @example samples/V1/DataChatServiceClient/create_conversation.php
     *
     ...
     *
     * @example samples/V1/DataChatServiceClient/delete_conversation.php
     *
     ...
     *
     * @example samples/V1/DataChatServiceClient/get_conversation.php
     *
     ...
     *
     * The async variant is {@see DataChatServiceClient::listConversationsAsync()} .
     *
     * @example samples/V1/DataChatServiceClient/list_conversations.php
     *
     ...
     *
     * The async variant is {@see DataChatServiceClient::listMessagesAsync()} .
     *
     * @example samples/V1/DataChatServiceClient/list_messages.php
     *
     ...
     *
     * The async variant is {@see DataChatServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/DataChatServiceClient/get_location.php
     *
    ...
    **Global locations**: If `name` is empty, the method lists the
     ...
     *
     * @example samples/V1/DataChatServiceClient/list_locations.php
     *
