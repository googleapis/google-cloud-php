 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.ListAccessibleDataAgentsRequest</code>
 */
class ListAccessibleDataAgentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.ListAccessibleDataAgentsRequest.CreatorFilter creator_filter = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * @return \Google\Cloud\GeminiDataAnalytics\V1\ListAccessibleDataAgentsRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\GeminiDataAnalytics\V1\ListAccessibleDataAgentsRequest\CreatorFilter::class);
