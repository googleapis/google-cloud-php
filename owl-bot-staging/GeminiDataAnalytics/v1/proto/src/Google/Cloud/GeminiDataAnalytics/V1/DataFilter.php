 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.DataFilter</code>
 */
class DataFilter extends \Google\Protobuf\Internal\Message
{
     ...
     * ALWAYS_FILTER.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.DataFilterType type = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\GeminiDataAnalytics\V1\DataFilterType::class);
        $this->type = $var;
