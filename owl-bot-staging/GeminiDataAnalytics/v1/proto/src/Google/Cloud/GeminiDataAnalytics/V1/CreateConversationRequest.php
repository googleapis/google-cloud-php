 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.CreateConversationRequest</code>
 */
class CreateConversationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.Conversation conversation = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\GeminiDataAnalytics\V1\Conversation $conversation   Required. The conversation to create.
     * @param string                                            $conversationId Optional. The conversation id of the conversation to create.
     *                                                                          Must be unique within the parent.
     *                                                                          The allowed format is: `^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$`.
     *                                                                          If not provided, the server will auto-generate a value for the id.
     *
     * @return \Google\Cloud\GeminiDataAnalytics\V1\CreateConversationRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\GeminiDataAnalytics\V1\Conversation $conversation, string $conversationId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           The allowed format is: `^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$`.
     *           If not provided, the server will auto-generate a value for the id.
     *     @type \Google\Cloud\GeminiDataAnalytics\V1\Conversation $conversation
     *           Required. The conversation to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.Conversation conversation = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\GeminiDataAnalytics\V1\Conversation|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GeminiDataAnalytics\V1\Conversation::class);
