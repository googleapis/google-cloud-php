...
namespace Google\Cloud\GeminiDataAnalytics\V1\DataAgentContext;
 ...
 * data agent.
 *
 * Protobuf type <code>google.cloud.geminidataanalytics.v1.DataAgentContext.ContextVersion</code>
 */
