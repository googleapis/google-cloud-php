 ...
 * A field in a schema.
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.Field</code>
 */
class Field extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1.Field subfields = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $subfields;
    /**
     ...
     *           Optional. Field display_name (same as label in
     *     @type \Google\Cloud\GeminiDataAnalytics\V1\Field[] $subfields
     *           Optional. Recursive property for nested schema structures.
