 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/geminidataanalytics/v1beta/data_agent_service.proto
 ...
 */
final class DataAgentServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.geminidataanalytics.v1beta.DataAgentService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/data_agent_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/data_agent_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/data_agent_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/data_agent_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @param string $dataAgent
     *
     * @return string The formatted data_agent resource.
     *
     * @experimental
     */
    public static function dataAgentName(string $project, string $location, string $dataAgent): string
    {
        return self::getPathTemplate('dataAgent')->render([
            'project' => $project,
            'location' => $location,
     ...
     *           use Google\Cloud\GeminiDataAnalytics\V1beta\DataAgentServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new DataAgentServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see DataAgentServiceClient::createDataAgentAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/create_data_agent.php
     *
     ...
     * }
     *
     * @return OperationResponse<DataAgent>
     *
     * @throws ApiException Thrown if the API call fails.
     *
     * @experimental
     */
    public function createDataAgent(CreateDataAgentRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * @example samples/V1beta/DataAgentServiceClient/delete_data_agent.php
     *
     ...
     *
     * The async variant is {@see DataAgentServiceClient::getDataAgentAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/get_data_agent.php
     *
     * @param GetDataAgentRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function getDataAgent(GetDataAgentRequest $request, array $callOptions = []): DataAgent
    {
        return $this->startApiCall('GetDataAgent', $request, $callOptions)->wait();
    }

    /**
     * Gets the IAM policy for DataAgent
     *
     * The async variant is {@see DataAgentServiceClient::getIamPolicyAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/get_iam_policy.php
     *
     ...
     * {@see DataAgentServiceClient::listAccessibleDataAgentsAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/list_accessible_data_agents.php
     *
     * @param ListAccessibleDataAgentsRequest $request     A request to house fields associated with the call.
     * @param array                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see DataAgentServiceClient::listDataAgentsAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/list_data_agents.php
     *
     * @param ListDataAgentsRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * @example samples/V1beta/DataAgentServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is {@see DataAgentServiceClient::updateDataAgentAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/update_data_agent.php
     *
     ...
     *
     * The async variant is {@see DataAgentServiceClient::getLocationAsync()} .
     *
     * @example samples/V1beta/DataAgentServiceClient/get_location.php
     *
     ...
     *
     * @example samples/V1beta/DataAgentServiceClient/list_locations.php
     *
