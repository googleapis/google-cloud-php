...
return [
    'interfaces' => [
        'google.cloud.geminidataanalytics.v1beta.DataAgentService' => [
            'CreateDataAgent' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*}/dataAgents',
                'body' => 'data_agent',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'GetIamPolicy' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{resource=projects/*/locations/*/dataAgents/*}:getIamPolicy',
                'body' => '*',
                'placeholders' => [
                    'resource' => [
                        'getters' => [
            ...
            'ListAccessibleDataAgents' => [
                'method' => 'get',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*}/dataAgents:listAccessible',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
