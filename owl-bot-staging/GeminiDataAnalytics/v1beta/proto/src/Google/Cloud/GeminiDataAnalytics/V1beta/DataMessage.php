...
class DataMessage extends \Google\Protobuf\Internal\Message
{
     ...
     * Looker Query generated by the system to retrieve data.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.LookerQuery generated_looker_query = 4 [deprecated = true];</code>
    ...
    {
        if ($this->hasOneof(4)) {
            @trigger_error('generated_looker_query is deprecated.', E_USER_DEPRECATED);
        }
     ...
     * A pre-existing query that was matched to retrieve data.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.MatchedQuery matched_query = 6;</code>
