 ...
 * location.
 *
 * @param string $formattedParent Parent value for ListAccessibleDataAgentsRequest. Please see
 *                                {@see DataAgentServiceClient::locationName()} for help formatting this field.
 */
function list_accessible_data_agents_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $dataAgentServiceClient->listAccessibleDataAgents($request);
...
function callSample(): void
{
    ...
    list_accessible_data_agents_sample($formattedParent);
}
