...
class DataChatServiceClientTest extends GeneratedTest
{
    ...
    public function chatTest()
    {
        ...
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/Chat', $actualFuncCall);
    ...
    public function createConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/CreateConversation', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
    ...
    public function deleteConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/DeleteConversation', $actualFuncCall);
    ...
    public function getConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/GetConversation', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listConversationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/ListConversations', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMessagesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1beta.DataChatService/ListMessages', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
