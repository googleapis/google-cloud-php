 ...
 * https://github.com/googleapis/googleapis/blob/master/google/developers/knowledge/v1/developerknowledge.proto
...
final class DeveloperKnowledgeClient
{
     ...
     *           as "<uri>:<port>". Default 'developerknowledge.googleapis.com:443'.
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchGetDocuments(BatchGetDocumentsRequest $request, array $callOptions = []): BatchGetDocumentsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchDocumentChunks(SearchDocumentChunksRequest $request, array $callOptions = []): PagedListResponse
    {
