 ...
 *
 * Generated from protobuf message <code>google.cloud.memcache.v1beta2.MaintenancePolicy</code>
 */
class MaintenancePolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memcache.v1beta2.WeeklyMaintenanceWindow weekly_maintenance_window = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Description of what this policy is for. Create/Update methods
     *           return INVALID_ARGUMENT if the length is greater than 512.
     *     @type array<\Google\Cloud\Memcache\V1beta2\WeeklyMaintenanceWindow>|\Google\Protobuf\Internal\RepeatedField $weekly_maintenance_window
     *           Required. Maintenance window that is applied to resources covered by this
     *           policy. Minimum 1. For the current version, the maximum number of
     *           weekly_maintenance_windows is expected to be one.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memcache.v1beta2.WeeklyMaintenanceWindow weekly_maintenance_window = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Cloud\Memcache\V1beta2\WeeklyMaintenanceWindow>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWeeklyMaintenanceWindow($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Memcache\V1beta2\WeeklyMaintenanceWindow::class);
