 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1beta.CreateMetadataImportRequest</code>
 */
class CreateMetadataImportRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1beta.MetadataImport metadata_import = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Metastore\V1beta\MetadataImport $metadataImport   Required. The metadata import to create. The `name` field is ignored. The
     *                                                                        ID of the created metadata import must be provided in the request's
     *                                                                        `metadata_import_id` field.
     ...
     *                                                                        or hyphens.
     *
     * @return \Google\Cloud\Metastore\V1beta\CreateMetadataImportRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Metastore\V1beta\MetadataImport $metadataImport, string $metadataImportId): self
    {
        return (new self())
            ->setParent($parent)
