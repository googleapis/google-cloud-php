 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1alpha.LocationMetadata</code>
 */
class LocationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.metastore.v1alpha.LocationMetadata.HiveMetastoreVersion supported_hive_metastore_versions = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Metastore\V1alpha\LocationMetadata\HiveMetastoreVersion[] $supported_hive_metastore_versions
     *           The versions of Hive Metastore that can be used when creating a new
     *           metastore service in this location. The server guarantees that exactly one
     *           `HiveMetastoreVersion` in the list will set `is_default`.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.metastore.v1alpha.LocationMetadata.HiveMetastoreVersion supported_hive_metastore_versions = 1;</code>
     * @return RepeatedField<\Google\Cloud\Metastore\V1alpha\LocationMetadata\HiveMetastoreVersion>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.metastore.v1alpha.LocationMetadata.HiveMetastoreVersion supported_hive_metastore_versions = 1;</code>
     * @param \Google\Cloud\Metastore\V1alpha\LocationMetadata\HiveMetastoreVersion[] $var
     * @return $this
     */
