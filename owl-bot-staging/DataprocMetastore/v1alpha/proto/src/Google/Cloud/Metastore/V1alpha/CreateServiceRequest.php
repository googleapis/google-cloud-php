...
class CreateServiceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\Metastore\V1alpha\Service $service   Required. The Metastore service to create. The `name` field is
     *                                                           ignored. The ID of the created metastore service must be provided in
     *                                                           the request's `service_id` field.
     ...
     *                                                           ASCII characters or hyphens.
     *
     * @return \Google\Cloud\Metastore\V1alpha\CreateServiceRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Metastore\V1alpha\Service $service, string $serviceId): self
    {
        return (new self())
            ->setParent($parent)
            ->setService($service)
