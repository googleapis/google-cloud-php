...
namespace Google\Cloud\Metastore\V1alpha\Client;
 ...
 * @method PromiseInterface removeIamPolicyAsync(RemoveIamPolicyRequest $request, array $optionalArgs = [])
...
final class DataprocMetastoreClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.metastore.v1alpha.DataprocMetastore';
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/alter_metadata_resource_location.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/create_backup.php
     *
     ...
     * .
     *
     * @example samples/V1alpha/DataprocMetastoreClient/create_metadata_import.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/create_service.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/delete_backup.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/delete_service.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/export_metadata.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/get_backup.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/get_metadata_import.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/get_service.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/list_backups.php
     *
     ...
     * .
     *
     * @example samples/V1alpha/DataprocMetastoreClient/list_metadata_imports.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/list_services.php
     *
     ...
     * .
     *
     * @example samples/V1alpha/DataprocMetastoreClient/move_table_to_database.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/query_metadata.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/remove_iam_policy.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/restore_service.php
     *
     ...
     * .
     *
     * @example samples/V1alpha/DataprocMetastoreClient/update_metadata_import.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/update_service.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/get_location.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/list_locations.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/get_iam_policy.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/set_iam_policy.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreClient/test_iam_permissions.php
     *
