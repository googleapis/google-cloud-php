...
class LocationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Metastore\V1\LocationMetadata\HiveMetastoreVersion[] $supported_hive_metastore_versions
     *           The versions of Hive Metastore that can be used when creating a new
     *           metastore service in this location. The server guarantees that exactly one
     *           `HiveMetastoreVersion` in the list will set `is_default`.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.metastore.v1.LocationMetadata.HiveMetastoreVersion supported_hive_metastore_versions = 1;</code>
     * @return RepeatedField<\Google\Cloud\Metastore\V1\LocationMetadata\HiveMetastoreVersion>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.metastore.v1.LocationMetadata.HiveMetastoreVersion supported_hive_metastore_versions = 1;</code>
     * @param \Google\Cloud\Metastore\V1\LocationMetadata\HiveMetastoreVersion[] $var
     * @return $this
     */
