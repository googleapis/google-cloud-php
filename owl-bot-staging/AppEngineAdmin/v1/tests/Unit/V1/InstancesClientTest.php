...
class InstancesClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function debugInstanceTest()
    {
        ...
        $incompleteOperation->setName('operations/debugInstanceTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $id = 'id3355';
        $appEngineRelease = 'appEngineRelease-720849688';
        $vmName = 'vmName562937619';
        $vmZoneName = 'vmZoneName-1200108618';
        $vmId = 'vmId112317347';
        $requests = 393257020;
        $errors = 1294635157;
        $qps = 11218;
        ...
        $expectedResponse->setAppEngineRelease($appEngineRelease);
        $expectedResponse->setVmName($vmName);
        $expectedResponse->setVmZoneName($vmZoneName);
        $expectedResponse->setVmId($vmId);
        $expectedResponse->setRequests($requests);
        $expectedResponse->setErrors($errors);
        $expectedResponse->setQps($qps);
        $expectedResponse->setAverageLatency($averageLatency);
        $expectedResponse->setMemoryUsage($memoryUsage);
        $expectedResponse->setVmStatus($vmStatus);
        $expectedResponse->setVmDebugEnabled($vmDebugEnabled);
        $expectedResponse->setVmIp($vmIp);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/debugInstanceTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->debugInstance();
        ...
        $this->assertSame('/google.appengine.v1.Instances/DebugInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/debugInstanceTest');
    ...
    /** @test */
    public function debugInstanceExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Instances/DeleteInstance', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getInstanceTest()
    {
        ...
        $this->assertSame('/google.appengine.v1.Instances/GetInstance', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Instances/ListInstances', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
