...
class AuthorizedCertificatesClientTest extends GeneratedTest
{
    ...
    public function createAuthorizedCertificateTest()
    {
        ...
        $response = $gapicClient->createAuthorizedCertificate($request);
    ...
    public function createAuthorizedCertificateExceptionTest()
    {
        ...
        $request = new CreateAuthorizedCertificateRequest();
        try {
            $gapicClient->createAuthorizedCertificate($request);
    ...
    public function deleteAuthorizedCertificateTest()
    {
        ...
        $gapicClient->deleteAuthorizedCertificate($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function getAuthorizedCertificateTest()
    {
        ...
        $response = $gapicClient->getAuthorizedCertificate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getAuthorizedCertificateExceptionTest()
    {
        ...
        $request = new GetAuthorizedCertificateRequest();
        try {
            $gapicClient->getAuthorizedCertificate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listAuthorizedCertificatesTest()
    {
        ...
        $response = $gapicClient->listAuthorizedCertificates($request);
    ...
    public function listAuthorizedCertificatesExceptionTest()
    {
        ...
        $request = new ListAuthorizedCertificatesRequest();
        try {
            $gapicClient->listAuthorizedCertificates($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateAuthorizedCertificateTest()
    {
        ...
        $response = $gapicClient->updateAuthorizedCertificate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateAuthorizedCertificateExceptionTest()
    {
        ...
        $request = new UpdateAuthorizedCertificateRequest();
        try {
            $gapicClient->updateAuthorizedCertificate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function createAuthorizedCertificateAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        $request = new CreateAuthorizedCertificateRequest();
        $response = $gapicClient->createAuthorizedCertificateAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
