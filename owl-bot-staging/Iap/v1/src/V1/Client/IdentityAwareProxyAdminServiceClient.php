...
final class IdentityAwareProxyAdminServiceClient
{
     ...
     */
    public static function tunnelDestGroupName(string $project, string $location, string $destGroup): string
    {
        return self::getPathTemplate('tunnelDestGroup')->render([
            'project' => $project,
            'location' => $location,
     ...
     */
    public static function tunnelLocationName(string $project, string $location): string
    {
        return self::getPathTemplate('tunnelLocation')->render([
            'project' => $project,
            'location' => $location,
        ]);
    }
     ...
     *           $options = new IdentityAwareProxyAdminServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteTunnelDestGroup(DeleteTunnelDestGroupRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteTunnelDestGroup', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getIapSettings(GetIapSettingsRequest $request, array $callOptions = []): IapSettings
    {
        return $this->startApiCall('GetIapSettings', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getTunnelDestGroup(GetTunnelDestGroupRequest $request, array $callOptions = []): TunnelDestGroup
    {
        return $this->startApiCall('GetTunnelDestGroup', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateIapSettings(UpdateIapSettingsRequest $request, array $callOptions = []): IapSettings
    {
        return $this->startApiCall('UpdateIapSettings', $request, $callOptions)->wait();
    }
