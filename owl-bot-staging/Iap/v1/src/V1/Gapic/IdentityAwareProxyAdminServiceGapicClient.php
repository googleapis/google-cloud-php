...
class IdentityAwareProxyAdminServiceGapicClient
{
    ...
    private static function getTunnelDestGroupNameTemplate()
    {
        if (self::$tunnelDestGroupNameTemplate == null) {
            self::$tunnelDestGroupNameTemplate = new PathTemplate('projects/{project}/iap_tunnel/locations/{location}/destGroups/{dest_group}');
        }
    ...
    private static function getTunnelLocationNameTemplate()
    {
        if (self::$tunnelLocationNameTemplate == null) {
            self::$tunnelLocationNameTemplate = new PathTemplate('projects/{project}/iap_tunnel/locations/{location}');
        }
     ...
     */
    public function createTunnelDestGroup($parent, $tunnelDestGroup, $tunnelDestGroupId, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateTunnelDestGroup', TunnelDestGroup::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteTunnelDestGroup($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteTunnelDestGroup', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTunnelDestGroup($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTunnelDestGroup', TunnelDestGroup::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listTunnelDestGroups($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTunnelDestGroups', $optionalArgs, ListTunnelDestGroupsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTunnelDestGroup($tunnelDestGroup, array $optionalArgs = [])
    {
        $request = new UpdateTunnelDestGroupRequest();
        $requestParamHeaders = [];
        $request->setTunnelDestGroup($tunnelDestGroup);
        $requestParamHeaders['tunnel_dest_group.name'] = $tunnelDestGroup->getName();
        if (isset($optionalArgs['updateMask'])) {
            $request->setUpdateMask($optionalArgs['updateMask']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateTunnelDestGroup', TunnelDestGroup::class, $optionalArgs, $request)->wait();
    }
}
