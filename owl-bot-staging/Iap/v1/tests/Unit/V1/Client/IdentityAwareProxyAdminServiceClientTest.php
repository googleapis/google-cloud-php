...
class IdentityAwareProxyAdminServiceClientTest extends GeneratedTest
{
    ...
    public function validateIapAttributeExpressionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.iap.v1.IdentityAwareProxyAdminService/ValidateIapAttributeExpression', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($name, $actualValue);
    ...
    /** @test */
    public function createTunnelDestGroupAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
