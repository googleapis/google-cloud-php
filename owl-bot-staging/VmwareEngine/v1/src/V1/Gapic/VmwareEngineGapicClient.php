...
class VmwareEngineGapicClient
{
    ...
    private static function getClusterNameTemplate()
    {
        if (self::$clusterNameTemplate == null) {
            self::$clusterNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/clusters/{cluster}');
        }
    ...
    private static function getDnsBindPermissionNameTemplate()
    {
        if (self::$dnsBindPermissionNameTemplate == null) {
            self::$dnsBindPermissionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/dnsBindPermission');
        }
    ...
    private static function getDnsForwardingNameTemplate()
    {
        if (self::$dnsForwardingNameTemplate == null) {
            self::$dnsForwardingNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/dnsForwarding');
        }
    ...
    private static function getExternalAccessRuleNameTemplate()
    {
        if (self::$externalAccessRuleNameTemplate == null) {
            self::$externalAccessRuleNameTemplate = new PathTemplate('projects/{project}/locations/{location}/networkPolicies/{network_policy}/externalAccessRules/{external_access_rule}');
        }
    ...
    private static function getExternalAddressNameTemplate()
    {
        if (self::$externalAddressNameTemplate == null) {
            self::$externalAddressNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/externalAddresses/{external_address}');
        }
    ...
    private static function getHcxActivationKeyNameTemplate()
    {
        if (self::$hcxActivationKeyNameTemplate == null) {
            self::$hcxActivationKeyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/hcxActivationKeys/{hcx_activation_key}');
        }
    ...
    private static function getLoggingServerNameTemplate()
    {
        if (self::$loggingServerNameTemplate == null) {
            self::$loggingServerNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/loggingServers/{logging_server}');
        }
    ...
    private static function getManagementDnsZoneBindingNameTemplate()
    {
        if (self::$managementDnsZoneBindingNameTemplate == null) {
            self::$managementDnsZoneBindingNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/managementDnsZoneBindings/{management_dns_zone_binding}');
        }
    ...
    private static function getNetworkPeeringNameTemplate()
    {
        if (self::$networkPeeringNameTemplate == null) {
            self::$networkPeeringNameTemplate = new PathTemplate('projects/{project}/locations/{location}/networkPeerings/{network_peering}');
        }
    ...
    private static function getNetworkPolicyNameTemplate()
    {
        if (self::$networkPolicyNameTemplate == null) {
            self::$networkPolicyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/networkPolicies/{network_policy}');
        }
    ...
    private static function getNodeNameTemplate()
    {
        if (self::$nodeNameTemplate == null) {
            self::$nodeNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/clusters/{cluster}/nodes/{node}');
        }
    ...
    private static function getNodeTypeNameTemplate()
    {
        if (self::$nodeTypeNameTemplate == null) {
            self::$nodeTypeNameTemplate = new PathTemplate('projects/{project}/locations/{location}/nodeTypes/{node_type}');
        }
    ...
    private static function getPrivateCloudNameTemplate()
    {
        if (self::$privateCloudNameTemplate == null) {
            self::$privateCloudNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}');
        }
    ...
    private static function getSubnetNameTemplate()
    {
        if (self::$subnetNameTemplate == null) {
            self::$subnetNameTemplate = new PathTemplate('projects/{project}/locations/{location}/privateClouds/{private_cloud}/subnets/{subnet}');
        }
    ...
    private static function getVmwareEngineNetworkNameTemplate()
    {
        if (self::$vmwareEngineNetworkNameTemplate == null) {
            self::$vmwareEngineNetworkNameTemplate = new PathTemplate('projects/{project}/locations/{location}/vmwareEngineNetworks/{vmware_engine_network}');
        }
     ...
     */
    public static function clusterName($project, $location, $privateCloud, $cluster)
    {
     ...
     */
    public static function externalAccessRuleName($project, $location, $networkPolicy, $externalAccessRule)
    {
     ...
     */
    public static function externalAddressName($project, $location, $privateCloud, $externalAddress)
    {
     ...
     */
    public static function hcxActivationKeyName($project, $location, $privateCloud, $hcxActivationKey)
    {
     ...
     */
    public static function loggingServerName($project, $location, $privateCloud, $loggingServer)
    {
     ...
     */
    public static function managementDnsZoneBindingName($project, $location, $privateCloud, $managementDnsZoneBinding)
    {
     ...
     */
    public static function networkPeeringName($project, $location, $networkPeering)
    {
     ...
     */
    public static function networkPolicyName($project, $location, $networkPolicy)
    {
     ...
     */
    public static function nodeName($project, $location, $privateCloud, $cluster, $node)
    {
     ...
     */
    public static function subnetName($project, $location, $privateCloud, $subnet)
    {
     ...
     */
    public static function vmwareEngineNetworkName($project, $location, $vmwareEngineNetwork)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createExternalAccessRule($parent, $externalAccessRule, $externalAccessRuleId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateExternalAccessRule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createExternalAddress($parent, $externalAddress, $externalAddressId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateExternalAddress', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createHcxActivationKey($parent, $hcxActivationKey, $hcxActivationKeyId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateHcxActivationKey', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createLoggingServer($parent, $loggingServer, $loggingServerId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateLoggingServer', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createManagementDnsZoneBinding($parent, $managementDnsZoneBinding, $managementDnsZoneBindingId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateManagementDnsZoneBinding', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createNetworkPeering($parent, $networkPeeringId, $networkPeering, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateNetworkPeering', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createNetworkPolicy($parent, $networkPolicyId, $networkPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateNetworkPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createPrivateCloud($parent, $privateCloudId, $privateCloud, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreatePrivateCloud', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createVmwareEngineNetwork($parent, $vmwareEngineNetworkId, $vmwareEngineNetwork, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateVmwareEngineNetwork', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteExternalAccessRule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteExternalAccessRule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteExternalAddress($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteExternalAddress', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteLoggingServer($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteLoggingServer', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteManagementDnsZoneBinding($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteManagementDnsZoneBinding', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteNetworkPeering($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteNetworkPeering', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteNetworkPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteNetworkPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deletePrivateCloud($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeletePrivateCloud', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteVmwareEngineNetwork($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteVmwareEngineNetwork', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function fetchNetworkPolicyExternalAddresses($networkPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('FetchNetworkPolicyExternalAddresses', $optionalArgs, FetchNetworkPolicyExternalAddressesResponse::class, $request);
    }
    ...
    public function getDnsBindPermission($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDnsBindPermission', DnsBindPermission::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDnsForwarding($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDnsForwarding', DnsForwarding::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getExternalAccessRule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetExternalAccessRule', ExternalAccessRule::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getExternalAddress($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetExternalAddress', ExternalAddress::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getHcxActivationKey($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetHcxActivationKey', HcxActivationKey::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getLoggingServer($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetLoggingServer', LoggingServer::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getManagementDnsZoneBinding($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetManagementDnsZoneBinding', ManagementDnsZoneBinding::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getNetworkPeering($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNetworkPeering', NetworkPeering::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getNetworkPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNetworkPolicy', NetworkPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getNodeType($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNodeType', NodeType::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getPrivateCloud($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetPrivateCloud', PrivateCloud::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getSubnet($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetSubnet', Subnet::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getVmwareEngineNetwork($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetVmwareEngineNetwork', VmwareEngineNetwork::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function grantDnsBindPermission($name, $principal, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('GrantDnsBindPermission', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function listExternalAccessRules($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListExternalAccessRules', $optionalArgs, ListExternalAccessRulesResponse::class, $request);
    }
    ...
    public function listExternalAddresses($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListExternalAddresses', $optionalArgs, ListExternalAddressesResponse::class, $request);
    }
    ...
    public function listHcxActivationKeys($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListHcxActivationKeys', $optionalArgs, ListHcxActivationKeysResponse::class, $request);
    }
    ...
    public function listLoggingServers($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListLoggingServers', $optionalArgs, ListLoggingServersResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listManagementDnsZoneBindings($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListManagementDnsZoneBindings', $optionalArgs, ListManagementDnsZoneBindingsResponse::class, $request);
    }
    ...
    public function listNetworkPeerings($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNetworkPeerings', $optionalArgs, ListNetworkPeeringsResponse::class, $request);
    }
    ...
    public function listNetworkPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNetworkPolicies', $optionalArgs, ListNetworkPoliciesResponse::class, $request);
    }
    ...
    public function listNodeTypes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNodeTypes', $optionalArgs, ListNodeTypesResponse::class, $request);
    }
    ...
    public function listPeeringRoutes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPeeringRoutes', $optionalArgs, ListPeeringRoutesResponse::class, $request);
    }
    ...
    public function listPrivateClouds($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPrivateClouds', $optionalArgs, ListPrivateCloudsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listPrivateConnectionPeeringRoutes($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPrivateConnectionPeeringRoutes', $optionalArgs, ListPrivateConnectionPeeringRoutesResponse::class, $request);
    }
    ...
    public function listSubnets($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSubnets', $optionalArgs, ListSubnetsResponse::class, $request);
    }
    ...
    public function listVmwareEngineNetworks($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListVmwareEngineNetworks', $optionalArgs, ListVmwareEngineNetworksResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function repairManagementDnsZoneBinding($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RepairManagementDnsZoneBinding', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function resetNsxCredentials($privateCloud, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ResetNsxCredentials', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function resetVcenterCredentials($privateCloud, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ResetVcenterCredentials', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function revokeDnsBindPermission($name, $principal, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RevokeDnsBindPermission', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function showNsxCredentials($privateCloud, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ShowNsxCredentials', Credentials::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function showVcenterCredentials($privateCloud, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ShowVcenterCredentials', Credentials::class, $optionalArgs, $request)->wait();
    }
    ...
    public function undeletePrivateCloud($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UndeletePrivateCloud', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateDnsForwarding($dnsForwarding, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateDnsForwarding', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateExternalAccessRule($updateMask, $externalAccessRule, array $optionalArgs = [])
    {
        $request = new UpdateExternalAccessRuleRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setExternalAccessRule($externalAccessRule);
        $requestParamHeaders['external_access_rule.name'] = $externalAccessRule->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateExternalAccessRule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateExternalAddress($updateMask, $externalAddress, array $optionalArgs = [])
    {
        $request = new UpdateExternalAddressRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setExternalAddress($externalAddress);
        $requestParamHeaders['external_address.name'] = $externalAddress->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateExternalAddress', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateLoggingServer($updateMask, $loggingServer, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateLoggingServer', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateManagementDnsZoneBinding($updateMask, $managementDnsZoneBinding, array $optionalArgs = [])
    {
        $request = new UpdateManagementDnsZoneBindingRequest();
        $requestParamHeaders = [];
        $request->setUpdateMask($updateMask);
        $request->setManagementDnsZoneBinding($managementDnsZoneBinding);
        $requestParamHeaders['management_dns_zone_binding.name'] = $managementDnsZoneBinding->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateManagementDnsZoneBinding', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateNetworkPeering($networkPeering, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateNetworkPeeringRequest();
        $requestParamHeaders = [];
        $request->setNetworkPeering($networkPeering);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['network_peering.name'] = $networkPeering->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateNetworkPeering', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateNetworkPolicy($networkPolicy, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateNetworkPolicy', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updatePrivateCloud($privateCloud, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdatePrivateCloud', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updatePrivateConnection($privateConnection, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdatePrivateConnectionRequest();
        $requestParamHeaders = [];
        $request->setPrivateConnection($privateConnection);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['private_connection.name'] = $privateConnection->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdatePrivateConnection', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateSubnet($updateMask, $subnet, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateSubnet', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateVmwareEngineNetwork($vmwareEngineNetwork, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateVmwareEngineNetworkRequest();
        $requestParamHeaders = [];
        $request->setVmwareEngineNetwork($vmwareEngineNetwork);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['vmware_engine_network.name'] = $vmwareEngineNetwork->getName();
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateVmwareEngineNetwork', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
