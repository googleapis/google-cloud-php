 ...
 *
 * Generated from protobuf message <code>google.cloud.vmwareengine.v1.CreatePrivateConnectionRequest</code>
 */
class CreatePrivateConnectionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\VmwareEngine\V1\PrivateConnection $privateConnection   Required. The initial description of the new private connection.
     ...
     *                                                                             (section 3.5)
     *
     * @return \Google\Cloud\VmwareEngine\V1\CreatePrivateConnectionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\VmwareEngine\V1\PrivateConnection $privateConnection, string $privateConnectionId): self
    {
        return (new self())
            ->setParent($parent)
