...
class MarketingplatformAdminServiceClientTest extends GeneratedTest
{
    ...
    public function findSalesPartnerManagedClientsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.marketingplatform.admin.v1alpha.MarketingplatformAdminService/FindSalesPartnerManagedClients', $actualFuncCall);
    ...
    public function reportPropertyUsageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.marketingplatform.admin.v1alpha.MarketingplatformAdminService/ReportPropertyUsage', $actualFuncCall);
        $actualValue = $actualRequestObject->getOrganization();
