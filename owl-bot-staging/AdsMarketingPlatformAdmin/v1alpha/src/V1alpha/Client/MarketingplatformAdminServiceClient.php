...
final class MarketingplatformAdminServiceClient
{
     ...
     * @experimental
     */
    public function findSalesPartnerManagedClients(FindSalesPartnerManagedClientsRequest $request, array $callOptions = []): FindSalesPartnerManagedClientsResponse
    {
     ...
     * @experimental
     */
    public function reportPropertyUsage(ReportPropertyUsageRequest $request, array $callOptions = []): ReportPropertyUsageResponse
    {
