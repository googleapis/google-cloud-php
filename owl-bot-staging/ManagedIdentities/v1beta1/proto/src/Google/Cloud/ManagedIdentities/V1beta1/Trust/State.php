 ...
 *
 * Protobuf type <code>google.cloud.managedidentities.v1beta1.Trust.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\ManagedIdentities\V1beta1\Trust_State::class);
