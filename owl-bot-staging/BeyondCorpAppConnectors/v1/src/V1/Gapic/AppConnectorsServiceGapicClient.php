 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\BeyondCorp\AppConnectors\V1\Client\AppConnectorsServiceClient}.
 */
class AppConnectorsServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/app_connectors_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/app_connectors_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/app_connectors_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/app_connectors_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getAppConnectorNameTemplate()
    {
        if (self::$appConnectorNameTemplate == null) {
            self::$appConnectorNameTemplate = new PathTemplate('projects/{project}/locations/{location}/appConnectors/{app_connector}');
        }
     ...
     */
    public function createAppConnector($parent, $appConnector, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateAppConnector', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteAppConnector($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteAppConnector', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getAppConnector($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAppConnector', AppConnector::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listAppConnectors($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListAppConnectors', $optionalArgs, ListAppConnectorsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function reportStatus($appConnector, $resourceInfo, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ReportStatus', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateAppConnector($updateMask, $appConnector, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateAppConnector', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
