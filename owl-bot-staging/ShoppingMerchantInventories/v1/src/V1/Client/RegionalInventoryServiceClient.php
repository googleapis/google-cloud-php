 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/inventories/v1/regionalinventory.proto
...
final class RegionalInventoryServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.inventories.v1.RegionalInventoryService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/regional_inventory_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/regional_inventory_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/regional_inventory_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     * @param string $region
     *
     * @return string The formatted regional_inventory resource.
     */
    public static function regionalInventoryName(string $account, string $product, string $region): string
    {
        return self::getPathTemplate('regionalInventory')->render([
            'account' => $account,
            'product' => $product,
            'region' => $region,
        ]);
     ...
     *           use Google\Shopping\Merchant\Inventories\V1\RegionalInventoryServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new RegionalInventoryServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/RegionalInventoryServiceClient/delete_regional_inventory.php
     *
     * @param DeleteRegionalInventoryRequest $request     A request to house fields associated with the call.
     ...
     */
    public function deleteRegionalInventory(DeleteRegionalInventoryRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteRegionalInventory', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/RegionalInventoryServiceClient/insert_regional_inventory.php
     *
     * @param InsertRegionalInventoryRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * @example samples/V1/RegionalInventoryServiceClient/list_regional_inventories.php
     *
     * @param ListRegionalInventoriesRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
