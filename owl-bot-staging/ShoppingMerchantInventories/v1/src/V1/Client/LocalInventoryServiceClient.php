 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/inventories/v1/localinventory.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Shopping\Merchant\Inventories\V1\Client;
...
final class LocalInventoryServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.inventories.v1.LocalInventoryService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/local_inventory_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/local_inventory_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/local_inventory_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/local_inventory_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function localInventoryName(string $account, string $product, string $storeCode): string
    {
        return self::getPathTemplate('localInventory')->render([
            'account' => $account,
            'product' => $product,
     ...
     *           use Google\Shopping\Merchant\Inventories\V1\LocalInventoryServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new LocalInventoryServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/LocalInventoryServiceClient/delete_local_inventory.php
     *
     * @param DeleteLocalInventoryRequest $request     A request to house fields associated with the call.
     ...
     */
    public function deleteLocalInventory(DeleteLocalInventoryRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteLocalInventory', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/LocalInventoryServiceClient/insert_local_inventory.php
     *
     * @param InsertLocalInventoryRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insertLocalInventory(InsertLocalInventoryRequest $request, array $callOptions = []): LocalInventory
    {
        return $this->startApiCall('InsertLocalInventory', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/LocalInventoryServiceClient/list_local_inventories.php
     *
     * @param ListLocalInventoriesRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
