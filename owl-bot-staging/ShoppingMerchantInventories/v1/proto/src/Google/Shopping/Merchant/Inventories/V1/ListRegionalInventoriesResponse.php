 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.inventories.v1.ListRegionalInventoriesResponse</code>
 */
class ListRegionalInventoriesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Inventories\V1\RegionalInventory::class);
