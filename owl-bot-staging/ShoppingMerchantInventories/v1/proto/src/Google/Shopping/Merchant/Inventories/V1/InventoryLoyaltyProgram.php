 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.inventories.v1.InventoryLoyaltyProgram</code>
 */
class InventoryLoyaltyProgram extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * comma, or slash.
     *
     * Generated from protobuf field <code>optional .google.type.Interval member_price_effective_interval = 6;</code>
     */
    protected $member_price_effective_interval = null;
    /**
     ...
     *           The amount of loyalty points earned on a purchase.
     *     @type \Google\Type\Interval $member_price_effective_interval
     *           A date range during which the item is eligible for member price. If not
     *           specified, the member price is always applicable. The date range is
     *           represented by a pair of ISO 8601 dates separated by a space,
     *           comma, or slash.
     ...
     */
    public function getMemberPriceEffectiveInterval()
    {
        return $this->member_price_effective_interval;
    }

    public function hasMemberPriceEffectiveInterval()
    {
        return isset($this->member_price_effective_interval);
    }

    public function clearMemberPriceEffectiveInterval()
    {
        unset($this->member_price_effective_interval);
    }
     ...
     * @return $this
     */
    public function setMemberPriceEffectiveInterval($var)
    {
        GPBUtil::checkMessage($var, \Google\Type\Interval::class);
        $this->member_price_effective_interval = $var;
