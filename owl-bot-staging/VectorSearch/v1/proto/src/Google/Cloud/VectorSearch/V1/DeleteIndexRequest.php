 ...
 *
 * Generated from protobuf message <code>google.cloud.vectorsearch.v1.DeleteIndexRequest</code>
 */
class DeleteIndexRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Index to delete.
     *                     Format:
     *                     `projects/{project}/locations/{location}/collections/{collection}/indexes/{index}`
     *                     Please see {@see VectorSearchServiceClient::indexName()} for help formatting this field.
     *
     * @return \Google\Cloud\VectorSearch\V1\DeleteIndexRequest
     *
     * @experimental
     */
