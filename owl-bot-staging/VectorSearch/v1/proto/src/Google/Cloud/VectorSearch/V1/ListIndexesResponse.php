 ...
 *
 * Generated from protobuf message <code>google.cloud.vectorsearch.v1.ListIndexesResponse</code>
 */
class ListIndexesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\VectorSearch\V1\Index::class);
        $this->indexes = $arr;
