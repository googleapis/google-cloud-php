...
return [
    'interfaces' => [
        'google.cloud.vectorsearch.v1.VectorSearchService' => [
            'CreateCollection' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\VectorSearch\V1\Collection',
            ...
            'ImportDataObjects' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => '\Google\Cloud\VectorSearch\V1\ImportDataObjectsMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
                    'totalPollTimeoutMillis' => '300000',
            ...
            'GetIndex' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\VectorSearch\V1\Index',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListCollections' => [
                ...
                'responseType' => 'Google\Cloud\VectorSearch\V1\ListCollectionsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListIndexes' => [
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\VectorSearch\V1\ListIndexesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
