...
class AppHubClientTest extends GeneratedTest
{
    ...
    public function deleteServiceProjectAttachmentTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->serviceProjectAttachmentName('[PROJECT]', '[LOCATION]', '[SERVICE_PROJECT_ATTACHMENT]');
    ...
    public function listServiceProjectAttachmentsTest()
    {
        ...
        $serviceProjectAttachments = [
            $serviceProjectAttachmentsElement,
        ];
