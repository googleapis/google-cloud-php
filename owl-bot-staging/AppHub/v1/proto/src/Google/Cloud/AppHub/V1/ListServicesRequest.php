 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.ListServicesRequest</code>
 */
class ListServicesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. Fully qualified name of the parent Application to list Services
     *                       for. Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\ListServicesRequest
     *
     * @experimental
     */
