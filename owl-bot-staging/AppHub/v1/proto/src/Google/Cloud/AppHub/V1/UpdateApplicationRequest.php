 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.UpdateApplicationRequest</code>
 */
class UpdateApplicationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.apphub.v1.Application application = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\AppHub\V1\Application $application Required. The resource being updated.
     ...
     *                                                         previously had.
     *
     * @return \Google\Cloud\AppHub\V1\UpdateApplicationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\AppHub\V1\Application $application, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
