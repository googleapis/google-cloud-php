 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.LookupServiceProjectAttachmentRequest</code>
 */
class LookupServiceProjectAttachmentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Service project ID and location to lookup service project
     *                     attachment for. Only global location is supported. Expected format:
     *                     `projects/{project}/locations/{location}`. Please see
     *                     {@see AppHubClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\AppHub\V1\LookupServiceProjectAttachmentRequest
     *
     * @experimental
     */
