 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.GetDiscoveredWorkloadRequest</code>
 */
class GetDiscoveredWorkloadRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Fully qualified name of the Discovered Workload to fetch.
     *                     Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\GetDiscoveredWorkloadRequest
     *
     * @experimental
     */
