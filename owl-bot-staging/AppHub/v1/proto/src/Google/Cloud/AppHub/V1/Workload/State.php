...
namespace Google\Cloud\AppHub\V1\Workload;
 ...
 * Workload state.
 *
 * Protobuf type <code>google.cloud.apphub.v1.Workload.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\AppHub\V1\Workload_State::class);
