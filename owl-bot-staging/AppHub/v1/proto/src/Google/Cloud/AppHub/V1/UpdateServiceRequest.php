 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.UpdateServiceRequest</code>
 */
class UpdateServiceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.apphub.v1.Service service = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\AppHub\V1\Service $service    Required. The resource being updated.
     ...
     *                                                    previously had.
     *
     * @return \Google\Cloud\AppHub\V1\UpdateServiceRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\AppHub\V1\Service $service, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
            ->setService($service)
