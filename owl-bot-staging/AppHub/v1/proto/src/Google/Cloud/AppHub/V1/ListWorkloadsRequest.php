 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.ListWorkloadsRequest</code>
 */
class ListWorkloadsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. Fully qualified name of the parent Application to list Workloads
     *                       for. Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\ListWorkloadsRequest
     *
     * @experimental
     */
