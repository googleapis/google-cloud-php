 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.DeleteWorkloadRequest</code>
 */
class DeleteWorkloadRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Fully qualified name of the Workload to delete from an
     *                     Application. Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\DeleteWorkloadRequest
     *
     * @experimental
     */
