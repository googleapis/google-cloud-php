 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.ListServiceProjectAttachmentsRequest</code>
 */
class ListServiceProjectAttachmentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Host project ID and location to list service project attachments.
     *                       Only global location is supported. Expected format:
     *                       `projects/{project}/locations/{location}`. Please see
     *                       {@see AppHubClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\AppHub\V1\ListServiceProjectAttachmentsRequest
     *
     * @experimental
     */
