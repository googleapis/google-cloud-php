 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.GetDiscoveredServiceRequest</code>
 */
class GetDiscoveredServiceRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Fully qualified name of the Discovered Service to fetch.
     *                     Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\GetDiscoveredServiceRequest
     *
     * @experimental
     */
