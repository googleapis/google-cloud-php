 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.GetServiceProjectAttachmentRequest</code>
 */
class GetServiceProjectAttachmentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Fully qualified name of the service project attachment to
     *                     retrieve. Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\GetServiceProjectAttachmentRequest
     *
     * @experimental
     */
