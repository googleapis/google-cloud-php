...
namespace Google\Cloud\Tpu\V2\Symptom;
 ...
 * at.
 *
 * Protobuf type <code>google.cloud.tpu.v2.Symptom.SymptomType</code>
 */
class SymptomType
{
    /**
...
class_alias(SymptomType::class, \Google\Cloud\Tpu\V2\Symptom_SymptomType::class);
