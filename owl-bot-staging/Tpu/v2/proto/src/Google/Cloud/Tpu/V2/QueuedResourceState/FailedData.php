 ...
 *
 * Generated from protobuf message <code>google.cloud.tpu.v2.QueuedResourceState.FailedData</code>
 */
class FailedData extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(FailedData::class, \Google\Cloud\Tpu\V2\QueuedResourceState_FailedData::class);
