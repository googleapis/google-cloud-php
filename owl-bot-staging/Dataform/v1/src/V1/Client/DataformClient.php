 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/dataform/v1/dataform.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\Dataform\V1\Client;
...
final class DataformClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dataform.v1.Dataform';
     ...
     *           use Google\Cloud\Dataform\V1\DataformClient;
     ...
     *
     * @example samples/V1/DataformClient/cancel_workflow_invocation.php
     *
     ...
     *
     * @example samples/V1/DataformClient/commit_repository_changes.php
     *
     ...
     *
     * @example samples/V1/DataformClient/commit_workspace_changes.php
     *
     ...
     *
     * @example samples/V1/DataformClient/compute_repository_access_token_status.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_compilation_result.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_release_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_repository.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_workflow_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_workflow_invocation.php
     *
     ...
     *
     * @example samples/V1/DataformClient/create_workspace.php
     *
     ...
     *
     * @example samples/V1/DataformClient/delete_release_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/delete_repository.php
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteTeamFolderTree(DeleteTeamFolderTreeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * @example samples/V1/DataformClient/delete_workflow_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/delete_workflow_invocation.php
     *
     ...
     *
     * @example samples/V1/DataformClient/delete_workspace.php
     *
     ...
     *
     * @example samples/V1/DataformClient/fetch_file_diff.php
     *
     ...
     *
     * @example samples/V1/DataformClient/fetch_file_git_statuses.php
     *
     ...
     *
     * @example samples/V1/DataformClient/fetch_git_ahead_behind.php
     *
     ...
     *
     * @example samples/V1/DataformClient/fetch_remote_branches.php
     *
     ...
     *
     * @example samples/V1/DataformClient/fetch_repository_history.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_compilation_result.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_release_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_repository.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_workflow_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_workflow_invocation.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_workspace.php
     *
     ...
     *
     * @example samples/V1/DataformClient/install_npm_packages.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_compilation_results.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_release_configs.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_repositories.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_workflow_configs.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_workflow_invocations.php
     *
     ...
     *
     * @example samples/V1/DataformClient/list_workspaces.php
     *
     ...
     *
     * @example samples/V1/DataformClient/make_directory.php
     *
     ...
     *
     * @example samples/V1/DataformClient/move_directory.php
     *
     ...
     *
     * @example samples/V1/DataformClient/move_file.php
     *
     ...
     *
     * @example samples/V1/DataformClient/pull_git_commits.php
     *
     ...
     *
     * @example samples/V1/DataformClient/push_git_commits.php
     *
     ...
     * .
     *
     * @example samples/V1/DataformClient/query_compilation_result_actions.php
     *
     ...
     *
     * @example samples/V1/DataformClient/query_directory_contents.php
     *
     ...
     *
     * @example samples/V1/DataformClient/query_repository_directory_contents.php
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function queryTeamFolderContents(QueryTeamFolderContentsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function queryUserRootContents(QueryUserRootContentsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * @example samples/V1/DataformClient/query_workflow_invocation_actions.php
     *
     ...
     *
     * @example samples/V1/DataformClient/read_file.php
     *
     ...
     *
     * @example samples/V1/DataformClient/read_repository_file.php
     *
     ...
     *
     * @example samples/V1/DataformClient/remove_directory.php
     *
     ...
     *
     * @example samples/V1/DataformClient/remove_file.php
     *
     ...
     *
     * @example samples/V1/DataformClient/reset_workspace_changes.php
     *
     ...
     *
     * @example samples/V1/DataformClient/search_files.php
     *
     ...
     *
     * @example samples/V1/DataformClient/update_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/update_release_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/update_repository.php
     *
     ...
     *
     * @example samples/V1/DataformClient/update_workflow_config.php
     *
     ...
     *
     * @example samples/V1/DataformClient/write_file.php
     *
     ...
     *
     * @example samples/V1/DataformClient/get_location.php
     *
    ...
    * **Global locations**: If `name` is empty, the method lists the
     ...
     *
     * @example samples/V1/DataformClient/list_locations.php
     *
