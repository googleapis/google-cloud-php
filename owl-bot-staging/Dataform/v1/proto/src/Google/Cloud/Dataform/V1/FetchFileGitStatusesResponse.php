 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.FetchFileGitStatusesResponse</code>
 */
class FetchFileGitStatusesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1\FetchFileGitStatusesResponse\UncommittedFileChange::class);
