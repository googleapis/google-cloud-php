...
namespace Google\Cloud\Dataform\V1\ComputeRepositoryAccessTokenStatusResponse;
 ...
 *
 * Protobuf type <code>google.cloud.dataform.v1.ComputeRepositoryAccessTokenStatusResponse.TokenStatus</code>
 */
class TokenStatus
{
    /**
...
class_alias(TokenStatus::class, \Google\Cloud\Dataform\V1\ComputeRepositoryAccessTokenStatusResponse_TokenStatus::class);
