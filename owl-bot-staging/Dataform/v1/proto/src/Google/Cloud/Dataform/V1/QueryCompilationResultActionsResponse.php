 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.QueryCompilationResultActionsResponse</code>
 */
class QueryCompilationResultActionsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1\CompilationResultAction::class);
