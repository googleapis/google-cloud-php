 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.ReleaseConfig</code>
 */
class ReleaseConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CodeCompilationConfig code_compilation_config = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1\ReleaseConfig\ScheduledReleaseRecord::class);
