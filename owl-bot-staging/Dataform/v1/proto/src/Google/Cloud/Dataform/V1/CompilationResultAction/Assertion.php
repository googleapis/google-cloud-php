 ...
 * rows.
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.CompilationResultAction.Assertion</code>
 */
class Assertion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.Target parent_action = 5;</code>
     */
     ...
     * columns.
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.RelationDescriptor relation_descriptor = 6;</code>
     */
     ...
     *           A list of actions that this action depends on.
     *     @type \Google\Cloud\Dataform\V1\Target $parent_action
     *           The parent action of this assertion. Only set if this assertion was
     *           automatically generated.
     *     @type bool $disabled
     *           Whether this action is disabled (i.e. should not be run).
...
class_alias(Assertion::class, \Google\Cloud\Dataform\V1\CompilationResultAction_Assertion::class);
