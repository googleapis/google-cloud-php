 ...
 *
 * Protobuf type <code>google.cloud.dataform.v1.Repository.GitRemoteSettings.TokenStatus</code>
 */
class TokenStatus
{
    /**
...
class_alias(TokenStatus::class, \Google\Cloud\Dataform\V1\Repository_GitRemoteSettings_TokenStatus::class);
