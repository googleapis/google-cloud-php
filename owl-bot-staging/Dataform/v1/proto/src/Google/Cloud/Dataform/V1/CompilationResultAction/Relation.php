...
class Relation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CompilationResultAction.Relation.TableFormat table_format = 16 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $table_format = 0;
    /**
     * Optional. The file format for the BigQuery table.
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CompilationResultAction.Relation.FileFormat file_format = 17 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataform\V1\CompilationResultAction\Relation\TableFormat::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataform\V1\CompilationResultAction\Relation\FileFormat::class);
