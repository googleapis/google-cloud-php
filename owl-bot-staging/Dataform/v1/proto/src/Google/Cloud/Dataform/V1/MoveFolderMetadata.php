 ...
 * operations.
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.MoveFolderMetadata</code>
 */
class MoveFolderMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.MoveFolderMetadata.State state = 4;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataform\V1\MoveFolderMetadata\State::class);
        $this->state = $var;
