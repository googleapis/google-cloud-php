 ...
 *
 * Protobuf type <code>google.cloud.dataform.v1.CompilationResultAction.Relation.RelationType</code>
 */
class RelationType
{
    /**
...
class_alias(RelationType::class, \Google\Cloud\Dataform\V1\CompilationResultAction_Relation_RelationType::class);
