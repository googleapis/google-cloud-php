...
namespace Google\Cloud\Dataform\V1\CompilationResult;
 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.CompilationResult.CompilationError</code>
 */
class CompilationError extends \Google\Protobuf\Internal\Message
{
     ...
     * available.
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.Target action_target = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. The path of the file where this error occurred, if
     *           available, relative to the project root.
     *     @type \Google\Cloud\Dataform\V1\Target $action_target
     *           Output only. The identifier of the action where this error occurred, if
     *           available.
     * }
     */
...
class_alias(CompilationError::class, \Google\Cloud\Dataform\V1\CompilationResult_CompilationError::class);
