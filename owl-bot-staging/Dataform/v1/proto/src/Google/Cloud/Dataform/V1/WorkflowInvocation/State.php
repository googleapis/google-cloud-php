...
namespace Google\Cloud\Dataform\V1\WorkflowInvocation;
 ...
 *
 * Protobuf type <code>google.cloud.dataform.v1.WorkflowInvocation.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Dataform\V1\WorkflowInvocation_State::class);
