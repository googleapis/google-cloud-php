...
class DataformGapicClient
{
     ...
     * @experimental
     */
    public function commitRepositoryChanges($name, $commitMetadata, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function computeRepositoryAccessTokenStatus($name, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function createReleaseConfig($parent, $releaseConfig, $releaseConfigId, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function createWorkflowConfig($parent, $workflowConfig, $workflowConfigId, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function queryRepositoryDirectoryContents($name, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function updateReleaseConfig($releaseConfig, array $optionalArgs = [])
    {
     ...
     * @experimental
     */
    public function updateWorkflowConfig($workflowConfig, array $optionalArgs = [])
    {
        $request = new UpdateWorkflowConfigRequest();
        $requestParamHeaders = [];
        $request->setWorkflowConfig($workflowConfig);
        $requestParamHeaders['workflow_config.name'] = $workflowConfig->getName();
        if (isset($optionalArgs['updateMask'])) {
            $request->setUpdateMask($optionalArgs['updateMask']);
        }
