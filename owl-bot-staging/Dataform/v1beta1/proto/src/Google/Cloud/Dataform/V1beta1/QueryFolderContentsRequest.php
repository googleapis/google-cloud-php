 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.QueryFolderContentsRequest</code>
 */
class QueryFolderContentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * @return \Google\Cloud\Dataform\V1beta1\QueryFolderContentsRequest
     *
     * @experimental
     */
    public static function build(string $folder): self
    {
        return (new self())
            ->setFolder($folder);
    }
