...
class AdvisoryNotificationsServiceGapicClient
{
    ...
    private static function getNotificationNameTemplate()
    {
        if (self::$notificationNameTemplate == null) {
            self::$notificationNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/notifications/{notification}');
        }
    ...
    private static function getOrganizationLocationNotificationNameTemplate()
    {
        if (self::$organizationLocationNotificationNameTemplate == null) {
            self::$organizationLocationNotificationNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/notifications/{notification}');
        }
    ...
    private static function getOrganizationLocationSettingsNameTemplate()
    {
        if (self::$organizationLocationSettingsNameTemplate == null) {
            self::$organizationLocationSettingsNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/settings');
        }
    ...
    private static function getProjectLocationNotificationNameTemplate()
    {
        if (self::$projectLocationNotificationNameTemplate == null) {
            self::$projectLocationNotificationNameTemplate = new PathTemplate('projects/{project}/locations/{location}/notifications/{notification}');
        }
    ...
    private static function getProjectLocationSettingsNameTemplate()
    {
        if (self::$projectLocationSettingsNameTemplate == null) {
            self::$projectLocationSettingsNameTemplate = new PathTemplate('projects/{project}/locations/{location}/settings');
        }
    ...
    private static function getSettingsNameTemplate()
    {
        if (self::$settingsNameTemplate == null) {
            self::$settingsNameTemplate = new PathTemplate('organizations/{organization}/locations/{location}/settings');
        }
     ...
     */
    public static function notificationName($organization, $location, $notification)
    {
     ...
     */
    public static function organizationLocationNotificationName($organization, $location, $notification)
    {
     ...
     */
    public static function organizationLocationSettingsName($organization, $location)
    {
     ...
     */
    public static function projectLocationNotificationName($project, $location, $notification)
    {
    ...
    public function getNotification($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetNotification', Notification::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listNotifications($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNotifications', $optionalArgs, ListNotificationsResponse::class, $request);
    }
