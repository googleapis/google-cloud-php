...
final class DatabaseCenterClient
{
     ...
     * @experimental
     */
    public function aggregateIssueStats(AggregateIssueStatsRequest $request, array $callOptions = []): AggregateIssueStatsResponse
    {
     ...
     * @experimental
     */
    public function queryDatabaseResourceGroups(QueryDatabaseResourceGroupsRequest $request, array $callOptions = []): PagedListResponse
    {
