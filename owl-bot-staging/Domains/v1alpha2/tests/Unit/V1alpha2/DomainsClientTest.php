...
namespace Google\Cloud\Domains\Tests\Unit\V1alpha2;
...
class DomainsClientTest extends GeneratedTest
{
    ...
    public function configureContactSettingsTest()
    {
        ...
        $response = $gapicClient->configureContactSettings();
        ...
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ConfigureContactSettings', $actualApiFuncCall);
    ...
    public function configureDnsSettingsTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->configureDnsSettings();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ConfigureDnsSettings', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function configureManagementSettingsTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->configureManagementSettings();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ConfigureManagementSettings', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteRegistrationTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->deleteRegistration();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/DeleteRegistration', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function exportRegistrationTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->exportRegistration();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ExportRegistration', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getRegistrationTest()
    {
        ...
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/GetRegistration', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listRegistrationsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->listRegistrations();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ListRegistrations', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function registerDomainTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->registerDomain();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/RegisterDomain', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function resetAuthorizationCodeTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->resetAuthorizationCode();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/ResetAuthorizationCode', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function retrieveAuthorizationCodeTest()
    {
        ...
        $expectedResponse->setCode($code);
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->retrieveAuthorizationCode();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/RetrieveAuthorizationCode', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function retrieveRegisterParametersTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->retrieveRegisterParameters();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/RetrieveRegisterParameters', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function retrieveRegisterParametersExceptionTest()
    {
        ...
        $transport->addResponse(null, $status);
        try {
            $gapicClient->retrieveRegisterParameters();
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function retrieveTransferParametersTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->retrieveTransferParameters();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function retrieveTransferParametersExceptionTest()
    {
        ...
        $transport->addResponse(null, $status);
        try {
            $gapicClient->retrieveTransferParameters();
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function searchDomainsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->searchDomains();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/SearchDomains', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function transferDomainTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->transferDomain();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function updateRegistrationTest()
    {
        ...
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->updateRegistration();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.domains.v1alpha2.Domains/UpdateRegistration', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
