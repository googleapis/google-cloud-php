 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1alpha2.DnsSettings.DsRecord</code>
 */
class DsRecord extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.DnsSettings.DsRecord.Algorithm algorithm = 2;</code>
     */
    protected $algorithm = 0;
    /**
     * The hash function used to generate the digest of the referenced DNSKEY.
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.DnsSettings.DsRecord.DigestType digest_type = 3;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1alpha2\DnsSettings\DsRecord\Algorithm::class);
        $this->algorithm = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1alpha2\DnsSettings\DsRecord\DigestType::class);
