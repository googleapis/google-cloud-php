 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1alpha2.DnsSettings.GoogleDomainsDns</code>
 */
class GoogleDomainsDns extends \Google\Protobuf\Internal\Message
{
     ...
     * automatic DNSSEC.
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.DnsSettings.DsState ds_state = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.domains.v1alpha2.DnsSettings.DsRecord ds_records = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $ds_records;
     ...
     *           Required. The state of DS records for this domain. Used to enable or disable
     *           automatic DNSSEC.
     *     @type \Google\Cloud\Domains\V1alpha2\DnsSettings\DsRecord[]|\Google\Protobuf\Internal\RepeatedField $ds_records
     *           Output only. The list of DS records published for this domain. The list is
     *           automatically populated when `ds_state` is `DS_RECORDS_PUBLISHED`,
     *           otherwise it remains empty.
     * }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1alpha2\DnsSettings\DsState::class);
        $this->ds_state = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.domains.v1alpha2.DnsSettings.DsRecord ds_records = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Domains\V1alpha2\DnsSettings\DsRecord[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
...
class_alias(GoogleDomainsDns::class, \Google\Cloud\Domains\V1alpha2\DnsSettings_GoogleDomainsDns::class);
