 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1alpha2.DnsSettings</code>
 */
class DnsSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Domains\V1alpha2\DnsSettings\CustomDns $custom_dns
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.DnsSettings.CustomDns custom_dns = 1;</code>
     * @param \Google\Cloud\Domains\V1alpha2\DnsSettings\CustomDns $var
     * @return $this
     */
    public function setCustomDns($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1alpha2\DnsSettings\CustomDns::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.DnsSettings.GoogleDomainsDns google_domains_dns = 2;</code>
     * @param \Google\Cloud\Domains\V1alpha2\DnsSettings\GoogleDomainsDns $var
     * @return $this
     */
    public function setGoogleDomainsDns($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1alpha2\DnsSettings\GoogleDomainsDns::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Domains\V1alpha2\DnsSettings\GlueRecord::class);
