...
class RegisterDomainRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                            RetrieveRegisterParameters or SearchDomains calls.
     *
     * @return \Google\Cloud\Domains\V1\RegisterDomainRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Domains\V1\Registration $registration, \Google\Type\Money $yearlyPrice): self
    {
        return (new self())
            ->setParent($parent)
