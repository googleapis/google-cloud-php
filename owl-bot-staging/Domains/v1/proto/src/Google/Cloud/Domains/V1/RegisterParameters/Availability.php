...
namespace Google\Cloud\Domains\V1\RegisterParameters;
 ...
 *
 * Protobuf type <code>google.cloud.domains.v1.RegisterParameters.Availability</code>
 */
class Availability
{
    /**
...
class_alias(Availability::class, \Google\Cloud\Domains\V1\RegisterParameters_Availability::class);
