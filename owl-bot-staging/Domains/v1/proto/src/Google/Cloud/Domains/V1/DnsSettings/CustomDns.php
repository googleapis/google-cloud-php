 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.DnsSettings.CustomDns</code>
 */
...
class_alias(CustomDns::class, \Google\Cloud\Domains\V1\DnsSettings_CustomDns::class);
