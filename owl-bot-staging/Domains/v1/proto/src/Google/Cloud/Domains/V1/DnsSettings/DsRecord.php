 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.DnsSettings.DsRecord</code>
 */
class DsRecord extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1\DnsSettings\DsRecord\Algorithm::class);
        $this->algorithm = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1\DnsSettings\DsRecord\DigestType::class);
...
class_alias(DsRecord::class, \Google\Cloud\Domains\V1\DnsSettings_DsRecord::class);
