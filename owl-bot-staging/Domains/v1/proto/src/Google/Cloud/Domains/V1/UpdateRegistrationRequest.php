...
class UpdateRegistrationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                            `"labels"`.
     *
     * @return \Google\Cloud\Domains\V1\UpdateRegistrationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Domains\V1\Registration $registration, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
