 ...
 *
 * Protobuf type <code>google.cloud.domains.v1.DnsSettings.DsRecord.Algorithm</code>
 */
class Algorithm
{
    /**
...
class_alias(Algorithm::class, \Google\Cloud\Domains\V1\DnsSettings_DsRecord_Algorithm::class);
