...
namespace Google\Cloud\ServiceControl\V1\Client;
...
final class QuotaControllerClient
{
     ...
     *           $options = new QuotaControllerClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function allocateQuota(AllocateQuotaRequest $request, array $callOptions = []): AllocateQuotaResponse
    {
        return $this->startApiCall('AllocateQuota', $request, $callOptions)->wait();
    }
}
