...
use Google\Cloud\BigQuery\AnalyticsHub\V1\ListQueryTemplatesResponse;
...
class AnalyticsHubServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function approveQueryTemplateTest()
    {
        ...
        $proposer = 'proposer-992842892';
        $primaryContact = 'primaryContact203339491';
        $documentation = 'documentation1587405498';
        $expectedResponse = new QueryTemplate();
        $expectedResponse->setName($name2);
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setDescription($description);
        $expectedResponse->setProposer($proposer);
        $expectedResponse->setPrimaryContact($primaryContact);
        $expectedResponse->setDocumentation($documentation);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->queryTemplateName('[PROJECT]', '[LOCATION]', '[DATA_EXCHANGE]', '[QUERY_TEMPLATE]');
        $request = (new ApproveQueryTemplateRequest())
            ->setName($formattedName);
        $response = $gapicClient->approveQueryTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ApproveQueryTemplate', $actualFuncCall);
    ...
    /** @test */
    public function approveQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new ApproveQueryTemplateRequest())
            ->setName($formattedName);
        try {
            $gapicClient->approveQueryTemplate($request);
    ...
    public function createDataExchangeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/CreateDataExchange', $actualFuncCall);
    ...
    /** @test */
    public function createQueryTemplateTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedParent = $gapicClient->dataExchangeName('[PROJECT]', '[LOCATION]', '[DATA_EXCHANGE]');
        $queryTemplateId = 'queryTemplateId-1152440823';
        $queryTemplate = new QueryTemplate();
        $queryTemplateDisplayName = 'queryTemplateDisplayName-990303317';
        $queryTemplate->setDisplayName($queryTemplateDisplayName);
        $request = (new CreateQueryTemplateRequest())
            ->setParent($formattedParent)
            ->setQueryTemplateId($queryTemplateId)
            ->setQueryTemplate($queryTemplate);
        $response = $gapicClient->createQueryTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/CreateQueryTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getQueryTemplateId();
        $this->assertProtobufEquals($queryTemplateId, $actualValue);
        $actualValue = $actualRequestObject->getQueryTemplate();
        $this->assertProtobufEquals($queryTemplate, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function createQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new CreateQueryTemplateRequest())
            ...
            ->setQueryTemplate($queryTemplate);
        try {
            $gapicClient->createQueryTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function deleteDataExchangeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/DeleteDataExchange', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteQueryTemplateTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new DeleteQueryTemplateRequest())
            ->setName($formattedName);
        $gapicClient->deleteQueryTemplate($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/DeleteQueryTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function deleteSubscriptionTest()
    {
        ...
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/DeleteSubscription', $actualApiFuncCall);
    ...
    public function getDataExchangeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/GetDataExchange', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getQueryTemplateTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetQueryTemplateRequest())
            ->setName($formattedName);
        $response = $gapicClient->getQueryTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/GetQueryTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetQueryTemplateRequest())
            ->setName($formattedName);
        try {
            $gapicClient->getQueryTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/GetSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listDataExchangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ListDataExchanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listOrgDataExchangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ListOrgDataExchanges', $actualFuncCall);
    ...
    /** @test */
    public function listQueryTemplatesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $queryTemplatesElement = new QueryTemplate();
        $queryTemplates = [
            $queryTemplatesElement,
        ];
        $expectedResponse = new ListQueryTemplatesResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setQueryTemplates($queryTemplates);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->dataExchangeName('[PROJECT]', '[LOCATION]', '[DATA_EXCHANGE]');
        $request = (new ListQueryTemplatesRequest())
            ->setParent($formattedParent);
        $response = $gapicClient->listQueryTemplates($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getQueryTemplates()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ListQueryTemplates', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listQueryTemplatesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new ListQueryTemplatesRequest())
            ->setParent($formattedParent);
        try {
            $gapicClient->listQueryTemplates($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listSharedResourceSubscriptionsTest()
    {
        ...
        $sharedResourceSubscriptions = [
            $sharedResourceSubscriptionsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ListSharedResourceSubscriptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSubscriptionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/ListSubscriptions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function refreshSubscriptionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/RefreshSubscription', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function revokeSubscriptionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/RevokeSubscription', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function submitQueryTemplateTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->queryTemplateName('[PROJECT]', '[LOCATION]', '[DATA_EXCHANGE]', '[QUERY_TEMPLATE]');
        $request = (new SubmitQueryTemplateRequest())
            ->setName($formattedName);
        $response = $gapicClient->submitQueryTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/SubmitQueryTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function submitQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new SubmitQueryTemplateRequest())
            ->setName($formattedName);
        try {
            $gapicClient->submitQueryTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function subscribeDataExchangeTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/SubscribeDataExchange', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function subscribeListingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/SubscribeListing', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getResource();
        $this->assertProtobufEquals($resource, $actualValue);
    ...
    public function updateDataExchangeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/UpdateDataExchange', $actualFuncCall);
    ...
    /** @test */
    public function updateQueryTemplateTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $queryTemplateDisplayName = 'queryTemplateDisplayName-990303317';
        $queryTemplate->setDisplayName($queryTemplateDisplayName);
        $request = (new UpdateQueryTemplateRequest())
            ->setQueryTemplate($queryTemplate);
        $response = $gapicClient->updateQueryTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.bigquery.analyticshub.v1.AnalyticsHubService/UpdateQueryTemplate', $actualFuncCall);
        $actualValue = $actualRequestObject->getQueryTemplate();
        $this->assertProtobufEquals($queryTemplate, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function updateQueryTemplateExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateQueryTemplateRequest())
            ->setQueryTemplate($queryTemplate);
        try {
            $gapicClient->updateQueryTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function approveQueryTemplateAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new ApproveQueryTemplateRequest())
            ->setName($formattedName);
        $response = $gapicClient->approveQueryTemplateAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
