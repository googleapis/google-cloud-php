 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.analyticshub.v1.ApproveQueryTemplateRequest</code>
 */
class ApproveQueryTemplateRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource path of the QueryTemplate.
     *                     e.g.
     ...
     *
     * @return \Google\Cloud\BigQuery\AnalyticsHub\V1\ApproveQueryTemplateRequest
     *
     * @experimental
     */
