 ...
 */
function submit_query_template_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $analyticsHubServiceClient->submitQueryTemplate($request);
...
function callSample(): void
{
    ...
    submit_query_template_sample($formattedName);
}
