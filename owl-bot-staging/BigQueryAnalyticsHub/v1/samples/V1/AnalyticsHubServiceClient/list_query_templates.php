 ...
 *
 * @param string $formattedParent The parent resource path of the QueryTemplates.
 ...
 */
function list_query_templates_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $analyticsHubServiceClient->listQueryTemplates($request);

        /** @var QueryTemplate $element */
...
function callSample(): void
{
    ...
    list_query_templates_sample($formattedParent);
}
