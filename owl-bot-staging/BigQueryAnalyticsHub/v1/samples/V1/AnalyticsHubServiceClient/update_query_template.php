 ...
 */
function update_query_template_sample(string $queryTemplateDisplayName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $analyticsHubServiceClient->updateQueryTemplate($request);
...
function callSample(): void
{
    ...
    update_query_template_sample($queryTemplateDisplayName);
}
