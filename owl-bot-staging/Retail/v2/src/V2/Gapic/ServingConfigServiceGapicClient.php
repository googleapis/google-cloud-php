...
class ServingConfigServiceGapicClient
{
    ...
    private static function getServingConfigNameTemplate()
    {
        if (self::$servingConfigNameTemplate == null) {
            self::$servingConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/catalogs/{catalog}/servingConfigs/{serving_config}');
        }
     ...
     */
    public static function servingConfigName($project, $location, $catalog, $servingConfig)
    {
     ...
     */
    public function addControl($servingConfig, $controlId, array $optionalArgs = [])
    {
        ...
        return $this->startCall('AddControl', ServingConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createServingConfig($parent, $servingConfig, $servingConfigId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateServingConfig', ServingConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteServingConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteServingConfig', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getServingConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetServingConfig', ServingConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listServingConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListServingConfigs', $optionalArgs, ListServingConfigsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function removeControl($servingConfig, $controlId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RemoveControl', ServingConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateServingConfig($servingConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateServingConfig', ServingConfig::class, $optionalArgs, $request)->wait();
    }
}
