...
class AnalyticsServiceGapicClient
{
     ...
     */
    public function exportAnalyticsMetrics($catalog, $outputConfig, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('ExportAnalyticsMetrics', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
