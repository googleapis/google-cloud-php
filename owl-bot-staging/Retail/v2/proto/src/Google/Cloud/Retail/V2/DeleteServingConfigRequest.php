 ...
 *
 * Generated from protobuf message <code>google.cloud.retail.v2.DeleteServingConfigRequest</code>
 */
class DeleteServingConfigRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *                     `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/servingConfigs/{serving_config_id}`
     *
     * @return \Google\Cloud\Retail\V2\DeleteServingConfigRequest
     *
     * @experimental
     */
