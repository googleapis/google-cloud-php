...
class PredictResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Retail\V2\PredictResponse\PredictionResult[] $results
     *           A list of recommended products. The order represents the ranking (from the
     *           most relevant product to the least).
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2.PredictResponse.PredictionResult results = 1;</code>
     * @return RepeatedField<\Google\Cloud\Retail\V2\PredictResponse\PredictionResult>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.retail.v2.PredictResponse.PredictionResult results = 1;</code>
     * @param \Google\Cloud\Retail\V2\PredictResponse\PredictionResult[] $var
     * @return $this
     */
