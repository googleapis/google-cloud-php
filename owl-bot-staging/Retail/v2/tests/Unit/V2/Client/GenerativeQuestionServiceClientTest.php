...
class GenerativeQuestionServiceClientTest extends GeneratedTest
{
    ...
    public function batchUpdateGenerativeQuestionConfigsTest()
    {
        ...
        $this->assertSame('/google.cloud.retail.v2.GenerativeQuestionService/BatchUpdateGenerativeQuestionConfigs', $actualFuncCall);
    ...
    public function getGenerativeQuestionsFeatureConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2.GenerativeQuestionService/GetGenerativeQuestionsFeatureConfig', $actualFuncCall);
    ...
    public function listGenerativeQuestionConfigsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2.GenerativeQuestionService/ListGenerativeQuestionConfigs', $actualFuncCall);
    ...
    public function updateGenerativeQuestionConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2.GenerativeQuestionService/UpdateGenerativeQuestionConfig', $actualFuncCall);
    ...
    public function updateGenerativeQuestionsFeatureConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.retail.v2.GenerativeQuestionService/UpdateGenerativeQuestionsFeatureConfig', $actualFuncCall);
