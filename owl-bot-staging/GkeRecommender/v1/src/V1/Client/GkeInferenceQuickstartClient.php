 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/gkerecommender/v1/gkerecommender.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\GkeRecommender\V1\Client;
 ...
 *
 * @method PromiseInterface<FetchBenchmarkingDataResponse> fetchBenchmarkingDataAsync(FetchBenchmarkingDataRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> fetchModelServerVersionsAsync(FetchModelServerVersionsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> fetchModelServersAsync(FetchModelServersRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> fetchModelsAsync(FetchModelsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> fetchProfilesAsync(FetchProfilesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<GenerateOptimizedManifestResponse> generateOptimizedManifestAsync(GenerateOptimizedManifestRequest $request, array $optionalArgs = [])
 */
final class GkeInferenceQuickstartClient
{
     ...
     *           as "<uri>:<port>". Default 'gkerecommender.googleapis.com:443'.
     ...
     */
    public function fetchBenchmarkingData(FetchBenchmarkingDataRequest $request, array $callOptions = []): FetchBenchmarkingDataResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function fetchModelServerVersions(FetchModelServerVersionsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateOptimizedManifest(GenerateOptimizedManifestRequest $request, array $callOptions = []): GenerateOptimizedManifestResponse
    {
