...
class GkeInferenceQuickstartClientTest extends GeneratedTest
{
    ...
    public function fetchBenchmarkingDataTest()
    {
        ...
        $this->assertSame('/google.cloud.gkerecommender.v1.GkeInferenceQuickstart/FetchBenchmarkingData', $actualFuncCall);
    ...
    public function fetchModelServerVersionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkerecommender.v1.GkeInferenceQuickstart/FetchModelServerVersions', $actualFuncCall);
    ...
    public function generateOptimizedManifestTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.gkerecommender.v1.GkeInferenceQuickstart/GenerateOptimizedManifest', $actualFuncCall);
        $actualValue = $actualRequestObject->getModelServerInfo();
        $this->assertProtobufEquals($modelServerInfo, $actualValue);
