 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1beta.UpdateClusterRequest</code>
 */
class UpdateClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1beta.Cluster cluster = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\HypercomputeCluster\V1beta\Cluster $cluster    Required. Cluster to update.
     * @param \Google\Protobuf\FieldMask                       $updateMask Optional. Mask specifying which fields in the cluster to update. All paths
     *                                                                     must be specified explicitly - wildcards are not supported. At least one
     *                                                                     path must be provided.
     *
     * @return \Google\Cloud\HypercomputeCluster\V1beta\UpdateClusterRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\HypercomputeCluster\V1beta\Cluster $cluster, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
            ->setCluster($cluster)
     ...
     *
     *     @type \Google\Cloud\HypercomputeCluster\V1beta\Cluster $cluster
     *           Required. Cluster to update.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1beta.Cluster cluster = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\HypercomputeCluster\V1beta\Cluster|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\HypercomputeCluster\V1beta\Cluster::class);
        $this->cluster = $var;
