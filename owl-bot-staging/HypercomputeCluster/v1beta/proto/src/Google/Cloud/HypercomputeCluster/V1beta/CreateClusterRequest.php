 ...
 *
 * Generated from protobuf message <code>google.cloud.hypercomputecluster.v1beta.CreateClusterRequest</code>
 */
class CreateClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.hypercomputecluster.v1beta.Cluster cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\HypercomputeCluster\V1beta\Cluster $cluster   Required. Cluster to create.
     * @param string                                           $clusterId Required. ID of the cluster to create. Must conform to
     *                                                                    [RFC-1034](https://datatracker.ietf.org/doc/html/rfc1034) (lower-case,
     *                                                                    alphanumeric, and at most 63 characters).
     *
     * @return \Google\Cloud\HypercomputeCluster\V1beta\CreateClusterRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\HypercomputeCluster\V1beta\Cluster $cluster, string $clusterId): self
    {
        return (new self())
            ->setParent($parent)
            ->setCluster($cluster)
