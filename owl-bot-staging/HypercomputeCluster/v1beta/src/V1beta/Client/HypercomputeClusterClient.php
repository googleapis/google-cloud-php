 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/hypercomputecluster/v1beta/hypercompute_cluster.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\HypercomputeCluster\V1beta\Client;
 ...
 */
final class HypercomputeClusterClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.hypercomputecluster.v1beta.HypercomputeCluster';
     ...
     */
    private const SERVICE_ADDRESS = 'hypercomputecluster.googleapis.com';

    /** The address template of the service. */
    private const SERVICE_ADDRESS_TEMPLATE = 'hypercomputecluster.UNIVERSE_DOMAIN';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/hypercompute_cluster_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/hypercompute_cluster_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/hypercompute_cluster_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/hypercompute_cluster_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * @return string The formatted compute_instance resource.
     *
     * @experimental
     */
    public static function computeInstanceName(string $project, string $zone, string $instance): string
    {
        return self::getPathTemplate('computeInstance')->render([
            'project' => $project,
            'zone' => $zone,
            'instance' => $instance,
        ]);
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a disk_type
     * resource.
     *
     * @param string $project
     * @param string $zone
     ...
     *
     * @return string The formatted disk_type resource.
     *
     * @experimental
     */
    public static function diskTypeName(string $project, string $zone, string $diskType): string
    {
        return self::getPathTemplate('diskType')->render([
            'project' => $project,
            'zone' => $zone,
            'disk_type' => $diskType,
        ]);
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * file_instance resource.
     *
     * @param string $project
     * @param string $location
     * @param string $instance
     *
     * @return string The formatted file_instance resource.
     *
     * @experimental
     */
    public static function fileInstanceName(string $project, string $location, string $instance): string
    {
        return self::getPathTemplate('fileInstance')->render([
            'project' => $project,
            'location' => $location,
            'instance' => $instance,
        ]);
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * lustre_instance resource.
     *
     * @param string $project
     * @param string $location
     * @param string $instance
     *
     * @return string The formatted lustre_instance resource.
     *
     * @experimental
     */
    public static function lustreInstanceName(string $project, string $location, string $instance): string
    {
        return self::getPathTemplate('lustreInstance')->render([
            'project' => $project,
            'location' => $location,
            'instance' => $instance,
        ]);
     ...
     * @experimental
     */
    public static function reservationName(string $project, string $zone, string $reservation): string
    {
     ...
     *           as "<uri>:<port>". Default 'hypercomputecluster.googleapis.com:443'.
     ...
     *           use Google\Cloud\HypercomputeCluster\V1beta\HypercomputeClusterClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new HypercomputeClusterClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::createClusterAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/create_cluster.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::deleteClusterAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/delete_cluster.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::getClusterAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/get_cluster.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::listClustersAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/list_clusters.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::updateClusterAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/update_cluster.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::getLocationAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/get_location.php
     *
     ...
     *
     * The async variant is {@see HypercomputeClusterClient::listLocationsAsync()} .
     *
     * @example samples/V1beta/HypercomputeClusterClient/list_locations.php
     *
