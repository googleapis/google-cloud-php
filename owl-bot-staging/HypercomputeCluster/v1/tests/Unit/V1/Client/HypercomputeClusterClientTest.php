...
namespace Google\Cloud\HypercomputeCluster\Tests\Unit\V1\Client;
...
use Google\Cloud\HypercomputeCluster\V1\ListClustersRequest;
use Google\Cloud\HypercomputeCluster\V1\ListClustersResponse;
use Google\Cloud\HypercomputeCluster\V1\UpdateClusterRequest;
...
/**
 * @group hypercomputecluster
 *
 * @group gapic
 */
class HypercomputeClusterClientTest extends GeneratedTest
{
    ...
    /** @return HypercomputeClusterClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new HypercomputeClusterClient($options);
    }
    ...
    public function createClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.hypercomputecluster.v1.HypercomputeCluster/CreateCluster', $actualApiFuncCall);
    ...
    public function deleteClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.hypercomputecluster.v1.HypercomputeCluster/DeleteCluster', $actualApiFuncCall);
    ...
    public function getClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.hypercomputecluster.v1.HypercomputeCluster/GetCluster', $actualFuncCall);
    ...
    public function updateClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.hypercomputecluster.v1.HypercomputeCluster/UpdateCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCluster();
        $this->assertProtobufEquals($cluster, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
