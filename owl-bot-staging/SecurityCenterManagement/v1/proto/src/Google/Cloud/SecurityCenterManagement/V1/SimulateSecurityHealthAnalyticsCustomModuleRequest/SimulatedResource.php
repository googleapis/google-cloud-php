...
class_alias(SimulatedResource::class, \Google\Cloud\SecurityCenterManagement\V1\SimulateSecurityHealthAnalyticsCustomModuleRequest_SimulatedResource::class);
