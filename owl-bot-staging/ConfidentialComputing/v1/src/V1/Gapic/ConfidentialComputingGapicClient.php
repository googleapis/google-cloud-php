...
class ConfidentialComputingGapicClient
{
    ...
    private static function getChallengeNameTemplate()
    {
        if (self::$challengeNameTemplate == null) {
            self::$challengeNameTemplate = new PathTemplate('projects/{project}/locations/{location}/challenges/{uuid}');
        }
     ...
     */
    public function createChallenge($parent, $challenge, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateChallenge', Challenge::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function verifyAttestation($challenge, $tpmAttestation, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['confidentialSpaceInfo'])) {
            $request->setConfidentialSpaceInfo($optionalArgs['confidentialSpaceInfo']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('VerifyAttestation', VerifyAttestationResponse::class, $optionalArgs, $request)->wait();
    }
