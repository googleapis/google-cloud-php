...
final class ConfidentialComputingClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function verifyConfidentialGke(VerifyConfidentialGkeRequest $request, array $callOptions = []): VerifyConfidentialGkeResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function verifyConfidentialSpace(VerifyConfidentialSpaceRequest $request, array $callOptions = []): VerifyConfidentialSpaceResponse
    {
