...
namespace Google\Cloud\ConfidentialComputing\Tests\Unit\V1\Client;
...
/**
 * @group confidentialcomputing
 *
 * @group gapic
 */
class ConfidentialComputingClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new ConfidentialComputingClient($options);
    }

    /** @test */
    public function createChallengeTest()
    {
        ...
        $name = 'name3373707';
        $used = false;
        $tpmNonce = 'tpmNonce-806632543';
        $expectedResponse = new Challenge();
    ...
    /** @test */
    public function createChallengeExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function verifyAttestationTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $oidcClaimsToken = 'oidcClaimsToken1151909399';
    ...
    /** @test */
    public function verifyAttestationExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function verifyConfidentialGkeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.confidentialcomputing.v1.ConfidentialComputing/VerifyConfidentialGke', $actualFuncCall);
        $actualValue = $actualRequestObject->getChallenge();
        $this->assertProtobufEquals($formattedChallenge, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function verifyConfidentialSpaceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.confidentialcomputing.v1.ConfidentialComputing/VerifyConfidentialSpace', $actualFuncCall);
        $actualValue = $actualRequestObject->getChallenge();
        $this->assertProtobufEquals($formattedChallenge, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function createChallengeAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
