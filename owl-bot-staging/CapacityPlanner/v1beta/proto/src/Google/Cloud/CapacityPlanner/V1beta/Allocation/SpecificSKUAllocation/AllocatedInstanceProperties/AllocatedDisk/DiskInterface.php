...
class_alias(DiskInterface::class, \Google\Cloud\CapacityPlanner\V1beta\Allocation_SpecificSKUAllocation_AllocatedInstanceProperties_AllocatedDisk_DiskInterface::class);
