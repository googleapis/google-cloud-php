 ...
 *
 * Protobuf type <code>google.cloud.capacityplanner.v1beta.BigQueryDestination.PartitionKey</code>
 */
class PartitionKey
{
    /**
...
class_alias(PartitionKey::class, \Google\Cloud\CapacityPlanner\V1beta\BigQueryDestination_PartitionKey::class);
