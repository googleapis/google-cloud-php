 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.AuthorizationPolicy</code>
 */
class AuthorizationPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     * request.
     *
     * Generated from protobuf field <code>repeated .google.cloud.networksecurity.v1.AuthorizationPolicy.Rule rules = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $rules;
     ...
     *           Required. The action to take when a rule match is found. Possible values
     *           are "ALLOW" or "DENY".
     *     @type \Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy\Rule[] $rules
     *           Optional. List of rules to match. Note that at least one of the rules must
     *           match in order for the action specified in the 'action' field to be taken.
     *           A rule is a match if there is a matching source and destination. If left
     *           blank, the action specified in the `action` field will be applied on every
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy\Action::class);
        $this->action = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networksecurity.v1.AuthorizationPolicy.Rule rules = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy\Rule>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networksecurity.v1.AuthorizationPolicy.Rule rules = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy\Rule[] $var
     * @return $this
     */
    public function setRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy\Rule::class);
        $this->rules = $arr;
