 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.DeleteInterceptEndpointGroupRequest</code>
 */
class DeleteInterceptEndpointGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The endpoint group to delete. Please see
     *                     {@see InterceptClient::interceptEndpointGroupName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\DeleteInterceptEndpointGroupRequest
     *
     * @experimental
     */
