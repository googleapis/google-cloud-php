 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.GetTlsInspectionPolicyRequest</code>
 */
class GetTlsInspectionPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. A name of the TlsInspectionPolicy to get. Must be in the format
     ...
     *
     * @return \Google\Cloud\NetworkSecurity\V1\GetTlsInspectionPolicyRequest
     *
     * @experimental
     */
