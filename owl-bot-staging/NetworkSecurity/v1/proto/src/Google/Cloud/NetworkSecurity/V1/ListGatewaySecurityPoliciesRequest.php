 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.ListGatewaySecurityPoliciesRequest</code>
 */
class ListGatewaySecurityPoliciesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project and location from which the GatewaySecurityPolicies
     *                       should be listed, specified in the format
     *                       `projects/{project}/locations/{location}`. Please see
     *                       {@see NetworkSecurityClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\ListGatewaySecurityPoliciesRequest
     *
     * @experimental
     */
