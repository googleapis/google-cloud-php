 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.ListGatewaySecurityPolicyRulesRequest</code>
 */
class ListGatewaySecurityPolicyRulesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project, location and GatewaySecurityPolicy from which the
     *                       GatewaySecurityPolicyRules should be listed, specified in the format
     ...
     *
     * @return \Google\Cloud\NetworkSecurity\V1\ListGatewaySecurityPolicyRulesRequest
     *
     * @experimental
     */
