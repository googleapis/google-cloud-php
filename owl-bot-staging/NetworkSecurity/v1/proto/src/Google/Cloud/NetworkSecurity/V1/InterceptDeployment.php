 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.InterceptDeployment</code>
 */
class InterceptDeployment extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * See https://google.aip.dev/124.
     *
     * Generated from protobuf field <code>string intercept_deployment_group = 6 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE, (.google.api.resource_reference) = {</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networksecurity.v1.InterceptDeployment.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
