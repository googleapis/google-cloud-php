 ...
 *
 * Protobuf type <code>google.cloud.networksecurity.v1.AuthorizationPolicy.Action</code>
 */
class Action
{
    /**
...
class_alias(Action::class, \Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy_Action::class);
