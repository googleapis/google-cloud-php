    ...
    'interfaces' => [
        'google.cloud.networksecurity.v1.Intercept' => [
            ...
            'CreateInterceptDeploymentGroup' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\InterceptDeploymentGroup',
                    'metadataReturnType' => '\Google\Cloud\NetworkSecurity\V1\OperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
            ...
            'CreateInterceptEndpointGroup' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\InterceptEndpointGroup',
                    'metadataReturnType' => '\Google\Cloud\NetworkSecurity\V1\OperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
            ...
            'CreateInterceptEndpointGroupAssociation' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\InterceptEndpointGroupAssociation',
                    'metadataReturnType' => '\Google\Cloud\NetworkSecurity\V1\OperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
            ...
            'UpdateInterceptDeployment' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'intercept_deployment.name',
                        'fieldAccessors' => [
            ...
            'UpdateInterceptDeploymentGroup' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'intercept_deployment_group.name',
                        'fieldAccessors' => [
            ...
            'UpdateInterceptEndpointGroup' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'intercept_endpoint_group.name',
                        'fieldAccessors' => [
            ...
            'UpdateInterceptEndpointGroupAssociation' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'intercept_endpoint_group_association.name',
                        'fieldAccessors' => [
            ...
            'GetInterceptDeployment' => [
                ...
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\InterceptDeployment',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'GetInterceptDeploymentGroup' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\InterceptDeploymentGroup',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'GetInterceptEndpointGroup' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\InterceptEndpointGroup',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'GetInterceptEndpointGroupAssociation' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\InterceptEndpointGroupAssociation',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListInterceptDeploymentGroups' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getInterceptDeploymentGroups',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListInterceptDeploymentGroupsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListInterceptDeployments' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getInterceptDeployments',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListInterceptDeploymentsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListInterceptEndpointGroupAssociations' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getInterceptEndpointGroupAssociations',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListInterceptEndpointGroupAssociationsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListInterceptEndpointGroups' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getInterceptEndpointGroups',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListInterceptEndpointGroupsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
