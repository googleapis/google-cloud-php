    ...
    'interfaces' => [
        'google.cloud.networksecurity.v1.DnsThreatDetectorService' => [
            'CreateDnsThreatDetector' => [
                ...
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\DnsThreatDetector',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListDnsThreatDetectors' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getDnsThreatDetectors',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListDnsThreatDetectorsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'UpdateDnsThreatDetector' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'dns_threat_detector.name',
                        'fieldAccessors' => [
                            'getDnsThreatDetector',
                            'getName',
                        ],
