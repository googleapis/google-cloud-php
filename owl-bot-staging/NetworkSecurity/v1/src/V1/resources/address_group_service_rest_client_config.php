    ...
    'interfaces' => [
        ...
        'google.cloud.networksecurity.v1.AddressGroupService' => [
            'AddAddressGroupItems' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{address_group=projects/*/locations/*/addressGroups/*}:addItems',
                'body' => '*',
                'placeholders' => [
                    'address_group' => [
                        'getters' => [
            ...
            'CloneAddressGroupItems' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{address_group=projects/*/locations/*/addressGroups/*}:cloneItems',
                'body' => '*',
                'placeholders' => [
                    'address_group' => [
                        'getters' => [
            ...
            'CreateAddressGroup' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/addressGroups',
                'body' => 'address_group',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteAddressGroup' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/addressGroups/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ListAddressGroupReferences' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{address_group=projects/*/locations/*/addressGroups/*}:listReferences',
                'placeholders' => [
                    'address_group' => [
                        'getters' => [
                            'getAddressGroup',
            ...
            'RemoveAddressGroupItems' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{address_group=projects/*/locations/*/addressGroups/*}:removeItems',
                'body' => '*',
                'placeholders' => [
                    'address_group' => [
                        'getters' => [
            ...
            'UpdateAddressGroup' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{address_group.name=projects/*/locations/*/addressGroups/*}',
                'body' => 'address_group',
                'placeholders' => [
                    'address_group.name' => [
                        'getters' => [
