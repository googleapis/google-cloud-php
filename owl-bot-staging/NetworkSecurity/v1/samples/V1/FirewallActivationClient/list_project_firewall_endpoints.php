 ...
 */
function list_project_firewall_endpoints_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $firewallActivationClient->listProjectFirewallEndpoints($request);
...
function callSample(): void
{
    ...
    list_project_firewall_endpoints_sample($formattedParent);
}
