 ...
 */
function get_project_firewall_endpoint_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $firewallActivationClient->getProjectFirewallEndpoint($request);
...
function callSample(): void
{
    ...
    get_project_firewall_endpoint_sample($formattedName);
}
