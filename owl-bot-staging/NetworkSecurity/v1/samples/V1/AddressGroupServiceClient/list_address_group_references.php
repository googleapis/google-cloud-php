...
// [START networksecurity_v1_generated_AddressGroupService_ListAddressGroupReferences_sync]
...
function list_address_group_references_sample(string $formattedAddressGroup): void
{
    ...
    try {
        ...
        $response = $addressGroupServiceClient->listAddressGroupReferences($request);
