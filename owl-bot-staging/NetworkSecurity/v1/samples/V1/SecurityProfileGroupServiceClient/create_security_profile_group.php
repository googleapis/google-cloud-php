...
function create_security_profile_group_sample(
    ...
    // Create a client.
    $securityProfileGroupServiceClient = new SecurityProfileGroupServiceClient();
    ...
    try {
        ...
        $response = $securityProfileGroupServiceClient->createSecurityProfileGroup($request);
...
{
    $formattedParent = SecurityProfileGroupServiceClient::organizationLocationName(
        '[ORGANIZATION]',
        '[LOCATION]'
    );
