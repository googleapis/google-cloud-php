 ...
 * @group gapic
 */
class AddressGroupServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new AddressGroupServiceClient($options);
    }
    ...
    public function listAddressGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.AddressGroupService/ListAddressGroups', $actualFuncCall);
