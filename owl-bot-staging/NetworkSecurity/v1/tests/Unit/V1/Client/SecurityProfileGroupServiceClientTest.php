...
class SecurityProfileGroupServiceClientTest extends GeneratedTest
{
    ...
    public function deleteSecurityProfileTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/DeleteSecurityProfile', $actualApiFuncCall);
    ...
    public function deleteSecurityProfileGroupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/DeleteSecurityProfileGroup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getSecurityProfileTest()
    {
        ...
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/GetSecurityProfile', $actualFuncCall);
    ...
    public function getSecurityProfileGroupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/GetSecurityProfileGroup', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSecurityProfileGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/ListSecurityProfileGroups', $actualFuncCall);
    ...
    public function listSecurityProfilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/ListSecurityProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateSecurityProfileTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/UpdateSecurityProfile', $actualApiFuncCall);
    ...
    public function updateSecurityProfileGroupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.SecurityProfileGroupService/UpdateSecurityProfileGroup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
        $actualValue = $actualApiRequestObject->getSecurityProfileGroup();
        $this->assertProtobufEquals($securityProfileGroup, $actualValue);
