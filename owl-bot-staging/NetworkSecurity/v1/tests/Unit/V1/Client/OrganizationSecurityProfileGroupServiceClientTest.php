 ...
 * @group gapic
 */
class OrganizationSecurityProfileGroupServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new OrganizationSecurityProfileGroupServiceClient($options);
    }
    ...
    public function createSecurityProfileTest()
    {
        ...
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/CreateSecurityProfile', $actualApiFuncCall);
    ...
    public function createSecurityProfileGroupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/CreateSecurityProfileGroup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deleteSecurityProfileTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/DeleteSecurityProfile', $actualApiFuncCall);
    ...
    public function deleteSecurityProfileGroupTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->securityProfileGroupName('[ORGANIZATION]', '[LOCATION]', '[SECURITY_PROFILE_GROUP]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/DeleteSecurityProfileGroup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getSecurityProfileTest()
    {
        ...
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/GetSecurityProfile', $actualFuncCall);
    ...
    public function getSecurityProfileGroupTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/GetSecurityProfileGroup', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSecurityProfileGroupsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/ListSecurityProfileGroups', $actualFuncCall);
    ...
    public function listSecurityProfilesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/ListSecurityProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateSecurityProfileTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/UpdateSecurityProfile', $actualApiFuncCall);
    ...
    public function updateSecurityProfileGroupTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService/UpdateSecurityProfileGroup', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
        $actualValue = $actualApiRequestObject->getSecurityProfileGroup();
        $this->assertProtobufEquals($securityProfileGroup, $actualValue);
