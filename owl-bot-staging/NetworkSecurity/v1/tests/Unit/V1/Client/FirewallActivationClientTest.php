...
class FirewallActivationClientTest extends GeneratedTest
{
    ...
    public function createFirewallEndpointTest()
    {
        ...
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/CreateFirewallEndpoint', $actualApiFuncCall);
    ...
    public function createProjectFirewallEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/CreateProjectFirewallEndpoint', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualApiRequestObject->getFirewallEndpointId();
        $this->assertProtobufEquals($firewallEndpointId, $actualValue);
    ...
    public function deleteFirewallEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/DeleteFirewallEndpoint', $actualApiFuncCall);
    ...
    public function deleteFirewallEndpointAssociationTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->firewallEndpointAssociationName('[PROJECT]', '[LOCATION]', '[FIREWALL_ENDPOINT_ASSOCIATION]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/DeleteFirewallEndpointAssociation', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function deleteProjectFirewallEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/DeleteProjectFirewallEndpoint', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getFirewallEndpointAssociationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/GetFirewallEndpointAssociation', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getProjectFirewallEndpointTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/GetProjectFirewallEndpoint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listFirewallEndpointAssociationsTest()
    {
        ...
        $firewallEndpointAssociations = [
            $firewallEndpointAssociationsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/ListFirewallEndpointAssociations', $actualFuncCall);
    ...
    public function listProjectFirewallEndpointsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/ListProjectFirewallEndpoints', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateFirewallEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/UpdateFirewallEndpoint', $actualApiFuncCall);
    ...
    public function updateFirewallEndpointAssociationTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/UpdateFirewallEndpointAssociation', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
        $actualValue = $actualApiRequestObject->getFirewallEndpointAssociation();
        $this->assertProtobufEquals($firewallEndpointAssociation, $actualValue);
    ...
    public function updateProjectFirewallEndpointTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networksecurity.v1.FirewallActivation/UpdateProjectFirewallEndpoint', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
        $actualValue = $actualApiRequestObject->getFirewallEndpoint();
        $this->assertProtobufEquals($firewallEndpoint, $actualValue);
