...
class SessionServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function bidiRunSessionTest()
    {
        ...
        // Mock response
        $expectedResponse = new BidiSessionServerMessage();
        $transport->addResponse($expectedResponse);
        $expectedResponse2 = new BidiSessionServerMessage();
        $transport->addResponse($expectedResponse2);
        $expectedResponse3 = new BidiSessionServerMessage();
        $transport->addResponse($expectedResponse3);
        // Mock request
        $request = new BidiSessionClientMessage();
        $request2 = new BidiSessionClientMessage();
        $request3 = new BidiSessionClientMessage();
        $bidi = $gapicClient->bidiRunSession();
        ...
        $this->assertSame('/google.cloud.ces.v1.SessionService/BidiRunSession', $streamFuncCall);
    ...
    /** @test */
    public function bidiRunSessionExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function runSessionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new RunSessionRequest())
            ->setConfig($config)
            ->setInputs($inputs);
        $response = $gapicClient->runSession($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.ces.v1.SessionService/RunSession', $actualFuncCall);
    ...
    /** @test */
    public function runSessionExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function runSessionAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new RunSessionRequest())
            ->setConfig($config)
            ->setInputs($inputs);
        $response = $gapicClient->runSessionAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
