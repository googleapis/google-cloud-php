 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.GetAppVersionRequest</code>
 */
class GetAppVersionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the app version to retrieve. Please see
     *                     {@see AgentServiceClient::appVersionName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\GetAppVersionRequest
     *
     * @experimental
     */
