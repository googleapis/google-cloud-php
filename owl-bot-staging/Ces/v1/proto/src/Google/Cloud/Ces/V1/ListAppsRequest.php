 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListAppsRequest</code>
 */
class ListAppsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The resource name of the location to list apps from. Please see
     *                       {@see AgentServiceClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\Ces\V1\ListAppsRequest
     *
     * @experimental
     */
