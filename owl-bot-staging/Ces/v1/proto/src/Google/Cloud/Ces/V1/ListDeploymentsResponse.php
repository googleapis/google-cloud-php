 ...
 *
 * Generated from protobuf message <code>google.cloud.ces.v1.ListDeploymentsResponse</code>
 */
class ListDeploymentsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Ces\V1\Deployment::class);
