...
class ProductReviewsServiceClientTest extends GeneratedTest
{
    ...
    public function deleteProductReviewTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.reviews.v1beta.ProductReviewsService/DeleteProductReview', $actualFuncCall);
    ...
    public function getProductReviewTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.reviews.v1beta.ProductReviewsService/GetProductReview', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function insertProductReviewTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.reviews.v1beta.ProductReviewsService/InsertProductReview', $actualFuncCall);
    ...
    public function listProductReviewsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.reviews.v1beta.ProductReviewsService/ListProductReviews', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
