...
namespace Google\Shopping\Merchant\Reviews\V1beta\ProductReviewStatus\ProductReviewItemLevelIssue;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.reviews.v1beta.ProductReviewStatus.ProductReviewItemLevelIssue.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Shopping\Merchant\Reviews\V1beta\ProductReviewStatus_ProductReviewItemLevelIssue_Severity::class);
