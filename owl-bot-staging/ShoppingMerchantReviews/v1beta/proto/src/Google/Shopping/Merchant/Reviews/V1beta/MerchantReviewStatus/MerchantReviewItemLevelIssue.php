 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.reviews.v1beta.MerchantReviewStatus.MerchantReviewItemLevelIssue</code>
 */
class MerchantReviewItemLevelIssue extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.reviews.v1beta.MerchantReviewStatus.MerchantReviewItemLevelIssue.Severity severity = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Reviews\V1beta\MerchantReviewStatus\MerchantReviewItemLevelIssue\Severity::class);
        $this->severity = $var;
...
class_alias(MerchantReviewItemLevelIssue::class, \Google\Shopping\Merchant\Reviews\V1beta\MerchantReviewStatus_MerchantReviewItemLevelIssue::class);
