 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.v1.DeleteAclRequest</code>
 */
class DeleteAclRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the acl to delete.
     *                     Structured like:
     *                     `projects/{project}/locations/{location}/clusters/{cluster}/acls/{acl_id}`.
     *
     *                     The structure of `acl_id` defines the Resource Pattern (resource_type,
     ...
     *
     * @return \Google\Cloud\ManagedKafka\V1\DeleteAclRequest
     *
     * @experimental
     */
