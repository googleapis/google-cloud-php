 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/modelarmor/v1beta/service.proto
...
final class ModelArmorClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.modelarmor.v1beta.ModelArmor';
     ...
     *           use Google\Cloud\ModelArmor\V1beta\ModelArmorClient;
     ...
     *
     * @example samples/V1beta/ModelArmorClient/create_template.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/delete_template.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/get_floor_setting.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/get_template.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/list_templates.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/sanitize_model_response.php
     *
     ...
     * @experimental
     */
    public function sanitizeModelResponse(SanitizeModelResponseRequest $request, array $callOptions = []): SanitizeModelResponseResponse
    {
     ...
     *
     * @example samples/V1beta/ModelArmorClient/sanitize_user_prompt.php
     *
     ...
     * @experimental
     */
    public function sanitizeUserPrompt(SanitizeUserPromptRequest $request, array $callOptions = []): SanitizeUserPromptResponse
    {
     ...
     *
     * @example samples/V1beta/ModelArmorClient/update_floor_setting.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/update_template.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/get_location.php
     *
     ...
     *
     * @example samples/V1beta/ModelArmorClient/list_locations.php
     *
