 ...
 *
 * Generated from protobuf message <code>google.cloud.modelarmor.v1beta.SdpDeidentifyResult</code>
 */
class SdpDeidentifyResult extends \Google\Protobuf\Internal\Message
{
     ...
     * De-identified data.
     *
     * Generated from protobuf field <code>.google.cloud.modelarmor.v1beta.DataItem data = 4;</code>
     */
    protected $data = null;
    /**
     ...
     *           Output only. Match state for Sensitive Data Protection Deidentification.
     *           Value is MATCH_FOUND if content is de-identified.
     *     @type \Google\Cloud\ModelArmor\V1beta\DataItem $data
     *           De-identified data.
