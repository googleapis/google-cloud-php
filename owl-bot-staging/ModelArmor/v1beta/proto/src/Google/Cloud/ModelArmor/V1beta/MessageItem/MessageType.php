...
namespace Google\Cloud\ModelArmor\V1beta\MessageItem;
 ...
 *
 * Protobuf type <code>google.cloud.modelarmor.v1beta.MessageItem.MessageType</code>
 */
class MessageType
{
    /**
...
class_alias(MessageType::class, \Google\Cloud\ModelArmor\V1beta\MessageItem_MessageType::class);
