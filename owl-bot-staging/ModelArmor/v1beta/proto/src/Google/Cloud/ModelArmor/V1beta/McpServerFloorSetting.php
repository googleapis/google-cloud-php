 ...
 *
 * Generated from protobuf message <code>google.cloud.modelarmor.v1beta.McpServerFloorSetting</code>
 */
class McpServerFloorSetting extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated string apis = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $apis;
