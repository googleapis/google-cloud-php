 ...
 *
 * Generated from protobuf message <code>google.cloud.modelarmor.v1beta.CreateTemplateRequest</code>
 */
class CreateTemplateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.modelarmor.v1beta.Template template = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\ModelArmor\V1beta\Template $template   Required. The resource being created
     * @param string                                   $templateId Required. Id of the requesting object
     *                                                             If auto-generating Id server-side, remove this field and
     *                                                             template_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\ModelArmor\V1beta\CreateTemplateRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\ModelArmor\V1beta\Template $template, string $templateId): self
    {
        return (new self())
            ->setParent($parent)
