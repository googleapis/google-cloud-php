...
class SanitizeModelResponseRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.modelarmor.v1.StreamingMode streaming_mode = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\ModelArmor\V1\StreamingMode::class);
