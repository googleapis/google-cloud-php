 ...
 *
 * Generated from protobuf message <code>google.cloud.recommendationengine.v1beta1.GetCatalogItemRequest</code>
 */
class GetCatalogItemRequest extends \Google\Protobuf\Internal\Message
{
    /**
