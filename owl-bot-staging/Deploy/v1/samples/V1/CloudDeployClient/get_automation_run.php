...
// [START clouddeploy_v1_generated_CloudDeploy_GetAutomationRun_sync]
 ...
 *
 * @param string $formattedName Name of the `AutomationRun`. Format must be
 ...
 */
function get_automation_run_sample(string $formattedName): void
{
    // Create a client.
