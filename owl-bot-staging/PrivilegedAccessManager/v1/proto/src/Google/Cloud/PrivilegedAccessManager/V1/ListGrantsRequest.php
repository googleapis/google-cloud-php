 ...
 *
 * Generated from protobuf message <code>google.cloud.privilegedaccessmanager.v1.ListGrantsRequest</code>
 */
class ListGrantsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent resource which owns the grants. Please see
     *                       {@see PrivilegedAccessManagerClient::entitlementName()} for help formatting this field.
     *
     * @return \Google\Cloud\PrivilegedAccessManager\V1\ListGrantsRequest
     *
     * @experimental
     */
