...
class PromotionsServiceClientTest extends GeneratedTest
{
    ...
    public function getPromotionTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.promotions.v1beta.PromotionsService/GetPromotion', $actualFuncCall);
    ...
    public function insertPromotionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.promotions.v1beta.PromotionsService/InsertPromotion', $actualFuncCall);
    ...
    public function listPromotionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.promotions.v1beta.PromotionsService/ListPromotions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
