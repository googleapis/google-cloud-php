...
namespace Google\Shopping\Merchant\Promotions\V1\PromotionStatus\DestinationStatus;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.promotions.v1.PromotionStatus.DestinationStatus.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Shopping\Merchant\Promotions\V1\PromotionStatus_DestinationStatus_State::class);
