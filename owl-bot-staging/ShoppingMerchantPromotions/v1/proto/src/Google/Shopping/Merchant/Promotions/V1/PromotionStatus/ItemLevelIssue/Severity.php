...
namespace Google\Shopping\Merchant\Promotions\V1\PromotionStatus\ItemLevelIssue;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.promotions.v1.PromotionStatus.ItemLevelIssue.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Shopping\Merchant\Promotions\V1\PromotionStatus_ItemLevelIssue_Severity::class);
