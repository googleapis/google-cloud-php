...
@trigger_error('Google\Cloud\OrgPolicy\V2\Constraint_BooleanConstraint is deprecated and will be removed in the next major release. Use Google\Cloud\OrgPolicy\V2\Constraint\BooleanConstraint instead', E_USER_DEPRECATED);
