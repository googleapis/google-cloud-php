 ...
 * \Google\Cloud\Video\LiveStream\V1\Client\LivestreamServiceClient} to use the new
 * surface.
 */
class LivestreamServiceGapicClient
{
    ...
    private static function getAssetNameTemplate()
    {
        if (self::$assetNameTemplate == null) {
            self::$assetNameTemplate = new PathTemplate('projects/{project}/locations/{location}/assets/{asset}');
        }
    ...
    private static function getPoolNameTemplate()
    {
        if (self::$poolNameTemplate == null) {
            self::$poolNameTemplate = new PathTemplate('projects/{project}/locations/{location}/pools/{pool}');
        }
     ...
     */
    public function createAsset($parent, $asset, $assetId, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateAsset', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getPool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetPool', Pool::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updatePool($pool, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdatePool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
