 ...
 * with a duration.
 *
 * Generated from protobuf message <code>google.cloud.video.livestream.v1.Event.ReturnToProgramTask</code>
 */
...
class_alias(ReturnToProgramTask::class, \Google\Cloud\Video\LiveStream\V1\Event_ReturnToProgramTask::class);
