 ...
 *
 * Generated from protobuf message <code>google.cloud.video.livestream.v1.PreprocessingConfig.Crop</code>
 */
...
class_alias(Crop::class, \Google\Cloud\Video\LiveStream\V1\PreprocessingConfig_Crop::class);
