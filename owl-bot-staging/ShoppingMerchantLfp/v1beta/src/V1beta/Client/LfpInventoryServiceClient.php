 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/lfp/v1beta/lfpinventory.proto
...
final class LfpInventoryServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.lfp.v1beta.LfpInventoryService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/lfp_inventory_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/lfp_inventory_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/lfp_inventory_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/lfp_inventory_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * The async variant is {@see LfpInventoryServiceClient::insertLfpInventoryAsync()}
     * .
     *
     * @example samples/V1beta/LfpInventoryServiceClient/insert_lfp_inventory.php
     *
     * @param InsertLfpInventoryRequest $request     A request to house fields associated with the call.
     ...
     * @experimental
     */
    public function insertLfpInventory(InsertLfpInventoryRequest $request, array $callOptions = []): LfpInventory
    {
        return $this->startApiCall('InsertLfpInventory', $request, $callOptions)->wait();
    }
}
