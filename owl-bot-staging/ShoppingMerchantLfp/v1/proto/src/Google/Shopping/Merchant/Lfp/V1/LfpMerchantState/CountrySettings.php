 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.lfp.v1.LfpMerchantState.CountrySettings</code>
 */
class CountrySettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.lfp.v1.LfpMerchantState.CountrySettings.VerificationState inventory_verification_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $inventory_verification_state = 0;
    /**
     * Output only. The product page type selected by this merchant.
     *
     * Generated from protobuf field <code>.google.shopping.merchant.lfp.v1.LfpMerchantState.CountrySettings.ProductPageType product_page_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * feature.
     *
     * Generated from protobuf field <code>.google.shopping.merchant.lfp.v1.LfpMerchantState.CountrySettings.VerificationState instock_serving_verification_state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * feature.
     *
     * Generated from protobuf field <code>.google.shopping.merchant.lfp.v1.LfpMerchantState.CountrySettings.VerificationState pickup_serving_verification_state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Lfp\V1\LfpMerchantState\CountrySettings\VerificationState::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Lfp\V1\LfpMerchantState\CountrySettings\ProductPageType::class);
...
class_alias(CountrySettings::class, \Google\Shopping\Merchant\Lfp\V1\LfpMerchantState_CountrySettings::class);
