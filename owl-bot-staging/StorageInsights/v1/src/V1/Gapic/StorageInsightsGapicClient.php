 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\StorageInsights\V1\Client\StorageInsightsClient}.
 */
class StorageInsightsGapicClient
{
    ...
    private static function getReportConfigNameTemplate()
    {
        if (self::$reportConfigNameTemplate == null) {
            self::$reportConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/reportConfigs/{report_config}');
        }
    ...
    private static function getReportDetailNameTemplate()
    {
        if (self::$reportDetailNameTemplate == null) {
            self::$reportDetailNameTemplate = new PathTemplate('projects/{project}/locations/{location}/reportConfigs/{report_config}/reportDetails/{report_detail}');
        }
     ...
     */
    public static function reportDetailName($project, $location, $reportConfig, $reportDetail)
    {
     ...
     */
    public function createReportConfig($parent, $reportConfig, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateReportConfig', ReportConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteReportConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteReportConfig', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getReportConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetReportConfig', ReportConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getReportDetail($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetReportDetail', ReportDetail::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listReportConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListReportConfigs', $optionalArgs, ListReportConfigsResponse::class, $request);
    }
    ...
    public function listReportDetails($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListReportDetails', $optionalArgs, ListReportDetailsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateReportConfig($updateMask, $reportConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateReportConfig', ReportConfig::class, $optionalArgs, $request)->wait();
    }
