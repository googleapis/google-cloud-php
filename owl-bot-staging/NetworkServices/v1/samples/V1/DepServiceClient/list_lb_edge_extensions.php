 ...
 *
 * @param string $formattedParent The project and location from which the `LbEdgeExtension`
 ...
 */
function list_lb_edge_extensions_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $depServiceClient->listLbEdgeExtensions($request);

        /** @var LbEdgeExtension $element */
...
function callSample(): void
{
    ...
    list_lb_edge_extensions_sample($formattedParent);
}
