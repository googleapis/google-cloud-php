 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.UpdateTcpRouteRequest</code>
 */
class UpdateTcpRouteRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1.TcpRoute tcp_route = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $tcp_route = null;

    /**
     * @param \Google\Cloud\NetworkServices\V1\TcpRoute $tcpRoute   Required. Updated TcpRoute resource.
     ...
     *                                                              user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\NetworkServices\V1\UpdateTcpRouteRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkServices\V1\TcpRoute $tcpRoute, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
