 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.ListWasmPluginVersionsRequest</code>
 */
class ListWasmPluginVersionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The `WasmPlugin` resource whose `WasmPluginVersion`s
     *                       are listed, specified in the following format:
     ...
     *
     * @return \Google\Cloud\NetworkServices\V1\ListWasmPluginVersionsRequest
     *
     * @experimental
     */
