 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.ListServiceLbPoliciesRequest</code>
 */
class ListServiceLbPoliciesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project and location from which the ServiceLbPolicies should
     *                       be listed, specified in the format
     *                       `projects/{project}/locations/{location}`. Please see
     *                       {@see NetworkServicesClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkServices\V1\ListServiceLbPoliciesRequest
     *
     * @experimental
     */
