 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.schemaregistry.v1.DeleteSchemaConfigRequest</code>
 */
class DeleteSchemaConfigRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of subject to delete the config for. The format
     *                     is
     *                     * projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/config/{subject}
     *                     Please see {@see ManagedSchemaRegistryClient::schemaConfigName()} for help formatting this field.
     *
     * @return \Google\Cloud\ManagedKafka\SchemaRegistry\V1\DeleteSchemaConfigRequest
     *
     * @experimental
     */
