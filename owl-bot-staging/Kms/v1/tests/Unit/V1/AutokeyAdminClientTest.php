...
use Google\Cloud\Kms\V1\AutokeyAdminClient;
...
class AutokeyAdminClientTest extends GeneratedTest
{
    ...
    public function getAutokeyConfigTest()
    {
        ...
        $response = $gapicClient->getAutokeyConfig($formattedName);
    ...
    public function getAutokeyConfigExceptionTest()
    {
        ...
        $formattedName = $gapicClient->autokeyConfigName('[FOLDER]');
        try {
            $gapicClient->getAutokeyConfig($formattedName);
    ...
    public function showEffectiveAutokeyConfigTest()
    {
        ...
        $response = $gapicClient->showEffectiveAutokeyConfig($formattedParent);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function showEffectiveAutokeyConfigExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        try {
            $gapicClient->showEffectiveAutokeyConfig($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateAutokeyConfigTest()
    {
        ...
        $response = $gapicClient->updateAutokeyConfig($autokeyConfig, $updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateAutokeyConfigExceptionTest()
    {
        ...
        $updateMask = new FieldMask();
        try {
            $gapicClient->updateAutokeyConfig($autokeyConfig, $updateMask);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
