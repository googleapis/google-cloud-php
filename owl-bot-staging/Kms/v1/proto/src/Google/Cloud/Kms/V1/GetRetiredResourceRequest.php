 ...
 *
 * Generated from protobuf message <code>google.cloud.kms.v1.GetRetiredResourceRequest</code>
 */
class GetRetiredResourceRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The [name][google.cloud.kms.v1.RetiredResource.name] of the
     ...
     *
     * @return \Google\Cloud\Kms\V1\GetRetiredResourceRequest
     *
     * @experimental
     */
