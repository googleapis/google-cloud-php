    ...
    'interfaces' => [
        'google.cloud.kms.v1.HsmManagement' => [
            'ApproveSingleTenantHsmInstanceProposal' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*/proposals/*}:approve',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'CreateSingleTenantHsmInstance' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/singleTenantHsmInstances',
            ...
            'CreateSingleTenantHsmInstanceProposal' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/singleTenantHsmInstances/*}/proposals',
            ...
            'DeleteSingleTenantHsmInstanceProposal' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*/proposals/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ExecuteSingleTenantHsmInstanceProposal' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*/proposals/*}:execute',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'GetSingleTenantHsmInstance' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
