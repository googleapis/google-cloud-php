...
use Google\Cloud\CloudControlsPartner\V1beta\GetViolationRequest;
use Google\Cloud\CloudControlsPartner\V1beta\ListViolationsRequest;
use Google\Cloud\CloudControlsPartner\V1beta\ListViolationsResponse;
...
class CloudControlsPartnerMonitoringClientTest extends GeneratedTest
{
    ...
    public function getViolationTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->violationName('[ORGANIZATION]', '[LOCATION]', '[CUSTOMER]', '[WORKLOAD]', '[VIOLATION]');
        ...
        $this->assertSame('/google.cloud.cloudcontrolspartner.v1beta.CloudControlsPartnerMonitoring/GetViolation', $actualFuncCall);
    ...
    public function listViolationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.cloudcontrolspartner.v1beta.CloudControlsPartnerMonitoring/ListViolations', $actualFuncCall);
