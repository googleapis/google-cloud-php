...
namespace Google\Cloud\CloudControlsPartner\V1beta\AccessReason;
 ...
 *
 * Protobuf type <code>google.cloud.cloudcontrolspartner.v1beta.AccessReason.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\CloudControlsPartner\V1beta\AccessReason_Type::class);
