 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudcontrolspartner.v1beta.WorkloadOnboardingStep</code>
 */
class WorkloadOnboardingStep extends \Google\Protobuf\Internal\Message
{
    /**
     * The onboarding step.
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1beta.WorkloadOnboardingStep.Step step = 1;</code>
     */
    protected $step = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudControlsPartner\V1beta\WorkloadOnboardingStep\Step::class);
        $this->step = $var;
