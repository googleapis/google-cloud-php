...
final class CloudControlsPartnerCoreClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/cloud_controls_partner_core_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @experimental
     */
    public static function ekmConnectionsName(string $organization, string $location, string $customer, string $workload): string
    {
     ...
     * @experimental
     */
    public static function partnerPermissionsName(string $organization, string $location, string $customer, string $workload): string
    {
     ...
     *           use Google\Cloud\CloudControlsPartner\V1beta\CloudControlsPartnerCoreClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CloudControlsPartnerCoreClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @experimental
     */
    public function getPartnerPermissions(GetPartnerPermissionsRequest $request, array $callOptions = []): PartnerPermissions
    {
     ...
     */
    public function listAccessApprovalRequests(ListAccessApprovalRequestsRequest $request, array $callOptions = []): PagedListResponse
    {
