...
namespace Google\Cloud\BigQuery\Migration\V2\Client\BaseClient;
 ...
 */
abstract class MigrationServiceBaseClient
{
     ...
     */
    public static function migrationWorkflowName(string $project, string $location, string $workflow): string
    {
        return self::getPathTemplate('migrationWorkflow')->render([
            'project' => $project,
            'location' => $location,
            'workflow' => $workflow,
        ]);
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteMigrationWorkflow(DeleteMigrationWorkflowRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteMigrationWorkflow', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getMigrationSubtask(GetMigrationSubtaskRequest $request, array $callOptions = []): MigrationSubtask
    {
        return $this->startApiCall('GetMigrationSubtask', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function startMigrationWorkflow(StartMigrationWorkflowRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('StartMigrationWorkflow', $request, $callOptions)->wait();
    }
}
