 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2.DeleteMigrationWorkflowRequest</code>
 */
class DeleteMigrationWorkflowRequest extends \Google\Protobuf\Internal\Message
{
    /**
