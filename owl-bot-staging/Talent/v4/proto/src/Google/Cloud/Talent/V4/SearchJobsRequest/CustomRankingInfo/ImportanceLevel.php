...
namespace Google\Cloud\Talent\V4\SearchJobsRequest\CustomRankingInfo;
...
class_alias(ImportanceLevel::class, \Google\Cloud\Talent\V4\SearchJobsRequest_CustomRankingInfo_ImportanceLevel::class);
