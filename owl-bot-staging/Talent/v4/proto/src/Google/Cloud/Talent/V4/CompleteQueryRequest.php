 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.CompleteQueryRequest</code>
 */
class CompleteQueryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\CompleteQueryRequest\CompletionScope::class);
        $this->scope = $var;
