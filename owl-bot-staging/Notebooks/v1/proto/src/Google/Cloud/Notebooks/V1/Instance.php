 ...
 *
 * Generated from protobuf message <code>google.cloud.notebooks.v1.Instance</code>
 */
class Instance extends \Google\Protobuf\Internal\Message
{
     ...
     *           type](https://cloud.google.com/compute/docs/machine-types) of this
     *           instance.
     *     @type \Google\Cloud\Notebooks\V1\Instance\AcceleratorConfig $accelerator_config
     *           The hardware accelerator used on this instance. If you use
     *           accelerators, make sure that your configuration has
     *           [enough vCPUs and memory to support the `machine_type` you have
     *           selected](https://cloud.google.com/compute/docs/gpus/#gpus-list).
     ...
     *           Optional. The type of vNIC to be used on this interface. This may be gVNIC or
     *           VirtioNet.
     *     @type \Google\Cloud\Notebooks\V1\ReservationAffinity $reservation_affinity
     *           Optional. The optional reservation affinity. Setting this field will apply
     *           the specified [Zonal Compute
     *           Reservation](https://cloud.google.com/compute/docs/instances/reserving-zonal-resources)
     *           to this notebook instance.
     ...
     * Use a Compute Engine VM image to start the notebook instance.
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.VmImage vm_image = 2;</code>
     ...
     * Use a container image to start the notebook instance.
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.ContainerImage container_image = 3;</code>
     ...
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.Instance.AcceleratorConfig accelerator_config = 9;</code>
     * @return \Google\Cloud\Notebooks\V1\Instance\AcceleratorConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.Instance.AcceleratorConfig accelerator_config = 9;</code>
     * @param \Google\Cloud\Notebooks\V1\Instance\AcceleratorConfig $var
     * @return $this
     */
    public function setAcceleratorConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Notebooks\V1\Instance\AcceleratorConfig::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Notebooks\V1\Instance\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Notebooks\V1\Instance\DiskType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Notebooks\V1\Instance\DiskEncryption::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Notebooks\V1\Instance\Disk::class);
        $this->disks = $arr;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Notebooks\V1\Instance\UpgradeHistoryEntry::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Notebooks\V1\Instance\NicType::class);
        $this->nic_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.ReservationAffinity reservation_affinity = 34 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Notebooks\V1\ReservationAffinity|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.ReservationAffinity reservation_affinity = 34 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Notebooks\V1\ReservationAffinity $var
     * @return $this
     */
    public function setReservationAffinity($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Notebooks\V1\ReservationAffinity::class);
