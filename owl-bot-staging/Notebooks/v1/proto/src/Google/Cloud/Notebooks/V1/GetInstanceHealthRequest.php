 ...
 *
 * Generated from protobuf message <code>google.cloud.notebooks.v1.GetInstanceHealthRequest</code>
 */
class GetInstanceHealthRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Required. Format:
