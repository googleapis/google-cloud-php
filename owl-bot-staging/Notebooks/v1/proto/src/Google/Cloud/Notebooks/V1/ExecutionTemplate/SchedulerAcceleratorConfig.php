 ...
 *
 * Generated from protobuf message <code>google.cloud.notebooks.v1.ExecutionTemplate.SchedulerAcceleratorConfig</code>
 */
class SchedulerAcceleratorConfig extends \Google\Protobuf\Internal\Message
{
    /**
     * Type of this accelerator.
     *
     * Generated from protobuf field <code>.google.cloud.notebooks.v1.ExecutionTemplate.SchedulerAcceleratorType type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Notebooks\V1\ExecutionTemplate\SchedulerAcceleratorType::class);
        $this->type = $var;
