 ...
 *
 * Protobuf type <code>google.cloud.notebooks.v1.Instance.DiskEncryption</code>
 */
...
class_alias(DiskEncryption::class, \Google\Cloud\Notebooks\V1\Instance_DiskEncryption::class);
