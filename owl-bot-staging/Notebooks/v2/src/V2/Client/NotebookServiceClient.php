 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/notebooks/v2/service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\Notebooks\V2\Client;
 ...
 *
 * @method PromiseInterface<CheckInstanceUpgradabilityResponse> checkInstanceUpgradabilityAsync(CheckInstanceUpgradabilityRequest $request, array $optionalArgs = [])
...
final class NotebookServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.notebooks.v2.NotebookService';
     ...
     *           use Google\Cloud\Notebooks\V2\NotebookServiceClient;
     ...
     *
     * @param CheckInstanceUpgradabilityRequest $request     A request to house fields associated with the call.
