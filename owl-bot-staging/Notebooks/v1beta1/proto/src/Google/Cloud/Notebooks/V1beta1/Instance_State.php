...
@trigger_error('Google\Cloud\Notebooks\V1beta1\Instance_State is deprecated and will be removed in the next major release. Use Google\Cloud\Notebooks\V1beta1\Instance\State instead', E_USER_DEPRECATED);
