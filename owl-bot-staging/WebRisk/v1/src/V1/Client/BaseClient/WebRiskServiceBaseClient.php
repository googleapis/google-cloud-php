...
namespace Google\Cloud\WebRisk\V1\Client\BaseClient;
 ...
 */
abstract class WebRiskServiceBaseClient
{
     ...
     * for each list.
     *
     * The async variant is {@see self::computeThreatListDiffAsync()} .
     *
     ...
     *
     * The async variant is {@see self::createSubmissionAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createSubmission(CreateSubmissionRequest $request, array $callOptions = []): Submission
    {
        return $this->startApiCall('CreateSubmission', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see self::searchHashesAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchHashes(SearchHashesRequest $request, array $callOptions = []): SearchHashesResponse
    {
        return $this->startApiCall('SearchHashes', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see self::searchUrisAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchUris(SearchUrisRequest $request, array $callOptions = []): SearchUrisResponse
    {
        return $this->startApiCall('SearchUris', $request, $callOptions)->wait();
    }
     ...
     * out to Sales or your customer engineer to obtain access.
     *
     * The async variant is {@see self::submitUriAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function submitUri(SubmitUriRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('SubmitUri', $request, $callOptions)->wait();
    }
}
