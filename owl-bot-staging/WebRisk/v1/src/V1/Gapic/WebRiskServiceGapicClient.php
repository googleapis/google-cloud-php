 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\WebRisk\V1\Client\WebRiskServiceClient}.
 */
class WebRiskServiceGapicClient
{
    ...
    public function submitUri($parent, $submission, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('SubmitUri', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
