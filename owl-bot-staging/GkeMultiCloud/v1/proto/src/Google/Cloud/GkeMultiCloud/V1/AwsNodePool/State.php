...
namespace Google\Cloud\GkeMultiCloud\V1\AwsNodePool;
 ...
 *
 * Protobuf type <code>google.cloud.gkemulticloud.v1.AwsNodePool.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\GkeMultiCloud\V1\AwsNodePool_State::class);
