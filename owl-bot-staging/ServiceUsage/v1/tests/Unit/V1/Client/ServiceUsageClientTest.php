...
namespace Google\Cloud\ServiceUsage\Tests\Unit\V1\Client;
...
class ServiceUsageClientTest extends GeneratedTest
{
    ...
    public function batchEnableServicesTest()
    {
        ...
        $response = $gapicClient->batchEnableServices($request);
    ...
    public function batchGetServicesTest()
    {
        ...
        $response = $gapicClient->batchGetServices($request);
    ...
    public function batchGetServicesExceptionTest()
    {
        ...
        $request = new BatchGetServicesRequest();
        try {
            $gapicClient->batchGetServices($request);
    ...
    public function disableServiceTest()
    {
        ...
        $response = $gapicClient->disableService($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function enableServiceTest()
    {
        ...
        $response = $gapicClient->enableService($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    /** @test */
    public function batchEnableServicesAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $operationsTransport->addResponse($completeOperation);
        $request = new BatchEnableServicesRequest();
        $response = $gapicClient->batchEnableServicesAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
