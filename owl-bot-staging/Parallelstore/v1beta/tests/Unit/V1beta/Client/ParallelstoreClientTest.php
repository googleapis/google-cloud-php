...
namespace Google\Cloud\Parallelstore\Tests\Unit\V1beta\Client;
...
class ParallelstoreClientTest extends GeneratedTest
{
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1beta.Parallelstore/DeleteInstance', $actualApiFuncCall);
    ...
    public function exportDataTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1beta.Parallelstore/ExportData', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getInstanceTest()
    {
        ...
        $this->assertSame('/google.cloud.parallelstore.v1beta.Parallelstore/GetInstance', $actualFuncCall);
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1beta.Parallelstore/ListInstances', $actualFuncCall);
    ...
    public function updateInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1beta.Parallelstore/UpdateInstance', $actualApiFuncCall);
