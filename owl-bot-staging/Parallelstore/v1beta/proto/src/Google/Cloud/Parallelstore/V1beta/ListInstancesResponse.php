...
class ListInstancesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Parallelstore\V1beta\Instance[] $instances
     *           The list of Parallelstore instances.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.parallelstore.v1beta.Instance instances = 1;</code>
     * @return RepeatedField<\Google\Cloud\Parallelstore\V1beta\Instance>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Parallelstore\V1beta\Instance::class);
        $this->instances = $arr;
