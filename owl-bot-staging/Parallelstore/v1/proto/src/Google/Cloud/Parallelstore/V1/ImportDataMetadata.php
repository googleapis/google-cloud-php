 ...
 *
 * Generated from protobuf message <code>google.cloud.parallelstore.v1.ImportDataMetadata</code>
 */
class ImportDataMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parallelstore.v1.TransferOperationMetadata operation_metadata = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>string target = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $target = '';
    /**
     * Output only. Name of the verb executed by the operation.
     *
     * Generated from protobuf field <code>string verb = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $verb = '';
    /**
     ...
     *
     *     @type \Google\Cloud\Parallelstore\V1\TransferOperationMetadata $operation_metadata
     *           Data transfer operation metadata.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parallelstore.v1.TransferOperationMetadata operation_metadata = 1;</code>
     * @return \Google\Cloud\Parallelstore\V1\TransferOperationMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parallelstore.v1.TransferOperationMetadata operation_metadata = 1;</code>
     * @param \Google\Cloud\Parallelstore\V1\TransferOperationMetadata $var
     * @return $this
     */
    public function setOperationMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Parallelstore\V1\TransferOperationMetadata::class);
