...
namespace Google\Cloud\Parallelstore\Tests\Unit\V1\Client;
...
use Google\Cloud\Parallelstore\V1\ImportDataRequest;
use Google\Cloud\Parallelstore\V1\ImportDataResponse;
use Google\Cloud\Parallelstore\V1\Instance;
use Google\Cloud\Parallelstore\V1\ListInstancesRequest;
use Google\Cloud\Parallelstore\V1\ListInstancesResponse;
 ...
 * @group gapic
 */
class ParallelstoreClientTest extends GeneratedTest
{
    ...
    /** @return ParallelstoreClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new ParallelstoreClient($options);
    }
    ...
    public function createInstanceTest()
    {
        ...
        $daosVersion = 'daosVersion-1809382982';
        $network = 'network1843485230';
        $reservedIpRange = 'reservedIpRange-1082940580';
        $effectiveReservedIpRange = 'effectiveReservedIpRange-598066492';
        $expectedResponse = new Instance();
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
        $expectedResponse->setCapacityGib($capacityGib);
        $expectedResponse->setDaosVersion($daosVersion);
        $expectedResponse->setNetwork($network);
        $expectedResponse->setReservedIpRange($reservedIpRange);
        $expectedResponse->setEffectiveReservedIpRange($effectiveReservedIpRange);
        $anyResponse = new Any();
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1.Parallelstore/DeleteInstance', $actualApiFuncCall);
    ...
    public function exportDataTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1.Parallelstore/ExportData', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getInstanceTest()
    {
        ...
        $this->assertSame('/google.cloud.parallelstore.v1.Parallelstore/GetInstance', $actualFuncCall);
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1.Parallelstore/ListInstances', $actualFuncCall);
    ...
    public function updateInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.parallelstore.v1.Parallelstore/UpdateInstance', $actualApiFuncCall);
