...
class DeliveryTime extends \Google\Protobuf\Internal\Message
{
     ...
     *           The business days during which orders can be in-transit.
     *           If not provided, Monday to Friday business days will be assumed.
     *     @type \Google\Shopping\Merchant\Accounts\V1beta\WarehouseBasedDeliveryTime[] $warehouse_based_delivery_times
     *           Optional. Indicates that the delivery time should be calculated per
     *           warehouse (shipping origin location) based on the settings of the selected
     *           carrier. When set, no other transit time related field in [delivery
     *           time][[google.shopping.content.bundles.ShippingSetting.DeliveryTime] should
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.WarehouseBasedDeliveryTime warehouse_based_delivery_times = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1beta\WarehouseBasedDeliveryTime>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.WarehouseBasedDeliveryTime warehouse_based_delivery_times = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1beta\WarehouseBasedDeliveryTime[] $var
     * @return $this
     */
