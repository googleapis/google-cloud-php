 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1beta.FindLfpProvidersRequest</code>
 */
class FindLfpProvidersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The name of the parent resource under which the LFP providers are
     *                       found. Format:
     ...
     *
     * @return \Google\Shopping\Merchant\Accounts\V1beta\FindLfpProvidersRequest
     *
     * @experimental
     */
