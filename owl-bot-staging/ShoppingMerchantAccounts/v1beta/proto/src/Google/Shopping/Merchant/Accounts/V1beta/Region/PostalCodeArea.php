...
class PostalCodeArea extends \Google\Protobuf\Internal\Message
{
     ...
     *           code](http://www.unicode.org/repos/cldr/tags/latest/common/main/en.xml)
     *           or the country the postal code group applies to.
     *     @type \Google\Shopping\Merchant\Accounts\V1beta\Region\PostalCodeArea\PostalCodeRange[] $postal_codes
     *           Required. A range of postal codes.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.Region.PostalCodeArea.PostalCodeRange postal_codes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1beta\Region\PostalCodeArea\PostalCodeRange>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.Region.PostalCodeArea.PostalCodeRange postal_codes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1beta\Region\PostalCodeArea\PostalCodeRange[] $var
     * @return $this
     */
