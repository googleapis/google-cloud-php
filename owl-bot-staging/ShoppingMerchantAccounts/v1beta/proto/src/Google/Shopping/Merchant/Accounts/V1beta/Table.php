...
class Table extends \Google\Protobuf\Internal\Message
{
     ...
     *           Headers of the table's columns. Optional: if not set then the table has
     *           only one dimension.
     *     @type \Google\Shopping\Merchant\Accounts\V1beta\Row[] $rows
     *           Required. The list of rows that constitute the table. Must have the same
     *           length as `row_headers`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.Row rows = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1beta\Row>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1beta.Row rows = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1beta\Row[] $var
     * @return $this
     */
