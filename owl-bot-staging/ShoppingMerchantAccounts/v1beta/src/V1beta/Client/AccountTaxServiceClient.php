 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1beta/account_tax.proto
...
final class AccountTaxServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1beta.AccountTaxService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1beta\AccountTaxServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AccountTaxServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
