...
use Google\Shopping\Merchant\Accounts\V1beta\CreateOmnichannelSettingRequest;
use Google\Shopping\Merchant\Accounts\V1beta\GetOmnichannelSettingRequest;
use Google\Shopping\Merchant\Accounts\V1beta\ListOmnichannelSettingsRequest;
use Google\Shopping\Merchant\Accounts\V1beta\ListOmnichannelSettingsResponse;
...
use Google\Shopping\Merchant\Accounts\V1beta\RequestInventoryVerificationRequest;
use Google\Shopping\Merchant\Accounts\V1beta\RequestInventoryVerificationResponse;
...
class OmnichannelSettingsServiceClientTest extends GeneratedTest
{
    ...
    public function createOmnichannelSettingTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/CreateOmnichannelSetting', $actualFuncCall);
    ...
    public function getOmnichannelSettingTest()
    {
        ...
        $request = (new GetOmnichannelSettingRequest())
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/GetOmnichannelSetting', $actualFuncCall);
    ...
    public function listOmnichannelSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/ListOmnichannelSettings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function requestInventoryVerificationTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->omnichannelSettingName('[ACCOUNT]', '[OMNICHANNEL_SETTING]');
        $request = (new RequestInventoryVerificationRequest())
            ->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/RequestInventoryVerification', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateOmnichannelSettingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService/UpdateOmnichannelSetting', $actualFuncCall);
        $actualValue = $actualRequestObject->getOmnichannelSetting();
        $this->assertProtobufEquals($omnichannelSetting, $actualValue);
