...
class AutomaticImprovementsServiceClientTest extends GeneratedTest
{
    ...
    public function getAutomaticImprovementsTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.AutomaticImprovementsService/GetAutomaticImprovements', $actualFuncCall);
    ...
    public function updateAutomaticImprovementsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.AutomaticImprovementsService/UpdateAutomaticImprovements', $actualFuncCall);
