...
class LfpProvidersServiceClientTest extends GeneratedTest
{
    ...
    public function findLfpProvidersTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.LfpProvidersService/FindLfpProviders', $actualFuncCall);
    ...
    public function linkLfpProviderTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.LfpProvidersService/LinkLfpProvider', $actualFuncCall);
