...
class OnlineReturnPolicyServiceClientTest extends GeneratedTest
{
    ...
    public function createOnlineReturnPolicyTest()
    {
        ...
        $onlineReturnPolicyLabel = 'onlineReturnPolicyLabel1719353215';
        $onlineReturnPolicy->setLabel($onlineReturnPolicyLabel);
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OnlineReturnPolicyService/CreateOnlineReturnPolicy', $actualFuncCall);
    ...
    public function deleteOnlineReturnPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OnlineReturnPolicyService/DeleteOnlineReturnPolicy', $actualFuncCall);
    ...
    /** @test */
    public function updateOnlineReturnPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateOnlineReturnPolicyRequest())
            ->setOnlineReturnPolicy($onlineReturnPolicy);
        $response = $gapicClient->updateOnlineReturnPolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1beta.OnlineReturnPolicyService/UpdateOnlineReturnPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getOnlineReturnPolicy();
        $this->assertProtobufEquals($onlineReturnPolicy, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function updateOnlineReturnPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateOnlineReturnPolicyRequest())
            ->setOnlineReturnPolicy($onlineReturnPolicy);
        try {
            $gapicClient->updateOnlineReturnPolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
