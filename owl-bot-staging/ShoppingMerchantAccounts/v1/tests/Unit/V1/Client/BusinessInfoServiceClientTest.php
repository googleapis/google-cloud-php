...
class BusinessInfoServiceClientTest extends GeneratedTest
{
    ...
    public function getBusinessInfoTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.BusinessInfoService/GetBusinessInfo', $actualFuncCall);
    ...
    public function updateBusinessInfoTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.BusinessInfoService/UpdateBusinessInfo', $actualFuncCall);
