...
class AutofeedSettingsServiceClientTest extends GeneratedTest
{
    ...
    public function getAutofeedSettingsTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.AutofeedSettingsService/GetAutofeedSettings', $actualFuncCall);
    ...
    public function updateAutofeedSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AutofeedSettingsService/UpdateAutofeedSettings', $actualFuncCall);
