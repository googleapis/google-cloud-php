...
use Google\Shopping\Merchant\Accounts\V1\ListAccountsResponse;
use Google\Shopping\Merchant\Accounts\V1\ListSubAccountsRequest;
use Google\Shopping\Merchant\Accounts\V1\ListSubAccountsResponse;
...
class AccountsServiceClientTest extends GeneratedTest
{
    ...
    public function createAndConfigureAccountTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/CreateAndConfigureAccount', $actualFuncCall);
    ...
    public function deleteAccountTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/DeleteAccount', $actualFuncCall);
    ...
    public function getAccountTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/GetAccount', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listAccountsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/ListAccounts', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listSubAccountsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/ListSubAccounts', $actualFuncCall);
    ...
    public function updateAccountTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountsService/UpdateAccount', $actualFuncCall);
        $actualValue = $actualRequestObject->getAccount();
        $this->assertProtobufEquals($account, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
