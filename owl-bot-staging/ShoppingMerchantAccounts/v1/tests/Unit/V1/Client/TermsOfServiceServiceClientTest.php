...
class TermsOfServiceServiceClientTest extends GeneratedTest
{
    ...
    public function acceptTermsOfServiceTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.TermsOfServiceService/AcceptTermsOfService', $actualFuncCall);
    ...
    public function getTermsOfServiceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.TermsOfServiceService/GetTermsOfService', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function retrieveLatestTermsOfServiceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.TermsOfServiceService/RetrieveLatestTermsOfService', $actualFuncCall);
        $actualValue = $actualRequestObject->getRegionCode();
        $this->assertProtobufEquals($regionCode, $actualValue);
