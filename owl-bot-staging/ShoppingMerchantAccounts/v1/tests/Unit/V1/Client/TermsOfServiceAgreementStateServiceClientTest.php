...
use Google\Shopping\Merchant\Accounts\V1\TermsOfServiceAgreementState;
use stdClass;
...
class TermsOfServiceAgreementStateServiceClientTest extends GeneratedTest
{
    ...
    public function getTermsOfServiceAgreementStateTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService/GetTermsOfServiceAgreementState', $actualFuncCall);
    ...
    public function retrieveForApplicationTermsOfServiceAgreementStateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService/RetrieveForApplicationTermsOfServiceAgreementState', $actualFuncCall);
