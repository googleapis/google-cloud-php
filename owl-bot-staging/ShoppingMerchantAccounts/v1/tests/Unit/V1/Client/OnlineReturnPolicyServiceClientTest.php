...
class OnlineReturnPolicyServiceClientTest extends GeneratedTest
{
    ...
    public function createOnlineReturnPolicyTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.OnlineReturnPolicyService/CreateOnlineReturnPolicy', $actualFuncCall);
    ...
    public function deleteOnlineReturnPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OnlineReturnPolicyService/DeleteOnlineReturnPolicy', $actualFuncCall);
    ...
    public function getOnlineReturnPolicyTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OnlineReturnPolicyService/GetOnlineReturnPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listOnlineReturnPoliciesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OnlineReturnPolicyService/ListOnlineReturnPolicies', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
