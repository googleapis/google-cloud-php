...
class EmailPreferencesServiceClientTest extends GeneratedTest
{
    ...
    public function getEmailPreferencesTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.EmailPreferencesService/GetEmailPreferences', $actualFuncCall);
    ...
    public function updateEmailPreferencesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.EmailPreferencesService/UpdateEmailPreferences', $actualFuncCall);
