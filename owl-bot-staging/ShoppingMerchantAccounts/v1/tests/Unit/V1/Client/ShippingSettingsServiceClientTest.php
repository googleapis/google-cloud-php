...
class ShippingSettingsServiceClientTest extends GeneratedTest
{
    ...
    public function getShippingSettingsTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.ShippingSettingsService/GetShippingSettings', $actualFuncCall);
    ...
    public function insertShippingSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.ShippingSettingsService/InsertShippingSettings', $actualFuncCall);
