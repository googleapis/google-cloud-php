...
class OmnichannelSettingsServiceClientTest extends GeneratedTest
{
    ...
    public function createOmnichannelSettingTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.OmnichannelSettingsService/CreateOmnichannelSetting', $actualFuncCall);
    ...
    public function getOmnichannelSettingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OmnichannelSettingsService/GetOmnichannelSetting', $actualFuncCall);
    ...
    public function listOmnichannelSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OmnichannelSettingsService/ListOmnichannelSettings', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function requestInventoryVerificationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OmnichannelSettingsService/RequestInventoryVerification', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateOmnichannelSettingTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.OmnichannelSettingsService/UpdateOmnichannelSetting', $actualFuncCall);
        $actualValue = $actualRequestObject->getOmnichannelSetting();
        $this->assertProtobufEquals($omnichannelSetting, $actualValue);
