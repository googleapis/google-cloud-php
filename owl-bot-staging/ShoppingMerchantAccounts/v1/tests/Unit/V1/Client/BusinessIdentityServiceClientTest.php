...
class BusinessIdentityServiceClientTest extends GeneratedTest
{
    ...
    public function getBusinessIdentityTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.BusinessIdentityService/GetBusinessIdentity', $actualFuncCall);
    ...
    public function updateBusinessIdentityTest()
    {
        ...
        $businessIdentity->setPromotionsConsent($businessIdentityPromotionsConsent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.BusinessIdentityService/UpdateBusinessIdentity', $actualFuncCall);
