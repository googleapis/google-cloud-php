...
class AccountRelationshipsServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountRelationshipTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountRelationshipsService/GetAccountRelationship', $actualFuncCall);
    ...
    public function listAccountRelationshipsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountRelationshipsService/ListAccountRelationships', $actualFuncCall);
    ...
    public function updateAccountRelationshipTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.AccountRelationshipsService/UpdateAccountRelationship', $actualFuncCall);
