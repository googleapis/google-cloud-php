 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/programs.proto
...
final class ProgramsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.ProgramsService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\ProgramsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ProgramsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ProgramsServiceClient/disable_program.php
     *
     ...
     *
     * @example samples/V1/ProgramsServiceClient/enable_program.php
     *
     ...
     *
     * @example samples/V1/ProgramsServiceClient/get_program.php
     *
     ...
     *
     * @example samples/V1/ProgramsServiceClient/list_programs.php
     *
