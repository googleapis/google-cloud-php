 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/online_return_policy.proto
...
/**
 * Service Description: The service facilitates the management of a business's remorse return policy
...
final class OnlineReturnPolicyServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.OnlineReturnPolicyService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicyServiceClient;
     ...
     *
     * @example samples/V1/OnlineReturnPolicyServiceClient/create_online_return_policy.php
     *
     ...
     *
     * @example samples/V1/OnlineReturnPolicyServiceClient/delete_online_return_policy.php
     *
     ...
     *
     * @example samples/V1/OnlineReturnPolicyServiceClient/get_online_return_policy.php
     *
     ...
     *
     * @example samples/V1/OnlineReturnPolicyServiceClient/list_online_return_policies.php
     *
