 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/autofeedsettings.proto
...
final class AutofeedSettingsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.AutofeedSettingsService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\AutofeedSettingsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AutofeedSettingsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/AutofeedSettingsServiceClient/get_autofeed_settings.php
     *
     ...
     *
     * @example samples/V1/AutofeedSettingsServiceClient/update_autofeed_settings.php
     *
