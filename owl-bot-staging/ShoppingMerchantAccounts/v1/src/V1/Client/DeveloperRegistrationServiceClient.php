 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/developerregistration.proto
 ...
 */
final class DeveloperRegistrationServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.DeveloperRegistrationService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/developer_registration_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/developer_registration_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/developer_registration_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     *
     * @return string The formatted developer_registration resource.
     */
    public static function developerRegistrationName(string $account): string
    {
        return self::getPathTemplate('developerRegistration')->render([
            'account' => $account,
        ]);
    }
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\DeveloperRegistrationServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new DeveloperRegistrationServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function getAccountForGcpRegistration(GPBEmpty $request, array $callOptions = []): GetAccountForGcpRegistrationResponse
    {
     ...
     *
     * The async variant is
     * {@see DeveloperRegistrationServiceClient::getDeveloperRegistrationAsync()} .
     *
     * @example samples/V1/DeveloperRegistrationServiceClient/get_developer_registration.php
     *
     * @param GetDeveloperRegistrationRequest $request     A request to house fields associated with the call.
     * @param array                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see DeveloperRegistrationServiceClient::registerGcpAsync()} .
     *
     * @example samples/V1/DeveloperRegistrationServiceClient/register_gcp.php
     *
     * @param RegisterGcpRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function registerGcp(RegisterGcpRequest $request, array $callOptions = []): DeveloperRegistration
    {
        return $this->startApiCall('RegisterGcp', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is
     * {@see DeveloperRegistrationServiceClient::unregisterGcpAsync()} .
     *
     * @example samples/V1/DeveloperRegistrationServiceClient/unregister_gcp.php
     *
     * @param UnregisterGcpRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function unregisterGcp(UnregisterGcpRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('UnregisterGcp', $request, $callOptions)->wait();
    }
}
