 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/emailpreferences.proto
...
final class EmailPreferencesServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.EmailPreferencesService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\EmailPreferencesServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new EmailPreferencesServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/EmailPreferencesServiceClient/get_email_preferences.php
     *
     ...
     *
     * @example samples/V1/EmailPreferencesServiceClient/update_email_preferences.php
     *
