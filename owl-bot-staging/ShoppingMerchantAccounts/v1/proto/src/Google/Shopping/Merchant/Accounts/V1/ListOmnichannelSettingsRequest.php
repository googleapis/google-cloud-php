 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.ListOmnichannelSettingsRequest</code>
 */
class ListOmnichannelSettingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of omnichannel settings.
     *                       Format: `accounts/{account}`
     *                       Please see {@see OmnichannelSettingsServiceClient::accountName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\Accounts\V1\ListOmnichannelSettingsRequest
     *
     * @experimental
     */
