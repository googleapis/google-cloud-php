 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.OnlineReturnPolicy.RestockingFee</code>
 */
...
class_alias(RestockingFee::class, \Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicy_RestockingFee::class);
