 ...
 * expressive enough.
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Table</code>
 */
class Table extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Headers row_headers = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * only one dimension.
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Headers column_headers = 3;</code>
     */
     ...
     *     @type string $name
     *           Name of the table. Required for subtables, ignored for the main table.
     *     @type \Google\Shopping\Merchant\Accounts\V1\Headers $row_headers
     *           Required. Headers of the table's rows.
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Headers row_headers = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\Headers|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Headers row_headers = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\Headers $var
     * @return $this
     */
    public function setRowHeaders($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\Headers::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\Row::class);
        $this->rows = $arr;
