 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.AccountIssue.Severity</code>
 */
class Severity
{
    /**
...
class_alias(Severity::class, \Google\Shopping\Merchant\Accounts\V1\AccountIssue_Severity::class);
