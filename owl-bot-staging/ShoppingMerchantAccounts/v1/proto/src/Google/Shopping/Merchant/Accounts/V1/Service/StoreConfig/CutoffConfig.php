 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Service.StoreConfig.CutoffConfig</code>
 */
class CutoffConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Service.StoreConfig.CutoffConfig.LocalCutoffTime local_cutoff_time = 1;</code>
     */
     ...
     *
     *     @type \Google\Shopping\Merchant\Accounts\V1\Service\StoreConfig\CutoffConfig\LocalCutoffTime $local_cutoff_time
     *           Time that local delivery ends for the day.
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Service.StoreConfig.CutoffConfig.LocalCutoffTime local_cutoff_time = 1;</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\Service\StoreConfig\CutoffConfig\LocalCutoffTime|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Service.StoreConfig.CutoffConfig.LocalCutoffTime local_cutoff_time = 1;</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\Service\StoreConfig\CutoffConfig\LocalCutoffTime $var
     * @return $this
     */
    public function setLocalCutoffTime($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\Service\StoreConfig\CutoffConfig\LocalCutoffTime::class);
...
class_alias(CutoffConfig::class, \Google\Shopping\Merchant\Accounts\V1\Service_StoreConfig_CutoffConfig::class);
