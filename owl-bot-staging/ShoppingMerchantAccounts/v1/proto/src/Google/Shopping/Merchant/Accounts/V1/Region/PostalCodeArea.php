 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Region.PostalCodeArea</code>
 */
class PostalCodeArea extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\Region\PostalCodeArea\PostalCodeRange::class);
...
class_alias(PostalCodeArea::class, \Google\Shopping\Merchant\Accounts\V1\Region_PostalCodeArea::class);
