 ...
 * identity.
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.BusinessIdentity.PromotionsConsent</code>
 */
...
class_alias(PromotionsConsent::class, \Google\Shopping\Merchant\Accounts\V1\BusinessIdentity_PromotionsConsent::class);
