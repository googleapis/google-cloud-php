...
namespace Google\Shopping\Merchant\Accounts\V1\Distance;
 ...
 * and kilometers.
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.Distance.Unit</code>
 */
class Unit
{
    /**
...
class_alias(Unit::class, \Google\Shopping\Merchant\Accounts\V1\Distance_Unit::class);
