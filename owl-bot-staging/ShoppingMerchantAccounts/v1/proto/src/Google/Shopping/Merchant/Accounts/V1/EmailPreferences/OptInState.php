...
namespace Google\Shopping\Merchant\Accounts\V1\EmailPreferences;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.EmailPreferences.OptInState</code>
 */
class OptInState
{
    /**
...
class_alias(OptInState::class, \Google\Shopping\Merchant\Accounts\V1\EmailPreferences_OptInState::class);
