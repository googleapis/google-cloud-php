 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Service.LoyaltyProgram</code>
 */
class LoyaltyProgram extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\Service\LoyaltyProgram\LoyaltyProgramTiers::class);
...
class_alias(LoyaltyProgram::class, \Google\Shopping\Merchant\Accounts\V1\Service_LoyaltyProgram::class);
