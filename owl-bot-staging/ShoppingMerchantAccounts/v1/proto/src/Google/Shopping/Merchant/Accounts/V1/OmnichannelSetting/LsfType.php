...
namespace Google\Shopping\Merchant\Accounts\V1\OmnichannelSetting;
 ...
 * details.
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.OmnichannelSetting.LsfType</code>
 */
class LsfType
{
    /**
...
class_alias(LsfType::class, \Google\Shopping\Merchant\Accounts\V1\OmnichannelSetting_LsfType::class);
