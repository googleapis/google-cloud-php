 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.DeliveryTime</code>
 */
class DeliveryTime extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CutoffTime cutoff_time = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.TransitTable transit_time_table = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.BusinessDayConfig handling_business_day_config = 7;</code>
     */
     ...
     * If not provided, Monday to Friday business days will be assumed.
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.BusinessDayConfig transit_business_day_config = 8;</code>
     */
     ...
     *           day delivery, 1 means next day delivery. Must be greater than or equal
     *           to `min_transit_days`.
     *     @type \Google\Shopping\Merchant\Accounts\V1\CutoffTime $cutoff_time
     *           Business days cutoff time definition.
     *           If not configured the cutoff time will be defaulted to 8AM PST.
     ...
     *           'min_handling_days' and 'max_handling_days' should be either set or not set
     *           at the same time.
     *     @type \Google\Shopping\Merchant\Accounts\V1\TransitTable $transit_time_table
     *           Transit time table, number of business days spent in transit based on row
     *           and column dimensions. Either `min_transit_days`, `max_transit_days` or
     *           `transit_time_table` can be set, but not both.
     *     @type \Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig $handling_business_day_config
     *           The business days during which orders can be handled.
     *           If not provided, Monday to Friday business days will be assumed.
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CutoffTime cutoff_time = 3;</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\CutoffTime|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CutoffTime cutoff_time = 3;</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\CutoffTime $var
     * @return $this
     */
    public function setCutoffTime($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\CutoffTime::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.TransitTable transit_time_table = 6;</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\TransitTable|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.TransitTable transit_time_table = 6;</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\TransitTable $var
     * @return $this
     */
    public function setTransitTimeTable($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\TransitTable::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.BusinessDayConfig handling_business_day_config = 7;</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.BusinessDayConfig handling_business_day_config = 7;</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig $var
     * @return $this
     */
    public function setHandlingBusinessDayConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\WarehouseBasedDeliveryTime::class);
