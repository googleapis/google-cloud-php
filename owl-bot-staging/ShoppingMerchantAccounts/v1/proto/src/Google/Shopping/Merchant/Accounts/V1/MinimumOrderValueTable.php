 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.MinimumOrderValueTable</code>
 */
class MinimumOrderValueTable extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\MinimumOrderValueTable\StoreCodeSetWithMov::class);
