 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.AutomaticItemUpdates</code>
 */
class AutomaticItemUpdates extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1.AutomaticItemUpdates.ItemUpdatesAccountLevelSettings account_item_updates_settings = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Shopping\Merchant\Accounts\V1\AutomaticItemUpdates\ItemUpdatesAccountLevelSettings $account_item_updates_settings
     *           Optional. Determines which attributes of the items should be automatically
     *           updated. If this field is not present and provided in the update mask, then
     *           the settings will be deleted. If there are no settings for subaccount, they
     *           are inherited from aggregator.
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1.AutomaticItemUpdates.ItemUpdatesAccountLevelSettings account_item_updates_settings = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\AutomaticItemUpdates\ItemUpdatesAccountLevelSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1.AutomaticItemUpdates.ItemUpdatesAccountLevelSettings account_item_updates_settings = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\AutomaticItemUpdates\ItemUpdatesAccountLevelSettings $var
     * @return $this
     */
    public function setAccountItemUpdatesSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\AutomaticItemUpdates\ItemUpdatesAccountLevelSettings::class);
