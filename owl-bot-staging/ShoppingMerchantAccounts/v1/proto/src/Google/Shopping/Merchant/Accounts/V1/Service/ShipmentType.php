 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.Service.ShipmentType</code>
 */
class ShipmentType
{
    /**
...
class_alias(ShipmentType::class, \Google\Shopping\Merchant\Accounts\V1\Service_ShipmentType::class);
