 ...
 * them.
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.EmailPreferences</code>
 */
class EmailPreferences extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1.EmailPreferences.OptInState news_and_tips = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1\EmailPreferences\OptInState::class);
