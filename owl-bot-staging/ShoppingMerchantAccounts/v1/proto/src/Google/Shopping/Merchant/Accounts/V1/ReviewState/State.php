...
namespace Google\Shopping\Merchant\Accounts\V1\ReviewState;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.ReviewState.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Shopping\Merchant\Accounts\V1\ReviewState_State::class);
