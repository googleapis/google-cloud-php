...
namespace Google\Shopping\Merchant\Accounts\V1\Program;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.Program.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Shopping\Merchant\Accounts\V1\Program_State::class);
