...
class RateGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *           expressive enough. Can only be set if `single_value` is not
     *           set.
     *     @type \Google\Shopping\Merchant\Accounts\V1\Table[] $subtables
     *           Optional. A list of subtables referred to by `main_table`. Can only
     *           be set if `main_table` is set.
     *     @type \Google\Shopping\Merchant\Accounts\V1\CarrierRate[] $carrier_rates
     *           Optional. A list of carrier rates that can be referred to by
     *           `main_table` or `single_value`.
     *     @type string $name
     *           Optional. Name of the rate group.
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1.Table subtables = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1\Table>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1.CarrierRate carrier_rates = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1\CarrierRate>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1.CarrierRate carrier_rates = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\CarrierRate[] $var
     * @return $this
     */
