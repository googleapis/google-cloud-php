...
class TransitTable extends \Google\Protobuf\Internal\Message
{
     ...
     *           `"all other labels"`. Example:
     *           `["food", "electronics", "all other labels"]`.
     *     @type \Google\Shopping\Merchant\Accounts\V1\TransitTable\TransitTimeRow[] $rows
     *           Required. If there's only one dimension set of `postal_code_group_names` or
     *           `transit_time_labels`, there are multiple rows each with one value
     *           for that dimension. If there are two dimensions, each row corresponds to a
     *           `postal_code_group_names`, and columns (values) to a
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRow rows = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Accounts\V1\TransitTable\TransitTimeRow>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRow rows = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\TransitTable\TransitTimeRow[] $var
     * @return $this
     */
