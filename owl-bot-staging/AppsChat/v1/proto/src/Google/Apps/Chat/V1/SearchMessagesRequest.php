 ...
 *
 * Generated from protobuf message <code>google.chat.v1.SearchMessagesRequest</code>
 */
class SearchMessagesRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.chat.v1.SearchMessagesRequest.SearchMessagesView view = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;

    /**
     * @param string $parent Required. The resource name of the space to search within.
     *
     *                       To search across all spaces the user has access to, set this field to
     *                       `spaces/-`. Using any other value for `parent` results in an
     *                       `INVALID_ARGUMENT` error.
     ...
     * @param string $filter Required. A search query.
     *
     *                       The query can specify one or more search keywords, which are used to filter
     *                       the results,
     *
     ...
     *                       error.
     *
     * @return \Google\Apps\Chat\V1\SearchMessagesRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Apps\Chat\V1\SearchMessagesRequest\SearchMessagesView::class);
        $this->view = $var;
