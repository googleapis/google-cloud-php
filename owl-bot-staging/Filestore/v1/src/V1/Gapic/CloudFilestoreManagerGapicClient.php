...
class CloudFilestoreManagerGapicClient
{
     ...
     * @throws ApiException if the remote call fails
     */
    public function createSnapshot($parent, $snapshotId, $snapshot, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function revertInstance($name, $targetSnapshotId, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateSnapshot($updateMask, $snapshot, array $optionalArgs = [])
    {
