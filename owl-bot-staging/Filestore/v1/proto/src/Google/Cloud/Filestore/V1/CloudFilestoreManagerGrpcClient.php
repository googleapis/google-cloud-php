...
class CloudFilestoreManagerGrpcClient extends \Grpc\BaseStub {
     ...
     * or for all locations.
     * @param \Google\Cloud\Filestore\V1\ListSnapshotsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListSnapshots(\Google\Cloud\Filestore\V1\ListSnapshotsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.filestore.v1.CloudFilestoreManager/ListSnapshots',
        $argument,
        ['\Google\Cloud\Filestore\V1\ListSnapshotsResponse', 'decode'],
        $metadata, $options);
    }

    /**
     * Gets the details of a specific snapshot.
     * @param \Google\Cloud\Filestore\V1\GetSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetSnapshot(\Google\Cloud\Filestore\V1\GetSnapshotRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.filestore.v1.CloudFilestoreManager/GetSnapshot',
        $argument,
        ['\Google\Cloud\Filestore\V1\Snapshot', 'decode'],
        $metadata, $options);
    }

    /**
     * Creates a snapshot.
     * @param \Google\Cloud\Filestore\V1\CreateSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function CreateSnapshot(\Google\Cloud\Filestore\V1\CreateSnapshotRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.filestore.v1.CloudFilestoreManager/CreateSnapshot',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
    ...
    /**
     * Deletes a snapshot.
     * @param \Google\Cloud\Filestore\V1\DeleteSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function DeleteSnapshot(\Google\Cloud\Filestore\V1\DeleteSnapshotRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.filestore.v1.CloudFilestoreManager/DeleteSnapshot',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Cloud\Filestore\V1\UpdateSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function UpdateSnapshot(\Google\Cloud\Filestore\V1\UpdateSnapshotRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.filestore.v1.CloudFilestoreManager/UpdateSnapshot',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
