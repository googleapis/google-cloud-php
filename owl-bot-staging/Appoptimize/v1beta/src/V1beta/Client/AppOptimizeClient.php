 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/appoptimize/v1beta/app_optimize.proto
 ...
 * @method PromiseInterface<void> deleteReportAsync(DeleteReportRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface<PagedListResponse> readReportAsync(ReadReportRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Location> getLocationAsync(GetLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listLocationsAsync(ListLocationsRequest $request, array $optionalArgs = [])
 */
final class AppOptimizeClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.appoptimize.v1beta.AppOptimize';
     ...
     */
    private const SERVICE_ADDRESS = 'appoptimize.googleapis.com';

    /** The address template of the service. */
    private const SERVICE_ADDRESS_TEMPLATE = 'appoptimize.UNIVERSE_DOMAIN';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/app_optimize_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/app_optimize_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/app_optimize_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/app_optimize_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @experimental
     */
    public static function reportName(string $project, string $location, string $report): string
    {
     ...
     *           as "<uri>:<port>". Default 'appoptimize.googleapis.com:443'.
     ...
     * via `ReadReport`.
     *
     * The async variant is {@see AppOptimizeClient::createReportAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/create_report.php
     *
     ...
     *
     * The async variant is {@see AppOptimizeClient::deleteReportAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/delete_report.php
     *
     ...
     * @experimental
     */
    public function deleteReport(DeleteReportRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteReport', $request, $callOptions)->wait();
    }

    /**
     * Retrieves the details of a report configuration.
     *
     * The async variant is {@see AppOptimizeClient::getReportAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/get_report.php
     *
     ...
     *
     * The async variant is {@see AppOptimizeClient::listReportsAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/list_reports.php
     *
     ...
     *
     * The async variant is {@see AppOptimizeClient::readReportAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/read_report.php
     *
     * @param ReadReportRequest $request     A request to house fields associated with the call.
     * @param array             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function readReport(ReadReportRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ReadReport', $request, $callOptions);
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see AppOptimizeClient::getLocationAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/get_location.php
     *
    ...
    * **Global locations**: If `name` is empty, the method lists the
     ...
     *
     * The async variant is {@see AppOptimizeClient::listLocationsAsync()} .
     *
     * @example samples/V1beta/AppOptimizeClient/list_locations.php
     *
