...
return [
    'interfaces' => [
        'google.cloud.appoptimize.v1beta.AppOptimize' => [
            'CreateReport' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*}/reports',
                'body' => 'report',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteReport' => [
                'method' => 'delete',
                'uriTemplate' => '/v1beta/{name=projects/*/locations/*/reports/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ReadReport' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{name=projects/*/locations/*/reports/*}:read',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
