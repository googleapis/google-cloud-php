...
class BreakRule extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Optimization\V1\BreakRule\BreakRequest[] $break_requests
     *           Sequence of breaks. See the `BreakRequest` message.
     *     @type \Google\Cloud\Optimization\V1\BreakRule\FrequencyConstraint[] $frequency_constraints
     *           Several `FrequencyConstraint` may apply. They must all be satisfied by
     *           the `BreakRequest`s of this `BreakRule`. See `FrequencyConstraint`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.optimization.v1.BreakRule.BreakRequest break_requests = 1;</code>
     * @return RepeatedField<\Google\Cloud\Optimization\V1\BreakRule\BreakRequest>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.optimization.v1.BreakRule.BreakRequest break_requests = 1;</code>
     * @param \Google\Cloud\Optimization\V1\BreakRule\BreakRequest[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.optimization.v1.BreakRule.FrequencyConstraint frequency_constraints = 2;</code>
     * @return RepeatedField<\Google\Cloud\Optimization\V1\BreakRule\FrequencyConstraint>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.optimization.v1.BreakRule.FrequencyConstraint frequency_constraints = 2;</code>
     * @param \Google\Cloud\Optimization\V1\BreakRule\FrequencyConstraint[] $var
     * @return $this
     */
