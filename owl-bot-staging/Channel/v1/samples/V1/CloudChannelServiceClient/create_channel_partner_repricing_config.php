 ...
 *
 * @param string $formattedParent                                            The resource name of the ChannelPartner that will receive the repricing
 ...
 * @param int    $channelPartnerRepricingConfigRepricingConfigRebillingBasis The [RebillingBasis][google.cloud.channel.v1.RebillingBasis] to use for this bill. Specifies the relative cost
