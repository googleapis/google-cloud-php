 ...
 *
 * @param string $parent         The resource name of the reseller's customer account that will receive
 *                               transferred entitlements.
 *                               Parent uses the format: accounts/{account_id}/customers/{customer_id}
 * @param string $formattedOffer The offer resource name for which the entitlement is to be
 ...
 */
function transfer_entitlements_sample(string $parent, string $formattedOffer): void
{
    // Create a client.
    ...
    $entitlement = (new Entitlement())
        ->setOffer($entitlementsOffer);
    $entitlements = [$entitlement,];

    // Call the API and handle any network failures.
    try {
        /** @var OperationResponse $response */
        $response = $cloudChannelServiceClient->transferEntitlements(
            $parent,
            $entitlements,
            $formattedOffer
        );
        ...
        if ($response->operationSucceeded()) {
            /** @var TransferEntitlementsResponse $response */
...
function callSample(): void
{
    ...
    transfer_entitlements_sample($parent, $formattedOffer);
}
