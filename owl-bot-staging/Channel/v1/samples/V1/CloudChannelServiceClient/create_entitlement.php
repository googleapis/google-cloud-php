 ...
 *
 * @param string $formattedParent The resource name of the reseller's customer account in which to create the
 *                                entitlement.
 ...
 */
function create_entitlement_sample(string $formattedParent, string $formattedOffer): void
{
    // Create a client.
    ...
    $entitlement = (new Entitlement())
        ->setOffer($entitlementOffer);

    // Call the API and handle any network failures.
    try {
        /** @var OperationResponse $response */
        $response = $cloudChannelServiceClient->createEntitlement(
            $formattedParent,
            $entitlement,
            $formattedOffer
        );
...
function callSample(): void
{
    ...
    create_entitlement_sample($formattedParent, $formattedOffer);
}
