...
class CloudChannelReportsServiceGapicClient
{
     ...
     * ```
     *
     * @param string $reportJob    Required. The report job created by [CloudChannelReportsService.RunReportJob][google.cloud.channel.v1.CloudChannelReportsService.RunReportJob].
     ...
     * ```
     *
     * @param string $parent       Required. The resource name of the partner account to list available reports for.
     ...
     * ```
     *
     * @param string $name         Required. The report's resource name. Specifies the account and report used to
