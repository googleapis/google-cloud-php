...
class_alias(BoostControlSpec::class, \Google\Cloud\Dialogflow\V2\SearchKnowledgeRequest_SearchConfig_BoostSpecs_BoostSpec_ConditionBoostSpec_BoostControlSpec::class);
