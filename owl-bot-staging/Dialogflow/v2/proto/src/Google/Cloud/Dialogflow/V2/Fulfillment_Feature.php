...
@trigger_error('Google\Cloud\Dialogflow\V2\Fulfillment_Feature is deprecated and will be removed in the next major release. Use Google\Cloud\Dialogflow\V2\Fulfillment\Feature instead', E_USER_DEPRECATED);
