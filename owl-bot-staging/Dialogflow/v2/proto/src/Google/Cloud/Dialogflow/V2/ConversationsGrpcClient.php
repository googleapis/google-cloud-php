...
class ConversationsGrpcClient extends \Grpc\BaseStub {
     ...
     * request.
     * @param \Google\Cloud\Dialogflow\V2\SuggestConversationSummaryRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SuggestConversationSummary(\Google\Cloud\Dialogflow\V2\SuggestConversationSummaryRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.dialogflow.v2.Conversations/SuggestConversationSummary',
        $argument,
        ['\Google\Cloud\Dialogflow\V2\SuggestConversationSummaryResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Cloud\Dialogflow\V2\GenerateStatelessSummaryRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GenerateStatelessSummary(\Google\Cloud\Dialogflow\V2\GenerateStatelessSummaryRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.dialogflow.v2.Conversations/GenerateStatelessSummary',
        $argument,
        ['\Google\Cloud\Dialogflow\V2\GenerateStatelessSummaryResponse', 'decode'],
        $metadata, $options);
    }
