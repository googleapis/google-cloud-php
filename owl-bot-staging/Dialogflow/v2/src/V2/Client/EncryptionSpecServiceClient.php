...
final class EncryptionSpecServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.v2.EncryptionSpecService';
     ...
     *           $options = new EncryptionSpecServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see EncryptionSpecServiceClient::getEncryptionSpecAsync()} .
     *
     * @example samples/V2/EncryptionSpecServiceClient/get_encryption_spec.php
     *
     ...
     *
     * The async variant is
     * {@see EncryptionSpecServiceClient::initializeEncryptionSpecAsync()} .
     *
     * @example samples/V2/EncryptionSpecServiceClient/initialize_encryption_spec.php
     *
     ...
     *
     * The async variant is {@see EncryptionSpecServiceClient::getLocationAsync()} .
     *
     * @example samples/V2/EncryptionSpecServiceClient/get_location.php
     *
     ...
     *
     * The async variant is {@see EncryptionSpecServiceClient::listLocationsAsync()} .
     *
     * @example samples/V2/EncryptionSpecServiceClient/list_locations.php
     *
