 ...
 */
abstract class FulfillmentsBaseClient
{
     ...
     *
     * The async variant is {@see self::getFulfillmentAsync()} .
     *
     ...
     */
    public function getFulfillment(GetFulfillmentRequest $request, array $callOptions = []): Fulfillment
    {
        return $this->startApiCall('GetFulfillment', $request, $callOptions)->wait();
    }

    /**
     * Updates the fulfillment.
     *
     * The async variant is {@see self::updateFulfillmentAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateFulfillment(UpdateFulfillmentRequest $request, array $callOptions = []): Fulfillment
    {
        return $this->startApiCall('UpdateFulfillment', $request, $callOptions)->wait();
    }
