...
final class ContextsClient
{
     ...
     *           $options = new ContextsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteAllContexts(DeleteAllContextsRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteAllContexts', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteContext(DeleteContextRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteContext', $request, $callOptions)->wait();
    }
