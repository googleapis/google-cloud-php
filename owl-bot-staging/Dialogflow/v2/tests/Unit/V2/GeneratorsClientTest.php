...
use Google\Cloud\Dialogflow\V2\GeneratorsClient;
...
class GeneratorsClientTest extends GeneratedTest
{
    ...
    public function createGeneratorTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2.Generators/CreateGenerator', $actualFuncCall);
    ...
    public function deleteGeneratorTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Generators/DeleteGenerator', $actualFuncCall);
    ...
    public function getGeneratorTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Generators/GetGenerator', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listGeneratorsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Generators/ListGenerators', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateGeneratorTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Generators/UpdateGenerator', $actualFuncCall);
        $actualValue = $actualRequestObject->getGenerator();
        $this->assertProtobufEquals($generator, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
