 ...
 * @group gapic
 */
class ConversationDatasetsClientTest extends GeneratedTest
{
    /**
    ...
    private function createClient(array $options = [])
    {
        ...
        return new ConversationDatasetsClient($options);
    }

    /**
     * @test
     */
    public function createConversationDatasetTest()
    {
        ...
        $incompleteOperation->setName('operations/createConversationDatasetTest');
        ...
        $completeOperation->setName('operations/createConversationDatasetTest');
        ...
        $response = $client->createConversationDataset($parent, $conversationDataset);
     ...
     * @test
     */
    public function createConversationDatasetExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
     ...
     * @test
     */
    public function deleteConversationDatasetTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteConversationDatasetTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteConversationDatasetTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $client->conversationDatasetName('[PROJECT]', '[LOCATION]', '[CONVERSATION_DATASET]');
        $response = $client->deleteConversationDataset($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
     ...
     * @test
     */
    public function deleteConversationDatasetExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
     ...
     * @test
     */
    public function getConversationDatasetTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $client->conversationDatasetName('[PROJECT]', '[LOCATION]', '[CONVERSATION_DATASET]');
        $response = $client->getConversationDataset($formattedName);
     ...
     * @test
     */
    public function getConversationDatasetExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $formattedName = $client->conversationDatasetName('[PROJECT]', '[LOCATION]', '[CONVERSATION_DATASET]');
        try {
            $client->getConversationDataset($formattedName);
     ...
     * @test
     */
    public function importConversationDataTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/importConversationDataTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $conversationDataset = 'conversationDataset1344013500';
        $importCount = 1721296907;
        $expectedResponse = new ImportConversationDataOperationResponse();
        $expectedResponse->setConversationDataset($conversationDataset);
        $expectedResponse->setImportCount($importCount);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/importConversationDataTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $response = $client->importConversationData($formattedName, $inputConfig);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
     ...
     * @test
     */
    public function importConversationDataExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'serviceAddress' => '',
     ...
     * @test
     */
    public function listConversationDatasetsTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $response = $client->listConversationDatasets($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getConversationDatasets()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
     ...
     * @test
     */
    public function listConversationDatasetsExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient([
            'transport' => $transport,
        ...
        $formattedParent = $client->locationName('[PROJECT]', '[LOCATION]');
        try {
            $client->listConversationDatasets($formattedParent);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
