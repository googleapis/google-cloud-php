 ...
 *
 * @method PromiseInterface<OperationResponse> synthesizeLongAudioAsync(SynthesizeLongAudioRequest $request, array $optionalArgs = [])
 */
final class TextToSpeechLongAudioSynthesizeClient
{
     ...
     *           $options = new TextToSpeechLongAudioSynthesizeClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<SynthesizeLongAudioResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function synthesizeLongAudio(SynthesizeLongAudioRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('SynthesizeLongAudio', $request, $callOptions)->wait();
    }
}
