...
namespace Google\Cloud\Trace\V2\Client;
 ...
 *
 * @method PromiseInterface<void> batchWriteSpansAsync(BatchWriteSpansRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Span> createSpanAsync(Span $request, array $optionalArgs = [])
 */
final class TraceServiceClient
{
     ...
     */
    public static function spanName(string $project, string $trace, string $span): string
    {
        return self::getPathTemplate('span')->render([
            'project' => $project,
            'trace' => $trace,
            'span' => $span,
        ]);
     ...
     *           $options = new TraceServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function batchWriteSpans(BatchWriteSpansRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('BatchWriteSpans', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createSpan(Span $request, array $callOptions = []): Span
    {
        return $this->startApiCall('CreateSpan', $request, $callOptions)->wait();
    }
}
