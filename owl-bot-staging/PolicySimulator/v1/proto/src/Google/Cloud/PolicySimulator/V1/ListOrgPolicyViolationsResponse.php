 ...
 *
 * Generated from protobuf message <code>google.cloud.policysimulator.v1.ListOrgPolicyViolationsResponse</code>
 */
class ListOrgPolicyViolationsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->org_policy_violations;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\PolicySimulator\V1\OrgPolicyViolation::class);
        $this->org_policy_violations = $arr;
