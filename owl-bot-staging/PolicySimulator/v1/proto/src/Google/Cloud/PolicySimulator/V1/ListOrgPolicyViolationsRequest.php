 ...
 *
 * Generated from protobuf message <code>google.cloud.policysimulator.v1.ListOrgPolicyViolationsRequest</code>
 */
class ListOrgPolicyViolationsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The OrgPolicyViolationsPreview to get OrgPolicyViolations from.
     *                       Format:
     *                       organizations/{organization}/locations/{location}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreview}
     *                       Please see {@see OrgPolicyViolationsPreviewServiceClient::orgPolicyViolationsPreviewName()} for help formatting this field.
     *
     * @return \Google\Cloud\PolicySimulator\V1\ListOrgPolicyViolationsRequest
     *
     * @experimental
     */
