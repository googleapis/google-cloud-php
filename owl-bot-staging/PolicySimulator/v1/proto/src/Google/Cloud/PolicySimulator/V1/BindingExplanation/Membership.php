 ...
 *
 * Protobuf type <code>google.cloud.policysimulator.v1.BindingExplanation.Membership</code>
 */
class Membership
{
    /**
...
class_alias(Membership::class, \Google\Cloud\PolicySimulator\V1\BindingExplanation_Membership::class);
