...
class OrgPolicyViolationsPreviewServiceClientTest extends GeneratedTest
{
    ...
    public function createOrgPolicyViolationsPreviewTest()
    {
        ...
        $this->assertSame('/google.cloud.policysimulator.v1.OrgPolicyViolationsPreviewService/CreateOrgPolicyViolationsPreview', $actualApiFuncCall);
    ...
    public function getOrgPolicyViolationsPreviewTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->orgPolicyViolationsPreviewName('[ORGANIZATION]', '[LOCATION]', '[ORG_POLICY_VIOLATIONS_PREVIEW]');
        ...
        $this->assertSame('/google.cloud.policysimulator.v1.OrgPolicyViolationsPreviewService/GetOrgPolicyViolationsPreview', $actualFuncCall);
    ...
    public function listOrgPolicyViolationsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->orgPolicyViolationsPreviewName('[ORGANIZATION]', '[LOCATION]', '[ORG_POLICY_VIOLATIONS_PREVIEW]');
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.policysimulator.v1.OrgPolicyViolationsPreviewService/ListOrgPolicyViolations', $actualFuncCall);
    ...
    public function listOrgPolicyViolationsPreviewsTest()
    {
        ...
        $orgPolicyViolationsPreviews = [
            $orgPolicyViolationsPreviewsElement,
        ];
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.policysimulator.v1.OrgPolicyViolationsPreviewService/ListOrgPolicyViolationsPreviews', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
