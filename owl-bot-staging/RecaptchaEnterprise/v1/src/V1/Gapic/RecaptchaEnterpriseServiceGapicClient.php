...
class RecaptchaEnterpriseServiceGapicClient
{
    ...
    private static function getFirewallPolicyNameTemplate()
    {
        if (self::$firewallPolicyNameTemplate == null) {
            self::$firewallPolicyNameTemplate = new PathTemplate('projects/{project}/firewallpolicies/{firewallpolicy}');
        }
    ...
    private static function getMetricsNameTemplate()
    {
        if (self::$metricsNameTemplate == null) {
            self::$metricsNameTemplate = new PathTemplate('projects/{project}/keys/{key}/metrics');
        }
     ...
     */
    public function addIpOverride($name, $ipOverrideData, array $optionalArgs = [])
    {
        ...
        return $this->startCall('AddIpOverride', AddIpOverrideResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createFirewallPolicy($parent, $firewallPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateFirewallPolicy', FirewallPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteFirewallPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteFirewallPolicy', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getFirewallPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetFirewallPolicy', FirewallPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getMetrics($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetMetrics', Metrics::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listFirewallPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListFirewallPolicies', $optionalArgs, ListFirewallPoliciesResponse::class, $request);
    }
    ...
    public function listIpOverrides($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListIpOverrides', $optionalArgs, ListIpOverridesResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function removeIpOverride($name, $ipOverrideData, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RemoveIpOverride', RemoveIpOverrideResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function reorderFirewallPolicies($parent, $names, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ReorderFirewallPolicies', ReorderFirewallPoliciesResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function retrieveLegacySecretKey($key, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RetrieveLegacySecretKey', RetrieveLegacySecretKeyResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchRelatedAccountGroupMemberships($project, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateFirewallPolicy($firewallPolicy, array $optionalArgs = [])
    {
        $request = new UpdateFirewallPolicyRequest();
        $requestParamHeaders = [];
        $request->setFirewallPolicy($firewallPolicy);
        $requestParamHeaders['firewall_policy.name'] = $firewallPolicy->getName();
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateFirewallPolicy', FirewallPolicy::class, $optionalArgs, $request)->wait();
    }
