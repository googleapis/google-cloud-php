 ...
 *
 * @param string $formattedProject The name of the project to search related account group memberships from.
 *                                 Specify the project name in the following format: "projects/{project}". Please see
