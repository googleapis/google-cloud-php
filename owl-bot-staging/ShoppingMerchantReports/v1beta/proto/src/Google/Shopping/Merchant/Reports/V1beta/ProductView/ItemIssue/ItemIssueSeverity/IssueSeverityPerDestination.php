...
class_alias(IssueSeverityPerDestination::class, \Google\Shopping\Merchant\Reports\V1beta\ProductView_ItemIssue_ItemIssueSeverity_IssueSeverityPerDestination::class);
