...
class_alias(AggregatedIssueSeverity::class, \Google\Shopping\Merchant\Reports\V1beta\ProductView_ItemIssue_ItemIssueSeverity_AggregatedIssueSeverity::class);
