 ...
 *
 * @param string $formattedName The name of the preview. Format:
 ...
 */
function get_preview_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $configClient->getPreview($request);
...
function callSample(): void
{
    ...
    get_preview_sample($formattedName);
}
