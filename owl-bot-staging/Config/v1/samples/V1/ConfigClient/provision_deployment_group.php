 ...
 * resources.
 *
 * @param string $formattedName The name of the deployment group to provision.
 *                              Format:
 ...
 */
function provision_deployment_group_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $configClient->provisionDeploymentGroup($request);
...
function callSample(): void
{
    ...
    provision_deployment_group_sample($formattedName);
}
