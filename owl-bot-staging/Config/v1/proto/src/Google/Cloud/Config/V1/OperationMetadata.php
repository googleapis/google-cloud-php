 ...
 *
 * Generated from protobuf message <code>google.cloud.config.v1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     * Output only. Metadata about the deployment operation state.
     *
     * Generated from protobuf field <code>.google.cloud.config.v1.DeploymentOperationMetadata deployment_metadata = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
