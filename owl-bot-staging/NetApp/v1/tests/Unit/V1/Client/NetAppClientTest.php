...
namespace Google\Cloud\NetApp\Tests\Unit\V1\Client;
...
use Google\Cloud\NetApp\V1\ListSnapshotsResponse;
 ...
 * @group gapic
 */
class NetAppClientTest extends GeneratedTest
{
    ...
    public function createBackupTest()
    {
        ...
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
        $expectedResponse->setVolumeUsageBytes($volumeUsageBytes);
    ...
    /** @test */
    public function createBackupPolicyTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/createBackupPolicyTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $dailyBackupLimit = 532629348;
        $weeklyBackupLimit = 2075144708;
        $monthlyBackupLimit = 1253809680;
        $description = 'description-1724546052';
        $enabled = false;
        $assignedVolumeCount = 396892795;
        $expectedResponse = new BackupPolicy();
        $expectedResponse->setName($name);
        $expectedResponse->setDailyBackupLimit($dailyBackupLimit);
        $expectedResponse->setWeeklyBackupLimit($weeklyBackupLimit);
        $expectedResponse->setMonthlyBackupLimit($monthlyBackupLimit);
        $expectedResponse->setDescription($description);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/createBackupPolicyTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    /** @test */
    public function createBackupPolicyExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function deleteBackupPolicyTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteBackupPolicyTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteBackupPolicyTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    /** @test */
    public function deleteBackupPolicyExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    public function deleteQuotaRuleTest()
    {
        ...
        $request = (new DeleteQuotaRuleRequest())
            ->setName($formattedName);
    ...
    public function executeOntapDeleteTest()
    {
        ...
        $request = (new ExecuteOntapDeleteRequest())
    ...
    public function executeOntapGetTest()
    {
        ...
        // Mock request
        $ontapPath = 'ontapPath-2095945184';
        $request = (new ExecuteOntapGetRequest())
            ->setOntapPath($ontapPath);
    ...
    public function executeOntapPostTest()
    {
        ...
        $body = new Struct();
        $ontapPath = 'ontapPath-2095945184';
        $request = (new ExecuteOntapPostRequest())
            ->setBody($body)
            ->setOntapPath($ontapPath);
    ...
    /** @test */
    public function getBackupPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getBackupPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function getHostGroupTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->hostGroupName('[PROJECT]', '[LOCATION]', '[HOST_GROUP]');
        $request = (new GetHostGroupRequest())
            ->setName($formattedName);
    ...
    /** @test */
    public function listBackupPoliciesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $backupPoliciesElement = new BackupPolicy();
        $backupPolicies = [
            $backupPoliciesElement,
        ];
        $expectedResponse = new ListBackupPoliciesResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getBackupPolicies()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listBackupPoliciesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function listHostGroupsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListHostGroupsRequest())
            ->setParent($formattedParent);
    ...
    public function updateBackupPolicyTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateBackupPolicyTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $dailyBackupLimit = 532629348;
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateBackupPolicyTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    /** @test */
    public function updateBackupPolicyExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function validateDirectoryServiceTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/validateDirectoryServiceTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new GPBEmpty();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/validateDirectoryServiceTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->storagePoolName('[PROJECT]', '[LOCATION]', '[STORAGE_POOL]');
        $request = (new ValidateDirectoryServiceRequest())
            ->setName($formattedName);
        $response = $gapicClient->validateDirectoryService($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.netapp.v1.NetApp/ValidateDirectoryService', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/validateDirectoryServiceTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function validateDirectoryServiceExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
