 ...
 *
 * @param string $formattedParent Parent value for ListQuotaRulesRequest
 *                                Please see {@see NetAppClient::volumeName()} for help formatting this field.
 */
function list_quota_rules_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $netAppClient->listQuotaRules($request);

        /** @var QuotaRule $element */
...
function callSample(): void
{
    ...
    list_quota_rules_sample($formattedParent);
}
