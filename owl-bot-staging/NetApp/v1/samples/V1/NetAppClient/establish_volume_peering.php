 ...
 *
 * @param string $formattedName   The volume resource name, in the format
 ...
 *                                destination volume.
 */
function establish_volume_peering_sample(
    ...
    try {
        ...
        $response = $netAppClient->establishVolumePeering($request);
...
function callSample(): void
{
    ...
    establish_volume_peering_sample($formattedName, $peerClusterName, $peerSvmName, $peerVolumeName);
}
