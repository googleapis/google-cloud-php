...
final class StorageBatchOperationsClient
{
     ...
     */
    public static function bucketOperationName(string $project, string $location, string $job, string $bucketOperation): string
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listBucketOperations(ListBucketOperationsRequest $request, array $callOptions = []): PagedListResponse
    {
