...
namespace Google\Cloud\StorageBatchOperations\Tests\Unit\V1\Client;
...
/**
 * @group storagebatchoperations
 *
 * @group gapic
 */
class StorageBatchOperationsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new StorageBatchOperationsClient($options);
    }
    ...
    public function cancelJobTest()
    {
        ...
        // Mock response
        $expectedResponse = new CancelJobResponse();
        ...
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/CancelJob', $actualFuncCall);
    ...
    public function createJobTest()
    {
        ...
        $incompleteOperation->setName('operations/createJobTest');
        ...
        $completeOperation->setName('operations/createJobTest');
        ...
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/CreateJob', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualApiRequestObject->getJobId();
        ...
        $expectedOperationsRequestObject->setName('operations/createJobTest');
    ...
    public function deleteJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/DeleteJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getBucketOperationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/GetBucketOperation', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getJobTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/GetJob', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBucketOperationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/ListBucketOperations', $actualFuncCall);
    ...
    public function listJobsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.storagebatchoperations.v1.StorageBatchOperations/ListJobs', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
