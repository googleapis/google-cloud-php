 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ListGeneratorsResponse</code>
 */
class ListGeneratorsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3\Generator::class);
        $this->generators = $arr;
