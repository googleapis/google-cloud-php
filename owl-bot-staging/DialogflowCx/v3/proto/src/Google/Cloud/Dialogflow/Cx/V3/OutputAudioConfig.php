 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.OutputAudioConfig</code>
 */
class OutputAudioConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3.OutputAudioEncoding audio_encoding = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * is applied.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3.SynthesizeSpeechConfig synthesize_speech_config = 3;</code>
     */
     ...
     *           rate, then the synthesizer will honor this request by converting to the
     *           desired sample rate (which might result in worse audio quality).
     *     @type \Google\Cloud\Dialogflow\Cx\V3\SynthesizeSpeechConfig $synthesize_speech_config
     *           Optional. Configuration of how speech should be synthesized.
     *           If not specified,
     *           [Agent.text_to_speech_settings][google.cloud.dialogflow.cx.v3.Agent.text_to_speech_settings]
     *           is applied.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3\OutputAudioEncoding::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3.SynthesizeSpeechConfig synthesize_speech_config = 3;</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3\SynthesizeSpeechConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3.SynthesizeSpeechConfig synthesize_speech_config = 3;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3\SynthesizeSpeechConfig $var
     * @return $this
     */
    public function setSynthesizeSpeechConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3\SynthesizeSpeechConfig::class);
