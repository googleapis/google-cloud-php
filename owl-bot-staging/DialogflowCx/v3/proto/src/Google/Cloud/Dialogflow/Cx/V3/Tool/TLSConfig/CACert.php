...
namespace Google\Cloud\Dialogflow\Cx\V3\Tool\TLSConfig;
 ...
 * The CA certificate.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.Tool.TLSConfig.CACert</code>
 */
...
class_alias(CACert::class, \Google\Cloud\Dialogflow\Cx\V3\Tool_TLSConfig_CACert::class);
