 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.IntentCoverage</code>
 */
class IntentCoverage extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3\IntentCoverage\Intent::class);
        $this->intents = $arr;
