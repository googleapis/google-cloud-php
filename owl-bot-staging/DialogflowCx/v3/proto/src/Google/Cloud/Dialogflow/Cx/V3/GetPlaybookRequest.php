 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.GetPlaybookRequest</code>
 */
class GetPlaybookRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the playbook.
     *                     Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\GetPlaybookRequest
     *
     * @experimental
     */
