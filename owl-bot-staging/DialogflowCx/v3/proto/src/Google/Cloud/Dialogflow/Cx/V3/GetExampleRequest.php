 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.GetExampleRequest</code>
 */
class GetExampleRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the example.
     *                     Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\GetExampleRequest
     *
     * @experimental
     */
