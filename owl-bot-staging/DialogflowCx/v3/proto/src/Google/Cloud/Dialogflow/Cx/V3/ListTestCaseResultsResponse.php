 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ListTestCaseResultsResponse</code>
 */
class ListTestCaseResultsResponse extends \Google\Protobuf\Internal\Message
{
    /**
