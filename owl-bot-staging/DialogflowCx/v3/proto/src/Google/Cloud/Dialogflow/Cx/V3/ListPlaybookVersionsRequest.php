 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ListPlaybookVersionsRequest</code>
 */
class ListPlaybookVersionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The playbook to list versions for.
     *                       Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\ListPlaybookVersionsRequest
     *
     * @experimental
     */
