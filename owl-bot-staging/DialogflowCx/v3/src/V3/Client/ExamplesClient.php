 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/cx/v3/example.proto
 ...
 */
final class ExamplesClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Examples';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/examples_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/examples_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/examples_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/examples_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\Dialogflow\Cx\V3\ExamplesClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ExamplesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ExamplesClient::createExampleAsync()} .
     *
     * @example samples/V3/ExamplesClient/create_example.php
     *
     ...
     *
     * @example samples/V3/ExamplesClient/delete_example.php
     *
     ...
     *
     * The async variant is {@see ExamplesClient::getExampleAsync()} .
     *
     * @example samples/V3/ExamplesClient/get_example.php
     *
     ...
     *
     * The async variant is {@see ExamplesClient::listExamplesAsync()} .
     *
     * @example samples/V3/ExamplesClient/list_examples.php
     *
     ...
     *
     * @example samples/V3/ExamplesClient/update_example.php
     *
     ...
     *
     * The async variant is {@see ExamplesClient::getLocationAsync()} .
     *
     * @example samples/V3/ExamplesClient/get_location.php
     *
     ...
     *
     * The async variant is {@see ExamplesClient::listLocationsAsync()} .
     *
     * @example samples/V3/ExamplesClient/list_locations.php
     *
