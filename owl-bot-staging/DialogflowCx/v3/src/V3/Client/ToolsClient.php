...
final class ToolsClient
{
     ...
     */
    public static function toolVersionName(string $project, string $location, string $agent, string $tool, string $version): string
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function restoreToolVersion(RestoreToolVersionRequest $request, array $callOptions = []): RestoreToolVersionResponse
    {
