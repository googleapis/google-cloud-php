 ...
 *
 * Protobuf type <code>google.cloud.memorystore.v1beta.PersistenceConfig.PersistenceMode</code>
 */
...
class_alias(PersistenceMode::class, \Google\Cloud\Memorystore\V1beta\PersistenceConfig_PersistenceMode::class);
