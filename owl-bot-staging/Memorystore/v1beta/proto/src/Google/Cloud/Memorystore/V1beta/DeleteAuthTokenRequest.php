 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.DeleteAuthTokenRequest</code>
 */
class DeleteAuthTokenRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the token auth user resource that this token will be
     *                     deleted from. Format:
     *                     projects/{project}/locations/{location}/instances/{instance}/tokenAuthUsers/{token_auth_user}/authTokens/{name}
     *                     Please see {@see MemorystoreClient::authTokenName()} for help formatting this field.
     *
     * @return \Google\Cloud\Memorystore\V1beta\DeleteAuthTokenRequest
     *
     * @experimental
     */
