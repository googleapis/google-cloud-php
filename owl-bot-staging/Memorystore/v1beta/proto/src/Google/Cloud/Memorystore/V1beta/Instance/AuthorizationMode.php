 ...
 *
 * Protobuf type <code>google.cloud.memorystore.v1beta.Instance.AuthorizationMode</code>
 */
...
class_alias(AuthorizationMode::class, \Google\Cloud\Memorystore\V1beta\Instance_AuthorizationMode::class);
