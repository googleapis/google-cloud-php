...
namespace Google\Cloud\Memorystore\V1beta\RescheduleMaintenanceRequest;
 ...
 * Reschedule options.
 *
 * Protobuf type <code>google.cloud.memorystore.v1beta.RescheduleMaintenanceRequest.RescheduleType</code>
 */
