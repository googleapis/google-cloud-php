 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.PersistenceConfig.RDBConfig</code>
 */
class RDBConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.PersistenceConfig.RDBConfig.SnapshotPeriod rdb_snapshot_period = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
...
class_alias(RDBConfig::class, \Google\Cloud\Memorystore\V1beta\PersistenceConfig_RDBConfig::class);
