 ...
 *
 * Protobuf type <code>google.cloud.memorystore.v1beta.Instance.NodeType</code>
 */
class NodeType
{
    /**
...
class_alias(NodeType::class, \Google\Cloud\Memorystore\V1beta\Instance_NodeType::class);
