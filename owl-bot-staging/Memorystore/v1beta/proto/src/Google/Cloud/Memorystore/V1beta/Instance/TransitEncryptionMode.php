 ...
 *
 * Protobuf type <code>google.cloud.memorystore.v1beta.Instance.TransitEncryptionMode</code>
 */
...
class_alias(TransitEncryptionMode::class, \Google\Cloud\Memorystore\V1beta\Instance_TransitEncryptionMode::class);
