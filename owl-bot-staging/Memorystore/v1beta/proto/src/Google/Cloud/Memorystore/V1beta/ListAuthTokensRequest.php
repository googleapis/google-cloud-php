 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.ListAuthTokensRequest</code>
 */
class ListAuthTokensRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent to list auth tokens from.
     *                       Format:
     *                       projects/{project}/locations/{location}/instances/{instance}/tokenAuthUsers/{token_auth_user}
     *                       Please see {@see MemorystoreClient::tokenAuthUserName()} for help formatting this field.
     *
     * @return \Google\Cloud\Memorystore\V1beta\ListAuthTokensRequest
     *
     * @experimental
     */
