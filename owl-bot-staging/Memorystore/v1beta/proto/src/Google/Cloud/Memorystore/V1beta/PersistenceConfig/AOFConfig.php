...
namespace Google\Cloud\Memorystore\V1beta\PersistenceConfig;
 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.PersistenceConfig.AOFConfig</code>
 */
class AOFConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.PersistenceConfig.AOFConfig.AppendFsync append_fsync = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
...
class_alias(AOFConfig::class, \Google\Cloud\Memorystore\V1beta\PersistenceConfig_AOFConfig::class);
