 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.FinishMigrationRequest</code>
 */
class FinishMigrationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                      call. Set this field to `true` to bypass this offset verification check.
     *
     * @return \Google\Cloud\Memorystore\V1beta\FinishMigrationRequest
     *
     * @experimental
     */
