 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.EncryptionInfo</code>
 */
class EncryptionInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.EncryptionInfo.Type encryption_type = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.EncryptionInfo.KmsKeyState kms_key_primary_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\EncryptionInfo\Type::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\EncryptionInfo\KmsKeyState::class);
