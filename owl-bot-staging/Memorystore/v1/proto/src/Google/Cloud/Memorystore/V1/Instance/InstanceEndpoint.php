...
class InstanceEndpoint extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Memorystore\V1\Instance\ConnectionDetail[] $connections
     *           Optional. A group of PSC connections. They are created in the same VPC
     *           network, one for each service attachment in the cluster.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.Instance.ConnectionDetail connections = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\Memorystore\V1\Instance\ConnectionDetail>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.Instance.ConnectionDetail connections = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Memorystore\V1\Instance\ConnectionDetail[] $var
     * @return $this
     */
