...
namespace Google\Cloud\Memorystore\V1\RescheduleMaintenanceRequest;
 ...
 * Reschedule options.
 *
 * Protobuf type <code>google.cloud.memorystore.v1.RescheduleMaintenanceRequest.RescheduleType</code>
 */
...
class_alias(RescheduleType::class, \Google\Cloud\Memorystore\V1\RescheduleMaintenanceRequest_RescheduleType::class);
