...
namespace Google\Cloud\Memorystore\V1\PersistenceConfig\AOFConfig;
 ...
 *
 * Protobuf type <code>google.cloud.memorystore.v1.PersistenceConfig.AOFConfig.AppendFsync</code>
 */
class AppendFsync
{
    /**
...
class_alias(AppendFsync::class, \Google\Cloud\Memorystore\V1\PersistenceConfig_AOFConfig_AppendFsync::class);
