 ...
 * @param string $formattedCertificateAuthority This can refer to a [CertificateAuthority][google.cloud.security.privateca.v1.CertificateAuthority] that was used to create a
...
function activate_certificate_authority_sample(
    ...
    string $formattedCertificateAuthority
): void {
    // Create a client.
...
function callSample(): void
{
    ...
    $formattedCertificateAuthority = CertificateAuthorityServiceClient::certificateAuthorityName(
        '[PROJECT]',
        '[LOCATION]',
        '[CA_POOL]',
        '[CERTIFICATE_AUTHORITY]'
