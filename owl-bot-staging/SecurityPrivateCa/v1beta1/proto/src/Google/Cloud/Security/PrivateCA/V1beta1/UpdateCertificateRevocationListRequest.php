 ...
 *
 * Generated from protobuf message <code>google.cloud.security.privateca.v1beta1.UpdateCertificateRevocationListRequest</code>
 */
class UpdateCertificateRevocationListRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $certificate_revocation_list = null;
    /**
     ...
     *
     *     @type \Google\Cloud\Security\PrivateCA\V1beta1\CertificateRevocationList $certificate_revocation_list
     *           Required. [CertificateRevocationList][google.cloud.security.privateca.v1beta1.CertificateRevocationList] with updated values.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.security.privateca.v1beta1.CertificateRevocationList certificate_revocation_list = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Security\PrivateCA\V1beta1\CertificateRevocationList $var
     * @return $this
     */
    public function setCertificateRevocationList($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Security\PrivateCA\V1beta1\CertificateRevocationList::class);
