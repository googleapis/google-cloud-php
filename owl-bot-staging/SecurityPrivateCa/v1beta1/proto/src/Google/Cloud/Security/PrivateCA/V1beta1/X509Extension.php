 ...
 *
 * Generated from protobuf message <code>google.cloud.security.privateca.v1beta1.X509Extension</code>
 */
class X509Extension extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Security\PrivateCA\V1beta1\ObjectId $object_id
     *           Required. The OID for this X.509 extension.
     *     @type bool $critical
     *           Required. Indicates whether or not this extension is critical (i.e., if the client
     *           does not know how to handle this extension, the client should consider this
     ...
     *
     * Generated from protobuf field <code>.google.cloud.security.privateca.v1beta1.ObjectId object_id = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Security\PrivateCA\V1beta1\ObjectId $var
     * @return $this
     */
    public function setObjectId($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Security\PrivateCA\V1beta1\ObjectId::class);
        $this->object_id = $var;
