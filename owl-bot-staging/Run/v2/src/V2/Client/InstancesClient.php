 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/run/v2/instance.proto
...
final class InstancesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.run.v2.Instances';
     ...
     *           use Google\Cloud\Run\V2\InstancesClient;
     ...
     * Creates an Instance.
     *
     * The async variant is {@see InstancesClient::createInstanceAsync()} .
     *
     * @example samples/V2/InstancesClient/create_instance.php
     *
     ...
     *
     * @example samples/V2/InstancesClient/delete_instance.php
     *
     ...
     *
     * @example samples/V2/InstancesClient/get_instance.php
     *
     ...
     *
     * @example samples/V2/InstancesClient/list_instances.php
     *
     ...
     * Starts an Instance.
     *
     * The async variant is {@see InstancesClient::startInstanceAsync()} .
     *
     * @example samples/V2/InstancesClient/start_instance.php
     *
     ...
     * Stops an Instance.
     *
     * The async variant is {@see InstancesClient::stopInstanceAsync()} .
     *
     * @example samples/V2/InstancesClient/stop_instance.php
     *
