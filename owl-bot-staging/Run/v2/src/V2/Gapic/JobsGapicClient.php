...
class JobsGapicClient
{
    ...
    private static function getExecutionNameTemplate()
    {
        if (self::$executionNameTemplate == null) {
            self::$executionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/jobs/{job}/executions/{execution}');
        }
    ...
    public function createJob($parent, $job, $jobId, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function runJob($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RunJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateJob($job, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
