...
class TasksGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__ . '/../resources/tasks_grpc_config.json',
            'credentialsConfig' => [
    ...
    private static function getTaskNameTemplate()
    {
        if (self::$taskNameTemplate == null) {
            self::$taskNameTemplate = new PathTemplate('projects/{project}/locations/{location}/jobs/{job}/executions/{execution}/tasks/{task}');
        }
     ...
     */
    public static function taskName($project, $location, $job, $execution, $task)
    {
