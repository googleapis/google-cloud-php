 ...
 *
 * Generated from protobuf message <code>google.cloud.run.v2.WorkerPool</code>
 */
class WorkerPool extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolRevisionTemplate template = 18 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     */
    private $instance_splits;
    /**
     * Optional. Specifies worker-pool-level scaling settings
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolScaling scaling = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     */
    private $instance_split_statuses;
    /**
     * Output only. Indicates whether Cloud Run Threat Detection monitoring is
     * enabled for the parent project of this worker pool.
     *
     * Generated from protobuf field <code>bool threat_detection_enabled = 28 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           provided, defaults to 100% instances assigned to the latest `Ready`
     *           Revision.
     *     @type \Google\Cloud\Run\V2\WorkerPoolScaling $scaling
     *           Optional. Specifies worker-pool-level scaling settings
     ...
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolRevisionTemplate template = 18 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Run\V2\WorkerPoolRevisionTemplate|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolRevisionTemplate template = 18 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Run\V2\WorkerPoolRevisionTemplate $var
     * @return $this
     */
    public function setTemplate($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Run\V2\WorkerPoolRevisionTemplate::class);
        $this->template = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Run\V2\InstanceSplit::class);
        $this->instance_splits = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolScaling scaling = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Run\V2\WorkerPoolScaling|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.run.v2.WorkerPoolScaling scaling = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Run\V2\WorkerPoolScaling $var
     * @return $this
     */
    public function setScaling($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Run\V2\WorkerPoolScaling::class);
        $this->scaling = $var;
    ...
    {
        return $this->instance_split_statuses;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Run\V2\InstanceSplitStatus::class);
        $this->instance_split_statuses = $arr;
