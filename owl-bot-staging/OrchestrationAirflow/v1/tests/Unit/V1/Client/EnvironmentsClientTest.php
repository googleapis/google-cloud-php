...
namespace Google\Cloud\Orchestration\Airflow\Service\Tests\Unit\V1\Client;
...
class EnvironmentsClientTest extends GeneratedTest
{
    ...
    public function checkUpgradeTest()
    {
        ...
        $this->assertSame('/google.cloud.orchestration.airflow.service.v1.Environments/CheckUpgrade', $actualApiFuncCall);
    ...
    public function createUserWorkloadsConfigMapTest()
    {
        ...
        $response = $gapicClient->createUserWorkloadsConfigMap($request);
    ...
    public function createUserWorkloadsConfigMapExceptionTest()
    {
        ...
        $request = (new CreateUserWorkloadsConfigMapRequest())
            ...
            ->setUserWorkloadsConfigMap($userWorkloadsConfigMap);
        try {
            $gapicClient->createUserWorkloadsConfigMap($request);
    ...
    public function createUserWorkloadsSecretTest()
    {
        ...
        $response = $gapicClient->createUserWorkloadsSecret($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createUserWorkloadsSecretExceptionTest()
    {
        ...
        $request = (new CreateUserWorkloadsSecretRequest())
            ...
            ->setUserWorkloadsSecret($userWorkloadsSecret);
        try {
            $gapicClient->createUserWorkloadsSecret($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function executeAirflowCommandTest()
    {
        ...
        $response = $gapicClient->executeAirflowCommand($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function executeAirflowCommandExceptionTest()
    {
        ...
        $request = new ExecuteAirflowCommandRequest();
        try {
            $gapicClient->executeAirflowCommand($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function pollAirflowCommandTest()
    {
        ...
        $response = $gapicClient->pollAirflowCommand($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function pollAirflowCommandExceptionTest()
    {
        ...
        $request = new PollAirflowCommandRequest();
        try {
            $gapicClient->pollAirflowCommand($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function stopAirflowCommandTest()
    {
        ...
        $response = $gapicClient->stopAirflowCommand($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function stopAirflowCommandExceptionTest()
    {
        ...
        $request = new StopAirflowCommandRequest();
        try {
            $gapicClient->stopAirflowCommand($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateUserWorkloadsConfigMapTest()
    {
        ...
        $response = $gapicClient->updateUserWorkloadsConfigMap($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateUserWorkloadsConfigMapExceptionTest()
    {
        ...
        $request = new UpdateUserWorkloadsConfigMapRequest();
        try {
            $gapicClient->updateUserWorkloadsConfigMap($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateUserWorkloadsSecretTest()
    {
        ...
        $response = $gapicClient->updateUserWorkloadsSecret($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateUserWorkloadsSecretExceptionTest()
    {
        ...
        $request = new UpdateUserWorkloadsSecretRequest();
        try {
            $gapicClient->updateUserWorkloadsSecret($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
