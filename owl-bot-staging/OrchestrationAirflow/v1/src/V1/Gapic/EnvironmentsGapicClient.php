...
class EnvironmentsGapicClient
{
    ...
    private static function getEnvironmentNameTemplate()
    {
        if (self::$environmentNameTemplate == null) {
            self::$environmentNameTemplate = new PathTemplate('projects/{project}/locations/{location}/environments/{environment}');
        }
    ...
    private static function getUserWorkloadsConfigMapNameTemplate()
    {
        if (self::$userWorkloadsConfigMapNameTemplate == null) {
            self::$userWorkloadsConfigMapNameTemplate = new PathTemplate('projects/{project}/locations/{location}/environments/{environment}/userWorkloadsConfigMaps/{user_workloads_config_map}');
        }
    ...
    private static function getUserWorkloadsSecretNameTemplate()
    {
        if (self::$userWorkloadsSecretNameTemplate == null) {
            self::$userWorkloadsSecretNameTemplate = new PathTemplate('projects/{project}/locations/{location}/environments/{environment}/userWorkloadsSecrets/{user_workloads_secret}');
        }
     ...
     */
    public static function userWorkloadsConfigMapName($project, $location, $environment, $userWorkloadsConfigMap)
    {
     ...
     */
    public static function userWorkloadsSecretName($project, $location, $environment, $userWorkloadsSecret)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createUserWorkloadsConfigMap($parent, $userWorkloadsConfigMap, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateUserWorkloadsConfigMap', UserWorkloadsConfigMap::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createUserWorkloadsSecret($parent, $userWorkloadsSecret, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateUserWorkloadsSecret', UserWorkloadsSecret::class, $optionalArgs, $request)->wait();
    }
    ...
    public function databaseFailover(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DatabaseFailover', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteUserWorkloadsConfigMap($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteUserWorkloadsConfigMap', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteUserWorkloadsSecret($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteUserWorkloadsSecret', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function executeAirflowCommand(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ExecuteAirflowCommand', ExecuteAirflowCommandResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function fetchDatabaseProperties($environment, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('FetchDatabaseProperties', FetchDatabasePropertiesResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getUserWorkloadsConfigMap($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetUserWorkloadsConfigMap', UserWorkloadsConfigMap::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getUserWorkloadsSecret($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetUserWorkloadsSecret', UserWorkloadsSecret::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listUserWorkloadsConfigMaps($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListUserWorkloadsConfigMaps', $optionalArgs, ListUserWorkloadsConfigMapsResponse::class, $request);
    }
    ...
    public function listUserWorkloadsSecrets($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListUserWorkloadsSecrets', $optionalArgs, ListUserWorkloadsSecretsResponse::class, $request);
    }
    ...
    public function loadSnapshot(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['skipPypiPackagesInstallation'])) {
            $request->setSkipPypiPackagesInstallation($optionalArgs['skipPypiPackagesInstallation']);
        }

        if (isset($optionalArgs['skipEnvironmentVariablesSetting'])) {
            $request->setSkipEnvironmentVariablesSetting($optionalArgs['skipEnvironmentVariablesSetting']);
        }

        if (isset($optionalArgs['skipAirflowOverridesSetting'])) {
            $request->setSkipAirflowOverridesSetting($optionalArgs['skipAirflowOverridesSetting']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('LoadSnapshot', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function pollAirflowCommand(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('PollAirflowCommand', PollAirflowCommandResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function saveSnapshot(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('SaveSnapshot', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function stopAirflowCommand(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('StopAirflowCommand', StopAirflowCommandResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateUserWorkloadsConfigMap(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['userWorkloadsConfigMap'])) {
            $request->setUserWorkloadsConfigMap($optionalArgs['userWorkloadsConfigMap']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateUserWorkloadsConfigMap', UserWorkloadsConfigMap::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateUserWorkloadsSecret(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['userWorkloadsSecret'])) {
            $request->setUserWorkloadsSecret($optionalArgs['userWorkloadsSecret']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateUserWorkloadsSecret', UserWorkloadsSecret::class, $optionalArgs, $request)->wait();
    }
}
