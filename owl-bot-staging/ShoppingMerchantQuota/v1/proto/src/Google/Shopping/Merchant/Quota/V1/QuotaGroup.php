 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.quota.v1.QuotaGroup</code>
 */
class QuotaGroup extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Quota\V1\MethodDetails::class);
