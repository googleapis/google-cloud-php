 ...
 *
 * Protobuf type <code>google.shopping.merchant.conversions.v1.AttributionSettings.AttributionModel</code>
 */
...
class_alias(AttributionModel::class, \Google\Shopping\Merchant\Conversions\V1\AttributionSettings_AttributionModel::class);
