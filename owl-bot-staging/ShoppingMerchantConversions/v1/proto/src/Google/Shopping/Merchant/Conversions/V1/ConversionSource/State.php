 ...
 *
 * Protobuf type <code>google.shopping.merchant.conversions.v1.ConversionSource.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Shopping\Merchant\Conversions\V1\ConversionSource_State::class);
