...
class ConversionSourcesServiceClientTest extends GeneratedTest
{
    ...
    public function createConversionSourceTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/CreateConversionSource', $actualFuncCall);
    ...
    public function deleteConversionSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/DeleteConversionSource', $actualFuncCall);
    ...
    public function getConversionSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/GetConversionSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listConversionSourcesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/ListConversionSources', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function undeleteConversionSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/UndeleteConversionSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateConversionSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.conversions.v1.ConversionSourcesService/UpdateConversionSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getConversionSource();
        $this->assertProtobufEquals($conversionSource, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
