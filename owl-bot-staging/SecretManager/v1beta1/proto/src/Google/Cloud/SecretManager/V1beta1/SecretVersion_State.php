...
@trigger_error('Google\Cloud\SecretManager\V1beta1\SecretVersion_State is deprecated and will be removed in the next major release. Use Google\Cloud\SecretManager\V1beta1\SecretVersion\State instead', E_USER_DEPRECATED);
