...
@trigger_error('Google\Cloud\SecretManager\V1beta1\Replication_UserManaged_Replica is deprecated and will be removed in the next major release. Use Google\Cloud\SecretManager\V1beta1\Replication\UserManaged\Replica instead', E_USER_DEPRECATED);
