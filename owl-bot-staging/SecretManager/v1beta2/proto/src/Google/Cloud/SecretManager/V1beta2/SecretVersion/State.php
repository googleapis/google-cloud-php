...
namespace Google\Cloud\SecretManager\V1beta2\SecretVersion;
 ...
 *
 * Protobuf type <code>google.cloud.secretmanager.v1beta2.SecretVersion.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\SecretManager\V1beta2\SecretVersion_State::class);
