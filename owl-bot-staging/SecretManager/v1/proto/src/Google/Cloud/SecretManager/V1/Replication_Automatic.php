...
@trigger_error('Google\Cloud\SecretManager\V1\Replication_Automatic is deprecated and will be removed in the next major release. Use Google\Cloud\SecretManager\V1\Replication\Automatic instead', E_USER_DEPRECATED);
