...
MarkRecommendationFailed<.google.cloud.recommender.v1.MarkRecommendationFailedRequest+.google.cloud.recommender.v1.Recommendation"˚Ç”‰ìŸ"M/v1/{name=projects/*/locations/*/recommenders/*/recommendations/*}:markFailed:*ZY"T/v1/{name=billingAccounts/*/locations/*/recommenders/*/recommendations/*}:markFailed:*ZQ"L/v1/{name=folders/*/locations/*/recommenders/*/recommendations/*}:markFailed:*ZW"R/v1/{name=organizations/*/locations/*/recommenders/*/recommendations/*}:markFailed:*⁄Aname,state_metadata,etagÃ
GetRecommenderConfig8.google.cloud.recommender.v1.GetRecommenderConfigRequest..google.cloud.recommender.v1.RecommenderConfig"…Ç”‰ìª7/v1/{name=projects/*/locations/*/recommenders/*/config}Z></v1/{name=organizations/*/locations/*/recommenders/*/config}Z@>/v1/{name=billingAccounts/*/locations/*/recommenders/*/config}⁄Aname·
UpdateRecommenderConfig;.google.cloud.recommender.v1.UpdateRecommenderConfigRequest..google.cloud.recommender.v1.RecommenderConfig"ÿÇ”‰ì∞2J/v1/{recommender_config.name=projects/*/locations/*/recommenders/*/config}:recommender_configZe2O/v1/{recommender_config.name=organizations/*/locations/*/recommenders/*/config}:recommender_configZg2Q/v1/{recommender_config.name=billingAccounts/*/locations/*/recommenders/*/config}:recommender_config⁄Arecommender_config,update_maskÃ
GetInsightTypeConfig8.google.cloud.recommender.v1.GetInsightTypeConfigRequest..google.cloud.recommender.v1.InsightTypeConfig"…Ç”‰ìª7/v1/{name=projects/*/locations/*/insightTypes/*/config}Z></v1/{name=organizations/*/locations/*/insightTypes/*/config}Z@>/v1/{name=billingAccounts/*/locations/*/insightTypes/*/config}⁄AnameË
UpdateInsightTypeConfig;.google.cloud.recommender.v1.UpdateInsightTypeConfigRequest..google.cloud.recommender.v1.InsightTypeConfig"ﬂÇ”‰ì∂2K/v1/{insight_type_config.name=projects/*/locations/*/insightTypes/*/config}:insight_type_configZg2P/v1/{insight_type_config.name=organizations/*/locations/*/insightTypes/*/config}:insight_type_configZi2R/v1/{insight_type_config.name=billingAccounts/*/locations/*/insightTypes/*/config}:insight_type_config⁄Ainsight_type_config,update_maskN Arecommender.googleapis.com“A.https://www.googleapis.com/auth/cloud-platformBù
