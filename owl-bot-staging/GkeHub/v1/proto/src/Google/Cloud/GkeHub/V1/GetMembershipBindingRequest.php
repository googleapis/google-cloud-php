 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1.GetMembershipBindingRequest</code>
 */
class GetMembershipBindingRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The MembershipBinding resource name in the format
     *                     `projects/&#42;/locations/&#42;/memberships/&#42;/bindings/*`. Please see
     *                     {@see GkeHubClient::membershipBindingName()} for help formatting this field.
     *
     * @return \Google\Cloud\GkeHub\V1\GetMembershipBindingRequest
     *
     * @experimental
     */
