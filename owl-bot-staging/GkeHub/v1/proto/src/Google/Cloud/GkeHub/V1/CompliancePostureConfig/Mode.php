...
/**
 * Protobuf type <code>google.cloud.gkehub.v1.CompliancePostureConfig.Mode</code>
 */
class Mode
{
    /**
...
class_alias(Mode::class, \Google\Cloud\GkeHub\V1\CompliancePostureConfig_Mode::class);
