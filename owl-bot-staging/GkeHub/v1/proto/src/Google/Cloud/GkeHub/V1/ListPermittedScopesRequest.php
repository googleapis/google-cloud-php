 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1.ListPermittedScopesRequest</code>
 */
class ListPermittedScopesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent (project and location) where the Scope will be listed.
     *                       Specified in the format `projects/&#42;/locations/*`. Please see
     *                       {@see GkeHubClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\GkeHub\V1\ListPermittedScopesRequest
     *
     * @experimental
     */
