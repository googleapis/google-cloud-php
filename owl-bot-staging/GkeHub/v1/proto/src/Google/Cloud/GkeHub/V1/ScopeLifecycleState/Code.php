...
namespace Google\Cloud\GkeHub\V1\ScopeLifecycleState;
 ...
 *
 * Protobuf type <code>google.cloud.gkehub.v1.ScopeLifecycleState.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\GkeHub\V1\ScopeLifecycleState_Code::class);
