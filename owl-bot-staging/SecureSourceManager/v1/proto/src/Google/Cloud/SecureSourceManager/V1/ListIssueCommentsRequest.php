 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.ListIssueCommentsRequest</code>
 */
class ListIssueCommentsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The issue in which to list the comments. Format:
     *                       `projects/{project_number}/locations/{location_id}/repositories/{repository_id}/issues/{issue_id}`
     *                       Please see {@see SecureSourceManagerClient::issueName()} for help formatting this field.
     *
     * @return \Google\Cloud\SecureSourceManager\V1\ListIssueCommentsRequest
     *
     * @experimental
     */
