 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.ListPullRequestsResponse</code>
 */
class ListPullRequestsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecureSourceManager\V1\PullRequest::class);
        $this->pull_requests = $arr;
