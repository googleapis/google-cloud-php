 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.GetIssueCommentRequest</code>
 */
class GetIssueCommentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the issue comment to retrieve.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\GetIssueCommentRequest
     *
     * @experimental
     */
