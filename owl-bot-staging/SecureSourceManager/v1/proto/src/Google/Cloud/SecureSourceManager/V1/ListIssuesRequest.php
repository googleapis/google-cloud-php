 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.ListIssuesRequest</code>
 */
class ListIssuesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The repository in which to list issues. Format:
     *                       `projects/{project_number}/locations/{location_id}/repositories/{repository_id}`
     *                       Please see {@see SecureSourceManagerClient::repositoryName()} for help formatting this field.
     *
     * @return \Google\Cloud\SecureSourceManager\V1\ListIssuesRequest
     *
     * @experimental
     */
