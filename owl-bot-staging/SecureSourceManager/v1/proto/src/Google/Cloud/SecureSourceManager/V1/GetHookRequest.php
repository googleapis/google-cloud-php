 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.GetHookRequest</code>
 */
class GetHookRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the hook to retrieve.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\GetHookRequest
     *
     * @experimental
     */
