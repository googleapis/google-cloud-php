 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.DeleteHookRequest</code>
 */
class DeleteHookRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the hook to delete.
     *                     The format is
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\DeleteHookRequest
     *
     * @experimental
     */
