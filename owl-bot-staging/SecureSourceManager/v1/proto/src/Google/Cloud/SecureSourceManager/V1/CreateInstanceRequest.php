 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.CreateInstanceRequest</code>
 */
class CreateInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securesourcemanager.v1.Instance instance = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\SecureSourceManager\V1\CreateInstanceRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\SecureSourceManager\V1\Instance $instance, string $instanceId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           Required. ID of the instance to be created.
     *     @type \Google\Cloud\SecureSourceManager\V1\Instance $instance
     *           Required. The resource being created.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securesourcemanager.v1.Instance instance = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\SecureSourceManager\V1\Instance|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecureSourceManager\V1\Instance::class);
        $this->instance = $var;
