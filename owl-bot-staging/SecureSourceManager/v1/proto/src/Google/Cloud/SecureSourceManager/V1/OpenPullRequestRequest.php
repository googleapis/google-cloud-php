 ...
 *
 * Generated from protobuf message <code>google.cloud.securesourcemanager.v1.OpenPullRequestRequest</code>
 */
class OpenPullRequestRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The pull request to open.
     *                     Format:
     *                     `projects/{project_number}/locations/{location_id}/repositories/{repository_id}/pullRequests/{pull_request_id}`
     *                     Please see {@see SecureSourceManagerClient::pullRequestName()} for help formatting this field.
     *
     * @return \Google\Cloud\SecureSourceManager\V1\OpenPullRequestRequest
     *
     * @experimental
     */
