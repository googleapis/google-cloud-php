...
// [START sqladmin_v1_generated_SqlFlagsService_List_sync]
use Google\ApiCore\ApiException;
use Google\Cloud\Sql\V1\Client\SqlFlagsServiceClient;
...
function list_sample(): void
{
    ...
    try {
        /** @var FlagsListResponse $response */
        $response = $sqlFlagsServiceClient->list($request);
