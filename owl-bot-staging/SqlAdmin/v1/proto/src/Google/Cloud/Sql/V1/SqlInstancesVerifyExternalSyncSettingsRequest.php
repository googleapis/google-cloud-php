 ...
 *
 * Generated from protobuf message <code>google.cloud.sql.v1.SqlInstancesVerifyExternalSyncSettingsRequest</code>
 */
class SqlInstancesVerifyExternalSyncSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * Optional. MySQL-specific settings for start external sync.
     *
     * Generated from protobuf field <code>.google.cloud.sql.v1.MySqlSyncConfig mysql_sync_config = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.ExternalSyncSelectedObject selected_objects = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\Sql\V1\ExternalSyncSelectedObject>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.ExternalSyncSelectedObject selected_objects = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Sql\V1\ExternalSyncSelectedObject[] $var
     * @return $this
     */
