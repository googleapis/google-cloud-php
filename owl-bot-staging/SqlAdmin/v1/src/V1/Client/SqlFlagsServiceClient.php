 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/sql/v1/cloud_sql_flags.proto
...
final class SqlFlagsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.sql.v1.SqlFlagsService';
     ...
     *           $options = new SqlFlagsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
