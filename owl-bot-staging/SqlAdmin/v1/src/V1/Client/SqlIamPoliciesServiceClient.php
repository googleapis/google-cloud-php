 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/sql/v1/cloud_sql_iam_policies.proto
...
/**
 * Service Description: Service for providing IAM Meta APIs for Cloud SQL.
 *
...
final class SqlIamPoliciesServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.sql.v1.SqlIamPoliciesService';
     ...
     *           use Google\Cloud\Sql\V1\SqlIamPoliciesServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SqlIamPoliciesServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
