 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/sql/v1/cloud_sql_regions.proto
...
/**
 * Service Description: Service that exposes Cloud SQL region information. This service is only used
 * internally and does not follow the same patterns as the other v1 RPCs.
 *
 * This class provides the ability to make remote calls to the backing service through method
 * calls that map to API methods.
 */
final class SqlRegionsServiceClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.sql.v1.SqlRegionsService';
     ...
     *           use Google\Cloud\Sql\V1\SqlRegionsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SqlRegionsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
