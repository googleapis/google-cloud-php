 ...
 *
 * Generated from protobuf message <code>google.apps.meet.v2.Recording</code>
 */
class Recording extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.Recording.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     *     @type \Google\Apps\Meet\V2\DriveDestination $drive_destination
     ...
     * download the file using the `files.get` method of the Drive API.
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.DriveDestination drive_destination = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Apps\Meet\V2\DriveDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.DriveDestination drive_destination = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Apps\Meet\V2\DriveDestination $var
     * @return $this
     */
    public function setDriveDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Apps\Meet\V2\DriveDestination::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Apps\Meet\V2\Recording\State::class);
        $this->state = $var;
