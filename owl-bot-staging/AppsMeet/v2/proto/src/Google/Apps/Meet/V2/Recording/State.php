...
namespace Google\Apps\Meet\V2\Recording;
 ...
 *
 * Protobuf type <code>google.apps.meet.v2.Recording.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Apps\Meet\V2\Recording_State::class);
