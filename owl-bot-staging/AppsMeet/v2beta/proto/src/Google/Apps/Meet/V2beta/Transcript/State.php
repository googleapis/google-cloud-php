...
namespace Google\Apps\Meet\V2beta\Transcript;
 ...
 *
 * Protobuf type <code>google.apps.meet.v2beta.Transcript.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Apps\Meet\V2beta\Transcript_State::class);
