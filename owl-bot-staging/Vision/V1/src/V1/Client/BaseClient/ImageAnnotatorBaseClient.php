 ...
 */
abstract class ImageAnnotatorBaseClient
{
     ...
     *
     * The async variant is {@see self::asyncBatchAnnotateFilesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::asyncBatchAnnotateImagesAsync()} .
     *
     ...
     * extracted.
     *
     * The async variant is {@see self::batchAnnotateFilesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::batchAnnotateImagesAsync()} .
     *
