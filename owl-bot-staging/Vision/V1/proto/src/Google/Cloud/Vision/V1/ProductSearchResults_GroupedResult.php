...
@trigger_error('Google\Cloud\Vision\V1\ProductSearchResults_GroupedResult is deprecated and will be removed in the next major release. Use Google\Cloud\Vision\V1\ProductSearchResults\GroupedResult instead', E_USER_DEPRECATED);
