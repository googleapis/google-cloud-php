...
@trigger_error('Google\Cloud\Vision\V1\WebDetection_WebLabel is deprecated and will be removed in the next major release. Use Google\Cloud\Vision\V1\WebDetection\WebLabel instead', E_USER_DEPRECATED);
