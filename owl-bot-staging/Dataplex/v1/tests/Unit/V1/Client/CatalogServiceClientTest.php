...
class CatalogServiceClientTest extends GeneratedTest
{
    ...
    public function createMetadataFeedTest()
    {
        ...
        $request = (new CreateMetadataFeedRequest())
            ->setParent($formattedParent)
    ...
    public function deleteEntryLinkTest()
    {
        ...
        $request = (new DeleteEntryLinkRequest())
            ->setName($formattedName);
    ...
    public function deleteMetadataFeedTest()
    {
        ...
        $request = (new DeleteMetadataFeedRequest())
            ->setName($formattedName);
    ...
    public function getEntryLinkTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->entryLinkName('[PROJECT]', '[LOCATION]', '[ENTRY_GROUP]', '[ENTRY_LINK]');
        $request = (new GetEntryLinkRequest())
            ->setName($formattedName);
    ...
    public function getMetadataFeedTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->metadataFeedName('[PROJECT]', '[LOCATION]', '[METADATA_FEED]');
        $request = (new GetMetadataFeedRequest())
            ->setName($formattedName);
    ...
    public function listMetadataFeedsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListMetadataFeedsRequest())
            ->setParent($formattedParent);
    ...
    public function lookupContextTest()
    {
        ...
        $name = 'name3373707';
        $formattedResources = [
            $gapicClient->entryName('[PROJECT]', '[LOCATION]', '[ENTRY_GROUP]', '[ENTRY]'),
        ];
    ...
    public function lookupEntryLinksTest()
    {
        ...
        $name = 'name3373707';
        $formattedEntry = $gapicClient->entryName('[PROJECT]', '[LOCATION]', '[ENTRY_GROUP]', '[ENTRY]');
        $request = (new LookupEntryLinksRequest())
            ->setName($name)
            ->setEntry($formattedEntry);
    ...
    public function updateEntryLinkTest()
    {
        ...
        $entryLinkEntryReferences = [];
        $entryLink->setEntryReferences($entryLinkEntryReferences);
        $request = (new UpdateEntryLinkRequest())
            ->setEntryLink($entryLink);
    ...
    public function updateMetadataFeedTest()
    {
        ...
        $metadataFeedScope = new Scope();
        $metadataFeed->setScope($metadataFeedScope);
        $request = (new UpdateMetadataFeedRequest())
            ->setMetadataFeed($metadataFeed);
