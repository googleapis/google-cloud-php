 ...
 */
function create_metadata_feed_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $catalogServiceClient->createMetadataFeed($request);
        $response->pollUntilComplete();

        if ($response->operationSucceeded()) {
            /** @var MetadataFeed $result */
...
function callSample(): void
{
    ...
    create_metadata_feed_sample($formattedParent);
}
