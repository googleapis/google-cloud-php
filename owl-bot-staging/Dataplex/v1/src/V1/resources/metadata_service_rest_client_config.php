...
return [
    'interfaces' => [
        'google.cloud.dataplex.v1.MetadataService' => [
            'CreateEntity' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/lakes/*/zones/*}/entities',
                'body' => 'entity',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreatePartition' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/lakes/*/zones/*/entities/*}/partitions',
                'body' => 'partition',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteEntity' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/lakes/*/zones/*/entities/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeletePartition' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/lakes/*/zones/*/entities/*/partitions/**}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateEntity' => [
                'method' => 'put',
                'uriTemplate' => '/v1/{entity.name=projects/*/locations/*/lakes/*/zones/*/entities/*}',
                'body' => 'entity',
                'placeholders' => [
                    'entity.name' => [
                        'getters' => [
        ...
        'google.iam.v1.IAMPolicy' => [
            'GetIamPolicy' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v1/{resource=projects/*/locations/*/dataProducts/*}:getIamPolicy',
                    ],
                    [
                        'method' => 'get',
