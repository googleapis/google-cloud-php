...
final class DataScanServiceClient
{
     ...
     *           $options = new DataScanServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function cancelDataScanJob(CancelDataScanJobRequest $request, array $callOptions = []): CancelDataScanJobResponse
    {
     ...
     * }
     *
     * @return OperationResponse<DataScan>
     *
     * @throws ApiException Thrown if the API call fails.
     */
