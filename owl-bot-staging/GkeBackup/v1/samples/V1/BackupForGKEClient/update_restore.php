 ...
 */
function update_restore_sample(string $formattedBackup): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $backupForGKEClient->updateRestore($restore, $formattedBackup);
...
function callSample(): void
{
    ...
    update_restore_sample($formattedBackup);
}
