 ...
 *
 * Generated from protobuf message <code>google.cloud.gkebackup.v1.ListRestoreChannelsRequest</code>
 */
class ListRestoreChannelsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The location that contains the RestoreChannels to list.
     *                       Format: `projects/&#42;/locations/*`
     *                       Please see {@see BackupForGKEClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\GkeBackup\V1\ListRestoreChannelsRequest
     *
     * @experimental
     */
