 ...
 * BackupPlan.
 *
 * Generated from protobuf message <code>google.cloud.gkebackup.v1.BackupPlanBinding.BackupPlanDetails.BackupConfigDetails</code>
 */
class BackupConfigDetails extends \Google\Protobuf\Internal\Message
{
     ...
     * Default: False
     *
     * Generated from protobuf field <code>bool include_volume_data = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * Default: False
     *
     * Generated from protobuf field <code>bool include_secrets = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.gkebackup.v1.EncryptionKey encryption_key = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * Output only. If True, include all namespaced resources
     *
     * Generated from protobuf field <code>bool all_namespaces = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return bool
     */
     ...
     * namespaces.
     *
     * Generated from protobuf field <code>.google.cloud.gkebackup.v1.Namespaces selected_namespaces = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * listed ProtectedApplications.
     *
     * Generated from protobuf field <code>.google.cloud.gkebackup.v1.NamespacedNames selected_applications = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
...
class_alias(BackupConfigDetails::class, \Google\Cloud\GkeBackup\V1\BackupPlanBinding_BackupPlanDetails_BackupConfigDetails::class);
