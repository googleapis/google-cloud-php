 ...
 *
 * Generated from protobuf message <code>google.cloud.gkebackup.v1.ListBackupPlanBindingsRequest</code>
 */
class ListBackupPlanBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The BackupChannel that contains the BackupPlanBindings to list.
     *                       Format: `projects/&#42;/locations/&#42;/backupChannels/*`
     *                       Please see {@see BackupForGKEClient::backupChannelName()} for help formatting this field.
     *
     * @return \Google\Cloud\GkeBackup\V1\ListBackupPlanBindingsRequest
     *
     * @experimental
     */
