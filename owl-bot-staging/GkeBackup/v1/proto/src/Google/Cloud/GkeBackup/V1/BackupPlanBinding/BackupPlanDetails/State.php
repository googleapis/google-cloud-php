 ...
 * State
 *
 * Protobuf type <code>google.cloud.gkebackup.v1.BackupPlanBinding.BackupPlanDetails.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\GkeBackup\V1\BackupPlanBinding_BackupPlanDetails_State::class);
