...
class ClientGatewaysServiceGapicClient
{
    ...
    private static function getClientGatewayNameTemplate()
    {
        if (self::$clientGatewayNameTemplate == null) {
            self::$clientGatewayNameTemplate = new PathTemplate('projects/{project}/locations/{location}/clientGateways/{client_gateway}');
        }
     ...
     */
    public static function clientGatewayName($project, $location, $clientGateway)
    {
     ...
     */
    public function createClientGateway($parent, $clientGateway, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateClientGateway', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteClientGateway($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteClientGateway', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getClientGateway($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetClientGateway', ClientGateway::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listClientGateways($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListClientGateways', $optionalArgs, ListClientGatewaysResponse::class, $request);
    }
