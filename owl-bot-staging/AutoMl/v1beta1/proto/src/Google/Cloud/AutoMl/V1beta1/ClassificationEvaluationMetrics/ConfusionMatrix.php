...
class ConfusionMatrix extends \Google\Protobuf\Internal\Message
{
     ...
     *           distinct values of the target column at the moment of the model
     *           evaluation are populated here.
     *     @type array<\Google\Cloud\AutoMl\V1beta1\ClassificationEvaluationMetrics\ConfusionMatrix\Row>|\Google\Protobuf\Internal\RepeatedField $row
     *           Output only. Rows in the confusion matrix. The number of rows is equal to
     *           the size of `annotation_spec_id`.
     *           `row[i].example_count[j]` is the number of examples that have ground
     *           truth of the `annotation_spec_id[i]` and are predicted as
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1beta1.ClassificationEvaluationMetrics.ConfusionMatrix.Row row = 2;</code>
     * @param array<\Google\Cloud\AutoMl\V1beta1\ClassificationEvaluationMetrics\ConfusionMatrix\Row>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
