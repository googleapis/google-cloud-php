...
use Google\Cloud\AutoMl\V1\BatchPredictInputConfig\SourceOneof;
use Google\Cloud\AutoMl\V1\BatchPredictOutputConfig;
use Google\Cloud\AutoMl\V1\BatchPredictOutputConfig\DestinationOneof;
...
class PredictionServiceClientTest extends GeneratedTest
{
    ...
    public function batchPredictTest()
    {
        ...
        $expectedResponse = new BatchPredictResult();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/batchPredictTest');
