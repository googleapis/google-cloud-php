...
use Google\Cloud\AutoMl\V1\OutputConfig\DestinationOneof;
...
class AutoMlClientTest extends GeneratedTest
{
    ...
    public function exportDataTest()
    {
        ...
        $destination = new DestinationOneof();
        $destination->setGcsDestination(new GcsDestination());
        $outputConfig->setGcsDestination($destination);
    ...
    public function exportModelTest()
    {
        ...
        $destination = new \Google\Cloud\AutoMl\V1\ModelExportOutputConfig\DestinationOneof();
        $destination->setGcsDestination(new GcsDestination());
        $outputConfig->setGcsDestination($destination);
    ...
    public function listModelEvaluationsTest()
    {
        ...
        $response = $client->listModelEvaluations($formattedParent, $filter);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
    ...
    public function listModelEvaluationsExceptionTest()
    {
        ...
        $filter = 'filter-1274492040';
        try {
            $client->listModelEvaluations($formattedParent, $filter);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
