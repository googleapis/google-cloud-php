...
class ClassificationEvaluationMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type float $log_loss
     *           Output only. The Log Loss metric.
     *     @type \Google\Cloud\AutoMl\V1\ClassificationEvaluationMetrics\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $confidence_metrics_entry
     *           Output only. Metrics for each confidence_threshold in
     *           0.00,0.05,0.10,...,0.95,0.96,0.97,0.98,0.99 and
     *           position_threshold = INT32_MAX_VALUE.
     *           ROC and precision-recall curves, and other aggregated metrics are derived
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1.ClassificationEvaluationMetrics.ConfidenceMetricsEntry confidence_metrics_entry = 3;</code>
     * @param \Google\Cloud\AutoMl\V1\ClassificationEvaluationMetrics\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
