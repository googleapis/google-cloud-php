 ...
 *     $pagedResponse = $autoscalersClient->aggregatedList();
...
class AutoscalersGapicClient
{
     ...
     * $autoscalersClient = new AutoscalersClient();
     * try {
     *     $operationResponse = $autoscalersClient->delete();
     ...
     * $autoscalersClient = new AutoscalersClient();
     * try {
     *     $operationResponse = $autoscalersClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $autoscalersClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $autoscalersClient = new AutoscalersClient();
     * try {
     *     $operationResponse = $autoscalersClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $autoscalersClient = new AutoscalersClient();
     * try {
     *     $operationResponse = $autoscalersClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
