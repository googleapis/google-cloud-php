 ...
 *     $pagedResponse = $nodeTemplatesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\NodeTemplatesClient}.
 */
class NodeTemplatesGapicClient
{
     ...
     * $nodeTemplatesClient = new NodeTemplatesClient();
     * try {
     *     $operationResponse = $nodeTemplatesClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['nodeTemplate'])) {
            $request->setNodeTemplate($optionalArgs['nodeTemplate']);
            $requestParamHeaders['node_template'] = $optionalArgs['nodeTemplate'];
        }
     ...
     * $nodeTemplatesClient = new NodeTemplatesClient();
     * try {
     *     $operationResponse = $nodeTemplatesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $nodeTemplatesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
