 ...
 *     $pagedResponse = $storagePoolTypesClient->aggregatedList($project);
 ...
 *     }
 * } finally {
 *     $storagePoolTypesClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\StoragePoolTypesClient}.
 */
class StoragePoolTypesGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.StoragePoolTypes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/storage_pool_types_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/storage_pool_types_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/storage_pool_types_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, StoragePoolTypeAggregatedList::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $storagePoolType, $zone, array $optionalArgs = [])
    {
        $request = new GetStoragePoolTypeRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setStoragePoolType($storagePoolType);
        $request->setZone($zone);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['storage_pool_type'] = $storagePoolType;
        $requestParamHeaders['zone'] = $zone;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', StoragePoolType::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $zone = 'zone';
     *     // Iterate over pages of elements
     *     $pagedResponse = $storagePoolTypesClient->list($project, $zone);
     *     foreach ($pagedResponse->iteratePages() as $page) {
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, StoragePoolTypeList::class, $request);
    }
}
