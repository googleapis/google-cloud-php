 ...
 * } finally {
 *     $interconnectRemoteLocationsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InterconnectRemoteLocationsClient}.
 */
class InterconnectRemoteLocationsGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectRemoteLocations';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/interconnect_remote_locations_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/interconnect_remote_locations_descriptor_config.php',
            'credentialsConfig' => [
     ...
     *     Optional.
     *
     *     @type string $interconnectRemoteLocation
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['interconnectRemoteLocation'])) {
            $request->setInterconnectRemoteLocation($optionalArgs['interconnectRemoteLocation']);
            $requestParamHeaders['interconnect_remote_location'] = $optionalArgs['interconnectRemoteLocation'];
        }
        ...
        return $this->startCall('Get', InterconnectRemoteLocation::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $pagedResponse = $interconnectRemoteLocationsClient->list();
    ...
    public function list(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, InterconnectRemoteLocationList::class, $request);
    }
}
