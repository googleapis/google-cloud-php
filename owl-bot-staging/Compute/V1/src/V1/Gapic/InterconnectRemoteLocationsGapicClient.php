...
class InterconnectRemoteLocationsGapicClient
{
     ...
     */
    public function get($interconnectRemoteLocation, $project, array $optionalArgs = [])
    {
        $request = new GetInterconnectRemoteLocationRequest();
        $requestParamHeaders = [];
        $request->setInterconnectRemoteLocation($interconnectRemoteLocation);
        $request->setProject($project);
        $requestParamHeaders['interconnect_remote_location'] = $interconnectRemoteLocation;
     ...
     *     $pagedResponse = $interconnectRemoteLocationsClient->list($project);
