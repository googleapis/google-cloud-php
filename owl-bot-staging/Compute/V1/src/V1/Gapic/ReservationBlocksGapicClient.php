 ...
 *     $zone = 'zone';
 *     $response = $reservationBlocksClient->get($project, $reservation, $reservationBlock, $zone);
 * } finally {
 *     $reservationBlocksClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\ReservationBlocksClient}.
 */
class ReservationBlocksGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.ReservationBlocks';
     ...
     */
    public function get($project, $reservation, $reservationBlock, $zone, array $optionalArgs = [])
    {
        $request = new GetReservationBlockRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setReservation($reservation);
        $request->setReservationBlock($reservationBlock);
     ...
     *     $pagedResponse = $reservationBlocksClient->list($project, $reservation, $zone);
     ...
     * @throws ApiException if the remote call fails
     */
    public function list($project, $reservation, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, ReservationBlocksListResponse::class, $request);
    }
     ...
     *     $zone = 'zone';
     *     $operationResponse = $reservationBlocksClient->performMaintenance($project, $reservation, $reservationBlock, $reservationsBlocksPerformMaintenanceRequestResource, $zone);
     ...
     *     // ... do other work
     *     $newOperationResponse = $reservationBlocksClient->resumeOperation($operationName, 'performMaintenance');
     ...
     * @param string                                      $reservation                                         The name of the reservation. Name should conform to RFC1035 or be a resource ID.
     * @param string                                      $reservationBlock                                    The name of the reservation block. Name should conform to RFC1035 or be a resource ID.
     * @param ReservationsBlocksPerformMaintenanceRequest $reservationsBlocksPerformMaintenanceRequestResource The body resource for this request
     * @param string                                      $zone                                                Name of the zone for this request. Zone name should conform to RFC1035.
     * @param array                                       $optionalArgs                                        {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function performMaintenance($project, $reservation, $reservationBlock, $reservationsBlocksPerformMaintenanceRequestResource, $zone, array $optionalArgs = [])
    {
        ...
        $request->setReservation($reservation);
        $request->setReservationBlock($reservationBlock);
        $request->setReservationsBlocksPerformMaintenanceRequestResource($reservationsBlocksPerformMaintenanceRequestResource);
        $request->setZone($zone);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['reservation'] = $reservation;
        $requestParamHeaders['reservation_block'] = $reservationBlock;
