 ...
 *     $pagedResponse = $targetHttpsProxiesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\TargetHttpsProxiesClient}.
 */
class TargetHttpsProxiesGapicClient
{
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetHttpsProxy'])) {
            $request->setTargetHttpsProxy($optionalArgs['targetHttpsProxy']);
            $requestParamHeaders['target_https_proxy'] = $optionalArgs['targetHttpsProxy'];
        }
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     @type string $requestId
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type TargetHttpsProxy $targetHttpsProxyResource
    ...
    public function insert(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetHttpsProxyResource'])) {
            $request->setTargetHttpsProxyResource($optionalArgs['targetHttpsProxyResource']);
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $targetHttpsProxiesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->setCertificateMap();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     @type string $requestId
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type TargetHttpsProxiesSetCertificateMapRequest $targetHttpsProxiesSetCertificateMapRequestResource
     *           The body resource for this request
     *     @type string $targetHttpsProxy
    ...
    public function setCertificateMap(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetHttpsProxiesSetCertificateMapRequestResource'])) {
            $request->setTargetHttpsProxiesSetCertificateMapRequestResource($optionalArgs['targetHttpsProxiesSetCertificateMapRequestResource']);
        }
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->setQuicOverride();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     @type string $requestId
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type TargetHttpsProxiesSetQuicOverrideRequest $targetHttpsProxiesSetQuicOverrideRequestResource
     *           The body resource for this request
     *     @type string $targetHttpsProxy
     ...
     * @throws ApiException if the remote call fails
     */
    public function setQuicOverride(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetHttpsProxiesSetQuicOverrideRequestResource'])) {
            $request->setTargetHttpsProxiesSetQuicOverrideRequestResource($optionalArgs['targetHttpsProxiesSetQuicOverrideRequestResource']);
        }
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->setSslCertificates();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     @type string $requestId
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type TargetHttpsProxiesSetSslCertificatesRequest $targetHttpsProxiesSetSslCertificatesRequestResource
     *           The body resource for this request
     *     @type string $targetHttpsProxy
    ...
    public function setSslCertificates(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetHttpsProxiesSetSslCertificatesRequestResource'])) {
            $request->setTargetHttpsProxiesSetSslCertificatesRequestResource($optionalArgs['targetHttpsProxiesSetSslCertificatesRequestResource']);
        }
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->setSslPolicy();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $targetHttpsProxiesClient = new TargetHttpsProxiesClient();
     * try {
     *     $operationResponse = $targetHttpsProxiesClient->setUrlMap();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
