 ...
 *     $pagedResponse = $reservationsClient->aggregatedList();
...
class ReservationsGapicClient
{
     ...
     * $reservationsClient = new ReservationsClient();
     * try {
     *     $operationResponse = $reservationsClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['reservation'])) {
            ...
            $requestParamHeaders['reservation'] = $optionalArgs['reservation'];
        }
     ...
     * $reservationsClient = new ReservationsClient();
     * try {
     *     $operationResponse = $reservationsClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $reservationsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $reservationsClient = new ReservationsClient();
     * try {
     *     $operationResponse = $reservationsClient->resize();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $reservationsClient = new ReservationsClient();
     * try {
     *     $operationResponse = $reservationsClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
