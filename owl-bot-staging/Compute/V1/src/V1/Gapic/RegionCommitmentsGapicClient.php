 ...
 *     $pagedResponse = $regionCommitmentsClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\RegionCommitmentsClient}.
 */
class RegionCommitmentsGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['commitment'])) {
            ...
            $requestParamHeaders['commitment'] = $optionalArgs['commitment'];
        }
     ...
     * $regionCommitmentsClient = new RegionCommitmentsClient();
     * try {
     *     $operationResponse = $regionCommitmentsClient->insert();
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $regionCommitmentsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $regionCommitmentsClient = new RegionCommitmentsClient();
     * try {
     *     $operationResponse = $regionCommitmentsClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
