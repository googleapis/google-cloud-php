 ...
 *     $pagedResponse = $urlMapsClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\UrlMapsClient}.
 */
class UrlMapsGapicClient
{
     ...
     * $urlMapsClient = new UrlMapsClient();
     * try {
     *     $operationResponse = $urlMapsClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['urlMap'])) {
            ...
            $requestParamHeaders['url_map'] = $optionalArgs['urlMap'];
        }
     ...
     * $urlMapsClient = new UrlMapsClient();
     * try {
     *     $operationResponse = $urlMapsClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $urlMapsClient = new UrlMapsClient();
     * try {
     *     $operationResponse = $urlMapsClient->invalidateCache();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $urlMapsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $urlMapsClient = new UrlMapsClient();
     * try {
     *     $operationResponse = $urlMapsClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $urlMapsClient = new UrlMapsClient();
     * try {
     *     $operationResponse = $urlMapsClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
