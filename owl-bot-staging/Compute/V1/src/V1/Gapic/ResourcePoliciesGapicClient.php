 ...
 *     $pagedResponse = $resourcePoliciesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\ResourcePoliciesClient}.
 */
class ResourcePoliciesGapicClient
{
     ...
     * $resourcePoliciesClient = new ResourcePoliciesClient();
     * try {
     *     $operationResponse = $resourcePoliciesClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['resourcePolicy'])) {
            ...
            $requestParamHeaders['resource_policy'] = $optionalArgs['resourcePolicy'];
        }
     ...
     * $resourcePoliciesClient = new ResourcePoliciesClient();
     * try {
     *     $operationResponse = $resourcePoliciesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $resourcePoliciesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $resourcePoliciesClient = new ResourcePoliciesClient();
     * try {
     *     $operationResponse = $resourcePoliciesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
