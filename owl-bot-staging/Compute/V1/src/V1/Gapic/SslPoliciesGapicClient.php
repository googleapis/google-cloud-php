 ...
 *     $pagedResponse = $sslPoliciesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\SslPoliciesClient}.
 */
class SslPoliciesGapicClient
{
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, SslPoliciesAggregatedList::class, $request);
    }
     ...
     * $sslPoliciesClient = new SslPoliciesClient();
     * try {
     *     $operationResponse = $sslPoliciesClient->delete();
     ...
     *     // ... do other work
     *     $newOperationResponse = $sslPoliciesClient->resumeOperation($operationName, 'delete');
     ...
     * $sslPoliciesClient = new SslPoliciesClient();
     * try {
     *     $operationResponse = $sslPoliciesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $sslPoliciesClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $sslPoliciesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $sslPoliciesClient = new SslPoliciesClient();
     * try {
     *     $operationResponse = $sslPoliciesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $sslPoliciesClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
