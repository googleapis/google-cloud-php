 ...
 *     $pagedResponse = $interconnectAttachmentsClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InterconnectAttachmentsClient}.
 */
class InterconnectAttachmentsGapicClient
{
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $operationResponse = $interconnectAttachmentsClient->delete();
     ...
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentsClient->resumeOperation($operationName, 'delete');
     ...
     *     Optional.
     *
     *     @type string $interconnectAttachment
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['interconnectAttachment'])) {
            $request->setInterconnectAttachment($optionalArgs['interconnectAttachment']);
            $requestParamHeaders['interconnect_attachment'] = $optionalArgs['interconnectAttachment'];
        }
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $operationResponse = $interconnectAttachmentsClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $interconnectAttachmentsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $operationResponse = $interconnectAttachmentsClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * $interconnectAttachmentsClient = new InterconnectAttachmentsClient();
     * try {
     *     $operationResponse = $interconnectAttachmentsClient->setLabels();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentsClient->resumeOperation($operationName, 'setLabels');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
