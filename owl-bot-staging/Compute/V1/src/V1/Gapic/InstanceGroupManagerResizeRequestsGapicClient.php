 ...
 *     $zone = 'zone';
 *     $operationResponse = $instanceGroupManagerResizeRequestsClient->cancel($instanceGroupManager, $project, $resizeRequest, $zone);
 ...
 *     // ... do other work
 *     $newOperationResponse = $instanceGroupManagerResizeRequestsClient->resumeOperation($operationName, 'cancel');
 ...
 *     }
 * } finally {
 *     $instanceGroupManagerResizeRequestsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InstanceGroupManagerResizeRequestsClient}.
 */
class InstanceGroupManagerResizeRequestsGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.InstanceGroupManagerResizeRequests';
    ...
    public function cancel($instanceGroupManager, $project, $resizeRequest, $zone, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('Cancel', $optionalArgs, $request, $this->getOperationsClient(), null, Operation::class)->wait();
    }
     ...
     *     $resizeRequest = 'resize_request';
     *     $zone = 'zone';
     *     $operationResponse = $instanceGroupManagerResizeRequestsClient->delete($instanceGroupManager, $project, $resizeRequest, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $instanceGroupManagerResizeRequestsClient->resumeOperation($operationName, 'delete');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($instanceGroupManager, $project, $resizeRequest, $zone, array $optionalArgs = [])
    {
     ...
     *     $resizeRequest = 'resize_request';
     *     $zone = 'zone';
     *     $response = $instanceGroupManagerResizeRequestsClient->get($instanceGroupManager, $project, $resizeRequest, $zone);
     * } finally {
     *     $instanceGroupManagerResizeRequestsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($instanceGroupManager, $project, $resizeRequest, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', InstanceGroupManagerResizeRequest::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $zone = 'zone';
     *     $operationResponse = $instanceGroupManagerResizeRequestsClient->insert($instanceGroupManager, $instanceGroupManagerResizeRequestResource, $project, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $instanceGroupManagerResizeRequestsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param InstanceGroupManagerResizeRequest $instanceGroupManagerResizeRequestResource The body resource for this request
     * @param string                            $project                                   Project ID for this request.
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($instanceGroupManager, $instanceGroupManagerResizeRequestResource, $project, $zone, array $optionalArgs = [])
    {
        $request = new InsertInstanceGroupManagerResizeRequestRequest();
        $requestParamHeaders = [];
        $request->setInstanceGroupManager($instanceGroupManager);
        $request->setInstanceGroupManagerResizeRequestResource($instanceGroupManagerResizeRequestResource);
        $request->setProject($project);
        $request->setZone($zone);
        $requestParamHeaders['instance_group_manager'] = $instanceGroupManager;
        $requestParamHeaders['project'] = $project;
     ...
     *     $pagedResponse = $instanceGroupManagerResizeRequestsClient->list($instanceGroupManager, $project, $zone);
     ...
     * @throws ApiException if the remote call fails
     */
    public function list($instanceGroupManager, $project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, InstanceGroupManagerResizeRequestsListResponse::class, $request);
    }
}
