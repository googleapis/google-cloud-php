 ...
 *     $pagedResponse = $subnetworksClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\SubnetworksClient}.
 */
class SubnetworksGapicClient
{
     ...
     * $subnetworksClient = new SubnetworksClient();
     * try {
     *     $operationResponse = $subnetworksClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['subnetwork'])) {
            ...
            $requestParamHeaders['subnetwork'] = $optionalArgs['subnetwork'];
        }
     ...
     * $subnetworksClient = new SubnetworksClient();
     * try {
     *     $operationResponse = $subnetworksClient->expandIpCidrRange();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $subnetworksClient = new SubnetworksClient();
     * try {
     *     $operationResponse = $subnetworksClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $subnetworksClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $subnetworksClient->listUsable();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * $subnetworksClient = new SubnetworksClient();
     * try {
     *     $operationResponse = $subnetworksClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $subnetworksClient = new SubnetworksClient();
     * try {
     *     $operationResponse = $subnetworksClient->setPrivateIpGoogleAccess();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
