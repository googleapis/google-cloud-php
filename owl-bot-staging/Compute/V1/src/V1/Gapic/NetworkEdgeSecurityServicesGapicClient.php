 ...
 *     $pagedResponse = $networkEdgeSecurityServicesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\NetworkEdgeSecurityServicesClient}.
 */
class NetworkEdgeSecurityServicesGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.compute.v1.NetworkEdgeSecurityServices';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/network_edge_security_services_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/network_edge_security_services_descriptor_config.php',
            'credentialsConfig' => [
    ...
    public function aggregatedList(array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, NetworkEdgeSecurityServiceAggregatedList::class, $request);
    }
     ...
     * $networkEdgeSecurityServicesClient = new NetworkEdgeSecurityServicesClient();
     * try {
     *     $operationResponse = $networkEdgeSecurityServicesClient->delete();
     ...
     *     Optional.
     *
     *     @type string $networkEdgeSecurityService
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['networkEdgeSecurityService'])) {
            $request->setNetworkEdgeSecurityService($optionalArgs['networkEdgeSecurityService']);
            $requestParamHeaders['network_edge_security_service'] = $optionalArgs['networkEdgeSecurityService'];
        }
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', NetworkEdgeSecurityService::class, $optionalArgs, $request)->wait();
    }
     ...
     * $networkEdgeSecurityServicesClient = new NetworkEdgeSecurityServicesClient();
     * try {
     *     $operationResponse = $networkEdgeSecurityServicesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     Optional.
     *
     *     @type NetworkEdgeSecurityService $networkEdgeSecurityServiceResource
    ...
    public function insert(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['networkEdgeSecurityServiceResource'])) {
            $request->setNetworkEdgeSecurityServiceResource($optionalArgs['networkEdgeSecurityServiceResource']);
        }
     ...
     * $networkEdgeSecurityServicesClient = new NetworkEdgeSecurityServicesClient();
     * try {
     *     $operationResponse = $networkEdgeSecurityServicesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
