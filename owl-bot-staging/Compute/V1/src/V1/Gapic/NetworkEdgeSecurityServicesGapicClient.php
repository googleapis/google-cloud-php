...
class NetworkEdgeSecurityServicesGapicClient
{
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($networkEdgeSecurityService, $project, $region, array $optionalArgs = [])
    {
        $request = new DeleteNetworkEdgeSecurityServiceRequest();
        $requestParamHeaders = [];
        $request->setNetworkEdgeSecurityService($networkEdgeSecurityService);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['network_edge_security_service'] = $networkEdgeSecurityService;
        $requestParamHeaders['project'] = $project;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($networkEdgeSecurityService, $project, $region, array $optionalArgs = [])
    {
     ...
     * ```
     *
     * @param NetworkEdgeSecurityService $networkEdgeSecurityServiceResource The body resource for this request
     * @param string                     $project                            Project ID for this request.
     * @param string                     $region                             Name of the region scoping this request.
     * @param array                      $optionalArgs                       {
     *     Optional.
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($networkEdgeSecurityServiceResource, $project, $region, array $optionalArgs = [])
    {
        $request = new InsertNetworkEdgeSecurityServiceRequest();
        $requestParamHeaders = [];
        $request->setNetworkEdgeSecurityServiceResource($networkEdgeSecurityServiceResource);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($networkEdgeSecurityService, $networkEdgeSecurityServiceResource, $project, $region, array $optionalArgs = [])
    {
