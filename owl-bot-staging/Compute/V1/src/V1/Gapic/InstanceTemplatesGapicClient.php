 ...
 *     $pagedResponse = $instanceTemplatesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InstanceTemplatesClient}.
 */
class InstanceTemplatesGapicClient
{
     ...
     * $instanceTemplatesClient = new InstanceTemplatesClient();
     * try {
     *     $operationResponse = $instanceTemplatesClient->delete();
     ...
     * $instanceTemplatesClient = new InstanceTemplatesClient();
     * try {
     *     $operationResponse = $instanceTemplatesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $instanceTemplatesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
