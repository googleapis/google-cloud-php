 ...
 *     $pagedResponse = $targetTcpProxiesClient->aggregatedList();
...
class TargetTcpProxiesGapicClient
{
     ...
     * $targetTcpProxiesClient = new TargetTcpProxiesClient();
     * try {
     *     $operationResponse = $targetTcpProxiesClient->delete();
     ...
     * $targetTcpProxiesClient = new TargetTcpProxiesClient();
     * try {
     *     $operationResponse = $targetTcpProxiesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $targetTcpProxiesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $targetTcpProxiesClient = new TargetTcpProxiesClient();
     * try {
     *     $operationResponse = $targetTcpProxiesClient->setBackendService();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $targetTcpProxiesClient = new TargetTcpProxiesClient();
     * try {
     *     $operationResponse = $targetTcpProxiesClient->setProxyHeader();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
