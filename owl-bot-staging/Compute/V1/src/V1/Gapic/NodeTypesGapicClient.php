 ...
 *     $pagedResponse = $nodeTypesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\NodeTypesClient}.
 */
class NodeTypesGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['nodeType'])) {
            $request->setNodeType($optionalArgs['nodeType']);
            $requestParamHeaders['node_type'] = $optionalArgs['nodeType'];
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $nodeTypesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
