 ...
 *     $pagedResponse = $networkEndpointGroupsClient->aggregatedList();
...
class NetworkEndpointGroupsGapicClient
{
     ...
     * $networkEndpointGroupsClient = new NetworkEndpointGroupsClient();
     * try {
     *     $operationResponse = $networkEndpointGroupsClient->attachNetworkEndpoints();
     ...
     * $networkEndpointGroupsClient = new NetworkEndpointGroupsClient();
     * try {
     *     $operationResponse = $networkEndpointGroupsClient->delete();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $networkEndpointGroupsClient = new NetworkEndpointGroupsClient();
     * try {
     *     $operationResponse = $networkEndpointGroupsClient->detachNetworkEndpoints();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $networkEndpointGroupsClient = new NetworkEndpointGroupsClient();
     * try {
     *     $operationResponse = $networkEndpointGroupsClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $networkEndpointGroupsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $networkEndpointGroupsClient->listNetworkEndpoints();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
