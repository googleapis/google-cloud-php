 ...
 *     $pagedResponse = $forwardingRulesClient->aggregatedList();
...
class ForwardingRulesGapicClient
{
     ...
     * $forwardingRulesClient = new ForwardingRulesClient();
     * try {
     *     $operationResponse = $forwardingRulesClient->delete();
     ...
     * $forwardingRulesClient = new ForwardingRulesClient();
     * try {
     *     $operationResponse = $forwardingRulesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $forwardingRulesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $forwardingRulesClient = new ForwardingRulesClient();
     * try {
     *     $operationResponse = $forwardingRulesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $forwardingRulesClient = new ForwardingRulesClient();
     * try {
     *     $operationResponse = $forwardingRulesClient->setLabels();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $forwardingRulesClient = new ForwardingRulesClient();
     * try {
     *     $operationResponse = $forwardingRulesClient->setTarget();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
