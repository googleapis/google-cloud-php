...
/**
 * DefaultActionOnFailure contains string constants that represent the names of
 * each value in the
...
{
    const UNDEFINED_DEFAULT_ACTION_ON_FAILURE = 'UNDEFINED_DEFAULT_ACTION_ON_FAILURE';
