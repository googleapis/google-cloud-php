...
namespace Google\Cloud\Compute\V1\Enums\PerInstanceConfig;

/**
 * Status contains string constants that represent the names of each value in the
 * google.cloud.compute.v1.PerInstanceConfig.Status descriptor.
 */
class Status
{
    ...
    const UNAPPLIED_DELETION = 'UNAPPLIED_DELETION';
}
