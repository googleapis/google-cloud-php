 ...
 * \Google\Cloud\Compute\V1\RegionSecurityPoliciesClient} for the stable
 * implementation
 *
 * @experimental
 *
...
final class RegionSecurityPoliciesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionSecurityPolicies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_security_policies_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_security_policies_descriptor_config.php',
            'credentialsConfig' => [
     ...
     */
    public function delete(DeleteRegionSecurityPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionSecurityPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionSecurityPoliciesRequest $request, array $callOptions = []): PagedListResponse
    {
