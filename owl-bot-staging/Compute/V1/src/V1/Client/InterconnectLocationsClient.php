 ...
 * \Google\Cloud\Compute\V1\InterconnectLocationsClient} for the stable
 * implementation
 *
 * @experimental
 *
 * @method PromiseInterface getAsync(GetInterconnectLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface listAsync(ListInterconnectLocationsRequest $request, array $optionalArgs = [])
 */
final class InterconnectLocationsClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectLocations';
     ...
     *
     * The async variant is {@see InterconnectLocationsGapicClient::getAsync()} .
     *
     ...
     */
    public function get(GetInterconnectLocationRequest $request, array $callOptions = []): InterconnectLocation
    {
     ...
     *
     * The async variant is {@see InterconnectLocationsGapicClient::listAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListInterconnectLocationsRequest $request, array $callOptions = []): PagedListResponse
    {
