 ...
 *
 * @method PromiseInterface<OperationResponse> deleteAsync(DeleteTargetGrpcProxyRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<TargetGrpcProxy> getAsync(GetTargetGrpcProxyRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> insertAsync(InsertTargetGrpcProxyRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListTargetGrpcProxiesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> patchAsync(PatchTargetGrpcProxyRequest $request, array $optionalArgs = [])
 */
final class TargetGrpcProxiesClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.TargetGrpcProxies';
     ...
     *           $options = new TargetGrpcProxiesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function delete(DeleteTargetGrpcProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetTargetGrpcProxyRequest $request, array $callOptions = []): TargetGrpcProxy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertTargetGrpcProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListTargetGrpcProxiesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchTargetGrpcProxyRequest $request, array $callOptions = []): OperationResponse
    {
