 ...
 * \Google\Cloud\Compute\V1\RegionHealthChecksClient} for the stable implementation
 *
 * @experimental
 *
...
final class RegionHealthChecksClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionHealthChecks';
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::deleteAsync()} .
     *
     ...
     */
    public function delete(DeleteRegionHealthCheckRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::getAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionHealthCheckRequest $request, array $callOptions = []): HealthCheck
    {
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::insertAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionHealthCheckRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::listAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionHealthChecksRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::patchAsync()} .
     *
     ...
     *
     * The async variant is {@see RegionHealthChecksGapicClient::updateAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function update(UpdateRegionHealthCheckRequest $request, array $callOptions = []): OperationResponse
    {
