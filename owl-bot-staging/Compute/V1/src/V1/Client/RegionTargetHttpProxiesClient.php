 ...
 * \Google\Cloud\Compute\V1\RegionTargetHttpProxiesClient} for the stable
 * implementation
 *
 * @experimental
 *
...
final class RegionTargetHttpProxiesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionTargetHttpProxies';
     ...
     *
     * The async variant is {@see RegionTargetHttpProxiesGapicClient::deleteAsync()} .
     *
     ...
     */
    public function delete(DeleteRegionTargetHttpProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionTargetHttpProxiesGapicClient::getAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionTargetHttpProxyRequest $request, array $callOptions = []): TargetHttpProxy
    {
     ...
     *
     * The async variant is {@see RegionTargetHttpProxiesGapicClient::insertAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionTargetHttpProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionTargetHttpProxiesGapicClient::listAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionTargetHttpProxiesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see RegionTargetHttpProxiesGapicClient::setUrlMapAsync()}
     * .
     *
