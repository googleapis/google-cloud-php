 ...
 * \Google\Cloud\Compute\V1\SnapshotSettingsServiceClient} for the stable
 * implementation
 *
 * @experimental
 *
...
final class SnapshotSettingsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.SnapshotSettingsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/snapshot_settings_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/snapshot_settings_service_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/snapshot_settings_service_rest_client_config.php',
                ],
            ],
     ...
     */
    public function get(GetSnapshotSettingRequest $request, array $callOptions = []): SnapshotSettings
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchSnapshotSettingRequest $request, array $callOptions = []): OperationResponse
    {
