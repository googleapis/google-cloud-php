 ...
 * \Google\Cloud\Compute\V1\NetworkAttachmentsClient} for the stable implementation
 *
 * @experimental
 *
...
final class NetworkAttachmentsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.NetworkAttachments';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteNetworkAttachmentRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetNetworkAttachmentRequest $request, array $callOptions = []): NetworkAttachment
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getIamPolicy(GetIamPolicyNetworkAttachmentRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertNetworkAttachmentRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function setIamPolicy(SetIamPolicyNetworkAttachmentRequest $request, array $callOptions = []): Policy
    {
