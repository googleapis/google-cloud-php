 ...
 * \Google\Cloud\Compute\V1\ZonesClient} for the stable implementation
 *
 * @experimental
 *
...
final class ZonesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.Zones';
     ...
     */
    public function get(GetZoneRequest $request, array $callOptions = []): Zone
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListZonesRequest $request, array $callOptions = []): PagedListResponse
    {
