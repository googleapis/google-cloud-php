 ...
 * \Google\Cloud\Compute\V1\RegionCommitmentsClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class RegionCommitmentsBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionCommitments';
     ...
     */
    public function aggregatedList(AggregatedListRegionCommitmentsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionCommitmentRequest $request, array $callOptions = []): Commitment
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionCommitmentRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionCommitmentsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function update(UpdateRegionCommitmentRequest $request, array $callOptions = []): OperationResponse
    {
