 ...
 */
abstract class SubnetworksBaseClient
{
     ...
     *
     * The async variant is {@see self::expandIpCidrRangeAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listUsableAsync()} .
     *
     ...
     *
     * The async variant is {@see self::setPrivateIpGoogleAccessAsync()} .
     *
