 ...
 */
abstract class MachineImagesBaseClient
{
     ...
     */
    public function delete(DeleteMachineImageRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetMachineImageRequest $request, array $callOptions = []): MachineImage
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getIamPolicy(GetIamPolicyMachineImageRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertMachineImageRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListMachineImagesRequest $request, array $callOptions = []): PagedListResponse
    {
