 ...
 * \Google\Cloud\Compute\V1\NetworksClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class NetworksBaseClient
{
     ...
     *
     * The async variant is {@see self::addPeeringAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listPeeringRoutesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::removePeeringAsync()} .
     *
     ...
     *
     * The async variant is {@see self::switchToCustomModeAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updatePeeringAsync()} .
     *
