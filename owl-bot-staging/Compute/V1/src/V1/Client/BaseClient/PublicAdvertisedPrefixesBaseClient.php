 ...
 * \Google\Cloud\Compute\V1\PublicAdvertisedPrefixesClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class PublicAdvertisedPrefixesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.PublicAdvertisedPrefixes';
     ...
     */
    public function delete(DeletePublicAdvertisedPrefixeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetPublicAdvertisedPrefixeRequest $request, array $callOptions = []): PublicAdvertisedPrefix
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertPublicAdvertisedPrefixeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListPublicAdvertisedPrefixesRequest $request, array $callOptions = []): PagedListResponse
    {
