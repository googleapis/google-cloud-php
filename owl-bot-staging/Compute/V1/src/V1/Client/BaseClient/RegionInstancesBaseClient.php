 ...
 * \Google\Cloud\Compute\V1\RegionInstancesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class RegionInstancesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionInstances';
     ...
     */
    public function bulkInsert(BulkInsertRegionInstanceRequest $request, array $callOptions = []): OperationResponse
    {
