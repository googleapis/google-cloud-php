 ...
 * \Google\Cloud\Compute\V1\RegionInstanceGroupsClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class RegionInstanceGroupsBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionInstanceGroups';
     ...
     */
    public function get(GetRegionInstanceGroupRequest $request, array $callOptions = []): InstanceGroup
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionInstanceGroupsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see self::setNamedPortsAsync()} .
     *
