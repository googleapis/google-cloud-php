...
class ReservationSubBlocksClientTest extends GeneratedTest
{
    ...
    public function getTest()
    {
        ...
        $zone = 'zone3744684';
        $response = $gapicClient->get($parentName, $project, $reservationSubBlock, $zone);
    ...
    public function getExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->get($parentName, $project, $reservationSubBlock, $zone);
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->list($parentName, $project, $zone);
    ...
    public function listExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->list($parentName, $project, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function performMaintenanceTest()
    {
        ...
        $reservationSubBlock = 'reservationSubBlock22750491';
        $zone = 'zone3744684';
        $response = $gapicClient->performMaintenance($parentName, $project, $reservationSubBlock, $zone);
