 ...
 * @group gapic
 */
class InstanceSettingsServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new InstanceSettingsServiceClient($options);
    }
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new InstanceSettings();
        ...
        $this->assertSame('/google.cloud.compute.v1.InstanceSettingsService/Get', $actualFuncCall);
    ...
    public function patchTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.InstanceSettingsService/Patch', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getInstanceSettingsResource();
        $this->assertProtobufEquals($instanceSettingsResource, $actualValue);
