...
use Google\Cloud\Compute\V1\InsertRegionInstanceTemplateRequest;
 ...
 * @group gapic
 */
class RegionInstanceTemplatesClientTest extends GeneratedTest
{
    ...
    /** @return RegionInstanceTemplatesClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionInstanceTemplatesClient($options);
    }
