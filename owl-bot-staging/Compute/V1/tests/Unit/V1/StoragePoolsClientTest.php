...
class StoragePoolsClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $zone = 'zone3744684';
        $response = $gapicClient->delete($project, $storagePool, $zone);
    ...
    public function getTest()
    {
        ...
        $storagePool = 'storagePool897344352';
        $zone = 'zone3744684';
        $response = $gapicClient->get($project, $storagePool, $zone);
    ...
    public function getExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->get($project, $storagePool, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function insertTest()
    {
        ...
        $zone = 'zone3744684';
        $response = $gapicClient->insert($project, $storagePoolResource, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function listDisksTest()
    {
        ...
        $storagePool = 'storagePool897344352';
        $zone = 'zone3744684';
        $response = $gapicClient->listDisks($project, $storagePool, $zone);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function listDisksExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->listDisks($project, $storagePool, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateTest()
    {
        ...
        $storagePoolResource = new StoragePool();
        $zone = 'zone3744684';
        $response = $gapicClient->update($project, $storagePool, $storagePoolResource, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
