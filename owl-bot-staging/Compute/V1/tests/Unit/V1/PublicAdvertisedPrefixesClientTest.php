...
class PublicAdvertisedPrefixesClientTest extends GeneratedTest
{
    ...
    public function getTest()
    {
        ...
        $dnsVerificationIp = 'dnsVerificationIp-1906472267';
        ...
        $expectedResponse->setDnsVerificationIp($dnsVerificationIp);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new PublicAdvertisedPrefix();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new PublicAdvertisedPrefixList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
