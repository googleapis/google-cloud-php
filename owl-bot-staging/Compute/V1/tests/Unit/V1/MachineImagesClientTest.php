 ...
 * @group gapic
 */
class MachineImagesClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new MachineImagesClient($options);
    }
    ...
    public function deleteTest()
    {
        ...
        $response = $gapicClient->delete($machineImage, $project);
    ...
    public function getTest()
    {
        ...
        $totalStorageBytes = 1528757268;
        $expectedResponse = new MachineImage();
        ...
        $machineImage = 'machineImage1142931299';
        $project = 'project-309310695';
        $response = $gapicClient->get($machineImage, $project);
    ...
    public function getExceptionTest()
    {
        ...
        $project = 'project-309310695';
        try {
            $gapicClient->get($machineImage, $project);
    ...
    public function insertTest()
    {
        ...
        $project = 'project-309310695';
        $response = $gapicClient->insert($machineImageResource, $project);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new MachineImage();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new MachineImageList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
    ...
    public function setLabelsTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.MachineImages/SetLabels', $actualApiFuncCall);
