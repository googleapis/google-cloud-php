...
class InstanceGroupManagerResizeRequestsClientTest extends GeneratedTest
{
    ...
    public function cancelTest()
    {
        ...
        $zone = 'zone3744684';
        $response = $gapicClient->cancel($instanceGroupManager, $project, $resizeRequest, $zone);
    ...
    public function deleteTest()
    {
        ...
        $resizeRequest = 'resizeRequest-319929852';
        $zone = 'zone3744684';
        $response = $gapicClient->delete($instanceGroupManager, $project, $resizeRequest, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function getTest()
    {
        ...
        $resizeRequest = 'resizeRequest-319929852';
        $zone = 'zone3744684';
        $response = $gapicClient->get($instanceGroupManager, $project, $resizeRequest, $zone);
    ...
    public function getExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->get($instanceGroupManager, $project, $resizeRequest, $zone);
    ...
    public function insertTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->insert($instanceGroupManager, $instanceGroupManagerResizeRequestResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->list($instanceGroupManager, $project, $zone);
    ...
    public function listExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->list($instanceGroupManager, $project, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
