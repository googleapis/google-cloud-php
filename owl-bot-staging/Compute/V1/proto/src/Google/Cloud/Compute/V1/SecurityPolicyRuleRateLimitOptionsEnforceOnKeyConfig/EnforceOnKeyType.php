...
namespace Google\Cloud\Compute\V1\SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig;
...
class EnforceOnKeyType
{
     ...
     *
     * Generated from protobuf enum <code>UNDEFINED_ENFORCE_ON_KEY_TYPE = 0;</code>
     */
    const UNDEFINED_ENFORCE_ON_KEY_TYPE = 0;
    /**
...
class_alias(EnforceOnKeyType::class, \Google\Cloud\Compute\V1\SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig_EnforceOnKeyType::class);
