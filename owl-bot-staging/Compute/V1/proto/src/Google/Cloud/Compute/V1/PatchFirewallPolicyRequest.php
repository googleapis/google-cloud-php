 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchFirewallPolicyRequest</code>
 */
class PatchFirewallPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchFirewallPolicyRequest
     *
     * @experimental
     */
    public static function build(string $firewallPolicy, \Google\Cloud\Compute\V1\FirewallPolicy $firewallPolicyResource): self
    {
        return (new self())
