...
class PatchSubnetworkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $drain_timeout_seconds = null;
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchSubnetworkRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $subnetwork, \Google\Cloud\Compute\V1\Subnetwork $subnetworkResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
