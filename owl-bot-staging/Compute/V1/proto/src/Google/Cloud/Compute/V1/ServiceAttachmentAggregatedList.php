 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ServiceAttachmentAggregatedList</code>
 */
class ServiceAttachmentAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.ServiceAttachmentsScopedList> items = 100526016;</code>
     */
    private $items;
    /**
     * Type of resource.
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\ServiceAttachmentsScopedList::class);
        $this->items = $arr;
