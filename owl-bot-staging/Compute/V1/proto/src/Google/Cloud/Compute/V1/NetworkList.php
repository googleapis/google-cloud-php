 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NetworkList</code>
 */
class NetworkList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Network items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Network[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Network resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#networkList for lists of networks.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Network items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\Network[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\Network::class);
        $this->items = $arr;
