 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetBackendServiceTargetSslProxyRequest</code>
 */
class SetBackendServiceTargetSslProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $target_ssl_proxies_set_backend_service_request_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\TargetSslProxiesSetBackendServiceRequest $targetSslProxiesSetBackendServiceRequestResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetBackendServiceTargetSslProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $targetSslProxy, \Google\Cloud\Compute\V1\TargetSslProxiesSetBackendServiceRequest $targetSslProxiesSetBackendServiceRequestResource): self
    {
        return (new self())
            ->setProject($project)
     ...
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type \Google\Cloud\Compute\V1\TargetSslProxiesSetBackendServiceRequest $target_ssl_proxies_set_backend_service_request_resource
     *           The body resource for this request
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.TargetSslProxiesSetBackendServiceRequest target_ssl_proxies_set_backend_service_request_resource = 139080868 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\TargetSslProxiesSetBackendServiceRequest|null
     */
    ...
    public function hasTargetSslProxiesSetBackendServiceRequestResource()
    {
        return isset($this->target_ssl_proxies_set_backend_service_request_resource);
    }
