...
class_alias(MostDisruptiveAllowedAction::class, \Google\Cloud\Compute\V1\RegionInstanceGroupManagersApplyUpdatesRequest_MostDisruptiveAllowedAction::class);
