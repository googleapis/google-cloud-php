 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.AcceleratorTypeList</code>
 */
class AcceleratorTypeList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.AcceleratorType items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\AcceleratorType[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of AcceleratorType resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#acceleratorTypeList for lists of accelerator types.
