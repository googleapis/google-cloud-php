 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.HealthCheckList</code>
 */
class HealthCheckList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.HealthCheck items = 100526016;</code>
     */
    private $items;
    /**
     * Type of resource.
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\HealthCheck[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of HealthCheck resources.
     *     @type string $kind
     *           Type of resource.
