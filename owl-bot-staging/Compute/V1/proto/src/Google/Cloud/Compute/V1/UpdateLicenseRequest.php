 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UpdateLicenseRequest</code>
 */
class UpdateLicenseRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\UpdateLicenseRequest
     *
     * @experimental
     */
    public static function build(string $project, string $license, \Google\Cloud\Compute\V1\License $licenseResource): self
    {
        return (new self())
            ->setProject($project)
            ->setLicense($license)
