...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SubnetworkAggregatedList</code>
 */
class SubnetworkAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.SubnetworksScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\SubnetworksScopedList::class);
        $this->items = $arr;
