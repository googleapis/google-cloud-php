 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetInstanceTemplateInstanceGroupManagerRequest</code>
 */
class SetInstanceTemplateInstanceGroupManagerRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $instance_group_managers_set_instance_template_request_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\InstanceGroupManagersSetInstanceTemplateRequest $instanceGroupManagersSetInstanceTemplateRequestResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetInstanceTemplateInstanceGroupManagerRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instanceGroupManager, \Google\Cloud\Compute\V1\InstanceGroupManagersSetInstanceTemplateRequest $instanceGroupManagersSetInstanceTemplateRequestResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
     ...
     *           The name of the managed instance group.
     *     @type \Google\Cloud\Compute\V1\InstanceGroupManagersSetInstanceTemplateRequest $instance_group_managers_set_instance_template_request_resource
     *           The body resource for this request
     *     @type string $project
     *           Project ID for this request.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.InstanceGroupManagersSetInstanceTemplateRequest instance_group_managers_set_instance_template_request_resource = 9809093 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\InstanceGroupManagersSetInstanceTemplateRequest|null
     */
    ...
    public function hasInstanceGroupManagersSetInstanceTemplateRequestResource()
    {
        return isset($this->instance_group_managers_set_instance_template_request_resource);
    }

    public function clearInstanceGroupManagersSetInstanceTemplateRequestResource()
    {
        unset($this->instance_group_managers_set_instance_template_request_resource);
    }
