 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRegionTargetHttpsProxyRequest</code>
 */
class PatchRegionTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.TargetHttpsProxy target_https_proxy_resource = 433657473 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchRegionTargetHttpsProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $targetHttpsProxy, \Google\Cloud\Compute\V1\TargetHttpsProxy $targetHttpsProxyResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
