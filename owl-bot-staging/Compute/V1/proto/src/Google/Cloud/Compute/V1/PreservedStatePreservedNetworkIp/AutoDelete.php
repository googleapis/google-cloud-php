...
namespace Google\Cloud\Compute\V1\PreservedStatePreservedNetworkIp;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.PreservedStatePreservedNetworkIp.AutoDelete</code>
 */
class AutoDelete
{
    /**
...
class_alias(AutoDelete::class, \Google\Cloud\Compute\V1\PreservedStatePreservedNetworkIp_AutoDelete::class);
