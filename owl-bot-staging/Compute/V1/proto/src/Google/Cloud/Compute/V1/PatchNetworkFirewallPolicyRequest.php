 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchNetworkFirewallPolicyRequest</code>
 */
class PatchNetworkFirewallPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchNetworkFirewallPolicyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $firewallPolicy, \Google\Cloud\Compute\V1\FirewallPolicy $firewallPolicyResource): self
    {
        return (new self())
            ->setProject($project)
