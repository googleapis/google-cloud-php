 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetSecurityPolicyTargetInstanceRequest</code>
 */
class SetSecurityPolicyTargetInstanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $project, string $zone, string $targetInstance, \Google\Cloud\Compute\V1\SecurityPolicyReference $securityPolicyReferenceResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
