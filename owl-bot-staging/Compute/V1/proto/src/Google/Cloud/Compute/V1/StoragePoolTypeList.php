 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.StoragePoolTypeList</code>
 */
class StoragePoolTypeList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.StoragePoolType items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\StoragePoolType::class);
        $this->items = $arr;
