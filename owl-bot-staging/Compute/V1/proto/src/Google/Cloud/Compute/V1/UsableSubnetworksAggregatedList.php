...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UsableSubnetworksAggregatedList</code>
 */
class UsableSubnetworksAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\UsableSubnetwork::class);
        $this->items = $arr;
