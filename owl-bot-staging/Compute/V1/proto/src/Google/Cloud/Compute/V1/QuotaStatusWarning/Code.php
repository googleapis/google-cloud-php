...
namespace Google\Cloud\Compute\V1\QuotaStatusWarning;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.QuotaStatusWarning.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\Compute\V1\QuotaStatusWarning_Code::class);
