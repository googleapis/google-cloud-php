...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PublicDelegatedPrefixList</code>
 */
class PublicDelegatedPrefixList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.PublicDelegatedPrefix items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\PublicDelegatedPrefix[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of PublicDelegatedPrefix resources.
     *     @type string $kind
     *           [Output Only] Type of the resource. Always compute#publicDelegatedPrefixList for public delegated prefixes.
