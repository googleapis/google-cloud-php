 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetSslCertificatesRegionTargetHttpsProxyRequest</code>
 */
class SetSslCertificatesRegionTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return isset($this->region_target_https_proxies_set_ssl_certificates_request_resource);
    }

    public function clearRegionTargetHttpsProxiesSetSslCertificatesRequestResource()
    {
        unset($this->region_target_https_proxies_set_ssl_certificates_request_resource);
    }
     ...
     * @return $this
     */
    public function setRegionTargetHttpsProxiesSetSslCertificatesRequestResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\RegionTargetHttpsProxiesSetSslCertificatesRequest::class);
        $this->region_target_https_proxies_set_ssl_certificates_request_resource = $var;
