 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetTargetPoolsInstanceGroupManagerRequest</code>
 */
class SetTargetPoolsInstanceGroupManagerRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $instance_group_managers_set_target_pools_request_resource = null;
    /**
     ...
     *           The name of the managed instance group.
     *     @type \Google\Cloud\Compute\V1\InstanceGroupManagersSetTargetPoolsRequest $instance_group_managers_set_target_pools_request_resource
     *           The body resource for this request
     *     @type string $project
     *           Project ID for this request.
    ...
    public function hasInstanceGroupManagersSetTargetPoolsRequestResource()
    {
        return isset($this->instance_group_managers_set_target_pools_request_resource);
    }

    public function clearInstanceGroupManagersSetTargetPoolsRequestResource()
    {
        unset($this->instance_group_managers_set_target_pools_request_resource);
    }
     ...
     * @return $this
     */
    public function setInstanceGroupManagersSetTargetPoolsRequestResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\InstanceGroupManagersSetTargetPoolsRequest::class);
        $this->instance_group_managers_set_target_pools_request_resource = $var;
