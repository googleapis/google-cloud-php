...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PublicAdvertisedPrefixList</code>
 */
class PublicAdvertisedPrefixList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.PublicAdvertisedPrefix items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\PublicAdvertisedPrefix[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of PublicAdvertisedPrefix resources.
     *     @type string $kind
     *           [Output Only] Type of the resource. Always compute#publicAdvertisedPrefix for public advertised prefixes.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.PublicAdvertisedPrefix items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\PublicAdvertisedPrefix[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\PublicAdvertisedPrefix::class);
        $this->items = $arr;
