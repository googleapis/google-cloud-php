 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.TargetTcpProxy.ProxyHeader</code>
 */
class ProxyHeader
{
    /**
...
class_alias(ProxyHeader::class, \Google\Cloud\Compute\V1\TargetTcpProxy_ProxyHeader::class);
