...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.HealthCheckServicesList</code>
 */
class HealthCheckServicesList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.HealthCheckService items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\HealthCheckService[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of HealthCheckService resources.
     *     @type string $kind
     *           [Output Only] Type of the resource. Always compute#healthCheckServicesList for lists of HealthCheckServices.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.HealthCheckService items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\HealthCheckService[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
