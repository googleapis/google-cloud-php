...
namespace Google\Cloud\Compute\V1\TargetSslProxiesSetProxyHeaderRequest;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.TargetSslProxiesSetProxyHeaderRequest.ProxyHeader</code>
 */
class ProxyHeader
{
    /**
...
class_alias(ProxyHeader::class, \Google\Cloud\Compute\V1\TargetSslProxiesSetProxyHeaderRequest_ProxyHeader::class);
