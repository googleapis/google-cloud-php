 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetShieldedInstanceIntegrityPolicyInstanceRequest</code>
 */
class SetShieldedInstanceIntegrityPolicyInstanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $shielded_instance_integrity_policy_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\ShieldedInstanceIntegrityPolicy $shieldedInstanceIntegrityPolicyResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetShieldedInstanceIntegrityPolicyInstanceRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instance, \Google\Cloud\Compute\V1\ShieldedInstanceIntegrityPolicy $shieldedInstanceIntegrityPolicyResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
    ...
    {
        return $this->shielded_instance_integrity_policy_resource;
    }

    public function hasShieldedInstanceIntegrityPolicyResource()
    {
        return isset($this->shielded_instance_integrity_policy_resource);
    }
     ...
     * @return $this
     */
    public function setShieldedInstanceIntegrityPolicyResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\ShieldedInstanceIntegrityPolicy::class);
        $this->shielded_instance_integrity_policy_resource = $var;
