 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ResourcePolicyAggregatedList</code>
 */
class ResourcePolicyAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.ResourcePoliciesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
     * Type of resource.
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\ResourcePoliciesScopedList::class);
        $this->items = $arr;
