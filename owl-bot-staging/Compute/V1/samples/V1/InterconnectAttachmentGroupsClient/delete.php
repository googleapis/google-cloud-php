 ...
 */
function delete_sample(string $interconnectAttachmentGroup, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $interconnectAttachmentGroupsClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($interconnectAttachmentGroup, $project);
}
