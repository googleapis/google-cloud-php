 ...
 */
function get_sample(string $project, string $region, string $securityPolicy): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionSecurityPoliciesClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($project, $region, $securityPolicy);
}
