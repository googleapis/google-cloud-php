 ...
 */
function get_sample(string $project, string $region, string $targetVpnGateway): void
{
    // Create a client.
    ...
    try {
        /** @var TargetVpnGateway $response */
        $response = $targetVpnGatewaysClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($project, $region, $targetVpnGateway);
}
