...
class RegionInstanceGroupManagerResizeRequestsClientTest extends GeneratedTest
{
    ...
    public function cancelTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionInstanceGroupManagerResizeRequests/Cancel', $actualApiFuncCall);
    ...
    public function deleteTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstanceGroupManagerResizeRequests/Delete', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getInstanceGroupManager();
        $this->assertProtobufEquals($instanceGroupManager, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function insertTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstanceGroupManagerResizeRequests/Insert', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getInstanceGroupManager();
        $this->assertProtobufEquals($instanceGroupManager, $actualValue);
