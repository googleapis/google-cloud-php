...
class RoutersClientTest extends GeneratedTest
{
    ...
    public function deleteRoutePolicyTest()
    {
        ...
        $request = (new DeleteRoutePolicyRouterRequest())
            ...
            ->setRegion($region)
            ->setRouter($router);
        $response = $gapicClient->deleteRoutePolicy($request);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function getRoutePolicyTest()
    {
        ...
        $request = (new GetRoutePolicyRouterRequest())
            ...
            ->setRegion($region)
            ->setRouter($router);
        $response = $gapicClient->getRoutePolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getRoutePolicyExceptionTest()
    {
        ...
        $request = (new GetRoutePolicyRouterRequest())
            ...
            ->setRouter($router);
        try {
            $gapicClient->getRoutePolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listBgpRoutesTest()
    {
        ...
        $request = (new ListBgpRoutesRoutersRequest())
            ...
            ->setRegion($region)
            ->setRouter($router);
        $response = $gapicClient->listBgpRoutes($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getResult()[0], $resources[0]);
    ...
    public function listBgpRoutesExceptionTest()
    {
        ...
        $request = (new ListBgpRoutesRoutersRequest())
            ...
            ->setRouter($router);
        try {
            $gapicClient->listBgpRoutes($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listRoutePoliciesTest()
    {
        ...
        $request = (new ListRoutePoliciesRoutersRequest())
            ...
            ->setRegion($region)
            ->setRouter($router);
        $response = $gapicClient->listRoutePolicies($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getResult()[0], $resources[0]);
    ...
    public function listRoutePoliciesExceptionTest()
    {
        ...
        $request = (new ListRoutePoliciesRoutersRequest())
            ...
            ->setRouter($router);
        try {
            $gapicClient->listRoutePolicies($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function patchRoutePolicyTest()
    {
        ...
        $router = 'router-925132983';
        $request = (new PatchRoutePolicyRouterRequest())
            ->setProject($project)
            ->setRegion($region)
            ->setRoutePolicyResource($routePolicyResource)
            ->setRouter($router);
        $response = $gapicClient->patchRoutePolicy($request);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function updateRoutePolicyTest()
    {
        ...
        $routePolicyResource = new RoutePolicy();
        $router = 'router-925132983';
        $request = (new UpdateRoutePolicyRouterRequest())
            ->setProject($project)
            ->setRegion($region)
            ->setRoutePolicyResource($routePolicyResource)
            ->setRouter($router);
        $response = $gapicClient->updateRoutePolicy($request);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
