...
use Google\Cloud\Compute\V1\Client\RegionSnapshotSettingsClient;
 ...
 * @group gapic
 */
class RegionSnapshotSettingsClientTest extends GeneratedTest
{
    ...
    /** @return RegionSnapshotSettingsClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionSnapshotSettingsClient($options);
    }
    ...
    public function getTest()
    {
        ...
        $request = (new GetRegionSnapshotSettingRequest())
            ->setProject($project)
            ->setRegion($region);
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionSnapshotSettings/Get', $actualFuncCall);
    ...
    public function patchTest()
    {
        ...
        $request = (new PatchRegionSnapshotSettingRequest())
            ->setProject($project)
            ->setRegion($region)
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionSnapshotSettings/Patch', $actualApiFuncCall);
