...
class DisksClientTest extends GeneratedTest
{
    ...
    public function updateKmsKeyTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.Disks/UpdateKmsKey', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getDisk();
        $this->assertProtobufEquals($disk, $actualValue);
        $actualValue = $actualApiRequestObject->getDiskUpdateKmsKeyRequestResource();
        $this->assertProtobufEquals($diskUpdateKmsKeyRequestResource, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
