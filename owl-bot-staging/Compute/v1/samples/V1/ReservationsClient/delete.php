 ...
 */
function delete_sample(string $project, string $reservation, string $zone): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $reservationsClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $reservation, $zone);
}
