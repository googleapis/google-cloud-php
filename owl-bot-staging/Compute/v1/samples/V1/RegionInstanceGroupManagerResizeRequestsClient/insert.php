 ...
 *
 * @param string $instanceGroupManager Name of the managed instance group to which the resize request is scoped.
 *                                     Name should conform to RFC1035 or be a resource ID.
 * @param string $project              Project ID for this request.
 * @param string $region               Name of the region
 *                                     scoping this request. Name should conform to RFC1035.
 */
function insert_sample(string $instanceGroupManager, string $project, string $region): void
{
    // Create a client.
    $regionInstanceGroupManagerResizeRequestsClient = new RegionInstanceGroupManagerResizeRequestsClient();
    ...
    try {
        ...
        $response = $regionInstanceGroupManagerResizeRequestsClient->insert($request);
...
function callSample(): void
{
    ...
    insert_sample($instanceGroupManager, $project, $region);
}
