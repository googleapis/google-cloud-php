 ...
 */
function list_sample(string $instanceGroupManager, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionInstanceGroupManagerResizeRequestsClient->list($request);
...
function callSample(): void
{
    ...
    list_sample($instanceGroupManager, $project, $region);
}
