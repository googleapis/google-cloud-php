 ...
 *
 * @param string $healthAggregationPolicy Name of the HealthAggregationPolicy to update. The name
 *                                        must be 1-63 characters long, and comply with RFC1035.
 * @param string $project                 Project ID for this request.
 * @param string $region                  Name of the region scoping this request.
 */
function patch_sample(string $healthAggregationPolicy, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionHealthAggregationPoliciesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($healthAggregationPolicy, $project, $region);
}
