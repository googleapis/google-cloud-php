 ...
 */
function get_sample(string $project, string $region, string $targetTcpProxy): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionTargetTcpProxiesClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($project, $region, $targetTcpProxy);
}
