 ...
 */
function get_sample(string $backendBucket, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionBackendBucketsClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($backendBucket, $project, $region);
}
