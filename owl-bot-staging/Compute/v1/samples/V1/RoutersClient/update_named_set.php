 ...
 */
function update_named_set_sample(string $project, string $region, string $router): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $routersClient->updateNamedSet($request);
...
function callSample(): void
{
    ...
    update_named_set_sample($project, $region, $router);
}
