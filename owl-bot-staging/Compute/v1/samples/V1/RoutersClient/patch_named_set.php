 ...
 */
function patch_named_set_sample(string $project, string $region, string $router): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $routersClient->patchNamedSet($request);
...
function callSample(): void
{
    ...
    patch_named_set_sample($project, $region, $router);
}
