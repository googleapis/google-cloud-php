 ...
 */
function add_association_sample(string $firewallPolicy, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkFirewallPoliciesClient->addAssociation($request);
...
function callSample(): void
{
    ...
    add_association_sample($firewallPolicy, $project);
}
