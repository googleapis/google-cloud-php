 ...
 */
function delete_sample(string $project, string $region, string $snapshot): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionSnapshotsClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $region, $snapshot);
}
