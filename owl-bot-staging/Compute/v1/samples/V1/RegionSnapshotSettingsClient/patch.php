 ...
 */
function patch_sample(string $project, string $region): void
{
    // Create a client.
    $regionSnapshotSettingsClient = new RegionSnapshotSettingsClient();
    ...
    try {
        ...
        $response = $regionSnapshotSettingsClient->patch($request);
