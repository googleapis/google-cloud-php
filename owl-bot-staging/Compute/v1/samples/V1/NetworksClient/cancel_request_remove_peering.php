 ...
 */
function cancel_request_remove_peering_sample(string $network, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networksClient->cancelRequestRemovePeering($request);
...
function callSample(): void
{
    ...
    cancel_request_remove_peering_sample($network, $project);
}
