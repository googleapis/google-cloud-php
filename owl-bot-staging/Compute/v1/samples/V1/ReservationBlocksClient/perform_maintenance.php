...
function perform_maintenance_sample(
    ...
    $request = (new PerformMaintenanceReservationBlockRequest())
        ->setProject($project)
    ...
    try {
        ...
        $response = $reservationBlocksClient->performMaintenance($request);
...
function callSample(): void
{
    ...
    perform_maintenance_sample($project, $reservation, $reservationBlock, $zone);
}
