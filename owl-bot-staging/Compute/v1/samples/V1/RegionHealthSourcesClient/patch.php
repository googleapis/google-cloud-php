 ...
 */
function patch_sample(string $healthSource, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionHealthSourcesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($healthSource, $project, $region);
}
