...
use Google\Cloud\Compute\V1\TestIamPermissionsRegionHealthSourceRequest;
...
function test_iam_permissions_sample(string $project, string $region, string $resource): void
{
    ...
    $request = (new TestIamPermissionsRegionHealthSourceRequest())
        ->setProject($project)
        ->setRegion($region)
    ...
    try {
        ...
        $response = $regionHealthSourcesClient->testIamPermissions($request);
