...
class ReservationSubBlock extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.compute.v1.AcceleratorTopologiesInfo accelerator_topologies_info = 84833420;</code>
     */
    ...
    {
        return $this->accelerator_topologies_info;
    }

    public function hasAcceleratorTopologiesInfo()
    {
        return isset($this->accelerator_topologies_info);
    }

    public function clearAcceleratorTopologiesInfo()
    {
        unset($this->accelerator_topologies_info);
    }
     ...
     * @return $this
     */
    public function setAcceleratorTopologiesInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\AcceleratorTopologiesInfo::class);
        $this->accelerator_topologies_info = $var;
