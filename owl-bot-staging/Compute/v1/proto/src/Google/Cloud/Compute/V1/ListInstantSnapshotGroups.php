 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ListInstantSnapshotGroups</code>
 */
class ListInstantSnapshotGroups extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InstantSnapshotGroup items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\InstantSnapshotGroup[] $items
     *           A list of InstantSnapshotGroup resources.
     *     @type string $kind
     *           Output only. Type of resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InstantSnapshotGroup items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\InstantSnapshotGroup>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\InstantSnapshotGroup::class);
        $this->items = $arr;
