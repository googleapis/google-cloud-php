 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.BackendServiceListUsable</code>
 */
class BackendServiceListUsable extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\BackendService[] $items
     *           A list of BackendService resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#usableBackendServiceList for lists of usable backend
     *           services.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendService items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\BackendService>
     */
