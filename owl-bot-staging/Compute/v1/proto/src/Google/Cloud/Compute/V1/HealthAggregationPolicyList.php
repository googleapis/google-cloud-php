...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.HealthAggregationPolicyList</code>
 */
class HealthAggregationPolicyList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.HealthAggregationPolicy items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type array<\Google\Cloud\Compute\V1\HealthAggregationPolicy>|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of HealthAggregationPolicy resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of the resource. Alwayscompute#healthAggregationPolicy for health aggregation
     *           policies.
