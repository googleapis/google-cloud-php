 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.GetRegionSnapshotRequest</code>
 */
class GetRegionSnapshotRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\GetRegionSnapshotRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $snapshot): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
