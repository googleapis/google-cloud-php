 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRegionSslPolicyRequest</code>
 */
class PatchRegionSslPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $project, string $region, string $sslPolicy, \Google\Cloud\Compute\V1\SslPolicy $sslPolicyResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
