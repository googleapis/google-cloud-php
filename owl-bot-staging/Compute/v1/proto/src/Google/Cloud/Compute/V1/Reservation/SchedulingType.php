 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.Reservation.SchedulingType</code>
 */
...
class_alias(SchedulingType::class, \Google\Cloud\Compute\V1\Reservation_SchedulingType::class);
