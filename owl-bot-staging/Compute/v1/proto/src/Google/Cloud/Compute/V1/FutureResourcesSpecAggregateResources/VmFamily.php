 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.FutureResourcesSpecAggregateResources.VmFamily</code>
 */
class VmFamily
{
    /**
...
class_alias(VmFamily::class, \Google\Cloud\Compute\V1\FutureResourcesSpecAggregateResources_VmFamily::class);
