 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.CrossSiteNetworkList</code>
 */
class CrossSiteNetworkList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.CrossSiteNetwork items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\CrossSiteNetwork[] $items
     *           A list of CrossSiteNetwork resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of the resource. Alwayscompute#crossSiteNetwork for cross-site networks.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.CrossSiteNetwork items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\CrossSiteNetwork>
     */
