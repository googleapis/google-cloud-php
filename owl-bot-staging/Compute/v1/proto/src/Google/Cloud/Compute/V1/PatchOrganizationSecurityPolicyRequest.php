 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchOrganizationSecurityPolicyRequest</code>
 */
class PatchOrganizationSecurityPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchOrganizationSecurityPolicyRequest
     *
     * @experimental
     */
    public static function build(string $securityPolicy, \Google\Cloud\Compute\V1\SecurityPolicy $securityPolicyResource): self
    {
        return (new self())
