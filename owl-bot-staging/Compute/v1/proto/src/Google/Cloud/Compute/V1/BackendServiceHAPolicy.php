...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.BackendServiceHAPolicy</code>
 */
class BackendServiceHAPolicy extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->fast_i_p_move) ? $this->fast_i_p_move : '';
    }

    public function hasFastIPMove()
    {
        return isset($this->fast_i_p_move);
    }

    public function clearFastIPMove()
    {
        unset($this->fast_i_p_move);
    }
     ...
     * @return $this
     */
    public function setFastIPMove($var)
    {
        GPBUtil::checkString($var, True);
        $this->fast_i_p_move = $var;
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\BackendServiceHAPolicyLeader::class);
        $this->leader = $var;
