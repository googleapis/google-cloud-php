...
namespace Google\Cloud\Compute\V1\AggregatedListSubnetworksRequest;
 ...
 *    response.
 *
 * Protobuf type <code>google.cloud.compute.v1.AggregatedListSubnetworksRequest.Views</code>
 */
class Views
{
    /**
...
class_alias(Views::class, \Google\Cloud\Compute\V1\AggregatedListSubnetworksRequest_Views::class);
