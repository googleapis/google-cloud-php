 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRegionSnapshotSettingRequest</code>
 */
class PatchRegionSnapshotSettingRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $snapshot_settings_resource = null;
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchRegionSnapshotSettingRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, \Google\Cloud\Compute\V1\SnapshotSettings $snapshotSettingsResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
