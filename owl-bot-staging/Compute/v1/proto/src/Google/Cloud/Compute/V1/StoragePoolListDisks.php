...
class StoragePoolListDisks extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           Output only. [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\StoragePoolDisk[] $items
     *           A list of StoragePoolDisk resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#storagePoolListDisks for lists of disks in a
     *           storagePool.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.StoragePoolDisk items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\StoragePoolDisk>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.StoragePoolDisk items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\StoragePoolDisk[] $var
     * @return $this
     */
