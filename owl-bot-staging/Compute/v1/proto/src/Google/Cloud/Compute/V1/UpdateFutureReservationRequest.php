 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UpdateFutureReservationRequest</code>
 */
class UpdateFutureReservationRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.FutureReservation future_reservation_resource = 466750493 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\Compute\V1\UpdateFutureReservationRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $futureReservation, \Google\Cloud\Compute\V1\FutureReservation $futureReservationResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
