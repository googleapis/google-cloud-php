...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.CompositeHealthCheckList</code>
 */
class CompositeHealthCheckList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.CompositeHealthCheck items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\CompositeHealthCheck[] $items
     *           A list of CompositeHealthCheck resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of the resource. Alwayscompute#compositeHealthCheck for composite health checks.
