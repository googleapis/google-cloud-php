 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.NetworkPeering.UpdateStrategy</code>
 */
...
class_alias(UpdateStrategy::class, \Google\Cloud\Compute\V1\NetworkPeering_UpdateStrategy::class);
