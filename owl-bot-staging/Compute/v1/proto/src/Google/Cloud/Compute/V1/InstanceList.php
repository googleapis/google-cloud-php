 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InstanceList</code>
 */
class InstanceList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Instance items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Instance[] $items
     *           A list of Instance resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Always compute#instanceList
     *           for lists of Instance resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Instance items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\Instance>
     */
