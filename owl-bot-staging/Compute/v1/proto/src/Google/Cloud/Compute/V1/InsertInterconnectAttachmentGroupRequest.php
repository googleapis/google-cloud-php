 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InsertInterconnectAttachmentGroupRequest</code>
 */
class InsertInterconnectAttachmentGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\InsertInterconnectAttachmentGroupRequest
     *
     * @experimental
     */
    public static function build(string $project, \Google\Cloud\Compute\V1\InterconnectAttachmentGroup $interconnectAttachmentGroupResource): self
    {
        return (new self())
            ->setProject($project)
