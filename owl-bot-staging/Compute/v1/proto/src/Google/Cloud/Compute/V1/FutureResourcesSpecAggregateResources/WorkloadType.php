...
namespace Google\Cloud\Compute\V1\FutureResourcesSpecAggregateResources;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.FutureResourcesSpecAggregateResources.WorkloadType</code>
 */
class WorkloadType
{
    /**
...
class_alias(WorkloadType::class, \Google\Cloud\Compute\V1\FutureResourcesSpecAggregateResources_WorkloadType::class);
