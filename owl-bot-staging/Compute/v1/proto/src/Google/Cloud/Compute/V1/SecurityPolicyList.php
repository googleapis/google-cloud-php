...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SecurityPolicyList</code>
 */
class SecurityPolicyList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.SecurityPolicy items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\SecurityPolicy[] $items
     *           A list of SecurityPolicy resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#securityPolicyList for listsof securityPolicies
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.SecurityPolicy items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\SecurityPolicy>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\SecurityPolicy::class);
        $this->items = $arr;
