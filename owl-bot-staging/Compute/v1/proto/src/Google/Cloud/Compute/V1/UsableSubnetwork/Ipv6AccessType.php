 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.UsableSubnetwork.Ipv6AccessType</code>
 */
...
class_alias(Ipv6AccessType::class, \Google\Cloud\Compute\V1\UsableSubnetwork_Ipv6AccessType::class);
