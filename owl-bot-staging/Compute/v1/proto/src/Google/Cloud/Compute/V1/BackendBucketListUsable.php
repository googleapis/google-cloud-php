...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.BackendBucketListUsable</code>
 */
class BackendBucketListUsable extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendBucket items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\BackendBucket[] $items
     *           A list of BackendBucket resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#usableBackendBucketList for lists of usable backend
     *           buckets.
