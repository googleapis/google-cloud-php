 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RolloutPlansListResponse</code>
 */
class RolloutPlansListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.RolloutPlan items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\RolloutPlan[] $items
     *           A list of RolloutPlan resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.RolloutPlan items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\RolloutPlan>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.RolloutPlan items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\RolloutPlan[] $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\RolloutPlan::class);
        $this->items = $arr;
