...
class InterconnectLocationList extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\InterconnectLocation[] $items
     *           A list of InterconnectLocation resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#interconnectLocationList for lists of interconnect
     *           locations.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InterconnectLocation items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\InterconnectLocation>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InterconnectLocation items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\InterconnectLocation[] $var
     * @return $this
     */
