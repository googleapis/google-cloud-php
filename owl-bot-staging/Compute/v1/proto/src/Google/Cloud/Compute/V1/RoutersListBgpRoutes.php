...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RoutersListBgpRoutes</code>
 */
class RoutersListBgpRoutes extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BgpRoute result = 139315229;</code>
     */
    private $result;
    /**
     ...
     *           Subsequent list requests will have their own nextPageToken to
     *           continue paging through the results.
     *     @type \Google\Cloud\Compute\V1\BgpRoute[] $result
     *           [Output Only] A list of bgp routes.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BgpRoute result = 139315229;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\BgpRoute>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BgpRoute result = 139315229;</code>
     * @param \Google\Cloud\Compute\V1\BgpRoute[] $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\BgpRoute::class);
        $this->result = $arr;
