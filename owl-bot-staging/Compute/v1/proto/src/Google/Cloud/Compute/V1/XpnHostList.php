...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.XpnHostList</code>
 */
class XpnHostList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Project[] $items
     *           [Output Only] A list of shared VPC host project URLs.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Always compute#xpnHostList for
     *           lists of shared VPC hosts.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Project items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\Project>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\Project::class);
        $this->items = $arr;
