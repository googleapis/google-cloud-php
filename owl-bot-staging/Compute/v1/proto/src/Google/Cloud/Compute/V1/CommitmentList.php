 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.CommitmentList</code>
 */
class CommitmentList extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Commitment[] $items
     *           A list of Commitment resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Always compute#commitmentList
     *           for lists of commitments.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Commitment items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\Commitment>
     */
