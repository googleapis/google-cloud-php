...
class BackendServiceCdnPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Compute\V1\BackendServiceCdnPolicyBypassCacheOnRequestHeader[] $bypass_cache_on_request_headers
     *           Bypass the cache when the specified request headers are matched - e.g.
     *           Pragma or Authorization headers. Up to 5 headers can be specified.
     *           The cache is bypassed for all cdnPolicy.cacheMode settings.
     ...
     *           HTTP 405 (Method Not Found), 501 (Not Implemented): 60s.
     *           These defaults can be overridden in negative_caching_policy.
     *     @type \Google\Cloud\Compute\V1\BackendServiceCdnPolicyNegativeCachingPolicy[] $negative_caching_policy
     *           Sets a cache TTL for the specified HTTP status code.
     *           negative_caching must be enabled to configure negative_caching_policy.
     *           Omitting the policy and leaving negative_caching enabled will use
     *           Cloud CDN's default cache TTLs.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyBypassCacheOnRequestHeader bypass_cache_on_request_headers = 486203082;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\BackendServiceCdnPolicyBypassCacheOnRequestHeader>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyBypassCacheOnRequestHeader bypass_cache_on_request_headers = 486203082;</code>
     * @param \Google\Cloud\Compute\V1\BackendServiceCdnPolicyBypassCacheOnRequestHeader[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyNegativeCachingPolicy negative_caching_policy = 155359996;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\BackendServiceCdnPolicyNegativeCachingPolicy>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyNegativeCachingPolicy negative_caching_policy = 155359996;</code>
     * @param \Google\Cloud\Compute\V1\BackendServiceCdnPolicyNegativeCachingPolicy[] $var
     * @return $this
     */
