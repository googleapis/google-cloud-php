...
namespace Google\Cloud\Compute\V1\FutureResourcesSpecLocationPolicyLocation;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.FutureResourcesSpecLocationPolicyLocation.Preference</code>
 */
class Preference
{
    /**
...
class_alias(Preference::class, \Google\Cloud\Compute\V1\FutureResourcesSpecLocationPolicyLocation_Preference::class);
