...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InterconnectGroupsListResponse</code>
 */
class InterconnectGroupsListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InterconnectGroup items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type array<\Google\Cloud\Compute\V1\InterconnectGroup>|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of InterconnectGroup resources.
     *     @type string $kind
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InterconnectGroup items = 100526016;</code>
     * @param array<\Google\Cloud\Compute\V1\InterconnectGroup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\InterconnectGroup::class);
        $this->items = $arr;
