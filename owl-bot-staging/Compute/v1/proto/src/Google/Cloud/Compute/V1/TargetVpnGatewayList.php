 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetVpnGatewayList</code>
 */
class TargetVpnGatewayList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.TargetVpnGateway items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\TargetVpnGateway[] $items
     *           A list of TargetVpnGateway resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Alwayscompute#targetVpnGateway for target VPN gateways.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.TargetVpnGateway items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\TargetVpnGateway>
     */
