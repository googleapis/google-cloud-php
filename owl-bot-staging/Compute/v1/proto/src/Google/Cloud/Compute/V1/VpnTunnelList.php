 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.VpnTunnelList</code>
 */
class VpnTunnelList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.VpnTunnel items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\VpnTunnel[] $items
     *           A list of VpnTunnel resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of resource. Always compute#vpnTunnel for
     *           VPN tunnels.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.VpnTunnel items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\VpnTunnel>
     */
