...
namespace Google\Cloud\Compute\V1\NetworkPeeringConnectionStatusTrafficConfiguration;
...
class_alias(StackType::class, \Google\Cloud\Compute\V1\NetworkPeeringConnectionStatusTrafficConfiguration_StackType::class);
