 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.DeleteRegionBackendBucketRequest</code>
 */
class DeleteRegionBackendBucketRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\DeleteRegionBackendBucketRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $backendBucket): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
