...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.HealthSourceList</code>
 */
class HealthSourceList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.HealthSource items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\HealthSource[] $items
     *           A list of HealthSource resources.
     *     @type string $kind
     *           Output only. [Output Only] Type of the resource. Alwayscompute#healthSource for health sources.
