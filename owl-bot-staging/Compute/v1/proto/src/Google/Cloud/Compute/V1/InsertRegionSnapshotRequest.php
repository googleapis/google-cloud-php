 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InsertRegionSnapshotRequest</code>
 */
class InsertRegionSnapshotRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\InsertRegionSnapshotRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, \Google\Cloud\Compute\V1\Snapshot $snapshotResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
