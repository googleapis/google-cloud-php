...
final class ReservationSubBlocksClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getVersion(GetVersionReservationSubBlockRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function reportFaulty(ReportFaultyReservationSubBlockRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsReservationSubBlockRequest $request, array $callOptions = []): TestPermissionsResponse
    {
