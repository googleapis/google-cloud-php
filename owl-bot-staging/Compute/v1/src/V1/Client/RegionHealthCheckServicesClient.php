 ...
 *
 * @method PromiseInterface<PagedListResponse> aggregatedListAsync(AggregatedListRegionHealthCheckServicesRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface<TestPermissionsResponse> testIamPermissionsAsync(TestIamPermissionsRegionHealthCheckServiceRequest $request, array $optionalArgs = [])
 */
final class RegionHealthCheckServicesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionHealthCheckServices';
     ...
     *           $options = new RegionHealthCheckServicesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see RegionHealthCheckServicesClient::aggregatedListAsync()} .
     *
     * @example samples/V1/RegionHealthCheckServicesClient/aggregated_list.php
     *
     * @param AggregatedListRegionHealthCheckServicesRequest $request     A request to house fields associated with the call.
     ...
     */
    public function aggregatedList(AggregatedListRegionHealthCheckServicesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteRegionHealthCheckServiceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionHealthCheckServiceRequest $request, array $callOptions = []): HealthCheckService
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionHealthCheckServiceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionHealthCheckServicesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchRegionHealthCheckServiceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is
     * {@see RegionHealthCheckServicesClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/RegionHealthCheckServicesClient/test_iam_permissions.php
     *
     * @param TestIamPermissionsRegionHealthCheckServiceRequest $request     A request to house fields associated with the call.
     * @param array                                             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionHealthCheckServiceRequest $request, array $callOptions = []): TestPermissionsResponse
    {
