...
final class BackendServicesClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getEffectiveSecurityPolicies(GetEffectiveSecurityPoliciesBackendServiceRequest $request, array $callOptions = []): GetEffectiveSecurityPoliciesBackendServiceResponse
    {
