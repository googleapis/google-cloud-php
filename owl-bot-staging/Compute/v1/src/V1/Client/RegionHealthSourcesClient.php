...
final class RegionHealthSourcesClient
{
     ...
     */
    public function aggregatedList(AggregatedListRegionHealthSourcesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionHealthSourceRequest $request, array $callOptions = []): TestPermissionsResponse
    {
