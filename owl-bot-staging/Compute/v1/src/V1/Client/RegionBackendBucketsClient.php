...
final class RegionBackendBucketsClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listUsable(ListUsableRegionBackendBucketsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionBackendBucketRequest $request, array $callOptions = []): TestPermissionsResponse
    {
