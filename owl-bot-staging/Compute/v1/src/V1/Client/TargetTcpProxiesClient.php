...
final class TargetTcpProxiesClient
{
     ...
     *           $options = new TargetTcpProxiesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsTargetTcpProxyRequest $request, array $callOptions = []): TestPermissionsResponse
    {
