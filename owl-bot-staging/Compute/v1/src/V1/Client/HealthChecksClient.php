...
final class HealthChecksClient
{
     ...
     *           $options = new HealthChecksClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsHealthCheckRequest $request, array $callOptions = []): TestPermissionsResponse
    {
