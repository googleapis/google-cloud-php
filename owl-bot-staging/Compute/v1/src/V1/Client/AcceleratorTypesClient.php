 ...
 *
 * @method PromiseInterface<PagedListResponse> aggregatedListAsync(AggregatedListAcceleratorTypesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<AcceleratorType> getAsync(GetAcceleratorTypeRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListAcceleratorTypesRequest $request, array $optionalArgs = [])
 */
final class AcceleratorTypesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.AcceleratorTypes';
     ...
     *           $options = new AcceleratorTypesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function aggregatedList(AggregatedListAcceleratorTypesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetAcceleratorTypeRequest $request, array $callOptions = []): AcceleratorType
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListAcceleratorTypesRequest $request, array $callOptions = []): PagedListResponse
    {
