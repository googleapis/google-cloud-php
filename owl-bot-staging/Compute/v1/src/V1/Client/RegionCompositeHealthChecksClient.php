...
final class RegionCompositeHealthChecksClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_composite_health_checks_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public function aggregatedList(AggregatedListRegionCompositeHealthChecksRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getHealth(GetHealthRegionCompositeHealthCheckRequest $request, array $callOptions = []): CompositeHealthCheckHealth
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionCompositeHealthCheckRequest $request, array $callOptions = []): TestPermissionsResponse
    {
