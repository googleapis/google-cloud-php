...
final class TargetVpnGatewaysClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.TargetVpnGateways';
     ...
     *           $options = new TargetVpnGatewaysClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteTargetVpnGatewayRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetTargetVpnGatewayRequest $request, array $callOptions = []): TargetVpnGateway
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertTargetVpnGatewayRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListTargetVpnGatewaysRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function setLabels(SetLabelsTargetVpnGatewayRequest $request, array $callOptions = []): OperationResponse
    {
