...
final class UrlMapsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.UrlMaps';
     ...
     */
    public function aggregatedList(AggregatedListUrlMapsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetUrlMapRequest $request, array $callOptions = []): UrlMap
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function invalidateCache(InvalidateCacheUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('InvalidateCache', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListUrlMapsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsUrlMapRequest $request, array $callOptions = []): TestPermissionsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function update(UpdateUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function validate(ValidateUrlMapRequest $request, array $callOptions = []): UrlMapsValidateResponse
    {
        return $this->startApiCall('Validate', $request, $callOptions)->wait();
    }
}
