...
final class RegionInstantSnapshotGroupsClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_instant_snapshot_groups_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getIamPolicy(GetIamPolicyRegionInstantSnapshotGroupRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function setIamPolicy(SetIamPolicyRegionInstantSnapshotGroupRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionInstantSnapshotGroupRequest $request, array $callOptions = []): TestPermissionsResponse
    {
