...
final class RegionNotificationEndpointsClient
{
     ...
     */
    public function aggregatedList(AggregatedListRegionNotificationEndpointsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionNotificationEndpointRequest $request, array $callOptions = []): TestPermissionsResponse
    {
