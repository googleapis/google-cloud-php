...
final class AutoscalersClient
{
     ...
     *           $options = new AutoscalersClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsAutoscalerRequest $request, array $callOptions = []): TestPermissionsResponse
    {
