 ...
 *
 * @method PromiseInterface<DiskType> getAsync(GetRegionDiskTypeRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListRegionDiskTypesRequest $request, array $optionalArgs = [])
 */
final class RegionDiskTypesClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionDiskTypes';
     ...
     *           $options = new RegionDiskTypesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function get(GetRegionDiskTypeRequest $request, array $callOptions = []): DiskType
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionDiskTypesRequest $request, array $callOptions = []): PagedListResponse
    {
