...
final class RegionHealthChecksClient
{
     ...
     *           $options = new RegionHealthChecksClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionHealthCheckRequest $request, array $callOptions = []): TestPermissionsResponse
    {
