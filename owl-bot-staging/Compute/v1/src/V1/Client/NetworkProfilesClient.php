...
final class NetworkProfilesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.NetworkProfiles';
     ...
     *           $options = new NetworkProfilesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function get(GetNetworkProfileRequest $request, array $callOptions = []): NetworkProfile
    {
