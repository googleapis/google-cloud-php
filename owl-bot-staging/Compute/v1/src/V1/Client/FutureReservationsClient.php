 ...
 *
 * @method PromiseInterface<PagedListResponse> aggregatedListAsync(AggregatedListFutureReservationsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> cancelAsync(CancelFutureReservationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> deleteAsync(DeleteFutureReservationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<FutureReservation> getAsync(GetFutureReservationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> insertAsync(InsertFutureReservationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListFutureReservationsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> updateAsync(UpdateFutureReservationRequest $request, array $optionalArgs = [])
 */
final class FutureReservationsClient
{
     ...
     */
    public function aggregatedList(AggregatedListFutureReservationsRequest $request, array $callOptions = []): PagedListResponse
    {
