 ...
 * @method PromiseInterface<TestPermissionsResponse> testIamPermissionsAsync(TestIamPermissionsRegionAutoscalerRequest $request, array $optionalArgs = [])
...
final class RegionAutoscalersClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionAutoscalers';
     ...
     */
    public function delete(DeleteRegionAutoscalerRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionAutoscalerRequest $request, array $callOptions = []): Autoscaler
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionAutoscalerRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionAutoscalersRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchRegionAutoscalerRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionAutoscalersClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/RegionAutoscalersClient/test_iam_permissions.php
     *
     * @param TestIamPermissionsRegionAutoscalerRequest $request     A request to house fields associated with the call.
     * @param array                                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRegionAutoscalerRequest $request, array $callOptions = []): TestPermissionsResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function update(UpdateRegionAutoscalerRequest $request, array $callOptions = []): OperationResponse
    {
