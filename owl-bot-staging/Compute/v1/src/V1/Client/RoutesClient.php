...
final class RoutesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.Routes';
     ...
     *           $options = new RoutesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function delete(DeleteRouteRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRouteRequest $request, array $callOptions = []): Route
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRouteRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsRouteRequest $request, array $callOptions = []): TestPermissionsResponse
    {
