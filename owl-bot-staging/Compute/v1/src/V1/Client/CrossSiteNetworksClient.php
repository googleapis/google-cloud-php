 ...
 *
 * @method PromiseInterface<OperationResponse> deleteAsync(DeleteCrossSiteNetworkRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<CrossSiteNetwork> getAsync(GetCrossSiteNetworkRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> insertAsync(InsertCrossSiteNetworkRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListCrossSiteNetworksRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> patchAsync(PatchCrossSiteNetworkRequest $request, array $optionalArgs = [])
 */
