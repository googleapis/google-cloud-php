...
return [
    'interfaces' => [
        'google.cloud.compute.v1.RegionHealthSources' => [
            'AggregatedList' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/aggregated/healthSources',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/healthSources/{health_source}',
                'placeholders' => [
                    'health_source' => [
                        'getters' => [
                            'getHealthSource',
            ...
            'TestIamPermissions' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/healthSources/{resource}/testIamPermissions',
