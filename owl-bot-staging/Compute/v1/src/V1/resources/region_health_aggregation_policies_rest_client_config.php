...
return [
    'interfaces' => [
        'google.cloud.compute.v1.RegionHealthAggregationPolicies' => [
            'AggregatedList' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/aggregated/healthAggregationPolicies',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/healthAggregationPolicies/{health_aggregation_policy}',
                'placeholders' => [
            ...
            'Insert' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/healthAggregationPolicies',
            ...
            'TestIamPermissions' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/healthAggregationPolicies/{resource}/testIamPermissions',
