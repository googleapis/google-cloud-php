...
final class AnalyticsAdminServiceClient
{
     ...
     * @experimental
     */
    public function getUserProvidedDataSettings(GetUserProvidedDataSettingsRequest $request, array $callOptions = []): UserProvidedDataSettings
    {
     ...
     * @experimental
     */
    public function updateReportingIdentitySettings(UpdateReportingIdentitySettingsRequest $request, array $callOptions = []): ReportingIdentitySettings
    {
