...
namespace Google\Analytics\Admin\V1alpha\DataRetentionSettings;
 ...
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.DataRetentionSettings.RetentionDuration</code>
 */
