 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.UpdateBigQueryLinkRequest</code>
 */
class UpdateBigQueryLinkRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *                                                                   fields.
     *
     * @return \Google\Analytics\Admin\V1alpha\UpdateBigQueryLinkRequest
     *
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1alpha\BigQueryLink $bigqueryLink, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
