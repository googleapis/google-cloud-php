...
class UpdateAccountRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                            fields.
     *
     * @return \Google\Analytics\Admin\V1alpha\UpdateAccountRequest
     *
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1alpha\Account $account, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
            ->setAccount($account)
