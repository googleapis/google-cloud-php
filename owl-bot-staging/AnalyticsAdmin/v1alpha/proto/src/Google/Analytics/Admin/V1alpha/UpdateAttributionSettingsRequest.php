...
class UpdateAttributionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                 fields.
     *
     * @return \Google\Analytics\Admin\V1alpha\UpdateAttributionSettingsRequest
     *
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1alpha\AttributionSettings $attributionSettings, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
