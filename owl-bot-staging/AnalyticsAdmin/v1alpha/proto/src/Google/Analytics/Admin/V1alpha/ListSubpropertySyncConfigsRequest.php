 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListSubpropertySyncConfigsRequest</code>
 */
class ListSubpropertySyncConfigsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Resource name of the property.
     *                       Format: properties/property_id
     *                       Example: properties/123
     *                       Please see {@see AnalyticsAdminServiceClient::propertyName()} for help formatting this field.
     *
     * @return \Google\Analytics\Admin\V1alpha\ListSubpropertySyncConfigsRequest
     *
     * @experimental
     */
