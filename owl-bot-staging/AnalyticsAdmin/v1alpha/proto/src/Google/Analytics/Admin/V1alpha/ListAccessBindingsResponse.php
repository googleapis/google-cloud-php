 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListAccessBindingsResponse</code>
 */
class ListAccessBindingsResponse extends \Google\Protobuf\Internal\Message
{
    /**
