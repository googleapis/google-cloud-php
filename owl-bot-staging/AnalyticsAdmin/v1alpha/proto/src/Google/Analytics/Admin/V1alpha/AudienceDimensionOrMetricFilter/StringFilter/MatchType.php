...
namespace Google\Analytics\Admin\V1alpha\AudienceDimensionOrMetricFilter\StringFilter;
 ...
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.AudienceDimensionOrMetricFilter.StringFilter.MatchType</code>
 */
class MatchType
{
    /**
