 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListAccessBindingsRequest</code>
 */
class ListAccessBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Required. Formats:
     * - accounts/{account}
