...
class UpdateDataRetentionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                    fields.
     *
     * @return \Google\Analytics\Admin\V1beta\UpdateDataRetentionSettingsRequest
     *
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1beta\DataRetentionSettings $dataRetentionSettings, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
