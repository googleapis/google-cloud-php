 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1beta.UpdateCustomMetricRequest</code>
 */
class UpdateCustomMetricRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1beta.CustomMetric custom_metric = 1;</code>
     */
     ...
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1beta\CustomMetric $customMetric, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
