...
class RunAccessReportResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Analytics\Admin\V1beta\AccessDimensionHeader[] $dimension_headers
     *           The header for a column in the report that corresponds to a specific
     *           dimension. The number of DimensionHeaders and ordering of DimensionHeaders
     *           matches the dimensions present in rows.
     *     @type \Google\Analytics\Admin\V1beta\AccessMetricHeader[] $metric_headers
     *           The header for a column in the report that corresponds to a specific
     *           metric. The number of MetricHeaders and ordering of MetricHeaders matches
     *           the metrics present in rows.
     *     @type \Google\Analytics\Admin\V1beta\AccessRow[] $rows
     *           Rows of dimension value combinations and metric values in the report.
     *     @type int $row_count
     *           The total number of rows in the query result. `rowCount` is independent of
     *           the number of rows returned in the response, the `limit` request
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessDimensionHeader dimension_headers = 1;</code>
     * @return RepeatedField<\Google\Analytics\Admin\V1beta\AccessDimensionHeader>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessDimensionHeader dimension_headers = 1;</code>
     * @param \Google\Analytics\Admin\V1beta\AccessDimensionHeader[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessMetricHeader metric_headers = 2;</code>
     * @return RepeatedField<\Google\Analytics\Admin\V1beta\AccessMetricHeader>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessMetricHeader metric_headers = 2;</code>
     * @param \Google\Analytics\Admin\V1beta\AccessMetricHeader[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessRow rows = 3;</code>
     * @return RepeatedField<\Google\Analytics\Admin\V1beta\AccessRow>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.analytics.admin.v1beta.AccessRow rows = 3;</code>
     * @param \Google\Analytics\Admin\V1beta\AccessRow[] $var
     * @return $this
     */
