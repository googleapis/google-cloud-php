 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1beta.UpdateKeyEventRequest</code>
 */
class UpdateKeyEventRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                            fields.
     *
     * @return \Google\Analytics\Admin\V1beta\UpdateKeyEventRequest
     *
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1beta\KeyEvent $keyEvent, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
     ...
     *
     *     @type \Google\Analytics\Admin\V1beta\KeyEvent $key_event
     *           Required. The Key Event to update.
     *           The `name` field is used to identify the settings to be updated.
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1beta.KeyEvent key_event = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Analytics\Admin\V1beta\KeyEvent|null
     */
