...
class ConversionEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.analytics.admin.v1beta.ConversionEvent.DefaultConversionValue default_conversion_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           events within a session. If this value is not provided, it will be set to
     *           `ONCE_PER_EVENT`.
     *     @type \Google\Analytics\Admin\V1beta\ConversionEvent\DefaultConversionValue $default_conversion_value
     *           Optional. Defines a default value/currency for a conversion event.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Analytics\Admin\V1beta\ConversionEvent\ConversionCountingMethod::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.analytics.admin.v1beta.ConversionEvent.DefaultConversionValue default_conversion_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Analytics\Admin\V1beta\ConversionEvent\DefaultConversionValue|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.analytics.admin.v1beta.ConversionEvent.DefaultConversionValue default_conversion_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Analytics\Admin\V1beta\ConversionEvent\DefaultConversionValue $var
     * @return $this
     */
    public function setDefaultConversionValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Analytics\Admin\V1beta\ConversionEvent\DefaultConversionValue::class);
