 ...
 * https://github.com/googleapis/googleapis/blob/master/google/api/cloudquotas/v1/quota_adjuster_settings.proto
...
final class QuotaAdjusterSettingsManagerClient
{
    ...
    private const SERVICE_NAME = 'google.api.cloudquotas.v1.QuotaAdjusterSettingsManager';
     ...
     *           use Google\Cloud\CloudQuotas\V1\QuotaAdjusterSettingsManagerClient;
     ...
     *
     * @example samples/V1/QuotaAdjusterSettingsManagerClient/get_quota_adjuster_settings.php
     *
     ...
     *
     * @example samples/V1/QuotaAdjusterSettingsManagerClient/update_quota_adjuster_settings.php
     *
