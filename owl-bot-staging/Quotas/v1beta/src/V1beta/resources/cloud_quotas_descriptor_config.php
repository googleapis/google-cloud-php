    ...
    'interfaces' => [
        'google.api.cloudquotas.v1beta.CloudQuotas' => [
            'CreateQuotaPreference' => [
                ...
                'responseType' => 'Google\Cloud\CloudQuotas\V1beta\QuotaPreference',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'GetQuotaInfo' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\CloudQuotas\V1beta\QuotaInfo',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListQuotaInfos' => [
                ...
                'responseType' => 'Google\Cloud\CloudQuotas\V1beta\ListQuotaInfosResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListQuotaPreferences' => [
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\CloudQuotas\V1beta\ListQuotaPreferencesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
