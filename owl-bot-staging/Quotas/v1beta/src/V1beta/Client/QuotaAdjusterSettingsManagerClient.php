 ...
 * https://github.com/googleapis/googleapis/blob/master/google/api/cloudquotas/v1beta/quota_adjuster_settings.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\CloudQuotas\V1beta\Client;
 ...
 * @experimental
 *
 * @method PromiseInterface<QuotaAdjusterSettings> getQuotaAdjusterSettingsAsync(GetQuotaAdjusterSettingsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<QuotaAdjusterSettings> updateQuotaAdjusterSettingsAsync(UpdateQuotaAdjusterSettingsRequest $request, array $optionalArgs = [])
 */
final class QuotaAdjusterSettingsManagerClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.api.cloudquotas.v1beta.QuotaAdjusterSettingsManager';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/quota_adjuster_settings_manager_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/quota_adjuster_settings_manager_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/quota_adjuster_settings_manager_grpc_config.json',
            'credentialsConfig' => [
     ...
     * @param string $location
     *
     * @return string The formatted quota_adjuster_settings resource.
     *
     * @experimental
     */
    public static function quotaAdjusterSettingsName(string $project, string $location): string
    {
        return self::getPathTemplate('quotaAdjusterSettings')->render([
            'project' => $project,
            'location' => $location,
        ]);
    }
     ...
     *           use Google\Cloud\CloudQuotas\V1beta\QuotaAdjusterSettingsManagerClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new QuotaAdjusterSettingsManagerClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1beta/QuotaAdjusterSettingsManagerClient/get_quota_adjuster_settings.php
     *
     * @param GetQuotaAdjusterSettingsRequest $request     A request to house fields associated with the call.
     ...
     *
     * @example samples/V1beta/QuotaAdjusterSettingsManagerClient/update_quota_adjuster_settings.php
     *
     * @param UpdateQuotaAdjusterSettingsRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
