 ...
 *
 * Generated from protobuf message <code>google.api.cloudquotas.v1beta.QuotaConfig</code>
 */
class QuotaConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.api.cloudquotas.v1beta.QuotaConfig.Origin request_origin = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudQuotas\V1beta\QuotaConfig\Origin::class);
