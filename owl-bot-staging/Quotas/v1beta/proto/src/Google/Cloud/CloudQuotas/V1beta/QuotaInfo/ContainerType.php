...
namespace Google\Cloud\CloudQuotas\V1beta\QuotaInfo;
 ...
 *
 * Protobuf type <code>google.api.cloudquotas.v1beta.QuotaInfo.ContainerType</code>
 */
class ContainerType
{
    /**
...
class_alias(ContainerType::class, \Google\Cloud\CloudQuotas\V1beta\QuotaInfo_ContainerType::class);
