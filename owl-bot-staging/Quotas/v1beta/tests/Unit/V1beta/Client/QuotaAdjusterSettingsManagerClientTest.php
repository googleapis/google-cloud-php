...
class QuotaAdjusterSettingsManagerClientTest extends GeneratedTest
{
    ...
    public function getQuotaAdjusterSettingsTest()
    {
        ...
        $this->assertSame('/google.api.cloudquotas.v1beta.QuotaAdjusterSettingsManager/GetQuotaAdjusterSettings', $actualFuncCall);
    ...
    public function updateQuotaAdjusterSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.QuotaAdjusterSettingsManager/UpdateQuotaAdjusterSettings', $actualFuncCall);
