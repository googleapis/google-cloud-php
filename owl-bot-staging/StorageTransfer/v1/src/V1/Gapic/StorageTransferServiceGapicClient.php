...
class StorageTransferServiceGapicClient
{
    ...
    private static function getAgentPoolsNameTemplate()
    {
        if (self::$agentPoolsNameTemplate == null) {
            self::$agentPoolsNameTemplate = new PathTemplate('projects/{project_id}/agentPools/{agent_pool_id}');
        }
     ...
     */
    public function createAgentPool($projectId, $agentPool, $agentPoolId, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateAgentPool', AgentPool::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createTransferJob($transferJob, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateTransferJob', TransferJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteAgentPool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteAgentPool', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteTransferJob($jobName, $projectId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteTransferJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getAgentPool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAgentPool', AgentPool::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getGoogleServiceAccount($projectId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetGoogleServiceAccount', GoogleServiceAccount::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getTransferJob($jobName, $projectId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTransferJob', TransferJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listAgentPools($projectId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListAgentPools', $optionalArgs, ListAgentPoolsResponse::class, $request);
    }
    ...
    public function listTransferJobs($filter, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('ListTransferJobs', $optionalArgs, ListTransferJobsResponse::class, $request);
    }
    ...
    public function pauseTransferOperation($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('PauseTransferOperation', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function resumeTransferOperation($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ResumeTransferOperation', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function runTransferJob($jobName, $projectId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RunTransferJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function updateAgentPool($agentPool, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateAgentPool', AgentPool::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTransferJob($jobName, $projectId, $transferJob, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['updateTransferJobFieldMask'])) {
            $request->setUpdateTransferJobFieldMask($optionalArgs['updateTransferJobFieldMask']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateTransferJob', TransferJob::class, $optionalArgs, $request)->wait();
    }
}
