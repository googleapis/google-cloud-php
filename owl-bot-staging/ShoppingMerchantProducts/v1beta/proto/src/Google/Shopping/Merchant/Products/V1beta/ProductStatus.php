 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.products.v1beta.ProductStatus</code>
 */
class ProductStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.DestinationStatus destination_statuses = 3;</code>
     */
    private $destination_statuses;
    /**
     * A list of all issues associated with the product.
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.ItemLevelIssue item_level_issues = 4;</code>
     */
     ...
     *
     *     @type \Google\Shopping\Merchant\Products\V1beta\ProductStatus\DestinationStatus[] $destination_statuses
     *           The intended destinations for the product.
     *     @type \Google\Shopping\Merchant\Products\V1beta\ProductStatus\ItemLevelIssue[] $item_level_issues
     *           A list of all issues associated with the product.
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.DestinationStatus destination_statuses = 3;</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Products\V1beta\ProductStatus\DestinationStatus>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.DestinationStatus destination_statuses = 3;</code>
     * @param \Google\Shopping\Merchant\Products\V1beta\ProductStatus\DestinationStatus[] $var
     * @return $this
     */
    public function setDestinationStatuses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Products\V1beta\ProductStatus\DestinationStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.ItemLevelIssue item_level_issues = 4;</code>
     * @return RepeatedField<\Google\Shopping\Merchant\Products\V1beta\ProductStatus\ItemLevelIssue>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.products.v1beta.ProductStatus.ItemLevelIssue item_level_issues = 4;</code>
     * @param \Google\Shopping\Merchant\Products\V1beta\ProductStatus\ItemLevelIssue[] $var
     * @return $this
     */
    public function setItemLevelIssues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Products\V1beta\ProductStatus\ItemLevelIssue::class);
