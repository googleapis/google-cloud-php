...
namespace Google\Shopping\Merchant\Products\V1beta\ProductSustainabilityIncentive;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.products.v1beta.ProductSustainabilityIncentive.Type</code>
 */
class Type
{
    /**
