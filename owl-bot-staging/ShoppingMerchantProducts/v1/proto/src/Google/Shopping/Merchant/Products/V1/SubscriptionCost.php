 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.products.v1.SubscriptionCost</code>
 */
class SubscriptionCost extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Products\V1\SubscriptionPeriod::class);
        $this->period = $var;
