 ...
 *
 * Generated from protobuf message <code>google.cloud.speech.v1.SpeechAdaptation</code>
 */
class SpeechAdaptation extends \Google\Protobuf\Internal\Message
{
     ...
     * `custom_class_id`.
     *
     * Generated from protobuf field <code>repeated .google.cloud.speech.v1.CustomClass custom_classes = 3;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar abnf_grammar = 4;</code>
     */
    protected $abnf_grammar = null;
     ...
     *           `custom_class_id`. Refer to the inline defined class in phrase hints by its
     *           `custom_class_id`.
     *     @type \Google\Cloud\Speech\V1\SpeechAdaptation\ABNFGrammar $abnf_grammar
     *           Augmented Backus-Naur form (ABNF) is a standardized grammar notation
     *           comprised by a set of derivation rules.
     *           See specifications: https://www.w3.org/TR/speech-grammar
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar abnf_grammar = 4;</code>
     * @return \Google\Cloud\Speech\V1\SpeechAdaptation\ABNFGrammar|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.speech.v1.SpeechAdaptation.ABNFGrammar abnf_grammar = 4;</code>
     * @param \Google\Cloud\Speech\V1\SpeechAdaptation\ABNFGrammar $var
     * @return $this
     */
    public function setAbnfGrammar($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Speech\V1\SpeechAdaptation\ABNFGrammar::class);
