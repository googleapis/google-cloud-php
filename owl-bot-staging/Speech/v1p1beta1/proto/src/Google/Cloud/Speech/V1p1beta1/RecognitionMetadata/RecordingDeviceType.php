 ...
 *
 * Protobuf type <code>google.cloud.speech.v1p1beta1.RecognitionMetadata.RecordingDeviceType</code>
 */
...
class_alias(RecordingDeviceType::class, \Google\Cloud\Speech\V1p1beta1\RecognitionMetadata_RecordingDeviceType::class);
