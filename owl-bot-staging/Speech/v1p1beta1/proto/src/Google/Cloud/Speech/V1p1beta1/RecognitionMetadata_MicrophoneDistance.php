...
@trigger_error('Google\Cloud\Speech\V1p1beta1\RecognitionMetadata_MicrophoneDistance is deprecated and will be removed in the next major release. Use Google\Cloud\Speech\V1p1beta1\RecognitionMetadata\MicrophoneDistance instead', E_USER_DEPRECATED);
