...
@trigger_error('Google\Cloud\Speech\V1p1beta1\RecognitionMetadata_OriginalMediaType is deprecated and will be removed in the next major release. Use Google\Cloud\Speech\V1p1beta1\RecognitionMetadata\OriginalMediaType instead', E_USER_DEPRECATED);
