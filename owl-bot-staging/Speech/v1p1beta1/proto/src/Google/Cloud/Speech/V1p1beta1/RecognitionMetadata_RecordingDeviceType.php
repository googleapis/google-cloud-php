...
@trigger_error('Google\Cloud\Speech\V1p1beta1\RecognitionMetadata_RecordingDeviceType is deprecated and will be removed in the next major release. Use Google\Cloud\Speech\V1p1beta1\RecognitionMetadata\RecordingDeviceType instead', E_USER_DEPRECATED);
