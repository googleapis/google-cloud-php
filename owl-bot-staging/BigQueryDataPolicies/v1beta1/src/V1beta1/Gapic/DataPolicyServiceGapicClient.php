 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/bigquery/datapolicies/v1beta1/datapolicy.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\BigQuery\DataPolicies\V1beta1\Gapic;
...
use Google\Cloud\BigQuery\DataPolicies\V1beta1\CreateDataPolicyRequest;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\DataPolicy;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\DeleteDataPolicyRequest;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\GetDataPolicyRequest;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\ListDataPoliciesRequest;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\ListDataPoliciesResponse;
use Google\Cloud\BigQuery\DataPolicies\V1beta1\UpdateDataPolicyRequest;
...
class DataPolicyServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/data_policy_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/data_policy_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/data_policy_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/data_policy_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getDataPolicyNameTemplate()
    {
        if (self::$dataPolicyNameTemplate == null) {
            self::$dataPolicyNameTemplate = new PathTemplate('projects/{project}/locations/{location}/dataPolicies/{data_policy}');
        }
     ...
     * ```
     *
     * @param string     $parent       Required. Resource name of the project that the data policy will belong to. The
     ...
     * @experimental
     */
    public function createDataPolicy($parent, $dataPolicy, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateDataPolicy', DataPolicy::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteDataPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteDataPolicy', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDataPolicy($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDataPolicy', DataPolicy::class, $optionalArgs, $request)->wait();
    }
     ...
     * ```
     *
     * @param string $parent       Required. Resource name of the project for which to list data policies. Format is
    ...
    public function listDataPolicies($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDataPolicies', $optionalArgs, ListDataPoliciesResponse::class, $request);
    }
    ...
    public function updateDataPolicy($dataPolicy, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateDataPolicy', DataPolicy::class, $optionalArgs, $request)->wait();
    }
}
