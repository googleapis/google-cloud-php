...
// [START vmmigration_v1_generated_VmMigration_FinalizeMigration_sync]
...
function finalize_migration_sample(string $formattedMigratingVm): void
{
    ...
    try {
        ...
        if ($response->operationSucceeded()) {
            /** @var FinalizeMigrationResponse $response */
...
// [END vmmigration_v1_generated_VmMigration_FinalizeMigration_sync]
