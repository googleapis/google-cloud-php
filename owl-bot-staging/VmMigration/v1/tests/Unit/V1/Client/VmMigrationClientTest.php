...
namespace Google\Cloud\VMMigration\Tests\Unit\V1\Client;
...
class VmMigrationClientTest extends GeneratedTest
{
    ...
    public function cancelDiskMigrationJobTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->diskMigrationJobName('[PROJECT]', '[LOCATION]', '[SOURCE]', '[DISK_MIGRATION_JOB]');
    ...
    public function createCloneJobTest()
    {
        ...
        $response = $gapicClient->createCloneJob($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createCutoverJobTest()
    {
        ...
        $response = $gapicClient->createCutoverJob($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createDatacenterConnectorTest()
    {
        ...
        $response = $gapicClient->createDatacenterConnector($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createMigratingVmTest()
    {
        ...
        $response = $gapicClient->createMigratingVm($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createTargetProjectTest()
    {
        ...
        $response = $gapicClient->createTargetProject($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createUtilizationReportTest()
    {
        ...
        $response = $gapicClient->createUtilizationReport($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function deleteImageImportTest()
    {
        ...
        $request = (new DeleteImageImportRequest())
            ->setName($formattedName);
    ...
    public function extendMigrationTest()
    {
        ...
        $request = (new ExtendMigrationRequest())
    ...
    public function getDiskMigrationJobTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->diskMigrationJobName('[PROJECT]', '[LOCATION]', '[SOURCE]', '[DISK_MIGRATION_JOB]');
        $request = (new GetDiskMigrationJobRequest())
            ->setName($formattedName);
    ...
    public function getImageImportTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->imageImportName('[PROJECT]', '[LOCATION]', '[JOB]');
        $request = (new GetImageImportRequest())
            ->setName($formattedName);
    ...
    public function getImageImportJobTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->imageImportJobName('[PROJECT]', '[LOCATION]', '[JOB]', '[RESULT]');
        $request = (new GetImageImportJobRequest())
            ->setName($formattedName);
    ...
    public function listDiskMigrationJobsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->sourceName('[PROJECT]', '[LOCATION]', '[SOURCE]');
        $request = (new ListDiskMigrationJobsRequest())
            ->setParent($formattedParent);
    ...
    public function listImageImportJobsTest()
    {
        ...
        $request = (new ListImageImportJobsRequest())
            ->setParent($formattedParent);
    ...
    public function listImageImportsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListImageImportsRequest())
            ->setParent($formattedParent);
    ...
    /** @test */
    public function addGroupMigrationAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
