...
class AwsSourceVmDetails extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The total size of the disks being migrated in bytes.
     *     @type \Google\Cloud\VMMigration\V1\AwsSourceVmDetails\AwsDiskDetails[] $disks
     *           Output only. The disks attached to the source VM.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vmmigration.v1.AwsSourceVmDetails.AwsDiskDetails disks = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Cloud\VMMigration\V1\AwsSourceVmDetails\AwsDiskDetails>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vmmigration.v1.AwsSourceVmDetails.AwsDiskDetails disks = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\VMMigration\V1\AwsSourceVmDetails\AwsDiskDetails[] $var
     * @return $this
     */
