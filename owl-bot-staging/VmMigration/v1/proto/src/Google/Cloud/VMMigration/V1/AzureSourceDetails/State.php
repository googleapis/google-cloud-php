 ...
 *
 * Protobuf type <code>google.cloud.vmmigration.v1.AzureSourceDetails.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\VMMigration\V1\AzureSourceDetails_State::class);
