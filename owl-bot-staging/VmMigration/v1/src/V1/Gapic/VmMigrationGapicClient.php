 ...
 * \Google\Cloud\VMMigration\V1\Client\VmMigrationClient} to use the new surface.
 */
class VmMigrationGapicClient
{
    ...
    private static function getReplicationCycleNameTemplate()
    {
        if (self::$replicationCycleNameTemplate == null) {
            self::$replicationCycleNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sources/{source}/migratingVms/{migrating_vm}/replicationCycles/{replication_cycle}');
        }
     ...
     */
    public static function replicationCycleName($project, $location, $source, $migratingVm, $replicationCycle)
    {
    ...
    public function getReplicationCycle($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetReplicationCycle', ReplicationCycle::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listReplicationCycles($parent, $pageToken, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListReplicationCycles', $optionalArgs, ListReplicationCyclesResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function upgradeAppliance($datacenterConnector, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpgradeAppliance', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
