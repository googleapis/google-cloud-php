...
@trigger_error('Google\Cloud\DataCatalog\V1\PhysicalSchema_AvroSchema is deprecated and will be removed in the next major release. Use Google\Cloud\DataCatalog\V1\PhysicalSchema\AvroSchema instead', E_USER_DEPRECATED);
