...
class AnnotateVideoResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\VideoIntelligence\V1\VideoAnnotationResults[] $annotation_results
     *           Annotation results for all videos specified in `AnnotateVideoRequest`.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.videointelligence.v1.VideoAnnotationResults annotation_results = 1;</code>
     * @return RepeatedField<\Google\Cloud\VideoIntelligence\V1\VideoAnnotationResults>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.videointelligence.v1.VideoAnnotationResults annotation_results = 1;</code>
     * @param \Google\Cloud\VideoIntelligence\V1\VideoAnnotationResults[] $var
     * @return $this
     */
