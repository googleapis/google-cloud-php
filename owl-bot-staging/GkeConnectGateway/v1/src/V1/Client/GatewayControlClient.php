 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/gkeconnect/gateway/v1/control.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\GkeConnect\Gateway\V1\Client;
...
final class GatewayControlClient
{
     ...
     *           use Google\Cloud\GkeConnect\Gateway\V1\GatewayControlClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new GatewayControlClient(['credentials' => $creds]);
     *           ```
     *           {@see
