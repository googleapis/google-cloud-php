...
class CloudBillingGapicClient
{
    ...
    private static function getOrganizationBillingAccountNameTemplate()
    {
        if (self::$organizationBillingAccountNameTemplate == null) {
            self::$organizationBillingAccountNameTemplate = new PathTemplate('organizations/{organization}/billingAccounts/{billing_account}');
        }
    ...
    private static function getProjectBillingInfoNameTemplate()
    {
        if (self::$projectBillingInfoNameTemplate == null) {
            self::$projectBillingInfoNameTemplate = new PathTemplate('projects/{project}/billingInfo');
        }
     ...
     */
    public static function organizationBillingAccountName($organization, $billingAccount)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function moveBillingAccount($name, $destinationParent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MoveBillingAccount', BillingAccount::class, $optionalArgs, $request)->wait();
    }
