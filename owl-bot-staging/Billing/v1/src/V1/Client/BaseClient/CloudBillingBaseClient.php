...
namespace Google\Cloud\Billing\V1\Client\BaseClient;
 ...
 */
abstract class CloudBillingBaseClient
{
     ...
     *
     * The async variant is {@see self::getBillingAccountAsync()} .
     *
     ...
     * role.
     *
     * The async variant is {@see self::getProjectBillingInfoAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listBillingAccountsAsync()} .
     *
     ...
     * [viewers](https://cloud.google.com/billing/docs/how-to/billing-access).
     *
     * The async variant is {@see self::listProjectBillingInfoAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateBillingAccountAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateProjectBillingInfoAsync()} .
     *
