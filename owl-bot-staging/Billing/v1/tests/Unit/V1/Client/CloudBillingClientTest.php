...
namespace Google\Cloud\Billing\Tests\Unit\V1\Client;
...
class CloudBillingClientTest extends GeneratedTest
{
    ...
    public function listBillingAccountsTest()
    {
        ...
        $response = $gapicClient->listBillingAccounts($request);
    ...
    public function listBillingAccountsExceptionTest()
    {
        ...
        $request = new ListBillingAccountsRequest();
        try {
            $gapicClient->listBillingAccounts($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function createBillingAccountAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
