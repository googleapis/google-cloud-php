...
use Google\Cloud\AIPlatform\V1\FindNeighborsRequest;
use Google\Cloud\AIPlatform\V1\FindNeighborsResponse;
 ...
 * @group gapic
 */
class MatchServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new MatchServiceClient($options);
    }

    /** @test */
    public function findNeighborsTest()
    {
    ...
    /** @test */
    public function findNeighborsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function readIndexDatapointsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function readIndexDatapointsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function findNeighborsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
