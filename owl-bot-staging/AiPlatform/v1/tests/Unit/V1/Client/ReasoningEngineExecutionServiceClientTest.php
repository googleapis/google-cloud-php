...
class ReasoningEngineExecutionServiceClientTest extends GeneratedTest
{
    ...
    public function asyncQueryReasoningEngineTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1.ReasoningEngineExecutionService/AsyncQueryReasoningEngine', $actualApiFuncCall);
    ...
    public function cancelAsyncQueryReasoningEngineTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1.ReasoningEngineExecutionService/CancelAsyncQueryReasoningEngine', $actualFuncCall);
    ...
    public function queryReasoningEngineTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.ReasoningEngineExecutionService/QueryReasoningEngine', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function streamQueryReasoningEngineTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.ReasoningEngineExecutionService/StreamQueryReasoningEngine', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
