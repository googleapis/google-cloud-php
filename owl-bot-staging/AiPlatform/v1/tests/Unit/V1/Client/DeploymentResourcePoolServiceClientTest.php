...
class DeploymentResourcePoolServiceClientTest extends GeneratedTest
{
    ...
    public function updateDeploymentResourcePoolTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.DeploymentResourcePoolService/UpdateDeploymentResourcePool', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getDeploymentResourcePool();
        $this->assertProtobufEquals($deploymentResourcePool, $actualValue);
    ...
    /** @test */
    public function createDeploymentResourcePoolAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
