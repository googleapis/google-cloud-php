 ...
 * @group gapic
 */
class FeatureOnlineStoreServiceClientTest extends GeneratedTest
{
    ...
    public function featureViewDirectWriteTest()
    {
        ...
        $this->assertSame('/google.cloud.aiplatform.v1.FeatureOnlineStoreService/FeatureViewDirectWrite', $streamFuncCall);
    ...
    /** @test */
    public function fetchFeatureValuesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertSame('/google.cloud.aiplatform.v1.FeatureOnlineStoreService/FetchFeatureValues', $actualFuncCall);
    ...
    /** @test */
    public function fetchFeatureValuesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function generateFetchAccessTokenTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $expectedResponse = new GenerateFetchAccessTokenResponse();
        $expectedResponse->setAccessToken($accessToken);
        $transport->addResponse($expectedResponse);
        $request = new GenerateFetchAccessTokenRequest();
        $response = $gapicClient->generateFetchAccessToken($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.FeatureOnlineStoreService/GenerateFetchAccessToken', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function generateFetchAccessTokenExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = new GenerateFetchAccessTokenRequest();
        try {
            $gapicClient->generateFetchAccessToken($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function fetchFeatureValuesAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
