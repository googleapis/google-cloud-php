 ...
 * evaluation dataset.
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.PairwiseMetricInstance</code>
 */
class PairwiseMetricInstance extends \Google\Protobuf\Internal\Message
{
    protected $instance;
