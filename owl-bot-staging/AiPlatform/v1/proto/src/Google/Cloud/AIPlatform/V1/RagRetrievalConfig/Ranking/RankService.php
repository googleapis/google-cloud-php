 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.RagRetrievalConfig.Ranking.RankService</code>
 */
class RankService extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(RankService::class, \Google\Cloud\AIPlatform\V1\RagRetrievalConfig_Ranking_RankService::class);
