 ...
 *
 * Generated from protobuf message <code>google.cloud.aiplatform.v1.StopNotebookRuntimeRequest</code>
 */
class StopNotebookRuntimeRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the NotebookRuntime resource to be stopped.
     *                     Instead of checking whether the name is in valid NotebookRuntime resource
     *                     name format, directly throw NotFound exception if there is no such
     *                     NotebookRuntime in spanner. Please see
     *                     {@see NotebookServiceClient::notebookRuntimeName()} for help formatting this field.
     *
     * @return \Google\Cloud\AIPlatform\V1\StopNotebookRuntimeRequest
     *
     * @experimental
     */
