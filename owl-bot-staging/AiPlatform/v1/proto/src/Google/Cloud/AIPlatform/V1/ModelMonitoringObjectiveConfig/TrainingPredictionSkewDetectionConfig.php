...
class_alias(TrainingPredictionSkewDetectionConfig::class, \Google\Cloud\AIPlatform\V1\ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig::class);
