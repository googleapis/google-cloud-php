...
class_alias(StatsAnomaliesObjective::class, \Google\Cloud\AIPlatform\V1\SearchModelDeploymentMonitoringStatsAnomaliesRequest_StatsAnomaliesObjective::class);
