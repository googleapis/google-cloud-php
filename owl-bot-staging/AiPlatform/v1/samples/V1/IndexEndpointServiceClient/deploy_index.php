...
function deploy_index_sample(
    ...
    try {
        ...
        $response = $indexEndpointServiceClient->deployIndex(
        ...
        if ($response->operationSucceeded()) {
            /** @var DeployIndexResponse $response */
...
function callSample(): void
{
    ...
    deploy_index_sample($formattedIndexEndpoint, $deployedIndexId, $formattedIndex);
}
