...
// [START aiplatform_v1_generated_MetadataService_ListExecutions_sync]
...
function list_executions_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $metadataServiceClient->listExecutions($formattedParent);
...
// [END aiplatform_v1_generated_MetadataService_ListExecutions_sync]
