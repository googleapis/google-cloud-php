 ...
 */
function update_reasoning_engine_sample(string $reasoningEngineDisplayName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $reasoningEngineServiceClient->updateReasoningEngine($request);
...
function callSample(): void
{
    ...
    update_reasoning_engine_sample($reasoningEngineDisplayName);
}
