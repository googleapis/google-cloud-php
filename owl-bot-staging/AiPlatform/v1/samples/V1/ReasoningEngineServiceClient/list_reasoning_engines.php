 ...
 *
 * @param string $formattedParent The resource name of the Location to list the ReasoningEngines
 *                                from. Format: `projects/{project}/locations/{location}`
 *                                Please see {@see ReasoningEngineServiceClient::locationName()} for help formatting this field.
 */
function list_reasoning_engines_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $reasoningEngineServiceClient->listReasoningEngines($request);

        /** @var ReasoningEngine $element */
...
function callSample(): void
{
    ...
    list_reasoning_engines_sample($formattedParent);
}
