...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.VertexRagService' => [
            'AugmentPrompt' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}:augmentPrompt',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CorroborateContent' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}:corroborateContent',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'RetrieveContexts' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}:retrieveContexts',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
