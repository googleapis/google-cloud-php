    ...
    'interfaces' => [
        'google.cloud.aiplatform.v1.NotebookService' => [
            'AssignNotebookRuntime' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\AIPlatform\V1\NotebookRuntime',
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\AssignNotebookRuntimeOperationMetadata',
            ...
            'CreateNotebookRuntimeTemplate' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\CreateNotebookRuntimeTemplateOperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
                    'totalPollTimeoutMillis' => '300000',
            ...
            'StartNotebookRuntime' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\AIPlatform\V1\StartNotebookRuntimeResponse',
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\StartNotebookRuntimeOperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
                    'totalPollTimeoutMillis' => '300000',
            ...
            'UpgradeNotebookRuntime' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\UpgradeNotebookRuntimeOperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
                    'totalPollTimeoutMillis' => '300000',
            ...
            'GetNotebookRuntime' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\NotebookRuntime',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListNotebookRuntimeTemplates' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getNotebookRuntimeTemplates',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\ListNotebookRuntimeTemplatesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListNotebookRuntimes' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getNotebookRuntimes',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\ListNotebookRuntimesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
