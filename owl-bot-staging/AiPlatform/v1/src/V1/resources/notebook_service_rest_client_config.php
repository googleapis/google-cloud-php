    ...
    'interfaces' => [
        'google.cloud.aiplatform.v1.NotebookService' => [
            'AssignNotebookRuntime' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/notebookRuntimes:assign',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteNotebookRuntimeTemplate' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/notebookRuntimeTemplates/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ListNotebookRuntimes' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/notebookRuntimes',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'StartNotebookRuntime' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/notebookRuntimes/*}:start',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'UpgradeNotebookRuntime' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/notebookRuntimes/*}:upgrade',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
