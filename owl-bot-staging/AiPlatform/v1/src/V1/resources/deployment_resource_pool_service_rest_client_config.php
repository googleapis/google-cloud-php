    ...
    'interfaces' => [
        'google.cloud.aiplatform.v1.DeploymentResourcePoolService' => [
            'CreateDeploymentResourcePool' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/deploymentResourcePools',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteDeploymentResourcePool' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/deploymentResourcePools/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'QueryDeployedModels' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{deployment_resource_pool=projects/*/locations/*/deploymentResourcePools/*}:queryDeployedModels',
                'placeholders' => [
