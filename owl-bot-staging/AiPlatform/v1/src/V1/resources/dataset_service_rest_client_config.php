        ...
        'google.cloud.aiplatform.v1.DatasetService' => [
            ...
            'CreateDatasetVersion' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{parent=datasets/*}/datasetVersions',
                        'body' => 'dataset_version',
                    ],
                ],
                'placeholders' => [
            ...
            'DeleteDatasetVersion' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1/{name=datasets/*/datasetVersions/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'ListSavedQueries' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/datasets/*}/savedQueries',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'RestoreDatasetVersion' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'get',
                        'uriTemplate' => '/v1/{name=datasets/*/datasetVersions/*}:restore',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'UpdateDataset' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{dataset.name=datasets/*}',
                        'body' => 'dataset',
                        'queryParams' => [
                            'update_mask',
                        ],
            ...
            'UpdateDatasetVersion' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{dataset_version.name=projects/*/locations/*/datasets/*/datasetVersions/*}',
                'body' => 'dataset_version',
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{dataset_version.name=datasets/*/datasetVersions/*}',
                        'body' => 'dataset_version',
                        'queryParams' => [
                            'update_mask',
                        ],
