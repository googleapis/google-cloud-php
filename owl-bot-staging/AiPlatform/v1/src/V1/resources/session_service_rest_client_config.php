...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.SessionService' => [
            'AppendEvent' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}:appendEvent',
                'body' => 'event',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'CreateSession' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/reasoningEngines/*}/sessions',
                'body' => 'session',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteSession' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ListEvents' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/reasoningEngines/*/sessions/*}/events',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'UpdateSession' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{session.name=projects/*/locations/*/reasoningEngines/*/sessions/*}',
                'body' => 'session',
                'placeholders' => [
                    'session.name' => [
                        'getters' => [
