    ...
    'interfaces' => [
        'google.cloud.aiplatform.v1.PersistentResourceService' => [
            'CreatePersistentResource' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/persistentResources',
            ...
            'DeletePersistentResource' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/persistentResources/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'RebootPersistentResource' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/persistentResources/*}:reboot',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'UpdatePersistentResource' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{persistent_resource.name=projects/*/locations/*/persistentResources/*}',
                'body' => 'persistent_resource',
                'placeholders' => [
