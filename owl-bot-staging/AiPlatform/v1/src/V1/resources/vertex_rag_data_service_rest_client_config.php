...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.VertexRagDataService' => [
            'CreateRagCorpus' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/ragCorpora',
                'body' => 'rag_corpus',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteRagCorpus' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/ragCorpora/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ImportRagFiles' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:import',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'ListRagFiles' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'UpdateRagCorpus' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{rag_corpus.name=projects/*/locations/*/ragCorpora/*}',
                'body' => 'rag_corpus',
                'placeholders' => [
                    'rag_corpus.name' => [
                        'getters' => [
            ...
            'UploadRagFile' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:upload',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
