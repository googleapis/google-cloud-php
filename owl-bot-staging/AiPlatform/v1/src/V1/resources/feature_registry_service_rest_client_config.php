...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.FeatureRegistryService' => [
            'BatchCreateFeatures' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/featureGroups/*}/features:batchCreate',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreateFeature' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/featureGroups/*}/features',
                'body' => 'feature',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreateFeatureGroup' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/featureGroups',
                'body' => 'feature_group',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteFeature' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/featureGroups/*/features/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteFeatureGroup' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/featureGroups/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateFeature' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{feature.name=projects/*/locations/*/featureGroups/*/features/*}',
                'body' => 'feature',
                'placeholders' => [
                    'feature.name' => [
                        'getters' => [
            ...
            'UpdateFeatureGroup' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{feature_group.name=projects/*/locations/*/featureGroups/*}',
                'body' => 'feature_group',
                'placeholders' => [
                    'feature_group.name' => [
                        'getters' => [
        ...
        'google.longrunning.Operations' => [
            'CancelOperation' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*/operations/*}:cancel',
                    ],
                    [
                        'method' => 'post',
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{name=reasoningEngines/*/sessions/*/operations/*}:cancel',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'DeleteOperation' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*/operations/*}',
                    ],
                    [
                        'method' => 'delete',
                    ...
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1/{name=reasoningEngines/*/sessions/*/operations/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'WaitOperation' => [
                ...
                'additionalBindings' => [
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*/operations/*}:wait',
                    ],
                    [
                        'method' => 'post',
                    ...
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{name=reasoningEngines/*/sessions/*/operations/*}:wait',
                    ],
                ],
                'placeholders' => [
                    'name' => [
