    ...
    'interfaces' => [
        'google.cloud.aiplatform.v1.PipelineService' => [
            'BatchCancelPipelineJobs' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\AIPlatform\V1\BatchCancelPipelineJobsResponse',
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\BatchCancelPipelineJobsOperationMetadata',
            ...
            'BatchDeletePipelineJobs' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\AIPlatform\V1\BatchDeletePipelineJobsResponse',
            ...
            'CreatePipelineJob' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\PipelineJob',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'CreateTrainingPipeline' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\TrainingPipeline',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListPipelineJobs' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getPipelineJobs',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\ListPipelineJobsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListTrainingPipelines' => [
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\ListTrainingPipelinesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
