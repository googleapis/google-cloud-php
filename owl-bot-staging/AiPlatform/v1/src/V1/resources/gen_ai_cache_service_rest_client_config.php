...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.GenAiCacheService' => [
            'CreateCachedContent' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/cachedContents',
                'body' => 'cached_content',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteCachedContent' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/cachedContents/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateCachedContent' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{cached_content.name=projects/*/locations/*/cachedContents/*}',
                'body' => 'cached_content',
                'placeholders' => [
                    'cached_content.name' => [
                        'getters' => [
