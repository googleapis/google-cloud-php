...
class DeploymentResourcePoolServiceGapicClient
{
    ...
    public function createDeploymentResourcePool(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['deploymentResourcePool'])) {
            $request->setDeploymentResourcePool($optionalArgs['deploymentResourcePool']);
        }

        if (isset($optionalArgs['deploymentResourcePoolId'])) {
            $request->setDeploymentResourcePoolId($optionalArgs['deploymentResourcePoolId']);
        }
    ...
    public function queryDeployedModels(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['deploymentResourcePool'])) {
            $request->setDeploymentResourcePool($optionalArgs['deploymentResourcePool']);
            $requestParamHeaders['deployment_resource_pool'] = $optionalArgs['deploymentResourcePool'];
        }
