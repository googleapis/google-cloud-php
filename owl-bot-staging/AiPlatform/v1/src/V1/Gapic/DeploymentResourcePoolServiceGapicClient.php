 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\AIPlatform\V1\Client\DeploymentResourcePoolServiceClient}.
 */
class DeploymentResourcePoolServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1.DeploymentResourcePoolService';
    ...
    private static function getDeploymentResourcePoolNameTemplate()
    {
        if (self::$deploymentResourcePoolNameTemplate == null) {
            self::$deploymentResourcePoolNameTemplate = new PathTemplate('projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}');
        }
     ...
     */
    public static function deploymentResourcePoolName($project, $location, $deploymentResourcePool)
    {
     ...
     */
    public function createDeploymentResourcePool($parent, $deploymentResourcePool, $deploymentResourcePoolId, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateDeploymentResourcePool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteDeploymentResourcePool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteDeploymentResourcePool', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getDeploymentResourcePool($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDeploymentResourcePool', DeploymentResourcePool::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listDeploymentResourcePools($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDeploymentResourcePools', $optionalArgs, ListDeploymentResourcePoolsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function queryDeployedModels($deploymentResourcePool, array $optionalArgs = [])
    {
        $request = new QueryDeployedModelsRequest();
        $requestParamHeaders = [];
        $request->setDeploymentResourcePool($deploymentResourcePool);
        $requestParamHeaders['deployment_resource_pool'] = $deploymentResourcePool;
        if (isset($optionalArgs['pageSize'])) {
            $request->setPageSize($optionalArgs['pageSize']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('QueryDeployedModels', $optionalArgs, QueryDeployedModelsResponse::class, $request);
    }
     ...
     * $deploymentResourcePoolServiceClient = new DeploymentResourcePoolServiceClient();
     * try {
     *     $response = $deploymentResourcePoolServiceClient->getLocation();
     * } finally {
     *     $deploymentResourcePoolServiceClient->close();
     * }
     * ```
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $deploymentResourcePoolServiceClient->listLocations();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
