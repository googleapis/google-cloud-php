 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1/feature_online_store_service.proto
...
use Google\Cloud\AIPlatform\V1\FeatureViewDataFormat;
...
class FeatureOnlineStoreServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/feature_online_store_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/feature_online_store_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/feature_online_store_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     *           will be used.
     *           For allowed values, use constants defined on {@see \Google\Cloud\AIPlatform\V1\FeatureViewDataFormat}
    ...
    public function fetchFeatureValues($featureView, array $optionalArgs = [])
    {
        ...
        return $this->startCall('FetchFeatureValues', FetchFeatureValuesResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchNearestEntities($featureView, $query, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SearchNearestEntities', SearchNearestEntitiesResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * $featureOnlineStoreServiceClient = new FeatureOnlineStoreServiceClient();
     * try {
     *     $response = $featureOnlineStoreServiceClient->getLocation();
     * } finally {
     *     $featureOnlineStoreServiceClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $featureOnlineStoreServiceClient->listLocations();
