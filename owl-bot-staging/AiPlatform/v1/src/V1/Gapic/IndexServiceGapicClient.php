...
class IndexServiceGapicClient
{
    ...
    public function removeDatapoints($index, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RemoveDatapoints', RemoveDatapointsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function upsertDatapoints($index, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpsertDatapoints', UpsertDatapointsResponse::class, $optionalArgs, $request)->wait();
    }
