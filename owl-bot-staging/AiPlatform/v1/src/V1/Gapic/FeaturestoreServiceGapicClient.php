...
class FeaturestoreServiceGapicClient
{
    ...
    public function batchReadFeatureValues(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['featurestore'])) {
            ...
            $requestParamHeaders['featurestore'] = $optionalArgs['featurestore'];
        }
    ...
    public function deleteFeatureValues(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['selectTimeRangeAndFeature'])) {
            $request->setSelectTimeRangeAndFeature($optionalArgs['selectTimeRangeAndFeature']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteFeatureValues', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
