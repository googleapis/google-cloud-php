 ...
 *     $instances = [];
 *     $response = $llmUtilityServiceClient->computeTokens($formattedEndpoint, $instances);
 * } finally {
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\AIPlatform\V1\Client\LlmUtilityServiceClient}.
 */
class LlmUtilityServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1.LlmUtilityService';
     ...
     *                              token ids.
     * @param Value[] $instances    Required. The instances that are the input to token computing API call.
     ...
     */
    public function computeTokens($endpoint, $instances, array $optionalArgs = [])
    {
        ...
        return $this->startCall('ComputeTokens', ComputeTokensResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function countTokens($endpoint, $model, $instances, $contents, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CountTokens', CountTokensResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * $llmUtilityServiceClient = new LlmUtilityServiceClient();
     * try {
     *     $response = $llmUtilityServiceClient->getLocation();
     * } finally {
     *     $llmUtilityServiceClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $llmUtilityServiceClient->listLocations();
     ...
     * try {
     *     $resource = 'resource';
     *     $response = $llmUtilityServiceClient->getIamPolicy($resource);
     * } finally {
     *     $llmUtilityServiceClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $policy = new Policy();
     *     $response = $llmUtilityServiceClient->setIamPolicy($resource, $policy);
     * } finally {
     *     $llmUtilityServiceClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $permissions = [];
     *     $response = $llmUtilityServiceClient->testIamPermissions($resource, $permissions);
     * } finally {
     *     $llmUtilityServiceClient->close();
     * }
     * ```
