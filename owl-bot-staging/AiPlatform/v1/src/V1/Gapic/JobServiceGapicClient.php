...
class JobServiceGapicClient
{
    ...
    private static function getNasJobNameTemplate()
    {
        if (self::$nasJobNameTemplate == null) {
            self::$nasJobNameTemplate = new PathTemplate('projects/{project}/locations/{location}/nasJobs/{nas_job}');
        }
    ...
    private static function getNasTrialDetailNameTemplate()
    {
        if (self::$nasTrialDetailNameTemplate == null) {
            self::$nasTrialDetailNameTemplate = new PathTemplate('projects/{project}/locations/{location}/nasJobs/{nas_job}/nasTrialDetails/{nas_trial_detail}');
        }
     ...
     */
    public static function nasTrialDetailName($project, $location, $nasJob, $nasTrialDetail)
    {
    ...
    public function cancelNasJob(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CancelNasJob', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createBatchPredictionJob(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['batchPredictionJob'])) {
            $request->setBatchPredictionJob($optionalArgs['batchPredictionJob']);
        }
    ...
    public function createHyperparameterTuningJob(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['hyperparameterTuningJob'])) {
            $request->setHyperparameterTuningJob($optionalArgs['hyperparameterTuningJob']);
        }
    ...
    public function createModelDeploymentMonitoringJob(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['modelDeploymentMonitoringJob'])) {
            $request->setModelDeploymentMonitoringJob($optionalArgs['modelDeploymentMonitoringJob']);
        }
    ...
    public function createNasJob(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateNasJob', NasJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteNasJob(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteNasJob', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getNasJob(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNasJob', NasJob::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getNasTrialDetail(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetNasTrialDetail', NasTrialDetail::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listNasJobs(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNasJobs', $optionalArgs, ListNasJobsResponse::class, $request);
    }
    ...
    public function listNasTrialDetails(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListNasTrialDetails', $optionalArgs, ListNasTrialDetailsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchModelDeploymentMonitoringStatsAnomalies(array $optionalArgs = [])
    {
        $request = new SearchModelDeploymentMonitoringStatsAnomaliesRequest();
        $requestParamHeaders = [];
        if (isset($optionalArgs['modelDeploymentMonitoringJob'])) {
            $request->setModelDeploymentMonitoringJob($optionalArgs['modelDeploymentMonitoringJob']);
            $requestParamHeaders['model_deployment_monitoring_job'] = $optionalArgs['modelDeploymentMonitoringJob'];
        }
