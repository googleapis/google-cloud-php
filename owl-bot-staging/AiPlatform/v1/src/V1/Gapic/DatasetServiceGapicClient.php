...
class DatasetServiceGapicClient
{
    ...
    private static function getDatasetVersionNameTemplate()
    {
        if (self::$datasetVersionNameTemplate == null) {
            self::$datasetVersionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/datasets/{dataset}/datasetVersions/{dataset_version}');
        }
    ...
    private static function getSavedQueryNameTemplate()
    {
        if (self::$savedQueryNameTemplate == null) {
            self::$savedQueryNameTemplate = new PathTemplate('projects/{project}/locations/{location}/datasets/{dataset}/savedQueries/{saved_query}');
        }
     ...
     */
    public static function datasetVersionName($project, $location, $dataset, $datasetVersion)
    {
     ...
     */
    public static function savedQueryName($project, $location, $dataset, $savedQuery)
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createDatasetVersion($parent, $datasetVersion, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateDatasetVersion', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteDatasetVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteDatasetVersion', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSavedQuery($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSavedQuery', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getDatasetVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDatasetVersion', DatasetVersion::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listDatasetVersions($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDatasetVersions', $optionalArgs, ListDatasetVersionsResponse::class, $request);
    }
    ...
    public function restoreDatasetVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('RestoreDatasetVersion', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function searchDataItems($dataset, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('SearchDataItems', $optionalArgs, SearchDataItemsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateDatasetVersion($datasetVersion, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateDatasetVersionRequest();
        $requestParamHeaders = [];
        $request->setDatasetVersion($datasetVersion);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['dataset_version.name'] = $datasetVersion->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateDatasetVersion', DatasetVersion::class, $optionalArgs, $request)->wait();
    }
