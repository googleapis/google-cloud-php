...
class ScheduleServiceGapicClient
{
    ...
    private static function getArtifactNameTemplate()
    {
        if (self::$artifactNameTemplate == null) {
            self::$artifactNameTemplate = new PathTemplate('projects/{project}/locations/{location}/metadataStores/{metadata_store}/artifacts/{artifact}');
        }
    ...
    private static function getExecutionNameTemplate()
    {
        if (self::$executionNameTemplate == null) {
            self::$executionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/metadataStores/{metadata_store}/executions/{execution}');
        }
    ...
    private static function getMetadataStoreNameTemplate()
    {
        if (self::$metadataStoreNameTemplate == null) {
            self::$metadataStoreNameTemplate = new PathTemplate('projects/{project}/locations/{location}/metadataStores/{metadata_store}');
        }
    ...
    private static function getScheduleNameTemplate()
    {
        if (self::$scheduleNameTemplate == null) {
            self::$scheduleNameTemplate = new PathTemplate('projects/{project}/locations/{location}/schedules/{schedule}');
        }
     ...
     */
    public static function artifactName($project, $location, $metadataStore, $artifact)
    {
     ...
     */
    public static function executionName($project, $location, $metadataStore, $execution)
    {
     ...
     */
    public static function metadataStoreName($project, $location, $metadataStore)
    {
    ...
    public function createSchedule($parent, $schedule, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateSchedule', Schedule::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteSchedule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSchedule', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getSchedule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetSchedule', Schedule::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listSchedules($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListSchedules', $optionalArgs, ListSchedulesResponse::class, $request);
    }
    ...
    public function pauseSchedule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('PauseSchedule', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function resumeSchedule($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ResumeSchedule', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateSchedule($schedule, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateSchedule', Schedule::class, $optionalArgs, $request)->wait();
    }
