...
class NotebookServiceGapicClient
{
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateNotebookRuntimeTemplate($notebookRuntimeTemplate, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateNotebookRuntimeTemplateRequest();
        $requestParamHeaders = [];
        $request->setNotebookRuntimeTemplate($notebookRuntimeTemplate);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['notebook_runtime_template.name'] = $notebookRuntimeTemplate->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateNotebookRuntimeTemplate', NotebookRuntimeTemplate::class, $optionalArgs, $request)->wait();
    }
