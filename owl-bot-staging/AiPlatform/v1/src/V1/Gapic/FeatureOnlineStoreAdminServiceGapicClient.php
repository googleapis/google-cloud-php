 ...
 * \Google\Cloud\AIPlatform\V1\Client\FeatureOnlineStoreAdminServiceClient} to use
 * the new surface.
 */
class FeatureOnlineStoreAdminServiceGapicClient
{
     ...
     */
    public function createFeatureOnlineStore($parent, $featureOnlineStore, $featureOnlineStoreId, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createFeatureView($parent, $featureView, $featureViewId, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateFeatureOnlineStore($featureOnlineStore, array $optionalArgs = [])
    {
        $request = new UpdateFeatureOnlineStoreRequest();
        $requestParamHeaders = [];
        $request->setFeatureOnlineStore($featureOnlineStore);
        $requestParamHeaders['feature_online_store.name'] = $featureOnlineStore->getName();
