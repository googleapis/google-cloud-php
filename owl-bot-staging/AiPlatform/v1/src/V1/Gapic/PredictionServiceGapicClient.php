 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\AIPlatform\V1\Client\PredictionServiceClient}.
 */
class PredictionServiceGapicClient
{
    ...
    public function directPredict($endpoint, array $optionalArgs = [])
    {
        ...
        return $this->startCall('DirectPredict', DirectPredictResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function directRawPredict($endpoint, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DirectRawPredict', DirectRawPredictResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function generateContent($model, $contents, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GenerateContent', GenerateContentResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function serverStreamingPredict($endpoint, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ServerStreamingPredict', StreamingPredictResponse::class, $optionalArgs, $request, Call::SERVER_STREAMING_CALL);
    }
    ...
    {
        return $this->startCall('StreamDirectPredict', StreamDirectPredictResponse::class, $optionalArgs, null, Call::BIDI_STREAMING_CALL);
    }
    ...
    {
        return $this->startCall('StreamDirectRawPredict', StreamDirectRawPredictResponse::class, $optionalArgs, null, Call::BIDI_STREAMING_CALL);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function streamGenerateContent($model, $contents, array $optionalArgs = [])
    {
        $request = new GenerateContentRequest();
        $requestParamHeaders = [];
        $request->setModel($model);
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('StreamGenerateContent', GenerateContentResponse::class, $optionalArgs, $request, Call::SERVER_STREAMING_CALL);
    }
    ...
    public function streamRawPredict($endpoint, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('StreamRawPredict', HttpBody::class, $optionalArgs, $request, Call::SERVER_STREAMING_CALL);
    }
    ...
    {
        return $this->startCall('StreamingPredict', StreamingPredictResponse::class, $optionalArgs, null, Call::BIDI_STREAMING_CALL);
    }
    ...
    {
        return $this->startCall('StreamingRawPredict', StreamingRawPredictResponse::class, $optionalArgs, null, Call::BIDI_STREAMING_CALL);
    }
