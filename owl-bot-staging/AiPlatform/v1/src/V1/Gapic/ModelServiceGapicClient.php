...
class ModelServiceGapicClient
{
     ...
     */
    public function batchImportEvaluatedAnnotations($parent, $evaluatedAnnotations, array $optionalArgs = [])
    {
        ...
        return $this->startCall('BatchImportEvaluatedAnnotations', BatchImportEvaluatedAnnotationsResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function batchImportModelEvaluationSlices($parent, $modelEvaluationSlices, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('BatchImportModelEvaluationSlices', BatchImportModelEvaluationSlicesResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function copyModel($parent, $sourceModel, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CopyModel', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteModelVersion($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteModelVersion', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function importModelEvaluation($parent, $modelEvaluation, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ImportModelEvaluation', ModelEvaluation::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listModelVersions($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListModelVersions', $optionalArgs, ListModelVersionsResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function mergeVersionAliases($name, $versionAliases, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('MergeVersionAliases', Model::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updateExplanationDataset($model, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateExplanationDataset', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
