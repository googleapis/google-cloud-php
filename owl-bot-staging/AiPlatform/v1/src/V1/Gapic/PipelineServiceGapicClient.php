...
class PipelineServiceGapicClient
{
     ...
     */
    public function batchCancelPipelineJobs($parent, $names, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('BatchCancelPipelineJobs', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function batchDeletePipelineJobs($parent, $names, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('BatchDeletePipelineJobs', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
