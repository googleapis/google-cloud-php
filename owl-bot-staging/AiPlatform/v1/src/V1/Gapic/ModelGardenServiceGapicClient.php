 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1/model_garden_service.proto
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\AIPlatform\V1\Client\ModelGardenServiceClient}.
 */
class ModelGardenServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1.ModelGardenService';
    ...
    private static $publisherModelNameTemplate;
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/model_garden_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/model_garden_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/model_garden_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/model_garden_service_rest_client_config.php',
                ],
            ],
        ];
    }

    private static function getPublisherModelNameTemplate()
    {
        if (self::$publisherModelNameTemplate == null) {
            self::$publisherModelNameTemplate = new PathTemplate('publishers/{publisher}/models/{model}');
        }

        return self::$publisherModelNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                'publisherModel' => self::getPublisherModelNameTemplate(),
            ];
        }
     ...
     * @param string $model
     *
     * @return string The formatted publisher_model resource.
     */
    public static function publisherModelName($publisher, $model)
    {
        return self::getPublisherModelNameTemplate()->render([
            'publisher' => $publisher,
            'model' => $model,
        ]);
    }
     ...
     *           For allowed values, use constants defined on {@see \Google\Cloud\AIPlatform\V1\PublisherModelView}
    ...
    public function getPublisherModel($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetPublisherModel', PublisherModel::class, $optionalArgs, $request)->wait();
    }
     ...
     * $modelGardenServiceClient = new ModelGardenServiceClient();
     * try {
     *     $response = $modelGardenServiceClient->getLocation();
     * } finally {
     *     $modelGardenServiceClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $modelGardenServiceClient->listLocations();
