 ...
 * \Google\Cloud\AIPlatform\V1\Client\FeatureRegistryServiceClient} to use the new
 * surface.
 */
class FeatureRegistryServiceGapicClient
{
    ...
    private static function getFeatureNameTemplate()
    {
        if (self::$featureNameTemplate == null) {
            self::$featureNameTemplate = new PathTemplate('projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}');
        }
    ...
    private static function getFeatureGroupNameTemplate()
    {
        if (self::$featureGroupNameTemplate == null) {
            self::$featureGroupNameTemplate = new PathTemplate('projects/{project}/locations/{location}/featureGroups/{feature_group}');
        }
    ...
    private static function getProjectLocationFeatureGroupFeatureNameTemplate()
    {
        if (self::$projectLocationFeatureGroupFeatureNameTemplate == null) {
            self::$projectLocationFeatureGroupFeatureNameTemplate = new PathTemplate('projects/{project}/locations/{location}/featureGroups/{feature_group}/features/{feature}');
        }
    ...
    {
        if (self::$projectLocationFeaturestoreEntityTypeFeatureNameTemplate == null) {
            self::$projectLocationFeaturestoreEntityTypeFeatureNameTemplate = new PathTemplate('projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}');
        }
     ...
     */
    public static function featureName($project, $location, $featurestore, $entityType, $feature)
    {
     ...
     */
    public static function projectLocationFeatureGroupFeatureName($project, $location, $featureGroup, $feature)
    {
     ...
     */
    public static function projectLocationFeaturestoreEntityTypeFeatureName($project, $location, $featurestore, $entityType, $feature)
    {
     ...
     */
    public function createFeature($parent, $feature, $featureId, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function createFeatureGroup($parent, $featureGroup, $featureGroupId, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateFeatureGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteFeatureGroup($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteFeatureGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getFeatureGroup($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetFeatureGroup', FeatureGroup::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listFeatureGroups($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListFeatureGroups', $optionalArgs, ListFeatureGroupsResponse::class, $request);
    }
    ...
    public function updateFeatureGroup($featureGroup, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateFeatureGroup', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
