 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1/deployment_resource_pool_service.proto
...
final class DeploymentResourcePoolServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.DeploymentResourcePoolService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/deployment_resource_pool_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/deployment_resource_pool_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/deployment_resource_pool_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     * {@see DeploymentResourcePoolServiceClient::createDeploymentResourcePoolAsync()}
     * .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/create_deployment_resource_pool.php
     *
     * @param CreateDeploymentResourcePoolRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::deleteDeploymentResourcePoolAsync()}
     * .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/delete_deployment_resource_pool.php
     *
     * @param DeleteDeploymentResourcePoolRequest $request     A request to house fields associated with the call.
     * @param array                               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::getDeploymentResourcePoolAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/get_deployment_resource_pool.php
     *
     * @param GetDeploymentResourcePoolRequest $request     A request to house fields associated with the call.
     * @param array                            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::listDeploymentResourcePoolsAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/list_deployment_resource_pools.php
     *
     * @param ListDeploymentResourcePoolsRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::queryDeployedModelsAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/query_deployed_models.php
     *
     * @param QueryDeployedModelsRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/get_location.php
     *
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::listLocationsAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/list_locations.php
     *
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::getIamPolicyAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/get_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::setIamPolicyAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see DeploymentResourcePoolServiceClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/DeploymentResourcePoolServiceClient/test_iam_permissions.php
     *
