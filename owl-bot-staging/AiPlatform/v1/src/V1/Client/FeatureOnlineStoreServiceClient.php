...
final class FeatureOnlineStoreServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.FeatureOnlineStoreService';
     ...
     * {@see FeatureOnlineStoreServiceClient::fetchFeatureValuesAsync()} .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/fetch_feature_values.php
     *
     * @param FetchFeatureValuesRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateFetchAccessToken(GenerateFetchAccessTokenRequest $request, array $callOptions = []): GenerateFetchAccessTokenResponse
    {
     ...
     *
     * The async variant is
     * {@see FeatureOnlineStoreServiceClient::searchNearestEntitiesAsync()} .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/search_nearest_entities.php
     *
     * @param SearchNearestEntitiesRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see FeatureOnlineStoreServiceClient::getLocationAsync()}
     * .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/get_location.php
     *
     ...
     *
     * The async variant is
     * {@see FeatureOnlineStoreServiceClient::listLocationsAsync()} .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/list_locations.php
     *
     ...
     *
     * The async variant is {@see FeatureOnlineStoreServiceClient::getIamPolicyAsync()}
     * .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/get_iam_policy.php
     *
    ...
    errors.
     *
     * The async variant is {@see FeatureOnlineStoreServiceClient::setIamPolicyAsync()}
     * .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see FeatureOnlineStoreServiceClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/FeatureOnlineStoreServiceClient/test_iam_permissions.php
     *
