 ...
 */
abstract class FeaturestoreServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.FeaturestoreService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/featurestore_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/featurestore_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../../resources/featurestore_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/featurestore_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function featurestoreName(string $project, string $location, string $featurestore): string
    {
        return self::getPathTemplate('featurestore')->render([
            'project' => $project,
            'location' => $location,
            'featurestore' => $featurestore,
        ]);
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createEntityType(CreateEntityTypeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createFeaturestore(CreateFeaturestoreRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateFeaturestore', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteEntityType(DeleteEntityTypeRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteEntityType', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteFeatureValues(DeleteFeatureValuesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteFeatureValues', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteFeaturestore(DeleteFeaturestoreRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteFeaturestore', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function exportFeatureValues(ExportFeatureValuesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ExportFeatureValues', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getFeaturestore(GetFeaturestoreRequest $request, array $callOptions = []): Featurestore
    {
        return $this->startApiCall('GetFeaturestore', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function importFeatureValues(ImportFeatureValuesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ImportFeatureValues', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listFeaturestores(ListFeaturestoresRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListFeaturestores', $request, $callOptions);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchFeatures(SearchFeaturesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('SearchFeatures', $request, $callOptions);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateFeature(UpdateFeatureRequest $request, array $callOptions = []): Feature
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateFeaturestore(UpdateFeaturestoreRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('UpdateFeaturestore', $request, $callOptions)->wait();
    }
