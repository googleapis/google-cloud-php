 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1/vertex_rag_data_service.proto
 ...
 *
 * @method PromiseInterface<OperationResponse> createRagCorpusAsync(CreateRagCorpusRequest $request, array $optionalArgs = [])
 ...
 */
final class VertexRagDataServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.VertexRagDataService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/vertex_rag_data_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/vertex_rag_data_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/vertex_rag_data_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/vertex_rag_data_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @param string $location
     * @param string $ragCorpus
     * @param string $ragFile
     *
     * @return string The formatted rag_file resource.
     */
    public static function ragFileName(string $project, string $location, string $ragCorpus, string $ragFile): string
    {
        return self::getPathTemplate('ragFile')->render([
            'project' => $project,
            'location' => $location,
            'rag_corpus' => $ragCorpus,
            'rag_file' => $ragFile,
     ...
     *           use Google\Cloud\AIPlatform\V1\VertexRagDataServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new VertexRagDataServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * Creates a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::createRagCorpusAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/create_rag_corpus.php
     *
     * @param CreateRagCorpusRequest $request     A request to house fields associated with the call.
     ...
     */
    public function createRagCorpus(CreateRagCorpusRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateRagCorpus', $request, $callOptions)->wait();
    }

    /**
     * Deletes a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::deleteRagCorpusAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/delete_rag_corpus.php
     *
     * @param DeleteRagCorpusRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteRagCorpus(DeleteRagCorpusRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteRagCorpus', $request, $callOptions)->wait();
    }

    /**
     * Deletes a RagFile.
     *
     * The async variant is {@see VertexRagDataServiceClient::deleteRagFileAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/delete_rag_file.php
     *
     * @param DeleteRagFileRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteRagFile(DeleteRagFileRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteRagFile', $request, $callOptions)->wait();
    }

    /**
     * Gets a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::getRagCorpusAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/get_rag_corpus.php
     *
     * @param GetRagCorpusRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getRagCorpus(GetRagCorpusRequest $request, array $callOptions = []): RagCorpus
    {
        return $this->startApiCall('GetRagCorpus', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/VertexRagDataServiceClient/get_rag_file.php
     *
     * @param GetRagFileRequest $request     A request to house fields associated with the call.
     * @param array             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getRagFile(GetRagFileRequest $request, array $callOptions = []): RagFile
    {
        return $this->startApiCall('GetRagFile', $request, $callOptions)->wait();
    }

    /**
     * Import files from Google Cloud Storage or Google Drive into a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::importRagFilesAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/import_rag_files.php
     *
     * @param ImportRagFilesRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function importRagFiles(ImportRagFilesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ImportRagFiles', $request, $callOptions)->wait();
    }

    /**
     * Lists RagCorpora in a Location.
     *
     * The async variant is {@see VertexRagDataServiceClient::listRagCorporaAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/list_rag_corpora.php
     *
     * @param ListRagCorporaRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listRagCorpora(ListRagCorporaRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListRagCorpora', $request, $callOptions);
    }

    /**
     * Lists RagFiles in a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::listRagFilesAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/list_rag_files.php
     *
     * @param ListRagFilesRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listRagFiles(ListRagFilesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListRagFiles', $request, $callOptions);
    }

    /**
     * Updates a RagCorpus.
     *
     * The async variant is {@see VertexRagDataServiceClient::updateRagCorpusAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/update_rag_corpus.php
     *
     * @param UpdateRagCorpusRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see VertexRagDataServiceClient::uploadRagFileAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/upload_rag_file.php
     *
     * @param UploadRagFileRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function uploadRagFile(UploadRagFileRequest $request, array $callOptions = []): UploadRagFileResponse
    {
        return $this->startApiCall('UploadRagFile', $request, $callOptions)->wait();
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see VertexRagDataServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/get_location.php
     *
     ...
     *
     * The async variant is {@see VertexRagDataServiceClient::listLocationsAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/list_locations.php
     *
     ...
     *
     * The async variant is {@see VertexRagDataServiceClient::getIamPolicyAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/get_iam_policy.php
     *
    ...
    errors.
     *
     * The async variant is {@see VertexRagDataServiceClient::setIamPolicyAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is
     * {@see VertexRagDataServiceClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/VertexRagDataServiceClient/test_iam_permissions.php
     *
