 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/aiplatform/v1/vertex_rag_service.proto
 ...
 */
final class VertexRagServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.VertexRagService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/vertex_rag_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/vertex_rag_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/vertex_rag_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/vertex_rag_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\AIPlatform\V1\VertexRagServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new VertexRagServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function asyncRetrieveContexts(AsyncRetrieveContextsRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see VertexRagServiceClient::augmentPromptAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/augment_prompt.php
     *
     * @param AugmentPromptRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function augmentPrompt(AugmentPromptRequest $request, array $callOptions = []): AugmentPromptResponse
    {
        return $this->startApiCall('AugmentPrompt', $request, $callOptions)->wait();
    }
     ...
     * supporting facts.
     *
     * The async variant is {@see VertexRagServiceClient::corroborateContentAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/corroborate_content.php
     *
     * @param CorroborateContentRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see VertexRagServiceClient::retrieveContextsAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/retrieve_contexts.php
     *
     * @param RetrieveContextsRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see VertexRagServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/get_location.php
     *
     ...
     *
     * The async variant is {@see VertexRagServiceClient::listLocationsAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/list_locations.php
     *
     ...
     *
     * The async variant is {@see VertexRagServiceClient::getIamPolicyAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/get_iam_policy.php
     *
    ...
    errors.
     *
     * The async variant is {@see VertexRagServiceClient::setIamPolicyAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/set_iam_policy.php
     *
     ...
     *
     * The async variant is {@see VertexRagServiceClient::testIamPermissionsAsync()} .
     *
     * @example samples/V1/VertexRagServiceClient/test_iam_permissions.php
     *
