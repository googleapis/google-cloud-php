...
// [START visionai_v1_generated_LiveVideoAnalytics_DeleteOperator_sync]
...
function delete_operator_sample(string $formattedName): void
{
    ...
    try {
        ...
        $response = $liveVideoAnalyticsClient->deleteOperator($formattedName);
...
// [END visionai_v1_generated_LiveVideoAnalytics_DeleteOperator_sync]
