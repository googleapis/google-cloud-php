...
class CreateCollectionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\VisionAI\V1\Collection $collection   Required. The collection resource to be created.
     * @param string                               $collectionId Optional. The ID to use for the collection, which will become the final
     *                                                           component of the resource name if user choose to specify. Otherwise,
     *                                                           collection id will be generated by system.
     *
     *                                                           This value should be up to 55 characters, and valid characters
     ...
     *                                                           a letter or a number.
     *
     * @return \Google\Cloud\VisionAI\V1\CreateCollectionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\VisionAI\V1\Collection $collection, string $collectionId): self
    {
        return (new self())
            ->setParent($parent)
