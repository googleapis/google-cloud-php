...
use Google\Cloud\BackupDR\V1\ListResourceBackupConfigsResponse;
 ...
 * @group gapic
 */
class BackupDrProtectionSummaryClientTest extends GeneratedTest
{
    ...
    public function listResourceBackupConfigsTest()
    {
        ...
        $this->assertSame('/google.cloud.backupdr.v1.BackupDrProtectionSummary/ListResourceBackupConfigs', $actualFuncCall);
