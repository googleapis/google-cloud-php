 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/backupdr/v1/protection_summary.proto
 ...
 *
 * @method PromiseInterface<PagedListResponse> listResourceBackupConfigsAsync(ListResourceBackupConfigsRequest $request, array $optionalArgs = [])
...
final class BackupDrProtectionSummaryClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/backup_dr_protection_summary_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public function listResourceBackupConfigs(ListResourceBackupConfigsRequest $request, array $callOptions = []): PagedListResponse
    {
