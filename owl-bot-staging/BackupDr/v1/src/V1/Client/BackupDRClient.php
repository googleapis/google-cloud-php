...
final class BackupDRClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function fetchBackupsForResourceType(FetchBackupsForResourceTypeRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listDataSourceReferences(ListDataSourceReferencesRequest $request, array $callOptions = []): PagedListResponse
    {
