...
class OsLoginServiceGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\OsLogin\V1beta\CreateSshPublicKeyRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function CreateSshPublicKey(\Google\Cloud\OsLogin\V1beta\CreateSshPublicKeyRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.oslogin.v1beta.OsLoginService/CreateSshPublicKey',
        $argument,
