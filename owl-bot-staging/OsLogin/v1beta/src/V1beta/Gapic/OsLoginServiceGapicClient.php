...
class OsLoginServiceGapicClient
{
     ...
     * @experimental
     */
    public function createSshPublicKey($parent, $sshPublicKey, array $optionalArgs = [])
    {
        ...
        return $this->startCall('CreateSshPublicKey', SshPublicKey::class, $optionalArgs, $request)->wait();
    }
    ...
    public function signSshPublicKey(array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SignSshPublicKey', SignSshPublicKeyResponse::class, $optionalArgs, $request)->wait();
    }
