...
class CertificateManagerGapicClient
{
    ...
    private static function getCertificateNameTemplate()
    {
        if (self::$certificateNameTemplate == null) {
            self::$certificateNameTemplate = new PathTemplate('projects/{project}/locations/{location}/certificates/{certificate}');
        }
    ...
    private static function getCertificateIssuanceConfigNameTemplate()
    {
        if (self::$certificateIssuanceConfigNameTemplate == null) {
            self::$certificateIssuanceConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/certificateIssuanceConfigs/{certificate_issuance_config}');
        }
    ...
    private static function getCertificateMapNameTemplate()
    {
        if (self::$certificateMapNameTemplate == null) {
            self::$certificateMapNameTemplate = new PathTemplate('projects/{project}/locations/{location}/certificateMaps/{certificate_map}');
        }
    ...
    private static function getCertificateMapEntryNameTemplate()
    {
        if (self::$certificateMapEntryNameTemplate == null) {
            self::$certificateMapEntryNameTemplate = new PathTemplate('projects/{project}/locations/{location}/certificateMaps/{certificate_map}/certificateMapEntries/{certificate_map_entry}');
        }
    ...
    private static function getDnsAuthorizationNameTemplate()
    {
        if (self::$dnsAuthorizationNameTemplate == null) {
            self::$dnsAuthorizationNameTemplate = new PathTemplate('projects/{project}/locations/{location}/dnsAuthorizations/{dns_authorization}');
        }
    ...
    private static function getTrustConfigNameTemplate()
    {
        if (self::$trustConfigNameTemplate == null) {
            self::$trustConfigNameTemplate = new PathTemplate('projects/{project}/locations/{location}/trustConfigs/{trust_config}');
        }
     ...
     */
    public static function certificateIssuanceConfigName($project, $location, $certificateIssuanceConfig)
    {
     ...
     */
    public static function certificateMapName($project, $location, $certificateMap)
    {
     ...
     */
    public static function certificateMapEntryName($project, $location, $certificateMap, $certificateMapEntry)
    {
     ...
     */
    public static function dnsAuthorizationName($project, $location, $dnsAuthorization)
    {
     ...
     */
    public function createCertificate($parent, $certificateId, $certificate, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateCertificate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createCertificateIssuanceConfig($parent, $certificateIssuanceConfigId, $certificateIssuanceConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateCertificateIssuanceConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createCertificateMap($parent, $certificateMapId, $certificateMap, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateCertificateMap', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createCertificateMapEntry($parent, $certificateMapEntryId, $certificateMapEntry, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateCertificateMapEntry', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createDnsAuthorization($parent, $dnsAuthorizationId, $dnsAuthorization, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateDnsAuthorization', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTrustConfig($parent, $trustConfigId, $trustConfig, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateTrustConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteCertificate($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCertificate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function deleteCertificateIssuanceConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCertificateIssuanceConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteCertificateMap($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCertificateMap', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteCertificateMapEntry($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteCertificateMapEntry', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteDnsAuthorization($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteDnsAuthorization', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteTrustConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteTrustConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getCertificateIssuanceConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCertificateIssuanceConfig', CertificateIssuanceConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getCertificateMap($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCertificateMap', CertificateMap::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getCertificateMapEntry($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetCertificateMapEntry', CertificateMapEntry::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getDnsAuthorization($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetDnsAuthorization', DnsAuthorization::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getTrustConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetTrustConfig', TrustConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listCertificateIssuanceConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCertificateIssuanceConfigs', $optionalArgs, ListCertificateIssuanceConfigsResponse::class, $request);
    }
    ...
    public function listCertificateMapEntries($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCertificateMapEntries', $optionalArgs, ListCertificateMapEntriesResponse::class, $request);
    }
    ...
    public function listCertificateMaps($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListCertificateMaps', $optionalArgs, ListCertificateMapsResponse::class, $request);
    }
    ...
    public function listDnsAuthorizations($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListDnsAuthorizations', $optionalArgs, ListDnsAuthorizationsResponse::class, $request);
    }
    ...
    public function listTrustConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListTrustConfigs', $optionalArgs, ListTrustConfigsResponse::class, $request);
    }
    ...
    public function updateCertificate($certificate, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateCertificate', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateCertificateMap($certificateMap, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateCertificateMapRequest();
        $requestParamHeaders = [];
        $request->setCertificateMap($certificateMap);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['certificate_map.name'] = $certificateMap->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateCertificateMap', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateCertificateMapEntry($certificateMapEntry, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateCertificateMapEntryRequest();
        $requestParamHeaders = [];
        $request->setCertificateMapEntry($certificateMapEntry);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['certificate_map_entry.name'] = $certificateMapEntry->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateCertificateMapEntry', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateDnsAuthorization($dnsAuthorization, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateDnsAuthorizationRequest();
        $requestParamHeaders = [];
        $request->setDnsAuthorization($dnsAuthorization);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['dns_authorization.name'] = $dnsAuthorization->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateDnsAuthorization', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateTrustConfig($trustConfig, $updateMask, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UpdateTrustConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
