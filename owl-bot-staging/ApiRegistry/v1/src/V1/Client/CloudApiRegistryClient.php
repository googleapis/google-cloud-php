 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/apiregistry/v1/service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\ApiRegistry\V1\Client;
 ...
 * @method PromiseInterface<McpTool> getMcpToolAsync(GetMcpToolRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listMcpServersAsync(ListMcpServersRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listMcpToolsAsync(ListMcpToolsRequest $request, array $optionalArgs = [])
...
final class CloudApiRegistryClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.apiregistry.v1.CloudApiRegistry';
     ...
     */
    public static function mcpServerName(string $project, string $location, string $apiNamespace, string $mcpServer): string
    {
     ...
     */
    public static function mcpToolName(string $project, string $location, string $apiNamespace, string $mcpServer, string $mcpTool): string
    {
     ...
     */
    public static function projectLocationApiNamespaceMcpServerName(string $project, string $location, string $apiNamespace, string $mcpServer): string
    {
     ...
     */
    public static function projectLocationApiNamespaceMcpServerMcpToolName(string $project, string $location, string $apiNamespace, string $mcpServer, string $mcpTool): string
    {
     ...
     */
    public static function projectLocationMcpServerMcpToolName(string $project, string $location, string $mcpServer, string $mcpTool): string
    {
     ...
     *           as "<uri>:<port>". Default 'cloudapiregistry.googleapis.com:443'.
     ...
     *           use Google\Cloud\ApiRegistry\V1\CloudApiRegistryClient;
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/get_mcp_server.php
     *
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/get_mcp_tool.php
     *
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/list_mcp_servers.php
     *
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/list_mcp_tools.php
     *
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/get_location.php
     *
     ...
     *
     * @example samples/V1/CloudApiRegistryClient/list_locations.php
     *
