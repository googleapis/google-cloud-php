 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/apihub/v1/discovery_service.proto
...
/**
 * Service Description: This service exposes methods used to manage DiscoveredApiObservations
 ...
 *
 * @method PromiseInterface<DiscoveredApiObservation> getDiscoveredApiObservationAsync(GetDiscoveredApiObservationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<DiscoveredApiOperation> getDiscoveredApiOperationAsync(GetDiscoveredApiOperationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listDiscoveredApiObservationsAsync(ListDiscoveredApiObservationsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listDiscoveredApiOperationsAsync(ListDiscoveredApiOperationsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Location> getLocationAsync(GetLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listLocationsAsync(ListLocationsRequest $request, array $optionalArgs = [])
 */
final class ApiHubDiscoveryClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.apihub.v1.ApiHubDiscovery';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/api_hub_discovery_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/api_hub_discovery_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/api_hub_discovery_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @param string $discoveredApiObservation
     *
     ...
     * @param string $location
     * @param string $discoveredApiObservation
     * @param string $discoveredApiOperation
     *
     ...
     * {@see ApiHubDiscoveryClient::getDiscoveredApiObservationAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/get_discovered_api_observation.php
     *
     * @param GetDiscoveredApiObservationRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see ApiHubDiscoveryClient::getDiscoveredApiOperationAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/get_discovered_api_operation.php
     *
     * @param GetDiscoveredApiOperationRequest $request     A request to house fields associated with the call.
     * @param array                            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see ApiHubDiscoveryClient::listDiscoveredApiObservationsAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/list_discovered_api_observations.php
     *
     * @param ListDiscoveredApiObservationsRequest $request     A request to house fields associated with the call.
     * @param array                                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see ApiHubDiscoveryClient::listDiscoveredApiOperationsAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/list_discovered_api_operations.php
     *
     * @param ListDiscoveredApiOperationsRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see ApiHubDiscoveryClient::getLocationAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/get_location.php
     *
     ...
     *
     * The async variant is {@see ApiHubDiscoveryClient::listLocationsAsync()} .
     *
     * @example samples/V1/ApiHubDiscoveryClient/list_locations.php
     *
