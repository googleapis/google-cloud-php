    ...
    'interfaces' => [
        'google.cloud.apihub.v1.RuntimeProjectAttachmentService' => [
            'CreateRuntimeProjectAttachment' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/runtimeProjectAttachments',
            ...
            'DeleteRuntimeProjectAttachment' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/runtimeProjectAttachments/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'LookupRuntimeProjectAttachment' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{name=projects/*/locations/*}:lookupRuntimeProjectAttachment',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
