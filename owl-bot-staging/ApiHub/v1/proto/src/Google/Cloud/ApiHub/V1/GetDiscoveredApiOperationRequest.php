 ...
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.GetDiscoveredApiOperationRequest</code>
 */
class GetDiscoveredApiOperationRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the DiscoveredApiOperation to retrieve.
     *                     Format:
     *                     projects/{project}/locations/{location}/discoveredApiObservations/{discovered_api_observation}/discoveredApiOperations/{discovered_api_operation}
     *                     Please see {@see ApiHubDiscoveryClient::discoveredApiOperationName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\GetDiscoveredApiOperationRequest
     *
     * @experimental
     */
