 ...
 * method's request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.DisablePluginInstanceActionRequest</code>
 */
class DisablePluginInstanceActionRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string $actionId Required. The action id to disable.
     *
     * @return \Google\Cloud\ApiHub\V1\DisablePluginInstanceActionRequest
     *
     * @experimental
     */
