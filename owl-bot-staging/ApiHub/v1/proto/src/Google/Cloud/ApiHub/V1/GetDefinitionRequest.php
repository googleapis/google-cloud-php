 ...
 * request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.GetDefinitionRequest</code>
 */
class GetDefinitionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the definition to retrieve.
     *                     Format:
     *                     `projects/{project}/locations/{location}/apis/{api}/versions/{version}/definitions/{definition}`
     *                     Please see {@see ApiHubClient::definitionName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\GetDefinitionRequest
     *
     * @experimental
     */
