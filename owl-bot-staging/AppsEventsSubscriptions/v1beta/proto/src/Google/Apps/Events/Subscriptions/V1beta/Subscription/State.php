 ...
 *
 * Protobuf type <code>google.apps.events.subscriptions.v1beta.Subscription.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Apps\Events\Subscriptions\V1beta\Subscription_State::class);
