 ...
 *
 * Protobuf type <code>google.apps.events.subscriptions.v1beta.Subscription.ErrorType</code>
 */
class ErrorType
{
    /**
...
class_alias(ErrorType::class, \Google\Apps\Events\Subscriptions\V1beta\Subscription_ErrorType::class);
