...
namespace Google\Apps\Events\Subscriptions\Tests\Unit\V1beta\Client;
...
use Google\Apps\Events\Subscriptions\V1beta\ListSubscriptionsRequest;
use Google\Apps\Events\Subscriptions\V1beta\ListSubscriptionsResponse;
 ...
 * @group gapic
 */
class SubscriptionsServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new SubscriptionsServiceClient($options);
    }
    ...
    public function createSubscriptionTest()
    {
        ...
        $incompleteOperation->setName('operations/createSubscriptionTest');
        ...
        $completeOperation->setName('operations/createSubscriptionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $subscription = new Subscription();
        $subscriptionTargetResource = 'subscriptionTargetResource-1934694596';
        $subscription->setTargetResource($subscriptionTargetResource);
        $subscriptionEventTypes = [];
        $subscription->setEventTypes($subscriptionEventTypes);
        $subscriptionNotificationEndpoint = new NotificationEndpoint();
        $subscription->setNotificationEndpoint($subscriptionNotificationEndpoint);
        ...
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/CreateSubscription', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getSubscription();
        $this->assertProtobufEquals($subscription, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/createSubscriptionTest');
    ...
    public function deleteSubscriptionTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->subscriptionName('[SUBSCRIPTION]');
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/DeleteSubscription', $actualApiFuncCall);
    ...
    public function getSubscriptionTest()
    {
        ...
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/GetSubscription', $actualFuncCall);
    ...
    public function listSubscriptionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/ListSubscriptions', $actualFuncCall);
    ...
    /** @test */
    public function reactivateSubscriptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/reactivateSubscriptionTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $uid = 'uid115792';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/reactivateSubscriptionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $request = (new ReactivateSubscriptionRequest())
            ->setName($formattedName);
        $response = $gapicClient->reactivateSubscription($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/ReactivateSubscription', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/reactivateSubscriptionTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function reactivateSubscriptionExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    public function updateSubscriptionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateSubscriptionTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $uid = 'uid115792';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateSubscriptionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1beta.SubscriptionsService/UpdateSubscription', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getSubscription();
        $this->assertProtobufEquals($subscription, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/updateSubscriptionTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function createSubscriptionAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $request = (new CreateSubscriptionRequest())
            ->setSubscription($subscription);
        $response = $gapicClient->createSubscriptionAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
