...
class SubscriptionsServiceClientTest extends GeneratedTest
{
    ...
    public function createSubscriptionTest()
    {
        ...
        $this->assertSame('/google.apps.events.subscriptions.v1.SubscriptionsService/CreateSubscription', $actualApiFuncCall);
    ...
    public function deleteSubscriptionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1.SubscriptionsService/DeleteSubscription', $actualApiFuncCall);
    ...
    public function reactivateSubscriptionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.apps.events.subscriptions.v1.SubscriptionsService/ReactivateSubscription', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
