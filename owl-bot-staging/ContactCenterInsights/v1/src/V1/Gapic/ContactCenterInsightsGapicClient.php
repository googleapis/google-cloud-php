...
class ContactCenterInsightsGapicClient
{
    ...
    private static function getAnalysisNameTemplate()
    {
        if (self::$analysisNameTemplate == null) {
            self::$analysisNameTemplate = new PathTemplate('projects/{project}/locations/{location}/conversations/{conversation}/analyses/{analysis}');
        }
    ...
    private static function getConversationNameTemplate()
    {
        if (self::$conversationNameTemplate == null) {
            self::$conversationNameTemplate = new PathTemplate('projects/{project}/locations/{location}/conversations/{conversation}');
        }
    ...
    private static function getConversationProfileNameTemplate()
    {
        if (self::$conversationProfileNameTemplate == null) {
            self::$conversationProfileNameTemplate = new PathTemplate('projects/{project}/locations/{location}/conversationProfiles/{conversation_profile}');
        }
    ...
    private static function getIssueNameTemplate()
    {
        if (self::$issueNameTemplate == null) {
            self::$issueNameTemplate = new PathTemplate('projects/{project}/locations/{location}/issueModels/{issue_model}/issues/{issue}');
        }
    ...
    private static function getIssueModelNameTemplate()
    {
        if (self::$issueModelNameTemplate == null) {
            self::$issueModelNameTemplate = new PathTemplate('projects/{project}/locations/{location}/issueModels/{issue_model}');
        }
    ...
    private static function getPhraseMatcherNameTemplate()
    {
        if (self::$phraseMatcherNameTemplate == null) {
            self::$phraseMatcherNameTemplate = new PathTemplate('projects/{project}/locations/{location}/phraseMatchers/{phrase_matcher}');
        }
    ...
    private static function getSettingsNameTemplate()
    {
        if (self::$settingsNameTemplate == null) {
            self::$settingsNameTemplate = new PathTemplate('projects/{project}/locations/{location}/settings');
        }
    ...
    private static function getViewNameTemplate()
    {
        if (self::$viewNameTemplate == null) {
            self::$viewNameTemplate = new PathTemplate('projects/{project}/locations/{location}/views/{view}');
        }
     ...
     */
    public static function analysisName($project, $location, $conversation, $analysis)
    {
     ...
     */
    public static function conversationProfileName($project, $location, $conversationProfile)
    {
     ...
     */
    public static function phraseMatcherName($project, $location, $phraseMatcher)
    {
     ...
     */
    public function bulkAnalyzeConversations($parent, $filter, $analysisPercentage, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('BulkAnalyzeConversations', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function bulkDeleteConversations($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('BulkDeleteConversations', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function calculateIssueModelStats($issueModel, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CalculateIssueModelStats', CalculateIssueModelStatsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function calculateStats($location, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CalculateStats', CalculateStatsResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function createPhraseMatcher($parent, $phraseMatcher, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreatePhraseMatcher', PhraseMatcher::class, $optionalArgs, $request)->wait();
    }
    ...
    public function createView($parent, $view, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('CreateView', View::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteAnalysis($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteAnalysis', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteConversation($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteConversation', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function deleteIssue($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DeleteIssue', GPBEmpty::class, $optionalArgs, $request)->wait();
    }
    ...
    public function exportInsightsData($parent, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['bigQueryDestination'])) {
            $request->setBigQueryDestination($optionalArgs['bigQueryDestination']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('ExportInsightsData', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getIssue($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetIssue', Issue::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getIssueModel($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetIssueModel', IssueModel::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getPhraseMatcher($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetPhraseMatcher', PhraseMatcher::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getView($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetView', View::class, $optionalArgs, $request)->wait();
    }
    ...
    public function ingestConversations($parent, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['transcriptObjectConfig'])) {
            $request->setTranscriptObjectConfig($optionalArgs['transcriptObjectConfig']);
        }
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('IngestConversations', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function listIssueModels($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListIssueModels', ListIssueModelsResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listIssues($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListIssues', ListIssuesResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listPhraseMatchers($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPhraseMatchers', $optionalArgs, ListPhraseMatchersResponse::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updatePhraseMatcher($phraseMatcher, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdatePhraseMatcher', PhraseMatcher::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateSettings($settings, $updateMask, array $optionalArgs = [])
    {
    ...
    public function updateView($view, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateView', View::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function uploadConversation($parent, $conversation, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('UploadConversation', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
}
