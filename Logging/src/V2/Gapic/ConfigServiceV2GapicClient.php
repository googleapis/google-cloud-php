...
class ConfigServiceV2GapicClient
{
    ...
    private static function getBillingAccountNameTemplate()
    {
        if (null == self::$billingAccountNameTemplate) {
            self::$billingAccountNameTemplate = new PathTemplate('billingAccounts/{billing_account}/cmekSettings');
        }
    ...
    private static function getFolderNameTemplate()
    {
        if (null == self::$folderNameTemplate) {
            self::$folderNameTemplate = new PathTemplate('folders/{folder}/cmekSettings');
        }
    ...
    private static function getOrganizationNameTemplate()
    {
        if (null == self::$organizationNameTemplate) {
            self::$organizationNameTemplate = new PathTemplate('organizations/{organization}/cmekSettings');
        }
    ...
    private static function getProjectNameTemplate()
    {
        if (null == self::$projectNameTemplate) {
            self::$projectNameTemplate = new PathTemplate('projects/{project}/cmekSettings');
        }
     ...
     * Template: Pattern
     * - billingAccount: billingAccounts/{billing_account}/cmekSettings
     ...
     * - folder: folders/{folder}/cmekSettings
     ...
     * - organization: organizations/{organization}/cmekSettings
     ...
     * - project: projects/{project}/cmekSettings
