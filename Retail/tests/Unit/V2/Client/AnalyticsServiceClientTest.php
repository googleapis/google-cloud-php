...
class AnalyticsServiceClientTest extends GeneratedTest
{
    ...
    public function exportAnalyticsMetricsTest()
    {
        ...
        $incompleteOperation->setName('operations/exportAnalyticsMetricsTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new ExportAnalyticsMetricsResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/exportAnalyticsMetricsTest');
        ...
        $this->assertSame('/google.cloud.retail.v2.AnalyticsService/ExportAnalyticsMetrics', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCatalog();
        ...
        $expectedOperationsRequestObject->setName('operations/exportAnalyticsMetricsTest');
