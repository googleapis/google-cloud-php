...
class ModelServiceClientTest extends GeneratedTest
{
    ...
    public function createModelTest()
    {
        ...
        $type = 'type3575610';
        $optimizationObjective = 'optimizationObjective1167007975';
    ...
    public function tuneModelTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/tuneModelTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new TuneModelResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/tuneModelTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
