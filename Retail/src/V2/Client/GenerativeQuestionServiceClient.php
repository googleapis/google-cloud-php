 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2/generative_question_service.proto
...
final class GenerativeQuestionServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.retail.v2.GenerativeQuestionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/generative_question_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/generative_question_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/generative_question_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     * {@see GenerativeQuestionServiceClient::batchUpdateGenerativeQuestionConfigsAsync()}
     * .
     *
     * @example samples/V2/GenerativeQuestionServiceClient/batch_update_generative_question_configs.php
     *
     * @param BatchUpdateGenerativeQuestionConfigsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return BatchUpdateGenerativeQuestionConfigsResponse
     *
     ...
     *
     * The async variant is
     * {@see GenerativeQuestionServiceClient::getGenerativeQuestionsFeatureConfigAsync()}
     * .
     *
     * @example samples/V2/GenerativeQuestionServiceClient/get_generative_questions_feature_config.php
     *
     * @param GetGenerativeQuestionsFeatureConfigRequest $request     A request to house fields associated with the call.
     * @param array                                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return GenerativeQuestionsFeatureConfig
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * The async variant is
     * {@see GenerativeQuestionServiceClient::listGenerativeQuestionConfigsAsync()} .
     *
     * @example samples/V2/GenerativeQuestionServiceClient/list_generative_question_configs.php
     *
     * @param ListGenerativeQuestionConfigsRequest $request     A request to house fields associated with the call.
     * @param array                                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return ListGenerativeQuestionConfigsResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * The async variant is
     * {@see GenerativeQuestionServiceClient::updateGenerativeQuestionConfigAsync()} .
     *
     * @example samples/V2/GenerativeQuestionServiceClient/update_generative_question_config.php
     *
     * @param UpdateGenerativeQuestionConfigRequest $request     A request to house fields associated with the call.
     * @param array                                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see GenerativeQuestionServiceClient::updateGenerativeQuestionsFeatureConfigAsync()}
     * .
     *
     * @example samples/V2/GenerativeQuestionServiceClient/update_generative_questions_feature_config.php
     *
     * @param UpdateGenerativeQuestionsFeatureConfigRequest $request     A request to house fields associated with the call.
     * @param array                                         $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
