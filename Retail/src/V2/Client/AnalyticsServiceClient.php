 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2/analytics_service.proto
...
final class AnalyticsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.retail.v2.AnalyticsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/analytics_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/analytics_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/analytics_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/analytics_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\Retail\V2\AnalyticsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AnalyticsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AnalyticsServiceClient::exportAnalyticsMetricsAsync()} .
     *
     * @example samples/V2/AnalyticsServiceClient/export_analytics_metrics.php
     *
     * @param ExportAnalyticsMetricsRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return OperationResponse<ExportAnalyticsMetricsResponse>
     *
