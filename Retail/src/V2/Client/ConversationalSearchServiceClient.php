 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/retail/v2/conversational_search_service.proto
...
final class ConversationalSearchServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.retail.v2.ConversationalSearchService';
     ...
     *           use Google\Cloud\Retail\V2\ConversationalSearchServiceClient;
     ...
     * enabled.
     *
     * @example samples/V2/ConversationalSearchServiceClient/conversational_search.php
     *
     * @param ConversationalSearchRequest $request     A request to house fields associated with the call.
     ...
     */
    public function conversationalSearch(ConversationalSearchRequest $request, array $callOptions = []): ServerStream
    {
        return $this->startApiCall('ConversationalSearch', $request, $callOptions);
    }
}
