 ...
 */
abstract class ControlServiceBaseClient
{
     ...
     */
    public static function controlName(string $project, string $location, string $catalog, string $control): string
    {
     ...
     *
     * The async variant is {@see self::createControlAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteControlAsync()} .
     *
     ...
     * Gets a Control.
     *
     * The async variant is {@see self::getControlAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listControlsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateControlAsync()} .
     *
