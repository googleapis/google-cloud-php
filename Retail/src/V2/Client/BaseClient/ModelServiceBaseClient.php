...
abstract class ModelServiceBaseClient
{
     ...
     */
    public static function modelName(string $project, string $location, string $catalog, string $model): string
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteModel(DeleteModelRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteModel', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see self::pauseModelAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function pauseModel(PauseModelRequest $request, array $callOptions = []): Model
    {
        return $this->startApiCall('PauseModel', $request, $callOptions)->wait();
    }

    /**
     * Resumes the training of an existing model.
     *
     * The async variant is {@see self::resumeModelAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function resumeModel(ResumeModelRequest $request, array $callOptions = []): Model
    {
        return $this->startApiCall('ResumeModel', $request, $callOptions)->wait();
    }

    /**
     * Tunes an existing model.
     *
     * The async variant is {@see self::tuneModelAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function tuneModel(TuneModelRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('TuneModel', $request, $callOptions)->wait();
    }
