 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Retail\V2\Client\CompletionServiceClient}.
 */
class CompletionServiceGapicClient
{
    ...
    public function completeQuery($catalog, $query, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['enableAttributeSuggestions'])) {
            $request->setEnableAttributeSuggestions(
                $optionalArgs['enableAttributeSuggestions']
            );
        }
