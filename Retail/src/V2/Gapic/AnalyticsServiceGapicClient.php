 ...
 *     $operationResponse = $analyticsServiceClient->exportAnalyticsMetrics($catalog, $outputConfig);
 ...
 *     // ... do other work
 *     $newOperationResponse = $analyticsServiceClient->resumeOperation($operationName, 'exportAnalyticsMetrics');
 ...
 *     }
 * } finally {
 *     $analyticsServiceClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Retail\V2\Client\AnalyticsServiceClient}.
 */
class AnalyticsServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.retail.v2.AnalyticsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../resources/analytics_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/analytics_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/analytics_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/analytics_service_rest_client_config.php',
                ],
            ],
        ];
    }
