    ...
    'interfaces' => [
        'google.cloud.retail.v2.ConversationalSearchService' => [
            'ConversationalSearch' => [
                'method' => 'post',
                'uriTemplate' => '/v2/{placement=projects/*/locations/*/catalogs/*/placements/*}:conversationalSearch',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v2/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:conversationalSearch',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
