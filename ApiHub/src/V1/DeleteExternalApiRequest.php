 ...
 * method's request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.DeleteExternalApiRequest</code>
 */
class DeleteExternalApiRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the External API resource to delete.
     *                     Format:
     *                     `projects/{project}/locations/{location}/externalApis/{externalApi}`
     *                     Please see {@see ApiHubClient::externalApiName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\DeleteExternalApiRequest
     *
     * @experimental
     */
