 ...
 * method's request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.GetDependencyRequest</code>
 */
class GetDependencyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the dependency resource to retrieve.
     *                     Format: `projects/{project}/locations/{location}/dependencies/{dependency}`
     *                     Please see {@see ApiHubDependenciesClient::dependencyName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\GetDependencyRequest
     *
     * @experimental
     */
