    ...
    'interfaces' => [
        'google.cloud.apihub.v1.RuntimeProjectAttachmentService' => [
            'CreateRuntimeProjectAttachment' => [
                ...
                'responseType' => 'Google\Cloud\ApiHub\V1\RuntimeProjectAttachment',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListRuntimeProjectAttachments' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getRuntimeProjectAttachments',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\ApiHub\V1\ListRuntimeProjectAttachmentsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'LookupRuntimeProjectAttachment' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\ApiHub\V1\LookupRuntimeProjectAttachmentResponse',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
