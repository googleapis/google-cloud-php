 ...
 * request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.DeleteAttributeRequest</code>
 */
class DeleteAttributeRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the attribute to delete.
     *                     Format:
     *                     `projects/{project}/locations/{location}/attributes/{attribute}`
     *                     Please see {@see ApiHubClient::attributeName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\DeleteAttributeRequest
     *
     * @experimental
     */
