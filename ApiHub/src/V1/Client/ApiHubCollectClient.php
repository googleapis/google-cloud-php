 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/apihub/v1/collect_service.proto
 ...
 *
 * @method PromiseInterface<OperationResponse> collectApiDataAsync(CollectApiDataRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Location> getLocationAsync(GetLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listLocationsAsync(ListLocationsRequest $request, array $optionalArgs = [])
 */
final class ApiHubCollectClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.apihub.v1.ApiHubCollect';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/api_hub_collect_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/api_hub_collect_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/api_hub_collect_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * The async variant is {@see ApiHubCollectClient::collectApiDataAsync()} .
     *
     * @example samples/V1/ApiHubCollectClient/collect_api_data.php
     *
     * @param CollectApiDataRequest $request     A request to house fields associated with the call.
     ...
     */
    public function collectApiData(CollectApiDataRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CollectApiData', $request, $callOptions)->wait();
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see ApiHubCollectClient::getLocationAsync()} .
     *
     * @example samples/V1/ApiHubCollectClient/get_location.php
     *
     ...
     *
     * The async variant is {@see ApiHubCollectClient::listLocationsAsync()} .
     *
     * @example samples/V1/ApiHubCollectClient/list_locations.php
     *
