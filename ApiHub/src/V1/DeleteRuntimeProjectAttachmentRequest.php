 ...
 * method's request.
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.DeleteRuntimeProjectAttachmentRequest</code>
 */
class DeleteRuntimeProjectAttachmentRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the Runtime Project Attachment to delete.
     *                     Format:
     *                     `projects/{project}/locations/{location}/runtimeProjectAttachments/{runtime_project_attachment}`
     *                     Please see {@see RuntimeProjectAttachmentServiceClient::runtimeProjectAttachmentName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\DeleteRuntimeProjectAttachmentRequest
     *
     * @experimental
     */
