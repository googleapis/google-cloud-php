 ...
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.ListDiscoveredApiObservationsRequest</code>
 */
class ListDiscoveredApiObservationsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of ApiObservations.
     *                       Format:
     *                       projects/{project}/locations/{location}
     *                       Please see {@see ApiHubDiscoveryClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\ListDiscoveredApiObservationsRequest
     *
     * @experimental
     */
