 ...
 *
 * Generated from protobuf message <code>google.cloud.apihub.v1.ListCurationsRequest</code>
 */
class ListCurationsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent, which owns this collection of curation resources.
     *                       Format: `projects/{project}/locations/{location}`
     *                       Please see {@see ApiHubCurateClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\ApiHub\V1\ListCurationsRequest
     *
     * @experimental
     */
