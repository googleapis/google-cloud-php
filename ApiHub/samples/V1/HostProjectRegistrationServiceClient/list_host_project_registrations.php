 ...
 *
 * @param string $formattedParent The parent, which owns this collection of host projects.
 *                                Format: `projects/&#42;/locations/*`
 *                                Please see {@see HostProjectRegistrationServiceClient::locationName()} for help formatting this field.
 */
function list_host_project_registrations_sample(string $formattedParent): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    list_host_project_registrations_sample($formattedParent);
}
