...
class ApiHubClientTest extends GeneratedTest
{
    ...
    public function createAttributeTest()
    {
        ...
        $request = (new CreateAttributeRequest())->setParent($formattedParent)->setAttribute($attribute);
    ...
    public function createExternalApiTest()
    {
        ...
        $request = (new CreateExternalApiRequest())->setParent($formattedParent)->setExternalApi($externalApi);
    ...
    public function createSpecTest()
    {
        ...
        $request = (new CreateSpecRequest())->setParent($formattedParent)->setSpec($spec);
    ...
    public function deleteAttributeTest()
    {
        ...
        $request = (new DeleteAttributeRequest())->setName($formattedName);
    ...
    public function deleteExternalApiTest()
    {
        ...
        $request = (new DeleteExternalApiRequest())->setName($formattedName);
    ...
    public function deleteSpecTest()
    {
        ...
        $request = (new DeleteSpecRequest())->setName($formattedName);
    ...
    public function getApiOperationTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->apiOperationName('[PROJECT]', '[LOCATION]', '[API]', '[VERSION]', '[OPERATION]');
        $request = (new GetApiOperationRequest())->setName($formattedName);
    ...
    public function getAttributeTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->attributeName('[PROJECT]', '[LOCATION]', '[ATTRIBUTE]');
        $request = (new GetAttributeRequest())->setName($formattedName);
    ...
    public function getDefinitionTest()
    {
        ...
        $request = (new GetDefinitionRequest())->setName($formattedName);
    ...
    public function getExternalApiTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->externalApiName('[PROJECT]', '[LOCATION]', '[EXTERNAL_API]');
        $request = (new GetExternalApiRequest())->setName($formattedName);
    ...
    public function getSpecTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->specName('[PROJECT]', '[LOCATION]', '[API]', '[VERSION]', '[SPEC]');
        $request = (new GetSpecRequest())->setName($formattedName);
    ...
    public function getSpecContentsTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->specName('[PROJECT]', '[LOCATION]', '[API]', '[VERSION]', '[SPEC]');
        $request = (new GetSpecContentsRequest())->setName($formattedName);
    ...
    public function listApiOperationsTest()
    {
        ...
        $apiOperations = [$apiOperationsElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->versionName('[PROJECT]', '[LOCATION]', '[API]', '[VERSION]');
        $request = (new ListApiOperationsRequest())->setParent($formattedParent);
    ...
    public function listAttributesTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListAttributesRequest())->setParent($formattedParent);
    ...
    public function listExternalApisTest()
    {
        ...
        $externalApis = [$externalApisElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListExternalApisRequest())->setParent($formattedParent);
    ...
    public function listSpecsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->versionName('[PROJECT]', '[LOCATION]', '[API]', '[VERSION]');
        $request = (new ListSpecsRequest())->setParent($formattedParent);
    ...
    public function searchResourcesTest()
    {
        ...
        $request = (new SearchResourcesRequest())->setLocation($formattedLocation)->setQuery($query);
    ...
    public function updateAttributeTest()
    {
        ...
        $attribute->setDataType($attributeDataType);
        $updateMask = new FieldMask();
        $request = (new UpdateAttributeRequest())->setAttribute($attribute)->setUpdateMask($updateMask);
    ...
    public function updateExternalApiTest()
    {
        ...
        $externalApi->setDisplayName($externalApiDisplayName);
        $updateMask = new FieldMask();
        $request = (new UpdateExternalApiRequest())->setExternalApi($externalApi)->setUpdateMask($updateMask);
    ...
    public function updateSpecTest()
    {
        ...
        $spec->setSpecType($specSpecType);
        $updateMask = new FieldMask();
        $request = (new UpdateSpecRequest())->setSpec($spec)->setUpdateMask($updateMask);
