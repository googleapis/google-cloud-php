...
namespace Google\Cloud\DataLabeling\Tests\Unit\V1beta1\Client;
...
class DataLabelingServiceClientTest extends GeneratedTest
{
    ...
    public function createAnnotationSpecSetTest()
    {
        ...
        $expectedResponse = new AnnotationSpecSet();
    ...
    public function createEvaluationJobTest()
    {
        ...
        $annotationSpecSet = 'annotationSpecSet1881405678';
        $labelMissingGroundTruth = false;
        $expectedResponse = new EvaluationJob();
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
    ...
    public function createInstructionTest()
    {
        ...
        $incompleteOperation->setName('operations/createInstructionTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        $description = 'description-1724546052';
        $expectedResponse = new Instruction();
        $expectedResponse->setName($name);
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setDescription($description);
        $anyResponse = new Any();
        ...
        $completeOperation->setName('operations/createInstructionTest');
    ...
    public function exportDataTest()
    {
        ...
        $totalCount = 407761836;
        $exportCount = 529256252;
        $expectedResponse = new ExportDataOperationResponse();
        $expectedResponse->setDataset($dataset);
        $expectedResponse->setTotalCount($totalCount);
        $expectedResponse->setExportCount($exportCount);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
    ...
    public function getAnnotatedDatasetTest()
    {
        ...
        $completedExampleCount = 612567290;
        $expectedResponse = new AnnotatedDataset();
    ...
    public function importDataTest()
    {
        ...
        $expectedResponse = new ImportDataOperationResponse();
        $expectedResponse->setDataset($dataset);
        $expectedResponse->setTotalCount($totalCount);
    ...
    public function labelImageTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/labelImageTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/labelImageTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    public function labelTextTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/labelTextTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/labelTextTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    public function labelVideoTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/labelVideoTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/labelVideoTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
    ...
    public function listAnnotatedDatasetsTest()
    {
        ...
        $this->assertEquals($expectedResponse->getAnnotatedDatasets()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listAnnotationSpecSetsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getAnnotationSpecSets()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listDataItemsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDataItems()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listEvaluationJobsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getEvaluationJobs()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listInstructionsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getInstructions()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function searchExampleComparisonsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getExampleComparisons()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function createAnnotationSpecSetAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
