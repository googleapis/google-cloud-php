 ...
 *
 * Generated from protobuf message <code>google.cloud.datalabeling.v1beta1.ListDataItemsResponse</code>
 */
class ListDataItemsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DataLabeling\V1beta1\DataItem::class);
        $this->data_items = $arr;
