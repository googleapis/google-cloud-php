...
// [START secretmanager_v1_generated_SecretManagerService_RotateSecret_sync]
 ...
 */
function rotate_secret_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $secretManagerServiceClient->rotateSecret($request);
...
function callSample(): void
{
    ...
    rotate_secret_sample($formattedParent);
}
// [END secretmanager_v1_generated_SecretManagerService_RotateSecret_sync]
