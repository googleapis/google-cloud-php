 ...
 */
function enable_managed_rotation_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $secretManagerServiceClient->enableManagedRotation($request);
...
function callSample(): void
{
    ...
    enable_managed_rotation_sample($formattedParent);
}
