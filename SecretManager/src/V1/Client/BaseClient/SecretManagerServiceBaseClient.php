...
namespace Google\Cloud\SecretManager\V1\Client\BaseClient;
...
class SecretManagerServiceBaseClient
{
    ...
    {
        self::loadPathTemplates(__DIR__ . '/../../resources/secret_manager_service_descriptor_config.php', self::SERVICE_NAME);
    }
