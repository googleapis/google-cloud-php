...
class UserManaged extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\SecretManager\V1\Replication\UserManaged\Replica[] $replicas
     *           Required. The list of Replicas for this
     *           [Secret][google.cloud.secretmanager.v1.Secret].
     *           Cannot be empty.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.secretmanager.v1.Replication.UserManaged.Replica replicas = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Cloud\SecretManager\V1\Replication\UserManaged\Replica>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.secretmanager.v1.Replication.UserManaged.Replica replicas = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\SecretManager\V1\Replication\UserManaged\Replica[] $var
     * @return $this
     */
