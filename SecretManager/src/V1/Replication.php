...
class Replication extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecretManager\V1\Replication_Automatic::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecretManager\V1\Replication_UserManaged::class);
