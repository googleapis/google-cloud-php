...
namespace Google\Cloud\SecretManager\V1beta2\ReplicationStatus\UserManagedStatus;
 ...
 *
 * Generated from protobuf message <code>google.cloud.secretmanager.v1beta2.ReplicationStatus.UserManagedStatus.ReplicaStatus</code>
 */
class ReplicaStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatus customer_managed_encryption = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
...
class_alias(ReplicaStatus::class, \Google\Cloud\SecretManager\V1beta2\ReplicationStatus_UserManagedStatus_ReplicaStatus::class);
