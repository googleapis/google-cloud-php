 ...
 *
 * Generated from protobuf message <code>google.cloud.secretmanager.v1beta2.UpdateSecretRequest</code>
 */
class UpdateSecretRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * field values.
     *
     * Generated from protobuf field <code>.google.cloud.secretmanager.v1beta2.Secret secret = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\SecretManager\V1beta2\Secret $secret     Required. [Secret][google.cloud.secretmanager.v1beta2.Secret] with updated
     *                                                               field values.
     * @param \Google\Protobuf\FieldMask                 $updateMask Required. Specifies the fields to be updated.
     *
     * @return \Google\Cloud\SecretManager\V1beta2\UpdateSecretRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\SecretManager\V1beta2\Secret $secret, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
            ->setSecret($secret)
