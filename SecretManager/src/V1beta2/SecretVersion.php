 ...
 *
 * Generated from protobuf message <code>google.cloud.secretmanager.v1beta2.SecretVersion</code>
 */
class SecretVersion extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The current state of the
     *           [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion].
     *     @type \Google\Cloud\SecretManager\V1beta2\ReplicationStatus $replication_status
     *           The replication status of the
     *           [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion].
     *     @type string $etag
     *           Output only. Etag of the currently stored
     ...
     *           destroyed, version is moved to disabled state and it is scheduled for
     *           destruction Version is destroyed only after the scheduled_destroy_time.
     *     @type \Google\Cloud\SecretManager\V1beta2\CustomerManagedEncryptionStatus $customer_managed_encryption
     *           Output only. The customer-managed encryption status of the
     *           [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]. Only
     *           populated if customer-managed encryption is used and
     *           [Secret][google.cloud.secretmanager.v1beta2.Secret] is a Regionalised
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecretManager\V1beta2\SecretVersion\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.secretmanager.v1beta2.ReplicationStatus replication_status = 5;</code>
     * @return \Google\Cloud\SecretManager\V1beta2\ReplicationStatus|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.secretmanager.v1beta2.ReplicationStatus replication_status = 5;</code>
     * @param \Google\Cloud\SecretManager\V1beta2\ReplicationStatus $var
     * @return $this
     */
    public function setReplicationStatus($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\SecretManager\V1beta2\ReplicationStatus::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatus customer_managed_encryption = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\SecretManager\V1beta2\CustomerManagedEncryptionStatus|null
     */
