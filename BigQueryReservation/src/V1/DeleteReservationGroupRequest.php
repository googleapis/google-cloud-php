 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.reservation.v1.DeleteReservationGroupRequest</code>
 */
class DeleteReservationGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Resource name of the reservation group to retrieve. E.g.,
     *                     `projects/myproject/locations/US/reservationGroups/team1-prod`
     *                     Please see {@see ReservationServiceClient::reservationGroupName()} for help formatting this field.
     *
     * @return \Google\Cloud\BigQuery\Reservation\V1\DeleteReservationGroupRequest
     *
     * @experimental
     */
