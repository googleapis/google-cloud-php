 ...
 *
 * Generated from protobuf message <code>google.cloud.datacatalog.lineage.v1.ListLineageEventsResponse</code>
 */
class ListLineageEventsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DataCatalog\Lineage\V1\LineageEvent::class);
