 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.RegisterParameters</code>
 */
class RegisterParameters extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1\RegisterParameters\Availability::class);
