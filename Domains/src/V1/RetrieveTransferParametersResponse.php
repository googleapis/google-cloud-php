 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.RetrieveTransferParametersResponse</code>
 */
class RetrieveTransferParametersResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Domains\V1\TransferParameters $transfer_parameters
     *           Parameters to use when calling the `TransferDomain` method.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1.TransferParameters transfer_parameters = 1;</code>
     * @return \Google\Cloud\Domains\V1\TransferParameters|null
     */
