 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1.ManagementSettings</code>
 */
class ManagementSettings extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1\ManagementSettings\RenewalMethod::class);
