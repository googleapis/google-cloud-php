 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1beta1.RetrieveTransferParametersResponse</code>
 */
class RetrieveTransferParametersResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1beta1.TransferParameters transfer_parameters = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Domains\V1beta1\TransferParameters $transfer_parameters
     *           Parameters to use when calling the `TransferDomain` method.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1beta1.TransferParameters transfer_parameters = 1;</code>
     * @return \Google\Cloud\Domains\V1beta1\TransferParameters|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1beta1.TransferParameters transfer_parameters = 1;</code>
     * @param \Google\Cloud\Domains\V1beta1\TransferParameters $var
     * @return $this
     */
    public function setTransferParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1beta1\TransferParameters::class);
