...
namespace Google\Cloud\Scheduler\V1\Client\BaseClient;
 ...
 */
abstract class CloudSchedulerBaseClient
{
     ...
     * be paused.
     *
     * The async variant is {@see self::pauseJobAsync()} .
     *
     ...
     * to be resumed.
     *
     * The async variant is {@see self::resumeJobAsync()} .
     *
