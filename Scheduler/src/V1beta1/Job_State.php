...
@trigger_error('Google\Cloud\Scheduler\V1beta1\Job_State is deprecated and will be removed in the next major release. Use Google\Cloud\Scheduler\V1beta1\Job\State instead', E_USER_DEPRECATED);
