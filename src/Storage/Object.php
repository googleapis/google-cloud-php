...
class Object
{
     ...
     * @param array $data
     */
    public function __construct(ConnectionInterface $connection, array $identity, array $data = null)
    {
    ...
    {
        $this->connection->patchObject($options + $this->identity);
    }
     ...
     * file_put_contents($string, 'file.txt');
     * ```
     *
     * @param array $options Configuration options.
     * @return string
