...
class IamObject implements IamConnectionInterface
{
    /**
    ...
    {
        return $this->connection->getObjectIamPolicy($args);
    }
    ...
    {
        return $this->connection->setObjectIamPolicy($args);
    }
    ...
    {
        return $this->connection->testObjectIamPermissions($args);
    }
}
