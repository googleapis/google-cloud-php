...
class ErrorGroupServiceGapicClient
{
    ...
    protected $errorGroupServiceTransport;
    private $scopes;
    ...
    public function __construct($options = [])
    {
                    ...
                    case 'grpc':
                        if (empty($options['createGrpcStubFunction'])) {
                            $options['createGrpcStubFunction'] = function ($fullAddress, $stubOpts, $channel) {
                                return new ErrorGroupServiceGrpcClient($fullAddress, $stubOpts, $channel);
                            };
                        }
        ...
        $this->errorGroupServiceTransport = call_user_func_array(
    ...
    public function getGroup($groupName, $optionalArgs = [])
    {
        ...
        $callable = $this->errorGroupServiceTransport->createApiCall(
            'GetGroup',
            $mergedSettings,
    ...
    {
        $this->errorGroupServiceTransport->close();
    }
}
