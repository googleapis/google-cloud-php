...
class ErrorStatsServiceGapicClient
{
    ...
    public function listGroupStats($projectName, $timeRange, $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse(
            new Call(
                self::SERVICE_NAME.'/ListGroupStats',
                ListGroupStatsResponse::class,
                $request
            ),
            $this->configureCallSettings('listGroupStats', $optionalArgs),
            $this->descriptors['listGroupStats']['pageStreaming']
        );
    }
    ...
    public function listEvents($projectName, $groupId, $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse(
            new Call(
                self::SERVICE_NAME.'/ListEvents',
                ListEventsResponse::class,
                $request
            ),
            $this->configureCallSettings('listEvents', $optionalArgs),
            $this->descriptors['listEvents']['pageStreaming']
        );
    }
    ...
    public function deleteEvents($projectName, $optionalArgs = [])
    {
        ...
        return $this->startCall(
            new Call(
                self::SERVICE_NAME.'/DeleteEvents',
                DeleteEventsResponse::class,
                $request
            ),
            $this->configureCallSettings('deleteEvents', $optionalArgs)
        )->wait();
    }
