...
class ErrorStatsServiceGapicClient
{
    ...
    protected $errorStatsServiceTransport;
    private $scopes;
    ...
    public function __construct($options = [])
    {
                    ...
                    case 'grpc':
                        if (empty($options['createGrpcStubFunction'])) {
                            $options['createGrpcStubFunction'] = function ($fullAddress, $stubOpts, $channel) {
                                return new ErrorStatsServiceGrpcClient($fullAddress, $stubOpts, $channel);
                            };
                        }
        ...
        $this->errorStatsServiceTransport = call_user_func_array(
    ...
    public function listGroupStats($projectName, $timeRange, $optionalArgs = [])
    {
        ...
        $callable = $this->errorStatsServiceTransport->createApiCall(
            'ListGroupStats',
            $mergedSettings,
    ...
    {
        $this->errorStatsServiceTransport->close();
    }
}
