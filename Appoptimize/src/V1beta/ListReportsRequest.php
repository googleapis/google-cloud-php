 ...
 *
 * Generated from protobuf message <code>google.cloud.appoptimize.v1beta.ListReportsRequest</code>
 */
class ListReportsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent project whose reports are to be listed.
     *
     *                       Format: `projects/{project}/locations/{location}`. Please see
     *                       {@see AppOptimizeClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\Appoptimize\V1beta\ListReportsRequest
     *
     * @experimental
     */
