...
/**
 * Generated from protobuf message <code>FirestoreTests.QueryTest</code>
 */
class QueryTest extends \Google\Protobuf\Internal\Message
{
    ...
    private $coll_path = '';
    /**
     * Generated from protobuf field <code>repeated .FirestoreTests.Clause clauses = 2;</code>
     */
    private $clauses;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .FirestoreTests.Clause clauses = 2;</code>
     * @param \Google\Cloud\Tests\Conformance\Firestore\Clause[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setClauses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Tests\Conformance\Firestore\Clause::class);
        $this->clauses = $arr;
