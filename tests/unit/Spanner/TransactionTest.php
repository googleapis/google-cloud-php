...
class TransactionTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->transaction = \Google\Cloud\Core\Testing\stub(Transaction::class, $args, $props);

        unset($args[2]);
        $this->singleUseTransaction = \Google\Cloud\Core\Testing\stub(Transaction::class, $args, $props);
    }
    ...
    public function testIsRetryTrue()
    {
        ...
        $transaction = \Google\Cloud\Core\Testing\stub(Transaction::class, $args);
