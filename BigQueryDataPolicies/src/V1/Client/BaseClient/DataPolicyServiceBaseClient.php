...
namespace Google\Cloud\BigQuery\DataPolicies\V1\Client\BaseClient;
 ...
 */
abstract class DataPolicyServiceBaseClient
{
     ...
     */
    public static function dataPolicyName(string $project, string $location, string $dataPolicy): string
    {
        return self::getPathTemplate('dataPolicy')->render([
            'project' => $project,
            'location' => $location,
     ...
     */
    public function createDataPolicy(CreateDataPolicyRequest $request, array $callOptions = []): DataPolicy
    {
        return $this->startApiCall('CreateDataPolicy', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteDataPolicy(DeleteDataPolicyRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteDataPolicy', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getDataPolicy(GetDataPolicyRequest $request, array $callOptions = []): DataPolicy
    {
        return $this->startApiCall('GetDataPolicy', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listDataPolicies(ListDataPoliciesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListDataPolicies', $request, $callOptions);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function renameDataPolicy(RenameDataPolicyRequest $request, array $callOptions = []): DataPolicy
    {
        return $this->startApiCall('RenameDataPolicy', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateDataPolicy(UpdateDataPolicyRequest $request, array $callOptions = []): DataPolicy
    {
        return $this->startApiCall('UpdateDataPolicy', $request, $callOptions)->wait();
    }
}
