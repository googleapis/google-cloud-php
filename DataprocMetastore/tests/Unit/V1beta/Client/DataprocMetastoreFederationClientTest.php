...
namespace Google\Cloud\Metastore\Tests\Unit\V1beta\Client;
...
use Google\Cloud\Metastore\V1beta\CreateFederationRequest;
use Google\Cloud\Metastore\V1beta\DeleteFederationRequest;
use Google\Cloud\Metastore\V1beta\Federation;
use Google\Cloud\Metastore\V1beta\GetFederationRequest;
use Google\Cloud\Metastore\V1beta\ListFederationsRequest;
use Google\Cloud\Metastore\V1beta\ListFederationsResponse;
 ...
 * @group gapic
 */
class DataprocMetastoreFederationClientTest extends GeneratedTest
{
    ...
    public function listFederationsTest()
    {
        ...
        $federations = [$federationsElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListFederationsRequest())->setParent($formattedParent);
    ...
    public function updateFederationTest()
    {
        ...
        $federation = new Federation();
        $request = (new UpdateFederationRequest())->setUpdateMask($updateMask)->setFederation($federation);
