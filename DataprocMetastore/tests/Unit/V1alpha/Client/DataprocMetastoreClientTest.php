...
namespace Google\Cloud\Metastore\Tests\Unit\V1alpha\Client;
...
use Google\Cloud\Metastore\V1alpha\QueryMetadataRequest;
use Google\Cloud\Metastore\V1alpha\QueryMetadataResponse;
use Google\Cloud\Metastore\V1alpha\RemoveIamPolicyRequest;
...
class DataprocMetastoreClientTest extends GeneratedTest
{
    ...
    public function removeIamPolicyTest()
    {
        ...
        $request = (new RemoveIamPolicyRequest())->setResource($resource);
        $response = $gapicClient->removeIamPolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function removeIamPolicyExceptionTest()
    {
        ...
        $request = (new RemoveIamPolicyRequest())->setResource($resource);
        try {
            $gapicClient->removeIamPolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function alterMetadataResourceLocationAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
