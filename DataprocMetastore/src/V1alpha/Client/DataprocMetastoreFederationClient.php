 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/metastore/v1alpha/metastore_federation.proto
...
final class DataprocMetastoreFederationClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.metastore.v1alpha.DataprocMetastoreFederation';
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/create_federation.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/delete_federation.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/get_federation.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/list_federations.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/update_federation.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/get_location.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/list_locations.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/get_iam_policy.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/set_iam_policy.php
     *
     ...
     *
     * @example samples/V1alpha/DataprocMetastoreFederationClient/test_iam_permissions.php
     *
