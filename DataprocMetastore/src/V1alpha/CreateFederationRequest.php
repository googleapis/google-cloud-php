 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1alpha.CreateFederationRequest</code>
 */
class CreateFederationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1alpha.Federation federation = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Metastore\V1alpha\Federation $federation   Required. The Metastore Federation to create. The `name` field is
     *                                                                 ignored. The ID of the created metastore federation must be
     *                                                                 provided in the request's `federation_id` field.
     ...
     *                                                                 ASCII characters or hyphens.
     *
     * @return \Google\Cloud\Metastore\V1alpha\CreateFederationRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Metastore\V1alpha\Federation $federation, string $federationId): self
    {
        return (new self())
            ->setParent($parent)
