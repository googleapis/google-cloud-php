 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1alpha.ExportMetadataRequest</code>
 */
class ExportMetadataRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * `MYSQL`.
     *
     * Generated from protobuf field <code>.google.cloud.metastore.v1alpha.DatabaseDumpSpec.Type database_dump_type = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
