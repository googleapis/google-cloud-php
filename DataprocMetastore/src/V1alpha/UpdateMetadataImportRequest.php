 ...
 *
 * Generated from protobuf message <code>google.cloud.metastore.v1alpha.UpdateMetadataImportRequest</code>
 */
class UpdateMetadataImportRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param \Google\Cloud\Metastore\V1alpha\MetadataImport $metadataImport Required. The metadata import to update. The server only merges fields
     *                                                                       in the import if they are specified in `update_mask`.
     *
     *                                                                       The metadata import's `name` field is used to identify the metastore
     *                                                                       import to be updated.
     ...
     *                                                                       to the full request). A field is overwritten if it is in the mask.
     *
     * @return \Google\Cloud\Metastore\V1alpha\UpdateMetadataImportRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Metastore\V1alpha\MetadataImport $metadataImport, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
