...
class DataprocMetastoreFederationGrpcClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Cloud\Metastore\V1beta\ListFederationsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function ListFederations(\Google\Cloud\Metastore\V1beta\ListFederationsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.cloud.metastore.v1beta.DataprocMetastoreFederation/ListFederations',
        $argument,
