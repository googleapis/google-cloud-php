...
class UpdateFederationRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param \Google\Cloud\Metastore\V1beta\Federation $federation Required. The metastore federation to update. The server only merges fields
     *                                                              in the service if they are specified in `update_mask`.
     *
     *                                                              The metastore federation's `name` field is used to identify the
     *                                                              metastore service to be updated.
     ...
     *                                                              to the full request). A field is overwritten if it is in the mask.
     *
     * @return \Google\Cloud\Metastore\V1beta\UpdateFederationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Metastore\V1beta\Federation $federation, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
