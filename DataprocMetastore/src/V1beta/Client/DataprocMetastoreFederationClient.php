 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/metastore/v1beta/metastore_federation.proto
...
final class DataprocMetastoreFederationClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.metastore.v1beta.DataprocMetastoreFederation';
     ...
     *           $options = new DataprocMetastoreFederationClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/create_federation.php
     *
     ...
     * }
     *
     * @return OperationResponse<Federation>
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/delete_federation.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/get_federation.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/list_federations.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/update_federation.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/get_location.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/list_locations.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/get_iam_policy.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/set_iam_policy.php
     *
     ...
     *
     * @example samples/V1beta/DataprocMetastoreFederationClient/test_iam_permissions.php
     *
