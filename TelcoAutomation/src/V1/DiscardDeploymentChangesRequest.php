 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1.DiscardDeploymentChangesRequest</code>
 */
class DiscardDeploymentChangesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the deployment of which changes are being discarded.
     *
