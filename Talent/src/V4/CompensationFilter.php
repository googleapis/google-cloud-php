 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.CompensationFilter</code>
 */
class CompensationFilter extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.CompensationFilter.FilterType type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\CompensationFilter\FilterType::class);
        $this->type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Talent\V4\CompensationInfo\CompensationUnit::class);
        $this->units = $arr;
