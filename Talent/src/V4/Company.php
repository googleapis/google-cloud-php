 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.Company</code>
 */
class Company extends \Google\Protobuf\Internal\Message
{
     ...
     *           parenthesis, brackets and special symbols are not searchable as-is,
     *           and those keyword queries must be surrounded by quotes.
     *     @type \Google\Cloud\Talent\V4\Company\DerivedInfo $derived_info
     *           Output only. Derived details about the company.
     *     @type bool $suspended
     *           Output only. Indicates whether a company is flagged to be suspended from
     *           public availability by the service when job content appears suspicious,
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\CompanySize::class);
        $this->size = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.Company.DerivedInfo derived_info = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Talent\V4\Company\DerivedInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.Company.DerivedInfo derived_info = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Talent\V4\Company\DerivedInfo $var
     * @return $this
     */
    public function setDerivedInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Talent\V4\Company\DerivedInfo::class);
