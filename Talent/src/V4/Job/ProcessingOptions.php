 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.Job.ProcessingOptions</code>
 */
class ProcessingOptions extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4\HtmlSanitization::class);
...
class_alias(ProcessingOptions::class, \Google\Cloud\Talent\V4\Job_ProcessingOptions::class);
