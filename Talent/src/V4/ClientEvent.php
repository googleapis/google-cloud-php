 ...
 *
 * Generated from protobuf message <code>google.cloud.talent.v4.ClientEvent</code>
 */
class ClientEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The timestamp of the event.
     *     @type \Google\Cloud\Talent\V4\JobEvent $job_event
     ...
     * implements Cloud Talent Solution.
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.JobEvent job_event = 5;</code>
     * @return \Google\Cloud\Talent\V4\JobEvent|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4.JobEvent job_event = 5;</code>
     * @param \Google\Cloud\Talent\V4\JobEvent $var
     * @return $this
     */
    public function setJobEvent($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Talent\V4\JobEvent::class);
