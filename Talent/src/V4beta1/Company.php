...
class Company extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.talent.v4beta1.Company.DataLearningType learning_type = 14;</code>
     */
    private $learning_type = 0;
     ...
     * @return $this
     */
    public function setLearningType($var)
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Talent\V4beta1\Company_DataLearningType::class);
        $this->learning_type = $var;
