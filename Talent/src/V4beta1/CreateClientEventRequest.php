...
class CreateClientEventRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\Talent\V4beta1\ClientEvent $clientEvent Required. Events issued when end user interacts with customer's application
     *                                                              that uses Cloud Talent Solution.
     *
     * @return \Google\Cloud\Talent\V4beta1\CreateClientEventRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Talent\V4beta1\ClientEvent $clientEvent): self
    {
        return (new self())
            ->setParent($parent)
