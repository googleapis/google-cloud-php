...
class JobQuery extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated string company_names = 2;</code>
     */
    private $company_names;
    /**
     * Optional.
     ...
     *           location fields.
     *           The maximum number of allowed characters is 255.
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $company_names
     *           Optional.
     *           This filter specifies the company entities to search against.
     *           If a value isn't specified, jobs are searched for against all
     *           companies.
     ...
     * @return $this
     */
    public function setCompanyNames($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::STRING);
        $this->company_names = $arr;
