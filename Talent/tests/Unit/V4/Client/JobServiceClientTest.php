...
namespace Google\Cloud\Talent\Tests\Unit\V4\Client;
...
class JobServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateJobsTest()
    {
        ...
        $expectedResponse = new BatchCreateJobsResponse();
        $anyResponse = new Any();
        ...
        $jobs = [];
        $request = (new BatchCreateJobsRequest())->setParent($formattedParent)->setJobs($jobs);
    ...
    public function batchDeleteJobsTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/batchDeleteJobsTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new BatchDeleteJobsResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/batchDeleteJobsTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedParent = $gapicClient->tenantName('[PROJECT]', '[TENANT]');
        $request = (new BatchDeleteJobsRequest())->setParent($formattedParent);
    ...
    public function batchUpdateJobsTest()
    {
        ...
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new BatchUpdateJobsResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        ...
        $formattedParent = $gapicClient->tenantName('[PROJECT]', '[TENANT]');
        $jobs = [];
        $request = (new BatchUpdateJobsRequest())->setParent($formattedParent)->setJobs($jobs);
    ...
    public function listJobsTest()
    {
        ...
        $request = (new ListJobsRequest())->setParent($formattedParent)->setFilter($filter);
    ...
    public function searchJobsTest()
    {
        ...
        $request = (new SearchJobsRequest())->setParent($formattedParent)->setRequestMetadata($requestMetadata);
