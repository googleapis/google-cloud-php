 ...
 * @param string $formattedNetwork                      Fully-qualified URL of the network that this route applies to. e.g.
...
function create_policy_based_route_sample(
    ...
    $policyBasedRoute = (new PolicyBasedRoute())
        ->setNetwork($policyBasedRouteNetwork)
...
function callSample(): void
{
    ...
    $formattedNetwork = PolicyBasedRoutingServiceClient::networkName('[PROJECT]', '[RESOURCE_ID]');
