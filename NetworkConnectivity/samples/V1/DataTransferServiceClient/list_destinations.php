 ...
 */
function list_destinations_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $dataTransferServiceClient->listDestinations($request);
...
function callSample(): void
{
    ...
    list_destinations_sample($formattedParent);
}
