 ...
 *
 * @param string $formattedName Name of the InternalRange to get. Please see
 *                              {@see InternalRangeServiceClient::internalRangeName()} for help formatting this field.
 */
function get_internal_range_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var InternalRange $response */
        $response = $internalRangeServiceClient->getInternalRange($request);
...
function callSample(): void
{
    ...
    get_internal_range_sample($formattedName);
}
