...
class PolicyBasedRoutingServiceClientTest extends GeneratedTest
{
    ...
    public function createPolicyBasedRouteTest()
    {
        ...
        $response = $gapicClient->createPolicyBasedRoute($formattedParent, $policyBasedRoute);
    ...
    public function deletePolicyBasedRouteTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->policyBasedRouteName('[PROJECT]', '[LOCATION]', '[POLICY_BASED_ROUTE]');
