 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.AcceptSpokeUpdateRequest</code>
 */
class AcceptSpokeUpdateRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name      Required. The name of the hub to accept spoke update. Please see
     *                          {@see HubServiceClient::hubName()} for help formatting this field.
     * @param string $spokeUri  Required. The URI of the spoke to accept update. Please see
     *                          {@see HubServiceClient::spokeName()} for help formatting this field.
     * @param string $spokeEtag Required. The etag of the spoke to accept update.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\AcceptSpokeUpdateRequest
     *
     * @experimental
     */
