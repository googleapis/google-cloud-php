 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.DeleteDestinationRequest</code>
 */
class DeleteDestinationRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the `Destination` resource to delete. Please see
     *                     {@see DataTransferServiceClient::destinationName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\DeleteDestinationRequest
     *
     * @experimental
     */
