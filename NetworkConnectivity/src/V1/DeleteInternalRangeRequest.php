 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.DeleteInternalRangeRequest</code>
 */
class DeleteInternalRangeRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the internal range to delete. Please see
     *                     {@see InternalRangeServiceClient::internalRangeName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\DeleteInternalRangeRequest
     *
     * @experimental
     */
