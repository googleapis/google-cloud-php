 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.DeleteServiceConnectionPolicyRequest</code>
 */
class DeleteServiceConnectionPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the ServiceConnectionPolicy to delete. Please see
     *                     {@see CrossNetworkAutomationServiceClient::serviceConnectionPolicyName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\DeleteServiceConnectionPolicyRequest
     *
     * @experimental
     */
