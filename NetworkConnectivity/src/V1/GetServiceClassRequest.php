 ...
 *
 * Generated from protobuf message <code>google.cloud.networkconnectivity.v1.GetServiceClassRequest</code>
 */
class GetServiceClassRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the ServiceClass to get. Please see
     *                     {@see CrossNetworkAutomationServiceClient::serviceClassName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkConnectivity\V1\GetServiceClassRequest
     *
     * @experimental
     */
