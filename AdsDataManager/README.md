...
> Idiomatic PHP client for [Google Ads Data Manager](https://developers.google.com/data-manager).

[![Latest Stable Version](https://poser.pugx.org/googleads/datamanager/v/stable)](https://packagist.org/packages/googleads/datamanager) [![Packagist](https://img.shields.io/packagist/dm/googleads/datamanager.svg)](https://packagist.org/packages/googleads/datamanager)

* [API documentation](https://cloud.google.com/php/docs/reference/googleads/datamanager/latest)
...
1. Understand the [official documentation](https://developers.google.com/data-manager).
