    ...
    'interfaces' => [
        'google.ads.datamanager.v1.UserListDirectLicenseService' => [
            'CreateUserListDirectLicense' => [
                ...
                'responseType' => 'Google\Ads\DataManager\V1\UserListDirectLicense',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListUserListDirectLicenses' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getUserListDirectLicenses',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Ads\DataManager\V1\ListUserListDirectLicensesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'UpdateUserListDirectLicense' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'user_list_direct_license.name',
                        'fieldAccessors' => [
                            'getUserListDirectLicense',
                            'getName',
                        ],
