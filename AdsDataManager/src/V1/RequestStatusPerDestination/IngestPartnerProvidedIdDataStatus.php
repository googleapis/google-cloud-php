 ...
 *
 * Generated from protobuf message <code>google.ads.datamanager.v1.RequestStatusPerDestination.IngestPartnerProvidedIdDataStatus</code>
 */
class IngestPartnerProvidedIdDataStatus extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>int64 partner_provided_id_count = 2;</code>
     */
    protected $partner_provided_id_count = 0;
     ...
     *           destination. Includes all audience members in the request, regardless of
     *           whether they were successfully ingested or not.
     *     @type int|string $partner_provided_id_count
     *           The total count of partner provided ids sent in the upload request for
     *           the destination. Includes all partner provided ids in the request,
     *           regardless of whether they were successfully ingested or not.
     * }
    ...
    {
        return $this->partner_provided_id_count;
    }
     ...
     * @return $this
     */
    public function setPartnerProvidedIdCount($var)
    {
        GPBUtil::checkInt64($var);
        $this->partner_provided_id_count = $var;
