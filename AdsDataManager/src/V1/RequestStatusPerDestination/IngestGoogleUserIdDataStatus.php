 ...
 *
 * Generated from protobuf message <code>google.ads.datamanager.v1.RequestStatusPerDestination.IngestGoogleUserIdDataStatus</code>
 */
class IngestGoogleUserIdDataStatus extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * whether they were successfully ingested or not.
     *
     * Generated from protobuf field <code>int64 google_user_id_count = 2;</code>
     */
    protected $google_user_id_count = 0;
     ...
     *           destination. Includes all audience members in the request, regardless of
     *           whether they were successfully ingested or not.
     *     @type int|string $google_user_id_count
     *           The total count of google user ids sent in the upload request for the
     *           destination. Includes all google user ids in the request, regardless of
     *           whether they were successfully ingested or not.
     * }
    ...
    {
        return $this->google_user_id_count;
    }
     ...
     * @return $this
     */
    public function setGoogleUserIdCount($var)
    {
        GPBUtil::checkInt64($var);
        $this->google_user_id_count = $var;
