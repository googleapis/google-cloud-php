 ...
 */
function create_user_list_global_license_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $userListGlobalLicenseServiceClient->createUserListGlobalLicense($request);
...
function callSample(): void
{
    ...
    create_user_list_global_license_sample($formattedParent);
}
