...
class UserListGlobalLicenseServiceClientTest extends GeneratedTest
{
    ...
    public function getUserListGlobalLicenseTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->userListGlobalLicenseName(
            '[ACCOUNT_TYPE]',
            '[ACCOUNT]',
            '[USER_LIST_GLOBAL_LICENSE]'
        );
        $request = (new GetUserListGlobalLicenseRequest())->setName($formattedName);
    ...
    public function listUserListGlobalLicenseCustomerInfosTest()
    {
        ...
        $userListGlobalLicenseCustomerInfos = [$userListGlobalLicenseCustomerInfosElement];
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->userListGlobalLicenseName(
            '[ACCOUNT_TYPE]',
            '[ACCOUNT]',
            '[USER_LIST_GLOBAL_LICENSE]'
        );
        $request = (new ListUserListGlobalLicenseCustomerInfosRequest())->setParent($formattedParent);
    ...
    public function listUserListGlobalLicensesTest()
    {
        ...
        $userListGlobalLicenses = [$userListGlobalLicensesElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->accountName('[ACCOUNT_TYPE]', '[ACCOUNT]');
        $request = (new ListUserListGlobalLicensesRequest())->setParent($formattedParent);
    ...
    public function updateUserListGlobalLicenseTest()
    {
        ...
        // Mock request
        $userListGlobalLicense = new UserListGlobalLicense();
        $request = (new UpdateUserListGlobalLicenseRequest())->setUserListGlobalLicense($userListGlobalLicense);
