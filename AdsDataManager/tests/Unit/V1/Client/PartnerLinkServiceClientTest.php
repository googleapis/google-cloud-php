...
class PartnerLinkServiceClientTest extends GeneratedTest
{
    ...
    public function createPartnerLinkTest()
    {
        ...
        $owningAccountAccountType = AccountType::ACCOUNT_TYPE_UNSPECIFIED;
        $partnerLinkOwningAccount->setAccountType($owningAccountAccountType);
        ...
        $partnerAccountAccountType = AccountType::ACCOUNT_TYPE_UNSPECIFIED;
        $partnerLinkPartnerAccount->setAccountType($partnerAccountAccountType);
        $partnerLink->setPartnerAccount($partnerLinkPartnerAccount);
        $request = (new CreatePartnerLinkRequest())->setParent($formattedParent)->setPartnerLink($partnerLink);
    ...
    public function deletePartnerLinkTest()
    {
        ...
        $request = (new DeletePartnerLinkRequest())->setName($formattedName);
    ...
    public function searchPartnerLinksTest()
    {
        ...
        $partnerLinks = [$partnerLinksElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->accountName('[ACCOUNT_TYPE]', '[ACCOUNT]');
        $request = (new SearchPartnerLinksRequest())->setParent($formattedParent);
