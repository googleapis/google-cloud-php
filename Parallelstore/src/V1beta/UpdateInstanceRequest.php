...
class UpdateInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                update_mask are relative to the resource, not the full request.
     *
     * @return \Google\Cloud\Parallelstore\V1beta\UpdateInstanceRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Parallelstore\V1beta\Instance $instance, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
