 ...
 *
 * Generated from protobuf message <code>google.cloud.support.v2beta.ListCommentsResponse</code>
 */
class ListCommentsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Support\V2beta\Comment::class);
        $this->comments = $arr;
