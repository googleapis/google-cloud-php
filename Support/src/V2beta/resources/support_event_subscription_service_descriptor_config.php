    ...
    'interfaces' => [
        'google.cloud.support.v2beta.SupportEventSubscriptionService' => [
            'CreateSupportEventSubscription' => [
                ...
                'responseType' => 'Google\Cloud\Support\V2beta\SupportEventSubscription',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListSupportEventSubscriptions' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getSupportEventSubscriptions',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\Support\V2beta\ListSupportEventSubscriptionsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'UpdateSupportEventSubscription' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'support_event_subscription.name',
                        'fieldAccessors' => [
                            'getSupportEventSubscription',
                            'getName',
                        ],
