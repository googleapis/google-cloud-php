    ...
    'interfaces' => [
        'google.cloud.support.v2beta.CaseService' => [
            'CloseCase' => [
                ...
                'responseType' => 'Google\Cloud\Support\V2beta\PBCase',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListCases' => [
                ...
                'responseType' => 'Google\Cloud\Support\V2beta\ListCasesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'SearchCaseClassifications' => [
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\Support\V2beta\SearchCaseClassificationsResponse',
            ],
            'SearchCases' => [
                'pageStreaming' => [
                    'requestPageTokenGetMethod' => 'getPageToken',
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\Support\V2beta\SearchCasesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
