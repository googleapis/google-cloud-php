 ...
 *
 * Generated from protobuf message <code>google.cloud.support.v2beta.Case</code>
 */
class PBCase extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.CaseClassification classification = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.Case.State state = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     * Google Support.
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.Actor creator = 15;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.Case.Priority priority = 32;</code>
     */
     ...
     *           A broad description of the issue.
     *     @type \Google\Cloud\Support\V2beta\CaseClassification $classification
     *           The issue classification applicable to this case.
     ...
     *           Output only. The time this case was last updated.
     *     @type \Google\Cloud\Support\V2beta\Actor $creator
     *           The user who created the case.
     *           Note: The name and email will be obfuscated if the case was created by
     *           Google Support.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.support.v2beta.CaseClassification classification = 4;</code>
     * @return \Google\Cloud\Support\V2beta\CaseClassification|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Support\V2beta\CaseClassification::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Support\V2beta\PBCase\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Support\V2beta\PBCase\Priority::class);
        $this->priority = $var;
