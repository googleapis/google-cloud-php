 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/support/v2beta/feed_service.proto
 ...
 * @experimental
 *
 * @method PromiseInterface<PagedListResponse> showFeedAsync(ShowFeedRequest $request, array $optionalArgs = [])
 */
final class FeedServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.support.v2beta.FeedService';
     ...
     *           use Google\Cloud\Support\V2beta\FeedServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new FeedServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see FeedServiceClient::showFeedAsync()} .
     *
     * @example samples/V2beta/FeedServiceClient/show_feed.php
     *
     * @param ShowFeedRequest $request     A request to house fields associated with the call.
     ...
     * @experimental
     */
    public function showFeed(ShowFeedRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ShowFeed', $request, $callOptions);
    }
}
