 ...
 *
 * Generated from protobuf message <code>google.cloud.support.v2beta.SearchCaseClassificationsResponse</code>
 */
class SearchCaseClassificationsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Support\V2beta\CaseClassification::class);
