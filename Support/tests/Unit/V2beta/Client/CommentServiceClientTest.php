...
class CommentServiceClientTest extends GeneratedTest
{
    ...
    public function createCommentTest()
    {
        ...
        $this->assertSame('/google.cloud.support.v2beta.CommentService/CreateComment', $actualFuncCall);
    ...
    public function listCommentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.support.v2beta.CommentService/ListComments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
