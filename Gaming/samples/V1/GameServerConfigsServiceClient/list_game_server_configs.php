 ...
 */
function list_game_server_configs_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $gameServerConfigsServiceClient->listGameServerConfigs($formattedParent);

        /** @var GameServerConfig $element */
...
function callSample(): void
{
    ...
    list_game_server_configs_sample($formattedParent);
}
