 ...
 *
 * @param string $formattedName The name of the game server delpoyment to retrieve, in the following form:
 ...
 */
function get_game_server_deployment_rollout_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var GameServerDeploymentRollout $response */
...
function callSample(): void
{
    ...
    get_game_server_deployment_rollout_sample($formattedName);
}
