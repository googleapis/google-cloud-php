...
class GameServerConfigsServiceGapicClient
{
    ...
    {
        if (self::$gameServerConfigNameTemplate == null) {
    ...
    public function createGameServerConfig($parent, $configId, $gameServerConfig, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateGameServerConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteGameServerConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteGameServerConfig', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function getGameServerConfig($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetGameServerConfig', GameServerConfig::class, $optionalArgs, $request)->wait();
    }
    ...
    public function listGameServerConfigs($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListGameServerConfigs', $optionalArgs, ListGameServerConfigsResponse::class, $request);
    }
}
