...
namespace Google\Cloud\AdvisoryNotifications\Tests\Unit\V1\Client;
...
/**
 * @group advisorynotifications
 *
 * @group gapic
 */
class AdvisoryNotificationsServiceClientTest extends GeneratedTest
{
