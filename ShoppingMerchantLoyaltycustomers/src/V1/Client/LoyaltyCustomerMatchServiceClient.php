 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/loyaltycustomers/v1/loyalty_customer.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Shopping\Merchant\Loyaltycustomers\V1\Client;
 ...
 *
 * @method PromiseInterface<ManageLoyaltyCustomerMatchResponse> manageLoyaltyCustomerMatchAsync(ManageLoyaltyCustomerMatchRequest $request, array $optionalArgs = [])
 */
final class LoyaltyCustomerMatchServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.shopping.merchant.loyaltycustomers.v1.LoyaltyCustomerMatchService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/loyalty_customer_match_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/loyalty_customer_match_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/loyalty_customer_match_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ . '/../resources/loyalty_customer_match_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use
     *           Google\Shopping\Merchant\Loyaltycustomers\V1\LoyaltyCustomerMatchServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new LoyaltyCustomerMatchServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see LoyaltyCustomerMatchServiceClient::manageLoyaltyCustomerMatchAsync()} .
     *
     * @example samples/V1/LoyaltyCustomerMatchServiceClient/manage_loyalty_customer_match.php
     *
     * @param ManageLoyaltyCustomerMatchRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return ManageLoyaltyCustomerMatchResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function manageLoyaltyCustomerMatch(
        ManageLoyaltyCustomerMatchRequest $request,
        array $callOptions = []
    ): ManageLoyaltyCustomerMatchResponse {
        return $this->startApiCall('ManageLoyaltyCustomerMatch', $request, $callOptions)->wait();
    }
}
