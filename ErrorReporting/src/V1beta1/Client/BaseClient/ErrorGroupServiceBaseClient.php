...
namespace Google\Cloud\ErrorReporting\V1beta1\Client\BaseClient;
 ...
 */
abstract class ErrorGroupServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.devtools.clouderrorreporting.v1beta1.ErrorGroupService';
