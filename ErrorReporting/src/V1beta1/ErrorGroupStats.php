...
class ErrorGroupStats extends \Google\Protobuf\Internal\Message
{
     ...
     *           implicitly affected, such as due to a crash of the whole service,
     *           this is not reflected here.
     *     @type \Google\Cloud\ErrorReporting\V1beta1\TimedCount[] $timed_counts
     *           Approximate number of occurrences over time.
     *           Timed counts returned by ListGroups are guaranteed to be:
     *           - Inside the requested time interval
     *           - Non-overlapping, and
     ...
     *           which matches the given filter criteria, ignoring the time_range
     *           that was specified in the request.
     *     @type \Google\Cloud\ErrorReporting\V1beta1\ServiceContext[] $affected_services
     *           Service contexts with a non-zero error count for the given filter
     *           criteria. This list can be truncated if multiple services are affected.
     *           Refer to `num_affected_services` for the total count.
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.clouderrorreporting.v1beta1.TimedCount timed_counts = 4;</code>
     * @return RepeatedField<\Google\Cloud\ErrorReporting\V1beta1\TimedCount>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.clouderrorreporting.v1beta1.TimedCount timed_counts = 4;</code>
     * @param \Google\Cloud\ErrorReporting\V1beta1\TimedCount[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.clouderrorreporting.v1beta1.ServiceContext affected_services = 7;</code>
     * @return RepeatedField<\Google\Cloud\ErrorReporting\V1beta1\ServiceContext>
     */
