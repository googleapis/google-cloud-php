 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.User</code>
 */
class User extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.User.UserType user_type = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AlloyDb\V1beta\User\UserType::class);
        $this->user_type = $var;
