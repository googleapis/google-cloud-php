 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1beta.CreateUserRequest</code>
 */
class CreateUserRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.User user = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $user = null;
    /**
     ...
     *     @type string $user_id
     *           Required. ID of the requesting object.
     *     @type \Google\Cloud\AlloyDb\V1beta\User $user
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.User user = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\AlloyDb\V1beta\User|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1beta.User user = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\AlloyDb\V1beta\User $var
     * @return $this
     */
    public function setUser($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1beta\User::class);
        $this->user = $var;
