 ...
 * instance level.
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.Instance.PscInstanceConfig</code>
 */
class PscInstanceConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * or 1 PSC interface.
     *
     * Generated from protobuf field <code>repeated .google.cloud.alloydb.v1alpha.Instance.PscInterfaceConfig psc_interface_configs = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. List of consumer networks that are allowed to create
     *           PSC endpoints to service-attachments to this instance.
     *     @type array<\Google\Cloud\AlloyDb\V1alpha\Instance\PscInterfaceConfig>|\Google\Protobuf\Internal\RepeatedField $psc_interface_configs
     *           Optional. Configurations for setting up PSC interfaces attached to the
     *           instance which are used for outbound connectivity. Only primary instances
     *           can have PSC interface attached. All the VMs created for the primary
     *           instance will share the same configurations. Currently we only support 0
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.alloydb.v1alpha.Instance.PscInterfaceConfig psc_interface_configs = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param array<\Google\Cloud\AlloyDb\V1alpha\Instance\PscInterfaceConfig>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPscInterfaceConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AlloyDb\V1alpha\Instance\PscInterfaceConfig::class);
