 ...
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.InjectFaultRequest</code>
 */
class InjectFaultRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.InjectFaultRequest.FaultType fault_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\AlloyDb\V1alpha\InjectFaultRequest\FaultType::class);
        $this->fault_type = $var;
