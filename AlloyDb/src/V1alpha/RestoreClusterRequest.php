 ...
 * point in time.
 *
 * Generated from protobuf message <code>google.cloud.alloydb.v1alpha.RestoreClusterRequest</code>
 */
class RestoreClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Backup source.
     *     @type \Google\Cloud\AlloyDb\V1alpha\ContinuousBackupSource $continuous_backup_source
     ...
     * Backup source.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.BackupSource backup_source = 4;</code>
     ...
     * source cluster for this operation to succeed.
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.ContinuousBackupSource continuous_backup_source = 8;</code>
     * @return \Google\Cloud\AlloyDb\V1alpha\ContinuousBackupSource|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.alloydb.v1alpha.ContinuousBackupSource continuous_backup_source = 8;</code>
     * @param \Google\Cloud\AlloyDb\V1alpha\ContinuousBackupSource $var
     * @return $this
     */
    public function setContinuousBackupSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\AlloyDb\V1alpha\ContinuousBackupSource::class);
