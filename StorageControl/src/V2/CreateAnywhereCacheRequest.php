...
class CreateAnywhereCacheRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string anywhere_cache_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $anywhere_cache_id = '';
    /**
     ...
     *                                                                        default value of `ttl` or `admission_policy` if not specified in
     *                                                                        request.
     * @param string                                         $anywhereCacheId Required. System generated Anywhere Cache ID.
     *
     * @return \Google\Cloud\Storage\Control\V2\CreateAnywhereCacheRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Storage\Control\V2\AnywhereCache $anywhereCache, string $anywhereCacheId): self
    {
        return (new self())
            ->setParent($parent)
