 ...
 *
 * Generated from protobuf message <code>google.storage.control.v2.DeleteFolderRecursiveRequest</code>
 */
class DeleteFolderRecursiveRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>optional int64 if_metageneration_match = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional int64 if_metageneration_not_match = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    /**
     * @param string $name Required. Name of the folder being deleted, however all of its contents
     *                     will be deleted too. Format:
     *                     `projects/{project}/buckets/{bucket}/folders/{folder}`
     *                     Please see {@see StorageControlClient::folderName()} for help formatting this field.
     *
     * @return \Google\Cloud\Storage\Control\V2\DeleteFolderRecursiveRequest
     *
     * @experimental
     */
