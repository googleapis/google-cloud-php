 ...
 * with a project.
 *
 * Generated from protobuf message <code>google.storage.control.v2.GetIntelligenceFindingRevisionRequest</code>
 */
class GetIntelligenceFindingRevisionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the `IntelligenceFindingRevision` resource.
     *                     ## Format:
     *
     *                     `projects/{project}/locations/{location}/intelligenceFindings/{intelligence_finding}/revisions/{revision}`
     *                     Please see {@see StorageControlClient::intelligenceFindingRevisionName()} for help formatting this field.
     *
     * @return \Google\Cloud\Storage\Control\V2\GetIntelligenceFindingRevisionRequest
     *
     * @experimental
     */
