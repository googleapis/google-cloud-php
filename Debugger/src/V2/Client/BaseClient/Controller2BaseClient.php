 ...
 */
abstract class Controller2BaseClient
{
     ...
     *
     * The async variant is {@see self::listActiveBreakpointsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::registerDebuggeeAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateActiveBreakpointAsync()} .
     *
