...
class Agent
{
    ...
    const DEFAULT_MAX_STACKFRAMES_CAPTURE = 5;
     ...
     *      @type int $maxStackFrames Limits the number of stackframes with
        ...
        if (array_key_exists($snapshot['id'], $this->breakpointsById)) {
            ...
            foreach ($snapshot['stackframes'] as $index => $stackframe) {
                $breakpoint->addStackFrame($stackframe, [
                    'captureVariables' => $index < $this->maxStackFrames
                ]);
            }
