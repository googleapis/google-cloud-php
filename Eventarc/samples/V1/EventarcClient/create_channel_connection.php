 ...
 * @param string $formattedChannel      The name of the connected subscriber Channel.
...
function create_channel_connection_sample(
    ...
    $channelConnection = (new ChannelConnection())
        ...
        ->setChannel($channelConnectionChannel);
...
function callSample(): void
{
    ...
    $formattedChannel = EventarcClient::channelName('[PROJECT]', '[LOCATION]', '[CHANNEL]');
