...
class Discovery
{
    ...
    public static function initOnce() {
        ...
        $pool->internalAddGeneratedFile(
            '
‚
(google/cloud/eventarc/v1/discovery.protogoogle.cloud.eventarc.v1google/api/resource.proto"ô
Provider
name (	BâA
display_name (	BâA>
event_types (2#.google.cloud.eventarc.v1.EventTypeBâA:xêAu
 eventarc.googleapis.com/Provider<projects/{project}/locations/{location}/providers/{provider}*	providers2provider"¬
	EventType
type (	BâA
description (	BâAP
filtering_attributes (2,.google.cloud.eventarc.v1.FilteringAttributeBâA
event_schema_uri (	BâA"†
FilteringAttribute
	attribute (	BâA
description (	BâA
required (BâA$
path_pattern_supported (BâABj
