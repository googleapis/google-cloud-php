 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.products.v1.UpdateProductInputRequest</code>
 */
class UpdateProductInputRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                         Providing special "*" value for full product replacement is not supported.
     *
     * @return \Google\Shopping\Merchant\Products\V1\UpdateProductInputRequest
     *
     * @experimental
     */
    public static function build(\Google\Shopping\Merchant\Products\V1\ProductInput $productInput, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
