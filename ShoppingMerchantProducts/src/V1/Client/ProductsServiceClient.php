 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/products/v1/products.proto
 ...
 */
final class ProductsServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.shopping.merchant.products.v1.ProductsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/products_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/products_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/products_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/products_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Shopping\Merchant\Products\V1\ProductsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ProductsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ProductsServiceClient::getProductAsync()} .
     *
     * @example samples/V1/ProductsServiceClient/get_product.php
     *
     ...
     *
     * The async variant is {@see ProductsServiceClient::listProductsAsync()} .
     *
     * @example samples/V1/ProductsServiceClient/list_products.php
     *
