 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/products/v1beta/products.proto
...
final class ProductsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.products.v1beta.ProductsService';
     ...
     *
     * @example samples/V1beta/ProductsServiceClient/get_product.php
     *
     ...
     *
     * @example samples/V1beta/ProductsServiceClient/list_products.php
     *
