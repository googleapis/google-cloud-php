 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.products.v1beta.ProductSustainabilityIncentive</code>
 */
class ProductSustainabilityIncentive extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.products.v1beta.ProductSustainabilityIncentive.Type type = 1;</code>
     */
    protected $type = null;
    protected $value;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Products\V1beta\ProductSustainabilityIncentive\Type::class);
        $this->type = $var;
