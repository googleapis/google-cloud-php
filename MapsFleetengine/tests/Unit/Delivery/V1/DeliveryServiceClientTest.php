...
namespace Maps\Fleetengine\Delivery\Tests\Unit\V1;
...
use Maps\Fleetengine\Delivery\V1\Task\State;
use Maps\Fleetengine\Delivery\V1\Task\Type;
use stdClass;
...
class DeliveryServiceClientTest extends GeneratedTest
{
    ...
    public function batchCreateTasksTest()
    {
        ...
        $requests = [];
        $response = $gapicClient->batchCreateTasks($formattedParent, $requests);
    ...
    public function batchCreateTasksExceptionTest()
    {
        ...
        $requests = [];
        try {
            $gapicClient->batchCreateTasks($formattedParent, $requests);
    ...
    public function createDeliveryVehicleTest()
    {
        ...
        $response = $gapicClient->createDeliveryVehicle($parent, $deliveryVehicleId, $deliveryVehicle);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createDeliveryVehicleExceptionTest()
    {
        ...
        $deliveryVehicle = new DeliveryVehicle();
        try {
            $gapicClient->createDeliveryVehicle($parent, $deliveryVehicleId, $deliveryVehicle);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function createTaskTest()
    {
        ...
        $response = $gapicClient->createTask($parent, $taskId, $task);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createTaskExceptionTest()
    {
        ...
        $task->setTaskDuration($taskTaskDuration);
        try {
            $gapicClient->createTask($parent, $taskId, $task);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getDeliveryVehicleTest()
    {
        ...
        $response = $gapicClient->getDeliveryVehicle($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getDeliveryVehicleExceptionTest()
    {
        ...
        $formattedName = $gapicClient->deliveryVehicleName('[PROVIDER]', '[VEHICLE]');
        try {
            $gapicClient->getDeliveryVehicle($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getTaskTrackingInfoTest()
    {
        ...
        $response = $gapicClient->getTaskTrackingInfo($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getTaskTrackingInfoExceptionTest()
    {
        ...
        $formattedName = $gapicClient->taskTrackingInfoName('[PROVIDER]', '[TRACKING]');
        try {
            $gapicClient->getTaskTrackingInfo($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listDeliveryVehiclesTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->providerName('[PROVIDER]');
        $response = $gapicClient->listDeliveryVehicles($formattedParent);
    ...
    public function listDeliveryVehiclesExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->providerName('[PROVIDER]');
        try {
            $gapicClient->listDeliveryVehicles($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function searchTasksTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $expectedResponse = new SearchTasksResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setTasks($tasks);
        $transport->addResponse($expectedResponse);
        // Mock request
        $parent = 'parent-995424086';
        $trackingId = 'trackingId1878901667';
        $response = $gapicClient->searchTasks($parent, $trackingId);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTasks()[0], $resources[0]);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/maps.fleetengine.delivery.v1.DeliveryService/SearchTasks', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($parent, $actualValue);
        $actualValue = $actualRequestObject->getTrackingId();
        $this->assertProtobufEquals($trackingId, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function searchTasksExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $trackingId = 'trackingId1878901667';
        try {
            $gapicClient->searchTasks($parent, $trackingId);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateDeliveryVehicleTest()
    {
        ...
        $response = $gapicClient->updateDeliveryVehicle($deliveryVehicle, $updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateDeliveryVehicleExceptionTest()
    {
        ...
        $updateMask = new FieldMask();
        try {
            $gapicClient->updateDeliveryVehicle($deliveryVehicle, $updateMask);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateTaskTest()
    {
        ...
        $task->setTaskDuration($taskTaskDuration);
        $updateMask = new FieldMask();
        $response = $gapicClient->updateTask($task, $updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateTaskExceptionTest()
    {
        ...
        $updateMask = new FieldMask();
        try {
            $gapicClient->updateTask($task, $updateMask);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
