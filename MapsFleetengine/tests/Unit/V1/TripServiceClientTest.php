...
class TripServiceClientTest extends GeneratedTest
{
    ...
    public function createTripTest()
    {
        ...
        $trip = new Trip();
        $response = $gapicClient->createTrip($formattedParent, $tripId, $trip);
    ...
    public function createTripExceptionTest()
    {
        ...
        $trip = new Trip();
        try {
            $gapicClient->createTrip($formattedParent, $tripId, $trip);
    ...
    public function getTripTest()
    {
        ...
        $response = $gapicClient->getTrip($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getTripExceptionTest()
    {
        ...
        $formattedName = $gapicClient->tripName('[PROVIDER]', '[TRIP]');
        try {
            $gapicClient->getTrip($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function reportBillableTripTest()
    {
        ...
        $gapicClient->reportBillableTrip($name, $countryCode);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function searchTripsTest()
    {
        ...
        $response = $gapicClient->searchTrips($parent);
    ...
    public function searchTripsExceptionTest()
    {
        ...
        $parent = 'parent-995424086';
        try {
            $gapicClient->searchTrips($parent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateTripTest()
    {
        ...
        $response = $gapicClient->updateTrip($name, $trip, $updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateTripExceptionTest()
    {
        ...
        $updateMask = new FieldMask();
        try {
            $gapicClient->updateTrip($name, $trip, $updateMask);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
