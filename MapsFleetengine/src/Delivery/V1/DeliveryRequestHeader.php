...
class DeliveryRequestHeader extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\DeliveryRequestHeader\SdkType::class);
        $this->sdk_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\DeliveryRequestHeader\Platform::class);
        $this->platform = $var;
