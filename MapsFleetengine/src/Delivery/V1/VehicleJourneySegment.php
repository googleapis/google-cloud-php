...
class VehicleJourneySegment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Maps\Fleetengine\Delivery\V1\VehicleStop $stop
     *           Specifies the stop location, along with the `Task`s associated with
     *           the stop. Some fields of the VehicleStop might not be present if this
     *           journey segment is part of `JourneySharingInfo`.
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.VehicleStop stop = 1;</code>
     * @return \Maps\Fleetengine\Delivery\V1\VehicleStop|null
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.VehicleStop stop = 1;</code>
     * @param \Maps\Fleetengine\Delivery\V1\VehicleStop $var
     * @return $this
     */
    public function setStop($var)
    {
        GPBUtil::checkMessage($var, \Maps\Fleetengine\Delivery\V1\VehicleStop::class);
        $this->stop = $var;
