...
class TaskTrackingInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *           * May not contain any of the following ASCII characters: '/', ':', '?',
     *           ',', or '#'.
     *     @type \Maps\Fleetengine\Delivery\V1\DeliveryVehicleLocation $vehicle_location
     *           The vehicle's last location.
     ...
     *           The timestamp that indicates when the Task's outcome was set by the
     *           provider.
     *     @type \Maps\Fleetengine\Delivery\V1\LocationInfo $planned_location
     *           Immutable. The location where the Task will be completed.
     *     @type \Maps\Fleetengine\Delivery\V1\TimeWindow $target_time_window
     *           The time window during which the task should be completed.
     *     @type array<\Maps\Fleetengine\Delivery\V1\TaskAttribute>|\Google\Protobuf\Internal\RepeatedField $attributes
     *           The custom attributes set on the task.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.DeliveryVehicleLocation vehicle_location = 3;</code>
     * @return \Maps\Fleetengine\Delivery\V1\DeliveryVehicleLocation|null
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.DeliveryVehicleLocation vehicle_location = 3;</code>
     * @param \Maps\Fleetengine\Delivery\V1\DeliveryVehicleLocation $var
     * @return $this
     */
    public function setVehicleLocation($var)
    {
        GPBUtil::checkMessage($var, \Maps\Fleetengine\Delivery\V1\DeliveryVehicleLocation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\Task\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\Task\TaskOutcome::class);
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.LocationInfo planned_location = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @return \Maps\Fleetengine\Delivery\V1\LocationInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.LocationInfo planned_location = 10 [(.google.api.field_behavior) = IMMUTABLE];</code>
     * @param \Maps\Fleetengine\Delivery\V1\LocationInfo $var
     * @return $this
     */
    public function setPlannedLocation($var)
    {
        GPBUtil::checkMessage($var, \Maps\Fleetengine\Delivery\V1\LocationInfo::class);
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.TimeWindow target_time_window = 13;</code>
     * @return \Maps\Fleetengine\Delivery\V1\TimeWindow|null
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.TimeWindow target_time_window = 13;</code>
     * @param \Maps\Fleetengine\Delivery\V1\TimeWindow $var
     * @return $this
     */
    public function setTargetTimeWindow($var)
    {
        GPBUtil::checkMessage($var, \Maps\Fleetengine\Delivery\V1\TimeWindow::class);
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.delivery.v1.TaskAttribute attributes = 14;</code>
     * @param array<\Maps\Fleetengine\Delivery\V1\TaskAttribute>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttributes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\Delivery\V1\TaskAttribute::class);
        $this->attributes = $arr;
