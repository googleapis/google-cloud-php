...
class UpdateTaskRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Optional. The standard Delivery API request header.
     *     @type \Maps\Fleetengine\Delivery\V1\Task $task
     *           Required. The Task associated with the update.
     *           The following fields are maintained by Fleet Engine. Do not update
     *           them using `Task.update`.
     *             * `last_location`.
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.Task task = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Maps\Fleetengine\Delivery\V1\Task|null
     */
     ...
     *
     * Generated from protobuf field <code>.maps.fleetengine.delivery.v1.Task task = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Maps\Fleetengine\Delivery\V1\Task $var
     * @return $this
     */
    public function setTask($var)
    {
        GPBUtil::checkMessage($var, \Maps\Fleetengine\Delivery\V1\Task::class);
        $this->task = $var;
