...
class VehicleStop extends \Google\Protobuf\Internal\Message
{
     ...
     *           of it. This field won't be populated in the response of either a `GetTask`,
     *           or a `SearchTasks` call.
     *     @type array<\Maps\Fleetengine\Delivery\V1\VehicleStop\TaskInfo>|\Google\Protobuf\Internal\RepeatedField $tasks
     *           The list of `Task`s to be performed at this stop. This field won't be
     *           populated in the response of either a `GetTask` or `SearchTasks` call.
     *     @type int $state
     *           The state of the `VehicleStop`. This field won't be populated in the
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.delivery.v1.VehicleStop.TaskInfo tasks = 2;</code>
     * @param array<\Maps\Fleetengine\Delivery\V1\VehicleStop\TaskInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTasks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\Delivery\V1\VehicleStop\TaskInfo::class);
        $this->tasks = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\VehicleStop\State::class);
        $this->state = $var;
