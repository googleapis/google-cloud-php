...
class DeliveryVehicle extends \Google\Protobuf\Internal\Message
{
     ...
     *           The unique name of this Delivery Vehicle.
     *           The format is `providers/{provider}/deliveryVehicles/{vehicle}`.
     *     @type \Maps\Fleetengine\Delivery\V1\DeliveryVehicleLocation $last_location
     *           The last reported location of the Delivery Vehicle.
     ...
     *           Fleet Engine ignores this field in `UpdateDeliveryVehicleRequest` if the
     *           `current_route_segment` field is empty.
     *     @type array<\Maps\Fleetengine\Delivery\V1\VehicleJourneySegment>|\Google\Protobuf\Internal\RepeatedField $remaining_vehicle_journey_segments
     *           The journey segments assigned to this Delivery Vehicle, starting from the
     *           Vehicle's most recently reported location. This field won't be populated
     *           in the response of `ListDeliveryVehicles`.
     *     @type array<\Maps\Fleetengine\Delivery\V1\DeliveryVehicleAttribute>|\Google\Protobuf\Internal\RepeatedField $attributes
     *           A list of custom Delivery Vehicle attributes. A Delivery Vehicle can have
     *           at most 100 attributes, and each attribute must have a unique key.
     *     @type int $type
     *           The type of this delivery vehicle. If unset, this will default to `AUTO`.
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\DeliveryVehicleNavigationStatus::class);
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.delivery.v1.VehicleJourneySegment remaining_vehicle_journey_segments = 8;</code>
     * @param array<\Maps\Fleetengine\Delivery\V1\VehicleJourneySegment>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRemainingVehicleJourneySegments($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\Delivery\V1\VehicleJourneySegment::class);
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.delivery.v1.DeliveryVehicleAttribute attributes = 9;</code>
     * @param array<\Maps\Fleetengine\Delivery\V1\DeliveryVehicleAttribute>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAttributes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\Delivery\V1\DeliveryVehicleAttribute::class);
        $this->attributes = $arr;
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\Delivery\V1\DeliveryVehicle\DeliveryVehicleType::class);
        $this->type = $var;
