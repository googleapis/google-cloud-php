...
class BatchCreateTasksRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           `CreateTaskRequest` messages must either  be empty, or it must match this
     *           field.
     *     @type array<\Maps\Fleetengine\Delivery\V1\CreateTaskRequest>|\Google\Protobuf\Internal\RepeatedField $requests
     *           Required. The request message that specifies the resources to create.
     *           Note: You can create a maximum of 500 tasks in a batch.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.delivery.v1.CreateTaskRequest requests = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Maps\Fleetengine\Delivery\V1\CreateTaskRequest>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Maps\Fleetengine\Delivery\V1\CreateTaskRequest::class);
        $this->requests = $arr;
