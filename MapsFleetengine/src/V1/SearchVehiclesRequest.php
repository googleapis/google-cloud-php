...
class SearchVehiclesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           transmitting their locations are not considered stale. If this field is not
     *           set, the server uses five minutes as the default value.
     *     @type array<\Maps\Fleetengine\V1\Vehicle\VehicleType>|\Google\Protobuf\Internal\RepeatedField $vehicle_types
     *           Required. Restricts the search to vehicles with one of the specified types.
     *           At least one vehicle type must be specified. VehicleTypes with a category
     *           of `UNKNOWN` are not allowed.
     *     @type array<\Maps\Fleetengine\V1\VehicleAttribute>|\Google\Protobuf\Internal\RepeatedField $required_attributes
     *           Callers can form complex logical operations using any combination of the
     *           `required_attributes`, `required_one_of_attributes`, and
     *           `required_one_of_attribute_sets` fields.
     *           `required_attributes` is a list; `required_one_of_attributes` uses a
     ...
     *           is allowed. This matches the maximum number of attributes allowed on a
     *           vehicle.
     *     @type array<\Maps\Fleetengine\V1\VehicleAttributeList>|\Google\Protobuf\Internal\RepeatedField $required_one_of_attributes
     *           Restricts the search to only those vehicles with at least one of
     *           the specified attributes in each `VehicleAttributeList`. Within each
     *           list, a vehicle must match at least one of the attributes. This field is an
     *           inclusive disjunction/OR operation in each `VehicleAttributeList` and a
     *           conjunction/AND operation across the collection of `VehicleAttributeList`.
     *     @type array<\Maps\Fleetengine\V1\VehicleAttributeList>|\Google\Protobuf\Internal\RepeatedField $required_one_of_attribute_sets
     *           `required_one_of_attribute_sets` provides additional functionality.
     *           Similar to `required_one_of_attributes`, `required_one_of_attribute_sets`
     *           uses a message which allows a list of lists, allowing expressions such as
     *           this one:
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.Vehicle.VehicleType vehicle_types = 14 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Maps\Fleetengine\V1\Vehicle\VehicleType>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.VehicleAttribute required_attributes = 12;</code>
     * @param array<\Maps\Fleetengine\V1\VehicleAttribute>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .maps.fleetengine.v1.VehicleAttributeList required_one_of_attributes = 15;</code>
     * @param array<\Maps\Fleetengine\V1\VehicleAttributeList>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    {
        GPBUtil::checkEnum($var, \Maps\Fleetengine\V1\SearchVehiclesRequest\CurrentTripsPresent::class);
