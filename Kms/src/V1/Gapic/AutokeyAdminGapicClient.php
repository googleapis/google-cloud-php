 ...
 *     $response = $autokeyAdminClient->getAutokeyConfig($formattedName);
 * } finally {
 *     $autokeyAdminClient->close();
 * }
 * ```
 *
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Kms\V1\Client\AutokeyAdminClient}.
 */
class AutokeyAdminGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.kms.v1.AutokeyAdmin';
    ...
    private static $autokeyConfigNameTemplate;
    ...
    private static function getAutokeyConfigNameTemplate()
    {
        if (self::$autokeyConfigNameTemplate == null) {
            self::$autokeyConfigNameTemplate = new PathTemplate('folders/{folder}/autokeyConfig');
        }

        return self::$autokeyConfigNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                'autokeyConfig' => self::getAutokeyConfigNameTemplate(),
     ...
     */
    public static function autokeyConfigName($folder)
    {
        return self::getAutokeyConfigNameTemplate()->render([
            'folder' => $folder,
        ]);
    }
     ...
     */
    public function getAutokeyConfig($name, array $optionalArgs = [])
    {
        ...
        return $this->startCall('GetAutokeyConfig', AutokeyConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $response = $autokeyAdminClient->showEffectiveAutokeyConfig($formattedParent);
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function showEffectiveAutokeyConfig($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ShowEffectiveAutokeyConfig', ShowEffectiveAutokeyConfigResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $response = $autokeyAdminClient->updateAutokeyConfig($autokeyConfig, $updateMask);
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
     *
     * @param AutokeyConfig $autokeyConfig Required. [AutokeyConfig][google.cloud.kms.v1.AutokeyConfig] with values to
     *                                     update.
     * @param FieldMask     $updateMask    Required. Masks which fields of the
     ...
     * @throws ApiException if the remote call fails
     */
    public function updateAutokeyConfig($autokeyConfig, $updateMask, array $optionalArgs = [])
    {
        $request = new UpdateAutokeyConfigRequest();
        $requestParamHeaders = [];
        $request->setAutokeyConfig($autokeyConfig);
        $request->setUpdateMask($updateMask);
        $requestParamHeaders['autokey_config.name'] = $autokeyConfig->getName();
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdateAutokeyConfig', AutokeyConfig::class, $optionalArgs, $request)->wait();
    }
     ...
     * $autokeyAdminClient = new AutokeyAdminClient();
     * try {
     *     $response = $autokeyAdminClient->getLocation();
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $autokeyAdminClient->listLocations();
     ...
     * try {
     *     $resource = 'resource';
     *     $response = $autokeyAdminClient->getIamPolicy($resource);
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $policy = new Policy();
     *     $response = $autokeyAdminClient->setIamPolicy($resource, $policy);
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $permissions = [];
     *     $response = $autokeyAdminClient->testIamPermissions($resource, $permissions);
     * } finally {
     *     $autokeyAdminClient->close();
     * }
     * ```
