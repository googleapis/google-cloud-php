 ...
 *     $operationResponse = $autokeyClient->createKeyHandle($formattedParent, $keyHandle);
 ...
 *     // ... do other work
 *     $newOperationResponse = $autokeyClient->resumeOperation($operationName, 'createKeyHandle');
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Kms\V1\Client\AutokeyClient}.
 */
class AutokeyGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.kms.v1.Autokey';
    ...
    private static $keyHandleNameTemplate;
    ...
    private static function getKeyHandleNameTemplate()
    {
        if (self::$keyHandleNameTemplate == null) {
            self::$keyHandleNameTemplate = new PathTemplate('projects/{project}/locations/{location}/keyHandles/{key_handle}');
        }

        return self::$keyHandleNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                ...
                'keyHandle' => self::getKeyHandleNameTemplate(),
     ...
     */
    public static function keyHandleName($project, $location, $keyHandle)
    {
        return self::getKeyHandleNameTemplate()->render([
            'project' => $project,
            'location' => $location,
     ...
     * @param KeyHandle $keyHandle    Required. [KeyHandle][google.cloud.kms.v1.KeyHandle] to create.
     * @param array     $optionalArgs {
     *     Optional.
     *
     *     @type string $keyHandleId
     ...
     */
    public function createKeyHandle($parent, $keyHandle, array $optionalArgs = [])
    {
        $request = new CreateKeyHandleRequest();
        $requestParamHeaders = [];
        $request->setParent($parent);
        $request->setKeyHandle($keyHandle);
        $requestParamHeaders['parent'] = $parent;
        if (isset($optionalArgs['keyHandleId'])) {
            $request->setKeyHandleId($optionalArgs['keyHandleId']);
        }

        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateKeyHandle', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
     ...
     *     $response = $autokeyClient->getKeyHandle($formattedName);
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function getKeyHandle($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetKeyHandle', KeyHandle::class, $optionalArgs, $request)->wait();
    }
     ...
     * try {
     *     $formattedParent = $autokeyClient->locationName('[PROJECT]', '[LOCATION]');
     *     $response = $autokeyClient->listKeyHandles($formattedParent);
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function listKeyHandles($parent, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListKeyHandles', ListKeyHandlesResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     * $autokeyClient = new AutokeyClient();
     * try {
     *     $response = $autokeyClient->getLocation();
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $autokeyClient->listLocations();
     ...
     * try {
     *     $resource = 'resource';
     *     $response = $autokeyClient->getIamPolicy($resource);
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $policy = new Policy();
     *     $response = $autokeyClient->setIamPolicy($resource, $policy);
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
     ...
     *     $resource = 'resource';
     *     $permissions = [];
     *     $response = $autokeyClient->testIamPermissions($resource, $permissions);
     * } finally {
     *     $autokeyClient->close();
     * }
     * ```
