...
class EkmServiceBaseClient
{
    ...
    {
        self::loadPathTemplates(__DIR__ . '/../../resources/ekm_service_descriptor_config.php', self::SERVICE_NAME);
    }
     ...
     *
     * The async variant is {@see self::createEkmConnectionAsync()} .
     *
     ...
     */
    public function createEkmConnection(CreateEkmConnectionRequest $request, array $optionalArgs = []): EkmConnection
    {
        return $this->startApiCall('CreateEkmConnection', $request, $optionalArgs)->wait();
    }
     ...
     *
     * The async variant is {@see self::getEkmConfigAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getEkmConfig(GetEkmConfigRequest $request, array $optionalArgs = []): EkmConfig
    {
        return $this->startApiCall('GetEkmConfig', $request, $optionalArgs)->wait();
    }
     ...
     * [EkmConnection][google.cloud.kms.v1.EkmConnection].
     *
     * The async variant is {@see self::getEkmConnectionAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getEkmConnection(GetEkmConnectionRequest $request, array $optionalArgs = []): EkmConnection
    {
        return $this->startApiCall('GetEkmConnection', $request, $optionalArgs)->wait();
    }

    /**
     * Lists [EkmConnections][google.cloud.kms.v1.EkmConnection].
     *
     * The async variant is {@see self::listEkmConnectionsAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listEkmConnections(ListEkmConnectionsRequest $request, array $optionalArgs = []): PagedListResponse
    {
        return $this->startApiCall('ListEkmConnections', $request, $optionalArgs);
    }
     ...
     * for a given project and location.
     *
     * The async variant is {@see self::updateEkmConfigAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateEkmConfig(UpdateEkmConfigRequest $request, array $optionalArgs = []): EkmConfig
    {
        return $this->startApiCall('UpdateEkmConfig', $request, $optionalArgs)->wait();
    }

    /**
     * Updates an [EkmConnection][google.cloud.kms.v1.EkmConnection]'s metadata.
     *
     * The async variant is {@see self::updateEkmConnectionAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateEkmConnection(UpdateEkmConnectionRequest $request, array $optionalArgs = []): EkmConnection
    {
        return $this->startApiCall('UpdateEkmConnection', $request, $optionalArgs)->wait();
    }
