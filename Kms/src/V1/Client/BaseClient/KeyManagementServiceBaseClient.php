...
class KeyManagementServiceBaseClient
{
    ...
    {
        self::loadPathTemplates(__DIR__ . '/../../resources/key_management_service_descriptor_config.php', self::SERVICE_NAME);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateRandomBytes(GenerateRandomBytesRequest $request, array $optionalArgs = []): GenerateRandomBytesResponse
    {
        return $this->startApiCall('GenerateRandomBytes', $request, $optionalArgs)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function macSign(MacSignRequest $request, array $optionalArgs = []): MacSignResponse
    {
        return $this->startApiCall('MacSign', $request, $optionalArgs)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function macVerify(MacVerifyRequest $request, array $optionalArgs = []): MacVerifyResponse
    {
        return $this->startApiCall('MacVerify', $request, $optionalArgs)->wait();
    }
