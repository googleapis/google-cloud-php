 ...
 * @group gapic
 */
class WorkflowsServiceV2BetaClientTest extends GeneratedTest
{
    ...
    /** @return WorkflowsServiceV2BetaClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new WorkflowsServiceV2BetaClient($options);
    }

    /** @test */
    public function runPipelineTest()
    {
        ...
        $request = (new RunPipelineRequest())->setPipeline($pipeline);
    ...
    /** @test */
    public function runPipelineExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
