...
class MockRequestBody extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setNumber(int|string $var)
    {
     ...
     * @return $this
     */
    public function setRepeatedField(array|RepeatedField $var)
    {
    ...
    /**
     * Generated from protobuf field <code>.google.apicore.testing.MockRequestBody nested_message = 4;</code>
     * @return \Google\ApiCore\Testing\MockRequestBody|null
     */
     ...
     * @return $this
     */
    public function setNestedMessage(\Google\ApiCore\Testing\MockRequestBody|null $var)
    {
     ...
     * @return $this
     */
    public function setBytesValue(\Google\Protobuf\BytesValue|null $var)
    {
     ...
     * @return $this
     */
    public function setInt64Value(\Google\Protobuf\Int64Value|null $var)
    {
     ...
     * @return $this
     */
    public function setStringValue(\Google\Protobuf\StringValue|null $var)
    {
     ...
     * @return $this
     */
    public function setValueValue(\Google\Protobuf\Value|null $var)
    {
     ...
     * @return $this
     */
    public function setField1(string $var)
    {
        GPBUtil::checkString($var, true);
     ...
     * @return $this
     */
    public function setField2(string $var)
    {
        GPBUtil::checkString($var, true);
     ...
     * @return $this
     */
    public function setField3(string $var)
    {
        GPBUtil::checkString($var, true);
