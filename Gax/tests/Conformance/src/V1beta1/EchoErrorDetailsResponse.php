...
class EchoErrorDetailsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setSingleDetail(\Google\Showcase\V1beta1\EchoErrorDetailsResponse\SingleDetail|null $var)
    {
     ...
     * @return $this
     */
    public function setMultipleDetails(\Google\Showcase\V1beta1\EchoErrorDetailsResponse\MultipleDetails|null $var)
    {
