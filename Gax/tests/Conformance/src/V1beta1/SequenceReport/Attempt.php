...
namespace Google\Showcase\V1beta1\SequenceReport;
 ...
 *
 * Generated from protobuf message <code>google.showcase.v1beta1.SequenceReport.Attempt</code>
 */
class Attempt extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setAttemptNumber(int $var)
    {
