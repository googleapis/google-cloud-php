...
class RepeatRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setInfo(\Google\Showcase\V1beta1\ComplianceData|null $var)
    {
        $this->info = $var;
     ...
     * @return $this
     */
    public function setServerVerify(bool $var)
    {
     ...
     * @return $this
     */
    public function setIntendedBindingUri(string $var)
    {
        GPBUtil::checkString($var, true);
