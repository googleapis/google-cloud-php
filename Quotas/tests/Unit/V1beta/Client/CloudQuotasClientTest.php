...
use Google\Cloud\CloudQuotas\V1beta\ListQuotaInfosResponse;
use Google\Cloud\CloudQuotas\V1beta\ListQuotaPreferencesRequest;
use Google\Cloud\CloudQuotas\V1beta\ListQuotaPreferencesResponse;
...
class CloudQuotasClientTest extends GeneratedTest
{
    ...
    public function createQuotaPreferenceTest()
    {
        ...
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/CreateQuotaPreference', $actualFuncCall);
    ...
    public function getQuotaInfoTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/GetQuotaInfo', $actualFuncCall);
    ...
    public function getQuotaPreferenceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/GetQuotaPreference', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listQuotaInfosTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/ListQuotaInfos', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listQuotaPreferencesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/ListQuotaPreferences', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateQuotaPreferenceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.api.cloudquotas.v1beta.CloudQuotas/UpdateQuotaPreference', $actualFuncCall);
        $actualValue = $actualRequestObject->getQuotaPreference();
        $this->assertProtobufEquals($quotaPreference, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
