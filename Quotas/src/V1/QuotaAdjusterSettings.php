 ...
 * Adjuster.
 *
 * Generated from protobuf message <code>google.api.cloudquotas.v1.QuotaAdjusterSettings</code>
 */
class QuotaAdjusterSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.api.cloudquotas.v1.QuotaAdjusterSettings.Enablement enablement = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudQuotas\V1\QuotaAdjusterSettings\Enablement::class);
        $this->enablement = $var;
