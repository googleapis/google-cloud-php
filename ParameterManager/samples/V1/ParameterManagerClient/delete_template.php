...
// [START parametermanager_v1_generated_ParameterManager_DeleteTemplate_sync]
...
{
    $formattedName = ParameterManagerClient::templateName('[PROJECT]', '[LOCATION]', '[TEMPLATE]');

    delete_template_sample($formattedName);
}
// [END parametermanager_v1_generated_ParameterManager_DeleteTemplate_sync]
