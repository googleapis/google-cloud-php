 ...
 *
 * @param string $formattedParent Parent value for ListTemplateVersionsRequest in the format
 *                                `projects/&#42;/locations/&#42;/templates/*`. Please see
 *                                {@see ParameterManagerClient::templateName()} for help formatting this field.
 */
function list_template_versions_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $parameterManagerClient->listTemplateVersions($request);

        /** @var TemplateVersion $element */
...
function callSample(): void
{
    ...
    list_template_versions_sample($formattedParent);
}
