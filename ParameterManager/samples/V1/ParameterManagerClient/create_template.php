...
// [START parametermanager_v1_generated_ParameterManager_CreateTemplate_sync]
 ...
 * @param string $templateId      Id of the Template resource
 */
function create_template_sample(string $formattedParent, string $templateId): void
{
    ...
    try {
        ...
        $response = $parameterManagerClient->createTemplate($request);
...
// [END parametermanager_v1_generated_ParameterManager_CreateTemplate_sync]
