 ...
 *
 * Generated from protobuf message <code>google.cloud.parametermanager.v1.UpdateTemplateRequest</code>
 */
class UpdateTemplateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parametermanager.v1.Template template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\ParameterManager\V1\Template $template   Required. The Template resource being updated
     ...
     *                                                               in the request will be overwritten.
     *
     * @return \Google\Cloud\ParameterManager\V1\UpdateTemplateRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\ParameterManager\V1\Template $template, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
     ...
     *           mask. If the user does not provide a mask then all mutable fields present
     *           in the request will be overwritten.
     *     @type \Google\Cloud\ParameterManager\V1\Template $template
     *           Required. The Template resource being updated
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parametermanager.v1.Template template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\ParameterManager\V1\Template|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parametermanager.v1.Template template = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\ParameterManager\V1\Template $var
     * @return $this
     */
    public function setTemplate($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\ParameterManager\V1\Template::class);
        $this->template = $var;
