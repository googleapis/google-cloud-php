 ...
 *
 * Generated from protobuf message <code>google.cloud.parametermanager.v1.CreateTemplateRequest</code>
 */
class CreateTemplateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.parametermanager.v1.Template template = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\ParameterManager\V1\Template $template   Required. The Template resource being created
     * @param string                                     $templateId Required. Id of the Template resource
     *
     * @return \Google\Cloud\ParameterManager\V1\CreateTemplateRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\ParameterManager\V1\Template $template, string $templateId): self
    {
        return (new self())
            ->setParent($parent)
