 ...
 *
 * Generated from protobuf message <code>google.cloud.parametermanager.v1.ListParametersRequest</code>
 */
class ListParametersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Parent value for ListParametersRequest in the format
     *                       `projects/&#42;/locations/*`. Please see
     *                       {@see ParameterManagerClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\ParameterManager\V1\ListParametersRequest
     *
     * @experimental
     */
