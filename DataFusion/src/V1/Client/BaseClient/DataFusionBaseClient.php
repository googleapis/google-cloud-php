...
namespace Google\Cloud\DataFusion\V1\Client\BaseClient;
 ...
 * @method PromiseInterface listAvailableVersionsAsync(ListAvailableVersionsRequest $request, array $optionalArgs = [])
 ...
 */
abstract class DataFusionBaseClient
{
