...
namespace Google\Cloud\DataFusion\V1\Client;
 ...
 * @method PromiseInterface<PagedListResponse> listAvailableVersionsAsync(ListAvailableVersionsRequest $request, array $optionalArgs = [])
 ...
 */
final class DataFusionClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.datafusion.v1.DataFusion';
     ...
     */
    private const SERVICE_ADDRESS = 'datafusion.googleapis.com';
     ...
     *           $options = new DataFusionClient(['credentials' => $creds]);
     *           ```
     *           {@see
