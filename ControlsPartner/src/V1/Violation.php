 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudcontrolspartner.v1.Violation</code>
 */
class Violation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.Violation.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.Violation.Remediation remediation = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           The folder_id of the violation
     *     @type \Google\Cloud\CloudControlsPartner\V1\Violation\Remediation $remediation
     *           Output only. Compliance violation remediation
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudControlsPartner\V1\Violation\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.Violation.Remediation remediation = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\CloudControlsPartner\V1\Violation\Remediation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.Violation.Remediation remediation = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\CloudControlsPartner\V1\Violation\Remediation $var
     * @return $this
     */
    public function setRemediation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\CloudControlsPartner\V1\Violation\Remediation::class);
