...
namespace Google\Cloud\CloudControlsPartner\V1\AccessReason;
 ...
 *
 * Protobuf type <code>google.cloud.cloudcontrolspartner.v1.AccessReason.Type</code>
 */
class Type
{
    /**
     ...
     *
     * Generated from protobuf enum <code>CLOUD_INITIATED_ACCESS = 6;</code>
     */
    const CLOUD_INITIATED_ACCESS = 6;
    ...
    private static $valueToName = [
        ...
        self::CLOUD_INITIATED_ACCESS => 'CLOUD_INITIATED_ACCESS',
    ];
