...
namespace Google\Cloud\CloudControlsPartner\V1\PartnerPermissions;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.cloudcontrolspartner.v1.PartnerPermissions.Permission</code>
 */
class Permission
{
    /**
