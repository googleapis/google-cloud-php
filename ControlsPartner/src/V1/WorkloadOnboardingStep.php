 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudcontrolspartner.v1.WorkloadOnboardingStep</code>
 */
class WorkloadOnboardingStep extends \Google\Protobuf\Internal\Message
{
     ...
     * The onboarding step.
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.WorkloadOnboardingStep.Step step = 1;</code>
     */
    protected $step = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudControlsPartner\V1\WorkloadOnboardingStep\Step::class);
        $this->step = $var;
