 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudcontrolspartner.v1.CustomerOnboardingStep</code>
 */
class CustomerOnboardingStep extends \Google\Protobuf\Internal\Message
{
     ...
     * The onboarding step
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.CustomerOnboardingStep.Step step = 1;</code>
     */
    protected $step = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.cloudcontrolspartner.v1.CompletionState completion_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudControlsPartner\V1\CustomerOnboardingStep\Step::class);
        $this->step = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\CloudControlsPartner\V1\CompletionState::class);
