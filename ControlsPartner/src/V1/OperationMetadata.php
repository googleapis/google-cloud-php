 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudcontrolspartner.v1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Cloudcontrolspartner\V1\Core::initOnce();
