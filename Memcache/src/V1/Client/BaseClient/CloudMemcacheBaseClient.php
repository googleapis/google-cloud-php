...
namespace Google\Cloud\Memcache\V1\Client\BaseClient;
 ...
 */
abstract class CloudMemcacheBaseClient
{
     ...
     *
     * The async variant is {@see self::applyParametersAsync()} .
     *
     ...
     * instance.
     *
     * The async variant is {@see self::updateParametersAsync()} .
     *
