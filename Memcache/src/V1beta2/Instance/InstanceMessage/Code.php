...
namespace Google\Cloud\Memcache\V1beta2\Instance\InstanceMessage;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.cloud.memcache.v1beta2.Instance.InstanceMessage.Code</code>
 */
class Code
{
    /**
...
class_alias(Code::class, \Google\Cloud\Memcache\V1beta2\Instance_InstanceMessage_Code::class);
