 ...
 *
 * Generated from protobuf message <code>google.cloud.maintenance.api.v1beta.MaintenanceControl</code>
 */
class MaintenanceControl extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.maintenance.api.v1beta.MaintenanceControl.Control control = 1;</code>
     */
    protected $control = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Maintenance\Api\V1beta\MaintenanceControl\Control::class);
        $this->control = $var;
