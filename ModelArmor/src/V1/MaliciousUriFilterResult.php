 ...
 *
 * Generated from protobuf message <code>google.cloud.modelarmor.v1.MaliciousUriFilterResult</code>
 */
class MaliciousUriFilterResult extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\ModelArmor\V1\MaliciousUriFilterResult\MaliciousUriMatchedItem::class);
