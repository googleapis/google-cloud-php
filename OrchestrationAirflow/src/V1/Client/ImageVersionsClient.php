 ...
 *
 * @method PromiseInterface<PagedListResponse> listImageVersionsAsync(ListImageVersionsRequest $request, array $optionalArgs = [])
 */
final class ImageVersionsClient
{
     ...
     *           $options = new ImageVersionsClient(['credentials' => $creds]);
     *           ```
     *           {@see
