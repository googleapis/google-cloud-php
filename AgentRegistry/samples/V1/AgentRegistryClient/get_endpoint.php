...
// [START agentregistry_v1_generated_AgentRegistry_GetEndpoint_sync]
 ...
 *                              Please see {@see AgentRegistryClient::endpointName()} for help formatting this field.
 */
function get_endpoint_sample(string $formattedName): void
{
    ...
    try {
        ...
        $response = $agentRegistryClient->getEndpoint($request);
...
{
    $formattedName = AgentRegistryClient::endpointName('[PROJECT]', '[LOCATION]', '[ENDPOINT]');

    get_endpoint_sample($formattedName);
}
// [END agentregistry_v1_generated_AgentRegistry_GetEndpoint_sync]
