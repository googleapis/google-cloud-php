 ...
 *
 * @param string $bindingName Identifier. The resource name of the Binding.
 *                            Format: `projects/{project}/locations/{location}/bindings/{binding}`.
 */
function update_binding_sample(string $bindingName): void
{
    // Create a client.
    ...
    $request = (new UpdateBindingRequest())
        ->setBinding($binding);

    // Call the API and handle any network failures.
    try {
        /** @var OperationResponse $response */
        $response = $agentRegistryClient->updateBinding($request);
...
function callSample(): void
{
    ...
    update_binding_sample($bindingName);
}
