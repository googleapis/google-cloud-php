 ...
 *
 * @param string $formattedParent The project and location to create the Binding in.
 ...
 * @param string $bindingId       The ID to use for the binding, which will become the final
 ...
 */
function create_binding_sample(
    ...
    try {
        ...
        $response = $agentRegistryClient->createBinding($request);
...
function callSample(): void
{
    ...
    create_binding_sample($formattedParent, $bindingId, $bindingName);
}
