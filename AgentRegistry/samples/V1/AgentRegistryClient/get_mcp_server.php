...
// [START agentregistry_v1_generated_AgentRegistry_GetMcpServer_sync]
 ...
 *                              Please see {@see AgentRegistryClient::mcpServerName()} for help formatting this field.
 */
function get_mcp_server_sample(string $formattedName): void
{
    ...
    try {
        ...
        $response = $agentRegistryClient->getMcpServer($request);
...
{
    $formattedName = AgentRegistryClient::mcpServerName('[PROJECT]', '[LOCATION]', '[MCP_SERVER]');

    get_mcp_server_sample($formattedName);
}
// [END agentregistry_v1_generated_AgentRegistry_GetMcpServer_sync]
