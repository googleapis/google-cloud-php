 ...
 *                              Please see {@see AgentRegistryClient::agentName()} for help formatting this field.
 */
function get_agent_sample(string $formattedName): void
{
    ...
    try {
        /** @var Agent $response */
        $response = $agentRegistryClient->getAgent($request);
...
{
    $formattedName = AgentRegistryClient::agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
