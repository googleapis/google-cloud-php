 ...
 *
 * Generated from protobuf message <code>google.cloud.agentregistry.v1.ListEndpointsRequest</code>
 */
class ListEndpointsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The project and location to list endpoints in.
     ...
     *
     * @return \Google\Cloud\AgentRegistry\V1\ListEndpointsRequest
     *
     * @experimental
     */
