 ...
 *                                Format: 'projects/{project_id}/locations/{location}'. Please see
 *                                {@see ConfigClient::locationName()} for help formatting this field.
 */
function list_deployment_groups_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $configClient->listDeploymentGroups($request);

        /** @var DeploymentGroup $element */
...
function callSample(): void
{
    ...
    list_deployment_groups_sample($formattedParent);
}
