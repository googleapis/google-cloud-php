    ...
    'interfaces' => [
        ...
        'google.cloud.workloadidentity.v1.WorkloadIdentity' => [
            'GenerateServiceAgents' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/serviceProducers/*}:generateServiceAgents',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{parent=folders/*/locations/*/serviceProducers/*}:generateServiceAgents',
                        'body' => '*',
                    ],
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{parent=organizations/*/locations/*/serviceProducers/*}:generateServiceAgents',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
        ...
        'google.longrunning.Operations' => [
            'CancelOperation' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{name=folders/*/locations/*/operations/*}:cancel',
                        'body' => '*',
                    ],
                    [
                        'method' => 'post',
