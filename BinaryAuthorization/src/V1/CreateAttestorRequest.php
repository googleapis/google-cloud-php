 ...
 *
 * Generated from protobuf message <code>google.cloud.binaryauthorization.v1.CreateAttestorRequest</code>
 */
class CreateAttestorRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\BinaryAuthorization\V1\Attestor $attestor   Required. The initial
     *                                                                  [attestor][google.cloud.binaryauthorization.v1.Attestor] value. The service
     *                                                                  will overwrite the [attestor
     *                                                                  name][google.cloud.binaryauthorization.v1.Attestor.name] field with the
     *                                                                  resource name, in the format `projects/&#42;/attestors/*`.
     *
     * @return \Google\Cloud\BinaryAuthorization\V1\CreateAttestorRequest
     *
     * @experimental
     */
    public static function build(string $parent, string $attestorId, \Google\Cloud\BinaryAuthorization\V1\Attestor $attestor): self
    {
        return (new self())
            ->setParent($parent)
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BinaryAuthorization\V1\Attestor::class);
        $this->attestor = $var;
