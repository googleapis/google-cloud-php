 ...
 */
abstract class ValidationHelperV1BaseClient
{
     ...
     */
    public function validateAttestationOccurrence(ValidateAttestationOccurrenceRequest $request, array $callOptions = []): ValidateAttestationOccurrenceResponse
    {
