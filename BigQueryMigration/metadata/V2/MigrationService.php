...
next_page_token (	2À
MigrationService˚
CreateMigrationWorkflowB.google.cloud.bigquery.migration.v2.CreateMigrationWorkflowRequest5.google.cloud.bigquery.migration.v2.MigrationWorkflow"e⁄Aparent,migration_workflowÇ”‰ìC"-/v2/{parent=projects/*/locations/*}/workflows:migration_workflowÃ
GetMigrationWorkflow?.google.cloud.bigquery.migration.v2.GetMigrationWorkflowRequest5.google.cloud.bigquery.migration.v2.MigrationWorkflow"<⁄AnameÇ”‰ì/-/v2/{name=projects/*/locations/*/workflows/*}ﬂ
ListMigrationWorkflowsA.google.cloud.bigquery.migration.v2.ListMigrationWorkflowsRequestB.google.cloud.bigquery.migration.v2.ListMigrationWorkflowsResponse">⁄AparentÇ”‰ì/-/v2/{parent=projects/*/locations/*}/workflows≥
DeleteMigrationWorkflowB.google.cloud.bigquery.migration.v2.DeleteMigrationWorkflowRequest.google.protobuf.Empty"<⁄AnameÇ”‰ì/*-/v2/{name=projects/*/locations/*/workflows/*}∫
StartMigrationWorkflowA.google.cloud.bigquery.migration.v2.StartMigrationWorkflowRequest.google.protobuf.Empty"E⁄AnameÇ”‰ì8"3/v2/{name=projects/*/locations/*/workflows/*}:start:*‘
GetMigrationSubtask>.google.cloud.bigquery.migration.v2.GetMigrationSubtaskRequest4.google.cloud.bigquery.migration.v2.MigrationSubtask"G⁄AnameÇ”‰ì:8/v2/{name=projects/*/locations/*/workflows/*/subtasks/*}Á
ListMigrationSubtasks@.google.cloud.bigquery.migration.v2.ListMigrationSubtasksRequestA.google.cloud.bigquery.migration.v2.ListMigrationSubtasksResponse"I⁄AparentÇ”‰ì:8/v2/{parent=projects/*/locations/*/workflows/*}/subtasksT A bigquerymigration.googleapis.com“A.https://www.googleapis.com/auth/cloud-platformB—
