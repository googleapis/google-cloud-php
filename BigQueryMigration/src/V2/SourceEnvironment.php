 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2.SourceEnvironment</code>
 */
class SourceEnvironment extends \Google\Protobuf\Internal\Message
{
    /**
