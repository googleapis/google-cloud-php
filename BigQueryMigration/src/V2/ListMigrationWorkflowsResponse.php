 ...
 *
 * Generated from protobuf message <code>google.cloud.bigquery.migration.v2.ListMigrationWorkflowsResponse</code>
 */
class ListMigrationWorkflowsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BigQuery\Migration\V2\MigrationWorkflow::class);
