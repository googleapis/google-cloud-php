 ...
 *
 * Generated from protobuf message <code>google.cloud.chronicle.v1.DeleteDataAccessLabelRequest</code>
 */
class DeleteDataAccessLabelRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The ID of the data access label to delete.
     *                     Format:
     *                     `projects/{project}/locations/{location}/instances/{instance}/dataAccessLabels/{data_access_label}`
     *                     Please see {@see DataAccessControlServiceClient::dataAccessLabelName()} for help formatting this field.
     *
     * @return \Google\Cloud\Chronicle\V1\DeleteDataAccessLabelRequest
     *
     * @experimental
     */
