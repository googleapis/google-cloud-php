 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/chronicle/v1/dashboard_query.proto
 ...
 *
 * @method PromiseInterface<ExecuteDashboardQueryResponse> executeDashboardQueryAsync(ExecuteDashboardQueryRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<DashboardQuery> getDashboardQueryAsync(GetDashboardQueryRequest $request, array $optionalArgs = [])
 */
