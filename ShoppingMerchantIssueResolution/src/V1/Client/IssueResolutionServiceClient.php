 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/issueresolution/v1/issueresolution.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Shopping\Merchant\IssueResolution\V1\Client;
...
/**
 * Service Description: Service to provide an issue resolution content for account issues and product
 * issues.
 *
 ...
 *
 * @method PromiseInterface<RenderAccountIssuesResponse> renderAccountIssuesAsync(RenderAccountIssuesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<RenderProductIssuesResponse> renderProductIssuesAsync(RenderProductIssuesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<TriggerActionResponse> triggerActionAsync(TriggerActionRequest $request, array $optionalArgs = [])
 */
final class IssueResolutionServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.shopping.merchant.issueresolution.v1.IssueResolutionService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/issue_resolution_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/issue_resolution_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/issue_resolution_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/issue_resolution_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Shopping\Merchant\IssueResolution\V1\IssueResolutionServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new IssueResolutionServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see IssueResolutionServiceClient::renderAccountIssuesAsync()} .
     *
     * @example samples/V1/IssueResolutionServiceClient/render_account_issues.php
     *
     * @param RenderAccountIssuesRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see IssueResolutionServiceClient::renderProductIssuesAsync()} .
     *
     * @example samples/V1/IssueResolutionServiceClient/render_product_issues.php
     *
     * @param RenderProductIssuesRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see IssueResolutionServiceClient::triggerActionAsync()} .
     *
     * @example samples/V1/IssueResolutionServiceClient/trigger_action.php
     *
     * @param TriggerActionRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function triggerAction(TriggerActionRequest $request, array $callOptions = []): TriggerActionResponse
    {
        return $this->startApiCall('TriggerAction', $request, $callOptions)->wait();
    }
}
