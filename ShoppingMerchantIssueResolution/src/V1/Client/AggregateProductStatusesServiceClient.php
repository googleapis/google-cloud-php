 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/issueresolution/v1/aggregateproductstatuses.proto
 ...
 *
 * @method PromiseInterface<PagedListResponse> listAggregateProductStatusesAsync(ListAggregateProductStatusesRequest $request, array $optionalArgs = [])
 */
final class AggregateProductStatusesServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.shopping.merchant.issueresolution.v1.AggregateProductStatusesService';
     ...
     *           use
     *           Google\Shopping\Merchant\IssueResolution\V1\AggregateProductStatusesServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new AggregateProductStatusesServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see AggregateProductStatusesServiceClient::listAggregateProductStatusesAsync()}
     * .
     *
     * @example samples/V1/AggregateProductStatusesServiceClient/list_aggregate_product_statuses.php
     *
     * @param ListAggregateProductStatusesRequest $request     A request to house fields associated with the call.
