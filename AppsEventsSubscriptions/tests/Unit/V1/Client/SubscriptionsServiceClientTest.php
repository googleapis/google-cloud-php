...
namespace Google\Apps\Events\Subscriptions\Tests\Unit\V1\Client;
...
use Google\Apps\Events\Subscriptions\V1\ListSubscriptionsResponse;
...
class SubscriptionsServiceClientTest extends GeneratedTest
{
    ...
    public function createSubscriptionTest()
    {
        ...
        $request = (new CreateSubscriptionRequest())->setSubscription($subscription);
    ...
    public function getSubscriptionTest()
    {
        ...
        $this->assertSame('/google.apps.events.subscriptions.v1.SubscriptionsService/GetSubscription', $actualFuncCall);
    ...
    public function listSubscriptionsTest()
    {
        ...
        $request = (new ListSubscriptionsRequest())->setFilter($filter);
    ...
    public function reactivateSubscriptionTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->subscriptionName('[SUBSCRIPTION]');
        $request = (new ReactivateSubscriptionRequest())->setName($formattedName);
    ...
    public function updateSubscriptionTest()
    {
        ...
        $subscriptionNotificationEndpoint = new NotificationEndpoint();
        $subscription->setNotificationEndpoint($subscriptionNotificationEndpoint);
        $request = (new UpdateSubscriptionRequest())->setSubscription($subscription);
