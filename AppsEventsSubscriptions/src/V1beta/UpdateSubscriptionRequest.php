 ...
 *
 * Generated from protobuf message <code>google.apps.events.subscriptions.v1beta.UpdateSubscriptionRequest</code>
 */
class UpdateSubscriptionRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param \Google\Apps\Events\Subscriptions\V1beta\Subscription $subscription Required. The subscription to update.
     *
     *                                                                            The subscription's `name` field is used to identify the subscription to
     *                                                                            update.
     * @param \Google\Protobuf\FieldMask                            $updateMask   Optional. The field to update. If omitted, updates any fields included in
     *                                                                            the request.
     *
     *                                                                            You can update one of the following fields in a subscription:
     *
     ...
     *                                                                            omitted fields are updated with empty values.
     *
     * @return \Google\Apps\Events\Subscriptions\V1beta\UpdateSubscriptionRequest
     *
     * @experimental
     */
    public static function build(\Google\Apps\Events\Subscriptions\V1beta\Subscription $subscription, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
