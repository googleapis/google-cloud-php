...
final class SubscriptionsServiceClient
{
     ...
     *           use Google\Apps\Events\Subscriptions\V1\SubscriptionsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SubscriptionsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<Subscription>
     *
