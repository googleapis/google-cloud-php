 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.ListTokenAuthUsersRequest</code>
 */
class ListTokenAuthUsersRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent to list token auth users from.
     *                       Format: projects/{project}/locations/{location}/instances/{instance}
     *                       Please see {@see MemorystoreClient::instanceName()} for help formatting this field.
     *
     * @return \Google\Cloud\Memorystore\V1beta\ListTokenAuthUsersRequest
     *
     * @experimental
     */
