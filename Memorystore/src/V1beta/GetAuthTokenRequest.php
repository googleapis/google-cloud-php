 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.GetAuthTokenRequest</code>
 */
class GetAuthTokenRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of token auth user for a token auth enabled instance.
     *                     Format:
     *                     projects/{project}/locations/{location}/instances/{instance}/tokenAuthUsers/{token_auth_user}/authTokens/{auth_token}
     *                     Please see {@see MemorystoreClient::authTokenName()} for help formatting this field.
     *
     * @return \Google\Cloud\Memorystore\V1beta\GetAuthTokenRequest
     *
     * @experimental
     */
