 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.RescheduleMaintenanceRequest</code>
 */
class RescheduleMaintenanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.RescheduleMaintenanceRequest.RescheduleType reschedule_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                   For allowed values, use constants defined on {@see \Google\Cloud\Memorystore\V1beta\RescheduleMaintenanceRequest\RescheduleType}
     * @param \Google\Protobuf\Timestamp $scheduleTime   Optional. Timestamp when the maintenance shall be rescheduled to if
     *                                                   reschedule_type=SPECIFIC_TIME, in RFC 3339 format.
     *                                                   Example: `2012-11-15T16:19:00.094Z`.
     *
     * @return \Google\Cloud\Memorystore\V1beta\RescheduleMaintenanceRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\RescheduleMaintenanceRequest\RescheduleType::class);
