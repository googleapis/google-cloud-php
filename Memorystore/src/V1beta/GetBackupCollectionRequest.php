 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.GetBackupCollectionRequest</code>
 */
class GetBackupCollectionRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Instance backupCollection resource name using the form:
     *                     `projects/{project_id}/locations/{location_id}/backupCollections/{backup_collection_id}`
     ...
     *
     * @return \Google\Cloud\Memorystore\V1beta\GetBackupCollectionRequest
     *
     * @experimental
     */
