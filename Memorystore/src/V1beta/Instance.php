...
class Instance extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.memorystore.v1beta.Instance.ServerCaMode server_ca_mode = 56 [(.google.api.field_behavior) = OPTIONAL, (.google.api.field_behavior) = IMMUTABLE];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\Instance\ServerCaMode::class);
