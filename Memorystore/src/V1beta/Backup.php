 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.Backup</code>
 */
class Backup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1beta.BackupFile backup_files = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $backup_files;
    /**
     * Output only. Node type of the instance.
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.Instance.NodeType node_type = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.Backup.BackupType backup_type = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $backup_type = 0;
    /**
     * Output only. State of the backup.
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.Backup.State state = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     * Output only. Encryption information of the backup.
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1beta.EncryptionInfo encryption_info = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. valkey-7.5/valkey-8.0, etc.
     *     @type \Google\Cloud\Memorystore\V1beta\BackupFile[] $backup_files
     *           Output only. List of backup files of the backup.
     *     @type int $node_type
     *           Output only. Node type of the instance.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1beta.BackupFile backup_files = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Cloud\Memorystore\V1beta\BackupFile>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1beta.BackupFile backup_files = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Memorystore\V1beta\BackupFile[] $var
     * @return $this
     */
    public function setBackupFiles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Memorystore\V1beta\BackupFile::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\Backup\BackupType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1beta\Backup\State::class);
        $this->state = $var;
