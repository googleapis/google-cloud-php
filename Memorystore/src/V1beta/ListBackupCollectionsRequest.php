 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1beta.ListBackupCollectionsRequest</code>
 */
class ListBackupCollectionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The resource name of the backupCollection location using the
     *                       form:
     *                       `projects/{project_id}/locations/{location_id}`
     ...
     *
     * @return \Google\Cloud\Memorystore\V1beta\ListBackupCollectionsRequest
     *
     * @experimental
     */
