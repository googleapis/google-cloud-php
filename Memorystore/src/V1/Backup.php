...
class Backup extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. valkey-7.5/valkey-8.0, etc.
     *     @type \Google\Cloud\Memorystore\V1\BackupFile[] $backup_files
     *           Output only. List of backup files of the backup.
     *     @type int $node_type
     *           Output only. Node type of the instance.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.BackupFile backup_files = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return RepeatedField<\Google\Cloud\Memorystore\V1\BackupFile>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.BackupFile backup_files = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Memorystore\V1\BackupFile[] $var
     * @return $this
     */
