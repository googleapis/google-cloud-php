 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1.CreateInstanceRequest</code>
 */
class CreateInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1.Instance instance = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Memorystore\V1\Instance $instance   Required. The instance to create.
     ...
     *                                                          * Must be unique within a location
     *
     * @return \Google\Cloud\Memorystore\V1\CreateInstanceRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Memorystore\V1\Instance $instance, string $instanceId): self
    {
        return (new self())
            ->setParent($parent)
