 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1.ExportBackupRequest</code>
 */
class ExportBackupRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * Google Cloud Storage bucket, like "my-bucket".
     *
     * Generated from protobuf field <code>string gcs_bucket = 2;</code>
     * @return string
     */
