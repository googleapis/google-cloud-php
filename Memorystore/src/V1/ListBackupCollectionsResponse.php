...
class ListBackupCollectionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.BackupCollection backup_collections = 1;</code>
     */
     ...
     *
     *     @type array<\Google\Cloud\Memorystore\V1\BackupCollection>|\Google\Protobuf\Internal\RepeatedField $backup_collections
     *           A list of backupCollections in the project.
     *           If the `location_id` in the parent field of the request is "-", all regions
     *           available to the project are queried, and the results aggregated.
     *           If in such an aggregated query a location is unavailable, a placeholder
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.memorystore.v1.BackupCollection backup_collections = 1;</code>
     * @param array<\Google\Cloud\Memorystore\V1\BackupCollection>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBackupCollections($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Memorystore\V1\BackupCollection::class);
