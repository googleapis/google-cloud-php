 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1.MaintenancePolicy</code>
 */
class MaintenancePolicy extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Memorystore\V1\WeeklyMaintenanceWindow::class);
