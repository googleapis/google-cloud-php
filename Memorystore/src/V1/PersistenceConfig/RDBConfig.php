 ...
 *
 * Generated from protobuf message <code>google.cloud.memorystore.v1.PersistenceConfig.RDBConfig</code>
 */
class RDBConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.memorystore.v1.PersistenceConfig.RDBConfig.SnapshotPeriod rdb_snapshot_period = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Memorystore\V1\PersistenceConfig\RDBConfig\SnapshotPeriod::class);
