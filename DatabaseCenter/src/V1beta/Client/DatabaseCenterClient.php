 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/databasecenter/v1beta/service.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Cloud\DatabaseCenter\V1beta\Client;
...
final class DatabaseCenterClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.databasecenter.v1beta.DatabaseCenter';
     ...
     */
    private const SERVICE_ADDRESS = 'databasecenter.googleapis.com';

    /** The address template of the service. */
    private const SERVICE_ADDRESS_TEMPLATE = 'databasecenter.UNIVERSE_DOMAIN';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/database_center_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/database_center_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/database_center_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/database_center_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           as "<uri>:<port>". Default 'databasecenter.googleapis.com:443'.
     ...
     *           use Google\Cloud\DatabaseCenter\V1beta\DatabaseCenterClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new DatabaseCenterClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see DatabaseCenterClient::queryDatabaseResourceGroupsAsync()} .
     *
     * @example samples/V1beta/DatabaseCenterClient/query_database_resource_groups.php
     *
     * @param QueryDatabaseResourceGroupsRequest $request     A request to house fields associated with the call.
     * @param array                              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function queryDatabaseResourceGroups(
     ...
     *
     * The async variant is {@see DatabaseCenterClient::queryProductsAsync()} .
     *
     * @example samples/V1beta/DatabaseCenterClient/query_products.php
     *
     * @param QueryProductsRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @experimental
     */
    public function queryProducts(QueryProductsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('QueryProducts', $request, $callOptions);
    }
}
