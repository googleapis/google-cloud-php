 ...
 */
function delete_app_gateway_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $appGatewaysServiceClient->deleteAppGateway($formattedName);
...
function callSample(): void
{
    ...
    delete_app_gateway_sample($formattedName);
}
