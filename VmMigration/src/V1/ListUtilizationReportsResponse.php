 ...
 *
 * Generated from protobuf message <code>google.cloud.vmmigration.v1.ListUtilizationReportsResponse</code>
 */
class ListUtilizationReportsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->utilization_reports;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\VMMigration\V1\UtilizationReport::class);
        $this->utilization_reports = $arr;
