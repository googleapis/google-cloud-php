...
class ClientConnectorServicesServiceClientTest extends GeneratedTest
{
    ...
    public function createClientConnectorServiceTest()
    {
        ...
        $incompleteOperation->setName('operations/createClientConnectorServiceTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        $expectedResponse = new ClientConnectorService();
        $expectedResponse->setName($name);
        $expectedResponse->setDisplayName($displayName);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/createClientConnectorServiceTest');
        ...
        $response = $gapicClient->createClientConnectorService($formattedParent, $clientConnectorService);
    ...
    public function deleteClientConnectorServiceTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteClientConnectorServiceTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteClientConnectorServiceTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->clientConnectorServiceName('[PROJECT]', '[LOCATION]', '[CLIENT_CONNECTOR_SERVICE]');
        $response = $gapicClient->deleteClientConnectorService($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function getClientConnectorServiceTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->clientConnectorServiceName('[PROJECT]', '[LOCATION]', '[CLIENT_CONNECTOR_SERVICE]');
        $response = $gapicClient->getClientConnectorService($formattedName);
    ...
    public function getClientConnectorServiceExceptionTest()
    {
        ...
        $formattedName = $gapicClient->clientConnectorServiceName('[PROJECT]', '[LOCATION]', '[CLIENT_CONNECTOR_SERVICE]');
        try {
            $gapicClient->getClientConnectorService($formattedName);
    ...
    public function listClientConnectorServicesTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $clientConnectorServicesElement = new ClientConnectorService();
        $clientConnectorServices = [
            $clientConnectorServicesElement,
        ];
        $expectedResponse = new ListClientConnectorServicesResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setClientConnectorServices($clientConnectorServices);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $response = $gapicClient->listClientConnectorServices($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getClientConnectorServices()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listClientConnectorServicesExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        try {
            $gapicClient->listClientConnectorServices($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateClientConnectorServiceTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateClientConnectorServiceTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateClientConnectorServiceTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $clientConnectorServiceEgress = new Egress();
        $clientConnectorService->setEgress($clientConnectorServiceEgress);
        $response = $gapicClient->updateClientConnectorService($updateMask, $clientConnectorService);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
