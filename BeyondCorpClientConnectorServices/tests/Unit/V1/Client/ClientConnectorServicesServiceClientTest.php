...
namespace Google\Cloud\BeyondCorp\ClientConnectorServices\Tests\Unit\V1\Client;
...
class ClientConnectorServicesServiceClientTest extends GeneratedTest
{
    ...
    public function deleteClientConnectorServiceTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->clientConnectorServiceName(
            '[PROJECT]',
            '[LOCATION]',
            '[CLIENT_CONNECTOR_SERVICE]'
        );
        $request = (new DeleteClientConnectorServiceRequest())->setName($formattedName);
    ...
    public function getClientConnectorServiceTest()
    {
        ...
        $request = (new GetClientConnectorServiceRequest())->setName($formattedName);
    ...
    public function listClientConnectorServicesTest()
    {
        ...
        $clientConnectorServices = [$clientConnectorServicesElement];
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListClientConnectorServicesRequest())->setParent($formattedParent);
    ...
    /** @test */
    public function createClientConnectorServiceAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
