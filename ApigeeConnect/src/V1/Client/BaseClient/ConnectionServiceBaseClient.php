 ...
 * \Google\Cloud\ApigeeConnect\V1\ConnectionServiceClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class ConnectionServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.apigeeconnect.v1.ConnectionService';
     ...
     */
    public static function endpointName(string $project, string $endpoint): string
    {
