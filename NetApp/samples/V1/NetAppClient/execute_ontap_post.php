 ...
 */
function execute_ontap_post_sample(string $ontapPath): void
{
    // Create a client.
    ...
    try {
        /** @var ExecuteOntapPostResponse $response */
        $response = $netAppClient->executeOntapPost($request);
...
function callSample(): void
{
    ...
    execute_ontap_post_sample($ontapPath);
}
