 ...
 */
function validate_directory_service_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $netAppClient->validateDirectoryService($request);
...
function callSample(): void
{
    ...
    validate_directory_service_sample($formattedName);
}
