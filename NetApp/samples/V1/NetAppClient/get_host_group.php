 ...
 */
function get_host_group_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        /** @var HostGroup $response */
        $response = $netAppClient->getHostGroup($request);
...
function callSample(): void
{
    ...
    get_host_group_sample($formattedName);
}
