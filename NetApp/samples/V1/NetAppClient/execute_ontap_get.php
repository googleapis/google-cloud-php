 ...
 */
function execute_ontap_get_sample(string $ontapPath): void
{
    // Create a client.
    ...
    try {
        /** @var ExecuteOntapGetResponse $response */
        $response = $netAppClient->executeOntapGet($request);
...
function callSample(): void
{
    ...
    execute_ontap_get_sample($ontapPath);
}
