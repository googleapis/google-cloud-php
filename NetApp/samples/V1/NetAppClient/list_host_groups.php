 ...
 *
 * @param string $formattedParent Parent value for ListHostGroupsRequest
 *                                Please see {@see NetAppClient::locationName()} for help formatting this field.
 */
function list_host_groups_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $netAppClient->listHostGroups($request);

        /** @var HostGroup $element */
...
function callSample(): void
{
    ...
    list_host_groups_sample($formattedParent);
}
