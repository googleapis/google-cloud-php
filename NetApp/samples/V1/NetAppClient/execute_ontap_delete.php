 ...
 */
function execute_ontap_delete_sample(string $ontapPath): void
{
    // Create a client.
    ...
    try {
        /** @var ExecuteOntapDeleteResponse $response */
        $response = $netAppClient->executeOntapDelete($request);
...
function callSample(): void
{
    ...
    execute_ontap_delete_sample($ontapPath);
}
