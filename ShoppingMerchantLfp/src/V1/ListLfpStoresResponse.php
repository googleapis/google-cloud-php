 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.lfp.v1.ListLfpStoresResponse</code>
 */
class ListLfpStoresResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Lfp\V1\LfpStore::class);
        $this->lfp_stores = $arr;
