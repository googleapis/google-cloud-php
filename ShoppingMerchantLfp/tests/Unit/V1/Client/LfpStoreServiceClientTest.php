...
use Google\Rpc\Code;
use Google\Shopping\Merchant\Lfp\V1\Client\LfpStoreServiceClient;
use Google\Shopping\Merchant\Lfp\V1\DeleteLfpStoreRequest;
use Google\Shopping\Merchant\Lfp\V1\GetLfpStoreRequest;
use Google\Shopping\Merchant\Lfp\V1\InsertLfpStoreRequest;
use Google\Shopping\Merchant\Lfp\V1\LfpStore;
use Google\Shopping\Merchant\Lfp\V1\ListLfpStoresRequest;
use Google\Shopping\Merchant\Lfp\V1\ListLfpStoresResponse;
use stdClass;
...
class LfpStoreServiceClientTest extends GeneratedTest
{
    ...
    public function deleteLfpStoreTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.lfp.v1.LfpStoreService/DeleteLfpStore', $actualFuncCall);
    ...
    public function getLfpStoreTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.lfp.v1.LfpStoreService/GetLfpStore', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function insertLfpStoreTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.lfp.v1.LfpStoreService/InsertLfpStore', $actualFuncCall);
    ...
    public function listLfpStoresTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.lfp.v1.LfpStoreService/ListLfpStores', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
