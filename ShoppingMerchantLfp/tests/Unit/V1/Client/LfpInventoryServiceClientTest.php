...
use Google\Rpc\Code;
use Google\Shopping\Merchant\Lfp\V1\Client\LfpInventoryServiceClient;
use Google\Shopping\Merchant\Lfp\V1\InsertLfpInventoryRequest;
use Google\Shopping\Merchant\Lfp\V1\LfpInventory;
use stdClass;
...
class LfpInventoryServiceClientTest extends GeneratedTest
{
    ...
    public function insertLfpInventoryTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.lfp.v1.LfpInventoryService/InsertLfpInventory', $actualFuncCall);
