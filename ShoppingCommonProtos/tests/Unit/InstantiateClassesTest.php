...
namespace Google\Cloud\ShoppingCommonProtos\Tests\Unit;
...
class InstantiateClassesTest extends TestCase
{
    ...
    public function classesProvider()
    {
        ...
        foreach ($reg as $files) {
            ...
            // Prepend standard '\Google\Shopping' portion of namespace, then replace '/' with '\'
            $fullyQualifiedName = "\\Google\\Shopping" . str_replace("/", "\\", $trimmedFile);
