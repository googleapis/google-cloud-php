 ...
 * @group gapic
 */
class TagHoldsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new TagHoldsClient($options);
    }

    /** @test */
    public function createTagHoldTest()
    {
        ...
        $incompleteOperation->setName('operations/createTagHoldTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $holder = 'holder-1211707988';
        $origin = 'origin-1008619738';
        $helpLink = 'helpLink1297152568';
        $expectedResponse = new TagHold();
        $expectedResponse->setName($name);
        $expectedResponse->setHolder($holder);
        $expectedResponse->setOrigin($origin);
        $expectedResponse->setHelpLink($helpLink);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/createTagHoldTest');
        ...
        $response = $gapicClient->createTagHold($formattedParent, $tagHold);
    ...
    /** @test */
    public function createTagHoldExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function deleteTagHoldTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteTagHoldTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteTagHoldTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->tagHoldName('[TAG_VALUE]', '[TAG_HOLD]');
        $response = $gapicClient->deleteTagHold($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    /** @test */
    public function deleteTagHoldExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function listTagHoldsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedParent = $gapicClient->tagValueName('[TAG_VALUE]');
        $response = $gapicClient->listTagHolds($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getTagHolds()[0], $resources[0]);
    ...
    /** @test */
    public function listTagHoldsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $formattedParent = $gapicClient->tagValueName('[TAG_VALUE]');
        try {
            $gapicClient->listTagHolds($formattedParent);
