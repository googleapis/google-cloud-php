 ...
 */
abstract class TagHoldsBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.resourcemanager.v3.TagHolds';
     ...
     */
    public static function tagHoldName(string $tagValue, string $tagHold): string
    {
        return self::getPathTemplate('tagHold')->render([
            'tag_value' => $tagValue,
            'tag_hold' => $tagHold,
        ]);
    }
     ...
     */
    public function createTagHold(CreateTagHoldRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateTagHold', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteTagHold(DeleteTagHoldRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteTagHold', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listTagHolds(ListTagHoldsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListTagHolds', $request, $callOptions);
    }
}
