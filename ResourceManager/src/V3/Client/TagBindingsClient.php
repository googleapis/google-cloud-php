...
final class TagBindingsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.resourcemanager.v3.TagBindings';
     ...
     */
    public static function tagBindingName(string $tagBinding): string
    {
        return self::getPathTemplate('tagBinding')->render([
     ...
     *           $options = new TagBindingsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<TagBinding>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function createTagBinding(CreateTagBindingRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateTagBinding', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteTagBinding(DeleteTagBindingRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteTagBinding', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listEffectiveTags(ListEffectiveTagsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListEffectiveTags', $request, $callOptions);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listTagBindings(ListTagBindingsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListTagBindings', $request, $callOptions);
    }
}
