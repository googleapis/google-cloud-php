 ...
 * @method PromiseInterface<PagedListResponse> searchOrganizationsAsync(SearchOrganizationsRequest $request, array $optionalArgs = [])
...
final class OrganizationsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.resourcemanager.v3.Organizations';
     ...
     *           $options = new OrganizationsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchOrganizations(SearchOrganizationsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('SearchOrganizations', $request, $callOptions);
    }
