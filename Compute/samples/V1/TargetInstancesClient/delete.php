 ...
 */
function delete_sample(string $project, string $targetInstance, string $zone): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $targetInstancesClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $targetInstance, $zone);
}
