 ...
 */
function update_sample(string $project, string $vmExtensionPolicy, string $zone): void
{
    // Create a client.
    ...
    $request = (new UpdateZoneVmExtensionPolicyRequest())
        ->setProject($project)
    ...
    try {
        ...
        $response = $zoneVmExtensionPoliciesClient->update($request);
...
function callSample(): void
{
    ...
    update_sample($project, $vmExtensionPolicy, $zone);
}
