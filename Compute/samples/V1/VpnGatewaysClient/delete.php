 ...
 */
function delete_sample(string $project, string $region, string $vpnGateway): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $vpnGatewaysClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $region, $vpnGateway);
}
