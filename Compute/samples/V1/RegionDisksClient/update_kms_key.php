 ...
 */
function update_kms_key_sample(string $disk, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionDisksClient->updateKmsKey($request);
...
function callSample(): void
{
    ...
    update_kms_key_sample($disk, $project, $region);
}
