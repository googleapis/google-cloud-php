 ...
 */
function delete_sample(string $packetMirroring, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $packetMirroringsClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($packetMirroring, $project, $region);
}
