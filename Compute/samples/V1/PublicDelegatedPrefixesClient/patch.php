 ...
 */
function patch_sample(string $project, string $publicDelegatedPrefix, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $publicDelegatedPrefixesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($project, $publicDelegatedPrefix, $region);
}
