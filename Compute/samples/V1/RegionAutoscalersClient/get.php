 ...
 */
function get_sample(string $autoscaler, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionAutoscalersClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($autoscaler, $project, $region);
}
