 ...
 */
function stop_instances_sample(
    ...
    try {
        ...
        $response = $regionInstanceGroupManagersClient->stopInstances($request);
...
function callSample(): void
{
    ...
    stop_instances_sample($instanceGroupManager, $project, $region);
}
