 ...
 */
function update_sample(string $healthCheck, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionHealthChecksClient->update($request);
...
function callSample(): void
{
    ...
    update_sample($healthCheck, $project, $region);
}
