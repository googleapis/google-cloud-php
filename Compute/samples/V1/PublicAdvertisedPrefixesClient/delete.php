 ...
 */
function delete_sample(string $project, string $publicAdvertisedPrefix): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $publicAdvertisedPrefixesClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $publicAdvertisedPrefix);
}
