 ...
 */
function patch_sample(string $backendBucket, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionBackendBucketsClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($backendBucket, $project, $region);
}
