 ...
 */
function delete_sample(string $backendBucket, string $project, string $region): void
{
    // Create a client.
    $regionBackendBucketsClient = new RegionBackendBucketsClient();
    ...
    try {
        ...
        $response = $regionBackendBucketsClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($backendBucket, $project, $region);
}
