 ...
 */
function patch_rule_sample(string $project, string $region, string $securityPolicy): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionSecurityPoliciesClient->patchRule($request);
...
function callSample(): void
{
    ...
    patch_rule_sample($project, $region, $securityPolicy);
}
