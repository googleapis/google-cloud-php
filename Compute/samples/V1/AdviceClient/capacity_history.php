 ...
 */
function capacity_history_sample(string $project, string $region): void
{
    // Create a client.
    ...
    try {
        /** @var CapacityHistoryResponse $response */
        $response = $adviceClient->capacityHistory($request);
...
function callSample(): void
{
    ...
    capacity_history_sample($project, $region);
}
