 ...
 */
function patch_sample(string $networkEdgeSecurityService, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkEdgeSecurityServicesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($networkEdgeSecurityService, $project, $region);
}
