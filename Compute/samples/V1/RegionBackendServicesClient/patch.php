 ...
 */
function patch_sample(string $backendService, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionBackendServicesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($backendService, $project, $region);
}
