 ...
 */
function delete_sample(string $project, string $region, string $sslCertificate): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionSslCertificatesClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $region, $sslCertificate);
}
