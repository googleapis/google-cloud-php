 ...
 */
function delete_sample(string $project, string $rollout): void
{
    // Create a client.
    $rolloutsClient = new RolloutsClient();

    // Prepare the request message.
    $request = (new DeleteRolloutRequest())
        ->setProject($project)
        ->setRollout($rollout);
    ...
    try {
        ...
        $response = $rolloutsClient->delete($request);
