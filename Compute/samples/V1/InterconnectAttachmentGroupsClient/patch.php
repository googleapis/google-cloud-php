 ...
 */
function patch_sample(string $interconnectAttachmentGroup, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $interconnectAttachmentGroupsClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($interconnectAttachmentGroup, $project);
}
