 ...
 */
function get_sample(string $interconnectAttachmentGroup, string $project): void
{
    // Create a client.
    ...
    try {
        /** @var InterconnectAttachmentGroup $response */
        $response = $interconnectAttachmentGroupsClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($interconnectAttachmentGroup, $project);
}
