 ...
 */
function set_url_map_sample(string $project, string $targetHttpProxy): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $targetHttpProxiesClient->setUrlMap($request);
...
function callSample(): void
{
    ...
    set_url_map_sample($project, $targetHttpProxy);
}
