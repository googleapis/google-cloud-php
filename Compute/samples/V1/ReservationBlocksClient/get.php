...
function get_sample(
    ...
    $request = (new GetReservationBlockRequest())
        ->setProject($project)
    ...
    try {
        /** @var ReservationBlocksGetResponse $response */
        $response = $reservationBlocksClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($project, $reservation, $reservationBlock, $zone);
}
