 ...
 */
function list_named_sets_sample(string $project, string $region, string $router): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $routersClient->listNamedSets($request);
...
function callSample(): void
{
    ...
    list_named_sets_sample($project, $region, $router);
}
