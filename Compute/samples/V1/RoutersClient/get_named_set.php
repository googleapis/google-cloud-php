 ...
 * @param string $router  Name of the Router resource to query for the named set. The name should
 *                        conform to RFC1035.
 */
function get_named_set_sample(string $project, string $region, string $router): void
{
    // Create a client.
    ...
    try {
        /** @var RoutersGetNamedSetResponse $response */
        $response = $routersClient->getNamedSet($request);
...
function callSample(): void
{
    ...
    get_named_set_sample($project, $region, $router);
}
