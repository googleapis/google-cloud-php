 ...
 * @param string $rolloutPlan Name of the RolloutPlan resource to delete.
 */
function delete_sample(string $project, string $rolloutPlan): void
{
    // Create a client.
    $rolloutPlansClient = new RolloutPlansClient();

    // Prepare the request message.
    $request = (new DeleteRolloutPlanRequest())
        ->setProject($project)
    ...
    try {
        ...
        $response = $rolloutPlansClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($project, $rolloutPlan);
}
