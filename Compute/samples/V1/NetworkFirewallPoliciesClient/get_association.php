 ...
 */
function get_association_sample(string $firewallPolicy, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkFirewallPoliciesClient->getAssociation($request);
...
function callSample(): void
{
    ...
    get_association_sample($firewallPolicy, $project);
}
