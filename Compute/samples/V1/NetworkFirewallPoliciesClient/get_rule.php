 ...
 */
function get_rule_sample(string $firewallPolicy, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkFirewallPoliciesClient->getRule($request);
...
function callSample(): void
{
    ...
    get_rule_sample($firewallPolicy, $project);
}
