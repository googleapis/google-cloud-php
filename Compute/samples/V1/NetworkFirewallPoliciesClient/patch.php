 ...
 */
function patch_sample(string $firewallPolicy, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkFirewallPoliciesClient->patch($request);
...
function callSample(): void
{
    ...
    patch_sample($firewallPolicy, $project);
}
