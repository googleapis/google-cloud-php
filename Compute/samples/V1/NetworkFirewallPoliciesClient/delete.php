 ...
 */
function delete_sample(string $firewallPolicy, string $project): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkFirewallPoliciesClient->delete($firewallPolicy, $project);
...
function callSample(): void
{
    ...
    delete_sample($firewallPolicy, $project);
}
