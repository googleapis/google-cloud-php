 ...
 */
function get_sample(string $healthSource, string $project, string $region): void
{
    // Create a client.
    $regionHealthSourcesClient = new RegionHealthSourcesClient();

    // Prepare the request message.
    $request = (new GetRegionHealthSourceRequest())
    ...
    try {
        /** @var HealthSource $response */
        $response = $regionHealthSourcesClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($healthSource, $project, $region);
}
