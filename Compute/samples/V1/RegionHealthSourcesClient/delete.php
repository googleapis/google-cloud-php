 ...
 */
function delete_sample(string $healthSource, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionHealthSourcesClient->delete($request);
...
function callSample(): void
{
    ...
    delete_sample($healthSource, $project, $region);
}
