 ...
 *
 * @param string $compositeHealthCheck Name of the CompositeHealthCheck resource to get health for.
 * @param string $project              Name of the project scoping this request.
 * @param string $region               Name of the region scoping this request.
 */
function get_health_sample(string $compositeHealthCheck, string $project, string $region): void
{
    // Create a client.
    ...
    try {
        /** @var CompositeHealthCheckHealth $response */
        $response = $regionCompositeHealthChecksClient->getHealth($request);
...
function callSample(): void
{
    ...
    get_health_sample($compositeHealthCheck, $project, $region);
}
