 ...
 */
function get_sample(string $project, string $region, string $targetHttpsProxy): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $regionTargetHttpsProxiesClient->get($request);
...
function callSample(): void
{
    ...
    get_sample($project, $region, $targetHttpsProxy);
}
