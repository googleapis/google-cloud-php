 ...
 * @group gapic
 */
class SnapshotSettingsServiceClientTest extends GeneratedTest
{
    ...
    /** @return SnapshotSettingsServiceClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new SnapshotSettingsServiceClient($options);
    }
    ...
    public function patchTest()
    {
        ...
        $response = $gapicClient->patch($project, $snapshotSettingsResource);
