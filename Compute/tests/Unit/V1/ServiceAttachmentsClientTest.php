 ...
 * @group gapic
 */
class ServiceAttachmentsClientTest extends GeneratedTest
{
    /**
    ...
    /**
     * @return ServiceAttachmentsClient
     */
    private function createClient(array $options = [])
    {
        ...
        return new ServiceAttachmentsClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new ServiceAttachmentsScopedList(),
        ];
        $expectedResponse = new ServiceAttachmentAggregatedList();
    ...
    public function deleteTest()
    {
        ...
        $response = $client->delete($project, $region, $serviceAttachment);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ServiceAttachments/Delete', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function deleteExceptionTest()
    {
        ...
        $serviceAttachment = 'serviceAttachment-1271655187';
        try {
            $client->delete($project, $region, $serviceAttachment);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getTest()
    {
        ...
        $region = 'region-934795532';
        $serviceAttachment = 'serviceAttachment-1271655187';
        $response = $client->get($project, $region, $serviceAttachment);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function insertTest()
    {
        ...
        $response = $client->insert($project, $region, $serviceAttachmentResource);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ServiceAttachments/Insert', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
        $actualValue = $actualRequestObject->getServiceAttachmentResource();
    ...
    public function insertExceptionTest()
    {
        ...
        $serviceAttachmentResource = new ServiceAttachment();
        try {
            $client->insert($project, $region, $serviceAttachmentResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new ServiceAttachment();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new ServiceAttachmentList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
    ...
    public function patchTest()
    {
        ...
        $serviceAttachment = 'serviceAttachment-1271655187';
        $serviceAttachmentResource = new ServiceAttachment();
        $response = $client->patch($project, $region, $serviceAttachment, $serviceAttachmentResource);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ServiceAttachments/Patch', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function patchExceptionTest()
    {
        ...
        $serviceAttachmentResource = new ServiceAttachment();
        try {
            $client->patch($project, $region, $serviceAttachment, $serviceAttachmentResource);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
