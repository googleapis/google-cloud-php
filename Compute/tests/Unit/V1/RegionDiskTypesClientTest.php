 ...
 * @group gapic
 */
class RegionDiskTypesClientTest extends GeneratedTest
{
    ...
    /** @return RegionDiskTypesClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionDiskTypesClient($options);
    }
    ...
    public function getTest()
    {
        ...
        $validDiskSize = 'validDiskSize-1653521184';
        $zone = 'zone3744684';
        $expectedResponse = new DiskType();
        $expectedResponse->setCreationTimestamp($creationTimestamp);
        $expectedResponse->setDefaultDiskSizeGb($defaultDiskSizeGb);
        ...
        $response = $gapicClient->get($diskType, $project, $region);
    ...
    public function getExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $gapicClient->get($diskType, $project, $region);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new DiskType();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new RegionDiskTypeList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
