...
use Google\Cloud\Compute\V1\InstanceTemplatesScopedList;
 ...
 * @group gapic
 */
class InstanceTemplatesClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new InstanceTemplatesClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new InstanceTemplatesScopedList(),
        ];
        $expectedResponse = new InstanceTemplateAggregatedList();
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new InstanceTemplate();
    ...
    public function getIamPolicyTest()
    {
        ...
        $request = (new GetIamPolicyInstanceTemplateRequest())->setProject($project)->setResource($resource);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new InstanceTemplate();
        $items = [$itemsElement];
        $expectedResponse = new InstanceTemplateList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        // Mock request
        $project = 'project-309310695';
        $request = (new ListInstanceTemplatesRequest())->setProject($project);
