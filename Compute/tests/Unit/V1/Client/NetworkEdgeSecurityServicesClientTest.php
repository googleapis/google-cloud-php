...
use Google\Cloud\Compute\V1\NetworkEdgeSecurityServiceAggregatedList;
use Google\Cloud\Compute\V1\NetworkEdgeSecurityServicesScopedList;
 ...
 * @group gapic
 */
class NetworkEdgeSecurityServicesClientTest extends GeneratedTest
{
    ...
    /** @return NetworkEdgeSecurityServicesClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new NetworkEdgeSecurityServicesClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new NetworkEdgeSecurityServicesScopedList(),
        ];
        $expectedResponse = new NetworkEdgeSecurityServiceAggregatedList();
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new NetworkEdgeSecurityService();
