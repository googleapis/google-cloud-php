 ...
 * @group gapic
 */
class NetworkProfilesClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new NetworkProfilesClient($options);
    }
    ...
    public function getTest()
    {
        ...
        $request = (new GetNetworkProfileRequest())->setNetworkProfile($networkProfile)->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.NetworkProfiles/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getNetworkProfile();
        $this->assertProtobufEquals($networkProfile, $actualValue);
    ...
    public function listTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.NetworkProfiles/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
