...
use Google\Cloud\Compute\V1\CommitmentsScopedList;
 ...
 * @group gapic
 */
class RegionCommitmentsClientTest extends GeneratedTest
{
    ...
    /** @return RegionCommitmentsClient */
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new CommitmentsScopedList(),
        ];
        $expectedResponse = new CommitmentAggregatedList();
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new Commitment();
        $items = [$itemsElement];
        $expectedResponse = new CommitmentList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionCommitmentsRequest())->setProject($project)->setRegion($region);
