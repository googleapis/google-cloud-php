...
class NetworkFirewallPoliciesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $firewallPolicy = 'firewallPolicy1035044177';
        $project = 'project-309310695';
        $request = (new DeleteNetworkFirewallPolicyRequest())->setFirewallPolicy($firewallPolicy)->setProject($project);
    ...
    public function getIamPolicyTest()
    {
        ...
        $request = (new GetIamPolicyNetworkFirewallPolicyRequest())->setProject($project)->setResource($resource);
