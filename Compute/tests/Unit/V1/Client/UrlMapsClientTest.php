 ...
 * @group gapic
 */
class UrlMapsClientTest extends GeneratedTest
{
    ...
    /** @return UrlMapsClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new UrlMapsClient($options);
    }
    ...
    public function deleteTest()
    {
        ...
        $request = (new DeleteUrlMapRequest())->setProject($project)->setUrlMap($urlMap);
    ...
    public function getTest()
    {
        ...
        $selfLink = 'selfLink-1691268851';
        $expectedResponse = new UrlMap();
        $expectedResponse->setCreationTimestamp($creationTimestamp);
        $expectedResponse->setDefaultService($defaultService);
        ...
        $project = 'project-309310695';
        $urlMap = 'urlMap-169850228';
        $request = (new GetUrlMapRequest())->setProject($project)->setUrlMap($urlMap);
    ...
    public function insertTest()
    {
        ...
        $request = (new InsertUrlMapRequest())->setProject($project)->setUrlMapResource($urlMapResource);
    ...
    /** @test */
    public function invalidateCacheTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new GlobalOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/invalidateCacheTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
    ...
    /** @test */
    public function invalidateCacheExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new GlobalOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/invalidateCacheExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
        $status->code = Code::DATA_LOSS;
    ...
    public function listTest()
    {
        ...
        // Mock request
        $project = 'project-309310695';
        $request = (new ListUrlMapsRequest())->setProject($project);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $request = (new TestIamPermissionsUrlMapRequest())
            ->setProject($project)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.UrlMaps/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
