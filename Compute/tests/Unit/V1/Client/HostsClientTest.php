...
use Google\Cloud\Compute\V1\HostsListResponse;
 ...
 * @group gapic
 */
class HostsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new HostsClient($options);
    }
    ...
    public function getTest()
    {
        ...
        // Mock request
        $association = 'association-87499647';
        $host = 'host3208616';
        ...
        $this->assertSame('/google.cloud.compute.v1.Hosts/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getAssociation();
        $this->assertProtobufEquals($association, $actualValue);
        $actualValue = $actualRequestObject->getHost();
        $this->assertProtobufEquals($host, $actualValue);
    ...
    public function getVersionTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.Hosts/GetVersion', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getAssociation();
        $this->assertProtobufEquals($association, $actualValue);
        $actualValue = $actualApiRequestObject->getHost();
        $this->assertProtobufEquals($host, $actualValue);
        $actualValue = $actualApiRequestObject->getHostsGetVersionRequestResource();
        $this->assertProtobufEquals($hostsGetVersionRequestResource, $actualValue);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new Host();
        $items = [$itemsElement];
        $expectedResponse = new HostsListResponse();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.Hosts/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getAssociation();
        $this->assertProtobufEquals($association, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
