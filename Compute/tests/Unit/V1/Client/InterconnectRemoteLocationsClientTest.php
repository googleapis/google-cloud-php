...
use Google\Cloud\Compute\V1\InterconnectRemoteLocationList;
 ...
 * @group gapic
 */
class InterconnectRemoteLocationsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new InterconnectRemoteLocationsClient($options);
    }
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new InterconnectRemoteLocation();
