...
use Google\Cloud\Compute\V1\HealthSourceAggregatedList;
use Google\Cloud\Compute\V1\HealthSourceHealth;
use Google\Cloud\Compute\V1\HealthSourceList;
use Google\Cloud\Compute\V1\HealthSourcesScopedList;
 ...
 * @group gapic
 */
class RegionHealthSourcesClientTest extends GeneratedTest
{
    ...
    /** @return RegionHealthSourcesClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionHealthSourcesClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new HealthSourcesScopedList(),
        ];
        $expectedResponse = new HealthSourceAggregatedList();
        ...
        $request = (new AggregatedListRegionHealthSourcesRequest())->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/AggregatedList', $actualFuncCall);
    ...
    public function deleteTest()
    {
        ...
        // Mock request
        $healthSource = 'healthSource913392478';
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new DeleteRegionHealthSourceRequest())
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/Delete', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getHealthSource();
        $this->assertProtobufEquals($healthSource, $actualValue);
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new HealthSource();
        $expectedResponse->setCreationTimestamp($creationTimestamp);
        $expectedResponse->setDescription($description);
        $expectedResponse->setFingerprint($fingerprint);
        $expectedResponse->setHealthAggregationPolicy($healthAggregationPolicy);
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getHealthSource();
        $this->assertProtobufEquals($healthSource, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function getHealthTest()
    {
        ...
        $kind = 'kind3292052';
        $expectedResponse = new HealthSourceHealth();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/GetHealth', $actualFuncCall);
        $actualValue = $actualRequestObject->getHealthSource();
        $this->assertProtobufEquals($healthSource, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function insertTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/Insert', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getHealthSourceResource();
        $this->assertProtobufEquals($healthSourceResource, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new HealthSource();
        $items = [$itemsElement];
        $expectedResponse = new HealthSourceList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionHealthSourcesRequest())->setProject($project)->setRegion($region);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function patchTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new PatchRegionHealthSourceRequest())
            ->setHealthSource($healthSource)
            ->setHealthSourceResource($healthSourceResource)
            ->setProject($project)
            ->setRegion($region);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/Patch', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getHealthSource();
        $this->assertProtobufEquals($healthSource, $actualValue);
        $actualValue = $actualApiRequestObject->getHealthSourceResource();
        $this->assertProtobufEquals($healthSourceResource, $actualValue);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthSources/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
