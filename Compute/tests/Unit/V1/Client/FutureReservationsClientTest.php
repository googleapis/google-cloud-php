...
use Google\Cloud\Compute\V1\FutureReservationsAggregatedListResponse;
use Google\Cloud\Compute\V1\FutureReservationsListResponse;
use Google\Cloud\Compute\V1\FutureReservationsScopedList;
 ...
 * @group gapic
 */
class FutureReservationsClientTest extends GeneratedTest
{
    ...
    /** @return FutureReservationsClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new FutureReservationsClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new FutureReservationsScopedList(),
        ];
        $expectedResponse = new FutureReservationsAggregatedListResponse();
        ...
        $request = (new AggregatedListFutureReservationsRequest())->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/AggregatedList', $actualFuncCall);
    ...
    public function cancelTest()
    {
        ...
        // Mock request
        $futureReservation = 'futureReservation-1554406576';
        $project = 'project-309310695';
        $zone = 'zone3744684';
        ...
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/Cancel', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getFutureReservation();
        $this->assertProtobufEquals($futureReservation, $actualValue);
    ...
    public function deleteTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/Delete', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getFutureReservation();
        $this->assertProtobufEquals($futureReservation, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function getTest()
    {
        ...
        $kind = 'kind3292052';
        $name = 'name3373707';
        $namePrefix = 'namePrefix236409542';
        ...
        $expectedResponse->setNamePrefix($namePrefix);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getFutureReservation();
        $this->assertProtobufEquals($futureReservation, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function insertTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/Insert', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getFutureReservationResource();
        $this->assertProtobufEquals($futureReservationResource, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new FutureReservation();
        $items = [$itemsElement];
        $expectedResponse = new FutureReservationsListResponse();
        $expectedResponse->setEtag($etag);
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $request = (new ListFutureReservationsRequest())->setProject($project)->setZone($zone);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
    ...
    public function updateTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.FutureReservations/Update', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getFutureReservation();
        $this->assertProtobufEquals($futureReservation, $actualValue);
        $actualValue = $actualApiRequestObject->getFutureReservationResource();
        $this->assertProtobufEquals($futureReservationResource, $actualValue);
