...
class NodeGroupsClientTest extends GeneratedTest
{
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $request = (new ListNodeGroupsRequest())->setProject($project)->setZone($zone);
    ...
    /** @test */
    public function addNodesAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new ZoneOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/addNodesAsyncTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
