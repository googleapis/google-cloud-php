...
class SubnetworksClientTest extends GeneratedTest
{
    ...
    public function aggregatedListTest()
    {
        ...
        $request = (new AggregatedListSubnetworksRequest())->setProject($project);
    ...
    public function getTest()
    {
        ...
        $resolveSubnetMask = 'resolveSubnetMask-1092916037';
        $role = 'role3506294';
        $selfLink = 'selfLink-1691268851';
        ...
        $expectedResponse->setResolveSubnetMask($resolveSubnetMask);
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListSubnetworksRequest())->setProject($project)->setRegion($region);
