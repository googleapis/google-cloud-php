 ...
 * @group gapic
 */
class MachineTypesClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new MachineTypesClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $request = (new AggregatedListMachineTypesRequest())->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.MachineTypes/AggregatedList', $actualFuncCall);
    ...
    public function getTest()
    {
        ...
        $expectedResponse->setId($id);
        $expectedResponse->setImageSpaceGb($imageSpaceGb);
        $expectedResponse->setIsSharedCpu($isSharedCpu);
        $expectedResponse->setKind($kind);
        $expectedResponse->setMaximumPersistentDisks($maximumPersistentDisks);
        $expectedResponse->setMaximumPersistentDisksSizeGb($maximumPersistentDisksSizeGb);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.MachineTypes/Get', $actualFuncCall);
        $actualValue = $actualRequestObject->getMachineType();
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new MachineType();
        $items = [$itemsElement];
        $expectedResponse = new MachineTypeList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $request = (new ListMachineTypesRequest())->setProject($project)->setZone($zone);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.MachineTypes/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
