 ...
 * @group gapic
 */
class AutoscalersClientTest extends GeneratedTest
{
    ...
    /** @return AutoscalersClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new AutoscalersClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new AutoscalersScopedList(),
        ];
        $expectedResponse = new AutoscalerAggregatedList();
    ...
    public function listTest()
    {
        ...
        $items = [$itemsElement];
        $expectedResponse = new AutoscalerList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $request = (new ListAutoscalersRequest())->setProject($project)->setZone($zone);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.Autoscalers/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
