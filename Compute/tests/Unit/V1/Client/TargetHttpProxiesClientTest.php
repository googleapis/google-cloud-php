...
class TargetHttpProxiesClientTest extends GeneratedTest
{
    ...
    public function aggregatedListTest()
    {
        ...
        $request = (new AggregatedListTargetHttpProxiesRequest())->setProject($project);
    ...
    public function deleteTest()
    {
        ...
        $request = (new DeleteTargetHttpProxyRequest())->setProject($project)->setTargetHttpProxy($targetHttpProxy);
    ...
    public function getTest()
    {
        ...
        $project = 'project-309310695';
        $targetHttpProxy = 'targetHttpProxy206872421';
        $request = (new GetTargetHttpProxyRequest())->setProject($project)->setTargetHttpProxy($targetHttpProxy);
