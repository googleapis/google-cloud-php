...
class RegionSecurityPoliciesClientTest extends GeneratedTest
{
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionSecurityPoliciesRequest())->setProject($project)->setRegion($region);
    ...
    /** @test */
    public function addRuleAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new RegionOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/addRuleAsyncTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
