 ...
 * @group gapic
 */
class RegionCompositeHealthChecksClientTest extends GeneratedTest
{
    ...
    /** @return RegionCompositeHealthChecksClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionCompositeHealthChecksClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new CompositeHealthChecksScopedList(),
        ];
        $expectedResponse = new CompositeHealthCheckAggregatedList();
        ...
        $request = (new AggregatedListRegionCompositeHealthChecksRequest())->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/AggregatedList', $actualFuncCall);
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/Delete', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCompositeHealthCheck();
    ...
    public function getTest()
    {
        ...
        $healthDestination = 'healthDestination-762643797';
        $id = 3355;
        $kind = 'kind3292052';
        $name = 'name3373707';
        ...
        $expectedResponse = new CompositeHealthCheck();
        $expectedResponse->setCreationTimestamp($creationTimestamp);
        $expectedResponse->setDescription($description);
        $expectedResponse->setFingerprint($fingerprint);
        $expectedResponse->setHealthDestination($healthDestination);
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/Get', $actualFuncCall);
    ...
    public function insertTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/Insert', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCompositeHealthCheckResource();
        $this->assertProtobufEquals($compositeHealthCheckResource, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new CompositeHealthCheck();
        $items = [$itemsElement];
        $expectedResponse = new CompositeHealthCheckList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionCompositeHealthChecksRequest())->setProject($project)->setRegion($region);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function patchTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/Patch', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getCompositeHealthCheck();
        $this->assertProtobufEquals($compositeHealthCheck, $actualValue);
        $actualValue = $actualApiRequestObject->getCompositeHealthCheckResource();
        $this->assertProtobufEquals($compositeHealthCheckResource, $actualValue);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionCompositeHealthChecks/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
