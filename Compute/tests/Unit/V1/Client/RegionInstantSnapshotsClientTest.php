 ...
 * @group gapic
 */
class RegionInstantSnapshotsClientTest extends GeneratedTest
{
    ...
    /** @return RegionInstantSnapshotsClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new RegionInstantSnapshotsClient($options);
    }
    ...
    public function deleteTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/Delete', $actualApiFuncCall);
    ...
    public function getTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/Get', $actualFuncCall);
    ...
    public function getIamPolicyTest()
    {
        ...
        $request = (new GetIamPolicyRegionInstantSnapshotRequest())
            ->setProject($project)
            ->setRegion($region)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/GetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function insertTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/Insert', $actualApiFuncCall);
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionInstantSnapshotsRequest())->setProject($project)->setRegion($region);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/List', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function setIamPolicyTest()
    {
        ...
        $resource = 'resource-341064690';
        $request = (new SetIamPolicyRegionInstantSnapshotRequest())
            ->setProject($project)
            ->setRegion($region)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/SetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function setLabelsTest()
    {
        ...
        $resource = 'resource-341064690';
        $request = (new SetLabelsRegionInstantSnapshotRequest())
            ->setProject($project)
            ->setRegion($region)
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/SetLabels', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $request = (new TestIamPermissionsRegionInstantSnapshotRequest())
            ->setProject($project)
            ->setRegion($region)
            ->setResource($resource)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionInstantSnapshots/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
