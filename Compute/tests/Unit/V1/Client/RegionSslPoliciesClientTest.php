...
class RegionSslPoliciesClientTest extends GeneratedTest
{
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionSslPoliciesRequest())->setProject($project)->setRegion($region);
    ...
    public function listAvailableFeaturesTest()
    {
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListAvailableFeaturesRegionSslPoliciesRequest())->setProject($project)->setRegion($region);
