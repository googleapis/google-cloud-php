...
class TargetHttpsProxiesClientTest extends GeneratedTest
{
    ...
    public function deleteTest()
    {
        ...
        $request = (new DeleteTargetHttpsProxyRequest())->setProject($project)->setTargetHttpsProxy($targetHttpsProxy);
    ...
    public function getTest()
    {
        ...
        $project = 'project-309310695';
        $targetHttpsProxy = 'targetHttpsProxy-2095146900';
        $request = (new GetTargetHttpsProxyRequest())->setProject($project)->setTargetHttpsProxy($targetHttpsProxy);
    ...
    public function setQuicOverrideTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/setQuicOverrideTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
    ...
    public function setQuicOverrideExceptionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/setQuicOverrideExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
        $status->code = Code::DATA_LOSS;
