...
use Google\Cloud\Compute\V1\ZoneSetNestedPolicyRequest;
use Google\Rpc\Code;
use stdClass;
...
class ReservationSubBlocksClientTest extends GeneratedTest
{
    ...
    public function getIamPolicyTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $parentResource = 'parentResource-1055650813';
        $project = 'project-309310695';
        $resource = 'resource-341064690';
        $zone = 'zone3744684';
        $request = (new GetIamPolicyReservationSubBlockRequest())
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ReservationSubBlocks/GetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getParentResource();
        $this->assertProtobufEquals($parentResource, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    /** @test */
    public function reportFaultyTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new ZoneOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/reportFaultyTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
        $completeOperation->setName('customOperations/reportFaultyTest');
        $completeOperation->setStatus(Status::DONE);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $parentName = 'parentName1015022848';
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ReservationSubBlocks/ReportFaulty', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParentName();
        $this->assertProtobufEquals($parentName, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getReservationSubBlock();
        $this->assertProtobufEquals($reservationSubBlock, $actualValue);
        $actualValue = $actualApiRequestObject->getReservationSubBlocksReportFaultyRequestResource();
        $this->assertProtobufEquals($reservationSubBlocksReportFaultyRequestResource, $actualValue);
        $actualValue = $actualApiRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
        $expectedOperationsRequestObject = new GetZoneOperationRequest();
        $expectedOperationsRequestObject->setOperation($completeOperation->getName());
    ...
    /** @test */
    public function reportFaultyExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new ZoneOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/reportFaultyExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
        $status->code = Code::DATA_LOSS;
    ...
    public function setIamPolicyTest()
    {
        ...
        $request = (new SetIamPolicyReservationSubBlockRequest())
            ->setParentResource($parentResource)
            ->setProject($project)
            ->setResource($resource)
            ->setZone($zone)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ReservationSubBlocks/SetIamPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getParentResource();
        $this->assertProtobufEquals($parentResource, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        ...
        $actualValue = $actualRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
        $actualValue = $actualRequestObject->getZoneSetNestedPolicyRequestResource();
        $this->assertProtobufEquals($zoneSetNestedPolicyRequestResource, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function testIamPermissionsTest()
    {
        ...
        $zone = 'zone3744684';
        $request = (new TestIamPermissionsReservationSubBlockRequest())
            ->setParentResource($parentResource)
            ->setProject($project)
            ->setResource($resource)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.ReservationSubBlocks/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParentResource();
        $this->assertProtobufEquals($parentResource, $actualValue);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
