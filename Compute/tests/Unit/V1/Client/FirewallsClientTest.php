 ...
 * @group gapic
 */
class FirewallsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new FirewallsClient($options);
    }
    ...
    public function deleteTest()
    {
        ...
        $request = (new DeleteFirewallRequest())->setFirewall($firewall)->setProject($project);
    ...
    public function getTest()
    {
        ...
        $firewall = 'firewall-562725632';
        $project = 'project-309310695';
        $request = (new GetFirewallRequest())->setFirewall($firewall)->setProject($project);
    ...
    public function insertTest()
    {
        ...
        $project = 'project-309310695';
        $request = (new InsertFirewallRequest())->setFirewallResource($firewallResource)->setProject($project);
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new Firewall();
        $items = [$itemsElement];
        $expectedResponse = new FirewallList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $request = (new TestIamPermissionsFirewallRequest())
            ->setProject($project)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.Firewalls/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
