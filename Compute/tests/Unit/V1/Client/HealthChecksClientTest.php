...
use Google\Cloud\Compute\V1\HealthChecksScopedList;
 ...
 * @group gapic
 */
class HealthChecksClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new HealthChecksClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new HealthChecksScopedList(),
        ];
        $expectedResponse = new HealthChecksAggregatedList();
        ...
        $request = (new AggregatedListHealthChecksRequest())->setProject($project);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.HealthChecks/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
