...
class InterconnectGroupsClientTest extends GeneratedTest
{
    ...
    public function createMembersTest()
    {
        ...
        $request = (new CreateMembersInterconnectGroupRequest())
            ...
            ->setProject($project);
        $response = $gapicClient->createMembers($request);
    ...
    public function getTest()
    {
        ...
        $interconnectGroup = 'interconnectGroup1462393742';
        $project = 'project-309310695';
        $request = (new GetInterconnectGroupRequest())->setInterconnectGroup($interconnectGroup)->setProject($project);
    ...
    public function getIamPolicyTest()
    {
        ...
        $request = (new GetIamPolicyInterconnectGroupRequest())->setProject($project)->setResource($resource);
    ...
    public function getOperationalStatusTest()
    {
        ...
        $request = (new GetOperationalStatusInterconnectGroupRequest())
            ->setInterconnectGroup($interconnectGroup)
            ->setProject($project);
        $response = $gapicClient->getOperationalStatus($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getOperationalStatusExceptionTest()
    {
        ...
        $request = (new GetOperationalStatusInterconnectGroupRequest())
            ...
            ->setProject($project);
        try {
            $gapicClient->getOperationalStatus($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function createMembersAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new GlobalOperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/createMembersAsyncTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
        $completeOperation->setName('customOperations/createMembersAsyncTest');
        $completeOperation->setStatus(Status::DONE);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $interconnectGroup = 'interconnectGroup1462393742';
