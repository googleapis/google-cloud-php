...
use Google\Cloud\Compute\V1\BackendBucketAggregatedList;
use Google\Cloud\Compute\V1\BackendBucketList;
use Google\Cloud\Compute\V1\BackendBucketListUsable;
use Google\Cloud\Compute\V1\BackendBucketsScopedList;
...
class BackendBucketsClientTest extends GeneratedTest
{
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new BackendBucketsScopedList(),
        ];
        $expectedResponse = new BackendBucketAggregatedList();
        ...
        // Mock request
        $project = 'project-309310695';
        $request = (new AggregatedListBackendBucketsRequest())->setProject($project);
        ...
        $this->assertSame('/google.cloud.compute.v1.BackendBuckets/AggregatedList', $actualFuncCall);
    ...
    public function getIamPolicyTest()
    {
        ...
        $request = (new GetIamPolicyBackendBucketRequest())->setProject($project)->setResource($resource);
    ...
    public function listTest()
    {
        ...
        // Mock request
        $project = 'project-309310695';
        $request = (new ListBackendBucketsRequest())->setProject($project);
    ...
    public function listUsableTest()
    {
        ...
        // Mock request
        $project = 'project-309310695';
        $request = (new ListUsableBackendBucketsRequest())->setProject($project);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.BackendBuckets/ListUsable', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
