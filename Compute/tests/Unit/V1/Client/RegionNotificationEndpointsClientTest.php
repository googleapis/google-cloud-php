 ...
 * @group gapic
 */
class RegionNotificationEndpointsClientTest extends GeneratedTest
{
    ...
    /** @return RegionNotificationEndpointsClient */
    ...
    public function getTest()
    {
        ...
        $expectedResponse = new NotificationEndpoint();
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new NotificationEndpoint();
        $items = [$itemsElement];
        $expectedResponse = new NotificationEndpointList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $request = (new ListRegionNotificationEndpointsRequest())->setProject($project)->setRegion($region);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionNotificationEndpoints/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
