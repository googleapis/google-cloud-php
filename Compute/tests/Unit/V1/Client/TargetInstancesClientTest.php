...
class TargetInstancesClientTest extends GeneratedTest
{
    ...
    public function listTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $request = (new ListTargetInstancesRequest())->setProject($project)->setZone($zone);
    ...
    public function testIamPermissionsTest()
    {
        ...
        $zone = 'zone3744684';
        $request = (new TestIamPermissionsTargetInstanceRequest())
            ->setProject($project)
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.TargetInstances/TestIamPermissions', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
