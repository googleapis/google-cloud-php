 ...
 * @group gapic
 */
class RegionZonesClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new RegionZonesClient($options);
    }
    ...
    public function listTest()
    {
        ...
        $this->assertSame('/google.cloud.compute.v1.RegionZones/List', $actualFuncCall);
