...
class NodeGroupsClientTest extends GeneratedTest
{
    ...
    public function addNodesTest()
    {
        ...
        $incompleteOperation->setName('customOperations/addNodesTest');
        ...
        $zone = 'zone3744684';
        $response = $gapicClient->addNodes($nodeGroup, $nodeGroupsAddNodesRequestResource, $project, $zone);
    ...
    public function addNodesExceptionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/addNodesExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
    ...
    public function deleteTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->delete($nodeGroup, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function deleteNodesTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/deleteNodesTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->deleteNodes($nodeGroup, $nodeGroupsDeleteNodesRequestResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function deleteNodesExceptionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/deleteNodesExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
        $status->code = Code::DATA_LOSS;
    ...
    public function getTest()
    {
        ...
        $maintenanceInterval = 'maintenanceInterval1477109873';
        ...
        $expectedResponse->setMaintenanceInterval($maintenanceInterval);
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->get($nodeGroup, $project, $zone);
    ...
    public function getExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->get($nodeGroup, $project, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function insertTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->insert($initialNodeCount, $nodeGroupResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new NodeGroup();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new NodeGroupList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
    ...
    public function listNodesTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new NodeGroupNode();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new NodeGroupsListNodes();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSelfLink($selfLink);
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->listNodes($nodeGroup, $project, $zone);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getItems()[0], $resources[0]);
    ...
    public function listNodesExceptionTest()
    {
        ...
        $zone = 'zone3744684';
        try {
            $gapicClient->listNodes($nodeGroup, $project, $zone);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function patchTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->patch($nodeGroup, $nodeGroupResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function performMaintenanceTest()
    {
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->performMaintenance($nodeGroup, $nodeGroupsPerformMaintenanceRequestResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.NodeGroups/PerformMaintenance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getNodeGroup();
        $this->assertProtobufEquals($nodeGroup, $actualValue);
        $actualValue = $actualApiRequestObject->getNodeGroupsPerformMaintenanceRequestResource();
        $this->assertProtobufEquals($nodeGroupsPerformMaintenanceRequestResource, $actualValue);
        $actualValue = $actualApiRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualApiRequestObject->getZone();
        $this->assertProtobufEquals($zone, $actualValue);
    ...
    public function setNodeTemplateTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/setNodeTemplateTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $completeOperation = new Operation();
        ...
        $project = 'project-309310695';
        $zone = 'zone3744684';
        $response = $gapicClient->setNodeTemplate($nodeGroup, $nodeGroupsSetNodeTemplateRequestResource, $project, $zone);
        $this->assertFalse($response->isDone());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        $operationsRequestsEmpty = $operationsTransport->popReceivedCalls();
    ...
    public function setNodeTemplateExceptionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('customOperations/setNodeTemplateExceptionTest');
        $incompleteOperation->setStatus(Status::RUNNING);
        $transport->addResponse($incompleteOperation);
        $status = new stdClass();
        $status->code = Code::DATA_LOSS;
