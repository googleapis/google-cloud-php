...
use Google\Cloud\Compute\V1\PublicDelegatedPrefixesScopedList;
 ...
 * @group gapic
 */
class PublicDelegatedPrefixesClientTest extends GeneratedTest
{
    /**
    ...
    /**
     * @return PublicDelegatedPrefixesClient
     */
    private function createClient(array $options = [])
    {
        ...
        return new PublicDelegatedPrefixesClient($options);
    }
    ...
    public function aggregatedListTest()
    {
        ...
        $items = [
            'itemsKey' => new PublicDelegatedPrefixesScopedList(),
        ];
        $expectedResponse = new PublicDelegatedPrefixAggregatedList();
    ...
    public function deleteTest()
    {
        ...
        $response = $client->delete($project, $publicDelegatedPrefix, $region);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.PublicDelegatedPrefixes/Delete', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
    ...
    public function deleteExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->delete($project, $publicDelegatedPrefix, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getTest()
    {
        ...
        $publicDelegatedPrefix = 'publicDelegatedPrefix1814851176';
        $region = 'region-934795532';
        $response = $client->get($project, $publicDelegatedPrefix, $region);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->get($project, $publicDelegatedPrefix, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function insertTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.PublicDelegatedPrefixes/Insert', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getPublicDelegatedPrefixResource();
    ...
    public function insertExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->insert($project, $publicDelegatedPrefixResource, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function patchTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.PublicDelegatedPrefixes/Patch', $actualFuncCall);
        $actualValue = $actualRequestObject->getProject();
        $this->assertProtobufEquals($project, $actualValue);
        $actualValue = $actualRequestObject->getPublicDelegatedPrefix();
        $this->assertProtobufEquals($publicDelegatedPrefix, $actualValue);
    ...
    public function patchExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->patch($project, $publicDelegatedPrefix, $publicDelegatedPrefixResource, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
