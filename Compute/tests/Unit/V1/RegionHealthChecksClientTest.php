 ...
 * @group gapic
 */
class RegionHealthChecksClientTest extends GeneratedTest
{
    /**
    ...
    /**
     * @return RegionHealthChecksClient
     */
    private function createClient(array $options = [])
    {
        ...
        return new RegionHealthChecksClient($options);
    }
    ...
    public function deleteTest()
    {
        ...
        $response = $client->delete($healthCheck, $project, $region);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthChecks/Delete', $actualFuncCall);
    ...
    public function deleteExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->delete($healthCheck, $project, $region);
    ...
    public function getTest()
    {
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $checkIntervalSec = 345561006;
        $creationTimestamp = 'creationTimestamp567396278';
        $description = 'description-1724546052';
        $healthyThreshold = 133658551;
        $id = 3355;
        $kind = 'kind3292052';
        $name = 'name3373707';
        $region2 = 'region2-690338393';
        ...
        $expectedResponse->setCreationTimestamp($creationTimestamp);
        $expectedResponse->setDescription($description);
        $expectedResponse->setHealthyThreshold($healthyThreshold);
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
        $expectedResponse->setName($name);
        $expectedResponse->setRegion($region2);
        ...
        $project = 'project-309310695';
        $region = 'region-934795532';
        $response = $client->get($healthCheck, $project, $region);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getExceptionTest()
    {
        ...
        $region = 'region-934795532';
        try {
            $client->get($healthCheck, $project, $region);
            // If the $client method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listTest()
    {
        ...
        $nextPageToken = '';
        $selfLink = 'selfLink-1691268851';
        $itemsElement = new HealthCheck();
        $items = [
            $itemsElement,
        ];
        $expectedResponse = new HealthCheckList();
        $expectedResponse->setId($id);
        $expectedResponse->setKind($kind);
    ...
    public function patchTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthChecks/Patch', $actualFuncCall);
        $actualValue = $actualRequestObject->getHealthCheck();
        $this->assertProtobufEquals($healthCheck, $actualValue);
        $actualValue = $actualRequestObject->getHealthCheckResource();
        $this->assertProtobufEquals($healthCheckResource, $actualValue);
    ...
    public function updateTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.compute.v1.RegionHealthChecks/Update', $actualFuncCall);
        $actualValue = $actualRequestObject->getHealthCheck();
        $this->assertProtobufEquals($healthCheck, $actualValue);
        $actualValue = $actualRequestObject->getHealthCheckResource();
        $this->assertProtobufEquals($healthCheckResource, $actualValue);
