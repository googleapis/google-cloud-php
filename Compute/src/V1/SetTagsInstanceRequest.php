 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetTagsInstanceRequest</code>
 */
class SetTagsInstanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param \Google\Cloud\Compute\V1\Tags $tagsResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetTagsInstanceRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instance, \Google\Cloud\Compute\V1\Tags $tagsResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
     ...
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type \Google\Cloud\Compute\V1\Tags $tags_resource
     *           The body resource for this request
     *     @type string $zone
     *           The name of the zone for this request.
     * }
    ...
    {
        return $this->tags_resource;
    }

    public function hasTagsResource()
    {
        return isset($this->tags_resource);
    }

    public function clearTagsResource()
    {
        unset($this->tags_resource);
    }
