 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetPoolList</code>
 */
class TargetPoolList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.TargetPool items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\TargetPool[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of TargetPool resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#targetPoolList for lists of target pools.
