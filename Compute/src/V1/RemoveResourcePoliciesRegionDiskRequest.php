...
class RemoveResourcePoliciesRegionDiskRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    private $region_disks_remove_resource_policies_request_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\RegionDisksRemoveResourcePoliciesRequest $regionDisksRemoveResourcePoliciesRequestResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\RemoveResourcePoliciesRegionDiskRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $disk, \Google\Cloud\Compute\V1\RegionDisksRemoveResourcePoliciesRequest $regionDisksRemoveResourcePoliciesRequestResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
