 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InsertOrganizationSecurityPolicyRequest</code>
 */
class InsertOrganizationSecurityPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * @return \Google\Cloud\Compute\V1\InsertOrganizationSecurityPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\Compute\V1\SecurityPolicy $securityPolicyResource): self
    {
        return (new self())
