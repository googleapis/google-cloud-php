 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NodeTemplateList</code>
 */
class NodeTemplateList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NodeTemplate items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\NodeTemplate[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of NodeTemplate resources.
     *     @type string $kind
     *           [Output Only] Type of resource.Always compute#nodeTemplateList for lists of node templates.
