...
class PatchPacketMirroringRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string packet_mirroring = 22305996 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $packet_mirroring = '';
    /**
     * The body resource for this request
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.PacketMirroring packet_mirroring_resource = 493501985 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchPacketMirroringRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $packetMirroring, \Google\Cloud\Compute\V1\PacketMirroring $packetMirroringResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
