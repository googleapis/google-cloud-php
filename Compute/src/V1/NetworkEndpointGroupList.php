...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NetworkEndpointGroupList</code>
 */
class NetworkEndpointGroupList extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NetworkEndpointGroup::class);
        $this->items = $arr;
