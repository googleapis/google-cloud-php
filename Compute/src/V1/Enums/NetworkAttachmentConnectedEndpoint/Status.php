...
namespace Google\Cloud\Compute\V1\Enums\NetworkAttachmentConnectedEndpoint;

/**
 * Status contains string constants that represent the names of each value in the
 * google.cloud.compute.v1.NetworkAttachmentConnectedEndpoint.Status descriptor.
 */
class Status
{
