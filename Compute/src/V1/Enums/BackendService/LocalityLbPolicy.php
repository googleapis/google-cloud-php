...
/**
 * LocalityLbPolicy contains string constants that represent the names of each
 * value in the google.cloud.compute.v1.BackendService.LocalityLbPolicy descriptor.
 */
class LocalityLbPolicy
{
    const UNDEFINED_LOCALITY_LB_POLICY = 'UNDEFINED_LOCALITY_LB_POLICY';
