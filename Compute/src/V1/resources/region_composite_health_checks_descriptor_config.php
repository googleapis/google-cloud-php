    ...
    'interfaces' => [
        'google.cloud.compute.v1.RegionCompositeHealthChecks' => [
            ...
            'AggregatedList' => [
                ...
                'responseType' => 'Google\Cloud\Compute\V1\CompositeHealthCheckAggregatedList',
                'headerParams' => [
                    [
                        'keyName' => 'project',
                        'fieldAccessors' => [
            ...
            'Get' => [
                ...
                'responseType' => 'Google\Cloud\Compute\V1\CompositeHealthCheck',
                'headerParams' => [
                    [
                        'keyName' => 'project',
                        'fieldAccessors' => [
            ...
            'List' => [
                ...
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\Compute\V1\CompositeHealthCheckList',
                'headerParams' => [
                    [
                        'keyName' => 'project',
                        'fieldAccessors' => [
