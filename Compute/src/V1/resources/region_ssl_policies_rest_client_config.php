...
return [
    'interfaces' => [
        'google.cloud.compute.v1.RegionSslPolicies' => [
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/sslPolicies/{ssl_policy}',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'ListAvailableFeatures' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/sslPolicies/listAvailableFeatures',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
