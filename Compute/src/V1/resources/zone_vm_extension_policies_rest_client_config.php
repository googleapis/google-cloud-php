...
return [
    'interfaces' => [
        'google.cloud.compute.v1.ZoneVmExtensionPolicies' => [
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/vmExtensionPolicies/{vm_extension_policy}',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Insert' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/vmExtensionPolicies',
