...
return [
    'interfaces' => [
        'google.cloud.compute.v1.RegionNotificationEndpoints' => [
            'AggregatedList' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/aggregated/notificationEndpoints',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Insert' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/notificationEndpoints',
            ...
            'TestIamPermissions' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/notificationEndpoints/{resource}/testIamPermissions',
