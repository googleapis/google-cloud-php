...
return [
    'interfaces' => [
        'google.cloud.compute.v1.WireGroups' => [
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/global/crossSiteNetworks/{cross_site_network}/wireGroups/{wire_group}',
                'placeholders' => [
                    'cross_site_network' => [
                        'getters' => [
                            'getCrossSiteNetwork',
            ...
            'Insert' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/global/crossSiteNetworks/{cross_site_network}/wireGroups',
