...
return [
    'interfaces' => [
        'google.cloud.compute.v1.Hosts' => [
            'Get' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/{association}/hosts/{host}',
                'placeholders' => [
                    'association' => [
                        'getters' => [
                            'getAssociation',
            ...
            'GetVersion' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/{association}/hosts/{host}/getVersion',
            ...
            'List' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/{association}/hosts',
                'placeholders' => [
                    'association' => [
                        'getters' => [
                            'getAssociation',
