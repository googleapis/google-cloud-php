...
return [
    'interfaces' => [
        'google.cloud.compute.v1.ReservationSlots' => [
            'Get' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/{parent_name=reservations/*/reservationBlocks/*/reservationSubBlocks/*}/reservationSlots/{reservation_slot}',
                'placeholders' => [
                    'parent_name' => [
                        'getters' => [
                            'getParentName',
            ...
            'GetHealth' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/zones/{zone}/{parent_name=reservations/*/reservationBlocks/*/reservationSubBlocks/*}/reservationSlots/{reservation_slot}/getHealth',
                'placeholders' => [
                    'parent_name' => [
                        'getters' => [
                            'getParentName',
