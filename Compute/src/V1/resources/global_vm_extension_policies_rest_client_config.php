...
return [
    'interfaces' => [
        'google.cloud.compute.v1.GlobalVmExtensionPolicies' => [
            'AggregatedList' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/aggregated/vmExtensionPolicies',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Delete' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}/delete',
            ...
            'Get' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/global/vmExtensionPolicies/{global_vm_extension_policy}',
                'placeholders' => [
                    'global_vm_extension_policy' => [
                        'getters' => [
                            'getGlobalVmExtensionPolicy',
            ...
            'Insert' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/global/vmExtensionPolicies',
