...
return [
    'interfaces' => [
        'google.cloud.compute.v1.RegionCompositeHealthChecks' => [
            'AggregatedList' => [
                'method' => 'get',
                'uriTemplate' => '/compute/v1/projects/{project}/aggregated/compositeHealthChecks',
                'placeholders' => [
                    'project' => [
                        'getters' => [
                            'getProject',
            ...
            'Delete' => [
                'method' => 'delete',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/compositeHealthChecks/{composite_health_check}',
                'placeholders' => [
            ...
            'TestIamPermissions' => [
                'method' => 'post',
                'uriTemplate' => '/compute/v1/projects/{project}/regions/{region}/compositeHealthChecks/{resource}/testIamPermissions',
