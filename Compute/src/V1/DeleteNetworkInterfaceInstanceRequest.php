 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.DeleteNetworkInterfaceInstanceRequest</code>
 */
class DeleteNetworkInterfaceInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string network_interface_name = 381342722 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $network_interface_name = '';
    /**
     ...
     * @experimental
     */
    public static function build(string $project, string $zone, string $instance, string $networkInterfaceName): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
    ...
    {
        return $this->network_interface_name;
    }
     ...
     * @return $this
     */
    public function setNetworkInterfaceName($var)
    {
        GPBUtil::checkString($var, True);
        $this->network_interface_name = $var;
