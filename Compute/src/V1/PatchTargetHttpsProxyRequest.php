 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchTargetHttpsProxyRequest</code>
 */
class PatchTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchTargetHttpsProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $targetHttpsProxy, \Google\Cloud\Compute\V1\TargetHttpsProxy $targetHttpsProxyResource): self
    {
        return (new self())
            ->setProject($project)
