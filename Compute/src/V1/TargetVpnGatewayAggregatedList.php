...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetVpnGatewayAggregatedList</code>
 */
class TargetVpnGatewayAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.TargetVpnGatewaysScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\TargetVpnGatewaysScopedList::class);
        $this->items = $arr;
