 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ReservationBlocksListResponse</code>
 */
class ReservationBlocksListResponse extends \Google\Protobuf\Internal\Message
{
    /**
