...
class SetNamedPortsInstanceGroupRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.InstanceGroupsSetNamedPortsRequest instance_groups_set_named_ports_request_resource = 385151535 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Compute\V1\InstanceGroupsSetNamedPortsRequest $instanceGroupsSetNamedPortsRequestResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetNamedPortsInstanceGroupRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instanceGroup, \Google\Cloud\Compute\V1\InstanceGroupsSetNamedPortsRequest $instanceGroupsSetNamedPortsRequestResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.InstanceGroupsSetNamedPortsRequest instance_groups_set_named_ports_request_resource = 385151535 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\InstanceGroupsSetNamedPortsRequest|null
     */
    ...
    public function hasInstanceGroupsSetNamedPortsRequestResource()
    {
        return isset($this->instance_groups_set_named_ports_request_resource);
    }

    public function clearInstanceGroupsSetNamedPortsRequestResource()
    {
        unset($this->instance_groups_set_named_ports_request_resource);
    }
