...
class HTTP2HealthCheck extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.compute.v1.HTTP2HealthCheck.PortSpecification port_specification = 51590597;</code>
     */
    private $port_specification = null;
    /**
     * Specifies the type of proxy header to append before sending data to the backend, either NONE or PROXY_V1. The default is NONE.
     *
     * Generated from protobuf field <code>optional .google.cloud.compute.v1.HTTP2HealthCheck.ProxyHeader proxy_header = 160374142;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\HTTP2HealthCheck\PortSpecification::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\HTTP2HealthCheck\ProxyHeader::class);
