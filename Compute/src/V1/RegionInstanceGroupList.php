 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RegionInstanceGroupList</code>
 */
class RegionInstanceGroupList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.InstanceGroup items = 100526016;</code>
     */
    private $items;
    /**
     * The resource type.
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\InstanceGroup[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of InstanceGroup resources.
     *     @type string $kind
     *           The resource type.
