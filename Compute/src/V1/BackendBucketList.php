 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.BackendBucketList</code>
 */
class BackendBucketList extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\BackendBucket[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of BackendBucket resources.
     *     @type string $kind
     *           Type of resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendBucket items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\BackendBucket[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
