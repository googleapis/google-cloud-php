...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RoutersListNamedSets</code>
 */
class RoutersListNamedSets extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NamedSet result = 139315229;</code>
     */
    private $result;
    /**
     ...
     *           Subsequent list requests will have their own nextPageToken to
     *           continue paging through the results.
     *     @type \Google\Cloud\Compute\V1\NamedSet[] $result
     *           [Output Only] A list of named sets.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NamedSet result = 139315229;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\NamedSet>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NamedSet::class);
        $this->result = $arr;
