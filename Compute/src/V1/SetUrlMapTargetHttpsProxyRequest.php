 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetUrlMapTargetHttpsProxyRequest</code>
 */
class SetUrlMapTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\SetUrlMapTargetHttpsProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $targetHttpsProxy, \Google\Cloud\Compute\V1\UrlMapReference $urlMapReferenceResource): self
    {
        return (new self())
            ->setProject($project)
