...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NotificationEndpointList</code>
 */
class NotificationEndpointList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NotificationEndpoint items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\NotificationEndpoint[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of NotificationEndpoint resources.
     *     @type string $kind
     *           [Output Only] Type of the resource. Always compute#notificationEndpoint for notification endpoints.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NotificationEndpoint items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\NotificationEndpoint[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NotificationEndpoint::class);
        $this->items = $arr;
