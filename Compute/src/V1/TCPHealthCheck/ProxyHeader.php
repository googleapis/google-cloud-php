 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.TCPHealthCheck.ProxyHeader</code>
 */
class ProxyHeader
{
    /**
...
class_alias(ProxyHeader::class, \Google\Cloud\Compute\V1\TCPHealthCheck_ProxyHeader::class);
