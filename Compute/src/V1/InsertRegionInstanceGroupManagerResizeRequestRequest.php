 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InsertRegionInstanceGroupManagerResizeRequestRequest</code>
 */
class InsertRegionInstanceGroupManagerResizeRequestRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\InsertRegionInstanceGroupManagerResizeRequestRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $instanceGroupManager, \Google\Cloud\Compute\V1\InstanceGroupManagerResizeRequest $instanceGroupManagerResizeRequestResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
