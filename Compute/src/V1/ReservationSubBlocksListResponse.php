 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ReservationSubBlocksListResponse</code>
 */
class ReservationSubBlocksListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ReservationSubBlock items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           Unique identifier for the resource; defined by the server.
     *     @type array<\Google\Cloud\Compute\V1\ReservationSubBlock>|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of reservation subBlock resources.
     *     @type string $kind
     *           Type of the resource. Always compute#reservationSubBlock for a list of reservation subBlocks.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ReservationSubBlock items = 100526016;</code>
     * @param array<\Google\Cloud\Compute\V1\ReservationSubBlock>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\ReservationSubBlock::class);
        $this->items = $arr;
