...
class Firewall extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.compute.v1.FirewallParams params = 78313862;</code>
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\FirewallParams::class);
        $this->params = $var;
