...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.VmExtensionPolicyList</code>
 */
class VmExtensionPolicyList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.VmExtensionPolicy items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           Output only. [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\VmExtensionPolicy[] $items
     *           Output only. [Output Only] A list of VM extension policy resources.
     *     @type string $kind
     *           Output only. Type of resource.
