 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchNodeGroupRequest</code>
 */
class PatchNodeGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchNodeGroupRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $nodeGroup, \Google\Cloud\Compute\V1\NodeGroup $nodeGroupResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
