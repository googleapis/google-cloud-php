 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InsertRegionBackendBucketRequest</code>
 */
class InsertRegionBackendBucketRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\InsertRegionBackendBucketRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, \Google\Cloud\Compute\V1\BackendBucket $backendBucketResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
