 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.MachineTypeList</code>
 */
class MachineTypeList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.MachineType items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\MachineType[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of MachineType resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#machineTypeList for lists of machine types.
