...
class BackendServiceCdnPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.BackendServiceCdnPolicy.CacheMode cache_mode = 28877888;</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool negative_caching = 336110005;</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool request_coalescing = 532808276;</code>
     */
     ...
     *
     * Generated from protobuf field <code>int32 serve_while_stale = 236682203;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Compute\V1\BackendServiceCdnPolicyBypassCacheOnRequestHeader[]|\Google\Protobuf\Internal\RepeatedField $bypass_cache_on_request_headers
     *           Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
     ...
     *           Negative caching allows per-status code TTLs to be set, in order to apply fine-grained caching for common errors or redirects. This can reduce the load on your origin and improve end-user experience by reducing response latency. When the cache mode is set to CACHE_ALL_STATIC or USE_ORIGIN_HEADERS, negative caching applies to responses with the specified response code that lack any Cache-Control, Expires, or Pragma: no-cache directives. When the cache mode is set to FORCE_CACHE_ALL, negative caching applies to all responses with the specified response code, and override any caching headers. By default, Cloud CDN will apply the following default TTLs to these status codes: HTTP 300 (Multiple Choice), 301, 308 (Permanent Redirects): 10m HTTP 404 (Not Found), 410 (Gone), 451 (Unavailable For Legal Reasons): 120s HTTP 405 (Method Not Found), 421 (Misdirected Request), 501 (Not Implemented): 60s. These defaults can be overridden in negative_caching_policy.
     *     @type \Google\Cloud\Compute\V1\BackendServiceCdnPolicyNegativeCachingPolicy[]|\Google\Protobuf\Internal\RepeatedField $negative_caching_policy
     *           Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyBypassCacheOnRequestHeader bypass_cache_on_request_headers = 486203082;</code>
     * @param \Google\Cloud\Compute\V1\BackendServiceCdnPolicyBypassCacheOnRequestHeader[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.BackendServiceCdnPolicyNegativeCachingPolicy negative_caching_policy = 155359996;</code>
     * @param \Google\Cloud\Compute\V1\BackendServiceCdnPolicyNegativeCachingPolicy[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
