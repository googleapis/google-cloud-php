...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetTcpProxyAggregatedList</code>
 */
class TargetTcpProxyAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.TargetTcpProxiesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\TargetTcpProxiesScopedList::class);
        $this->items = $arr;
