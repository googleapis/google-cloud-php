 ...
 *     $project = 'project';
 *     $operationResponse = $interconnectAttachmentGroupsClient->delete($interconnectAttachmentGroup, $project);
 ...
 *     // ... do other work
 *     $newOperationResponse = $interconnectAttachmentGroupsClient->resumeOperation($operationName, 'delete');
 ...
 *     }
 * } finally {
 *     $interconnectAttachmentGroupsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InterconnectAttachmentGroupsClient}.
 */
class InterconnectAttachmentGroupsGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectAttachmentGroups';
     ...
     * ```
     *
     * @param string $interconnectAttachmentGroup Name of the InterconnectAttachmentGroup resource to delete.
     ...
     */
    public function delete($interconnectAttachmentGroup, $project, array $optionalArgs = [])
    {
        $request = new DeleteInterconnectAttachmentGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectAttachmentGroup($interconnectAttachmentGroup);
        $request->setProject($project);
        $requestParamHeaders['interconnect_attachment_group'] = $interconnectAttachmentGroup;
     ...
     *     $interconnectAttachmentGroup = 'interconnect_attachment_group';
     *     $project = 'project';
     *     $response = $interconnectAttachmentGroupsClient->get($interconnectAttachmentGroup, $project);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($interconnectAttachmentGroup, $project, array $optionalArgs = [])
    {
        $request = new GetInterconnectAttachmentGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectAttachmentGroup($interconnectAttachmentGroup);
        $request->setProject($project);
        $requestParamHeaders['interconnect_attachment_group'] = $interconnectAttachmentGroup;
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', InterconnectAttachmentGroup::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $interconnectAttachmentGroupsClient->getIamPolicy($project, $resource);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
     ...
     *     $interconnectAttachmentGroup = 'interconnect_attachment_group';
     *     $project = 'project';
     *     $response = $interconnectAttachmentGroupsClient->getOperationalStatus($interconnectAttachmentGroup, $project);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function getOperationalStatus($interconnectAttachmentGroup, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetOperationalStatus', InterconnectAttachmentGroupsGetOperationalStatusResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $operationResponse = $interconnectAttachmentGroupsClient->insert($interconnectAttachmentGroupResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentGroupsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * ```
     *
     * @param InterconnectAttachmentGroup $interconnectAttachmentGroupResource The body resource for this request
     * @param string                      $project                             Project ID for this request.
     * @param array                       $optionalArgs                        {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($interconnectAttachmentGroupResource, $project, array $optionalArgs = [])
    {
        $request = new InsertInterconnectAttachmentGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectAttachmentGroupResource($interconnectAttachmentGroupResource);
        $request->setProject($project);
        $requestParamHeaders['project'] = $project;
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
     ...
     * try {
     *     $project = 'project';
     *     $response = $interconnectAttachmentGroupsClient->list($project);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('List', InterconnectAttachmentGroupsListResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $interconnectAttachmentGroupResource = new InterconnectAttachmentGroup();
     *     $project = 'project';
     *     $operationResponse = $interconnectAttachmentGroupsClient->patch($interconnectAttachmentGroup, $interconnectAttachmentGroupResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectAttachmentGroupsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($interconnectAttachmentGroup, $interconnectAttachmentGroupResource, $project, array $optionalArgs = [])
    {
        $request = new PatchInterconnectAttachmentGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectAttachmentGroup($interconnectAttachmentGroup);
        $request->setInterconnectAttachmentGroupResource($interconnectAttachmentGroupResource);
        $request->setProject($project);
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $interconnectAttachmentGroupsClient->setIamPolicy($globalSetPolicyRequestResource, $project, $resource);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
     ...
     *     $response = $interconnectAttachmentGroupsClient->testIamPermissions($project, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $interconnectAttachmentGroupsClient->close();
     * }
     * ```
    ...
    {
        $request = new TestIamPermissionsInterconnectAttachmentGroupRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setResource($resource);
