 ...
 *     $pagedResponse = $machineTypesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\MachineTypesClient}.
 */
class MachineTypesGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['machineType'])) {
            ...
            $requestParamHeaders['machine_type'] = $optionalArgs['machineType'];
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $machineTypesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
