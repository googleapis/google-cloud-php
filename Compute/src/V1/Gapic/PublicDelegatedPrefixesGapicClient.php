 ...
 *     $pagedResponse = $publicDelegatedPrefixesClient->aggregatedList();
...
class PublicDelegatedPrefixesGapicClient
{
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $operationResponse = $publicDelegatedPrefixesClient->announce();
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $operationResponse = $publicDelegatedPrefixesClient->delete();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $response = $publicDelegatedPrefixesClient->get();
     * } finally {
     *     $publicDelegatedPrefixesClient->close();
     * }
     * ```
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $operationResponse = $publicDelegatedPrefixesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $publicDelegatedPrefixesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $operationResponse = $publicDelegatedPrefixesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $publicDelegatedPrefixesClient = new PublicDelegatedPrefixesClient();
     * try {
     *     $operationResponse = $publicDelegatedPrefixesClient->withdraw();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
