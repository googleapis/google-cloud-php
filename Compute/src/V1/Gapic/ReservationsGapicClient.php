 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\ReservationsClient}.
 */
class ReservationsGapicClient
{
     ...
     *     $zone = 'zone';
     *     $operationResponse = $reservationsClient->delete($project, $reservation, $zone);
     ...
     *     // ... do other work
     *     $newOperationResponse = $reservationsClient->resumeOperation($operationName, 'delete');
     ...
     *     $zone = 'zone';
     *     $operationResponse = $reservationsClient->insert($project, $reservationResource, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $reservationsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $zone = 'zone';
     *     $operationResponse = $reservationsClient->resize($project, $reservation, $reservationsResizeRequestResource, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $reservationsClient->resumeOperation($operationName, 'resize');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     $reservationResource = new Reservation();
     *     $zone = 'zone';
     *     $operationResponse = $reservationsClient->update($project, $reservation, $reservationResource, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $reservationsClient->resumeOperation($operationName, 'update');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function update($project, $reservation, $reservationResource, $zone, array $optionalArgs = [])
    {
