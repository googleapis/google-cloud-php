 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InterconnectLocationsClient}.
 */
class InterconnectLocationsGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['interconnectLocation'])) {
            ...
            $requestParamHeaders['interconnect_location'] = $optionalArgs['interconnectLocation'];
        }
     ...
     *     $pagedResponse = $interconnectLocationsClient->list();
