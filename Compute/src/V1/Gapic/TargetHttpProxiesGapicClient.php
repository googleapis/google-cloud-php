 ...
 *     $pagedResponse = $targetHttpProxiesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\TargetHttpProxiesClient}.
 */
class TargetHttpProxiesGapicClient
{
     ...
     * $targetHttpProxiesClient = new TargetHttpProxiesClient();
     * try {
     *     $operationResponse = $targetHttpProxiesClient->delete();
     ...
     * $targetHttpProxiesClient = new TargetHttpProxiesClient();
     * try {
     *     $operationResponse = $targetHttpProxiesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $targetHttpProxiesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $targetHttpProxiesClient = new TargetHttpProxiesClient();
     * try {
     *     $operationResponse = $targetHttpProxiesClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $targetHttpProxiesClient = new TargetHttpProxiesClient();
     * try {
     *     $operationResponse = $targetHttpProxiesClient->setUrlMap();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
