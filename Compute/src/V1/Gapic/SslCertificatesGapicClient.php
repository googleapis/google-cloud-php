 ...
 *     $pagedResponse = $sslCertificatesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\SslCertificatesClient}.
 */
class SslCertificatesGapicClient
{
     ...
     * $sslCertificatesClient = new SslCertificatesClient();
     * try {
     *     $operationResponse = $sslCertificatesClient->delete();
     ...
     * $sslCertificatesClient = new SslCertificatesClient();
     * try {
     *     $operationResponse = $sslCertificatesClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $sslCertificatesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
