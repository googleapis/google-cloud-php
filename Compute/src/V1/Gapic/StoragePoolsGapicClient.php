 ...
 *     $pagedResponse = $storagePoolsClient->aggregatedList($project);
 ...
 *     }
 * } finally {
 *     $storagePoolsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\StoragePoolsClient}.
 */
class StoragePoolsGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.StoragePools';
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, StoragePoolAggregatedList::class, $request);
    }
     ...
     *     $zone = 'zone';
     *     $operationResponse = $storagePoolsClient->delete($project, $storagePool, $zone);
     ...
     *     // ... do other work
     *     $newOperationResponse = $storagePoolsClient->resumeOperation($operationName, 'delete');
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $storagePool, $zone, array $optionalArgs = [])
    {
        $request = new DeleteStoragePoolRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setStoragePool($storagePool);
        $request->setZone($zone);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['storage_pool'] = $storagePool;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $storagePool, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', StoragePool::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $zone = 'zone';
     *     $operationResponse = $storagePoolsClient->insert($project, $storagePoolResource, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $storagePoolsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *
     * @param string      $project             Project ID for this request.
     * @param StoragePool $storagePoolResource The body resource for this request
     * @param string      $zone                The name of the zone for this request.
     * @param array       $optionalArgs        {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($project, $storagePoolResource, $zone, array $optionalArgs = [])
    {
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('List', StoragePoolList::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listDisks($project, $storagePool, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('ListDisks', StoragePoolListDisks::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $response = $storagePoolsClient->setIamPolicy($project, $resource, $zone, $zoneSetPolicyRequestResource);
     * } finally {
     *     $storagePoolsClient->close();
     * }
     * ```
     ...
     *     $zone = 'zone';
     *     $response = $storagePoolsClient->testIamPermissions($project, $resource, $testPermissionsRequestResource, $zone);
     * } finally {
     *     $storagePoolsClient->close();
     * }
     * ```
     ...
     *     $storagePoolResource = new StoragePool();
     *     $zone = 'zone';
     *     $operationResponse = $storagePoolsClient->update($project, $storagePool, $storagePoolResource, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $storagePoolsClient->resumeOperation($operationName, 'update');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function update($project, $storagePool, $storagePoolResource, $zone, array $optionalArgs = [])
    {
