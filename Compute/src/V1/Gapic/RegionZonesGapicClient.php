 ...
 *     $pagedResponse = $regionZonesClient->list($project, $region);
 ...
 *     }
 * } finally {
 *     $regionZonesClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\RegionZonesClient}.
 */
class RegionZonesGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionZones';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_zones_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_zones_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_zones_rest_client_config.php',
                ],
            ],
        ];
    }
