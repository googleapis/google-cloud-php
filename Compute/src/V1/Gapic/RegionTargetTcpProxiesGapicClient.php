 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\RegionTargetTcpProxiesClient}.
 */
class RegionTargetTcpProxiesGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionTargetTcpProxies';
