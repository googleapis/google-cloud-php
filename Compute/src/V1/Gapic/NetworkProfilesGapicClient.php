 ...
 * } finally {
 *     $networkProfilesClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\NetworkProfilesClient}.
 */
class NetworkProfilesGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.NetworkProfiles';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/network_profiles_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/network_profiles_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/network_profiles_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public function get($networkProfile, $project, array $optionalArgs = [])
    {
        $request = new GetNetworkProfileRequest();
        $requestParamHeaders = [];
        $request->setNetworkProfile($networkProfile);
        $request->setProject($project);
        $requestParamHeaders['network_profile'] = $networkProfile;
        $requestParamHeaders['project'] = $project;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', NetworkProfile::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('List', NetworkProfilesListResponse::class, $optionalArgs, $request)->wait();
    }
}
