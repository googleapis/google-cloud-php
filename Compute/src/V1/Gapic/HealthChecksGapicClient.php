 ...
 *     $pagedResponse = $healthChecksClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\HealthChecksClient}.
 */
class HealthChecksGapicClient
{
     ...
     * $healthChecksClient = new HealthChecksClient();
     * try {
     *     $operationResponse = $healthChecksClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['healthCheck'])) {
            ...
            $requestParamHeaders['health_check'] = $optionalArgs['healthCheck'];
        }
     ...
     * $healthChecksClient = new HealthChecksClient();
     * try {
     *     $response = $healthChecksClient->get();
     * } finally {
     *     $healthChecksClient->close();
     * }
     * ```
     ...
     * $healthChecksClient = new HealthChecksClient();
     * try {
     *     $operationResponse = $healthChecksClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $healthChecksClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $healthChecksClient = new HealthChecksClient();
     * try {
     *     $operationResponse = $healthChecksClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $healthChecksClient = new HealthChecksClient();
     * try {
     *     $operationResponse = $healthChecksClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
