 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\RegionDiskTypesClient}.
 */
class RegionDiskTypesGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['diskType'])) {
            ...
            $requestParamHeaders['disk_type'] = $optionalArgs['diskType'];
        }
     ...
     *     $pagedResponse = $regionDiskTypesClient->list();
