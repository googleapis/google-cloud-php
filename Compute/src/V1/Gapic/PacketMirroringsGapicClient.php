...
class PacketMirroringsGapicClient
{
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $packetMirroringsClient->delete($packetMirroring, $project, $region);
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $packetMirroringsClient->insert($packetMirroringResource, $project, $region);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $packetMirroringsClient->patch($packetMirroring, $packetMirroringResource, $project, $region);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
