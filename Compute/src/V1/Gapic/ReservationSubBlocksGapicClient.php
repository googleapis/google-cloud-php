 ...
 *     $zone = 'zone';
 *     $response = $reservationSubBlocksClient->get($parentName, $project, $reservationSubBlock, $zone);
 * } finally {
 *     $reservationSubBlocksClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\ReservationSubBlocksClient}.
 */
class ReservationSubBlocksGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.ReservationSubBlocks';
     ...
     */
    public function get($parentName, $project, $reservationSubBlock, $zone, array $optionalArgs = [])
    {
        $request = new GetReservationSubBlockRequest();
        $requestParamHeaders = [];
        $request->setParentName($parentName);
        $request->setProject($project);
        $request->setReservationSubBlock($reservationSubBlock);
        $request->setZone($zone);
        $requestParamHeaders['parent_name'] = $parentName;
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['reservation_sub_block'] = $reservationSubBlock;
        $requestParamHeaders['zone'] = $zone;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', ReservationSubBlocksGetResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $pagedResponse = $reservationSubBlocksClient->list($parentName, $project, $zone);
     ...
     * @throws ApiException if the remote call fails
     */
    public function list($parentName, $project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, ReservationSubBlocksListResponse::class, $request);
    }
     ...
     *     $reservationSubBlock = 'reservation_sub_block';
     *     $zone = 'zone';
     *     $operationResponse = $reservationSubBlocksClient->performMaintenance($parentName, $project, $reservationSubBlock, $zone);
     ...
     *     // ... do other work
     *     $newOperationResponse = $reservationSubBlocksClient->resumeOperation($operationName, 'performMaintenance');
     ...
     * @throws ApiException if the remote call fails
     */
    public function performMaintenance($parentName, $project, $reservationSubBlock, $zone, array $optionalArgs = [])
    {
