 ...
 *     $pagedResponse = $diskTypesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\DiskTypesClient}.
 */
class DiskTypesGapicClient
{
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $diskTypesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
