 ...
 *     $pagedResponse = $serviceAttachmentsClient->aggregatedList($project);
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\ServiceAttachmentsClient}.
 */
class ServiceAttachmentsGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.compute.v1.ServiceAttachments';
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, ServiceAttachmentAggregatedList::class, $request);
    }
     ...
     *     $operationResponse = $serviceAttachmentsClient->delete($project, $region, $serviceAttachment);
     ...
     *     // ... do other work
     *     $newOperationResponse = $serviceAttachmentsClient->resumeOperation($operationName, 'delete');
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $region, $serviceAttachment, array $optionalArgs = [])
    {
        $request = new DeleteServiceAttachmentRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $request->setServiceAttachment($serviceAttachment);
        $requestParamHeaders['project'] = $project;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $region, $serviceAttachment, array $optionalArgs = [])
    {
     ...
     *     $region = 'region';
     *     $resource = 'resource';
     *     $response = $serviceAttachmentsClient->getIamPolicy($project, $region, $resource);
     * } finally {
     *     $serviceAttachmentsClient->close();
     * }
     * ```
     ...
     *     $operationResponse = $serviceAttachmentsClient->insert($project, $region, $serviceAttachmentResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $serviceAttachmentsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @param string            $project                   Project ID for this request.
     * @param string            $region                    Name of the region of this request.
     * @param ServiceAttachment $serviceAttachmentResource The body resource for this request
     * @param array             $optionalArgs              {
     *     Optional.
     *
     *     @type string $requestId
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($project, $region, $serviceAttachmentResource, array $optionalArgs = [])
    {
        $request = new InsertServiceAttachmentRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $request->setServiceAttachmentResource($serviceAttachmentResource);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
     ...
     *     $region = 'region';
     *     // Iterate over pages of elements
     *     $pagedResponse = $serviceAttachmentsClient->list($project, $region);
     *     foreach ($pagedResponse->iteratePages() as $page) {
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, ServiceAttachmentList::class, $request);
    }
     ...
     *     $serviceAttachment = 'service_attachment';
     *     $serviceAttachmentResource = new ServiceAttachment();
     *     $operationResponse = $serviceAttachmentsClient->patch($project, $region, $serviceAttachment, $serviceAttachmentResource);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $serviceAttachmentsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($project, $region, $serviceAttachment, $serviceAttachmentResource, array $optionalArgs = [])
    {
     ...
     *     $resource = 'resource';
     *     $response = $serviceAttachmentsClient->setIamPolicy($project, $region, $regionSetPolicyRequestResource, $resource);
     * } finally {
     *     $serviceAttachmentsClient->close();
     * }
     * ```
     ...
     *     $response = $serviceAttachmentsClient->testIamPermissions($project, $region, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $serviceAttachmentsClient->close();
     * }
     * ```
