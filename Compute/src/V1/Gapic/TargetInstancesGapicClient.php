...
class TargetInstancesGapicClient
{
     ...
     *     $targetInstance = 'target_instance';
     *     $zone = 'zone';
     *     $operationResponse = $targetInstancesClient->setSecurityPolicy($project, $securityPolicyReferenceResource, $targetInstance, $zone);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * @throws ApiException if the remote call fails
     */
    public function setSecurityPolicy($project, $securityPolicyReferenceResource, $targetInstance, $zone, array $optionalArgs = [])
    {
     ...
     *     $zone = 'zone';
     *     $response = $targetInstancesClient->testIamPermissions($project, $resource, $testPermissionsRequestResource, $zone);
     * } finally {
     *     $targetInstancesClient->close();
     * }
     * ```
