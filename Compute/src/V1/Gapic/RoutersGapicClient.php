 ...
 *     $pagedResponse = $routersClient->aggregatedList();
...
class RoutersGapicClient
{
     ...
     * $routersClient = new RoutersClient();
     * try {
     *     $operationResponse = $routersClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['router'])) {
            ...
            $requestParamHeaders['router'] = $optionalArgs['router'];
        }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getNatIpInfo(array $optionalArgs = [])
    {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $routersClient->getNatMappingInfo();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $routersClient = new RoutersClient();
     * try {
     *     $operationResponse = $routersClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $routersClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * $routersClient = new RoutersClient();
     * try {
     *     $operationResponse = $routersClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $routersClient = new RoutersClient();
     * try {
     *     $operationResponse = $routersClient->update();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
