 ...
 *     $pagedResponse = $globalOperationsClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\GlobalOperationsClient}.
 */
class GlobalOperationsGapicClient
{
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $globalOperationsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
