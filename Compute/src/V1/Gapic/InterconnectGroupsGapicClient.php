 ...
 *     $project = 'project';
 *     $operationResponse = $interconnectGroupsClient->createMembers($interconnectGroup, $interconnectGroupsCreateMembersRequestResource, $project);
 ...
 *     // ... do other work
 *     $newOperationResponse = $interconnectGroupsClient->resumeOperation($operationName, 'createMembers');
 ...
 *     }
 * } finally {
 *     $interconnectGroupsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\InterconnectGroupsClient}.
 */
class InterconnectGroupsGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectGroups';
     ...
     * @param InterconnectGroupsCreateMembersRequest $interconnectGroupsCreateMembersRequestResource The body resource for this request
     ...
     */
    public function createMembers($interconnectGroup, $interconnectGroupsCreateMembersRequestResource, $project, array $optionalArgs = [])
    {
        $request = new CreateMembersInterconnectGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectGroup($interconnectGroup);
        $request->setInterconnectGroupsCreateMembersRequestResource($interconnectGroupsCreateMembersRequestResource);
        $request->setProject($project);
        $requestParamHeaders['interconnect_group'] = $interconnectGroup;
        $requestParamHeaders['project'] = $project;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('CreateMembers', $optionalArgs, $request, $this->getOperationsClient(), null, Operation::class)->wait();
    }
     ...
     *     $interconnectGroup = 'interconnect_group';
     *     $project = 'project';
     *     $operationResponse = $interconnectGroupsClient->delete($interconnectGroup, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectGroupsClient->resumeOperation($operationName, 'delete');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($interconnectGroup, $project, array $optionalArgs = [])
    {
     ...
     *     $interconnectGroup = 'interconnect_group';
     *     $project = 'project';
     *     $response = $interconnectGroupsClient->get($interconnectGroup, $project);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($interconnectGroup, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', InterconnectGroup::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $interconnectGroupsClient->getIamPolicy($project, $resource);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
     ...
     *     $interconnectGroup = 'interconnect_group';
     *     $project = 'project';
     *     $response = $interconnectGroupsClient->getOperationalStatus($interconnectGroup, $project);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function getOperationalStatus($interconnectGroup, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetOperationalStatus', InterconnectGroupsGetOperationalStatusResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $operationResponse = $interconnectGroupsClient->insert($interconnectGroupResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectGroupsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * ```
     *
     * @param InterconnectGroup $interconnectGroupResource The body resource for this request
     * @param string            $project                   Project ID for this request.
     * @param array             $optionalArgs              {
     *     Optional.
     *
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($interconnectGroupResource, $project, array $optionalArgs = [])
    {
        $request = new InsertInterconnectGroupRequest();
        $requestParamHeaders = [];
        $request->setInterconnectGroupResource($interconnectGroupResource);
        $request->setProject($project);
        $requestParamHeaders['project'] = $project;
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
     ...
     * try {
     *     $project = 'project';
     *     $response = $interconnectGroupsClient->list($project);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('List', InterconnectGroupsListResponse::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $interconnectGroupResource = new InterconnectGroup();
     *     $project = 'project';
     *     $operationResponse = $interconnectGroupsClient->patch($interconnectGroup, $interconnectGroupResource, $project);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $interconnectGroupsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($interconnectGroup, $interconnectGroupResource, $project, array $optionalArgs = [])
    {
     ...
     *     $project = 'project';
     *     $resource = 'resource';
     *     $response = $interconnectGroupsClient->setIamPolicy($globalSetPolicyRequestResource, $project, $resource);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
     ...
     *     $response = $interconnectGroupsClient->testIamPermissions($project, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $interconnectGroupsClient->close();
     * }
     * ```
