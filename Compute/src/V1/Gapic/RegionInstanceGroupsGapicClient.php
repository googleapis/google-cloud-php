 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\RegionInstanceGroupsClient}.
 */
class RegionInstanceGroupsGapicClient
{
     ...
     *     $response = $regionInstanceGroupsClient->testIamPermissions($project, $region, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $regionInstanceGroupsClient->close();
     * }
     * ```
