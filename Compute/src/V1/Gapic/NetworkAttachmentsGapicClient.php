 ...
 *     $pagedResponse = $networkAttachmentsClient->aggregatedList();
...
class NetworkAttachmentsGapicClient
{
     ...
     * $networkAttachmentsClient = new NetworkAttachmentsClient();
     * try {
     *     $operationResponse = $networkAttachmentsClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['networkAttachment'])) {
            $request->setNetworkAttachment($optionalArgs['networkAttachment']);
            $requestParamHeaders['network_attachment'] = $optionalArgs['networkAttachment'];
        }
     ...
     * $networkAttachmentsClient = new NetworkAttachmentsClient();
     * try {
     *     $operationResponse = $networkAttachmentsClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     Optional.
     *
     *     @type NetworkAttachment $networkAttachmentResource
    ...
    public function insert(array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        if (isset($optionalArgs['networkAttachmentResource'])) {
            $request->setNetworkAttachmentResource($optionalArgs['networkAttachmentResource']);
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $networkAttachmentsClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $networkAttachmentsClient = new NetworkAttachmentsClient();
     * try {
     *     $operationResponse = $networkAttachmentsClient->patch();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * $networkAttachmentsClient = new NetworkAttachmentsClient();
     * try {
     *     $response = $networkAttachmentsClient->setIamPolicy();
     * } finally {
     *     $networkAttachmentsClient->close();
     * }
     * ```
