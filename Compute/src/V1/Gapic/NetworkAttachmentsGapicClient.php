...
use Google\Cloud\Compute\V1\NetworkAttachmentAggregatedList;
use Google\Cloud\Compute\V1\NetworkAttachmentList;
 ...
 *     $pagedResponse = $networkAttachmentsClient->aggregatedList($project);
 ...
 *     }
 * } finally {
 *     $networkAttachmentsClient->close();
 * }
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\NetworkAttachmentsClient}.
 */
class NetworkAttachmentsGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.compute.v1.NetworkAttachments';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/network_attachments_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/network_attachments_descriptor_config.php',
            'credentialsConfig' => [
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, NetworkAttachmentAggregatedList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $networkAttachmentsClient->delete($networkAttachment, $project, $region);
     ...
     *     // ... do other work
     *     $newOperationResponse = $networkAttachmentsClient->resumeOperation($operationName, 'delete');
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($networkAttachment, $project, $region, array $optionalArgs = [])
    {
        $request = new DeleteNetworkAttachmentRequest();
        $requestParamHeaders = [];
        $request->setNetworkAttachment($networkAttachment);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['network_attachment'] = $networkAttachment;
        $requestParamHeaders['project'] = $project;
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($networkAttachment, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', NetworkAttachment::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $networkAttachmentsClient->insert($networkAttachmentResource, $project, $region);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $networkAttachmentsClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * ```
     *
     * @param NetworkAttachment $networkAttachmentResource The body resource for this request
     * @param string            $project                   Project ID for this request.
     * @param string            $region                    Name of the region of this request.
     * @param array             $optionalArgs              {
     *     Optional.
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($networkAttachmentResource, $project, $region, array $optionalArgs = [])
    {
        $request = new InsertNetworkAttachmentRequest();
        $requestParamHeaders = [];
        $request->setNetworkAttachmentResource($networkAttachmentResource);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
     ...
     *     $region = 'region';
     *     // Iterate over pages of elements
     *     $pagedResponse = $networkAttachmentsClient->list($project, $region);
     *     foreach ($pagedResponse->iteratePages() as $page) {
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, NetworkAttachmentList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $operationResponse = $networkAttachmentsClient->patch($networkAttachment, $networkAttachmentResource, $project, $region);
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $networkAttachmentsClient->resumeOperation($operationName, 'patch');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($networkAttachment, $networkAttachmentResource, $project, $region, array $optionalArgs = [])
    {
     ...
     *     $resource = 'resource';
     *     $response = $networkAttachmentsClient->setIamPolicy($project, $region, $regionSetPolicyRequestResource, $resource);
     * } finally {
     *     $networkAttachmentsClient->close();
     * }
     * ```
    ...
    {
        $request = new SetIamPolicyNetworkAttachmentRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
     ...
     *     $response = $networkAttachmentsClient->testIamPermissions($project, $region, $resource, $testPermissionsRequestResource);
     * } finally {
     *     $networkAttachmentsClient->close();
     * }
     * ```
