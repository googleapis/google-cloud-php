 ...
 *     $pagedResponse = $acceleratorTypesClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\AcceleratorTypesClient}.
 */
class AcceleratorTypesGapicClient
{
    ...
    public function get(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['acceleratorType'])) {
            ...
            $requestParamHeaders['accelerator_type'] = $optionalArgs['acceleratorType'];
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $acceleratorTypesClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
