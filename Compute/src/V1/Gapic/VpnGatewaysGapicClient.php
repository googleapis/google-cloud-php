 ...
 *     $pagedResponse = $vpnGatewaysClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\VpnGatewaysClient}.
 */
class VpnGatewaysGapicClient
{
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $operationResponse = $vpnGatewaysClient->delete();
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['vpnGateway'])) {
            $request->setVpnGateway($optionalArgs['vpnGateway']);
            $requestParamHeaders['vpn_gateway'] = $optionalArgs['vpnGateway'];
        }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getStatus(array $optionalArgs = [])
    {
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $operationResponse = $vpnGatewaysClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $vpnGatewaysClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $vpnGatewaysClient = new VpnGatewaysClient();
     * try {
     *     $operationResponse = $vpnGatewaysClient->setLabels();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
