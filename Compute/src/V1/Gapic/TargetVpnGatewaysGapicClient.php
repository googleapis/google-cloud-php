 ...
 *     $pagedResponse = $targetVpnGatewaysClient->aggregatedList();
 ...
 * ```
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Compute\V1\Client\TargetVpnGatewaysClient}.
 */
class TargetVpnGatewaysGapicClient
{
     ...
     * $targetVpnGatewaysClient = new TargetVpnGatewaysClient();
     * try {
     *     $operationResponse = $targetVpnGatewaysClient->delete();
     ...
     *     // ... do other work
     *     $newOperationResponse = $targetVpnGatewaysClient->resumeOperation($operationName, 'delete');
    ...
    public function delete(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetVpnGateway'])) {
            $request->setTargetVpnGateway($optionalArgs['targetVpnGateway']);
            $requestParamHeaders['target_vpn_gateway'] = $optionalArgs['targetVpnGateway'];
        }
     ...
     * $targetVpnGatewaysClient = new TargetVpnGatewaysClient();
     * try {
     *     $operationResponse = $targetVpnGatewaysClient->insert();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $targetVpnGatewaysClient->resumeOperation($operationName, 'insert');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
     ...
     *     @type string $requestId
     *           An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
     *     @type TargetVpnGateway $targetVpnGatewayResource
    ...
    public function insert(array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['targetVpnGatewayResource'])) {
            $request->setTargetVpnGatewayResource($optionalArgs['targetVpnGatewayResource']);
        }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $targetVpnGatewaysClient->list();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     ...
     * $targetVpnGatewaysClient = new TargetVpnGatewaysClient();
     * try {
     *     $operationResponse = $targetVpnGatewaysClient->setLabels();
     *     $operationResponse->pollUntilComplete();
     *     if ($operationResponse->operationSucceeded()) {
     *         // if creating/modifying, retrieve the target resource
     *     } else {
     ...
     *     $operationName = $operationResponse->getName();
     *     // ... do other work
     *     $newOperationResponse = $targetVpnGatewaysClient->resumeOperation($operationName, 'setLabels');
     *     while (!$newOperationResponse->isDone()) {
     *         // ... do other work
     *         $newOperationResponse->reload();
     *     }
