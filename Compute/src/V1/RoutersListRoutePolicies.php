...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RoutersListRoutePolicies</code>
 */
class RoutersListRoutePolicies extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\RoutePolicy::class);
        $this->result = $arr;
