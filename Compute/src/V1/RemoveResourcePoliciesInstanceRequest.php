 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RemoveResourcePoliciesInstanceRequest</code>
 */
class RemoveResourcePoliciesInstanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $instances_remove_resource_policies_request_resource = null;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.InstancesRemoveResourcePoliciesRequest instances_remove_resource_policies_request_resource = 49229558 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\InstancesRemoveResourcePoliciesRequest|null
     */
    public function getInstancesRemoveResourcePoliciesRequestResource()
    {
        return isset($this->instances_remove_resource_policies_request_resource) ? $this->instances_remove_resource_policies_request_resource : null;
    }
    ...
    public function clearInstancesRemoveResourcePoliciesRequestResource()
    {
        unset($this->instances_remove_resource_policies_request_resource);
    }
     ...
     * @return $this
     */
    public function setInstancesRemoveResourcePoliciesRequestResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\InstancesRemoveResourcePoliciesRequest::class);
        $this->instances_remove_resource_policies_request_resource = $var;
