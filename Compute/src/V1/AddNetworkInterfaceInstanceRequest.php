 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.AddNetworkInterfaceInstanceRequest</code>
 */
class AddNetworkInterfaceInstanceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $project, string $zone, string $instance, \Google\Cloud\Compute\V1\NetworkInterface $networkInterfaceResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
