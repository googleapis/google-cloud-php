 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetBackendServiceTargetTcpProxyRequest</code>
 */
class SetBackendServiceTargetTcpProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $target_tcp_proxies_set_backend_service_request_resource = null;
    /**
    ...
    {
        return isset($this->target_tcp_proxies_set_backend_service_request_resource) ? $this->target_tcp_proxies_set_backend_service_request_resource : null;
    }

    public function hasTargetTcpProxiesSetBackendServiceRequestResource()
    {
        return isset($this->target_tcp_proxies_set_backend_service_request_resource);
    }

    public function clearTargetTcpProxiesSetBackendServiceRequestResource()
    {
        unset($this->target_tcp_proxies_set_backend_service_request_resource);
    }
     ...
     * @return $this
     */
    public function setTargetTcpProxiesSetBackendServiceRequestResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\TargetTcpProxiesSetBackendServiceRequest::class);
        $this->target_tcp_proxies_set_backend_service_request_resource = $var;
