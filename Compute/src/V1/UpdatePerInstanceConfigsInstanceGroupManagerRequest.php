 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.UpdatePerInstanceConfigsInstanceGroupManagerRequest</code>
 */
class UpdatePerInstanceConfigsInstanceGroupManagerRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $instance_group_managers_update_per_instance_configs_req_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\InstanceGroupManagersUpdatePerInstanceConfigsReq $instanceGroupManagersUpdatePerInstanceConfigsReqResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\UpdatePerInstanceConfigsInstanceGroupManagerRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instanceGroupManager, \Google\Cloud\Compute\V1\InstanceGroupManagersUpdatePerInstanceConfigsReq $instanceGroupManagersUpdatePerInstanceConfigsReqResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
    ...
    {
        return $this->instance_group_managers_update_per_instance_configs_req_resource;
    }

    public function hasInstanceGroupManagersUpdatePerInstanceConfigsReqResource()
    {
        return isset($this->instance_group_managers_update_per_instance_configs_req_resource);
    }

    public function clearInstanceGroupManagersUpdatePerInstanceConfigsReqResource()
    {
        unset($this->instance_group_managers_update_per_instance_configs_req_resource);
    }
     ...
     * @return $this
     */
    public function setInstanceGroupManagersUpdatePerInstanceConfigsReqResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\InstanceGroupManagersUpdatePerInstanceConfigsReq::class);
        $this->instance_group_managers_update_per_instance_configs_req_resource = $var;
