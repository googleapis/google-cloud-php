 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.VpnGatewayList</code>
 */
class VpnGatewayList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.VpnGateway items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\VpnGateway[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of VpnGateway resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#vpnGateway for VPN gateways.
