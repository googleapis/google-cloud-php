...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetHttpProxyAggregatedList</code>
 */
class TargetHttpProxyAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.TargetHttpProxiesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\TargetHttpProxiesScopedList::class);
        $this->items = $arr;
