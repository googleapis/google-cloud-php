 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetSslPolicyTargetSslProxyRequest</code>
 */
class SetSslPolicyTargetSslProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\SetSslPolicyTargetSslProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $targetSslProxy, \Google\Cloud\Compute\V1\SslPolicyReference $sslPolicyReferenceResource): self
    {
        return (new self())
            ->setProject($project)
