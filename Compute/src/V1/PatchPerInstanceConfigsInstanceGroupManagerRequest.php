 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchPerInstanceConfigsInstanceGroupManagerRequest</code>
 */
class PatchPerInstanceConfigsInstanceGroupManagerRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $instance_group_managers_patch_per_instance_configs_req_resource = null;
    /**
     ...
     * @param \Google\Cloud\Compute\V1\InstanceGroupManagersPatchPerInstanceConfigsReq $instanceGroupManagersPatchPerInstanceConfigsReqResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\PatchPerInstanceConfigsInstanceGroupManagerRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $instanceGroupManager, \Google\Cloud\Compute\V1\InstanceGroupManagersPatchPerInstanceConfigsReq $instanceGroupManagersPatchPerInstanceConfigsReqResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
     ...
     *           The name of the managed instance group. It should conform to RFC1035.
     *     @type \Google\Cloud\Compute\V1\InstanceGroupManagersPatchPerInstanceConfigsReq $instance_group_managers_patch_per_instance_configs_req_resource
     *           The body resource for this request
     *     @type string $project
     *           Project ID for this request.
    ...
    public function hasInstanceGroupManagersPatchPerInstanceConfigsReqResource()
    {
        return isset($this->instance_group_managers_patch_per_instance_configs_req_resource);
    }

    public function clearInstanceGroupManagersPatchPerInstanceConfigsReqResource()
    {
     ...
     * @return $this
     */
    public function setInstanceGroupManagersPatchPerInstanceConfigsReqResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\InstanceGroupManagersPatchPerInstanceConfigsReq::class);
        $this->instance_group_managers_patch_per_instance_configs_req_resource = $var;
