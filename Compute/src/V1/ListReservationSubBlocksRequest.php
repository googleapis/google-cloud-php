 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ListReservationSubBlocksRequest</code>
 */
class ListReservationSubBlocksRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\ListReservationSubBlocksRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $parentName): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
