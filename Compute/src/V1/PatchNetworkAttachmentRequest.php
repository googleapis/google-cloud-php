 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchNetworkAttachmentRequest</code>
 */
class PatchNetworkAttachmentRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchNetworkAttachmentRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $networkAttachment, \Google\Cloud\Compute\V1\NetworkAttachment $networkAttachmentResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
