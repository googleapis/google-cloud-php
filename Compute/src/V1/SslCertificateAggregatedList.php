...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SslCertificateAggregatedList</code>
 */
class SslCertificateAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.SslCertificatesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\SslCertificatesScopedList::class);
        $this->items = $arr;
