 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ReliabilityRisksListResponse</code>
 */
class ReliabilityRisksListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ReliabilityRisk items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\ReliabilityRisk[] $items
     *           A list of ReliabilityRisk resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ReliabilityRisk items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\ReliabilityRisk>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ReliabilityRisk items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\ReliabilityRisk[] $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\ReliabilityRisk::class);
        $this->items = $arr;
