 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchPublicDelegatedPrefixeRequest</code>
 */
class PatchPublicDelegatedPrefixeRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.PublicDelegatedPrefix public_delegated_prefix_resource = 47594501 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $public_delegated_prefix_resource = null;
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchPublicDelegatedPrefixeRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $publicDelegatedPrefix, \Google\Cloud\Compute\V1\PublicDelegatedPrefix $publicDelegatedPrefixResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
