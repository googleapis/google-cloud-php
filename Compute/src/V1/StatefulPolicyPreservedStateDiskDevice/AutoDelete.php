...
namespace Google\Cloud\Compute\V1\StatefulPolicyPreservedStateDiskDevice;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.StatefulPolicyPreservedStateDiskDevice.AutoDelete</code>
 */
class AutoDelete
{
    /**
...
class_alias(AutoDelete::class, \Google\Cloud\Compute\V1\StatefulPolicyPreservedStateDiskDevice_AutoDelete::class);
