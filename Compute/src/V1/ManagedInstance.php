...
class ManagedInstance extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->current_action) ? $this->current_action : 0;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\ManagedInstance\CurrentAction::class);
    ...
    {
        return isset($this->instance_status) ? $this->instance_status : 0;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Compute\V1\ManagedInstance\InstanceStatus::class);
