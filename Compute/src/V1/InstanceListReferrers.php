 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.InstanceListReferrers</code>
 */
class InstanceListReferrers extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Reference[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Reference resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always compute#instanceListReferrers for lists of Instance referrers.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Reference items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\Reference[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
