 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TestIamPermissionsReservationBlockRequest</code>
 */
class TestIamPermissionsReservationBlockRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\TestIamPermissionsReservationBlockRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $parentResource, string $resource, \Google\Cloud\Compute\V1\TestPermissionsRequest $testPermissionsRequestResource): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
