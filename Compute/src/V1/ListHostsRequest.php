 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ListHostsRequest</code>
 */
class ListHostsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *                            reservations/reservation_name/reservationBlocks/reservation_block_name/reservationSubBlocks/reservation_sub_block_name.
     *
     * @return \Google\Cloud\Compute\V1\ListHostsRequest
     *
     * @experimental
     */
    public static function build(string $project, string $zone, string $association): self
    {
        return (new self())
            ->setProject($project)
            ->setZone($zone)
