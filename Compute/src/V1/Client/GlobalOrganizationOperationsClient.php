 ...
 * \Google\Cloud\Compute\V1\GlobalOrganizationOperationsClient} for the stable
 * implementation
 *
 * @experimental
 *
...
final class GlobalOrganizationOperationsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.GlobalOrganizationOperations';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetGlobalOrganizationOperationRequest $request, array $callOptions = []): Operation
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListGlobalOrganizationOperationsRequest $request, array $callOptions = []): PagedListResponse
    {
