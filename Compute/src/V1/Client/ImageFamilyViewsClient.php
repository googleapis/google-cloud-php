 ...
 * \Google\Cloud\Compute\V1\ImageFamilyViewsClient} for the stable implementation
 *
 * @experimental
 *
...
final class ImageFamilyViewsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.ImageFamilyViews';
     ...
     */
    public function get(GetImageFamilyViewRequest $request, array $callOptions = []): ImageFamilyView
    {
