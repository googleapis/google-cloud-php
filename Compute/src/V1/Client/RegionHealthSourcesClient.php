 ...
 * @method PromiseInterface<TestPermissionsResponse> testIamPermissionsAsync(TestIamPermissionsRegionHealthSourceRequest $request, array $optionalArgs = [])
 */
final class RegionHealthSourcesClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionHealthSources';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_health_sources_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_health_sources_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_health_sources_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new RegionHealthSourcesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::aggregatedListAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/aggregated_list.php
     *
     * @param AggregatedListRegionHealthSourcesRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::deleteAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/delete.php
     *
     * @param DeleteRegionHealthSourceRequest $request     A request to house fields associated with the call.
     * @param array                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteRegionHealthSourceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::getAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/get.php
     *
     * @param GetRegionHealthSourceRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::insertAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/insert.php
     *
     * @param InsertRegionHealthSourceRequest $request     A request to house fields associated with the call.
     * @param array                           $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionHealthSourceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::listAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/list.php
     *
     * @param ListRegionHealthSourcesRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionHealthSourcesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::patchAsync()} .
     *
     * @example samples/V1/RegionHealthSourcesClient/patch.php
     *
     * @param PatchRegionHealthSourceRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchRegionHealthSourceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see RegionHealthSourcesClient::testIamPermissionsAsync()}
     * .
     *
     * @example samples/V1/RegionHealthSourcesClient/test_iam_permissions.php
     *
     * @param TestIamPermissionsRegionHealthSourceRequest $request     A request to house fields associated with the call.
     * @param array                                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
