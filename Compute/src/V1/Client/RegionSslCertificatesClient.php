 ...
 * \Google\Cloud\Compute\V1\RegionSslCertificatesClient} for the stable
 * implementation
 *
 * @experimental
 *
...
final class RegionSslCertificatesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionSslCertificates';
     ...
     */
    public function delete(DeleteRegionSslCertificateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionSslCertificateRequest $request, array $callOptions = []): SslCertificate
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionSslCertificateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionSslCertificatesRequest $request, array $callOptions = []): PagedListResponse
    {
