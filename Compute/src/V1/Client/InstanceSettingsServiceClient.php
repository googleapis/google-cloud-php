...
final class InstanceSettingsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.InstanceSettingsService';
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ . '/../resources/instance_settings_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new InstanceSettingsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function get(GetInstanceSettingRequest $request, array $callOptions = []): InstanceSettings
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchInstanceSettingRequest $request, array $callOptions = []): OperationResponse
    {
