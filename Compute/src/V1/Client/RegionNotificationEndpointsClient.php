...
final class RegionNotificationEndpointsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionNotificationEndpoints';
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ . '/../resources/region_notification_endpoints_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new RegionNotificationEndpointsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function delete(DeleteRegionNotificationEndpointRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionNotificationEndpointRequest $request, array $callOptions = []): NotificationEndpoint
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionNotificationEndpointRequest $request, array $callOptions = []): OperationResponse
    {
