 ...
 * \Google\Cloud\Compute\V1\LicenseCodesClient} for the stable implementation
 *
 * @experimental
 *
...
final class LicenseCodesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.LicenseCodes';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsLicenseCodeRequest $request, array $callOptions = []): TestPermissionsResponse
    {
