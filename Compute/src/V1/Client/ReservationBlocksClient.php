 ...
 *
 * @method PromiseInterface<ReservationBlocksGetResponse> getAsync(GetReservationBlockRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Policy> getIamPolicyAsync(GetIamPolicyReservationBlockRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListReservationBlocksRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> performMaintenanceAsync(PerformMaintenanceReservationBlockRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Policy> setIamPolicyAsync(SetIamPolicyReservationBlockRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<TestPermissionsResponse> testIamPermissionsAsync(TestIamPermissionsReservationBlockRequest $request, array $optionalArgs = [])
 */
final class ReservationBlocksClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.ReservationBlocks';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/reservation_blocks_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/reservation_blocks_descriptor_config.php',
            'credentialsConfig' => [
     ...
     *           $options = new ReservationBlocksClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ReservationBlocksClient::getAsync()} .
     *
     * @example samples/V1/ReservationBlocksClient/get.php
     *
     * @param GetReservationBlockRequest $request     A request to house fields associated with the call.
     ...
     */
    public function get(GetReservationBlockRequest $request, array $callOptions = []): ReservationBlocksGetResponse
    {
     ...
     *
     * The async variant is {@see ReservationBlocksClient::listAsync()} .
     *
     * @example samples/V1/ReservationBlocksClient/list.php
     *
     * @param ListReservationBlocksRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListReservationBlocksRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see ReservationBlocksClient::performMaintenanceAsync()} .
     *
     * @example samples/V1/ReservationBlocksClient/perform_maintenance.php
     *
     * @param PerformMaintenanceReservationBlockRequest $request     A request to house fields associated with the call.
     * @param array                                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
