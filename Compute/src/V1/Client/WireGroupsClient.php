 ...
 *
 * @method PromiseInterface<OperationResponse> deleteAsync(DeleteWireGroupRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<WireGroup> getAsync(GetWireGroupRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> insertAsync(InsertWireGroupRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listAsync(ListWireGroupsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> patchAsync(PatchWireGroupRequest $request, array $optionalArgs = [])
 */
