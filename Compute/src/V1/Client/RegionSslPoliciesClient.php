...
final class RegionSslPoliciesClient
{
     ...
     *           $options = new RegionSslPoliciesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function delete(DeleteRegionSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionSslPolicyRequest $request, array $callOptions = []): SslPolicy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionSslPoliciesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchRegionSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
