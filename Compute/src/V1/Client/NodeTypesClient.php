 ...
 * \Google\Cloud\Compute\V1\NodeTypesClient} for the stable implementation
 *
 * @experimental
 *
...
final class NodeTypesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.NodeTypes';
     ...
     */
    public function aggregatedList(AggregatedListNodeTypesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetNodeTypeRequest $request, array $callOptions = []): NodeType
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListNodeTypesRequest $request, array $callOptions = []): PagedListResponse
    {
