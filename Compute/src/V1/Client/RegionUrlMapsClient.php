 ...
 * \Google\Cloud\Compute\V1\RegionUrlMapsClient} for the stable implementation
 *
 * @experimental
 *
...
final class RegionUrlMapsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionUrlMaps';
     ...
     */
    public function delete(DeleteRegionUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionUrlMapRequest $request, array $callOptions = []): UrlMap
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionUrlMapsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchRegionUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function update(UpdateRegionUrlMapRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function validate(ValidateRegionUrlMapRequest $request, array $callOptions = []): UrlMapsValidateResponse
    {
