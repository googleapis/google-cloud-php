...
final class RegionZonesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionZones';
     ...
     *           $options = new RegionZonesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     */
    public function list(ListRegionZonesRequest $request, array $callOptions = []): PagedListResponse
    {
