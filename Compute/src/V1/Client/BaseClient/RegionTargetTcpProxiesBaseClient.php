 ...
 * \Google\Cloud\Compute\V1\RegionTargetTcpProxiesClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class RegionTargetTcpProxiesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionTargetTcpProxies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/region_target_tcp_proxies_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/region_target_tcp_proxies_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/region_target_tcp_proxies_rest_client_config.php',
                ],
            ],
     ...
     */
    public function delete(DeleteRegionTargetTcpProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionTargetTcpProxyRequest $request, array $callOptions = []): TargetTcpProxy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionTargetTcpProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionTargetTcpProxiesRequest $request, array $callOptions = []): PagedListResponse
    {
