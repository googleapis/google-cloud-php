 ...
 * \Google\Cloud\Compute\V1\DiskTypesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class DiskTypesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.DiskTypes';
     ...
     */
    public function aggregatedList(AggregatedListDiskTypesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetDiskTypeRequest $request, array $callOptions = []): DiskType
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListDiskTypesRequest $request, array $callOptions = []): PagedListResponse
    {
