 ...
 * \Google\Cloud\Compute\V1\GlobalPublicDelegatedPrefixesClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class GlobalPublicDelegatedPrefixesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.GlobalPublicDelegatedPrefixes';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetGlobalPublicDelegatedPrefixeRequest $request, array $callOptions = []): PublicDelegatedPrefix
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListGlobalPublicDelegatedPrefixesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchGlobalPublicDelegatedPrefixeRequest $request, array $callOptions = []): OperationResponse
    {
