 ...
 * \Google\Cloud\Compute\V1\InterconnectRemoteLocationsClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class InterconnectRemoteLocationsBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectRemoteLocations';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListInterconnectRemoteLocationsRequest $request, array $callOptions = []): PagedListResponse
    {
