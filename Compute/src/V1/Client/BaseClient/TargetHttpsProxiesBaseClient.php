 ...
 * \Google\Cloud\Compute\V1\TargetHttpsProxiesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class TargetHttpsProxiesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.TargetHttpsProxies';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteTargetHttpsProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetTargetHttpsProxyRequest $request, array $callOptions = []): TargetHttpsProxy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertTargetHttpsProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListTargetHttpsProxiesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchTargetHttpsProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see self::setCertificateMapAsync()} .
     *
     ...
     *
     * The async variant is {@see self::setQuicOverrideAsync()} .
     *
     ...
     *
     * The async variant is {@see self::setSslPolicyAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function setUrlMap(SetUrlMapTargetHttpsProxyRequest $request, array $callOptions = []): OperationResponse
    {
