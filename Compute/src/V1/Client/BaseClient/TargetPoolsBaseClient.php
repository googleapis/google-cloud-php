 ...
 */
abstract class TargetPoolsBaseClient
{
     ...
     *
     * The async variant is {@see self::addHealthCheckAsync()} .
     *
     ...
     *
     * The async variant is {@see self::addInstanceAsync()} .
     *
     ...
     *
     * The async variant is {@see self::removeHealthCheckAsync()} .
     *
     ...
     *
     * The async variant is {@see self::removeInstanceAsync()} .
     *
     ...
     *
     * The async variant is {@see self::setBackupAsync()} .
     *
