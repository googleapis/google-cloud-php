 ...
 * \Google\Cloud\Compute\V1\PublicDelegatedPrefixesClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class PublicDelegatedPrefixesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.PublicDelegatedPrefixes';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeletePublicDelegatedPrefixeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetPublicDelegatedPrefixeRequest $request, array $callOptions = []): PublicDelegatedPrefix
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertPublicDelegatedPrefixeRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListPublicDelegatedPrefixesRequest $request, array $callOptions = []): PagedListResponse
    {
