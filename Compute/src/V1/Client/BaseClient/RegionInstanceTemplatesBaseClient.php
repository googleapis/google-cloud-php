 ...
 * \Google\Cloud\Compute\V1\RegionInstanceTemplatesClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class RegionInstanceTemplatesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.RegionInstanceTemplates';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../../resources/region_instance_templates_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../../resources/region_instance_templates_descriptor_config.php',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../../resources/region_instance_templates_rest_client_config.php',
                ],
            ],
     ...
     */
    public function delete(DeleteRegionInstanceTemplateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetRegionInstanceTemplateRequest $request, array $callOptions = []): InstanceTemplate
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertRegionInstanceTemplateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListRegionInstanceTemplatesRequest $request, array $callOptions = []): PagedListResponse
    {
