 ...
 */
abstract class NetworkEdgeSecurityServicesBaseClient
{
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteNetworkEdgeSecurityServiceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertNetworkEdgeSecurityServiceRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchNetworkEdgeSecurityServiceRequest $request, array $callOptions = []): OperationResponse
    {
