 ...
 */
abstract class RoutersBaseClient
{
     ...
     *
     * The async variant is {@see self::getNatMappingInfoAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getRouterStatusAsync()} .
     *
     ...
     *
     * The async variant is {@see self::previewAsync()} .
     *
