 ...
 */
abstract class TargetSslProxiesBaseClient
{
     ...
     */
    public function delete(DeleteTargetSslProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetTargetSslProxyRequest $request, array $callOptions = []): TargetSslProxy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertTargetSslProxyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListTargetSslProxiesRequest $request, array $callOptions = []): PagedListResponse
    {
