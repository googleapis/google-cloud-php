 ...
 * \Google\Cloud\Compute\V1\InterconnectsClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class InterconnectsBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.Interconnects';
     ...
     */
    public function delete(DeleteInterconnectRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetInterconnectRequest $request, array $callOptions = []): Interconnect
    {
     ...
     *
     * The async variant is {@see self::getDiagnosticsAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertInterconnectRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListInterconnectsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchInterconnectRequest $request, array $callOptions = []): OperationResponse
    {
