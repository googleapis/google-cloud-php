 ...
 * \Google\Cloud\Compute\V1\NodeTemplatesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class NodeTemplatesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.NodeTemplates';
     ...
     */
    public function aggregatedList(AggregatedListNodeTemplatesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteNodeTemplateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetNodeTemplateRequest $request, array $callOptions = []): NodeTemplate
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getIamPolicy(GetIamPolicyNodeTemplateRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertNodeTemplateRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListNodeTemplatesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function setIamPolicy(SetIamPolicyNodeTemplateRequest $request, array $callOptions = []): Policy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function testIamPermissions(TestIamPermissionsNodeTemplateRequest $request, array $callOptions = []): TestPermissionsResponse
    {
