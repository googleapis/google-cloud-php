 ...
 * \Google\Cloud\Compute\V1\SslPoliciesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class SslPoliciesBaseClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.compute.v1.SslPolicies';
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function delete(DeleteSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetSslPolicyRequest $request, array $callOptions = []): SslPolicy
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function insert(InsertSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListSslPoliciesRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     *
     * The async variant is {@see self::listAvailableFeaturesAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function patch(PatchSslPolicyRequest $request, array $callOptions = []): OperationResponse
    {
