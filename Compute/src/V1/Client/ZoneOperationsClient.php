...
final class ZoneOperationsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.compute.v1.ZoneOperations';
     ...
     */
    public function delete(DeleteZoneOperationRequest $request, array $callOptions = []): DeleteZoneOperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function get(GetZoneOperationRequest $request, array $callOptions = []): Operation
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function list(ListZoneOperationsRequest $request, array $callOptions = []): PagedListResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function wait(WaitZoneOperationRequest $request, array $callOptions = []): Operation
    {
