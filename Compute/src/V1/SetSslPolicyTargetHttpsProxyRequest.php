 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetSslPolicyTargetHttpsProxyRequest</code>
 */
class SetSslPolicyTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $ssl_policy_reference_resource = null;
    /**
     ...
     *                                                                                to be set. The name must be 1-63 characters long, and comply with RFC1035.
     * @param \Google\Cloud\Compute\V1\SslPolicyReference $sslPolicyReferenceResource The body resource for this request
     *
     * @return \Google\Cloud\Compute\V1\SetSslPolicyTargetHttpsProxyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $targetHttpsProxy, \Google\Cloud\Compute\V1\SslPolicyReference $sslPolicyReferenceResource): self
    {
        return (new self())
            ->setProject($project)
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.SslPolicyReference ssl_policy_reference_resource = 235403836 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\SslPolicyReference|null
     */
    public function getSslPolicyReferenceResource()
    {
        return $this->ssl_policy_reference_resource;
    }

    public function hasSslPolicyReferenceResource()
    {
        return isset($this->ssl_policy_reference_resource);
    }

    public function clearSslPolicyReferenceResource()
    {
     ...
     * @return $this
     */
    public function setSslPolicyReferenceResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Compute\V1\SslPolicyReference::class);
        $this->ssl_policy_reference_resource = $var;
