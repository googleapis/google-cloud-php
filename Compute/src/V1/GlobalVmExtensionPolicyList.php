 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.GlobalVmExtensionPolicyList</code>
 */
class GlobalVmExtensionPolicyList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.GlobalVmExtensionPolicy items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\GlobalVmExtensionPolicy[] $items
     *           A list of GlobalVmExtensionPolicy resources.
     *     @type string $kind
     *           Output only. Type of resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.GlobalVmExtensionPolicy items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\GlobalVmExtensionPolicy>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.GlobalVmExtensionPolicy items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\GlobalVmExtensionPolicy[] $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\GlobalVmExtensionPolicy::class);
        $this->items = $arr;
