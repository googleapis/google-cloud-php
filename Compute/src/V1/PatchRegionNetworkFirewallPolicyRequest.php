 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRegionNetworkFirewallPolicyRequest</code>
 */
class PatchRegionNetworkFirewallPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchRegionNetworkFirewallPolicyRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $firewallPolicy, \Google\Cloud\Compute\V1\FirewallPolicy $firewallPolicyResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
