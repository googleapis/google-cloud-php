 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.OperationList</code>
 */
class OperationList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $id
     *           [Output Only] The unique identifier for the resource. This identifier is defined by the server.
     *     @type \Google\Cloud\Compute\V1\Operation[]|\Google\Protobuf\Internal\RepeatedField $items
     *           [Output Only] A list of Operation resources.
     *     @type string $kind
     *           [Output Only] Type of resource. Always `compute#operations` for Operations resource.
