 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetEdgeSecurityPolicyBackendBucketRequest</code>
 */
class SetEdgeSecurityPolicyBackendBucketRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @experimental
     */
    public static function build(string $project, string $backendBucket, \Google\Cloud\Compute\V1\SecurityPolicyReference $securityPolicyReferenceResource): self
    {
        return (new self())
            ->setProject($project)
