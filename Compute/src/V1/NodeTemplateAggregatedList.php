...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NodeTemplateAggregatedList</code>
 */
class NodeTemplateAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.NodeTemplatesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NodeTemplatesScopedList::class);
        $this->items = $arr;
