 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TargetHttpsProxyList</code>
 */
class TargetHttpsProxyList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.TargetHttpsProxy items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\TargetHttpsProxy[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of TargetHttpsProxy resources.
     *     @type string $kind
     *           Type of resource. Always compute#targetHttpsProxyList for lists of target HTTPS proxies.
