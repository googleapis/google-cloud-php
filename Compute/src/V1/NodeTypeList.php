 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NodeTypeList</code>
 */
class NodeTypeList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.NodeType items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\NodeType[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of NodeType resources.
     *     @type string $kind
     *           [Output Only] Type of resource.Always compute#nodeTypeList for lists of node types.
