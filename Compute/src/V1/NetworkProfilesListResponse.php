 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NetworkProfilesListResponse</code>
 */
class NetworkProfilesListResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NetworkProfile::class);
        $this->items = $arr;
