 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ForwardingRuleList</code>
 */
class ForwardingRuleList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ForwardingRule items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\ForwardingRule[] $items
     *           A list of ForwardingRule resources.
     *     @type string $kind
     *           Output only. Type of resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.ForwardingRule items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\ForwardingRule>
     */
