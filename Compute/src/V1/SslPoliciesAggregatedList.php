...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SslPoliciesAggregatedList</code>
 */
class SslPoliciesAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.SslPoliciesScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\SslPoliciesScopedList::class);
        $this->items = $arr;
