...
class SetQuicOverrideTargetHttpsProxyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.TargetHttpsProxiesSetQuicOverrideRequest target_https_proxies_set_quic_override_request_resource = 72940258 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Compute\V1\TargetHttpsProxiesSetQuicOverrideRequest|null
     */
    public function getTargetHttpsProxiesSetQuicOverrideRequestResource()
    {
        return isset($this->target_https_proxies_set_quic_override_request_resource) ? $this->target_https_proxies_set_quic_override_request_resource : null;
    }

    public function hasTargetHttpsProxiesSetQuicOverrideRequestResource()
    {
        return isset($this->target_https_proxies_set_quic_override_request_resource);
    }

    public function clearTargetHttpsProxiesSetQuicOverrideRequestResource()
    {
        unset($this->target_https_proxies_set_quic_override_request_resource);
    }
