 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRegionBackendBucketRequest</code>
 */
class PatchRegionBackendBucketRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.compute.v1.BackendBucket backend_bucket_resource = 380757784 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\Compute\V1\PatchRegionBackendBucketRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $backendBucket, \Google\Cloud\Compute\V1\BackendBucket $backendBucketResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
