 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetSecurityPolicyTargetPoolRequest</code>
 */
class SetSecurityPolicyTargetPoolRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * @return \Google\Cloud\Compute\V1\SetSecurityPolicyTargetPoolRequest
     *
     * @experimental
     */
    public static function build(string $project, string $region, string $targetPool, \Google\Cloud\Compute\V1\SecurityPolicyReference $securityPolicyReferenceResource): self
    {
        return (new self())
            ->setProject($project)
            ->setRegion($region)
