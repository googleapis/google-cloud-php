...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.VpnGatewayAggregatedList</code>
 */
class VpnGatewayAggregatedList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.compute.v1.VpnGatewaysScopedList> items = 100526016;</code>
     */
    private $items;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\VpnGatewaysScopedList::class);
        $this->items = $arr;
