...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.RolloutsListResponse</code>
 */
class RolloutsListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Rollout items = 100526016;</code>
     */
    private $items;
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Rollout[] $items
     *           A list of Rollout resources.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Rollout items = 100526016;</code>
     * @return RepeatedField<\Google\Cloud\Compute\V1\Rollout>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Rollout items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\Rollout[] $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\Rollout::class);
        $this->items = $arr;
