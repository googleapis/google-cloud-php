 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SnapshotList</code>
 */
class SnapshotList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Snapshot items = 100526016;</code>
     */
    private $items;
    /**
     * Type of resource.
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\Snapshot[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of Snapshot resources.
     *     @type string $kind
     *           Type of resource.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.compute.v1.Snapshot items = 100526016;</code>
     * @param \Google\Cloud\Compute\V1\Snapshot[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\Snapshot::class);
        $this->items = $arr;
