...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.NodeGroupsListNodes</code>
 */
class NodeGroupsListNodes extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Compute\V1\NodeGroupNode::class);
        $this->items = $arr;
