 ...
 *
 * Generated from protobuf message <code>google.maps.weather.v1.HistoryHour</code>
 */
class HistoryHour extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Maps\Weather\V1\HistoryHour::initOnce();
