 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/css/v1/css_product_inputs.proto
...
final class CssProductInputsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.css.v1.CssProductInputsService';
     ...
     *           use Google\Shopping\Css\V1\CssProductInputsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CssProductInputsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
