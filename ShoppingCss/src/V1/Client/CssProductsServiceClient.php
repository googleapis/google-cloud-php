 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/css/v1/css_products.proto
...
final class CssProductsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.css.v1.CssProductsService';
     ...
     *           use Google\Shopping\Css\V1\CssProductsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new CssProductsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
