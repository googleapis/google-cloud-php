 ...
 */
function update_audit_schedule_sample(
    ...
    $request = (new UpdateAuditScheduleRequest())
        ->setAuditSchedule($auditSchedule);

    // Call the API and handle any network failures.
    try {
        /** @var AuditSchedule $response */
        $response = $auditManagerClient->updateAuditSchedule($request);
