 ...
 *
 * @param string $formattedParent The name of the parent resource under which the GBP accounts are
 *                                listed. Format: `accounts/{account}`. Please see
 *                                {@see GbpAccountsServiceClient::accountName()} for help formatting this field.
 */
function list_gbp_accounts_sample(string $formattedParent): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    list_gbp_accounts_sample($formattedParent);
}
