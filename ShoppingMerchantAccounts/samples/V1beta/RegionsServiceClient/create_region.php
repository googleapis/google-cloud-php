 ...
 *
 * @param string $formattedParent The account to create a region for.
 *                                Format: `accounts/{account}`
 *                                Please see {@see RegionsServiceClient::accountName()} for help formatting this field.
 * @param string $regionId        The identifier for the region, unique over all regions of the
 *                                same account.
 */
function create_region_sample(string $formattedParent, string $regionId): void
{
    // Create a client.
