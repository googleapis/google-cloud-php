...
use Google\Shopping\Merchant\Accounts\V1beta\AccountIssue;
 ...
 *
 * @param string $formattedParent The parent, which owns this collection of issues.
 *                                Format: `accounts/{account}`
 *                                Please see {@see AccountIssueServiceClient::accountName()} for help formatting this field.
 */
function list_account_issues_sample(string $formattedParent): void
{
    // Create a client.
    $accountIssueServiceClient = new AccountIssueServiceClient();
