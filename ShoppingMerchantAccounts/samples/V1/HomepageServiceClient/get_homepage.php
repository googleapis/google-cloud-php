...
// [START merchantapi_v1_generated_HomepageService_GetHomepage_sync]
 ...
 *
 * @param string $formattedName The name of the homepage to retrieve.
 *                              Format: `accounts/{account}/homepage`
 *                              Please see {@see HomepageServiceClient::homepageName()} for help formatting this field.
 */
function get_homepage_sample(string $formattedName): void
{
    // Create a client.
...
// [END merchantapi_v1_generated_HomepageService_GetHomepage_sync]
