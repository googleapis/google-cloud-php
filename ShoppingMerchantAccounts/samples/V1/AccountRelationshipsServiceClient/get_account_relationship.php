 ...
 *
 * @param string $formattedName The resource name of the account relationship to get.
 *                              Format: `accounts/{account}/relationships/{relationship}`. For example,
 *                              `accounts/123456/relationships/567890`. Please see
 *                              {@see AccountRelationshipsServiceClient::accountRelationshipName()} for help formatting this field.
 */
function get_account_relationship_sample(string $formattedName): void
{
    // Create a client.
...
{
    $formattedName = AccountRelationshipsServiceClient::accountRelationshipName(
        '[ACCOUNT]',
        '[RELATIONSHIP]'
    );

    get_account_relationship_sample($formattedName);
}
