 ...
 *
 * @param string $formattedName The name of the program for which to enable participation for the
 *                              given account. Format: `accounts/{account}/programs/{program}`. For
 *                              example, `accounts/123456/programs/free-listings`. Please see
 *                              {@see ProgramsServiceClient::programName()} for help formatting this field.
 */
function enable_program_sample(string $formattedName): void
{
    // Create a client.
    $programsServiceClient = new ProgramsServiceClient();
