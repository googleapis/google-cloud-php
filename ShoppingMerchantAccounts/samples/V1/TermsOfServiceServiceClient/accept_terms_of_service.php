 ...
 * @param string $formattedAccount The account for which to accept the ToS.
 *                                 Format: `accounts/{account}`
 *                                 Please see {@see TermsOfServiceServiceClient::accountName()} for help formatting this field.
...
function accept_terms_of_service_sample(
    ...
    try {
        /** @var AcceptTermsOfServiceResponse $response */
        $response = $termsOfServiceServiceClient->acceptTermsOfService($request);
