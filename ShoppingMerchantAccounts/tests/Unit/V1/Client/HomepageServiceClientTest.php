...
class HomepageServiceClientTest extends GeneratedTest
{
    ...
    public function claimHomepageTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.HomepageService/ClaimHomepage', $actualFuncCall);
    ...
    public function getHomepageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.HomepageService/GetHomepage', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function unclaimHomepageTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.HomepageService/UnclaimHomepage', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateHomepageTest()
    {
        ...
        $request = (new UpdateHomepageRequest())->setHomepage($homepage);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.HomepageService/UpdateHomepage', $actualFuncCall);
