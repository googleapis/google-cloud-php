 ...
 * @group gapic
 */
class DeveloperRegistrationServiceClientTest extends GeneratedTest
{
    ...
    /** @return DeveloperRegistrationServiceClient */
    ...
    /** @test */
    public function getDeveloperRegistrationTest()
    {
        ...
        $response = $gapicClient->getDeveloperRegistration($request);
    ...
    /** @test */
    public function getDeveloperRegistrationExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetDeveloperRegistrationRequest())->setName($formattedName);
        try {
            $gapicClient->getDeveloperRegistration($request);
    ...
    /** @test */
    public function registerGcpTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->developerRegistrationName('[ACCOUNT]');
        $request = (new RegisterGcpRequest())->setName($formattedName);
        $response = $gapicClient->registerGcp($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    /** @test */
    public function registerGcpExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new RegisterGcpRequest())->setName($formattedName);
        try {
            $gapicClient->registerGcp($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function unregisterGcpTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->developerRegistrationName('[ACCOUNT]');
        $request = (new UnregisterGcpRequest())->setName($formattedName);
        $gapicClient->unregisterGcp($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function unregisterGcpExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
