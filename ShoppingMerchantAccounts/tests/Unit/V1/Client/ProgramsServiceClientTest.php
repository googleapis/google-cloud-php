...
use Google\Shopping\Merchant\Accounts\V1\ListProgramsResponse;
use Google\Shopping\Merchant\Accounts\V1\Program;
use stdClass;
 ...
 * @group gapic
 */
class ProgramsServiceClientTest extends GeneratedTest
{
    ...
    public function disableProgramTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.ProgramsService/DisableProgram', $actualFuncCall);
    ...
    public function enableProgramTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.ProgramsService/EnableProgram', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getProgramTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.ProgramsService/GetProgram', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listProgramsTest()
    {
        ...
        $request = (new ListProgramsRequest())->setParent($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.ProgramsService/ListPrograms', $actualFuncCall);
