...
use Google\Shopping\Merchant\Accounts\V1\AcceptTermsOfServiceResponse;
...
use Google\Shopping\Merchant\Accounts\V1\TermsOfService;
...
class TermsOfServiceServiceClientTest extends GeneratedTest
{
    ...
    public function acceptTermsOfServiceTest()
    {
        ...
        // Mock response
        $expectedResponse = new AcceptTermsOfServiceResponse();
        ...
        $response = $gapicClient->acceptTermsOfService($request);
    ...
    public function getTermsOfServiceTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->termsOfServiceName('[VERSION]');
        $request = (new GetTermsOfServiceRequest())->setName($formattedName);
    ...
    public function acceptTermsOfServiceAsyncTest()
    {
        ...
        $request = (new AcceptTermsOfServiceRequest())
            ...
            ->setAccount($formattedAccount)
            ->setRegionCode($regionCode);
        $response = $gapicClient->acceptTermsOfServiceAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
