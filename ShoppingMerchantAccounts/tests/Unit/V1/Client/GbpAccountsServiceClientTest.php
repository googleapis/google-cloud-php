...
use Google\Shopping\Merchant\Accounts\V1\ListGbpAccountsResponse;
use stdClass;
...
class GbpAccountsServiceClientTest extends GeneratedTest
{
    ...
    public function linkGbpAccountTest()
    {
        ...
        $this->assertSame('/google.shopping.merchant.accounts.v1.GbpAccountsService/LinkGbpAccount', $actualFuncCall);
    ...
    public function listGbpAccountsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.GbpAccountsService/ListGbpAccounts', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
