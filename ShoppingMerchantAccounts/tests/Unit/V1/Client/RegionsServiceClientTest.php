...
use Google\Shopping\Merchant\Accounts\V1\ListRegionsResponse;
 ...
 * @group gapic
 */
class RegionsServiceClientTest extends GeneratedTest
{
    ...
    public function deleteRegionTest()
    {
        ...
        $request = (new DeleteRegionRequest())->setName($formattedName);
        $gapicClient->deleteRegion($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.RegionsService/DeleteRegion', $actualFuncCall);
    ...
    public function getRegionTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->regionName('[ACCOUNT]', '[REGION]');
        $request = (new GetRegionRequest())->setName($formattedName);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.RegionsService/GetRegion', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listRegionsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->accountName('[ACCOUNT]');
        $request = (new ListRegionsRequest())->setParent($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.RegionsService/ListRegions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateRegionTest()
    {
        ...
        // Mock request
        $region = new Region();
        $request = (new UpdateRegionRequest())->setRegion($region);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.accounts.v1.RegionsService/UpdateRegion', $actualFuncCall);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
