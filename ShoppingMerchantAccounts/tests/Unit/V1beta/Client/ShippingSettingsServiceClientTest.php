...
class ShippingSettingsServiceClientTest extends GeneratedTest
{
    ...
    public function getShippingSettingsTest()
    {
        ...
        $request = (new GetShippingSettingsRequest())->setName($formattedName);
    ...
    public function insertShippingSettingsTest()
    {
        ...
        $request = (new InsertShippingSettingsRequest())->setParent($parent)->setShippingSetting($shippingSetting);
