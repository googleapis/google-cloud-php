...
use Google\Shopping\Merchant\Accounts\V1beta\ListAccountTaxRequest;
use Google\Shopping\Merchant\Accounts\V1beta\ListAccountTaxResponse;
 ...
 * @group gapic
 */
class AccountTaxServiceClientTest extends GeneratedTest
{
    ...
    public function getAccountTaxTest()
    {
        ...
        $request = (new GetAccountTaxRequest())->setName($formattedName);
    ...
    public function listAccountTaxTest()
    {
        ...
        $accountTaxes = [$accountTaxesElement];
        ...
        $request = (new ListAccountTaxRequest())->setParent($formattedParent);
    ...
    public function updateAccountTaxTest()
    {
        ...
        $request = (new UpdateAccountTaxRequest())->setAccountTax($accountTax);
