 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1beta/user.proto
...
final class UserServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1beta.UserService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1beta\UserServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new UserServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
