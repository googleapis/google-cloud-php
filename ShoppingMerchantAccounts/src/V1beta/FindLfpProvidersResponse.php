 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1beta.FindLfpProvidersResponse</code>
 */
class FindLfpProvidersResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1beta\LfpProvider::class);
