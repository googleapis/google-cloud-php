 ...
 * a specific merchant.
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1beta.CheckoutSettings</code>
 */
class CheckoutSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.UriSettings uri_settings = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.CheckoutSettings.CheckoutEnrollmentState enrollment_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.CheckoutSettings.CheckoutReviewState review_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * marketplace sellers).
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1beta.UriSettings effective_uri_settings = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.CheckoutSettings.CheckoutEnrollmentState effective_enrollment_state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * account (for only marketplace sellers).
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.CheckoutSettings.CheckoutReviewState effective_review_state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           `ENROLLED` before a review can begin for the merchant.For more details,
     *           check the help center doc.
     *     @type \Google\Shopping\Merchant\Accounts\V1beta\UriSettings $effective_uri_settings
     *           Output only. The effective value of `uri_settings` for a given merchant. If
     *           account level settings are present then this value will be a copy of url
     *           settings. Otherwise, it will have the value of the parent account (for only
     *           marketplace sellers).
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.UriSettings uri_settings = 2;</code>
     * @return \Google\Shopping\Merchant\Accounts\V1beta\UriSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1beta.UriSettings uri_settings = 2;</code>
     * @param \Google\Shopping\Merchant\Accounts\V1beta\UriSettings $var
     * @return $this
     */
    public function setUriSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1beta\UriSettings::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1beta\CheckoutSettings\CheckoutEnrollmentState::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1beta\CheckoutSettings\CheckoutReviewState::class);
