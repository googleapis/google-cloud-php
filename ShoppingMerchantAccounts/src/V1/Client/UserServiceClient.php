 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/user.proto
...
final class UserServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.UserService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\UserServiceClient;
     ...
     *
     * @example samples/V1/UserServiceClient/delete_user.php
     *
     ...
     *
     * @example samples/V1/UserServiceClient/get_user.php
     *
