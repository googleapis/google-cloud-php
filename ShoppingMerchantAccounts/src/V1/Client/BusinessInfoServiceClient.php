 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/businessinfo.proto
...
final class BusinessInfoServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.BusinessInfoService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\BusinessInfoServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BusinessInfoServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/BusinessInfoServiceClient/get_business_info.php
     *
     ...
     * .
     *
     * @example samples/V1/BusinessInfoServiceClient/update_business_info.php
     *
