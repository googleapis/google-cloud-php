 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/businessidentity.proto
...
final class BusinessIdentityServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.BusinessIdentityService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\BusinessIdentityServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new BusinessIdentityServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/BusinessIdentityServiceClient/get_business_identity.php
     *
     ...
     *
     * @example samples/V1/BusinessIdentityServiceClient/update_business_identity.php
     *
