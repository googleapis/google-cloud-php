 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/shippingsettings.proto
...
final class ShippingSettingsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.ShippingSettingsService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\ShippingSettingsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ShippingSettingsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ShippingSettingsServiceClient/get_shipping_settings.php
     *
     ...
     *
     * @example samples/V1/ShippingSettingsServiceClient/insert_shipping_settings.php
     *
