 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/accounts.proto
...
final class AccountsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.AccountsService';
     ...
     *           $options = new AccountsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/AccountsServiceClient/create_and_configure_account.php
     *
     ...
     *
     * @example samples/V1/AccountsServiceClient/delete_account.php
     *
     ...
     *
     * @example samples/V1/AccountsServiceClient/list_accounts.php
     *
     ...
     *
     * @example samples/V1/AccountsServiceClient/list_sub_accounts.php
     *
     ...
     *
     * @example samples/V1/AccountsServiceClient/update_account.php
     *
