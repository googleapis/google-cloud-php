 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/homepage.proto
...
final class HomepageServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.HomepageService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\HomepageServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new HomepageServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/HomepageServiceClient/claim_homepage.php
     *
     ...
     *
     * @example samples/V1/HomepageServiceClient/get_homepage.php
     *
     ...
     *
     * @example samples/V1/HomepageServiceClient/unclaim_homepage.php
     *
     ...
     *
     * @example samples/V1/HomepageServiceClient/update_homepage.php
     *
