 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/termsofserviceagreementstate.proto
...
final class TermsOfServiceAgreementStateServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService';
     ...
     *           use
     *           Google\Shopping\Merchant\Accounts\V1\TermsOfServiceAgreementStateServiceClient;
     ...
     * .
     *
     * @example samples/V1/TermsOfServiceAgreementStateServiceClient/get_terms_of_service_agreement_state.php
     *
     ...
     * .
     *
     * @example samples/V1/TermsOfServiceAgreementStateServiceClient/retrieve_for_application_terms_of_service_agreement_state.php
     *
