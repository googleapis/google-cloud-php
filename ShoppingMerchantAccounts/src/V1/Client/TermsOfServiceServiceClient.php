 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/accounts/v1/termsofservice.proto
 ...
 *
 * @method PromiseInterface<AcceptTermsOfServiceResponse> acceptTermsOfServiceAsync(AcceptTermsOfServiceRequest $request, array $optionalArgs = [])
...
final class TermsOfServiceServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.accounts.v1.TermsOfServiceService';
     ...
     *           use Google\Shopping\Merchant\Accounts\V1\TermsOfServiceServiceClient;
     ...
     *
     * @example samples/V1/TermsOfServiceServiceClient/accept_terms_of_service.php
     *
     ...
     */
    public function acceptTermsOfService(AcceptTermsOfServiceRequest $request, array $callOptions = []): AcceptTermsOfServiceResponse
    {
        return $this->startApiCall('AcceptTermsOfService', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V1/TermsOfServiceServiceClient/get_terms_of_service.php
     *
     ...
     *
     * @example samples/V1/TermsOfServiceServiceClient/retrieve_latest_terms_of_service.php
     *
