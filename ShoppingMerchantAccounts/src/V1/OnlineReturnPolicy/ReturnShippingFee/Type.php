...
namespace Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicy\ReturnShippingFee;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.accounts.v1.OnlineReturnPolicy.ReturnShippingFee.Type</code>
 */
class Type
{
    /**
