...
namespace Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicy;
 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.OnlineReturnPolicy.ReturnShippingFee</code>
 */
class ReturnShippingFee extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.accounts.v1.OnlineReturnPolicy.ReturnShippingFee.Type type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicy\ReturnShippingFee\Type::class);
        $this->type = $var;
