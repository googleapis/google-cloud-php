 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Distance</code>
 */
class Distance extends \Google\Protobuf\Internal\Message
{
     ...
     * and kilometers.
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.Distance.Unit unit = 2;</code>
     */
    protected $unit = null;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1\Distance\Unit::class);
        $this->unit = $var;
