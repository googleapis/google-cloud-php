 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.BusinessInfo</code>
 */
class BusinessInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.PhoneVerificationState phone_verification_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $phone_verification_state = null;
    /**
     * Optional. The customer service of the business.
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CustomerService customer_service = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Output only. The phone verification state of the business.
     *     @type \Google\Shopping\Merchant\Accounts\V1\CustomerService $customer_service
     *           Optional. The customer service of the business.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Accounts\V1\PhoneVerificationState::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CustomerService customer_service = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Shopping\Merchant\Accounts\V1\CustomerService|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.shopping.merchant.accounts.v1.CustomerService customer_service = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Shopping\Merchant\Accounts\V1\CustomerService $var
     * @return $this
     */
    public function setCustomerService($var)
    {
        GPBUtil::checkMessage($var, \Google\Shopping\Merchant\Accounts\V1\CustomerService::class);
