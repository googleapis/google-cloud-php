 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.ApproveAccountServiceRequest</code>
 */
class ApproveAccountServiceRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the account service to approve.
     *                     Format: `accounts/{account}/services/{service}`
     *                     Please see {@see AccountServicesServiceClient::accountServiceName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\Accounts\V1\ApproveAccountServiceRequest
     *
     * @experimental
     */
