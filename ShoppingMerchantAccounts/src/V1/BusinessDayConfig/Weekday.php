...
namespace Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig;

use UnexpectedValueException;

/**
 * Protobuf type <code>google.shopping.merchant.accounts.v1.BusinessDayConfig.Weekday</code>
 */
class Weekday
{
    /**
