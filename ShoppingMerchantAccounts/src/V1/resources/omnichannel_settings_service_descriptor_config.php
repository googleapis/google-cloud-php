    ...
    'interfaces' => [
        'google.shopping.merchant.accounts.v1.OmnichannelSettingsService' => [
            'CreateOmnichannelSetting' => [
                ...
                'responseType' => 'Google\Shopping\Merchant\Accounts\V1\OmnichannelSetting',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListOmnichannelSettings' => [
                ...
                'responseType' => 'Google\Shopping\Merchant\Accounts\V1\ListOmnichannelSettingsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'RequestInventoryVerification' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Shopping\Merchant\Accounts\V1\RequestInventoryVerificationResponse',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
