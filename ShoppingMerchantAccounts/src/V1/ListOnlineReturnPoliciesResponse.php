 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.ListOnlineReturnPoliciesResponse</code>
 */
class ListOnlineReturnPoliciesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\OnlineReturnPolicy::class);
