 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.BusinessDayConfig</code>
 */
class BusinessDayConfig extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Shopping\Merchant\Accounts\V1\BusinessDayConfig\Weekday::class);
