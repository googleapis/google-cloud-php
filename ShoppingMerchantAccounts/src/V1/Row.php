 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.accounts.v1.Row</code>
 */
class Row extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Accounts\V1\Value::class);
        $this->cells = $arr;
