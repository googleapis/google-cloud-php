 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/policysimulator/v1/simulator.proto
...
final class SimulatorClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/simulator_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/simulator_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/simulator_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/simulator_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * folder_location_replay resource.
     *
     * @param string $folder
     * @param string $location
     * @param string $replay
     *
     * @return string The formatted folder_location_replay resource.
     */
    public static function folderLocationReplayName(string $folder, string $location, string $replay): string
    {
        return self::getPathTemplate('folderLocationReplay')->render([
            'folder' => $folder,
            'location' => $location,
            'replay' => $replay,
        ]);
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * organization_location_replay resource.
     *
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a
     * project_location_replay resource.
     *
     * @param string $project
     * @param string $location
     * @param string $replay
     *
     * @return string The formatted project_location_replay resource.
     */
    public static function projectLocationReplayName(string $project, string $location, string $replay): string
    {
        return self::getPathTemplate('projectLocationReplay')->render([
            'project' => $project,
            'location' => $location,
            'replay' => $replay,
        ]);
    ...
    /**
     * Formats a string containing the fully-qualified path to represent a replay
     * resource.
     *
     * @param string $project
     * @param string $location
     * @param string $replay
     *
     * @return string The formatted replay resource.
     */
    public static function replayName(string $project, string $location, string $replay): string
    {
        return self::getPathTemplate('replay')->render([
            'project' => $project,
            'location' => $location,
            'replay' => $replay,
        ]);
     ...
     *           use Google\Cloud\PolicySimulator\V1\SimulatorClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SimulatorClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @param CreateReplayRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return OperationResponse<Replay>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function createReplay(CreateReplayRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateReplay', $request, $callOptions)->wait();
    }
     ...
     *
     * @param GetReplayRequest $request     A request to house fields associated with the call.
     * @param array            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getReplay(GetReplayRequest $request, array $callOptions = []): Replay
    {
        return $this->startApiCall('GetReplay', $request, $callOptions)->wait();
    }
     ...
     *
     * @param ListReplayResultsRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listReplayResults(ListReplayResultsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListReplayResults', $request, $callOptions);
    }
}
