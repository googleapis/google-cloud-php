...
namespace Google\Cloud\PolicySimulator\V1\Client\BaseClient;
 ...
 */
abstract class SimulatorBaseClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../../resources/simulator_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ . '/../../resources/simulator_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../../resources/simulator_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../../resources/simulator_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function folderLocationReplayName(
        string $folder,
        string $location,
        string $replay
    ): string {
     ...
     */
    public static function projectLocationReplayName(
        string $project,
        string $location,
        string $replay
    ): string {
     ...
     */
    public static function replayName(
        string $project,
        string $location,
        string $replay
    ): string {
     ...
     *
     * The async variant is {@see self::createReplayAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getReplayAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listReplayResultsAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listReplayResults(
