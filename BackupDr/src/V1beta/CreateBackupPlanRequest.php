 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.CreateBackupPlanRequest</code>
 */
class CreateBackupPlanRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlan backup_plan = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\BackupDR\V1beta\BackupPlan $backupPlan   Required. The `BackupPlan` resource object to create.
     * @param string                                   $backupPlanId Required. The name of the `BackupPlan` to create. The name must be unique
     *                                                               for the specified project and location.The name must start with a lowercase
     *                                                               letter followed by up to 62 lowercase letters, numbers, or hyphens.
     *                                                               Pattern, /[a-z][a-z0-9-]{,62}/.
     *
     * @return \Google\Cloud\BackupDR\V1beta\CreateBackupPlanRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\BackupDR\V1beta\BackupPlan $backupPlan, string $backupPlanId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           letter followed by up to 62 lowercase letters, numbers, or hyphens.
     *           Pattern, /[a-z][a-z0-9-]{,62}/.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupPlan $backup_plan
     *           Required. The `BackupPlan` resource object to create.
