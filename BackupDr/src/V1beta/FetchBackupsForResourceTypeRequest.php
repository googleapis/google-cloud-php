 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.FetchBackupsForResourceTypeRequest</code>
 */
class FetchBackupsForResourceTypeRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupView view = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;
     ...
     *                             Ex: sqladmin.googleapis.com/Instance
     *
     * @return \Google\Cloud\BackupDR\V1beta\FetchBackupsForResourceTypeRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\BackupView::class);
        $this->view = $var;
