 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.UpdateBackupVaultRequest</code>
 */
class UpdateBackupVaultRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupVault backup_vault = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\BackupDR\V1beta\BackupVault $backupVault Required. The resource being updated
     ...
     *                                                               user does not provide a mask then the request will fail.
     *
     * @return \Google\Cloud\BackupDR\V1beta\UpdateBackupVaultRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\BackupDR\V1beta\BackupVault $backupVault, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
