 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.DataSourceReference</code>
 */
class DataSourceReference extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigState data_source_backup_config_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceBackupConfigInfo data_source_backup_config_info = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     * with.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceGcpResourceInfo data_source_gcp_resource_info = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           Output only. Number of backups in the DataSource.
     *     @type \Google\Cloud\BackupDR\V1beta\DataSourceBackupConfigInfo $data_source_backup_config_info
     *           Output only. Information of backup configuration on the DataSource.
     *     @type \Google\Cloud\BackupDR\V1beta\DataSourceGcpResourceInfo $data_source_gcp_resource_info
     *           Output only. The Google Cloud resource that the DataSource is associated
     *           with.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceBackupConfigInfo data_source_backup_config_info = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\DataSourceBackupConfigInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceBackupConfigInfo data_source_backup_config_info = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\DataSourceBackupConfigInfo $var
     * @return $this
     */
    public function setDataSourceBackupConfigInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\DataSourceBackupConfigInfo::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceGcpResourceInfo data_source_gcp_resource_info = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\DataSourceGcpResourceInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceGcpResourceInfo data_source_gcp_resource_info = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\DataSourceGcpResourceInfo $var
     * @return $this
     */
    public function setDataSourceGcpResourceInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\DataSourceGcpResourceInfo::class);
