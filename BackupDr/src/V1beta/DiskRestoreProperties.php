 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.DiskRestoreProperties</code>
 */
class DiskRestoreProperties extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.GuestOsFeature guest_os_feature = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.CustomerEncryptionKey disk_encryption_key = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.DiskRestoreProperties.AccessMode access_mode = 12 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * ARM64 or X86_64.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.DiskRestoreProperties.Architecture architecture = 14 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Cloud\BackupDR\V1beta\RestoreDiskFromInstanceOptions $instance_backup_source
     ...
     * Options for creating a disk from a source Compute Instance backup.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.RestoreDiskFromInstanceOptions instance_backup_source = 19;</code>
     * @return \Google\Cloud\BackupDR\V1beta\RestoreDiskFromInstanceOptions|null
     */
    ...
    public function hasInstanceBackupSource()
    {
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.RestoreDiskFromInstanceOptions instance_backup_source = 19;</code>
     * @param \Google\Cloud\BackupDR\V1beta\RestoreDiskFromInstanceOptions $var
     * @return $this
     */
    public function setInstanceBackupSource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\RestoreDiskFromInstanceOptions::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\DiskRestoreProperties\AccessMode::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\DiskRestoreProperties\Architecture::class);
