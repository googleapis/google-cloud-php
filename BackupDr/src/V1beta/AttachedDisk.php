 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.AttachedDisk</code>
 */
class AttachedDisk extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.InitializeParams initialize_params = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.DiskType disk_type_deprecated = 6 [deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.DiskMode mode = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $mode = null;
    /**
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.DiskInterface disk_interface = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.GuestOsFeature guest_os_feature = 14 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * encryption key.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.CustomerEncryptionKey disk_encryption_key = 15 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.DiskSavedState saved_state = 17 [(.google.api.field_behavior) = OPTIONAL, (.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.DiskType type = 19 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $type = null;
     ...
     *
     *     @type \Google\Cloud\BackupDR\V1beta\AttachedDisk\InitializeParams $initialize_params
     *           Optional. Specifies the parameters to initialize this disk.
     ...
     *           Optional. A list of features to enable on the guest operating system.
     *           Applicable only for bootable images.
     *     @type \Google\Cloud\BackupDR\V1beta\CustomerEncryptionKey $disk_encryption_key
     *           Optional. Encrypts or decrypts a disk using a customer-supplied
     *           encryption key.
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.InitializeParams initialize_params = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\BackupDR\V1beta\AttachedDisk\InitializeParams|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AttachedDisk.InitializeParams initialize_params = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\AttachedDisk\InitializeParams $var
     * @return $this
     */
    public function setInitializeParams($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\AttachedDisk\InitializeParams::class);
    ...
    {
        @trigger_error('disk_type_deprecated is deprecated.', E_USER_DEPRECATED);
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AttachedDisk\DiskType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AttachedDisk\DiskMode::class);
        $this->mode = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AttachedDisk\DiskInterface::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AttachedDisk\DiskSavedState::class);
