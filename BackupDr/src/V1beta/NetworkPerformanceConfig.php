 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.NetworkPerformanceConfig</code>
 */
class NetworkPerformanceConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.NetworkPerformanceConfig.Tier total_egress_bandwidth_tier = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\NetworkPerformanceConfig\Tier::class);
