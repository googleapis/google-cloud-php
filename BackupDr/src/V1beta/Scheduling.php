 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.Scheduling</code>
 */
class Scheduling extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.Scheduling.OnHostMaintenance on_host_maintenance = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.Scheduling.NodeAffinity node_affinities = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.Scheduling.ProvisioningModel provisioning_model = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $provisioning_model = null;
    /**
     * Optional. Specifies the termination action for the instance.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.Scheduling.InstanceTerminationAction instance_termination_action = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * hour.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.SchedulingDuration local_ssd_recovery_timeout = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Optional. Defines whether the instance is preemptible.
     *     @type \Google\Cloud\BackupDR\V1beta\Scheduling\NodeAffinity[] $node_affinities
     *           Optional. A set of node affinity and anti-affinity configurations.
     *           Overrides reservationAffinity.
     ...
     *           Optional. Specifies the termination action for the instance.
     *     @type \Google\Cloud\BackupDR\V1beta\SchedulingDuration $local_ssd_recovery_timeout
     *           Optional. Specifies the maximum amount of time a Local Ssd Vm should wait
     *           while recovery of the Local Ssd state is attempted. Its value should be in
     *           between 0 and 168 hours with hour granularity and the default value being 1
     *           hour.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\Scheduling\OnHostMaintenance::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.Scheduling.NodeAffinity node_affinities = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\BackupDR\V1beta\Scheduling\NodeAffinity>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.Scheduling.NodeAffinity node_affinities = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\Scheduling\NodeAffinity[] $var
     * @return $this
     */
    public function setNodeAffinities($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BackupDR\V1beta\Scheduling\NodeAffinity::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\Scheduling\ProvisioningModel::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\Scheduling\InstanceTerminationAction::class);
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.SchedulingDuration local_ssd_recovery_timeout = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\BackupDR\V1beta\SchedulingDuration|null
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.SchedulingDuration local_ssd_recovery_timeout = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\SchedulingDuration $var
     * @return $this
     */
    public function setLocalSsdRecoveryTimeout($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\SchedulingDuration::class);
