 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.ManagementServer</code>
 */
class ManagementServer extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementServer.InstanceType type = 14 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $type = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementURI management_uri = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedManagementURI workforce_identity_based_management_uri = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $workforce_identity_based_management_uri = null;
    /**
     * Output only. The ManagementServer state.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementServer.InstanceState state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.NetworkConfig networks = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $networks;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedOAuth2ClientID workforce_identity_based_oauth2_client_id = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type int $type
     *           Optional. The type of the ManagementServer resource.
     *     @type \Google\Cloud\BackupDR\V1beta\ManagementURI $management_uri
     *           Output only. The hostname or ip address of the exposed AGM endpoints, used
     *           by clients to connect to AGM/RD graphical user interface and APIs.
     *     @type \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedManagementURI $workforce_identity_based_management_uri
     *           Output only. The hostnames of the exposed AGM endpoints for both types of
     *           user i.e. 1p and 3p, used to connect AGM/RM UI.
     *     @type int $state
     *           Output only. The ManagementServer state.
     *     @type \Google\Cloud\BackupDR\V1beta\NetworkConfig[] $networks
     *           Optional. VPC networks to which the ManagementServer instance is connected.
     *           For this version, only a single network is supported. This field is
     *           optional if MS is created without PSA
     *     @type string $etag
     ...
     *           specification
     *           https://openid.net/specs/openid-connect-core-1_0.html#IDToken).
     *     @type \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedOAuth2ClientID $workforce_identity_based_oauth2_client_id
     *           Output only. The OAuth client IDs for both types of user i.e. 1p and 3p.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\ManagementServer\InstanceType::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementURI management_uri = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\ManagementURI|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementURI management_uri = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\ManagementURI $var
     * @return $this
     */
    public function setManagementUri($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\ManagementURI::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedManagementURI workforce_identity_based_management_uri = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedManagementURI|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedManagementURI workforce_identity_based_management_uri = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedManagementURI $var
     * @return $this
     */
    public function setWorkforceIdentityBasedManagementUri($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedManagementURI::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\ManagementServer\InstanceState::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.NetworkConfig networks = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\BackupDR\V1beta\NetworkConfig>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.NetworkConfig networks = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\NetworkConfig[] $var
     * @return $this
     */
    public function setNetworks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BackupDR\V1beta\NetworkConfig::class);
        $this->networks = $arr;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedOAuth2ClientID workforce_identity_based_oauth2_client_id = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedOAuth2ClientID|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WorkforceIdentityBasedOAuth2ClientID workforce_identity_based_oauth2_client_id = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedOAuth2ClientID $var
     * @return $this
     */
    public function setWorkforceIdentityBasedOauth2ClientId($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\WorkforceIdentityBasedOAuth2ClientID::class);
