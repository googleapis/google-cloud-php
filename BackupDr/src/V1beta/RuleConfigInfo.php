 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.RuleConfigInfo</code>
 */
class RuleConfigInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.RuleConfigInfo.LastBackupState last_backup_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\RuleConfigInfo\LastBackupState::class);
