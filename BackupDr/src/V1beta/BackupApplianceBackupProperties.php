 ...
 * properties.
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.BackupApplianceBackupProperties</code>
 */
class BackupApplianceBackupProperties extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Backupdr\V1Beta\BackupvaultBa::initOnce();
