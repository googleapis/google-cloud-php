 ...
 * s
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.NetworkInterface</code>
 */
class NetworkInterface extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AccessConfig access_configs = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AccessConfig ipv6_access_configs = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AliasIpRange alias_ip_ranges = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $alias_ip_ranges;
    /**
     * The stack type for this network interface.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.NetworkInterface.StackType stack_type = 10;</code>
     */
     ...
     * its subnetwork.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.NetworkInterface.Ipv6AccessType ipv6_access_type = 11 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * or VirtioNet.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.NetworkInterface.NicType nic_type = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Output only. [Output Only] The name of the network interface, which is
     *           generated by the server.
     *     @type \Google\Cloud\BackupDR\V1beta\AccessConfig[] $access_configs
     *           Optional. An array of configurations for this interface. Currently, only
     *           one access config,ONE_TO_ONE_NAT is supported. If there are no
     *           accessConfigs specified, then this instance will have
     *           no external internet access.
     *     @type \Google\Cloud\BackupDR\V1beta\AccessConfig[] $ipv6_access_configs
     *           Optional. An array of IPv6 access configurations for this interface.
     *           Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there
     *           is no ipv6AccessConfig specified, then this instance will
     *           have no external IPv6 Internet access.
     *     @type \Google\Cloud\BackupDR\V1beta\AliasIpRange[] $alias_ip_ranges
     *           Optional. An array of alias IP ranges for this network interface.
     *           You can only specify this field for network interfaces in VPC networks.
     *     @type int $stack_type
     *           The stack type for this network interface.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AccessConfig access_configs = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\BackupDR\V1beta\AccessConfig>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AccessConfig access_configs = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\AccessConfig[] $var
     * @return $this
     */
    public function setAccessConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BackupDR\V1beta\AccessConfig::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AliasIpRange alias_ip_ranges = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\BackupDR\V1beta\AliasIpRange>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.AliasIpRange alias_ip_ranges = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\AliasIpRange[] $var
     * @return $this
     */
    public function setAliasIpRanges($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BackupDR\V1beta\AliasIpRange::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\NetworkInterface\StackType::class);
        $this->stack_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\NetworkInterface\Ipv6AccessType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\NetworkInterface\NicType::class);
        $this->nic_type = $var;
