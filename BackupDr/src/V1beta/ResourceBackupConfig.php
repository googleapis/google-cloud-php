 ...
 * configurations.
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.ResourceBackupConfig</code>
 */
class ResourceBackupConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ResourceBackupConfig.ResourceType target_resource_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.BackupConfigDetails backup_configs_details = 7;</code>
     */
     ...
     *           Labels associated with the target resource.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupConfigDetails[] $backup_configs_details
     *           Backup configurations applying to the target resource, including those
     *           targeting its related/child resources. For example, backup configuration
     *           applicable to Compute Engine disks will be populated in this field for a
     *           Compute Engine VM which has the disk associated.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\ResourceBackupConfig\ResourceType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.BackupConfigDetails backup_configs_details = 7;</code>
     * @return RepeatedField<\Google\Cloud\BackupDR\V1beta\BackupConfigDetails>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.backupdr.v1beta.BackupConfigDetails backup_configs_details = 7;</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupConfigDetails[] $var
     * @return $this
     */
    public function setBackupConfigsDetails($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BackupDR\V1beta\BackupConfigDetails::class);
