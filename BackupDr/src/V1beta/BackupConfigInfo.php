 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.BackupConfigInfo</code>
 */
class BackupConfigInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigInfo.LastBackupState last_backup_state = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Cloud\BackupDR\V1beta\GcpBackupConfig $gcp_backup_config
     *           Configuration for a Google Cloud resource.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupApplianceBackupConfig $backup_appliance_backup_config
     ...
     * Configuration for a Google Cloud resource.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.GcpBackupConfig gcp_backup_config = 4;</code>
     * @return \Google\Cloud\BackupDR\V1beta\GcpBackupConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.GcpBackupConfig gcp_backup_config = 4;</code>
     * @param \Google\Cloud\BackupDR\V1beta\GcpBackupConfig $var
     * @return $this
     */
    public function setGcpBackupConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\GcpBackupConfig::class);
     ...
     * Configuration for an application backed up by a Backup Appliance.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupApplianceBackupConfig backup_appliance_backup_config = 5;</code>
     * @return \Google\Cloud\BackupDR\V1beta\BackupApplianceBackupConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupApplianceBackupConfig backup_appliance_backup_config = 5;</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupApplianceBackupConfig $var
     * @return $this
     */
    public function setBackupApplianceBackupConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\BackupApplianceBackupConfig::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\BackupConfigInfo\LastBackupState::class);
