 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.ListBackupPlanAssociationsRequest</code>
 */
class ListBackupPlanAssociationsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project and location for which to retrieve backup Plan
     *                       Associations information, in the format
     *                       `projects/{project_id}/locations/{location}`. In Backup and DR, locations
     *                       map to Google Cloud regions, for example **us-central1**. To retrieve
     *                       backup plan associations for all locations, use "-" for the
     ...
     *
     * @return \Google\Cloud\BackupDR\V1beta\ListBackupPlanAssociationsRequest
     *
     * @experimental
     */
