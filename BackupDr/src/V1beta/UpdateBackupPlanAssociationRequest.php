 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.UpdateBackupPlanAssociationRequest</code>
 */
class UpdateBackupPlanAssociationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlanAssociation backup_plan_association = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $backupPlanAssociation Required. The resource being updated
     ...
     *                                                                                   Currently backup_plan_association.backup_plan is the only supported field.
     *
     * @return \Google\Cloud\BackupDR\V1beta\UpdateBackupPlanAssociationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $backupPlanAssociation, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
