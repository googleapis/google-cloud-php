 ...
 * basic view.
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.DataSource</code>
 */
class DataSource extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSource.State state = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigState config_state = 24 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $config_state = 0;
    /**
     * Output only. Details of how the resource is configured for backup.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigInfo backup_config_info = 25 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     *     @type \Google\Cloud\BackupDR\V1beta\DataSourceGcpResource $data_source_gcp_resource
     ...
     *           DataSource object.
     *     @type \Google\Cloud\BackupDR\V1beta\DataSourceBackupApplianceApplication $data_source_backup_appliance_application
     ...
     *           Output only. The backup configuration state.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupConfigInfo $backup_config_info
     *           Output only. Details of how the resource is configured for backup.
     ...
     * DataSource object.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceGcpResource data_source_gcp_resource = 26;</code>
     * @return \Google\Cloud\BackupDR\V1beta\DataSourceGcpResource|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceGcpResource data_source_gcp_resource = 26;</code>
     * @param \Google\Cloud\BackupDR\V1beta\DataSourceGcpResource $var
     * @return $this
     */
    public function setDataSourceGcpResource($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\DataSourceGcpResource::class);
     ...
     * The backed up resource is a backup appliance application.
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceBackupApplianceApplication data_source_backup_appliance_application = 27;</code>
     * @return \Google\Cloud\BackupDR\V1beta\DataSourceBackupApplianceApplication|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.DataSourceBackupApplianceApplication data_source_backup_appliance_application = 27;</code>
     * @param \Google\Cloud\BackupDR\V1beta\DataSourceBackupApplianceApplication $var
     * @return $this
     */
    public function setDataSourceBackupApplianceApplication($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\DataSourceBackupApplianceApplication::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\DataSource\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\BackupConfigState::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigInfo backup_config_info = 25 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\BackupDR\V1beta\BackupConfigInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupConfigInfo backup_config_info = 25 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupConfigInfo $var
     * @return $this
     */
    public function setBackupConfigInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\BackupConfigInfo::class);
