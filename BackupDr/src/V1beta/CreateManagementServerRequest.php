 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.CreateManagementServerRequest</code>
 */
class CreateManagementServerRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementServer management_server = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\BackupDR\V1beta\ManagementServer $managementServer   Required. A [management server
     *                                                                           resource][google.cloud.backupdr.v1.ManagementServer]
     * @param string                                         $managementServerId Required. The name of the management server to create. The name must be
     *                                                                           unique for the specified project and location.
     *
     * @return \Google\Cloud\BackupDR\V1beta\CreateManagementServerRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\BackupDR\V1beta\ManagementServer $managementServer, string $managementServerId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           Required. The name of the management server to create. The name must be
     *           unique for the specified project and location.
     *     @type \Google\Cloud\BackupDR\V1beta\ManagementServer $management_server
     *           Required. A [management server
     *           resource][google.cloud.backupdr.v1.ManagementServer]
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementServer management_server = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BackupDR\V1beta\ManagementServer|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.ManagementServer management_server = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BackupDR\V1beta\ManagementServer $var
     * @return $this
     */
    public function setManagementServer($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\ManagementServer::class);
