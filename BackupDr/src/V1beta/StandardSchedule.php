 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.StandardSchedule</code>
 */
class StandardSchedule extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.StandardSchedule.RecurrenceType recurrence_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WeekDayOfMonth week_day_of_month = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupWindow backup_window = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           `MONTHLY` and `YEARLY`. A validation error will occur if other values are
     *           supplied.
     *     @type \Google\Cloud\BackupDR\V1beta\WeekDayOfMonth $week_day_of_month
     *           Optional. Specifies a week day of the month like, FIRST SUNDAY or LAST
     *           MONDAY, on which jobs will run. This will be specified by two fields in
     *           `WeekDayOfMonth`, one for the day, e.g. `MONDAY`, and one for the week,
     *           e.g. `LAST`.
     ...
     *           This field is only applicable when `recurrence_type` is `YEARLY`. A
     *           validation error will occur if other values are supplied.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupWindow $backup_window
     *           Required. A BackupWindow defines the window of day during which backup jobs
     *           will run. Jobs are queued at the beginning of the window and will be marked
     *           as `NOT_RUN` if they do not start by the end of the window.
     *           Note: running jobs will not be cancelled at the end of the window.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\StandardSchedule\RecurrenceType::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WeekDayOfMonth week_day_of_month = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\BackupDR\V1beta\WeekDayOfMonth|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WeekDayOfMonth week_day_of_month = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\BackupDR\V1beta\WeekDayOfMonth $var
     * @return $this
     */
    public function setWeekDayOfMonth($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\WeekDayOfMonth::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupWindow backup_window = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BackupDR\V1beta\BackupWindow|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupWindow backup_window = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupWindow $var
     * @return $this
     */
    public function setBackupWindow($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\BackupWindow::class);
