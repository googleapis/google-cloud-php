 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.FetchDataSourceReferencesForResourceTypeRequest</code>
 */
class FetchDataSourceReferencesForResourceTypeRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param string $resourceType Required. The type of the Google Cloud resource.
     *                             Ex: sql.googleapis.com/Instance
     *
     * @return \Google\Cloud\BackupDR\V1beta\FetchDataSourceReferencesForResourceTypeRequest
     *
     * @experimental
     */
