 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.WeekDayOfMonth</code>
 */
class WeekDayOfMonth extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.WeekDayOfMonth.WeekOfMonth week_of_month = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\WeekDayOfMonth\WeekOfMonth::class);
