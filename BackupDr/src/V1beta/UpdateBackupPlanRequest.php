 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.UpdateBackupPlanRequest</code>
 */
class UpdateBackupPlanRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlan backup_plan = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\BackupDR\V1beta\BackupPlan $backupPlan Required. The resource being updated
     ...
     *                                                             retention period, adding and removing Backup Rules.
     *
     * @return \Google\Cloud\BackupDR\V1beta\UpdateBackupPlanRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\BackupDR\V1beta\BackupPlan $backupPlan, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
