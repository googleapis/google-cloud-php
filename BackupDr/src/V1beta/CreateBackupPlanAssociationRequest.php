 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.CreateBackupPlanAssociationRequest</code>
 */
class CreateBackupPlanAssociationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlanAssociation backup_plan_association = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $backupPlanAssociation   Required. The resource being created
     * @param string                                              $backupPlanAssociationId Required. The name of the backup plan association to create. The name must
     *                                                                                     be unique for the specified project and location.
     *
     * @return \Google\Cloud\BackupDR\V1beta\CreateBackupPlanAssociationRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $backupPlanAssociation, string $backupPlanAssociationId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           Required. The name of the backup plan association to create. The name must
     *           be unique for the specified project and location.
     *     @type \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $backup_plan_association
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlanAssociation backup_plan_association = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupPlanAssociation backup_plan_association = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation $var
     * @return $this
     */
    public function setBackupPlanAssociation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\BackupPlanAssociation::class);
