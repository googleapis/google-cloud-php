 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.CreateBackupVaultRequest</code>
 */
class CreateBackupVaultRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupVault backup_vault = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\BackupDR\V1beta\BackupVault $backupVault   Required. The resource being created
     * @param string                                    $backupVaultId Required. ID of the requesting object
     *                                                                 If auto-generating ID server-side, remove this field and
     *                                                                 backup_vault_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\BackupDR\V1beta\CreateBackupVaultRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\BackupDR\V1beta\BackupVault $backupVault, string $backupVaultId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           If auto-generating ID server-side, remove this field and
     *           backup_vault_id from the method_signature of Create RPC
     *     @type \Google\Cloud\BackupDR\V1beta\BackupVault $backup_vault
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupVault backup_vault = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\BackupDR\V1beta\BackupVault|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.backupdr.v1beta.BackupVault backup_vault = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\BackupDR\V1beta\BackupVault $var
     * @return $this
     */
    public function setBackupVault($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\BackupDR\V1beta\BackupVault::class);
