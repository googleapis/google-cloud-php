 ...
 *
 * Generated from protobuf message <code>google.cloud.backupdr.v1beta.AccessConfig</code>
 */
class AccessConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * DIRECT_IPV6.
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AccessConfig.AccessType type = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $type = null;
    /**
     ...
     * access
     *
     * Generated from protobuf field <code>optional .google.cloud.backupdr.v1beta.AccessConfig.NetworkTier network_tier = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AccessConfig\AccessType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\BackupDR\V1beta\AccessConfig\NetworkTier::class);
