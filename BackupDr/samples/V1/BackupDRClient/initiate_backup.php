 ...
 * @param string $backupId            Resource ID of the Backup resource.
 */
function initiate_backup_sample(string $formattedDataSource, string $backupId): void
{
    // Create a client.
    ...
    try {
        /** @var InitiateBackupResponse $response */
        $response = $backupDRClient->initiateBackup($request);
...
function callSample(): void
{
    ...
    initiate_backup_sample($formattedDataSource, $backupId);
}
