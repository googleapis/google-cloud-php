 ...
 * deployment.
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1beta.ResourceBundleDeploymentInfo</code>
 */
class ResourceBundleDeploymentInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1beta.ResourceBundleDeploymentInfo.SyncState sync_state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\ConfigDelivery\V1beta\ResourceBundleDeploymentInfo\SyncState::class);
        $this->sync_state = $var;
