 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1beta.ListRolloutsRequest</code>
 */
class ListRolloutsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. Parent value for ListRolloutsRequest
     *                       Please see {@see ConfigDeliveryClient::fleetPackageName()} for help formatting this field.
     *
     * @return \Google\Cloud\ConfigDelivery\V1beta\ListRolloutsRequest
     *
     * @experimental
     */
