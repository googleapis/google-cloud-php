 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1beta.ListReleasesRequest</code>
 */
class ListReleasesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. Parent value for ListReleasesRequest. Please see
     *                       {@see ConfigDeliveryClient::resourceBundleName()} for help formatting this field.
     *
     * @return \Google\Cloud\ConfigDelivery\V1beta\ListReleasesRequest
     *
     * @experimental
     */
