 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1beta.CreateReleaseRequest</code>
 */
class CreateReleaseRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1beta.Release release = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\ConfigDelivery\V1beta\Release $release   Required. The resource being created
     * @param string                                      $releaseId Required. Id of the requesting object
     *                                                               If auto-generating Id server-side, remove this field and
     *                                                               release_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\ConfigDelivery\V1beta\CreateReleaseRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\ConfigDelivery\V1beta\Release $release, string $releaseId): self
    {
        return (new self())
            ->setParent($parent)
            ->setRelease($release)
     ...
     *           If auto-generating Id server-side, remove this field and
     *           release_id from the method_signature of Create RPC
     *     @type \Google\Cloud\ConfigDelivery\V1beta\Release $release
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1beta.Release release = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\ConfigDelivery\V1beta\Release|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1beta.Release release = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\ConfigDelivery\V1beta\Release $var
     * @return $this
     */
    public function setRelease($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\ConfigDelivery\V1beta\Release::class);
        $this->release = $var;
