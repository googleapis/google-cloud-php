 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1.CreateReleaseRequest</code>
 */
class CreateReleaseRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1.Release release = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\ConfigDelivery\V1\Release $release   Required. The resource being created
     * @param string                                  $releaseId Required. Id of the requesting object
     *                                                           If auto-generating Id server-side, remove this field and
     *                                                           release_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\ConfigDelivery\V1\CreateReleaseRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\ConfigDelivery\V1\Release $release, string $releaseId): self
    {
        return (new self())
            ->setParent($parent)
            ->setRelease($release)
