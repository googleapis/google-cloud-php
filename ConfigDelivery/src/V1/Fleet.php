 ...
 *
 * Generated from protobuf message <code>google.cloud.configdelivery.v1.Fleet</code>
 */
class Fleet extends \Google\Protobuf\Internal\Message
{
     ...
     * labels.
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1.Fleet.LabelSelector selector = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Required. The host project for the GKE fleet. Format is
     *           `projects/{project}`.
     *     @type \Google\Cloud\ConfigDelivery\V1\Fleet\LabelSelector $selector
     *           Optional. selector allows targeting a subset of fleet members using their
     *           labels.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1.Fleet.LabelSelector selector = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\ConfigDelivery\V1\Fleet\LabelSelector|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.configdelivery.v1.Fleet.LabelSelector selector = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\ConfigDelivery\V1\Fleet\LabelSelector $var
     * @return $this
     */
    public function setSelector($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\ConfigDelivery\V1\Fleet\LabelSelector::class);
        $this->selector = $var;
