# Google Shopping Merchant Loyalty Customers for PHP

> Idiomatic PHP client for [Google Shopping Merchant Loyalty Customers](https://developers.google.com/merchant/api).
