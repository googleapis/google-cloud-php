 ...
 *
 * Generated from protobuf message <code>google.cloud.audit.BigQueryAuditMetadata.RoutineCreation</code>
 */
class RoutineCreation extends \Google\Protobuf\Internal\Message
{
    /**
     * Created routine.
     *
     ...
     *
     * Generated from protobuf field <code>.google.cloud.audit.BigQueryAuditMetadata.RoutineCreation.Reason reason = 3;</code>
     */
    protected $reason = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Audit\BigQueryAuditMetadata\RoutineCreation\Reason::class);
        $this->reason = $var;
