 ...
 *
 * Generated from protobuf message <code>google.cloud.audit.BigQueryAuditMetadata.TableDeletion</code>
 */
class TableDeletion extends \Google\Protobuf\Internal\Message
{
    /**
     * Describes how table was deleted.
     *
     * Generated from protobuf field <code>.google.cloud.audit.BigQueryAuditMetadata.TableDeletion.Reason reason = 1;</code>
     */
    protected $reason = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Audit\BigQueryAuditMetadata\TableDeletion\Reason::class);
        $this->reason = $var;
