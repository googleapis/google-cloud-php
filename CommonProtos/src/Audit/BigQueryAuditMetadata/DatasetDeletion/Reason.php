...
namespace Google\Cloud\Audit\BigQueryAuditMetadata\DatasetDeletion;
 ...
 *
 * Protobuf type <code>google.cloud.audit.BigQueryAuditMetadata.DatasetDeletion.Reason</code>
 */
class Reason
{
    /**
