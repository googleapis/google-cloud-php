 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.ListClientTlsPoliciesResponse</code>
 */
class ListClientTlsPoliciesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\NetworkSecurity\V1\ClientTlsPolicy::class);
