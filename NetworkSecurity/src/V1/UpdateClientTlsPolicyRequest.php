 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.UpdateClientTlsPolicyRequest</code>
 */
class UpdateClientTlsPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networksecurity.v1.ClientTlsPolicy client_tls_policy = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $client_tls_policy = null;

    /**
     * @param \Google\Cloud\NetworkSecurity\V1\ClientTlsPolicy $clientTlsPolicy Required. Updated ClientTlsPolicy resource.
     ...
     *                                                                          overwritten.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\UpdateClientTlsPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkSecurity\V1\ClientTlsPolicy $clientTlsPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
