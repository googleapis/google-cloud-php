...
namespace Google\Cloud\NetworkSecurity\V1\InterceptEndpointGroupAssociation\LocationDetails;
 ...
 *
 * Protobuf type <code>google.cloud.networksecurity.v1.InterceptEndpointGroupAssociation.LocationDetails.State</code>
 */
class State
{
    /**
