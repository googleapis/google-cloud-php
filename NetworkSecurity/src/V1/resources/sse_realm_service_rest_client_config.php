...
return [
    'interfaces' => [
        ...
        'google.cloud.networksecurity.v1.SSERealmService' => [
            'CreateSACAttachment' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/sacAttachments',
                'body' => 'sac_attachment',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreateSACRealm' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/sacRealms',
                'body' => 'sac_realm',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteSACAttachment' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/sacAttachments/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteSACRealm' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/sacRealms/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
