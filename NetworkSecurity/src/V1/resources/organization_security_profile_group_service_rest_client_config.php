    ...
    'interfaces' => [
        ...
        'google.cloud.networksecurity.v1.OrganizationSecurityProfileGroupService' => [
            'CreateSecurityProfile' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=organizations/*/locations/*}/securityProfiles',
            ...
            'CreateSecurityProfileGroup' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=organizations/*/locations/*}/securityProfileGroups',
            ...
            'DeleteSecurityProfile' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=organizations/*/locations/*/securityProfiles/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteSecurityProfileGroup' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=organizations/*/locations/*/securityProfileGroups/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateSecurityProfile' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{security_profile.name=organizations/*/locations/*/securityProfiles/*}',
                'body' => 'security_profile',
                'placeholders' => [
            ...
            'UpdateSecurityProfileGroup' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{security_profile_group.name=organizations/*/locations/*/securityProfileGroups/*}',
                'body' => 'security_profile_group',
                'placeholders' => [
