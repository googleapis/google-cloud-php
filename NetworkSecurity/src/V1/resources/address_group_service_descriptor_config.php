    ...
    'interfaces' => [
        'google.cloud.networksecurity.v1.AddressGroupService' => [
            'AddAddressGroupItems' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\AddressGroup',
            ...
            'GetAddressGroup' => [
                ...
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\AddressGroup',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListAddressGroupReferences' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getAddressGroupReferences',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListAddressGroupReferencesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'address_group',
                        'fieldAccessors' => [
            ...
            'ListAddressGroups' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getAddressGroups',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListAddressGroupsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
