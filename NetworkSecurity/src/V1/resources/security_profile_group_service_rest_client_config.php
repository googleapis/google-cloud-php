    ...
    'interfaces' => [
        ...
        'google.cloud.networksecurity.v1.SecurityProfileGroupService' => [
            'CreateSecurityProfile' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/securityProfiles',
            ...
            'CreateSecurityProfileGroup' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/securityProfileGroups',
            ...
            'DeleteSecurityProfile' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/securityProfiles/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteSecurityProfileGroup' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/securityProfileGroups/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateSecurityProfile' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{security_profile.name=projects/*/locations/*/securityProfiles/*}',
                'body' => 'security_profile',
                'placeholders' => [
            ...
            'UpdateSecurityProfileGroup' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{security_profile_group.name=projects/*/locations/*/securityProfileGroups/*}',
                'body' => 'security_profile_group',
                'placeholders' => [
