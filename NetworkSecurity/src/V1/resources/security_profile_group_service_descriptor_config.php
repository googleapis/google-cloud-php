    ...
    'interfaces' => [
        'google.cloud.networksecurity.v1.SecurityProfileGroupService' => [
            'CreateSecurityProfile' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\SecurityProfile',
            ...
            'CreateSecurityProfileGroup' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\NetworkSecurity\V1\SecurityProfileGroup',
                    'metadataReturnType' => '\Google\Cloud\NetworkSecurity\V1\OperationMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
            ...
            'UpdateSecurityProfileGroup' => [
                ...
                'headerParams' => [
                    [
                        'keyName' => 'security_profile_group.name',
                        'fieldAccessors' => [
            ...
            'GetSecurityProfile' => [
                ...
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\SecurityProfile',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'GetSecurityProfileGroup' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\SecurityProfileGroup',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'ListSecurityProfileGroups' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getSecurityProfileGroups',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListSecurityProfileGroupsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListSecurityProfiles' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getSecurityProfiles',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\NetworkSecurity\V1\ListSecurityProfilesResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
