    ...
    'interfaces' => [
        ...
        'google.cloud.networksecurity.v1.DnsThreatDetectorService' => [
            'CreateDnsThreatDetector' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/dnsThreatDetectors',
            ...
            'DeleteDnsThreatDetector' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/dnsThreatDetectors/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateDnsThreatDetector' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{dns_threat_detector.name=projects/*/locations/*/dnsThreatDetectors/*}',
                'body' => 'dns_threat_detector',
                'placeholders' => [
