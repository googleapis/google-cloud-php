 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.UpdateServerTlsPolicyRequest</code>
 */
class UpdateServerTlsPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                          overwritten.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\UpdateServerTlsPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkSecurity\V1\ServerTlsPolicy $serverTlsPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
