 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.DeleteUrlListRequest</code>
 */
class DeleteUrlListRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. A name of the UrlList to delete. Must be in
     ...
     *
     * @return \Google\Cloud\NetworkSecurity\V1\DeleteUrlListRequest
     *
     * @experimental
     */
