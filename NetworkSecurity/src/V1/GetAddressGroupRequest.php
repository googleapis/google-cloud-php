 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.GetAddressGroupRequest</code>
 */
class GetAddressGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. A name of the AddressGroup to get. Must be in the format
     ...
     *
     * @return \Google\Cloud\NetworkSecurity\V1\GetAddressGroupRequest
     *
     * @experimental
     */
