 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.DeleteGatewaySecurityPolicyRequest</code>
 */
class DeleteGatewaySecurityPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. A name of the GatewaySecurityPolicy to delete. Must be in the
     ...
     *
     * @return \Google\Cloud\NetworkSecurity\V1\DeleteGatewaySecurityPolicyRequest
     *
     * @experimental
     */
