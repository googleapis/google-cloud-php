 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.UpdateAuthorizationPolicyRequest</code>
 */
class UpdateAuthorizationPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                                  user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\UpdateAuthorizationPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkSecurity\V1\AuthorizationPolicy $authorizationPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
