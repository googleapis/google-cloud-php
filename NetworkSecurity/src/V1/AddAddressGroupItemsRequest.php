 ...
 *
 * Generated from protobuf message <code>google.cloud.networksecurity.v1.AddAddressGroupItemsRequest</code>
 */
class AddAddressGroupItemsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string   $addressGroup Required. A name of the AddressGroup to add items to. Must be in the format
     ...
     * @param string[] $items        Required. List of items to add.
     *
     * @return \Google\Cloud\NetworkSecurity\V1\AddAddressGroupItemsRequest
     *
     * @experimental
     */
