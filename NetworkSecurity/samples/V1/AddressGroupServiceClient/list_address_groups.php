 ...
 *                                {@see AddressGroupServiceClient::locationName()} for help formatting this field.
 */
function list_address_groups_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $addressGroupServiceClient->listAddressGroups($request);
...
{
    $formattedParent = AddressGroupServiceClient::locationName('[PROJECT]', '[LOCATION]');
