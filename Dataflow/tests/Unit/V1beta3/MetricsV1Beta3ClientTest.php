...
class MetricsV1Beta3ClientTest extends GeneratedTest
{
    ...
    public function getJobExecutionDetailsTest()
    {
        ...
        $this->assertEquals($expectedResponse->getStages()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.dataflow.v1beta3.MetricsV1Beta3/GetJobExecutionDetails', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getJobMetricsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.dataflow.v1beta3.MetricsV1Beta3/GetJobMetrics', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getStageExecutionDetailsTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getWorkers()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.dataflow.v1beta3.MetricsV1Beta3/GetStageExecutionDetails', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
