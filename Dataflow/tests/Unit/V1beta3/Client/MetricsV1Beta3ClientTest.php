...
class MetricsV1Beta3ClientTest extends GeneratedTest
{
    ...
    public function getJobExecutionDetailsTest()
    {
        ...
        $response = $gapicClient->getJobExecutionDetails($request);
    ...
    public function getJobExecutionDetailsExceptionTest()
    {
        ...
        $request = new GetJobExecutionDetailsRequest();
        try {
            $gapicClient->getJobExecutionDetails($request);
    ...
    public function getJobMetricsTest()
    {
        ...
        $response = $gapicClient->getJobMetrics($request);
    ...
    public function getJobMetricsExceptionTest()
    {
        ...
        $request = new GetJobMetricsRequest();
        try {
            $gapicClient->getJobMetrics($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getStageExecutionDetailsTest()
    {
        ...
        $response = $gapicClient->getStageExecutionDetails($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
    ...
    public function getStageExecutionDetailsExceptionTest()
    {
        ...
        $request = new GetStageExecutionDetailsRequest();
        try {
            $gapicClient->getStageExecutionDetails($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function getJobExecutionDetailsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        $request = new GetJobExecutionDetailsRequest();
        $response = $gapicClient->getJobExecutionDetailsAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getStages()[0], $resources[0]);
