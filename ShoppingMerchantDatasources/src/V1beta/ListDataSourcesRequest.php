 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1beta.ListDataSourcesRequest</code>
 */
class ListDataSourcesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The account to list data sources for.
     *                       Format: `accounts/{account}`
     *                       Please see {@see DataSourcesServiceClient::accountName()} for help formatting this field.
     *
     * @return \Google\Shopping\Merchant\Datasources\V1beta\ListDataSourcesRequest
     *
     * @experimental
     */
