...
class CreateEnvironmentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\Notebooks\V1\Environment $environment   Required. The environment to be created.
     * @param string                                 $environmentId Required. User-defined unique ID of this environment. The `environment_id` must
     *                                                              be 1 to 63 characters long and contain only lowercase letters,
     *                                                              numeric characters, and dashes. The first character must be a lowercase
     *                                                              letter and the last character cannot be a dash.
     *
     * @return \Google\Cloud\Notebooks\V1\CreateEnvironmentRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Notebooks\V1\Environment $environment, string $environmentId): self
    {
        return (new self())
            ->setParent($parent)
