 ...
 *
 * Protobuf type <code>google.cloud.notebooks.v1.VirtualMachineConfig.NicType</code>
 */
class NicType
{
    /**
...
class_alias(NicType::class, \Google\Cloud\Notebooks\V1\VirtualMachineConfig_NicType::class);
