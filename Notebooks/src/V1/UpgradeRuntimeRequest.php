 ...
 *
 * Generated from protobuf message <code>google.cloud.notebooks.v1.UpgradeRuntimeRequest</code>
 */
class UpgradeRuntimeRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * Required. Format:
     ...
     *                     `projects/{project_id}/locations/{location}/runtimes/{runtime_id}`
     *
     * @return \Google\Cloud\Notebooks\V1\UpgradeRuntimeRequest
     *
     * @experimental
     */
