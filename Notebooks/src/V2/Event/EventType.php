...
namespace Google\Cloud\Notebooks\V2\Event;
 ...
 *
 * Protobuf type <code>google.cloud.notebooks.v2.Event.EventType</code>
 */
class EventType
{
    /**
     ...
     * modified.
     *
     * Generated from protobuf enum <code>METADATA_CHANGE = 5;</code>
     */
    const METADATA_CHANGE = 5;
    ...
    private static $valueToName = [
        ...
        self::METADATA_CHANGE => 'METADATA_CHANGE',
    ];
