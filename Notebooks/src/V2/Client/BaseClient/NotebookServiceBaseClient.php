...
namespace Google\Cloud\Notebooks\V2\Client\BaseClient;
 ...
 * @internal
 *
 * @method PromiseInterface checkInstanceUpgradabilityAsync(CheckInstanceUpgradabilityRequest $request, array $optionalArgs = [])
...
abstract class NotebookServiceBaseClient
{
     ...
     *
     * The async variant is {@see self::checkInstanceUpgradabilityAsync()} .
     *
