...
class PgWriteTest extends SpannerPgTestCase
{
    ...
    public function fieldValueProvider()
    {
        return [
            ...
            [$this->randId(), 'pgjsonbfield', new JsonB('{}')],
            [$this->randId(), 'pgjsonbfield', new JsonB('{"a": 1.1, "b": "def"}')],
        ];
    }
    ...
    public function arrayFieldComplexValueProvider()
    {
        return [
            ...
            [$this->randId(), 'arraypgnumericfield', [new JsonB('{"a":1.1,"b":"hello"}'),null,new JsonB(["a" => 1])]],
        ];
    }
