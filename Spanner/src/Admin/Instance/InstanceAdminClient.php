...
namespace Google\Cloud\Spanner\Admin\Instance;

use Google\Cloud\Core\EmulatorTrait;
use Google\Cloud\Spanner\Admin\Instance\V1\Client\InstanceAdminClient as Client;

/**
 * A wrapper over the Google\Cloud\Spanner\Admin\Instance\V1\Client\InstanceAdminClient
 * to support SPANNER_EMULATOR_HOST environment variable.
 *
 * ```
 * // Using a Spanner Emulator
 * use Google\Cloud\Spanner\Admin\Database\InstanceAdminClient;
 *
 ...
 *
 * $spanner = new InstanceAdminClient();
 * ```
 */
class InstanceAdminClient
{
     ...
     *     {@see Google\Cloud\Spanner\Admin\Instance\V1\Client\InstanceAdminClient}
