...
class InstanceAdminGapicClient
{
     ...
     * ```
     *
     * @param string         $parent           The name of the project in which to create the instance config. Values
     *                                         are of the form `projects/<project>`.
     * @param string         $instanceConfigId The ID of the instance config to create.  Valid identifiers are of the
     ...
     * @param InstanceConfig $instanceConfig   The InstanceConfig proto of the configuration to create.
     ...
     * ```
     *
     * @param string $name         The name of the instance configuration to be deleted.
     ...
     * ```
     *
     * @param InstanceConfig $instanceConfig The user instance config to update, which must always include the instance
     ...
     *                                       be used.
     * @param FieldMask      $updateMask     A mask specifying which fields in
