...
namespace Google\Cloud\Spanner\Admin\Instance\V1\InstancePartition;
 ...
 *
 * Protobuf type <code>google.spanner.admin.instance.v1.InstancePartition.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Spanner\Admin\Instance\V1\InstancePartition_State::class);
