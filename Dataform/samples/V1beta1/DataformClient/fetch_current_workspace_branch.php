 ...
 */
function fetch_current_workspace_branch_sample(string $formattedName): void
{
    // Create a client.
    $dataformClient = new DataformClient();

    // Prepare the request message.
    $request = (new FetchCurrentWorkspaceBranchRequest())
        ->setName($formattedName);

    // Call the API and handle any network failures.
    try {
        /** @var FetchCurrentWorkspaceBranchResponse $response */
        $response = $dataformClient->fetchCurrentWorkspaceBranch($request);
...
function callSample(): void
{
    ...
    fetch_current_workspace_branch_sample($formattedName);
}
