 ...
 */
function fetch_workspace_branches_sample(string $formattedName): void
{
    // Create a client.
    $dataformClient = new DataformClient();

    // Prepare the request message.
    $request = (new FetchWorkspaceBranchesRequest())
        ->setName($formattedName);

    // Call the API and handle any network failures.
    try {
        /** @var PagedListResponse $response */
        $response = $dataformClient->fetchWorkspaceBranches($request);

        /** @var BranchMetadata $element */
...
function callSample(): void
{
    ...
    fetch_workspace_branches_sample($formattedName);
}
