...
// [START dataform_v1beta1_generated_Dataform_DeleteBranch_sync]
 ...
 * @param string $branch        The name of the branch in the Git repository to delete.
 */
function delete_branch_sample(string $formattedName, string $branch): void
{
    // Create a client.
    ...
    try {
        /** @var DeleteBranchResponse $response */
        $response = $dataformClient->deleteBranch($request);
...
function callSample(): void
{
    ...
    delete_branch_sample($formattedName, $branch);
}
// [END dataform_v1beta1_generated_Dataform_DeleteBranch_sync]
