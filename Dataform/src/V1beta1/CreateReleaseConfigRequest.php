 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.CreateReleaseConfigRequest</code>
 */
class CreateReleaseConfigRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                      component of the release config's resource name.
     *
     * @return \Google\Cloud\Dataform\V1beta1\CreateReleaseConfigRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Dataform\V1beta1\ReleaseConfig $releaseConfig, string $releaseConfigId): self
    {
        return (new self())
            ->setParent($parent)
