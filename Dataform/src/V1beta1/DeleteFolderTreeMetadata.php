 ...
 * operations.
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.DeleteFolderTreeMetadata</code>
 */
class DeleteFolderTreeMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1beta1.DeleteFolderTreeMetadata.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataform\V1beta1\DeleteFolderTreeMetadata\State::class);
        $this->state = $var;
