 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.SearchTeamFoldersResponse</code>
 */
class SearchTeamFoldersResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1beta1\SearchTeamFoldersResponse\TeamFolderSearchResult::class);
        $this->results = $arr;
