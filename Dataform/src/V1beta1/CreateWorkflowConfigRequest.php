 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.CreateWorkflowConfigRequest</code>
 */
class CreateWorkflowConfigRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                        final component of the workflow config's resource name.
     *
     * @return \Google\Cloud\Dataform\V1beta1\CreateWorkflowConfigRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Dataform\V1beta1\WorkflowConfig $workflowConfig, string $workflowConfigId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           Required. The repository in which to create the workflow config. Must be in
     *           the format `projects/&#42;&#47;locations/&#42;&#47;repositories/&#42;`.
     *     @type \Google\Cloud\Dataform\V1beta1\WorkflowConfig $workflow_config
     *           Required. The workflow config to create.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1beta1.WorkflowConfig workflow_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dataform\V1beta1\WorkflowConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1beta1.WorkflowConfig workflow_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dataform\V1beta1\WorkflowConfig $var
     * @return $this
     */
    public function setWorkflowConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dataform\V1beta1\WorkflowConfig::class);
