 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1beta1.QueryDirectoryContentsRequest</code>
 */
class QueryDirectoryContentsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1beta1.DirectoryContentsView view = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataform\V1beta1\DirectoryContentsView::class);
        $this->view = $var;
