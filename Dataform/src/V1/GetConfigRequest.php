 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.GetConfigRequest</code>
 */
class GetConfigRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The config name. Please see
     *                     {@see DataformClient::configName()} for help formatting this field.
     *
     * @return \Google\Cloud\Dataform\V1\GetConfigRequest
     *
     * @experimental
     */
