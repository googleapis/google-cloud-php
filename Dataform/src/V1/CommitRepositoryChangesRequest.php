 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.CommitRepositoryChangesRequest</code>
 */
class CommitRepositoryChangesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CommitMetadata commit_metadata = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.dataform.v1.CommitRepositoryChangesRequest.FileOperation> file_operations = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *     @type string $name
     *           Required. The repository's name.
     *     @type \Google\Cloud\Dataform\V1\CommitMetadata $commit_metadata
     *           Required. The changes to commit to the repository.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CommitMetadata commit_metadata = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dataform\V1\CommitMetadata|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.CommitMetadata commit_metadata = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dataform\V1\CommitMetadata $var
     * @return $this
     */
    public function setCommitMetadata($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dataform\V1\CommitMetadata::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1\CommitRepositoryChangesRequest\FileOperation::class);
