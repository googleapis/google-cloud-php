 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.WorkflowConfig</code>
 */
class WorkflowConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.InvocationConfig invocation_config = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dataform\V1\WorkflowConfig\ScheduledExecutionRecord::class);
