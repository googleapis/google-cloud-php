 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.CreateWorkflowInvocationRequest</code>
 */
class CreateWorkflowInvocationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.WorkflowInvocation workflow_invocation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Dataform\V1\WorkflowInvocation $workflowInvocation Required. The workflow invocation resource to create.
     *
     * @return \Google\Cloud\Dataform\V1\CreateWorkflowInvocationRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Dataform\V1\WorkflowInvocation $workflowInvocation): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.WorkflowInvocation workflow_invocation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dataform\V1\WorkflowInvocation|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dataform.v1.WorkflowInvocation workflow_invocation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dataform\V1\WorkflowInvocation $var
     * @return $this
     */
    public function setWorkflowInvocation($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dataform\V1\WorkflowInvocation::class);
