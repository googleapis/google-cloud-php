 ...
 *
 * Generated from protobuf message <code>google.cloud.dataform.v1.CreateRepositoryRequest</code>
 */
class CreateRepositoryRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\Dataform\V1\Repository $repository   Required. The repository to create.
     * @param string                               $repositoryId Required. The ID to use for the repository, which will become the final
     *                                                           component of the repository's resource name.
     *
     * @return \Google\Cloud\Dataform\V1\CreateRepositoryRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Dataform\V1\Repository $repository, string $repositoryId): self
    {
        return (new self())
            ->setParent($parent)
