...
namespace Google\Shopping\Merchant\OrderTracking\V1\OrderTrackingSignal\ShippingInfo;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.ordertracking.v1.OrderTrackingSignal.ShippingInfo.ShippingState</code>
 */
class ShippingState
{
    /**
