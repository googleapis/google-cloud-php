...
namespace Google\Cloud\AssuredWorkloads\V1\Workload\SaaEnrollmentResponse;
 ...
 *
 * Protobuf type <code>google.cloud.assuredworkloads.v1.Workload.SaaEnrollmentResponse.SetupError</code>
 */
class SetupError
{
    /**
