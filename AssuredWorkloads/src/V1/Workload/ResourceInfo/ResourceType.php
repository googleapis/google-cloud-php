...
namespace Google\Cloud\AssuredWorkloads\V1\Workload\ResourceInfo;
 ...
 *
 * Protobuf type <code>google.cloud.assuredworkloads.v1.Workload.ResourceInfo.ResourceType</code>
 */
class ResourceType
{
    /**
