...
namespace Google\Cloud\AssuredWorkloads\V1\Client\BaseClient;
 ...
 */
abstract class AssuredWorkloadsServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.assuredworkloads.v1.AssuredWorkloadsService';
     ...
     * }
     *
     * @return AcknowledgeViolationResponse
     *
