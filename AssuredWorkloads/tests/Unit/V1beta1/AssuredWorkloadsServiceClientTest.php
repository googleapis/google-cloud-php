...
use Google\Cloud\AssuredWorkloads\V1beta1\Workload\ComplianceRegimeSettingsOneof;
...
class AssuredWorkloadsServiceClientTest extends GeneratedTest
{
    ...
    public function createWorkloadTest()
    {
        ...
        $complianceRegimeSettings = new ComplianceRegimeSettingsOneof();
        $complianceRegimeSettings->setCjisSettings(new CJISSettings());
        $workload->setCjisSettings($complianceRegimeSettings);
        $complianceRegimeSettings = new ComplianceRegimeSettingsOneof();
        $complianceRegimeSettings->setFedrampHighSettings(new FedrampHighSettings());
        $workload->setFedrampHighSettings($complianceRegimeSettings);
        $complianceRegimeSettings = new ComplianceRegimeSettingsOneof();
        $complianceRegimeSettings->setFedrampModerateSettings(new FedrampModerateSettings());
        $workload->setFedrampModerateSettings($complianceRegimeSettings);
