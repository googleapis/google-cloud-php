 ...
 *
 * @param string $formattedName The name of the change log entry.
 *                              Format:
 ...
 */
function get_change_log_entry_sample(string $formattedName): void
{
    // Create a client.
    $gDCHardwareManagementClient = new GDCHardwareManagementClient();

    // Prepare the request message.
    $request = (new GetChangeLogEntryRequest())
