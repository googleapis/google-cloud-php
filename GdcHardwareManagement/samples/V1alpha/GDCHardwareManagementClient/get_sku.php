...
// [START gdchardwaremanagement_v1alpha_generated_GDCHardwareManagement_GetSku_sync]
 ...
 *
 * @param string $formattedName The name of the SKU.
 ...
 */
function get_sku_sample(string $formattedName): void
{
    // Create a client.
    $gDCHardwareManagementClient = new GDCHardwareManagementClient();

    // Prepare the request message.
    $request = (new GetSkuRequest())
