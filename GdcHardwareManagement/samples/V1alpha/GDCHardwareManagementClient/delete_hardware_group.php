 ...
 *
 * @param string $formattedName The name of the hardware group.
 *                              Format:
 ...
 */
function delete_hardware_group_sample(string $formattedName): void
{
    // Create a client.
    $gDCHardwareManagementClient = new GDCHardwareManagementClient();

    // Prepare the request message.
    $request = (new DeleteHardwareGroupRequest())
