 ...
 *
 * @param string $formattedParent The order to list change log entries for.
 *                                Format: `projects/{project}/locations/{location}/orders/{order}`
 *                                Please see {@see GDCHardwareManagementClient::orderName()} for help formatting this field.
 */
function list_change_log_entries_sample(string $formattedParent): void
{
    // Create a client.
    $gDCHardwareManagementClient = new GDCHardwareManagementClient();

    // Prepare the request message.
    $request = (new ListChangeLogEntriesRequest())
