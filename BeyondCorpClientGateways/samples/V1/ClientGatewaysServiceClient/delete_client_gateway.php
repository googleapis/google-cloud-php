 ...
 */
function delete_client_gateway_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $clientGatewaysServiceClient->deleteClientGateway($formattedName);
...
function callSample(): void
{
    ...
    delete_client_gateway_sample($formattedName);
}
