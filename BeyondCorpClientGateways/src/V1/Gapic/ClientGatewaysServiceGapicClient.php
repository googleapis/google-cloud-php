...
namespace Google\Cloud\BeyondCorp\ClientGateways\V1\Gapic;
...
class ClientGatewaysServiceGapicClient
{
    ...
    private static $clientGatewayNameTemplate;
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../resources/client_gateways_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/client_gateways_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../resources/client_gateways_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/client_gateways_service_rest_client_config.php',
                ],
            ],
        ];
    }

    private static function getClientGatewayNameTemplate()
    {
        if (self::$clientGatewayNameTemplate == null) {
            self::$clientGatewayNameTemplate = new PathTemplate(
                'projects/{project}/locations/{location}/clientGateways/{client_gateway}'
            );
        }

        return self::$clientGatewayNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (self::$pathTemplateMap == null) {
            self::$pathTemplateMap = [
                'clientGateway' => self::getClientGatewayNameTemplate(),
     ...
     */
    public static function clientGatewayName(
        $project,
        $location,
        $clientGateway
    ) {
        return self::getClientGatewayNameTemplate()->render([
            'project' => $project,
            'location' => $location,
    ...
    public function listClientGateways($parent, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse(
            'ListClientGateways',
            $optionalArgs,
            ListClientGatewaysResponse::class,
            $request
        );
    }
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $clientGatewaysServiceClient->listLocations();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
