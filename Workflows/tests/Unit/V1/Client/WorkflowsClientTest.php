...
namespace Google\Cloud\Workflows\Tests\Unit\V1\Client;
...
class WorkflowsClientTest extends GeneratedTest
{
    ...
    public function createWorkflowTest()
    {
        ...
        $response = $gapicClient->createWorkflow($request);
        ...
        $this->assertSame('/google.cloud.workflows.v1.Workflows/CreateWorkflow', $actualApiFuncCall);
    ...
    public function getWorkflowTest()
    {
        ...
        $this->assertSame('/google.cloud.workflows.v1.Workflows/GetWorkflow', $actualFuncCall);
    ...
    public function listWorkflowsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.workflows.v1.Workflows/ListWorkflows', $actualFuncCall);
    ...
    public function updateWorkflowTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.workflows.v1.Workflows/UpdateWorkflow', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getWorkflow();
        $this->assertProtobufEquals($workflow, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function createWorkflowAsyncTest()
    {
        ...
        $request = (new CreateWorkflowRequest())
            ...
            ->setWorkflow($workflow)
            ->setWorkflowId($workflowId);
        $response = $gapicClient->createWorkflowAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
