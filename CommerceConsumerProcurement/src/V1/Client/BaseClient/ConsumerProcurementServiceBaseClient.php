...
abstract class ConsumerProcurementServiceBaseClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../../resources/consumer_procurement_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../../resources/consumer_procurement_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../../resources/consumer_procurement_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../../resources/consumer_procurement_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function consumerBillingAccountOfferName(
        string $consumerBillingAccount,
        string $offer
    ): string {
     ...
     */
    public static function serviceOfferName(
        string $service,
        string $offer
    ): string {
