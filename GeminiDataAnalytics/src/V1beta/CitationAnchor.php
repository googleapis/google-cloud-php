 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1beta.CitationAnchor</code>
 */
class CitationAnchor extends \Google\Protobuf\Internal\Message
{
     ...
     * Output only. Only set if the citation is for a TextMessage.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.CitationAnchor.TextMessageCitationAnchor text_message_anchor = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
