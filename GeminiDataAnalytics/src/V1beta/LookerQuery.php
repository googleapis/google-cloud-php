...
class LookerQuery extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1beta.DynamicField dynamic_fields = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *     @type string $limit
     *           Optional. Limit in the query.
     *     @type \Google\Cloud\GeminiDataAnalytics\V1beta\DynamicField[] $dynamic_fields
     *           Optional. The dynamic fields used in the query.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1beta.DynamicField dynamic_fields = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\GeminiDataAnalytics\V1beta\DynamicField>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1beta.DynamicField dynamic_fields = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\GeminiDataAnalytics\V1beta\DynamicField[] $var
     * @return $this
     */
    public function setDynamicFields($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\GeminiDataAnalytics\V1beta\DynamicField::class);
