 ...
 */
class CloudSqlReference extends \Google\Protobuf\Internal\Message
{
    /**
     * Required. Singular proto that supports specifying which database and tables
     * to include.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.CloudSqlDatabaseReference database_reference = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\GeminiDataAnalytics\V1beta\CloudSqlDatabaseReference $database_reference
     *           Required. Singular proto that supports specifying which database and tables
     *           to include.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.CloudSqlDatabaseReference database_reference = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\GeminiDataAnalytics\V1beta\CloudSqlDatabaseReference|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.CloudSqlDatabaseReference database_reference = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\GeminiDataAnalytics\V1beta\CloudSqlDatabaseReference $var
     * @return $this
     */
    public function setDatabaseReference($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GeminiDataAnalytics\V1beta\CloudSqlDatabaseReference::class);
