 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1beta.CitationSource</code>
 */
class CitationSource extends \Google\Protobuf\Internal\Message
{
     ...
     * Output only. The example query used as the source.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.ExampleQuery example_query = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     ...
     * Output only. The glossary term used as the source.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1beta.GlossaryTerm glossary_term = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
