 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.DataAgent</code>
 */
class DataAgent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.BigQueryTableReference bigquery_agent_analytics_table = 19 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     *     @type \Google\Cloud\GeminiDataAnalytics\V1\DataAnalyticsAgent $data_analytics_agent
     ...
     *           setting configured through `SetAgentOpsObservability`. An agent does not
     *           inherit that setting.
     *     @type \Google\Cloud\GeminiDataAnalytics\V1\BigQueryTableReference $bigquery_agent_analytics_table
     *           Optional. The BigQuery table that BigQuery Agent Analytics trace rows are
     *           written to. Has no effect unless `bigquery_agent_analytics_enabled` is
     *           `true`. The Preview enrollment described on that field applies here too.
     *           The trace table is validated when it is set on `CreateDataAgent`, or when
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Geminidataanalytics\V1\DataAgent::initOnce();
     ...
     * Data analytics agent.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.DataAnalyticsAgent data_analytics_agent = 101;</code>
     * @return \Google\Cloud\GeminiDataAnalytics\V1\DataAnalyticsAgent|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1.DataAnalyticsAgent data_analytics_agent = 101;</code>
     * @param \Google\Cloud\GeminiDataAnalytics\V1\DataAnalyticsAgent $var
     * @return $this
     */
    public function setDataAnalyticsAgent($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\GeminiDataAnalytics\V1\DataAnalyticsAgent::class);
