 ...
 * sources.
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1.ExampleQuery</code>
 */
class ExampleQuery extends \Google\Protobuf\Internal\Message
{
     ...
     * id.
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1.QueryParameter parameters = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    private $parameters;
    protected $query;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1.QueryParameter parameters = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return RepeatedField<\Google\Cloud\GeminiDataAnalytics\V1\QueryParameter>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.geminidataanalytics.v1.QueryParameter parameters = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\GeminiDataAnalytics\V1\QueryParameter[] $var
     * @return $this
     */
    public function setParameters($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\GeminiDataAnalytics\V1\QueryParameter::class);
        $this->parameters = $arr;
