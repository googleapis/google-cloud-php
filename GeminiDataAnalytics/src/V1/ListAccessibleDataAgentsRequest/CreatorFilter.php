...
namespace Google\Cloud\GeminiDataAnalytics\V1\ListAccessibleDataAgentsRequest;
 ...
 *
 * Protobuf type <code>google.cloud.geminidataanalytics.v1.ListAccessibleDataAgentsRequest.CreatorFilter</code>
 */
class CreatorFilter
{
    /**
