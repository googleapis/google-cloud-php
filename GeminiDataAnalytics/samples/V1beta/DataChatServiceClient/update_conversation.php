 ...
 */
function update_conversation_sample(string $conversationAgentsElement): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $dataChatServiceClient->updateConversation($request);
...
function callSample(): void
{
    ...
    update_conversation_sample($conversationAgentsElement);
}
