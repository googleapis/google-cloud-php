...
use Google\Cloud\GeminiDataAnalytics\V1\DeleteDataAgentRequest;
 ...
 */
function delete_data_agent_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $dataAgentServiceClient->deleteDataAgent($request);
...
function callSample(): void
{
    ...
    delete_data_agent_sample($formattedName);
}
