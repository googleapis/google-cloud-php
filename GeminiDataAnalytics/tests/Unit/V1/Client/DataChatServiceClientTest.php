...
use Google\Cloud\GeminiDataAnalytics\V1\ListConversationsResponse;
use Google\Cloud\GeminiDataAnalytics\V1\ListMessagesRequest;
use Google\Cloud\GeminiDataAnalytics\V1\ListMessagesResponse;
use Google\Cloud\GeminiDataAnalytics\V1\Message;
use Google\Cloud\GeminiDataAnalytics\V1\StorageMessage;
...
class DataChatServiceClientTest extends GeneratedTest
{
    ...
    public function chatTest()
    {
        ...
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/Chat', $actualFuncCall);
    ...
    public function createConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/CreateConversation', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
    ...
    public function deleteConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/DeleteConversation', $actualFuncCall);
    ...
    public function getConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/GetConversation', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listConversationsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/ListConversations', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listMessagesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/ListMessages', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1.DataChatService/UpdateConversation', $actualFuncCall);
        $actualValue = $actualRequestObject->getConversation();
        $this->assertProtobufEquals($conversation, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
