 ...
 *
 * Generated from protobuf message <code>google.cloud.redis.cluster.v1beta1.DiscoveryEndpoint</code>
 */
class DiscoveryEndpoint extends \Google\Protobuf\Internal\Message
{
     ...
     * accessed from.
     *
     * Generated from protobuf field <code>.google.cloud.redis.cluster.v1beta1.PscConfig psc_config = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *     @type int $port
     *           Output only. The port number of the exposed Redis endpoint.
     *     @type \Google\Cloud\Redis\Cluster\V1beta1\PscConfig $psc_config
     *           Output only. Customer configuration for where the endpoint is created and
     *           accessed from.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.cluster.v1beta1.PscConfig psc_config = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @return \Google\Cloud\Redis\Cluster\V1beta1\PscConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.cluster.v1beta1.PscConfig psc_config = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param \Google\Cloud\Redis\Cluster\V1beta1\PscConfig $var
     * @return $this
     */
    public function setPscConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Redis\Cluster\V1beta1\PscConfig::class);
        $this->psc_config = $var;
