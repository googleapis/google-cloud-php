 ...
 *
 * Generated from protobuf message <code>google.cloud.redis.cluster.v1.RescheduleClusterMaintenanceRequest</code>
 */
class RescheduleClusterMaintenanceRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * well.
     *
     * Generated from protobuf field <code>.google.cloud.redis.cluster.v1.RescheduleClusterMaintenanceRequest.RescheduleType reschedule_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param string                     $name           Required. Redis Cluster instance resource name using the form:
     *                                                   `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}`
     ...
     *                                                   well.
     *                                                   For allowed values, use constants defined on {@see \Google\Cloud\Redis\Cluster\V1\RescheduleClusterMaintenanceRequest\RescheduleType}
     * @param \Google\Protobuf\Timestamp $scheduleTime   Optional. Timestamp when the maintenance shall be rescheduled to if
     *                                                   reschedule_type=SPECIFIC_TIME, in RFC 3339 format, for
     *                                                   example `2012-11-15T16:19:00.094Z`.
     *
     * @return \Google\Cloud\Redis\Cluster\V1\RescheduleClusterMaintenanceRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Redis\Cluster\V1\RescheduleClusterMaintenanceRequest\RescheduleType::class);
