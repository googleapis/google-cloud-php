 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/policytroubleshooter/iam/v3/troubleshooter.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\PolicyTroubleshooter\Iam\V3\Client;
...
final class PolicyTroubleshooterClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/policy_troubleshooter_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/policy_troubleshooter_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/policy_troubleshooter_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/policy_troubleshooter_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           use Google\Cloud\PolicyTroubleshooter\Iam\V3\PolicyTroubleshooterClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new PolicyTroubleshooterClient(['credentials' => $creds]);
     *           ```
     *           {@see
