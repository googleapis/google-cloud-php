...
namespace Google\Cloud\VmwareEngine\Tests\Unit\V1\Client;
...
class VmwareEngineClientTest extends GeneratedTest
{
    ...
    public function createHcxActivationKeyTest()
    {
        ...
        $response = $gapicClient->createHcxActivationKey($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createNetworkPolicyTest()
    {
        ...
        $response = $gapicClient->createNetworkPolicy($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createPrivateCloudTest()
    {
        ...
        $response = $gapicClient->createPrivateCloud($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createVmwareEngineNetworkTest()
    {
        ...
        $response = $gapicClient->createVmwareEngineNetwork($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function updatePrivateConnectionTest()
    {
        ...
        $request = (new UpdatePrivateConnectionRequest())
            ->setPrivateConnection($privateConnection)
            ->setUpdateMask($updateMask);
        $response = $gapicClient->updatePrivateConnection($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function updateVmwareEngineNetworkTest()
    {
        ...
        $request = (new UpdateVmwareEngineNetworkRequest())
            ->setVmwareEngineNetwork($vmwareEngineNetwork)
            ->setUpdateMask($updateMask);
        $response = $gapicClient->updateVmwareEngineNetwork($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
