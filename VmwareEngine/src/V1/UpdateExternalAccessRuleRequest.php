 ...
 *
 * Generated from protobuf message <code>google.cloud.vmwareengine.v1.UpdateExternalAccessRuleRequest</code>
 */
class UpdateExternalAccessRuleRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param \Google\Cloud\VmwareEngine\V1\ExternalAccessRule $externalAccessRule Required. Description of the external access rule.
     ...
     *                                                                             user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\VmwareEngine\V1\UpdateExternalAccessRuleRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\VmwareEngine\V1\ExternalAccessRule $externalAccessRule, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
