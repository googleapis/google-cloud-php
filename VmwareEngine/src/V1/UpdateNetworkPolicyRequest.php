 ...
 *
 * Generated from protobuf message <code>google.cloud.vmwareengine.v1.UpdateNetworkPolicyRequest</code>
 */
class UpdateNetworkPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *                                                                   user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\VmwareEngine\V1\UpdateNetworkPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\VmwareEngine\V1\NetworkPolicy $networkPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
