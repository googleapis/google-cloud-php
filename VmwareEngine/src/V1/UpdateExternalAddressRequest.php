 ...
 *
 * Generated from protobuf message <code>google.cloud.vmwareengine.v1.UpdateExternalAddressRequest</code>
 */
class UpdateExternalAddressRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param \Google\Cloud\VmwareEngine\V1\ExternalAddress $externalAddress Required. External IP address description.
     ...
     *                                                                       user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\VmwareEngine\V1\UpdateExternalAddressRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\VmwareEngine\V1\ExternalAddress $externalAddress, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
