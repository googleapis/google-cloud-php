 ...
 *
 * Generated from protobuf message <code>google.cloud.vmwareengine.v1.Hcx</code>
 */
class Hcx extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.vmwareengine.v1.Hcx.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\VmwareEngine\V1\Hcx\State::class);
        $this->state = $var;
