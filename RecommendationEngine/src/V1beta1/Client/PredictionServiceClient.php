...
final class PredictionServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.recommendationengine.v1beta1.PredictionService';
     ...
     * @experimental
     */
    public function predict(PredictRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('Predict', $request, $callOptions);
    }
}
