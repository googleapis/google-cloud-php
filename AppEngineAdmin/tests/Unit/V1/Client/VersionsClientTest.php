...
class VersionsClientTest extends GeneratedTest
{
    ...
    public function createVersionTest()
    {
        ...
        $name = 'name3373707';
        $id = 'id3355';
        $instanceClass = 'instanceClass77208910';
        ...
        $runtimeApiVersion = 'runtimeApiVersion51162572';
        $runtimeMainExecutablePath = 'runtimeMainExecutablePath2027790971';
        $serviceAccount = 'serviceAccount-1948028253';
        $nobuildFilesRegex = 'nobuildFilesRegex935728269';
        $versionUrl = 'versionUrl689431944';
        $expectedResponse = new Version();
        $expectedResponse->setName($name);
        $expectedResponse->setId($id);
        $expectedResponse->setInstanceClass($instanceClass);
        ...
        $expectedResponse->setRuntimeApiVersion($runtimeApiVersion);
        $expectedResponse->setRuntimeMainExecutablePath($runtimeMainExecutablePath);
        $expectedResponse->setServiceAccount($serviceAccount);
        $expectedResponse->setNobuildFilesRegex($nobuildFilesRegex);
        $expectedResponse->setVersionUrl($versionUrl);
        $anyResponse = new Any();
        ...
        $this->assertSame('/google.appengine.v1.Versions/CreateVersion', $actualApiFuncCall);
    ...
    public function deleteVersionTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Versions/DeleteVersion', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getVersionTest()
    {
        ...
        $this->assertSame('/google.appengine.v1.Versions/GetVersion', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listVersionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Versions/ListVersions', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateVersionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateVersionTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $id = 'id3355';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateVersionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Versions/UpdateVersion', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/updateVersionTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function createVersionAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
