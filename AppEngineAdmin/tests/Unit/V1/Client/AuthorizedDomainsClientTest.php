...
class AuthorizedDomainsClientTest extends GeneratedTest
{
    ...
    public function listAuthorizedDomainsTest()
    {
        ...
        $response = $gapicClient->listAuthorizedDomains($request);
    ...
    public function listAuthorizedDomainsExceptionTest()
    {
        ...
        $request = new ListAuthorizedDomainsRequest();
        try {
            $gapicClient->listAuthorizedDomains($request);
    ...
    /** @test */
    public function listAuthorizedDomainsAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        $request = new ListAuthorizedDomainsRequest();
        $response = $gapicClient->listAuthorizedDomainsAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDomains()[0], $resources[0]);
