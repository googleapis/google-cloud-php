...
class FirewallClientTest extends GeneratedTest
{
    ...
    public function batchUpdateIngressRulesTest()
    {
        ...
        $response = $gapicClient->batchUpdateIngressRules($request);
    ...
    public function batchUpdateIngressRulesExceptionTest()
    {
        ...
        $request = new BatchUpdateIngressRulesRequest();
        try {
            $gapicClient->batchUpdateIngressRules($request);
    ...
    public function createIngressRuleTest()
    {
        ...
        $response = $gapicClient->createIngressRule($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createIngressRuleExceptionTest()
    {
        ...
        $request = new CreateIngressRuleRequest();
        try {
            $gapicClient->createIngressRule($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function deleteIngressRuleTest()
    {
        ...
        $gapicClient->deleteIngressRule($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function getIngressRuleTest()
    {
        ...
        $response = $gapicClient->getIngressRule($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getIngressRuleExceptionTest()
    {
        ...
        $request = new GetIngressRuleRequest();
        try {
            $gapicClient->getIngressRule($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listIngressRulesTest()
    {
        ...
        $response = $gapicClient->listIngressRules($request);
    ...
    public function listIngressRulesExceptionTest()
    {
        ...
        $request = new ListIngressRulesRequest();
        try {
            $gapicClient->listIngressRules($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function updateIngressRuleTest()
    {
        ...
        $response = $gapicClient->updateIngressRule($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateIngressRuleExceptionTest()
    {
        ...
        $request = new UpdateIngressRuleRequest();
        try {
            $gapicClient->updateIngressRule($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function batchUpdateIngressRulesAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        $request = new BatchUpdateIngressRulesRequest();
        $response = $gapicClient->batchUpdateIngressRulesAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
