 ...
 * @group gapic
 */
class ApplicationsClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new ApplicationsClient($options);
    }
    ...
    public function createApplicationTest()
    {
        ...
        $name = 'name3373707';
        $id = 'id3355';
        $authDomain = 'authDomain-988231877';
        ...
        $expectedResponse->setAuthDomain($authDomain);
        ...
        $this->assertSame('/google.appengine.v1.Applications/CreateApplication', $actualApiFuncCall);
    ...
    public function getApplicationTest()
    {
        ...
        $this->assertSame('/google.appengine.v1.Applications/GetApplication', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function repairApplicationTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/repairApplicationTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name2 = 'name2-1052831874';
        $id = 'id3355';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/repairApplicationTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $request = new RepairApplicationRequest();
        $response = $gapicClient->repairApplication($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.appengine.v1.Applications/RepairApplication', $actualApiFuncCall);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/repairApplicationTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function repairApplicationExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
