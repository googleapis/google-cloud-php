 ...
 */
abstract class AuthorizedCertificatesBaseClient
{
     ...
     *
     * The async variant is {@see self::createAuthorizedCertificateAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteAuthorizedCertificateAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getAuthorizedCertificateAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listAuthorizedCertificatesAsync()} .
     *
     ...
     * updated.
     *
     * The async variant is {@see self::updateAuthorizedCertificateAsync()} .
     *
