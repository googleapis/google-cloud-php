 ...
 */
abstract class DomainMappingsBaseClient
{
     ...
     *
     * The async variant is {@see self::createDomainMappingAsync()} .
     *
     ...
     * resource.
     *
     * The async variant is {@see self::deleteDomainMappingAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getDomainMappingAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listDomainMappingsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateDomainMappingAsync()} .
     *
