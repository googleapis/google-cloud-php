 ...
 *
 * Generated from protobuf message <code>google.appengine.v1.ListVersionsResponse</code>
 */
class ListVersionsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\AppEngine\V1\Version::class);
        $this->versions = $arr;
