...
class SpeechRecognitionAlternative extends \Google\Protobuf\Internal\Message
{
     ...
     *           to be always provided.
     *           The default of 0.0 is a sentinel value indicating `confidence` was not set.
     *     @type array<\Google\Cloud\Speech\V1p1beta1\WordInfo>|\Google\Protobuf\Internal\RepeatedField $words
     *           A list of word-specific information for each recognized word.
     *           Note: When `enable_speaker_diarization` is true, you will see all the words
     *           from the beginning of the audio.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.speech.v1p1beta1.WordInfo words = 3;</code>
     * @param array<\Google\Cloud\Speech\V1p1beta1\WordInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
