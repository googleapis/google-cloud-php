 ...
 *
 * Generated from protobuf message <code>google.cloud.speech.v2.TranscriptNormalization</code>
 */
class TranscriptNormalization extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Speech\V2\TranscriptNormalization\Entry::class);
        $this->entries = $arr;
