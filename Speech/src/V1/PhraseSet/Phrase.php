...
namespace Google\Cloud\Speech\V1\PhraseSet;
 ...
 * `eu` location value.
 *
 * Generated from protobuf message <code>google.cloud.speech.v1.PhraseSet.Phrase</code>
 */
...
class_alias(Phrase::class, \Google\Cloud\Speech\V1\PhraseSet_Phrase::class);
