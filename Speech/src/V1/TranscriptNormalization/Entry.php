...
namespace Google\Cloud\Speech\V1\TranscriptNormalization;
 ...
 *
 * Generated from protobuf message <code>google.cloud.speech.v1.TranscriptNormalization.Entry</code>
 */
...
class_alias(Entry::class, \Google\Cloud\Speech\V1\TranscriptNormalization_Entry::class);
