 ...
 */
function get_cloud_location_sample(string $formattedName): void
{
    // Create a client.
...
{
    $formattedName = CloudLocationFinderClient::cloudLocationName(
        '[PROJECT]',
        '[LOCATION]',
        '[CLOUD_LOCATION]'
    );

    get_cloud_location_sample($formattedName);
}
