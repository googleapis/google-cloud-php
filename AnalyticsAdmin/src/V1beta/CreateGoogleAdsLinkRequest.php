...
class CreateGoogleAdsLinkRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Analytics\Admin\V1beta\GoogleAdsLink $googleAdsLink Required. The GoogleAdsLink to create.
     *
     * @return \Google\Analytics\Admin\V1beta\CreateGoogleAdsLinkRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Analytics\Admin\V1beta\GoogleAdsLink $googleAdsLink): self
    {
        return (new self())
            ->setParent($parent)
