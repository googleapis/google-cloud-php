 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1beta.CreateKeyEventRequest</code>
 */
class CreateKeyEventRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Analytics\Admin\V1beta\KeyEvent $keyEvent Required. The Key Event to create.
     *
     * @return \Google\Analytics\Admin\V1beta\CreateKeyEventRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Analytics\Admin\V1beta\KeyEvent $keyEvent): self
    {
        return (new self())
            ->setParent($parent)
