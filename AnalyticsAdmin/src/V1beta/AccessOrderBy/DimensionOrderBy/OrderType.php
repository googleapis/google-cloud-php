...
namespace Google\Analytics\Admin\V1beta\AccessOrderBy\DimensionOrderBy;
 ...
 *
 * Protobuf type <code>google.analytics.admin.v1beta.AccessOrderBy.DimensionOrderBy.OrderType</code>
 */
class OrderType
{
    /**
