...
class ChangeHistoryEvent extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Analytics\Admin\V1beta\ActorType::class);
        $this->actor_type = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Admin\V1beta\ChangeHistoryChange::class);
        $this->changes = $arr;
