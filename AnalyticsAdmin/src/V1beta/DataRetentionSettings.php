...
class DataRetentionSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1beta.DataRetentionSettings.RetentionDuration event_data_retention = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $event_data_retention = 0;
    /**
     * Required. The length of time that user-level data is retained.
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1beta.DataRetentionSettings.RetentionDuration user_data_retention = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
