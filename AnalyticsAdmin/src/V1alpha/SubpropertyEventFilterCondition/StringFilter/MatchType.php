...
namespace Google\Analytics\Admin\V1alpha\SubpropertyEventFilterCondition\StringFilter;
 ...
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.SubpropertyEventFilterCondition.StringFilter.MatchType</code>
 */
class MatchType
{
    /**
