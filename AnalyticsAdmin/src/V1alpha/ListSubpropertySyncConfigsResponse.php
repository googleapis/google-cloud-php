 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListSubpropertySyncConfigsResponse</code>
 */
class ListSubpropertySyncConfigsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     */
    private $subproperty_sync_configs;
    /**
    ...
    {
        return $this->subproperty_sync_configs;
    }
     ...
     * @return $this
     */
    public function setSubpropertySyncConfigs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Admin\V1alpha\SubpropertySyncConfig::class);
        $this->subproperty_sync_configs = $arr;
