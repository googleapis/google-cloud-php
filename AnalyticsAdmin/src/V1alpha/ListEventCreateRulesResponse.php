 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListEventCreateRulesResponse</code>
 */
class ListEventCreateRulesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->event_create_rules;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Admin\V1alpha\EventCreateRule::class);
        $this->event_create_rules = $arr;
