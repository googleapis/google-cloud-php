...
namespace Google\Analytics\Admin\V1alpha\AccessOrderBy\DimensionOrderBy;
 ...
 *
 * Protobuf type <code>google.analytics.admin.v1alpha.AccessOrderBy.DimensionOrderBy.OrderType</code>
 */
class OrderType
{
    /**
