 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.GetEventCreateRuleRequest</code>
 */
class GetEventCreateRuleRequest extends \Google\Protobuf\Internal\Message
{
    /**
