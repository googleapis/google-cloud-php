 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.UpdateChannelGroupRequest</code>
 */
class UpdateChannelGroupRequest extends \Google\Protobuf\Internal\Message
{
    /**
