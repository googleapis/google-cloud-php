...
class EnhancedMeasurementSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool content_views_enabled = 6;</code>
     */
    private $content_views_enabled = false;
    /**
     ...
     *
     * Generated from protobuf field <code>bool form_interactions_enabled = 8;</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool data_tagged_element_clicks_enabled = 11;</code>
     */
    private $data_tagged_element_clicks_enabled = false;
    /**
     * If enabled, capture a page view event each time a page loads.
     *
     * Generated from protobuf field <code>bool page_loads_enabled = 12;</code>
     */
     ...
     *
     * Generated from protobuf field <code>bool articles_and_blogs_enabled = 14;</code>
     */
    private $articles_and_blogs_enabled = false;
    /**
     * Capture events when your visitors view content on your site that has
     * product details screens, etc.
     *
     * Generated from protobuf field <code>bool products_and_ecommerce_enabled = 15;</code>
     */
    private $products_and_ecommerce_enabled = false;
    /**
     ...
     *
     * Generated from protobuf field <code>string url_query_parameter = 17;</code>
     */
    private $url_query_parameter = '';
    /**
     * Domains to exclude from measurement. Max length is 1024 characters.
     *
     * Generated from protobuf field <code>string excluded_domains = 18;</code>
     */
     ...
     *           If enabled, capture an outbound click event each time a visitor clicks a
     *           link that leads them away from your domain.
     *     @type bool $content_views_enabled
     *           Capture events when your visitors view content on your site that has
     *           structured data (eg, articles, blog posts, product details screens, etc.).
     ...
     *           If enabled, capture a file download event each time a link is clicked with
     *           a common document, compressed file, application, video, or audio extension.
     *     @type bool $data_tagged_element_clicks_enabled
     *           If enabled, capture a click event each time a visitor clicks a link or
     *           element that has data attributes beginning with "data-ga".
     ...
     *           If enabled, capture a page view event each time the website changes the
     *           browser history state.
     *     @type bool $articles_and_blogs_enabled
     *           Capture events when your visitors view content on your site that has
     *           articles or blog posts.
     *     @type bool $products_and_ecommerce_enabled
     *           Capture events when your visitors view content on your site that has
     *           product details screens, etc.
     ...
     * @return $this
     */
    public function setContentViewsEnabled($var)
    {
        GPBUtil::checkBool($var);
        $this->content_views_enabled = $var;
    ...
    {
        return $this->data_tagged_element_clicks_enabled;
    }
     ...
     * @return $this
     */
    public function setDataTaggedElementClicksEnabled($var)
    {
        GPBUtil::checkBool($var);
        $this->data_tagged_element_clicks_enabled = $var;
    ...
    {
        return $this->articles_and_blogs_enabled;
    }
     ...
     * @return $this
     */
    public function setArticlesAndBlogsEnabled($var)
    {
        GPBUtil::checkBool($var);
        $this->articles_and_blogs_enabled = $var;
    ...
    {
        return $this->products_and_ecommerce_enabled;
    }
     ...
     * @return $this
     */
    public function setProductsAndEcommerceEnabled($var)
    {
        GPBUtil::checkBool($var);
     ...
     * @return $this
     */
    public function setExcludedDomains($var)
    {
        GPBUtil::checkString($var, True);
        $this->excluded_domains = $var;
