 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.BatchUpdateAccessBindingsRequest</code>
 */
class BatchUpdateAccessBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Admin\V1alpha\UpdateAccessBindingRequest::class);
        $this->requests = $arr;
