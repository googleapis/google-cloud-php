 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.KeyEvent</code>
 */
class KeyEvent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1alpha.KeyEvent.CountingMethod counting_method = 6 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $counting_method = 0;
    /**
     * Optional. Defines a default value/currency for a key event.
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1alpha.KeyEvent.DefaultValue default_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Required. The method by which Key Events will be counted across multiple
     *           events within a session.
     *     @type \Google\Analytics\Admin\V1alpha\KeyEvent\DefaultValue $default_value
     *           Optional. Defines a default value/currency for a key event.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Analytics\Admin\V1alpha\KeyEvent\CountingMethod::class);
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1alpha.KeyEvent.DefaultValue default_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Analytics\Admin\V1alpha\KeyEvent\DefaultValue|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.analytics.admin.v1alpha.KeyEvent.DefaultValue default_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Analytics\Admin\V1alpha\KeyEvent\DefaultValue $var
     * @return $this
     */
    public function setDefaultValue($var)
    {
        GPBUtil::checkMessage($var, \Google\Analytics\Admin\V1alpha\KeyEvent\DefaultValue::class);
