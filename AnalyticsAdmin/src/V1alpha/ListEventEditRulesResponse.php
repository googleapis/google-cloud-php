 ...
 *
 * Generated from protobuf message <code>google.analytics.admin.v1alpha.ListEventEditRulesResponse</code>
 */
class ListEventEditRulesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Analytics\Admin\V1alpha\EventEditRule::class);
