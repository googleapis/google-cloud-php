 ...
 */
class UpdateDataRedactionSettingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(\Google\Analytics\Admin\V1alpha\DataRedactionSettings $dataRedactionSettings, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
