 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/sql/v1/cloud_sql_events.proto
...
/**
 * Service Description: Service that exposes Cloud SQL event information. This
 * service is only used internally.
 *
 * This class provides the ability to make remote calls to the backing service through method
 * calls that map to API methods.
 */
final class SqlEventsServiceClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.sql.v1.SqlEventsService';
     ...
     *           use Google\Cloud\Sql\V1\SqlEventsServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SqlEventsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
