 ...
 */
final class SqlInstanceNamesServiceClient
{
     ...
     *           use Google\Cloud\Sql\V1\SqlInstanceNamesServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new SqlInstanceNamesServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
