 ...
 *
 * Generated from protobuf message <code>google.cloud.sql.v1.GetBackupRequest</code>
 */
class GetBackupRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the backup to retrieve.
     *                     Format: projects/{project}/backups/{backup}
     *                     Please see {@see SqlBackupsServiceClient::backupName()} for help formatting this field.
     *
     * @return \Google\Cloud\Sql\V1\GetBackupRequest
     *
     * @experimental
     */
