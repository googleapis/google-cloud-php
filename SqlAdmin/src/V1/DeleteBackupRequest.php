 ...
 *
 * Generated from protobuf message <code>google.cloud.sql.v1.DeleteBackupRequest</code>
 */
class DeleteBackupRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the backup to delete.
     *                     Format: projects/{project}/backups/{backup}
     *                     Please see {@see SqlBackupsServiceClient::backupName()} for help formatting this field.
     *
     * @return \Google\Cloud\Sql\V1\DeleteBackupRequest
     *
     * @experimental
     */
