...
class Settings extends \Google\Protobuf\Internal\Message
{
     ...
     *           use the most recent settingsVersion value for this instance and do not try
     *           to update this value.
     *     @type string[] $authorized_gae_applications
     *           The App Engine app IDs that can access this instance.
     *           (Deprecated) Applied to First Generation instances only.
     *     @type string $tier
     *           The tier (or machine type) for this instance, for example
     ...
     *           better performance. App Engine co-location was only applicable to First
     *           Generation instances.
     *     @type \Google\Cloud\Sql\V1\DatabaseFlags[] $database_flags
     *           The database flags passed to the instance at startup.
     ...
     *           The name of server Instance collation.
     *     @type \Google\Cloud\Sql\V1\DenyMaintenancePeriod[] $deny_maintenance_periods
     *           Deny maintenance periods
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.DatabaseFlags database_flags = 14;</code>
     * @return RepeatedField<\Google\Cloud\Sql\V1\DatabaseFlags>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.DatabaseFlags database_flags = 14;</code>
     * @param \Google\Cloud\Sql\V1\DatabaseFlags[] $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.DenyMaintenancePeriod deny_maintenance_periods = 24;</code>
     * @return RepeatedField<\Google\Cloud\Sql\V1\DenyMaintenancePeriod>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.sql.v1.DenyMaintenancePeriod deny_maintenance_periods = 24;</code>
     * @param \Google\Cloud\Sql\V1\DenyMaintenancePeriod[] $var
     * @return $this
     */
