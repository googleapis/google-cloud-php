 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/sql/v1beta4/cloud_sql_tiers.proto
...
use Google\Cloud\Sql\V1beta4\SqlTiersListRequest;
...
class SqlTiersServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../resources/sql_tiers_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/sql_tiers_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/sql_tiers_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/sql_tiers_service_rest_client_config.php',
                ],
            ],
        ];
    }
