...
namespace Google\Cloud\Sql\V1beta4\SqlInstancesStartExternalSyncRequest;
 ...
 *
 * Protobuf type <code>google.cloud.sql.v1beta4.SqlInstancesStartExternalSyncRequest.ExternalSyncParallelLevel</code>
 */
