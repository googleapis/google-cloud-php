 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.LookupDiscoveredWorkloadRequest</code>
 */
class LookupDiscoveredWorkloadRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Host project ID and location to lookup Discovered Workload in.
     ...
     * @param string $uri    Required. Resource URI to find Discovered Workload for.
     *                       Accepts both project number and project ID and does translation when
     *                       needed.
     *
     * @return \Google\Cloud\AppHub\V1\LookupDiscoveredWorkloadRequest
     *
     * @experimental
     */
