 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.DeleteServiceRequest</code>
 */
class DeleteServiceRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Fully qualified name of the Service to delete from an
     *                     Application. Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\DeleteServiceRequest
     *
     * @experimental
     */
