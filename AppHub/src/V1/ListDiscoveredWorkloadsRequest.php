 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.ListDiscoveredWorkloadsRequest</code>
 */
class ListDiscoveredWorkloadsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Project and location to list Discovered Workloads on.
     ...
     *
     * @return \Google\Cloud\AppHub\V1\ListDiscoveredWorkloadsRequest
     *
     * @experimental
     */
