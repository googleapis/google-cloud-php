 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.ListDiscoveredServicesRequest</code>
 */
class ListDiscoveredServicesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Project and location to list Discovered Services on.
     ...
     *
     * @return \Google\Cloud\AppHub\V1\ListDiscoveredServicesRequest
     *
     * @experimental
     */
