 ...
 *
 * Generated from protobuf message <code>google.cloud.apphub.v1.DeleteApplicationRequest</code>
 */
class DeleteApplicationRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Fully qualified name of the Application to delete.
     *                     Expected format:
     ...
     *
     * @return \Google\Cloud\AppHub\V1\DeleteApplicationRequest
     *
     * @experimental
     */
