...
namespace Google\Cloud\Profiler\V2\Client\BaseClient;
 ...
 */
abstract class ProfilerServiceBaseClient
{
     ...
     * server records it.
     *
     * The async variant is {@see self::createOfflineProfileAsync()} .
     *
     ...
     */
    public function createOfflineProfile(CreateOfflineProfileRequest $request, array $callOptions = []): Profile
    {
        return $this->startApiCall('CreateOfflineProfile', $request, $callOptions)->wait();
    }
