 ...
 *
 * @method PromiseInterface<PagedListResponse> listProfilesAsync(ListProfilesRequest $request, array $optionalArgs = [])
 */
final class ExportServiceClient
{
     ...
     *           $options = new ExportServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
