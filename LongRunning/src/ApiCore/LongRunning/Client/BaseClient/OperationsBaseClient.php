...
namespace Google\ApiCore\LongRunning\Client\BaseClient;
...
class OperationsBaseClient
{
     ...
     *
     * The async variant is {@see self::deleteOperationAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteOperation(DeleteOperationRequest $request, array $optionalArgs = []): void
    {
        $this->startApiCall('DeleteOperation', $request, $optionalArgs)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listOperations(ListOperationsRequest $request, array $optionalArgs = []): PagedListResponse
    {
        return $this->startApiCall('ListOperations', $request, $optionalArgs);
    }
     ...
     *
     * The async variant is {@see self::waitOperationAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function waitOperation(WaitOperationRequest $request, array $optionalArgs = []): Operation
    {
        return $this->startApiCall('WaitOperation', $request, $optionalArgs)->wait();
    }
}
