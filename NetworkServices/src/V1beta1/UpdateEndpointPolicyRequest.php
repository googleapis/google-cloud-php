...
class UpdateEndpointPolicyRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy $endpointPolicy Required. Updated EndpointPolicy resource.
     ...
     *                                                                             user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\NetworkServices\V1beta1\UpdateEndpointPolicyRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\NetworkServices\V1beta1\EndpointPolicy $endpointPolicy, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
