...
class CreateEndpointPolicyRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * @param \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy $endpointPolicy   Required. EndpointPolicy resource to be created.
     * @param string                                               $endpointPolicyId Required. Short name of the EndpointPolicy resource to be created.
     *                                                                               E.g. "CustomECS".
     *
     * @return \Google\Cloud\NetworkServices\V1beta1\CreateEndpointPolicyRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\NetworkServices\V1beta1\EndpointPolicy $endpointPolicy, string $endpointPolicyId): self
    {
        return (new self())
            ->setParent($parent)
