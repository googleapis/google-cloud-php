 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.CreateLbTrafficExtensionRequest</code>
 */
class CreateLbTrafficExtensionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.LbTrafficExtension lb_traffic_extension = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\NetworkServices\V1beta1\LbTrafficExtension $lbTrafficExtension   Required. `LbTrafficExtension` resource to be created.
     * @param string                                                   $lbTrafficExtensionId Required. User-provided ID of the `LbTrafficExtension` resource to be
     *                                                                                       created.
     *
     * @return \Google\Cloud\NetworkServices\V1beta1\CreateLbTrafficExtensionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\NetworkServices\V1beta1\LbTrafficExtension $lbTrafficExtension, string $lbTrafficExtensionId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           Required. User-provided ID of the `LbTrafficExtension` resource to be
     *           created.
     *     @type \Google\Cloud\NetworkServices\V1beta1\LbTrafficExtension $lb_traffic_extension
     *           Required. `LbTrafficExtension` resource to be created.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.LbTrafficExtension lb_traffic_extension = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\NetworkServices\V1beta1\LbTrafficExtension|null
     */
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\NetworkServices\V1beta1\LbTrafficExtension::class);
