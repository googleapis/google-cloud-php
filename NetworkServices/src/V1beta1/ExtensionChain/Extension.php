...
namespace Google\Cloud\NetworkServices\V1beta1\ExtensionChain;
 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.ExtensionChain.Extension</code>
 */
class Extension extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networkservices.v1beta1.EventType supported_events = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\NetworkServices\V1beta1\EventType::class);
