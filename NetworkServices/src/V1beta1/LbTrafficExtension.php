 ...
 * backend service.
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.LbTrafficExtension</code>
 */
class LbTrafficExtension extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networkservices.v1beta1.ExtensionChain extension_chains = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.LoadBalancingScheme load_balancing_scheme = 8 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           service extension is attached to. At least one forwarding rule is required.
     *           There can be only one `LBTrafficExtension` resource per forwarding rule.
     *     @type \Google\Cloud\NetworkServices\V1beta1\ExtensionChain[] $extension_chains
     *           Required. A set of ordered extension chains that contain the match
     *           conditions and extensions to execute. Match conditions for each extension
     *           chain are evaluated in sequence for a given request. The first extension
     *           chain that has a condition that matches the request is executed.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networkservices.v1beta1.ExtensionChain extension_chains = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Cloud\NetworkServices\V1beta1\ExtensionChain>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.networkservices.v1beta1.ExtensionChain extension_chains = 7 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\NetworkServices\V1beta1\ExtensionChain[] $var
     * @return $this
     */
    public function setExtensionChains($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\NetworkServices\V1beta1\ExtensionChain::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\NetworkServices\V1beta1\LoadBalancingScheme::class);
