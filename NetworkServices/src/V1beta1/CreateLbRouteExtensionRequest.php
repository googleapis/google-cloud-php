 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1beta1.CreateLbRouteExtensionRequest</code>
 */
class CreateLbRouteExtensionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.networkservices.v1beta1.LbRouteExtension lb_route_extension = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\NetworkServices\V1beta1\LbRouteExtension $lbRouteExtension   Required. `LbRouteExtension` resource to be created.
     * @param string                                                 $lbRouteExtensionId Required. User-provided ID of the `LbRouteExtension` resource to be
     *                                                                                   created.
     *
     * @return \Google\Cloud\NetworkServices\V1beta1\CreateLbRouteExtensionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\NetworkServices\V1beta1\LbRouteExtension $lbRouteExtension, string $lbRouteExtensionId): self
    {
        return (new self())
            ->setParent($parent)
