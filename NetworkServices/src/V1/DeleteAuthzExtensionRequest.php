 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.DeleteAuthzExtensionRequest</code>
 */
class DeleteAuthzExtensionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the `AuthzExtension` resource to delete. Must
     *                     be in the format
     ...
     *
     * @return \Google\Cloud\NetworkServices\V1\DeleteAuthzExtensionRequest
     *
     * @experimental
     */
