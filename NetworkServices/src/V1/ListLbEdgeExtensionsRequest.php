 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.ListLbEdgeExtensionsRequest</code>
 */
class ListLbEdgeExtensionsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project and location from which the `LbEdgeExtension`
     *                       resources are listed. These values are specified in the following format:
     *                       `projects/{project}/locations/{location}`. Please see
     *                       {@see DepServiceClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\NetworkServices\V1\ListLbEdgeExtensionsRequest
     *
     * @experimental
     */
