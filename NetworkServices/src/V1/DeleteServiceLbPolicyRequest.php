 ...
 *
 * Generated from protobuf message <code>google.cloud.networkservices.v1.DeleteServiceLbPolicyRequest</code>
 */
class DeleteServiceLbPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. A name of the ServiceLbPolicy to delete. Must be in the format
     ...
     *
     * @return \Google\Cloud\NetworkServices\V1\DeleteServiceLbPolicyRequest
     *
     * @experimental
     */
