...
namespace Google\Cloud\NetworkServices\Tests\Unit\V1beta1\Client;
...
use Google\Cloud\NetworkServices\V1beta1\ListExtensionBindingsResponse;
use Google\Cloud\NetworkServices\V1beta1\ListLbRouteExtensionsRequest;
use Google\Cloud\NetworkServices\V1beta1\ListLbRouteExtensionsResponse;
use Google\Cloud\NetworkServices\V1beta1\ListLbTrafficExtensionsRequest;
use Google\Cloud\NetworkServices\V1beta1\ListLbTrafficExtensionsResponse;
...
class DepServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function createExtensionBindingTest()
    {
        ...
        $incompleteOperation->setName('operations/createExtensionBindingTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $description = 'description-1724546052';
        $etag = 'etag3123477';
        $producerExtension = 'producerExtension606148562';
        $failOpen = false;
        $priority = 1165461084;
        $expectedResponse = new ExtensionBinding();
        $expectedResponse->setName($name);
        $expectedResponse->setDescription($description);
        $expectedResponse->setEtag($etag);
        $expectedResponse->setProducerExtension($producerExtension);
        $expectedResponse->setFailOpen($failOpen);
        $expectedResponse->setPriority($priority);
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/createExtensionBindingTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $extensionBindingId = 'extensionBindingId-228989675';
        $extensionBinding = new ExtensionBinding();
        $extensionBindingProducerExtension = 'extensionBindingProducerExtension-1974677465';
        $extensionBinding->setProducerExtension($extensionBindingProducerExtension);
        $extensionBindingTarget = new Target();
        $extensionBinding->setTarget($extensionBindingTarget);
        ...
        $response = $gapicClient->createExtensionBinding($request);
        ...
        $actualValue = $actualApiRequestObject->getExtensionBindingId();
        $this->assertProtobufEquals($extensionBindingId, $actualValue);
        $actualValue = $actualApiRequestObject->getExtensionBinding();
        $this->assertProtobufEquals($extensionBinding, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/createExtensionBindingTest');
    ...
    /** @test */
    public function createExtensionBindingExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function deleteExtensionBindingTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteExtensionBindingTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteExtensionBindingTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->extensionBindingName('[PROJECT]', '[LOCATION]', '[EXTENSION_BINDING]');
        $request = (new DeleteExtensionBindingRequest())->setName($formattedName);
        $response = $gapicClient->deleteExtensionBinding($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deleteExtensionBindingTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function deleteExtensionBindingExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function getExtensionBindingTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->extensionBindingName('[PROJECT]', '[LOCATION]', '[EXTENSION_BINDING]');
        $request = (new GetExtensionBindingRequest())->setName($formattedName);
        $response = $gapicClient->getExtensionBinding($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/GetExtensionBinding', $actualFuncCall);
    ...
    /** @test */
    public function getExtensionBindingExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetExtensionBindingRequest())->setName($formattedName);
        try {
            $gapicClient->getExtensionBinding($request);
    ...
    public function getLbRouteExtensionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/GetLbRouteExtension', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getLbTrafficExtensionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/GetLbTrafficExtension', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listExtensionBindingsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $extensionBindingsElement = new ExtensionBinding();
        $extensionBindings = [$extensionBindingsElement];
        $expectedResponse = new ListExtensionBindingsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setExtensionBindings($extensionBindings);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListExtensionBindingsRequest())->setParent($formattedParent);
        $response = $gapicClient->listExtensionBindings($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getExtensionBindings()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/ListExtensionBindings', $actualFuncCall);
    ...
    /** @test */
    public function listExtensionBindingsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new ListExtensionBindingsRequest())->setParent($formattedParent);
        try {
            $gapicClient->listExtensionBindings($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listLbRouteExtensionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/ListLbRouteExtensions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listLbTrafficExtensionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.networkservices.v1beta1.DepService/ListLbTrafficExtensions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function updateExtensionBindingTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateExtensionBindingTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $description = 'description-1724546052';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateExtensionBindingTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $extensionBindingTarget = new Target();
        $extensionBinding->setTarget($extensionBindingTarget);
        $request = (new UpdateExtensionBindingRequest())->setExtensionBinding($extensionBinding);
        $response = $gapicClient->updateExtensionBinding($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $this->assertProtobufEquals($extensionBinding, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/updateExtensionBindingTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    /** @test */
    public function updateExtensionBindingExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function createExtensionBindingAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $request = (new CreateExtensionBindingRequest())
            ...
            ->setExtensionBindingId($extensionBindingId)
            ->setExtensionBinding($extensionBinding);
        $response = $gapicClient->createExtensionBindingAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
