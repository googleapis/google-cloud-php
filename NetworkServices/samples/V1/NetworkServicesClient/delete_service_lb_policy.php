 ...
 *
 * @param string $formattedName A name of the ServiceLbPolicy to delete. Must be in the format
 ...
 */
function delete_service_lb_policy_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkServicesClient->deleteServiceLbPolicy($request);
...
function callSample(): void
{
    ...
    delete_service_lb_policy_sample($formattedName);
}
