 ...
 *
 * @param string $formattedParent The project and location from which the AgentGateways should be
 ...
 */
function list_agent_gateways_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $networkServicesClient->listAgentGateways($request);

        /** @var AgentGateway $element */
...
function callSample(): void
{
    ...
    list_agent_gateways_sample($formattedParent);
}
