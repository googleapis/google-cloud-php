...
namespace Google\Cloud\Lustre\Tests\Unit\V1\Client;
...
use Google\Cloud\Lustre\V1\ListInstancesResponse;
 ...
 * @group gapic
 */
class LustreClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new LustreClient($options);
    }
    ...
    public function createInstanceTest()
    {
        ...
        $name = 'name3373707';
        $filesystem = 'filesystem-1572513109';
        $capacityGib = 498394811;
        $network = 'network1843485230';
        $mountPoint = 'mountPoint1477295594';
        $description = 'description-1724546052';
        $perUnitStorageThroughput = 946502681;
        $gkeSupportEnabled = false;
        $expectedResponse = new Instance();
        $expectedResponse->setName($name);
        $expectedResponse->setFilesystem($filesystem);
        $expectedResponse->setCapacityGib($capacityGib);
        $expectedResponse->setNetwork($network);
        $expectedResponse->setMountPoint($mountPoint);
        $expectedResponse->setDescription($description);
        $expectedResponse->setPerUnitStorageThroughput($perUnitStorageThroughput);
        $expectedResponse->setGkeSupportEnabled($gkeSupportEnabled);
        $anyResponse = new Any();
        ...
        $instanceFilesystem = 'instanceFilesystem924898592';
        $instance->setFilesystem($instanceFilesystem);
        $instanceCapacityGib = 1813257007;
        ...
        $this->assertSame('/google.cloud.lustre.v1.Lustre/CreateInstance', $actualApiFuncCall);
    ...
    public function deleteInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.lustre.v1.Lustre/DeleteInstance', $actualApiFuncCall);
    ...
    public function exportDataTest()
    {
        ...
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new ExportDataResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        ...
        // Mock request
        $formattedName = $gapicClient->instanceName('[PROJECT]', '[LOCATION]', '[INSTANCE]');
        $request = (new ExportDataRequest())->setName($formattedName);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.lustre.v1.Lustre/ExportData', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function getInstanceTest()
    {
        ...
        $this->assertSame('/google.cloud.lustre.v1.Lustre/GetInstance', $actualFuncCall);
    ...
    public function importDataTest()
    {
        ...
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $expectedResponse = new ImportDataResponse();
        $anyResponse = new Any();
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        ...
        // Mock request
        $formattedName = $gapicClient->instanceName('[PROJECT]', '[LOCATION]', '[INSTANCE]');
        $request = (new ImportDataRequest())->setName($formattedName);
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.lustre.v1.Lustre/ImportData', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function listInstancesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.lustre.v1.Lustre/ListInstances', $actualFuncCall);
    ...
    public function updateInstanceTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.lustre.v1.Lustre/UpdateInstance', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getInstance();
        $this->assertProtobufEquals($instance, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
