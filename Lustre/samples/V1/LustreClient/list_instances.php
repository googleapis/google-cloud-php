 ...
 *
 * @param string $formattedParent The project and location for which to retrieve a list of
...
function list_instances_sample(string $formattedParent): void
{
    ...
    try {
        ...
        $response = $lustreClient->listInstances($request);
