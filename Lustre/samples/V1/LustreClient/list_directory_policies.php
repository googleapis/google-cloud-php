 ...
 */
function list_directory_policies_sample(string $formattedParent): void
{
    // Create a client.
    $lustreClient = new LustreClient();

    // Prepare the request message.
    $request = (new ListDirectoryPoliciesRequest())
        ->setParent($formattedParent);

    // Call the API and handle any network failures.
    try {
        /** @var PagedListResponse $response */
        $response = $lustreClient->listDirectoryPolicies($request);

        /** @var DirectoryPolicy $element */
...
function callSample(): void
{
    ...
    list_directory_policies_sample($formattedParent);
}
