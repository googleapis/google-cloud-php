 ...
 *
 * Generated from protobuf message <code>google.cloud.lustre.v1.DeleteMirrorRequest</code>
 */
class DeleteMirrorRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Name of the mirror to delete, in the format:
     *                     `projects/{project}/locations/{location}/instances/{instance}/mirrors/{mirror}`
     *                     Please see {@see LustreClient::mirrorName()} for help formatting this field.
     *
     * @return \Google\Cloud\Lustre\V1\DeleteMirrorRequest
     *
     * @experimental
     */
