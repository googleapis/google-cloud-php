 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.DeleteBacktestResultRequest</code>
 */
class DeleteBacktestResultRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of the BacktestResult. Please see
     *                     {@see AMLClient::backtestResultName()} for help formatting this field.
     *
     * @return \Google\Cloud\FinancialServices\V1\DeleteBacktestResultRequest
     *
     * @experimental
     */
