 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.GetModelRequest</code>
 */
class GetModelRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Model
     *                     Please see {@see AMLClient::modelName()} for help formatting this field.
     *
     * @return \Google\Cloud\FinancialServices\V1\GetModelRequest
     *
     * @experimental
     */
