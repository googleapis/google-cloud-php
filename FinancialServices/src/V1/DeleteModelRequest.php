 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.DeleteModelRequest</code>
 */
class DeleteModelRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The resource name of the Model. Please see
     *                     {@see AMLClient::modelName()} for help formatting this field.
     *
     * @return \Google\Cloud\FinancialServices\V1\DeleteModelRequest
     *
     * @experimental
     */
