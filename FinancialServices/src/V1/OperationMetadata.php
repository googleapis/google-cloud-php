 ...
 *
 * Generated from protobuf message <code>google.cloud.financialservices.v1.OperationMetadata</code>
 */
class OperationMetadata extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Financialservices\V1\Service::initOnce();
