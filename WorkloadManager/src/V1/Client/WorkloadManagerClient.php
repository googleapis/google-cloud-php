 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/workloadmanager/v1/service.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Cloud\WorkloadManager\V1\Client;
 ...
 *
 * @method PromiseInterface<OperationResponse> createEvaluationAsync(CreateEvaluationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> deleteEvaluationAsync(DeleteEvaluationRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface<PagedListResponse> listExecutionResultsAsync(ListExecutionResultsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listExecutionsAsync(ListExecutionsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<ListRulesResponse> listRulesAsync(ListRulesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listScannedResourcesAsync(ListScannedResourcesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> runEvaluationAsync(RunEvaluationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> updateEvaluationAsync(UpdateEvaluationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<Location> getLocationAsync(GetLocationRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listLocationsAsync(ListLocationsRequest $request, array $optionalArgs = [])
 */
final class WorkloadManagerClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.workloadmanager.v1.WorkloadManager';
     ...
     */
    private const SERVICE_ADDRESS = 'workloadmanager.googleapis.com';

    /** The address template of the service. */
    private const SERVICE_ADDRESS_TEMPLATE = 'workloadmanager.UNIVERSE_DOMAIN';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/workload_manager_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/workload_manager_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/workload_manager_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/workload_manager_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function evaluationName(string $project, string $location, string $evaluation): string
    {
     ...
     *           as "<uri>:<port>". Default 'workloadmanager.googleapis.com:443'.
     ...
     *           use Google\Cloud\WorkloadManager\V1\WorkloadManagerClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new WorkloadManagerClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see WorkloadManagerClient::createEvaluationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/create_evaluation.php
     *
     ...
     */
    public function createEvaluation(CreateEvaluationRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see WorkloadManagerClient::deleteEvaluationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/delete_evaluation.php
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteEvaluation(DeleteEvaluationRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteEvaluation', $request, $callOptions)->wait();
    }

    /**
     * Deletes a single Execution.
     *
     * The async variant is {@see WorkloadManagerClient::deleteExecutionAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/delete_execution.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::getEvaluationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/get_evaluation.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::getExecutionAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/get_execution.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::listEvaluationsAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/list_evaluations.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::listExecutionResultsAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/list_execution_results.php
     *
     * @param ListExecutionResultsRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listExecutionResults(
        ListExecutionResultsRequest $request,
        array $callOptions = []
    ): PagedListResponse {
        return $this->startApiCall('ListExecutionResults', $request, $callOptions);
    }

    /**
     * Lists Executions in a given project and location.
     *
     * The async variant is {@see WorkloadManagerClient::listExecutionsAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/list_executions.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::listRulesAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/list_rules.php
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listRules(ListRulesRequest $request, array $callOptions = []): ListRulesResponse
    {
        return $this->startApiCall('ListRules', $request, $callOptions)->wait();
    }

    /**
     * List all scanned resources for a single Execution.
     *
     * The async variant is {@see WorkloadManagerClient::listScannedResourcesAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/list_scanned_resources.php
     *
     * @param ListScannedResourcesRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listScannedResources(
        ListScannedResourcesRequest $request,
        array $callOptions = []
    ): PagedListResponse {
        return $this->startApiCall('ListScannedResources', $request, $callOptions);
    }

    /**
     * Creates a new Execution in a given project and location.
     *
     * The async variant is {@see WorkloadManagerClient::runEvaluationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/run_evaluation.php
     *
     ...
     *
     * The async variant is {@see WorkloadManagerClient::updateEvaluationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/update_evaluation.php
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateEvaluation(UpdateEvaluationRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     *
     * The async variant is {@see WorkloadManagerClient::getLocationAsync()} .
     *
     * @example samples/V1/WorkloadManagerClient/get_location.php
     *
    ...
    *   **List project-visible locations:** Use the path
     ...
     *
     * @example samples/V1/WorkloadManagerClient/list_locations.php
     *
