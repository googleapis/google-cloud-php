...
use Google\Cloud\Geminidataanalytics\V1alpha\ChatRequest;
...
use Google\Cloud\Geminidataanalytics\V1alpha\CreateConversationRequest;
use Google\Cloud\Geminidataanalytics\V1alpha\GetConversationRequest;
use Google\Cloud\Geminidataanalytics\V1alpha\ListConversationsRequest;
use Google\Cloud\Geminidataanalytics\V1alpha\ListConversationsResponse;
use Google\Cloud\Geminidataanalytics\V1alpha\ListMessagesRequest;
use Google\Cloud\Geminidataanalytics\V1alpha\ListMessagesResponse;
use Google\Cloud\Geminidataanalytics\V1alpha\Message;
use Google\Cloud\Geminidataanalytics\V1alpha\StorageMessage;
 ...
 * @group gapic
 */
class DataChatServiceClientTest extends GeneratedTest
{
    ...
    /** @return DataChatServiceClient */
    private function createClient(array $options = [])
    {
        $options += [
            'credentials' => $this->createCredentials(),
        ];
        return new DataChatServiceClient($options);
    }
    ...
    public function chatTest()
    {
        ...
        // Mock response
        $messageId = 'messageId-1690722221';
        $expectedResponse = new Message();
        $expectedResponse->setMessageId($messageId);
        $transport->addResponse($expectedResponse);
        $messageId2 = 'messageId2-1286413498';
        $expectedResponse2 = new Message();
        $expectedResponse2->setMessageId($messageId2);
        $transport->addResponse($expectedResponse2);
        $messageId3 = 'messageId3-1286413497';
        $expectedResponse3 = new Message();
        $expectedResponse3->setMessageId($messageId3);
        $transport->addResponse($expectedResponse3);
        // Mock request
        $parent = 'parent-995424086';
        $messages = [];
        $request = (new ChatRequest())->setParent($parent)->setMessages($messages);
        $serverStream = $gapicClient->chat($request);
        ...
        $this->assertSame('/google.cloud.geminidataanalytics.v1alpha.DataChatService/Chat', $actualFuncCall);
    ...
    public function getConversationTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1alpha.DataChatService/GetConversation', $actualFuncCall);
    ...
    public function listMessagesTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $messagesElement = new StorageMessage();
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.geminidataanalytics.v1alpha.DataChatService/ListMessages', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function createConversationAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $conversation->setAgents($conversationAgents);
        $request = (new CreateConversationRequest())->setParent($formattedParent)->setConversation($conversation);
        $response = $gapicClient->createConversationAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
