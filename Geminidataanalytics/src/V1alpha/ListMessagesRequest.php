 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1alpha.ListMessagesRequest</code>
 */
class ListMessagesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The conversation to list messages under.
     *                       Format:
     *                       projects/{project}/locations/{location}/conversations/{conversation_id}
     *                       Please see {@see DataChatServiceClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\Geminidataanalytics\V1alpha\ListMessagesRequest
     *
     * @experimental
     */
