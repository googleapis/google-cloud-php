    ...
    'interfaces' => [
        'google.cloud.geminidataanalytics.v1alpha.ContextRetrievalService' => [
            'RetrieveBigQueryRecentRelevantTables' => [
                'method' => 'post',
                'uriTemplate' => '/v1alpha/{parent=projects/*/locations/*}/retrieval:retrieveBigQueryRecentRelevantTables',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'RetrieveBigQueryTableContext' => [
                'method' => 'post',
                'uriTemplate' => '/v1alpha/{parent=projects/*/locations/*}:retrieveBigQueryTableContext',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'RetrieveBigQueryTableContextsFromRecentTables' => [
                'method' => 'post',
                'uriTemplate' => '/v1alpha/{parent=projects/*/locations/*}:retrieveBigQueryTableContextsFromRecentTables',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'RetrieveBigQueryTableSuggestedDescriptions' => [
                'method' => 'post',
                'uriTemplate' => '/v1alpha/{parent=projects/*/locations/*}/retrieval:retrieveBigQueryTableSuggestedDescriptions',
                'body' => '*',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
