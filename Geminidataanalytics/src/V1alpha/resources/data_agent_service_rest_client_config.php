...
return [
    'interfaces' => [
        'google.cloud.geminidataanalytics.v1alpha.DataAgentService' => [
            'CreateDataAgent' => [
                'method' => 'post',
                'uriTemplate' => '/v1alpha/{parent=projects/*/locations/*}/dataAgents',
                'body' => 'data_agent',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteDataAgent' => [
                'method' => 'delete',
                'uriTemplate' => '/v1alpha/{name=projects/*/locations/*/dataAgents/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateDataAgent' => [
                'method' => 'patch',
                'uriTemplate' => '/v1alpha/{data_agent.name=projects/*/locations/*/dataAgents/*}',
                'body' => 'data_agent',
                'placeholders' => [
                    'data_agent.name' => [
                        'getters' => [
