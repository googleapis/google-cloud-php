...
# source: google/cloud/geminidataanalytics/v1alpha/data_agent.proto
 ...
 *
 * Generated from protobuf message <code>google.cloud.geminidataanalytics.v1alpha.DataAgent</code>
 */
class DataAgent extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Geminidataanalytics\V1alpha\DataAnalyticsAgent $data_analytics_agent
     ...
     * Data analytics agent.
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1alpha.DataAnalyticsAgent data_analytics_agent = 101;</code>
     * @return \Google\Cloud\Geminidataanalytics\V1alpha\DataAnalyticsAgent|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.geminidataanalytics.v1alpha.DataAnalyticsAgent data_analytics_agent = 101;</code>
     * @param \Google\Cloud\Geminidataanalytics\V1alpha\DataAnalyticsAgent $var
     * @return $this
     */
    public function setDataAnalyticsAgent($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Geminidataanalytics\V1alpha\DataAnalyticsAgent::class);
