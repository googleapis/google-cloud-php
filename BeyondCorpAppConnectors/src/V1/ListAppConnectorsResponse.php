 ...
 *
 * Generated from protobuf message <code>google.cloud.beyondcorp.appconnectors.v1.ListAppConnectorsResponse</code>
 */
class ListAppConnectorsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\BeyondCorp\AppConnectors\V1\AppConnector::class);
        $this->app_connectors = $arr;
