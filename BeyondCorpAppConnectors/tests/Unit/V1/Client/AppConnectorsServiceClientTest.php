...
namespace Google\Cloud\BeyondCorp\AppConnectors\Tests\Unit\V1\Client;
...
class AppConnectorsServiceClientTest extends GeneratedTest
{
    ...
    public function createAppConnectorTest()
    {
        ...
        $incompleteOperation->setName('operations/createAppConnectorTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        $uid = 'uid115792';
        $expectedResponse = new AppConnector();
        ...
        $completeOperation->setName('operations/createAppConnectorTest');
        ...
        $request = (new CreateAppConnectorRequest())->setParent($formattedParent)->setAppConnector($appConnector);
        $response = $gapicClient->createAppConnector($request);
    ...
    public function deleteAppConnectorTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteAppConnectorTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteAppConnectorTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $response = $gapicClient->deleteAppConnector($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function getAppConnectorTest()
    {
        ...
        $response = $gapicClient->getAppConnector($request);
    ...
    public function getAppConnectorExceptionTest()
    {
        ...
        $request = (new GetAppConnectorRequest())->setName($formattedName);
        try {
            $gapicClient->getAppConnector($request);
    ...
    public function listAppConnectorsTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $appConnectorsElement = new AppConnector();
        $appConnectors = [$appConnectorsElement];
        $expectedResponse = new ListAppConnectorsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setAppConnectors($appConnectors);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListAppConnectorsRequest())->setParent($formattedParent);
        $response = $gapicClient->listAppConnectors($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getAppConnectors()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listAppConnectorsExceptionTest()
    {
        ...
        $request = (new ListAppConnectorsRequest())->setParent($formattedParent);
        try {
            $gapicClient->listAppConnectors($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function reportStatusTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/reportStatusTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/reportStatusTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $request = (new ReportStatusRequest())->setAppConnector($formattedAppConnector)->setResourceInfo($resourceInfo);
        $response = $gapicClient->reportStatus($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function updateAppConnectorTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateAppConnectorTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateAppConnectorTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $appConnectorPrincipalInfo = new PrincipalInfo();
        $appConnector->setPrincipalInfo($appConnectorPrincipalInfo);
        $request = (new UpdateAppConnectorRequest())->setUpdateMask($updateMask)->setAppConnector($appConnector);
        $response = $gapicClient->updateAppConnector($request);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    /** @test */
    public function createAppConnectorAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $appConnector->setPrincipalInfo($appConnectorPrincipalInfo);
        $request = (new CreateAppConnectorRequest())->setParent($formattedParent)->setAppConnector($appConnector);
        $response = $gapicClient->createAppConnectorAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
