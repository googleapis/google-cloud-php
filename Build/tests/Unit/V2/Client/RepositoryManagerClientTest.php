...
namespace Google\Cloud\Build\Tests\Unit\V2\Client;
...
use Google\Cloud\Build\V2\ListConnectionsResponse;
use Google\Cloud\Build\V2\ListRepositoriesRequest;
use Google\Cloud\Build\V2\ListRepositoriesResponse;
 ...
 * @group gapic
 */
class RepositoryManagerClientTest extends GeneratedTest
{
