...
namespace Google\Cloud\Vision\V1\Client\BaseClient;
 ...
 */
abstract class ProductSearchBaseClient
{
     ...
     *
     * The async variant is {@see self::addProductToProductSetAsync()} .
     *
     ...
     * 4096 characters.
     *
     * The async variant is {@see self::createProductSetAsync()} .
     *
     ...
     *
     * The async variant is {@see self::createReferenceImageAsync()} .
     *
     ...
     * The actual image files are not deleted from Google Cloud Storage.
     *
     * The async variant is {@see self::deleteReferenceImageAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getProductSetAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getReferenceImageAsync()} .
     *
     ...
     *
     * The async variant is {@see self::importProductSetsAsync()} .
     *
     ...
     * than 1.
     *
     * The async variant is {@see self::listProductSetsAsync()} .
     *
     ...
     * * Returns INVALID_ARGUMENT if page_size is greater than 100 or less than 1.
     *
     * The async variant is {@see self::listProductsInProductSetAsync()} .
     *
     ...
     * than 1.
     *
     * The async variant is {@see self::listReferenceImagesAsync()} .
     *
     ...
     * `Operation.metadata` contains `BatchOperationMetadata`. (progress)
     *
     * The async variant is {@see self::purgeProductsAsync()} .
     *
     ...
     *
     * The async variant is {@see self::removeProductFromProductSetAsync()} .
     *
     ...
     * missing from the request or longer than 4096 characters.
     *
     * The async variant is {@see self::updateProductSetAsync()} .
     *
