...
key (	
value (	:8:tÍAq
run.googleapis.com/RevisionOprojects/{project}/locations/{location}/services/{service}/revisions/{revision}R2ƒ
	Revisionsí
GetRevision\'.google.cloud.run.v2.GetRevisionRequest.google.cloud.run.v2.Revision"∫⁄AnameÇ”‰ìy8/v2/{name=projects/*/locations/*/services/*/revisions/*}Z=;/v2/{name=projects/*/locations/*/workerPools/*/revisions/*}ä”‰ì.,
name$projects/*/locations/{location=*}/**ß
ListRevisions).google.cloud.run.v2.ListRevisionsRequest*.google.cloud.run.v2.ListRevisionsResponse"æ⁄AparentÇ”‰ìy8/v2/{parent=projects/*/locations/*/services/*}/revisionsZ=;/v2/{parent=projects/*/locations/*/workerPools/*}/revisionsä”‰ì0.
parent$projects/*/locations/{location=*}/**Ø
DeleteRevision*.google.cloud.run.v2.DeleteRevisionRequest.google.longrunning.Operation"— A
RevisionRevision⁄AnameÇ”‰ìy*8/v2/{name=projects/*/locations/*/services/*/revisions/*}Z=*;/v2/{name=projects/*/locations/*/workerPools/*/revisions/*}ä”‰ì.,
