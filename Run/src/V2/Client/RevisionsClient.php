...
final class RevisionsClient
{
     ...
     *           $options = new RevisionsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<Revision>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteRevision(DeleteRevisionRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeleteRevision', $request, $callOptions)->wait();
    }
