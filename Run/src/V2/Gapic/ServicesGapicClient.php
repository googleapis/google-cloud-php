 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Run\V2\Client\ServicesClient}.
 */
class ServicesGapicClient
{
    ...
    const SERVICE_NAME = 'google.cloud.run.v2.Services';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../resources/services_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ . '/../resources/services_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/services_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/services_rest_client_config.php',
                ],
            ],
        ];
    }
