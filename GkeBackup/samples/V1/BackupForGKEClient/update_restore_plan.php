 ...
 */
function update_restore_plan_sample(string $formattedBackupPlan, string $formattedCluster): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $backupForGKEClient->updateRestorePlan(
            $restorePlan,
            $formattedBackupPlan,
            $formattedCluster
        );
...
function callSample(): void
{
    ...
    update_restore_plan_sample($formattedBackupPlan, $formattedCluster);
}
