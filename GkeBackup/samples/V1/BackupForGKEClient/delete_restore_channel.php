 ...
 */
function delete_restore_channel_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $backupForGKEClient->deleteRestoreChannel($request);
...
function callSample(): void
{
    ...
    delete_restore_channel_sample($formattedName);
}
