 ...
 *
 * Generated from protobuf message <code>google.cloud.gkebackup.v1.ListRestorePlanBindingsRequest</code>
 */
class ListRestorePlanBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The RestoreChannel that contains the ListRestorePlanBindings to
     *                       list. Format: `projects/&#42;/locations/&#42;/restoreChannels/*`
     *                       Please see {@see BackupForGKEClient::restoreChannelName()} for help formatting this field.
     *
     * @return \Google\Cloud\GkeBackup\V1\ListRestorePlanBindingsRequest
     *
     * @experimental
     */
