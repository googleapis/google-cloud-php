 ...
 */
function update_data_source_sample(string $dataSourceName, string $dataSourceDisplayName): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    update_data_source_sample($dataSourceName, $dataSourceDisplayName);
}
