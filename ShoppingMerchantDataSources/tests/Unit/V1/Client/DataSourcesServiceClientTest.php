...
use Google\Shopping\Merchant\DataSources\V1\ListDataSourcesResponse;
...
class DataSourcesServiceClientTest extends GeneratedTest
{
    ...
    public function createDataSourceTest()
    {
        ...
        $dataSourceName = 'dataSourceName-1241608048';
    ...
    public function getDataSourceTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.shopping.merchant.datasources.v1.DataSourcesService/GetDataSource', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
