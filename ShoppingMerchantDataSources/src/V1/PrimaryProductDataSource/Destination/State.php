...
namespace Google\Shopping\Merchant\DataSources\V1\PrimaryProductDataSource\Destination;
 ...
 *
 * Protobuf type <code>google.shopping.merchant.datasources.v1.PrimaryProductDataSource.Destination.State</code>
 */
class State
{
    /**
