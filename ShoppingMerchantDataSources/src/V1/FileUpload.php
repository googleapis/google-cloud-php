 ...
 * sources.
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1.FileUpload</code>
 */
class FileUpload extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.shopping.merchant.datasources.v1.FileUpload.ProcessingState processing_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $processing_state = 0;
    /**
     * Output only. The list of issues occurring in the data source.
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.FileUpload.Issue issues = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $issues;
    /**
     ...
     *           Output only. The processing state of the data source.
     *     @type array<\Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue>|\Google\Protobuf\Internal\RepeatedField $issues
     *           Output only. The list of issues occurring in the data source.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Shopping\Merchant\Datasources\V1\Fileuploads::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\DataSources\V1\FileUpload\ProcessingState::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.FileUpload.Issue issues = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIssues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\DataSources\V1\FileUpload\Issue::class);
        $this->issues = $arr;
