 ...
 *
 * Generated from protobuf message <code>google.shopping.merchant.datasources.v1.SupplementalProductDataSource</code>
 */
class SupplementalProductDataSource extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.shopping.merchant.datasources.v1.DataSourceReference referencing_primary_data_sources = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *           combination. If unset, the data source will accept produts without that
     *           restriction.
     *     @type array<\Google\Shopping\Merchant\DataSources\V1\DataSourceReference>|\Google\Protobuf\Internal\RepeatedField $referencing_primary_data_sources
     *           Output only. The (unordered and deduplicated) list of all primary data
     *           sources linked to this data source in either default or custom rules.
     *           Supplemental data source cannot be deleted before all links are removed.
     * }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\DataSources\V1\DataSourceReference::class);
