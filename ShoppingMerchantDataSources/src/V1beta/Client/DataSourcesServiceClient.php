 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/datasources/v1beta/datasources.proto
...
final class DataSourcesServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.datasources.v1beta.DataSourcesService';
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/create_data_source.php
     *
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/delete_data_source.php
     *
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/fetch_data_source.php
     *
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/get_data_source.php
     *
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/list_data_sources.php
     *
     ...
     *
     * @example samples/V1beta/DataSourcesServiceClient/update_data_source.php
     *
