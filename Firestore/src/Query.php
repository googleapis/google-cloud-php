...
class Query
{
     ...
     * ```
     *
     * @param mixed $fieldValues An array of values, or an instance of
     *        {@see Google\Cloud\Firestore\DocumentSnapshot} defining the query
     *        starting point.
     * @return Query A new instance of Query with the given changes applied.
     */
     ...
     * @param mixed $fieldValues An array of values, or an instance of
     *        {@see Google\Cloud\Firestore\DocumentSnapshot} to use as the query
     *        boundary.
