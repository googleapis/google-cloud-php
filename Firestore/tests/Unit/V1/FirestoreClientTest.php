...
class FirestoreClientTest extends GeneratedTest
{
    ...
    public function batchGetDocumentsTest()
    {
        ...
        // Mock request
        $documents = [];
        $serverStream = $gapicClient->batchGetDocuments($documents);
    ...
    public function commitTest()
    {
        ...
        // Mock request
        $writes = [];
        $response = $gapicClient->commit($writes);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createDocumentTest()
    {
        ...
        $response = $gapicClient->createDocument($documentId);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createDocumentExceptionTest()
    {
        ...
        $documentId = 'documentId506676927';
        try {
            $gapicClient->createDocument($documentId);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listCollectionIdsTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->listCollectionIds();
    ...
    public function listDocumentsTest()
    {
        ...
        $response = $gapicClient->listDocuments($collectionId);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
    ...
    public function listDocumentsExceptionTest()
    {
        ...
        $collectionId = 'collectionId-821242276';
        try {
            $gapicClient->listDocuments($collectionId);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function runAggregationQueryTest()
    {
        ...
        $transport->addResponse($expectedResponse3);
        // Mock request
        $serverStream = $gapicClient->runAggregationQuery();
        $this->assertInstanceOf(ServerStream::class, $serverStream);
        $responses = iterator_to_array($serverStream->readAll());
        $expectedResponses = [];
        $expectedResponses[] = $expectedResponse;
    ...
    public function runQueryTest()
    {
        ...
        $transport->addResponse($expectedResponse3);
        // Mock request
        $serverStream = $gapicClient->runQuery();
        $this->assertInstanceOf(ServerStream::class, $serverStream);
        $responses = iterator_to_array($serverStream->readAll());
        $expectedResponses = [];
        $expectedResponses[] = $expectedResponse;
    ...
    public function updateDocumentTest()
    {
        ...
        $response = $gapicClient->updateDocument($updateMask);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateDocumentExceptionTest()
    {
        ...
        $updateMask = new DocumentMask();
        try {
            $gapicClient->updateDocument($updateMask);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
