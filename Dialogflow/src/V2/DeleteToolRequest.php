 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2.DeleteToolRequest</code>
 */
class DeleteToolRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The tool resource name to delete. Format:
     *                     `projects/<Project ID>/locations/<Location ID>/tools/<Tool ID>`
     *                     Please see {@see ToolsClient::toolName()} for help formatting this field.
     *
     * @return \Google\Cloud\Dialogflow\V2\DeleteToolRequest
     *
     * @experimental
     */
