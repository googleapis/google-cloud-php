 ...
 * operation.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2.CreateConversationModelOperationMetadata</code>
 */
class CreateConversationModelOperationMetadata extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2\CreateConversationModelOperationMetadata\State::class);
        $this->state = $var;
