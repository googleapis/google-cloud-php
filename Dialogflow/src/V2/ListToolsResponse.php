 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2.ListToolsResponse</code>
 */
class ListToolsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2\Tool::class);
        $this->tools = $arr;
