 ...
 * \Google\Cloud\Dialogflow\V2\KnowledgeBasesClient} for the stable implementation
 *
 * @experimental
 *
 * @internal
 ...
 */
abstract class KnowledgeBasesBaseClient
{
     ...
     *
     * The async variant is {@see self::createKnowledgeBaseAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteKnowledgeBaseAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getKnowledgeBaseAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listKnowledgeBasesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::updateKnowledgeBaseAsync()} .
     *
