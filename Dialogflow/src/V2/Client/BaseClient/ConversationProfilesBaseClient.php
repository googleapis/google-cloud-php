 ...
 */
abstract class ConversationProfilesBaseClient
{
     ...
     *
     * The async variant is {@see self::clearSuggestionFeatureConfigAsync()} .
     *
     ...
     * API.
     *
     * The async variant is {@see self::createConversationProfileAsync()} .
     *
     ...
     *
     * The async variant is {@see self::deleteConversationProfileAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getConversationProfileAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listConversationProfilesAsync()} .
     *
     ...
     *
     * The async variant is {@see self::setSuggestionFeatureConfigAsync()} .
     *
     ...
     * API.
     *
     * The async variant is {@see self::updateConversationProfileAsync()} .
     *
