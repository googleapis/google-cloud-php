 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2.ListToolsRequest</code>
 */
class ListToolsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The project/location to list tools for. Format:
     *                       `projects/<Project ID>/locations/<Location ID>`
     *                       Please see {@see ToolsClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\Dialogflow\V2\ListToolsRequest
     *
     * @experimental
     */
