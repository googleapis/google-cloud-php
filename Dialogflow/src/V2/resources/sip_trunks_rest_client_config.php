...
return [
    'interfaces' => [
        'google.cloud.dialogflow.v2.SipTrunks' => [
            'CreateSipTrunk' => [
                'method' => 'post',
                'uriTemplate' => '/v2/{parent=projects/*/locations/*}/sipTrunks',
                'body' => 'sip_trunk',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteSipTrunk' => [
                'method' => 'delete',
                'uriTemplate' => '/v2/{name=projects/*/locations/*/sipTrunks/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateSipTrunk' => [
                'method' => 'patch',
                'uriTemplate' => '/v2/{sip_trunk.name=projects/*/locations/*/sipTrunks/*}',
                'body' => 'sip_trunk',
                'placeholders' => [
                    'sip_trunk.name' => [
                        'getters' => [
