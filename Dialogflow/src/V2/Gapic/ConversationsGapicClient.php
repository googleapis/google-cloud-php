...
class ConversationsGapicClient
{
     ...
     *     $response = $conversationsClient->searchKnowledge($parent, $query, $formattedConversationProfile, $sessionId);
     * } finally {
     *     $conversationsClient->close();
     * }
     * ```
     *
     * @param string    $parent              Required. The parent resource contains the conversation profile
     ...
     * @param string    $sessionId           Required. The ID of the search session.
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchKnowledge($parent, $query, $conversationProfile, $sessionId, array $optionalArgs = [])
    {
