 ...
 * try {
 *     $response = $conversationsClient->completeConversation();
 * } finally {
...
class ConversationsGapicClient
{
     ...
     */
    public function completeConversation(array $optionalArgs = [])
    {
     ...
     *     Optional.
     *
     *     @type MinimalConversation $statelessConversation
     ...
     * @throws ApiException if the remote call fails
     */
    public function generateStatelessSummary(array $optionalArgs = [])
    {
        $request = new GenerateStatelessSummaryRequest();
        $requestParamHeaders = [];
        if (isset($optionalArgs['statelessConversation'])) {
            $request->setStatelessConversation($optionalArgs['statelessConversation']);
        }
     ...
     * $conversationsClient = new ConversationsClient();
     * try {
     *     $response = $conversationsClient->getConversation();
     * } finally {
     *     $conversationsClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $conversationsClient->listConversations();
     ...
     * try {
     *     // Iterate over pages of elements
     *     $pagedResponse = $conversationsClient->listMessages();
     *     foreach ($pagedResponse->iteratePages() as $page) {
     *         foreach ($page as $element) {
     *             // doSomethingWith($element);
     *         }
     ...
     * @throws ApiException if the remote call fails
     */
    public function listMessages(array $optionalArgs = [])
    {
     ...
     * $conversationsClient = new ConversationsClient();
     * try {
     *     $response = $conversationsClient->searchKnowledge();
     * } finally {
     *     $conversationsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function searchKnowledge(array $optionalArgs = [])
    {
     ...
     * $conversationsClient = new ConversationsClient();
     * try {
     *     $response = $conversationsClient->suggestConversationSummary();
     * } finally {
     *     $conversationsClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function suggestConversationSummary(array $optionalArgs = [])
    {
