 ...
 * operation.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2.CreateConversationModelEvaluationOperationMetadata</code>
 */
class CreateConversationModelEvaluationOperationMetadata extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     *     @type string $conversation_model_evaluation
     *           The resource name of the conversation model. Format:
     *           `projects/<Project ID>/locations/<Location
     *           ID>/conversationModels/<Conversation Model Id>/evaluations/<Evaluation Id>`
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\V2\CreateConversationModelEvaluationOperationMetadata\State::class);
        $this->state = $var;
