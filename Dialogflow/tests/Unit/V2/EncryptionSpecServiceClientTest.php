...
use Google\Cloud\Dialogflow\V2\EncryptionSpecServiceClient;
 ...
 * @group gapic
 */
class EncryptionSpecServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new EncryptionSpecServiceClient($options);
    }
    ...
    public function getEncryptionSpecTest()
    {
        ...
        $response = $gapicClient->getEncryptionSpec($formattedName);
    ...
    public function getEncryptionSpecExceptionTest()
    {
        ...
        $formattedName = $gapicClient->encryptionSpecName('[PROJECT]', '[LOCATION]');
        try {
            $gapicClient->getEncryptionSpec($formattedName);
    ...
    public function initializeEncryptionSpecTest()
    {
        ...
        $response = $gapicClient->initializeEncryptionSpec($encryptionSpec);
