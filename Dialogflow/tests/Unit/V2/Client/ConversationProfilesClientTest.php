...
class ConversationProfilesClientTest extends GeneratedTest
{
    ...
    public function deleteConversationProfileTest()
    {
        ...
        $request = (new DeleteConversationProfileRequest())->setName($formattedName);
    ...
    public function getConversationProfileTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->conversationProfileName('[PROJECT]', '[CONVERSATION_PROFILE]');
        $request = (new GetConversationProfileRequest())->setName($formattedName);
    ...
    public function listConversationProfilesTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new ListConversationProfilesRequest())->setParent($formattedParent);
    ...
    /** @test */
    public function clearSuggestionFeatureConfigAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
