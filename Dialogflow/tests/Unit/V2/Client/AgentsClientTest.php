...
class AgentsClientTest extends GeneratedTest
{
    ...
    public function deleteAgentTest()
    {
        ...
        $request = (new DeleteAgentRequest())->setParent($formattedParent);
    ...
    public function exportAgentTest()
    {
        ...
        $request = (new ExportAgentRequest())->setParent($formattedParent)->setAgentUri($agentUri);
    ...
    public function getAgentTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new GetAgentRequest())->setParent($formattedParent);
    ...
    public function getValidationResultTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new GetValidationResultRequest())->setParent($formattedParent);
    ...
    public function importAgentTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new ImportAgentRequest())->setParent($formattedParent);
    ...
    public function restoreAgentTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new RestoreAgentRequest())->setParent($formattedParent);
    ...
    public function setAgentTest()
    {
        ...
        $request = (new SetAgentRequest())->setAgent($agent);
    ...
    public function trainAgentTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        $request = (new TrainAgentRequest())->setParent($formattedParent);
    ...
    /** @test */
    public function deleteAgentAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
