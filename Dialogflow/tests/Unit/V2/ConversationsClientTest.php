...
class ConversationsClientTest extends GeneratedTest
{
     ...
     * @test
     */
    public function createCallMatcherTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        // Mock response
        $name = 'name3373707';
        $toHeader = 'toHeader-1840668463';
        $fromHeader = 'fromHeader-117132094';
        $callIdHeader = 'callIdHeader734299536';
        $expectedResponse = new CallMatcher();
        $expectedResponse->setName($name);
        $expectedResponse->setToHeader($toHeader);
        $expectedResponse->setFromHeader($fromHeader);
        $expectedResponse->setCallIdHeader($callIdHeader);
        $transport->addResponse($expectedResponse);
        ...
        $response = $client->createCallMatcher($parent, $callMatcher);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Conversations/CreateCallMatcher', $actualFuncCall);

        $actualValue = $actualRequestObject->getParent();

        $this->assertProtobufEquals($parent, $actualValue);
        $actualValue = $actualRequestObject->getCallMatcher();

        $this->assertProtobufEquals($callMatcher, $actualValue);
     ...
     * @test
     */
    public function createCallMatcherExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
     ...
     * @test
     */
    public function listCallMatchersTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        // Mock response
        $nextPageToken = '';
        $callMatchersElement = new CallMatcher();
        $callMatchers = [$callMatchersElement];
        $expectedResponse = new ListCallMatchersResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setCallMatchers($callMatchers);
        $transport->addResponse($expectedResponse);

        // Mock request
        $parent = 'parent-995424086';

        $response = $client->listCallMatchers($parent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getCallMatchers()[0], $resources[0]);

        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Conversations/ListCallMatchers', $actualFuncCall);
     ...
     * @test
     */
    public function listCallMatchersExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
     ...
     * @test
     */
    public function deleteCallMatcherTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2.Conversations/DeleteCallMatcher', $actualFuncCall);
     ...
     * @test
     */
    public function deleteCallMatcherExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
