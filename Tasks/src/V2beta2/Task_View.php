...
@\trigger_error('Google\Cloud\Tasks\V2beta2\Task_View is deprecated and will be removed in a future release. Use Google\Cloud\Tasks\V2beta2\Task\View instead', E_USER_DEPRECATED);
