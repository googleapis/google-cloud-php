...
@\trigger_error('Google\Cloud\Tasks\V2beta2\Queue_State is deprecated and will be removed in a future release. Use Google\Cloud\Tasks\V2beta2\Queue\State instead', E_USER_DEPRECATED);
