...
namespace Google\Cloud\Tasks\V2beta3\Task;
 ...
 * contains.
 *
 * Protobuf type <code>google.cloud.tasks.v2beta3.Task.View</code>
 */
class View
{
    /**
...
class_alias(View::class, \Google\Cloud\Tasks\V2beta3\Task_View::class);
