    ...
    'interfaces' => [
        ...
        'google.cloud.networkmanagement.v1.VpcFlowLogsService' => [
            ...
            'DeleteVpcFlowLogsConfig' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/vpcFlowLogsConfigs/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'QueryOrgVpcFlowLogsConfigs' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/vpcFlowLogsConfigs:queryOrgVpcFlowLogsConfigs',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'ShowEffectiveFlowLogsConfigs' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/vpcFlowLogsConfigs:showEffectiveFlowLogsConfigs',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
                            'getParent',
            ...
            'UpdateVpcFlowLogsConfig' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{vpc_flow_logs_config.name=projects/*/locations/*/vpcFlowLogsConfigs/*}',
                'body' => 'vpc_flow_logs_config',
                'placeholders' => [
