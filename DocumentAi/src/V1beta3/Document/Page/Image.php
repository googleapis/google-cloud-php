 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.Image</code>
 */
...
class_alias(Image::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_Image::class);
