 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.Matrix</code>
 */
...
class_alias(Matrix::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_Matrix::class);
