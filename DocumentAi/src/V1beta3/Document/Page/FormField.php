 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.FormField</code>
 */
class FormField extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Document.Page.Layout field_name = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Document.Page.Layout field_value = 2;</code>
     */
    private $field_value = null;
    /**
     * A list of detected languages for name together with confidence.
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage name_detected_languages = 3;</code>
     */
    private $name_detected_languages;
    /**
     * A list of detected languages for value together with confidence.
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta3.Document.Page.DetectedLanguage value_detected_languages = 4;</code>
     */
     ...
     *
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\Layout $field_name
     *           [Layout][google.cloud.documentai.v1beta3.Document.Page.Layout] for the [FormField][google.cloud.documentai.v1beta3.Document.Page.FormField] name. e.g. `Address`, `Email`,
     *           `Grand total`, `Phone number`, etc.
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\Layout $field_value
     *           [Layout][google.cloud.documentai.v1beta3.Document.Page.Layout] for the [FormField][google.cloud.documentai.v1beta3.Document.Page.FormField] value.
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $name_detected_languages
     *           A list of detected languages for name together with confidence.
     *     @type \Google\Cloud\DocumentAI\V1beta3\Document\Page\DetectedLanguage[]|\Google\Protobuf\Internal\RepeatedField $value_detected_languages
     *           A list of detected languages for value together with confidence.
...
class_alias(FormField::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_FormField::class);
