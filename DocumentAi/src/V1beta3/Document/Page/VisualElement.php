 ...
 * page.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.Document.Page.VisualElement</code>
 */
...
class_alias(VisualElement::class, \Google\Cloud\DocumentAI\V1beta3\Document_Page_VisualElement::class);
