 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.CreateProcessorRequest</code>
 */
class CreateProcessorRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Processor processor = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Required. The parent (project and location) under which to create the processor.
     *           Format: projects/{project}/locations/{location}
     *     @type \Google\Cloud\DocumentAI\V1beta3\Processor $processor
     *           Required. The processor to be created, requires [processor_type] and [display_name]
     *           to be set. Also, the processor is under CMEK if CMEK fields are set.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Processor processor = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\DocumentAI\V1beta3\Processor|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.Processor processor = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\DocumentAI\V1beta3\Processor $var
     * @return $this
     */
    public function setProcessor($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta3\Processor::class);
        $this->processor = $var;
