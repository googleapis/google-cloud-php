 ...
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta3.BatchDocumentsInputConfig</code>
 */
class BatchDocumentsInputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\DocumentAI\V1beta3\GcsPrefix $gcs_prefix
     *           The set of documents that match the specified Cloud Storage [gcs_prefix].
     *     @type \Google\Cloud\DocumentAI\V1beta3\GcsDocuments $gcs_documents
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.GcsPrefix gcs_prefix = 1;</code>
     * @param \Google\Cloud\DocumentAI\V1beta3\GcsPrefix $var
     * @return $this
     */
    public function setGcsPrefix($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta3\GcsPrefix::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta3.GcsDocuments gcs_documents = 2;</code>
     * @param \Google\Cloud\DocumentAI\V1beta3\GcsDocuments $var
     * @return $this
     */
    public function setGcsDocuments($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta3\GcsDocuments::class);
