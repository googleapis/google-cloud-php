 ...
 *
 * Protobuf type <code>google.cloud.documentai.v1beta3.BatchProcessMetadata.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DocumentAI\V1beta3\BatchProcessMetadata_State::class);
