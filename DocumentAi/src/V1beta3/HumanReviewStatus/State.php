...
namespace Google\Cloud\DocumentAI\V1beta3\HumanReviewStatus;
 ...
 *
 * Protobuf type <code>google.cloud.documentai.v1beta3.HumanReviewStatus.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\DocumentAI\V1beta3\HumanReviewStatus_State::class);
