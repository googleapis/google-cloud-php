...
namespace Google\Cloud\DocumentAI\V1beta3\ReviewDocumentRequest;
 ...
 *
 * Protobuf type <code>google.cloud.documentai.v1beta3.ReviewDocumentRequest.Priority</code>
 */
class Priority
{
    /**
...
class_alias(Priority::class, \Google\Cloud\DocumentAI\V1beta3\ReviewDocumentRequest_Priority::class);
