 ...
 * page.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.VisualElement</code>
 */
...
class_alias(VisualElement::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_VisualElement::class);
