 ...
 * A detected token.
 *
 * Generated from protobuf message <code>google.cloud.documentai.v1beta2.Document.Page.Token</code>
 */
class Token extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Page.Token.DetectedBreak detected_break = 2;</code>
     */
    private $detected_break = null;
    /**
     * A list of detected languages together with confidence.
     *
     * Generated from protobuf field <code>repeated .google.cloud.documentai.v1beta2.Document.Page.DetectedLanguage detected_languages = 3;</code>
     */
     ...
     *           [Layout][google.cloud.documentai.v1beta2.Document.Page.Layout] for [Token][google.cloud.documentai.v1beta2.Document.Page.Token].
     *     @type \Google\Cloud\DocumentAI\V1beta2\Document\Page\Token\DetectedBreak $detected_break
     *           Detected break at the end of a [Token][google.cloud.documentai.v1beta2.Document.Page.Token].
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Page.Token.DetectedBreak detected_break = 2;</code>
     * @return \Google\Cloud\DocumentAI\V1beta2\Document\Page\Token\DetectedBreak|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.documentai.v1beta2.Document.Page.Token.DetectedBreak detected_break = 2;</code>
     * @param \Google\Cloud\DocumentAI\V1beta2\Document\Page\Token\DetectedBreak $var
     * @return $this
     */
    public function setDetectedBreak($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DocumentAI\V1beta2\Document\Page\Token\DetectedBreak::class);
...
class_alias(Token::class, \Google\Cloud\DocumentAI\V1beta2\Document_Page_Token::class);
