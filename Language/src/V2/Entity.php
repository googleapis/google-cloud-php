 ...
 *
 * Generated from protobuf message <code>google.cloud.language.v2.Entity</code>
 */
class Entity extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.language.v2.EntityMention mentions = 5;</code>
     */
    private $mentions;
    /**
     ...
     *           For the metadata
     *           associated with other entity types, see the Type table below.
     *     @type \Google\Cloud\Language\V2\EntityMention[] $mentions
     *           The mentions of this entity in the input document. The API currently
     *           supports proper noun mentions.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Language\V2\Entity\Type::class);
        $this->type = $var;
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.language.v2.EntityMention mentions = 5;</code>
     * @return RepeatedField<\Google\Cloud\Language\V2\EntityMention>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.language.v2.EntityMention mentions = 5;</code>
     * @param \Google\Cloud\Language\V2\EntityMention[] $var
     * @return $this
     */
    public function setMentions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Language\V2\EntityMention::class);
        $this->mentions = $arr;
