 ...
 *
 * @param string $formattedParent The account to list merchant reviews for.
 *                                Format: accounts/{account}
 *                                Please see {@see MerchantReviewsServiceClient::accountName()} for help formatting this field.
 */
function list_merchant_reviews_sample(string $formattedParent): void
{
    // Create a client.
...
{
    $formattedParent = MerchantReviewsServiceClient::accountName('[ACCOUNT]');

    list_merchant_reviews_sample($formattedParent);
}
