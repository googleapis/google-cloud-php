...
class KeyTrackingServiceClientTest extends GeneratedTest
{
    ...
    public function getProtectedResourcesSummaryTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->protectedResourcesSummaryName(
            '[PROJECT]',
            '[LOCATION]',
            '[KEY_RING]',
            '[CRYPTO_KEY]'
        );
        $request = (new GetProtectedResourcesSummaryRequest())->setName($formattedName);
    ...
    public function searchProtectedResourcesTest()
    {
        ...
        $protectedResources = [$protectedResourcesElement];
