    ...
    'interfaces' => [
        'google.cloud.cloudsecuritycompliance.v1.CmEnrollmentService' => [
            'CalculateEffectiveCmEnrollment' => [
                ...
                'responseType' => 'Google\Cloud\CloudSecurityCompliance\V1\CalculateEffectiveCmEnrollmentResponse',
                'headerParams' => [
                    [
                        'keyName' => 'name',
                        'fieldAccessors' => [
            ...
            'UpdateCmEnrollment' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => 'Google\Cloud\CloudSecurityCompliance\V1\CmEnrollment',
                'headerParams' => [
                    [
                        'keyName' => 'cm_enrollment.name',
                        'fieldAccessors' => [
                            'getCmEnrollment',
                            'getName',
                        ],
