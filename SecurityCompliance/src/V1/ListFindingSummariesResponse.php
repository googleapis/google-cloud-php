 ...
 *
 * Generated from protobuf message <code>google.cloud.cloudsecuritycompliance.v1.ListFindingSummariesResponse</code>
 */
class ListFindingSummariesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\CloudSecurityCompliance\V1\FindingSummary::class);
