...
class TraceServiceClientTest extends GeneratedTest
{
    ...
    public function getTraceTest()
    {
        ...
        $request = (new GetTraceRequest())->setProjectId($projectId)->setTraceId($traceId);
    ...
    public function listTracesTest()
    {
        ...
        // Mock request
        $projectId = 'projectId-1969970175';
        $request = (new ListTracesRequest())->setProjectId($projectId);
    ...
    public function patchTracesTest()
    {
        ...
        $projectId = 'projectId-1969970175';
        $traces = new Traces();
        $request = (new PatchTracesRequest())->setProjectId($projectId)->setTraces($traces);
