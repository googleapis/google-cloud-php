...
namespace Google\Cloud\Trace\V2\Client\BaseClient;
 ...
 */
abstract class TraceServiceBaseClient
{
     ...
     * existing spans.
     *
     * The async variant is {@see self::batchWriteSpansAsync()} .
     *
     ...
     * Creates a new span.
     *
     * The async variant is {@see self::createSpanAsync()} .
     *
