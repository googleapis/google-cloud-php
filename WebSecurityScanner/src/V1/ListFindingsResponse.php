 ...
 *
 * Generated from protobuf message <code>google.cloud.websecurityscanner.v1.ListFindingsResponse</code>
 */
class ListFindingsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\WebSecurityScanner\V1\Finding::class);
        $this->findings = $arr;
