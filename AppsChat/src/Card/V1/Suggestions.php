...
class Suggestions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Apps\Card\V1\Suggestions\SuggestionItem[] $items
     *           A list of suggestions used for autocomplete recommendations in text input
     *           fields.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.apps.card.v1.Suggestions.SuggestionItem items = 1;</code>
     * @return RepeatedField<\Google\Apps\Card\V1\Suggestions\SuggestionItem>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.apps.card.v1.Suggestions.SuggestionItem items = 1;</code>
     * @param \Google\Apps\Card\V1\Suggestions\SuggestionItem[] $var
     * @return $this
     */
