 ...
 *
 * Generated from protobuf message <code>google.cloud.developerconnect.v1.ListInsightsConfigsRequest</code>
 */
class ListInsightsConfigsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. Parent value for ListInsightsConfigsRequest. Please see
     *                       {@see InsightsConfigServiceClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\DeveloperConnect\V1\ListInsightsConfigsRequest
     *
     * @experimental
     */
