 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/developerconnect/v1/insights_config.proto
 ...
 */
final class InsightsConfigServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.developerconnect.v1.InsightsConfigService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/insights_config_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/insights_config_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/insights_config_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/insights_config_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * @return string The formatted insights_config resource.
     */
    public static function insightsConfigName(string $project, string $location, string $insightsConfig): string
    {
        return self::getPathTemplate('insightsConfig')->render([
            'project' => $project,
            'location' => $location,
     ...
     *           use Google\Cloud\DeveloperConnect\V1\InsightsConfigServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new InsightsConfigServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * {@see InsightsConfigServiceClient::createInsightsConfigAsync()} .
     *
     * @example samples/V1/InsightsConfigServiceClient/create_insights_config.php
     *
     * @param CreateInsightsConfigRequest $request     A request to house fields associated with the call.
     ...
     * }
     *
     * @return OperationResponse<InsightsConfig>
     *
     ...
     *
     * @example samples/V1/InsightsConfigServiceClient/delete_insights_config.php
     *
     * @param DeleteInsightsConfigRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see InsightsConfigServiceClient::getInsightsConfigAsync()} .
     *
     * @example samples/V1/InsightsConfigServiceClient/get_insights_config.php
     *
     * @param GetInsightsConfigRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see InsightsConfigServiceClient::listInsightsConfigsAsync()} .
     *
     * @example samples/V1/InsightsConfigServiceClient/list_insights_configs.php
     *
     * @param ListInsightsConfigsRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listInsightsConfigs(ListInsightsConfigsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListInsightsConfigs', $request, $callOptions);
    }
     ...
     *
     * The async variant is
     * {@see InsightsConfigServiceClient::updateInsightsConfigAsync()} .
     *
     * @example samples/V1/InsightsConfigServiceClient/update_insights_config.php
     *
     * @param UpdateInsightsConfigRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is {@see InsightsConfigServiceClient::getLocationAsync()} .
     *
     * @example samples/V1/InsightsConfigServiceClient/get_location.php
     *
     ...
     *
     * @example samples/V1/InsightsConfigServiceClient/list_locations.php
     *
