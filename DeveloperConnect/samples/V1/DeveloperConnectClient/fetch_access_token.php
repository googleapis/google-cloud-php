...
// [START developerconnect_v1_generated_DeveloperConnect_FetchAccessToken_sync]
 ...
 */
function fetch_access_token_sample(string $formattedAccountConnector): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $developerConnectClient->fetchAccessToken($request);
...
function callSample(): void
{
    ...
    fetch_access_token_sample($formattedAccountConnector);
}
// [END developerconnect_v1_generated_DeveloperConnect_FetchAccessToken_sync]
