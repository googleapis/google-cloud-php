 ...
 *
 * Generated from protobuf message <code>google.cloud.channel.v1.ListOffersResponse</code>
 */
class ListOffersResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Channel\V1\Offer::class);
        $this->offers = $arr;
