 ...
 * \Google\Cloud\Channel\V1\CloudChannelReportsServiceClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class CloudChannelReportsServiceBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.channel.v1.CloudChannelReportsService';
     ...
     */
    public static function reportName(string $account, string $report): string
    {
     ...
     */
    public static function reportJobName(string $account, string $reportJob): string
    {
        return self::getPathTemplate('reportJob')->render([
            'account' => $account,
     ...
     *
     * The async variant is {@see self::fetchReportResultsAsync()} .
     *
     ...
     */
    public function fetchReportResults(FetchReportResultsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('FetchReportResults', $request, $callOptions);
    }
     ...
     *
     * The async variant is {@see self::runReportJobAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function runReportJob(RunReportJobRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('RunReportJob', $request, $callOptions)->wait();
    }
}
