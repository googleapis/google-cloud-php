 ...
 *
 * Generated from protobuf message <code>maps.fleetengine.v1.TripAttribute</code>
 */
class TripAttribute extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     */
    protected $key = '';
    protected $trip_attribute_value;
     ...
     * @return string
     */
    public function getTripAttributeValue()
    {
        return $this->whichOneof("trip_attribute_value");
    }
