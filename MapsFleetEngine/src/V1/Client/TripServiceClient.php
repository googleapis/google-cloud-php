...
final class TripServiceClient
{
    ...
    private const SERVICE_NAME = 'maps.fleetengine.v1.TripService';
     ...
     */
    public static function tripName(string $provider, string $trip): string
    {
        return self::getPathTemplate('trip')->render([
            'provider' => $provider,
            'trip' => $trip,
        ]);
    }
     ...
     *
     * The async variant is {@see TripServiceClient::createTripAsync()} .
     *
     * @example samples/V1/TripServiceClient/create_trip.php
     *
     * @param CreateTripRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is {@see TripServiceClient::getTripAsync()} .
     *
     * @example samples/V1/TripServiceClient/get_trip.php
     *
     * @param GetTripRequest $request     A request to house fields associated with the call.
     * @param array          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getTrip(GetTripRequest $request, array $callOptions = []): Trip
    {
        return $this->startApiCall('GetTrip', $request, $callOptions)->wait();
    }

    /**
     * Report billable trip usage.
     *
     * The async variant is {@see TripServiceClient::reportBillableTripAsync()} .
     *
     * @example samples/V1/TripServiceClient/report_billable_trip.php
     *
     * @param ReportBillableTripRequest $request     A request to house fields associated with the call.
     * @param array                     $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function reportBillableTrip(ReportBillableTripRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('ReportBillableTrip', $request, $callOptions)->wait();
    }

    /**
     * Get all the trips for a specific vehicle.
     *
     * The async variant is {@see TripServiceClient::searchTripsAsync()} .
     *
     * @example samples/V1/TripServiceClient/search_trips.php
     *
     * @param SearchTripsRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function searchTrips(SearchTripsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('SearchTrips', $request, $callOptions);
    }

    /**
     * Updates trip data.
     *
     * The async variant is {@see TripServiceClient::updateTripAsync()} .
     *
     * @example samples/V1/TripServiceClient/update_trip.php
     *
     * @param UpdateTripRequest $request     A request to house fields associated with the call.
     * @param array             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateTrip(UpdateTripRequest $request, array $callOptions = []): Trip
    {
        return $this->startApiCall('UpdateTrip', $request, $callOptions)->wait();
    }
}
