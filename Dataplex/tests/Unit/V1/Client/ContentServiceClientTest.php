...
class ContentServiceClientTest extends GeneratedTest
{
    ...
    public function createContentTest()
    {
        ...
        $request = (new CreateContentRequest())->setParent($formattedParent)->setContent($content);
    ...
    public function deleteContentTest()
    {
        ...
        $request = (new DeleteContentRequest())->setName($formattedName);
    ...
    public function updateContentTest()
    {
        ...
        $contentDataText = 'contentDataText-82259056';
        $content->setDataText($contentDataText);
        $request = (new UpdateContentRequest())->setUpdateMask($updateMask)->setContent($content);
    ...
    /** @test */
    public function createContentAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
