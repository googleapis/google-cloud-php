 ...
 */
function list_metadata_feeds_sample(string $formattedParent): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $catalogServiceClient->listMetadataFeeds($request);

        /** @var MetadataFeed $element */
...
function callSample(): void
{
    ...
    list_metadata_feeds_sample($formattedParent);
}
