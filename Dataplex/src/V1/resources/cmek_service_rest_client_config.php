    ...
    'interfaces' => [
        'google.cloud.dataplex.v1.CmekService' => [
            'CreateEncryptionConfig' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=organizations/*/locations/*}/encryptionConfigs',
            ...
            'DeleteEncryptionConfig' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=organizations/*/locations/*/encryptionConfigs/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateEncryptionConfig' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{encryption_config.name=organizations/*/locations/*/encryptionConfigs/*}',
                'body' => 'encryption_config',
                'placeholders' => [
