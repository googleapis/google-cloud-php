...
return [
    'interfaces' => [
        'google.cloud.dataplex.v1.DataProductService' => [
            'CreateDataAsset' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*/dataProducts/*}/dataAssets',
                'body' => 'data_asset',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'CreateDataProduct' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/dataProducts',
                'body' => 'data_product',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'DeleteDataAsset' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/dataProducts/*/dataAssets/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'DeleteDataProduct' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/dataProducts/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateDataProduct' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{data_product.name=projects/*/locations/*/dataProducts/*}',
                'body' => 'data_product',
                'placeholders' => [
                    'data_product.name' => [
                        'getters' => [
