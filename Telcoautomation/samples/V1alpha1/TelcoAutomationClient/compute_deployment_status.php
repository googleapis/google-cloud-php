...
use Google\Cloud\Telcoautomation\V1alpha1\ComputeDeploymentStatusRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ComputeDeploymentStatusResponse;

/**
 * Returns the requested deployment status.
 *
 * @param string $formattedName The name of the deployment. Please see
