...
namespace Google\Cloud\Telcoautomation\Tests\Unit\V1alpha1\Client;
...
use Google\Cloud\Telcoautomation\V1alpha1\ListBlueprintRevisionsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListBlueprintsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListBlueprintsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListDeploymentRevisionsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListDeploymentRevisionsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListDeploymentsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListDeploymentsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListEdgeSlmsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListEdgeSlmsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListHydratedDeploymentsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListHydratedDeploymentsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListOrchestrationClustersRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListOrchestrationClustersResponse;
use Google\Cloud\Telcoautomation\V1alpha1\ListPublicBlueprintsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\ListPublicBlueprintsResponse;
...
use Google\Cloud\Telcoautomation\V1alpha1\SearchBlueprintRevisionsResponse;
use Google\Cloud\Telcoautomation\V1alpha1\SearchDeploymentRevisionsRequest;
use Google\Cloud\Telcoautomation\V1alpha1\SearchDeploymentRevisionsResponse;
...
class TelcoAutomationClientTest extends GeneratedTest
{
    ...
    public function applyDeploymentTest()
    {
        ...
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ApplyDeployment', $actualFuncCall);
    ...
    public function applyHydratedDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ApplyHydratedDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function approveBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ApproveBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function computeDeploymentStatusTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ComputeDeploymentStatus', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function createBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/CreateBlueprint', $actualFuncCall);
    ...
    public function createDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/CreateDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function createEdgeSlmTest()
    {
        ...
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/CreateEdgeSlm', $actualApiFuncCall);
    ...
    public function createOrchestrationClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/CreateOrchestrationCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function deleteBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteBlueprintRevisionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new DeleteBlueprintRevisionRequest())
            ->setName($formattedName);
        $response = $gapicClient->deleteBlueprintRevision($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteBlueprintRevision', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteBlueprintRevisionExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new DeleteBlueprintRevisionRequest())
            ->setName($formattedName);
        try {
            $gapicClient->deleteBlueprintRevision($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function deleteDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteDeploymentRevisionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->deploymentName('[PROJECT]', '[LOCATION]', '[ORCHESTRATION_CLUSTER]', '[DEPLOYMENT]');
        $request = (new DeleteDeploymentRevisionRequest())
            ->setName($formattedName);
        $response = $gapicClient->deleteDeploymentRevision($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteDeploymentRevision', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteDeploymentRevisionExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new DeleteDeploymentRevisionRequest())
            ->setName($formattedName);
        try {
            $gapicClient->deleteDeploymentRevision($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function deleteEdgeSlmTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteEdgeSlm', $actualApiFuncCall);
    ...
    public function deleteOrchestrationClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DeleteOrchestrationCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    public function discardBlueprintChangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DiscardBlueprintChanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function discardDeploymentChangesTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/DiscardDeploymentChanges', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getEdgeSlmTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetEdgeSlm', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getHydratedDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetHydratedDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getOrchestrationClusterTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetOrchestrationCluster', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function getPublicBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/GetPublicBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBlueprintRevisionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListBlueprintRevisions', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listBlueprintsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListBlueprints', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listDeploymentRevisionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListDeploymentRevisions', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listDeploymentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListDeployments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listEdgeSlmsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListEdgeSlms', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listHydratedDeploymentsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListHydratedDeployments', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listOrchestrationClustersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListOrchestrationClusters', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listPublicBlueprintsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ListPublicBlueprints', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function proposeBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/ProposeBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function rejectBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/RejectBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function removeDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/RemoveDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function rollbackDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/RollbackDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function searchBlueprintRevisionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/SearchBlueprintRevisions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
    ...
    public function searchDeploymentRevisionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/SearchDeploymentRevisions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getQuery();
        $this->assertProtobufEquals($query, $actualValue);
    ...
    public function updateBlueprintTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/UpdateBlueprint', $actualFuncCall);
        $actualValue = $actualRequestObject->getBlueprint();
        $this->assertProtobufEquals($blueprint, $actualValue);
    ...
    public function updateDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/UpdateDeployment', $actualFuncCall);
        $actualValue = $actualRequestObject->getDeployment();
        $this->assertProtobufEquals($deployment, $actualValue);
        $actualValue = $actualRequestObject->getUpdateMask();
        $this->assertProtobufEquals($updateMask, $actualValue);
    ...
    public function updateHydratedDeploymentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.telcoautomation.v1alpha1.TelcoAutomation/UpdateHydratedDeployment', $actualFuncCall);
