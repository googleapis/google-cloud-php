...
namespace Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster;
 ...
 *
 * Protobuf type <code>google.cloud.telcoautomation.v1alpha1.OrchestrationCluster.State</code>
 */
class State
{
    /**
