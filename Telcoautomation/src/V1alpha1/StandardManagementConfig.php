 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.StandardManagementConfig</code>
 */
class StandardManagementConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           subnetwork to use for service ClusterIPs. Alternatively,
     *           services_cidr_block can be used to automatically create a GKE-managed one.
     *     @type \Google\Cloud\Telcoautomation\V1alpha1\MasterAuthorizedNetworksConfig $master_authorized_networks_config
     *           Optional. Master Authorized Network that supports multiple CIDR blocks.
     *           Allows access to the k8s master from multiple blocks. It cannot be set at
     *           the same time with the field man_block.
     * }
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Telcoautomation\V1alpha1\MasterAuthorizedNetworksConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Telcoautomation\V1alpha1\MasterAuthorizedNetworksConfig $var
     * @return $this
     */
    public function setMasterAuthorizedNetworksConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Telcoautomation\V1alpha1\MasterAuthorizedNetworksConfig::class);
