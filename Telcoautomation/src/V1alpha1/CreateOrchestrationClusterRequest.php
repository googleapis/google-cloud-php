 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.CreateOrchestrationClusterRequest</code>
 */
class CreateOrchestrationClusterRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.OrchestrationCluster orchestration_cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster $orchestrationCluster   Required. The resource being created
     * @param string                                                      $orchestrationClusterId Required. Id of the requesting object
     *                                                                                            If auto-generating Id server-side, remove this field and
     *                                                                                            orchestration_cluster_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\Telcoautomation\V1alpha1\CreateOrchestrationClusterRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster $orchestrationCluster, string $orchestrationClusterId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     *           If auto-generating Id server-side, remove this field and
     *           orchestration_cluster_id from the method_signature of Create RPC
     *     @type \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster $orchestration_cluster
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.OrchestrationCluster orchestration_cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.OrchestrationCluster orchestration_cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster $var
     * @return $this
     */
    public function setOrchestrationCluster($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Telcoautomation\V1alpha1\OrchestrationCluster::class);
