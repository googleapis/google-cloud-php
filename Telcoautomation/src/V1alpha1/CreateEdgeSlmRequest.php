 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.CreateEdgeSlmRequest</code>
 */
class CreateEdgeSlmRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.EdgeSlm edge_slm = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm $edgeSlm   Required. The resource being created
     * @param string                                         $edgeSlmId Required. Id of the requesting object
     *                                                                  If auto-generating Id server-side, remove this field and
     *                                                                  edge_slm_id from the method_signature of Create RPC
     *
     * @return \Google\Cloud\Telcoautomation\V1alpha1\CreateEdgeSlmRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm $edgeSlm, string $edgeSlmId): self
    {
        return (new self())
            ->setParent($parent)
            ->setEdgeSlm($edgeSlm)
     ...
     *           If auto-generating Id server-side, remove this field and
     *           edge_slm_id from the method_signature of Create RPC
     *     @type \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm $edge_slm
     *           Required. The resource being created
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.EdgeSlm edge_slm = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.EdgeSlm edge_slm = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm $var
     * @return $this
     */
    public function setEdgeSlm($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm::class);
        $this->edge_slm = $var;
