...
namespace Google\Cloud\Telcoautomation\V1alpha1\HydratedDeployment;
 ...
 *
 * Protobuf type <code>google.cloud.telcoautomation.v1alpha1.HydratedDeployment.State</code>
 */
class State
{
    /**
