 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.GetBlueprintRequest</code>
 */
class GetBlueprintRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.BlueprintView view = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $view = 0;
     ...
     *
     * @return \Google\Cloud\Telcoautomation\V1alpha1\GetBlueprintRequest
     *
     * @experimental
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Telcoautomation\V1alpha1\BlueprintView::class);
        $this->view = $var;
