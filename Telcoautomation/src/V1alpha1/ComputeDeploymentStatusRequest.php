 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.ComputeDeploymentStatusRequest</code>
 */
class ComputeDeploymentStatusRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the deployment. Please see
     *                     {@see TelcoAutomationClient::deploymentName()} for help formatting this field.
     *
     * @return \Google\Cloud\Telcoautomation\V1alpha1\ComputeDeploymentStatusRequest
     *
     * @experimental
     */
