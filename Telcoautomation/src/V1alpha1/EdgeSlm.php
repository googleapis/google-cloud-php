 ...
 * Cluster.
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.EdgeSlm</code>
 */
class EdgeSlm extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.EdgeSlm.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    /**
     ...
     * created.
     *
     * Generated from protobuf field <code>.google.cloud.telcoautomation.v1alpha1.EdgeSlm.WorkloadClusterType workload_cluster_type = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm\State::class);
        $this->state = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Telcoautomation\V1alpha1\EdgeSlm\WorkloadClusterType::class);
