 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.ListPublicBlueprintsResponse</code>
 */
class ListPublicBlueprintsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.telcoautomation.v1alpha1.PublicBlueprint public_blueprints = 1;</code>
     */
     ...
     *
     *     @type array<\Google\Cloud\Telcoautomation\V1alpha1\PublicBlueprint>|\Google\Protobuf\Internal\RepeatedField $public_blueprints
     *           The list of public blueprints to return.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.telcoautomation.v1alpha1.PublicBlueprint public_blueprints = 1;</code>
     * @param array<\Google\Cloud\Telcoautomation\V1alpha1\PublicBlueprint>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPublicBlueprints($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Telcoautomation\V1alpha1\PublicBlueprint::class);
