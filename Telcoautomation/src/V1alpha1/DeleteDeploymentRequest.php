 ...
 *
 * Generated from protobuf message <code>google.cloud.telcoautomation.v1alpha1.DeleteDeploymentRequest</code>
 */
class DeleteDeploymentRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of deployment to delete. Please see
     *                     {@see TelcoAutomationClient::deploymentName()} for help formatting this field.
     *
     * @return \Google\Cloud\Telcoautomation\V1alpha1\DeleteDeploymentRequest
     *
     * @experimental
     */
