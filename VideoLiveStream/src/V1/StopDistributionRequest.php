 ...
 *
 * Generated from protobuf message <code>google.cloud.video.livestream.v1.StopDistributionRequest</code>
 */
class StopDistributionRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * @param string[] $distributionKeys Optional. A list of key to identify the distribution configuration in the
     *                                   channel resource. If left empty, all the distributions in the channel
     *                                   specification will be stopped.
     *
     * @return \Google\Cloud\Video\LiveStream\V1\StopDistributionRequest
     *
     * @experimental
     */
