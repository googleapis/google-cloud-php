...
namespace Google\Cloud\Video\LiveStream\V1\Client\BaseClient;
 ...
 */
abstract class LivestreamServiceBaseClient
{
     ...
     */
    public static function eventName(string $project, string $location, string $channel, string $event): string
    {
     ...
     */
    public static function inputName(string $project, string $location, string $input): string
    {
        return self::getPathTemplate('input')->render([
            'project' => $project,
            'location' => $location,
            'input' => $input,
        ]);
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createEvent(CreateEventRequest $request, array $callOptions = []): Event
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createInput(CreateInputRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('CreateInput', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteEvent(DeleteEventRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteEvent', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listInputs(ListInputsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListInputs', $request, $callOptions);
    }
