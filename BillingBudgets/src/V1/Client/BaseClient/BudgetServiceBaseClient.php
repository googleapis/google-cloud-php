...
namespace Google\Cloud\Billing\Budgets\V1\Client\BaseClient;
 ...
 */
abstract class BudgetServiceBaseClient
{
     ...
     */
    public static function budgetName(string $billingAccount, string $budget): string
    {
        return self::getPathTemplate('budget')->render([
            'billing_account' => $billingAccount,
            'budget' => $budget,
        ]);
    }
     ...
     *
     * The async variant is {@see self::createBudgetAsync()} .
     *
     ...
     */
    public function createBudget(CreateBudgetRequest $request, array $callOptions = []): Budget
    {
        return $this->startApiCall('CreateBudget', $request, $callOptions)->wait();
    }

    /**
     * Deletes a budget. Returns successfully if already deleted.
     *
     * The async variant is {@see self::deleteBudgetAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteBudget(DeleteBudgetRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteBudget', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see self::getBudgetAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getBudget(GetBudgetRequest $request, array $callOptions = []): Budget
    {
        return $this->startApiCall('GetBudget', $request, $callOptions)->wait();
    }
     ...
     * in the Cloud Console.
     *
     * The async variant is {@see self::listBudgetsAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listBudgets(ListBudgetsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListBudgets', $request, $callOptions);
    }
     ...
     *
     * The async variant is {@see self::updateBudgetAsync()} .
     *
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateBudget(UpdateBudgetRequest $request, array $callOptions = []): Budget
    {
        return $this->startApiCall('UpdateBudget', $request, $callOptions)->wait();
    }
}
