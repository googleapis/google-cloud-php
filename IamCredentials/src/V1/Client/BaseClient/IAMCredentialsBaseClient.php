...
namespace Google\Cloud\Iam\Credentials\V1\Client\BaseClient;
 ...
 */
abstract class IAMCredentialsBaseClient
{
     ...
     *
     * The async variant is {@see self::generateAccessTokenAsync()} .
     *
     ...
     *
     * The async variant is {@see self::generateIdTokenAsync()} .
     *
     ...
     *
     * The async variant is {@see self::signBlobAsync()} .
     *
     ...
     *
     * The async variant is {@see self::signJwtAsync()} .
     *
