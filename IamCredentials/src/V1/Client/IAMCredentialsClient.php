...
namespace Google\Cloud\Iam\Credentials\V1\Client;
...
final class IAMCredentialsClient
{
     ...
     *           $options = new IAMCredentialsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function generateIdToken(GenerateIdTokenRequest $request, array $callOptions = []): GenerateIdTokenResponse
    {
        return $this->startApiCall('GenerateIdToken', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function signBlob(SignBlobRequest $request, array $callOptions = []): SignBlobResponse
    {
        return $this->startApiCall('SignBlob', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function signJwt(SignJwtRequest $request, array $callOptions = []): SignJwtResponse
    {
        return $this->startApiCall('SignJwt', $request, $callOptions)->wait();
    }
}
