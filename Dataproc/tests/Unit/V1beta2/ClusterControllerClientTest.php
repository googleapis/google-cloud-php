...
use Google\Cloud\Dataproc\V1beta2\ClusterConfig;

use Google\Cloud\Dataproc\V1beta2\ClusterControllerClient;
...
class ClusterControllerClientTest extends GeneratedTest
{
    ...
    public function createClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/CreateCluster', $actualApiFuncCall);
    ...
    public function deleteClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/DeleteCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProjectId();
        $this->assertProtobufEquals($projectId, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function diagnoseClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/DiagnoseCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProjectId();
        $this->assertProtobufEquals($projectId, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function getClusterTest()
    {
        ...
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/GetCluster', $actualFuncCall);
    ...
    public function listClustersTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/ListClusters', $actualFuncCall);
        $actualValue = $actualRequestObject->getProjectId();
        $this->assertProtobufEquals($projectId, $actualValue);
        $actualValue = $actualRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
    ...
    public function updateClusterTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dataproc.v1beta2.ClusterController/UpdateCluster', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getProjectId();
        $this->assertProtobufEquals($projectId, $actualValue);
        $actualValue = $actualApiRequestObject->getRegion();
        $this->assertProtobufEquals($region, $actualValue);
