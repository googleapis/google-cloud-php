...
class BatchControllerClientTest extends GeneratedTest
{
    ...
    public function createBatchTest()
    {
        ...
        $incompleteOperation->setName('operations/createBatchTest');
        ...
        $completeOperation->setName('operations/createBatchTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        $response = $gapicClient->createBatch();
    ...
    public function listBatchesTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $batchesElement = new Batch();
        $batches = [
            $batchesElement,
        ];
        $expectedResponse = new ListBatchesResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setBatches($batches);
        $transport->addResponse($expectedResponse);
        $response = $gapicClient->listBatches();
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getBatches()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
