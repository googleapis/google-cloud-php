 ...
 */
abstract class NodeGroupControllerBaseClient
{
     ...
     *
     * The async variant is {@see self::createNodeGroupAsync()} .
     *
     ...
     * cluster.
     *
     * The async variant is {@see self::getNodeGroupAsync()} .
     *
     ...
     * [NodeGroupOperationMetadata](https://cloud.google.com/dataproc/docs/reference/rpc/google.cloud.dataproc.v1#nodegroupoperationmetadata).
     *
     * The async variant is {@see self::resizeNodeGroupAsync()} .
     *
