...
use Google\Cloud\Dataproc\V1\ListSessionsResponse;
 ...
 *
 * @deprecated Please use the new service client {@see \Google\Cloud\Dataproc\V1\Client\SessionControllerClient}.
 */
class SessionControllerGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.dataproc.v1.SessionController';
    ...
    private static function getSessionNameTemplate()
    {
        if (self::$sessionNameTemplate == null) {
            self::$sessionNameTemplate = new PathTemplate('projects/{project}/locations/{location}/sessions/{session}');
        }
     ...
     */
    public static function sessionName($project, $location, $session)
    {
    ...
    public function createSession($parent, $session, $sessionId, array $optionalArgs = [])
    {
        ...
        return $this->startOperationsCall('CreateSession', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function deleteSession($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('DeleteSession', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
    ...
    public function terminateSession($name, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startOperationsCall('TerminateSession', $optionalArgs, $request, $this->getOperationsClient())->wait();
    }
