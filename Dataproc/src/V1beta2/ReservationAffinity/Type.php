...
namespace Google\Cloud\Dataproc\V1beta2\ReservationAffinity;
 ...
 *
 * Protobuf type <code>google.cloud.dataproc.v1beta2.ReservationAffinity.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\Dataproc\V1beta2\ReservationAffinity_Type::class);
