 ...
 *
 * Generated from protobuf message <code>google.cloud.dataproc.v1beta2.LoggingConfig</code>
 */
class LoggingConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>map<string, .google.cloud.dataproc.v1beta2.LoggingConfig.Level> driver_log_levels = 2;</code>
     */
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Dataproc\V1beta2\LoggingConfig\Level::class);
