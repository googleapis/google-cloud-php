 ...
 * The cluster state.
 *
 * Protobuf type <code>google.cloud.dataproc.v1beta2.ClusterStatus.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\Dataproc\V1beta2\ClusterStatus_State::class);
