 ...
 *
 * Generated from protobuf message <code>google.cloud.dataproc.v1beta2.ClusterOperationStatus</code>
 */
final class ClusterOperationStatus extends \Google\Protobuf\Internal\Message
{
    /**
     * Output only. A message containing the operation state.
     *
     * Generated from protobuf field <code>.google.cloud.dataproc.v1beta2.ClusterOperationStatus.State state = 1;</code>
     */
    private $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dataproc\V1beta2\ClusterOperationStatus_State::class);
        $this->state = $var;
