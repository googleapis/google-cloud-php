 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1.GroupFindingsResponse</code>
 */
class GroupFindingsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\SecurityCenter\V1\GroupResult[] $group_by_results
     *           Group results. There exists an element for each existing unique
     *           combination of property/values. The element contains a count for the number
     *           of times those specific property/values appear.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.GroupResult group_by_results = 1;</code>
     * @return RepeatedField<\Google\Cloud\SecurityCenter\V1\GroupResult>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.securitycenter.v1.GroupResult group_by_results = 1;</code>
     * @param \Google\Cloud\SecurityCenter\V1\GroupResult[] $var
     * @return $this
     */
    public function setGroupByResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V1\GroupResult::class);
