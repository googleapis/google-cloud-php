 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v1.AttackPath.AttackPathNode.NodeType</code>
 */
class NodeType
{
    /**
...
class_alias(NodeType::class, \Google\Cloud\SecurityCenter\V1\AttackPath_AttackPathNode_NodeType::class);
