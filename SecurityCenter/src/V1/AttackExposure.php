 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1.AttackExposure</code>
 */
class AttackExposure extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V1\AttackExposure\State::class);
        $this->state = $var;
