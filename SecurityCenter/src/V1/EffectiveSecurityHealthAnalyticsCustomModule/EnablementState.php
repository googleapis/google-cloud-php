...
namespace Google\Cloud\SecurityCenter\V1\EffectiveSecurityHealthAnalyticsCustomModule;
 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.EnablementState</code>
 */
...
class_alias(EnablementState::class, \Google\Cloud\SecurityCenter\V1\EffectiveSecurityHealthAnalyticsCustomModule_EnablementState::class);
