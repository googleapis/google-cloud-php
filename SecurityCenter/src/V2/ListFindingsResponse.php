 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.ListFindingsResponse</code>
 */
class ListFindingsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V2\ListFindingsResponse\ListFindingsResult::class);
