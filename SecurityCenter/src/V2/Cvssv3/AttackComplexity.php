 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Cvssv3.AttackComplexity</code>
 */
...
class_alias(AttackComplexity::class, \Google\Cloud\SecurityCenter\V2\Cvssv3_AttackComplexity::class);
