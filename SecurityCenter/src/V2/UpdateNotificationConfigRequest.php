 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.UpdateNotificationConfigRequest</code>
 */
class UpdateNotificationConfigRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *                                                                               If empty all mutable fields will be updated.
     *
     * @return \Google\Cloud\SecurityCenter\V2\UpdateNotificationConfigRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\SecurityCenter\V2\NotificationConfig $notificationConfig, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
