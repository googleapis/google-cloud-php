 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.Kubernetes.NodePool</code>
 */
...
class_alias(NodePool::class, \Google\Cloud\SecurityCenter\V2\Kubernetes_NodePool::class);
