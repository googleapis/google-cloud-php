 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.Kubernetes.Role</code>
 */
class Role extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\SecurityCenter\V2\Kubernetes\Role\Kind::class);
        $this->kind = $var;
