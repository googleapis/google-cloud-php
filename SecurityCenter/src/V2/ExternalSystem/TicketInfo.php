 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.ExternalSystem.TicketInfo</code>
 */
...
class_alias(TicketInfo::class, \Google\Cloud\SecurityCenter\V2\ExternalSystem_TicketInfo::class);
