 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v2.Finding.FindingClass</code>
 */
class FindingClass
{
    /**
...
class_alias(FindingClass::class, \Google\Cloud\SecurityCenter\V2\Finding_FindingClass::class);
