 ...
 * default is global.
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.DeleteMuteConfigRequest</code>
 */
class DeleteMuteConfigRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. Name of the mute config to delete. The following list shows some
     *                     examples of the format:
     *
     *                     + `organizations/{organization}/muteConfigs/{config_id}`
     *                     +
     ...
     *
     * @return \Google\Cloud\SecurityCenter\V2\DeleteMuteConfigRequest
     *
     * @experimental
     */
