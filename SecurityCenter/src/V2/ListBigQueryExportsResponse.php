 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.ListBigQueryExportsResponse</code>
 */
class ListBigQueryExportsResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V2\BigQueryExport::class);
