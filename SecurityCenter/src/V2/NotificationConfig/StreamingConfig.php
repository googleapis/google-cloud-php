 ...
 * as it is detected.
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.NotificationConfig.StreamingConfig</code>
 */
...
class_alias(StreamingConfig::class, \Google\Cloud\SecurityCenter\V2\NotificationConfig_StreamingConfig::class);
