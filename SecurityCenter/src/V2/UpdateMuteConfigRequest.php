 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v2.UpdateMuteConfigRequest</code>
 */
class UpdateMuteConfigRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v2.MuteConfig mute_config = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\SecurityCenter\V2\MuteConfig $muteConfig Required. The mute config being updated.
     * @param \Google\Protobuf\FieldMask                 $updateMask The list of fields to be updated.
     *                                                               If empty all mutable fields will be updated.
     *
     * @return \Google\Cloud\SecurityCenter\V2\UpdateMuteConfigRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\SecurityCenter\V2\MuteConfig $muteConfig, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
