 ...
 *
 * Generated from protobuf message <code>google.apps.meet.v2beta.BatchUpdateMembersRequest</code>
 */
class BatchUpdateMembersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.apps.meet.v2beta.UpdateMemberRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $requests;
    /**
     ...
     *           Required. The parent resource shared by all Members being updated.
     *           Format: spaces/{space}
     *     @type \Google\Apps\Meet\V2beta\UpdateMemberRequest[] $requests
     *           Required. The request message specifying the resources to update.
     *           A maximum of 500 members can be modified in a batch.
     ...
     *
     * Generated from protobuf field <code>repeated .google.apps.meet.v2beta.UpdateMemberRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return RepeatedField<\Google\Apps\Meet\V2beta\UpdateMemberRequest>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.apps.meet.v2beta.UpdateMemberRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Apps\Meet\V2beta\UpdateMemberRequest[] $var
     * @return $this
     */
    public function setRequests($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Apps\Meet\V2beta\UpdateMemberRequest::class);
        $this->requests = $arr;
