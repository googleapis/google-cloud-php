 ...
 *
 * Generated from protobuf message <code>google.apps.meet.v2.SpaceConfig.ModerationRestrictions</code>
 */
class ModerationRestrictions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.SpaceConfig.ModerationRestrictions.RestrictionType chat_restriction = 1;</code>
     */
    protected $chat_restriction = 0;
    /**
     * Defines who has permission to send reactions in the meeting space.
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.SpaceConfig.ModerationRestrictions.RestrictionType reaction_restriction = 2;</code>
     */
    protected $reaction_restriction = 0;
    /**
     * Defines who has permission to share their screen in the meeting space.
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.SpaceConfig.ModerationRestrictions.RestrictionType present_restriction = 3;</code>
     */
    protected $present_restriction = 0;
    /**
     * Defines whether to restrict the default role assigned to users as viewer.
     *
     * Generated from protobuf field <code>.google.apps.meet.v2.SpaceConfig.ModerationRestrictions.DefaultJoinAsViewerType default_join_as_viewer_type = 4;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Apps\Meet\V2\SpaceConfig\ModerationRestrictions\RestrictionType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Apps\Meet\V2\SpaceConfig\ModerationRestrictions\DefaultJoinAsViewerType::class);
