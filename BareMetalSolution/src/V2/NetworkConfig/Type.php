 ...
 * Network type.
 *
 * Protobuf type <code>google.cloud.baremetalsolution.v2.NetworkConfig.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Google\Cloud\BareMetalSolution\V2\NetworkConfig_Type::class);
