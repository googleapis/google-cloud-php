...
class IntentsClientTest extends GeneratedTest
{
    ...
    public function exportIntentsTest()
    {
        ...
        $formattedParent = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $intents = [];
        $response = $gapicClient->exportIntents($formattedParent, $intents);
        ...
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/ExportIntents', $actualApiFuncCall);
    ...
    public function importIntentsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $gapicClient->importIntents($formattedParent);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Intents/ImportIntents', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
