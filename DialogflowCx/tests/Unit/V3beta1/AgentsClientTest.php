...
use Google\Cloud\Dialogflow\Cx\V3beta1\GenerativeSettings;
...
class AgentsClientTest extends GeneratedTest
{
    ...
    public function getGenerativeSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Agents/GetGenerativeSettings', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
    ...
    public function updateGenerativeSettingsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3beta1.Agents/UpdateGenerativeSettings', $actualFuncCall);
