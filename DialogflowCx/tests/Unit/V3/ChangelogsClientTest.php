...
use Google\Cloud\Dialogflow\Cx\V3\ListChangelogsResponse;
...
class ChangelogsClientTest extends GeneratedTest
{
    ...
    public function getChangelogTest()
    {
        ...
        $response = $gapicClient->getChangelog($formattedName);
    ...
    public function getChangelogExceptionTest()
    {
        ...
        $formattedName = $gapicClient->changelogName('[PROJECT]', '[LOCATION]', '[AGENT]', '[CHANGELOG]');
        try {
            $gapicClient->getChangelog($formattedName);
    ...
    public function listChangelogsTest()
    {
        ...
        $response = $gapicClient->listChangelogs($formattedParent);
    ...
    public function listChangelogsExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        try {
            $gapicClient->listChangelogs($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
