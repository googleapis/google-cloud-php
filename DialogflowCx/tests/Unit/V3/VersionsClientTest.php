...
class VersionsClientTest extends GeneratedTest
{
    ...
    public function compareVersionsTest()
    {
        ...
        $response = $gapicClient->compareVersions($formattedBaseVersion, $formattedTargetVersion);
    ...
    public function compareVersionsExceptionTest()
    {
        ...
        $formattedTargetVersion = $gapicClient->versionName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]', '[VERSION]');
        try {
            $gapicClient->compareVersions($formattedBaseVersion, $formattedTargetVersion);
    ...
    public function loadVersionTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->versionName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]', '[VERSION]');
        $response = $gapicClient->loadVersion($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
