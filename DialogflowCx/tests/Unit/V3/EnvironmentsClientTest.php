...
class EnvironmentsClientTest extends GeneratedTest
{
    ...
    public function createEnvironmentTest()
    {
        ...
        $response = $gapicClient->createEnvironment($formattedParent, $environment);
    ...
    public function deleteEnvironmentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
    ...
    public function deployFlowTest()
    {
        ...
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedEnvironment = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $formattedFlowVersion = $gapicClient->versionName('[PROJECT]', '[LOCATION]', '[AGENT]', '[FLOW]', '[VERSION]');
        $response = $gapicClient->deployFlow($formattedEnvironment, $formattedFlowVersion);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3.Environments/DeployFlow', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEnvironment();
    ...
    public function listContinuousTestResultsTest()
    {
        ...
        $response = $gapicClient->listContinuousTestResults($formattedParent);
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3.Environments/ListContinuousTestResults', $actualFuncCall);
    ...
    public function listContinuousTestResultsExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        try {
            $gapicClient->listContinuousTestResults($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function lookupEnvironmentHistoryTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $response = $gapicClient->lookupEnvironmentHistory($formattedName);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getEnvironments()[0], $resources[0]);
    ...
    public function lookupEnvironmentHistoryExceptionTest()
    {
        ...
        $formattedName = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        try {
            $gapicClient->lookupEnvironmentHistory($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function runContinuousTestTest()
    {
        ...
        // Mock request
        $formattedEnvironment = $gapicClient->environmentName('[PROJECT]', '[LOCATION]', '[AGENT]', '[ENVIRONMENT]');
        $response = $gapicClient->runContinuousTest($formattedEnvironment);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.cx.v3.Environments/RunContinuousTest', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getEnvironment();
        $this->assertProtobufEquals($formattedEnvironment, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
