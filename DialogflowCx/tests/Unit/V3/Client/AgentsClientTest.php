...
class AgentsClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function getGenerativeSettingsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $name2 = 'name2-1052831874';
        $languageCode2 = 'languageCode2-1564186329';
        $expectedResponse = new GenerativeSettings();
        $expectedResponse->setName($name2);
    ...
    /** @test */
    public function getGenerativeSettingsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function updateGenerativeSettingsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function updateGenerativeSettingsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function createAgentAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
