...
class AgentsClientTest extends GeneratedTest
{
    ...
    public function createAgentTest()
    {
        ...
        $response = $gapicClient->createAgent($formattedParent, $agent);
    ...
    public function createAgentExceptionTest()
    {
        ...
        $agent->setTimeZone($agentTimeZone);
        try {
            $gapicClient->createAgent($formattedParent, $agent);
    ...
    public function deleteAgentTest()
    {
        ...
        $gapicClient->deleteAgent($formattedName);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function exportAgentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $gapicClient->exportAgent($formattedName);
    ...
    public function getAgentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $gapicClient->getAgent($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getAgentExceptionTest()
    {
        ...
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        try {
            $gapicClient->getAgent($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getAgentValidationResultTest()
    {
        ...
        $response = $gapicClient->getAgentValidationResult($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getAgentValidationResultExceptionTest()
    {
        ...
        $formattedName = $gapicClient->agentValidationResultName('[PROJECT]', '[LOCATION]', '[AGENT]');
        try {
            $gapicClient->getAgentValidationResult($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function getGenerativeSettingsTest()
    {
        ...
        $response = $gapicClient->getGenerativeSettings($formattedName, $languageCode);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function getGenerativeSettingsExceptionTest()
    {
        ...
        $languageCode = 'languageCode-412800396';
        try {
            $gapicClient->getGenerativeSettings($formattedName, $languageCode);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listAgentsTest()
    {
        ...
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $response = $gapicClient->listAgents($formattedParent);
    ...
    public function listAgentsExceptionTest()
    {
        ...
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        try {
            $gapicClient->listAgents($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function restoreAgentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $gapicClient->restoreAgent($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function updateAgentTest()
    {
        ...
        $agentTimeZone = 'agentTimeZone-453669314';
        $agent->setTimeZone($agentTimeZone);
        $response = $gapicClient->updateAgent($agent);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateGenerativeSettingsTest()
    {
        ...
        $response = $gapicClient->updateGenerativeSettings($generativeSettings);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function updateGenerativeSettingsExceptionTest()
    {
        ...
        $generativeSettings = new GenerativeSettings();
        try {
            $gapicClient->updateGenerativeSettings($generativeSettings);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function validateAgentTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        $response = $gapicClient->validateAgent($formattedName);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function validateAgentExceptionTest()
    {
        ...
        $formattedName = $gapicClient->agentName('[PROJECT]', '[LOCATION]', '[AGENT]');
        try {
            $gapicClient->validateAgent($formattedName);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
