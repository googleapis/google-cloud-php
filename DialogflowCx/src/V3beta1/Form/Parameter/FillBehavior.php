...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\Form\Parameter;
 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Form.Parameter.FillBehavior</code>
 */
class FillBehavior extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EventHandler reprompt_event_handlers = 5;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Fulfillment $initial_prompt_fulfillment
     *           Required. The fulfillment to provide the initial prompt that the agent
     *           can present to the user in order to fill the parameter.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\EventHandler>|\Google\Protobuf\Internal\RepeatedField $reprompt_event_handlers
     *           The handlers for parameter-level events, used to provide reprompt for
     *           the parameter or transition to a different page/flow. The supported
     *           events are:
     *           *   `sys.no-match-<N>`, where N can be from 1 to 6
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EventHandler reprompt_event_handlers = 5;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\EventHandler>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
