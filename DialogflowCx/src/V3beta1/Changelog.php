 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Changelog</code>
 */
class Changelog extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Dialogflow\Cx\V3Beta1\Changelog::initOnce();
