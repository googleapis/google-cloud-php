 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.TestCase</code>
 */
class TestCase extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.ConversationTurn test_case_conversation_turns = 5;</code>
     */
     ...
     *     @type string $notes
     *           Additional freeform notes about the test case. Limit of 400 characters.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\TestConfig $test_config
     *           Config for the test case.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\ConversationTurn>|\Google\Protobuf\Internal\RepeatedField $test_case_conversation_turns
     *           The conversation turns uttered when the test case was created, in
     *           chronological order. These include the canonical set of agent utterances
     *           that should occur when the agent is working properly.
     *     @type \Google\Protobuf\Timestamp $creation_time
     *           Output only. When the test was created.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\TestCaseResult $last_test_result
     *           The latest test result.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.TestConfig test_config = 13;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\TestConfig $var
     * @return $this
     */
    public function setTestConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\TestConfig::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.ConversationTurn test_case_conversation_turns = 5;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\ConversationTurn>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.TestCaseResult last_test_result = 12;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\TestCaseResult $var
     * @return $this
     */
    public function setLastTestResult($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\TestCaseResult::class);
