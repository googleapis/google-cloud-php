 ...
 * Dialogflow.
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.InlineDestination</code>
 */
class InlineDestination extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Cloud\Dialogflow\Cx\V3Beta1\Inline::initOnce();
