...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\Webhook\GenericWebService;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.Webhook.GenericWebService.HttpMethod</code>
 */
class HttpMethod
{
    /**
