 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.UpdateSessionEntityTypeRequest</code>
 */
class UpdateSessionEntityTypeRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * environment.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.SessionEntityType session_entity_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType $session_entity_type
     *           Required. The session entity type to update.
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/sessions/<Session ID>/entityTypes/<Entity Type ID>` or
     *           `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.SessionEntityType session_entity_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.SessionEntityType session_entity_type = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType $var
     * @return $this
     */
    public function setSessionEntityType($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType::class);
