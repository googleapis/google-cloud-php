    ...
    'interfaces' => [
        'google.cloud.dialogflow.cx.v3beta1.Agents' => [
            ...
            'GetGenerativeSettings' => [
                'method' => 'get',
                'uriTemplate' => '/v3beta1/{name=projects/*/locations/*/agents/*/generativeSettings}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'UpdateGenerativeSettings' => [
                'method' => 'patch',
                'uriTemplate' => '/v3beta1/{generative_settings.name=projects/*/locations/*/agents/*/generativeSettings}',
