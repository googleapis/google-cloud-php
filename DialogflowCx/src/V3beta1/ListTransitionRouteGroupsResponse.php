...
class ListTransitionRouteGroupsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroup>|\Google\Protobuf\Internal\RepeatedField $transition_route_groups
     *           The list of transition route groups. There will be a maximum number of
     *           items returned based on the page_size field in the request. The list may in
     *           some cases be empty or contain fewer entries than page_size even if this
     *           isn't the last page.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup transition_route_groups = 1;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\TransitionRouteGroup>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
