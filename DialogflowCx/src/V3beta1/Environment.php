...
class Environment extends \Google\Protobuf\Internal\Message
{
     ...
     * returned.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.Environment.VersionConfig version_configs = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Environment.WebhookConfig webhook_config = 10;</code>
     */
     ...
     *           The human-readable description of the environment. The maximum length is
     *           500 characters. If exceeded, the request is rejected.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\Environment\VersionConfig>|\Google\Protobuf\Internal\RepeatedField $version_configs
     *           A list of configurations for flow versions. You should include version
     *           configs for all flows that are reachable from [`Start
     *           Flow`][Agent.start_flow] in the agent. Otherwise, an error will be
     *           returned.
     ...
     *           The test cases config for continuous tests of this environment.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Environment\WebhookConfig $webhook_config
     *           The webhook configuration for this environment.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.Environment.VersionConfig version_configs = 6;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\Environment\VersionConfig>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Environment.WebhookConfig webhook_config = 10;</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\Environment\WebhookConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Environment.WebhookConfig webhook_config = 10;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Environment\WebhookConfig $var
     * @return $this
     */
    public function setWebhookConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Environment\WebhookConfig::class);
