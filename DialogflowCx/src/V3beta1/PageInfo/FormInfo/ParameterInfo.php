...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\PageInfo\FormInfo;
 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.PageInfo.FormInfo.ParameterInfo</code>
 */
class ParameterInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.PageInfo.FormInfo.ParameterInfo.ParameterState state = 3;</code>
     */
    protected $state = 0;
    /**
     * Optional for both
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\PageInfo\FormInfo\ParameterInfo\ParameterState::class);
        $this->state = $var;
