 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Experiment.Result.Metric</code>
 */
class Metric extends \Google\Protobuf\Internal\Message
{
     ...
     * each Metric.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.MetricType type = 1;</code>
     */
    protected $type = 0;
    /**
     ...
     * each Metric.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.CountType count_type = 5;</code>
     */
     ...
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment\Result\ConfidenceInterval $confidence_interval
     *           The probability that the treatment is better than all other treatments
     *           in the experiment
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment\Result\MetricType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment\Result\CountType::class);
        $this->count_type = $var;
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment.Result.ConfidenceInterval confidence_interval = 3;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment\Result\ConfidenceInterval $var
     * @return $this
     */
    public function setConfidenceInterval($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment\Result\ConfidenceInterval::class);
