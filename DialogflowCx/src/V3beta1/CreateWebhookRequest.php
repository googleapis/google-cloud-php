 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.CreateWebhookRequest</code>
 */
class CreateWebhookRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           Required. The agent to create a webhook for.
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>`.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Webhook $webhook
     *           Required. The webhook to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Webhook webhook = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Webhook $var
     * @return $this
     */
    public function setWebhook($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Webhook::class);
        $this->webhook = $var;
