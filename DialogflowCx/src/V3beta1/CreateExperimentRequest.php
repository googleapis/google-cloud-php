 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.CreateExperimentRequest</code>
 */
class CreateExperimentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/environments/<Environment ID>`.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment $experiment
     *           Required. The experiment to create.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Experiment experiment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment $var
     * @return $this
     */
    public function setExperiment($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Experiment::class);
        $this->experiment = $var;
