...
class ExportAgentRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * is assumed.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ExportAgentRequest.DataFormat data_format = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ExportAgentRequest.GitDestination git_destination = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/environments/<Environment ID>`.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\ExportAgentRequest\GitDestination $git_destination
     *           Optional. The Git branch to export the agent to.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ExportAgentRequest\DataFormat::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ExportAgentRequest.GitDestination git_destination = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\ExportAgentRequest\GitDestination|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ExportAgentRequest.GitDestination git_destination = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\ExportAgentRequest\GitDestination $var
     * @return $this
     */
    public function setGitDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ExportAgentRequest\GitDestination::class);
