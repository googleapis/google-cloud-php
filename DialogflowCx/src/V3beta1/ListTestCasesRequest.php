 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ListTestCasesRequest</code>
 */
class ListTestCasesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ListTestCasesRequest.TestCaseView view = 4;</code>
     */
    protected $view = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ListTestCasesRequest\TestCaseView::class);
        $this->view = $var;
