 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.TextToSpeechSettings</code>
 */
class TextToSpeechSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *    is not specified.
     *
     * Generated from protobuf field <code>map<string, .google.cloud.dialogflow.cx.v3beta1.SynthesizeSpeechConfig> synthesize_speech_configs = 1;</code>
     */
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\SynthesizeSpeechConfig::class);
