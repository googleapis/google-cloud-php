...
class StreamingDetectIntentResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.CloudConversationDebuggingInfo debugging_info = 4;</code>
     */
     ...
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\CloudConversationDebuggingInfo $debugging_info
     *           Debugging info that would get populated when
     *           `StreamingDetectIntentRequest.enable_debugging_info` is set to true.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.CloudConversationDebuggingInfo debugging_info = 4;</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\CloudConversationDebuggingInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.CloudConversationDebuggingInfo debugging_info = 4;</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\CloudConversationDebuggingInfo $var
     * @return $this
     */
    public function setDebuggingInfo($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\CloudConversationDebuggingInfo::class);
