...
namespace Google\Cloud\Dialogflow\Cx\V3beta1\ImportIntentsRequest;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3beta1.ImportIntentsRequest.MergeOption</code>
 */
class MergeOption
{
    /**
