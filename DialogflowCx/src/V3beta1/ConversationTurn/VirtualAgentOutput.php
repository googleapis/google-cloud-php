 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ConversationTurn.VirtualAgentOutput</code>
 */
class VirtualAgentOutput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.TestRunDifference differences = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $differences;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Intent triggered_intent = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Page current_page = 8;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.ResponseMessage.Text text_responses = 9;</code>
     */
     ...
     *           The session parameters available to the bot at this point.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference>|\Google\Protobuf\Internal\RepeatedField $differences
     *           Output only. If this is part of a [result conversation
     *           turn][TestCaseResult.conversation_turns], the list of differences
     *           between the original run and the replay for this output, if any.
     ...
     *           The [Page][google.cloud.dialogflow.cx.v3beta1.Page] on which the
     *           utterance was spoken. Only name and displayName will be set.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text>|\Google\Protobuf\Internal\RepeatedField $text_responses
     *           The [text][google.cloud.dialogflow.cx.v3beta1.ResponseMessage.Text]
     *           responses from the agent for the turn.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.TestRunDifference differences = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDifferences($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.ResponseMessage.Text text_responses = 9;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTextResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage\Text::class);
