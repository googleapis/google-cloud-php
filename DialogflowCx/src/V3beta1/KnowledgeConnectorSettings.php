 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.KnowledgeConnectorSettings</code>
 */
class KnowledgeConnectorSettings extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.DataStoreConnection data_store_connections = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     *           ID>/flows/<Flow ID>`.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\DataStoreConnection>|\Google\Protobuf\Internal\RepeatedField $data_store_connections
     *           Optional. List of related data store connections.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.DataStoreConnection data_store_connections = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\DataStoreConnection>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDataStoreConnections($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\DataStoreConnection::class);
