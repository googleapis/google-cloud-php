 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.CalculateCoverageRequest</code>
 */
class CalculateCoverageRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.CalculateCoverageRequest.CoverageType type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\CalculateCoverageRequest\CoverageType::class);
        $this->type = $var;
