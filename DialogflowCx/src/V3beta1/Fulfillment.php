...
class Fulfillment extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.AdvancedSettings advanced_settings = 7;</code>
     */
     ...
     *
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage>|\Google\Protobuf\Internal\RepeatedField $messages
     *           The list of rich message responses to present to the user.
     *     @type string $webhook
     *           The webhook to call.
     *           Format: `projects/<Project ID>/locations/<Location ID>/agents/<Agent
     ...
     *           fulfillment is being called, but it could be used for other purposes.
     *           This field is required if `webhook` is specified.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\Fulfillment\SetParameterAction>|\Google\Protobuf\Internal\RepeatedField $set_parameter_actions
     *           Set parameter values before executing the webhook.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\Fulfillment\ConditionalCases>|\Google\Protobuf\Internal\RepeatedField $conditional_cases
     *           Conditional cases for this fulfillment.
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.ResponseMessage messages = 1;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\ResponseMessage>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.Fulfillment.SetParameterAction set_parameter_actions = 4;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\Fulfillment\SetParameterAction>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.Fulfillment.ConditionalCases conditional_cases = 5;</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\Fulfillment\ConditionalCases>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
