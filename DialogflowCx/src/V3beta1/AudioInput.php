 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.AudioInput</code>
 */
class AudioInput extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\InputAudioConfig $config
     *           Required. Instructs the speech recognizer how to process the speech audio.
     *     @type string $audio
     *           The natural language speech audio to be processed.
     *           A single request can contain up to 2 minutes of speech audio data.
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.InputAudioConfig config = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\InputAudioConfig $var
     * @return $this
     */
    public function setConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\InputAudioConfig::class);
        $this->config = $var;
