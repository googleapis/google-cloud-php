 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.Version</code>
 */
class Version extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.Version.State state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $state = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\Version\State::class);
        $this->state = $var;
