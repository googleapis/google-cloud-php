 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.ImportFlowRequest</code>
 */
class ImportFlowRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.ImportFlowRequest.ImportOption import_option = 4;</code>
     */
     ...
     * conflicts.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.FlowImportStrategy flow_import_strategy = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Flow import mode. If not specified, `KEEP` is assumed.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\FlowImportStrategy $flow_import_strategy
     *           Optional. Specifies the import strategy used when resolving resource
     *           conflicts.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\ImportFlowRequest\ImportOption::class);
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.FlowImportStrategy flow_import_strategy = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\FlowImportStrategy|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.FlowImportStrategy flow_import_strategy = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\FlowImportStrategy $var
     * @return $this
     */
    public function setFlowImportStrategy($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\FlowImportStrategy::class);
