...
class Flow extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.AdvancedSettings advanced_settings = 14;</code>
     */
    protected $advanced_settings = null;
    /**
     * Optional. Knowledge connector configuration.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.KnowledgeConnectorSettings knowledge_connector_settings = 18 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           *   TransitionRoutes with only condition specified.
     *           TransitionRoutes with intent specified are inherited by pages in the flow.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\EventHandler>|\Google\Protobuf\Internal\RepeatedField $event_handlers
     *           A flow's event handlers serve two purposes:
     *           *   They are responsible for handling events (e.g. no match,
     *           webhook errors) in the flow.
     *           *   They are inherited by every page's [event
     ...
     *           Hierarchical advanced settings for this flow. The settings exposed at the
     *           lower level overrides the settings exposed at the higher level.
     *     @type \Google\Cloud\Dialogflow\Cx\V3beta1\KnowledgeConnectorSettings $knowledge_connector_settings
     *           Optional. Knowledge connector configuration.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.KnowledgeConnectorSettings knowledge_connector_settings = 18 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Dialogflow\Cx\V3beta1\KnowledgeConnectorSettings|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.KnowledgeConnectorSettings knowledge_connector_settings = 18 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Dialogflow\Cx\V3beta1\KnowledgeConnectorSettings $var
     * @return $this
     */
    public function setKnowledgeConnectorSettings($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Dialogflow\Cx\V3beta1\KnowledgeConnectorSettings::class);
