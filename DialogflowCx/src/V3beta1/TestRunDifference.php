 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.TestRunDifference</code>
 */
class TestRunDifference extends \Google\Protobuf\Internal\Message
{
     ...
     * The type of diff.
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.TestRunDifference.DiffType type = 1;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\TestRunDifference\DiffType::class);
        $this->type = $var;
