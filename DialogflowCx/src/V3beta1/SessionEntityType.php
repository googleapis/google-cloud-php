 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3beta1.SessionEntityType</code>
 */
class SessionEntityType extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.dialogflow.cx.v3beta1.SessionEntityType.EntityOverrideMode entity_override_mode = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * entity type.
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.Entity entities = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $entities;
     ...
     *           Required. Indicates whether the additional data should override or
     *           supplement the custom entity type definition.
     *     @type array<\Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Entity>|\Google\Protobuf\Internal\RepeatedField $entities
     *           Required. The collection of entities to override or supplement the custom
     *           entity type.
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dialogflow\Cx\V3beta1\SessionEntityType\EntityOverrideMode::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.cx.v3beta1.EntityType.Entity entities = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Entity>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEntities($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\Cx\V3beta1\EntityType\Entity::class);
        $this->entities = $arr;
