 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.DeleteToolVersionRequest</code>
 */
class DeleteToolVersionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the tool version to delete.
     *                     Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\DeleteToolVersionRequest
     *
     * @experimental
     */
