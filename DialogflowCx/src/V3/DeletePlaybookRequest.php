 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.DeletePlaybookRequest</code>
 */
class DeletePlaybookRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the playbook to delete.
     *                     Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\DeletePlaybookRequest
     *
     * @experimental
     */
