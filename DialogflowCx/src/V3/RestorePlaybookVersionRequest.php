 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.RestorePlaybookVersionRequest</code>
 */
class RestorePlaybookVersionRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the playbook version.
     *                     Format:
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\RestorePlaybookVersionRequest
     *
     * @experimental
     */
