 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.cx.v3.ListPlaybooksRequest</code>
 */
class ListPlaybooksRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The agent to list playbooks from.
     ...
     *
     * @return \Google\Cloud\Dialogflow\Cx\V3\ListPlaybooksRequest
     *
     * @experimental
     */
