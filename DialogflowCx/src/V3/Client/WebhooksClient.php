...
final class WebhooksClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Webhooks';
     ...
     *           $options = new WebhooksClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see WebhooksClient::createWebhookAsync()} .
     *
     * @example samples/V3/WebhooksClient/create_webhook.php
     *
     * @param CreateWebhookRequest $request     A request to house fields associated with the call.
     ...
     */
    public function createWebhook(CreateWebhookRequest $request, array $callOptions = []): Webhook
    {
        return $this->startApiCall('CreateWebhook', $request, $callOptions)->wait();
    }

    /**
     * Deletes the specified webhook.
     *
     * The async variant is {@see WebhooksClient::deleteWebhookAsync()} .
     *
     * @example samples/V3/WebhooksClient/delete_webhook.php
     *
     * @param DeleteWebhookRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteWebhook(DeleteWebhookRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteWebhook', $request, $callOptions)->wait();
    }

    /**
     * Retrieves the specified webhook.
     *
     * The async variant is {@see WebhooksClient::getWebhookAsync()} .
     *
     * @example samples/V3/WebhooksClient/get_webhook.php
     *
     * @param GetWebhookRequest $request     A request to house fields associated with the call.
     * @param array             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getWebhook(GetWebhookRequest $request, array $callOptions = []): Webhook
    {
        return $this->startApiCall('GetWebhook', $request, $callOptions)->wait();
    }

    /**
     * Returns the list of all webhooks in the specified agent.
     *
     * The async variant is {@see WebhooksClient::listWebhooksAsync()} .
     *
     * @example samples/V3/WebhooksClient/list_webhooks.php
     *
     * @param ListWebhooksRequest $request     A request to house fields associated with the call.
     * @param array               $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listWebhooks(ListWebhooksRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListWebhooks', $request, $callOptions);
    }

    /**
     * Updates the specified webhook.
     *
     * The async variant is {@see WebhooksClient::updateWebhookAsync()} .
     *
     * @example samples/V3/WebhooksClient/update_webhook.php
     *
     * @param UpdateWebhookRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateWebhook(UpdateWebhookRequest $request, array $callOptions = []): Webhook
    {
        return $this->startApiCall('UpdateWebhook', $request, $callOptions)->wait();
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see WebhooksClient::getLocationAsync()} .
     *
     * @example samples/V3/WebhooksClient/get_location.php
     *
     ...
     *
     * The async variant is {@see WebhooksClient::listLocationsAsync()} .
     *
     * @example samples/V3/WebhooksClient/list_locations.php
     *
