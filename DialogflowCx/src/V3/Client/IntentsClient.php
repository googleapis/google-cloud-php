...
use Google\Cloud\Dialogflow\Cx\V3\ExportIntentsMetadata;
...
use Google\Cloud\Dialogflow\Cx\V3\ImportIntentsMetadata;
...
final class IntentsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Intents';
     ...
     *           $options = new IntentsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V3/IntentsClient/create_intent.php
     *
     ...
     *
     * @example samples/V3/IntentsClient/delete_intent.php
     *
     ...
     *
     * The async variant is {@see IntentsClient::exportIntentsAsync()} .
     *
     * @example samples/V3/IntentsClient/export_intents.php
     *
     * @param ExportIntentsRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return OperationResponse<ExportIntentsResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function exportIntents(ExportIntentsRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ExportIntents', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V3/IntentsClient/get_intent.php
     *
     ...
     *
     * The async variant is {@see IntentsClient::importIntentsAsync()} .
     *
     * @example samples/V3/IntentsClient/import_intents.php
     *
     * @param ImportIntentsRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return OperationResponse<ImportIntentsResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function importIntents(ImportIntentsRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ImportIntents', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V3/IntentsClient/list_intents.php
     *
     ...
     *
     * @example samples/V3/IntentsClient/update_intent.php
     *
     ...
     *
     * @example samples/V3/IntentsClient/get_location.php
     *
     ...
     *
     * @example samples/V3/IntentsClient/list_locations.php
     *
