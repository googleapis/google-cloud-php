...
final class ExperimentsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Experiments';
     ...
     *           $options = new ExperimentsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ExperimentsClient::createExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/create_experiment.php
     *
     * @param CreateExperimentRequest $request     A request to house fields associated with the call.
     ...
     */
    public function createExperiment(CreateExperimentRequest $request, array $callOptions = []): Experiment
    {
        return $this->startApiCall('CreateExperiment', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see ExperimentsClient::deleteExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/delete_experiment.php
     *
     * @param DeleteExperimentRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deleteExperiment(DeleteExperimentRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('DeleteExperiment', $request, $callOptions)->wait();
    }
     ...
     * [Experiment][google.cloud.dialogflow.cx.v3.Experiment].
     *
     * The async variant is {@see ExperimentsClient::getExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/get_experiment.php
     *
     * @param GetExperimentRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getExperiment(GetExperimentRequest $request, array $callOptions = []): Experiment
    {
        return $this->startApiCall('GetExperiment', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see ExperimentsClient::listExperimentsAsync()} .
     *
     * @example samples/V3/ExperimentsClient/list_experiments.php
     *
     * @param ListExperimentsRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listExperiments(ListExperimentsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListExperiments', $request, $callOptions);
    }
     ...
     *
     * The async variant is {@see ExperimentsClient::startExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/start_experiment.php
     *
     * @param StartExperimentRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function startExperiment(StartExperimentRequest $request, array $callOptions = []): Experiment
    {
        return $this->startApiCall('StartExperiment', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see ExperimentsClient::stopExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/stop_experiment.php
     *
     * @param StopExperimentRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function stopExperiment(StopExperimentRequest $request, array $callOptions = []): Experiment
    {
        return $this->startApiCall('StopExperiment', $request, $callOptions)->wait();
    }
     ...
     * [Experiment][google.cloud.dialogflow.cx.v3.Experiment].
     *
     * The async variant is {@see ExperimentsClient::updateExperimentAsync()} .
     *
     * @example samples/V3/ExperimentsClient/update_experiment.php
     *
     * @param UpdateExperimentRequest $request     A request to house fields associated with the call.
     * @param array                   $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateExperiment(UpdateExperimentRequest $request, array $callOptions = []): Experiment
    {
        return $this->startApiCall('UpdateExperiment', $request, $callOptions)->wait();
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see ExperimentsClient::getLocationAsync()} .
     *
     * @example samples/V3/ExperimentsClient/get_location.php
     *
     ...
     *
     * The async variant is {@see ExperimentsClient::listLocationsAsync()} .
     *
     * @example samples/V3/ExperimentsClient/list_locations.php
     *
