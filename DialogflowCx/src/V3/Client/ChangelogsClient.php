 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/dialogflow/cx/v3/changelog.proto
...
final class ChangelogsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Changelogs';
     ...
     */
    public static function changelogName(string $project, string $location, string $agent, string $changelog): string
    {
     ...
     *           $options = new ChangelogsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see ChangelogsClient::getChangelogAsync()} .
     *
     * @example samples/V3/ChangelogsClient/get_changelog.php
     *
     ...
     *
     * The async variant is {@see ChangelogsClient::listChangelogsAsync()} .
     *
     * @example samples/V3/ChangelogsClient/list_changelogs.php
     *
     ...
     *
     * The async variant is {@see ChangelogsClient::getLocationAsync()} .
     *
     * @example samples/V3/ChangelogsClient/get_location.php
     *
     ...
     *
     * The async variant is {@see ChangelogsClient::listLocationsAsync()} .
     *
     * @example samples/V3/ChangelogsClient/list_locations.php
     *
