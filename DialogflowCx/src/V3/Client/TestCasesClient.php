...
final class TestCasesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.TestCases';
     ...
     *
     * The async variant is {@see TestCasesClient::batchDeleteTestCasesAsync()} .
     *
     * @example samples/V3/TestCasesClient/batch_delete_test_cases.php
     *
     * @param BatchDeleteTestCasesRequest $request     A request to house fields associated with the call.
     ...
     */
    public function batchDeleteTestCases(BatchDeleteTestCasesRequest $request, array $callOptions = []): void
    {
        $this->startApiCall('BatchDeleteTestCases', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see TestCasesClient::batchRunTestCasesAsync()} .
     *
     * @example samples/V3/TestCasesClient/batch_run_test_cases.php
     *
     * @param BatchRunTestCasesRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function batchRunTestCases(BatchRunTestCasesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('BatchRunTestCases', $request, $callOptions)->wait();
    }

    /**
     * Calculates the test coverage for an agent.
     *
     * The async variant is {@see TestCasesClient::calculateCoverageAsync()} .
     *
     * @example samples/V3/TestCasesClient/calculate_coverage.php
     *
     * @param CalculateCoverageRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * }
     *
     * @return CalculateCoverageResponse
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * The async variant is {@see TestCasesClient::createTestCaseAsync()} .
     *
     * @example samples/V3/TestCasesClient/create_test_case.php
     *
     * @param CreateTestCaseRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function createTestCase(CreateTestCaseRequest $request, array $callOptions = []): TestCase
    {
        return $this->startApiCall('CreateTestCase', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see TestCasesClient::exportTestCasesAsync()} .
     *
     * @example samples/V3/TestCasesClient/export_test_cases.php
     *
     * @param ExportTestCasesRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function exportTestCases(ExportTestCasesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ExportTestCases', $request, $callOptions)->wait();
    }

    /**
     * Gets a test case.
     *
     * The async variant is {@see TestCasesClient::getTestCaseAsync()} .
     *
     * @example samples/V3/TestCasesClient/get_test_case.php
     *
     * @param GetTestCaseRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getTestCase(GetTestCaseRequest $request, array $callOptions = []): TestCase
    {
        return $this->startApiCall('GetTestCase', $request, $callOptions)->wait();
    }

    /**
     * Gets a test case result.
     *
     * The async variant is {@see TestCasesClient::getTestCaseResultAsync()} .
     *
     * @example samples/V3/TestCasesClient/get_test_case_result.php
     *
     * @param GetTestCaseResultRequest $request     A request to house fields associated with the call.
     * @param array                    $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getTestCaseResult(GetTestCaseResultRequest $request, array $callOptions = []): TestCaseResult
    {
        return $this->startApiCall('GetTestCaseResult', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see TestCasesClient::importTestCasesAsync()} .
     *
     * @example samples/V3/TestCasesClient/import_test_cases.php
     *
     * @param ImportTestCasesRequest $request     A request to house fields associated with the call.
     * @param array                  $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function importTestCases(ImportTestCasesRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('ImportTestCases', $request, $callOptions)->wait();
    }
     ...
     *
     * The async variant is {@see TestCasesClient::listTestCaseResultsAsync()} .
     *
     * @example samples/V3/TestCasesClient/list_test_case_results.php
     *
     * @param ListTestCaseResultsRequest $request     A request to house fields associated with the call.
     * @param array                      $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listTestCaseResults(ListTestCaseResultsRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListTestCaseResults', $request, $callOptions);
    }

    /**
     * Fetches a list of test cases for a given agent.
     *
     * The async variant is {@see TestCasesClient::listTestCasesAsync()} .
     *
     * @example samples/V3/TestCasesClient/list_test_cases.php
     *
     * @param ListTestCasesRequest $request     A request to house fields associated with the call.
     * @param array                $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function listTestCases(ListTestCasesRequest $request, array $callOptions = []): PagedListResponse
    {
        return $this->startApiCall('ListTestCases', $request, $callOptions);
    }
     ...
     *
     * The async variant is {@see TestCasesClient::runTestCaseAsync()} .
     *
     * @example samples/V3/TestCasesClient/run_test_case.php
     *
     * @param RunTestCaseRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function runTestCase(RunTestCaseRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('RunTestCase', $request, $callOptions)->wait();
    }

    /**
     * Updates the specified test case.
     *
     * The async variant is {@see TestCasesClient::updateTestCaseAsync()} .
     *
     * @example samples/V3/TestCasesClient/update_test_case.php
     *
     * @param UpdateTestCaseRequest $request     A request to house fields associated with the call.
     * @param array                 $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updateTestCase(UpdateTestCaseRequest $request, array $callOptions = []): TestCase
    {
        return $this->startApiCall('UpdateTestCase', $request, $callOptions)->wait();
    }

    /**
     * Gets information about a location.
     *
     * The async variant is {@see TestCasesClient::getLocationAsync()} .
     *
     * @example samples/V3/TestCasesClient/get_location.php
     *
     ...
     *
     * The async variant is {@see TestCasesClient::listLocationsAsync()} .
     *
     * @example samples/V3/TestCasesClient/list_locations.php
     *
