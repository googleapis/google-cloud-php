...
final class EntityTypesClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.EntityTypes';
     ...
     *           $options = new EntityTypesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V3/EntityTypesClient/create_entity_type.php
     *
     ...
     *
     * @example samples/V3/EntityTypesClient/delete_entity_type.php
     *
     ...
     * }
     *
     * @return OperationResponse<ExportEntityTypesResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * @example samples/V3/EntityTypesClient/get_entity_type.php
     *
     ...
     * }
     *
     * @return OperationResponse<ImportEntityTypesResponse>
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * @example samples/V3/EntityTypesClient/list_entity_types.php
     *
     ...
     *
     * @example samples/V3/EntityTypesClient/update_entity_type.php
     *
     ...
     *
     * @example samples/V3/EntityTypesClient/get_location.php
     *
     ...
     *
     * @example samples/V3/EntityTypesClient/list_locations.php
     *
