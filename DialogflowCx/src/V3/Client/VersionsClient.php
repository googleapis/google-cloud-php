 ...
 *
 * @method PromiseInterface compareVersionsAsync(CompareVersionsRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface loadVersionAsync(LoadVersionRequest $request, array $optionalArgs = [])
