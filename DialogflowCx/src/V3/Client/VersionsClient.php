 ...
 *
 * @method PromiseInterface<CompareVersionsResponse> compareVersionsAsync(CompareVersionsRequest $request, array $optionalArgs = [])
 ...
 * @method PromiseInterface<OperationResponse> loadVersionAsync(LoadVersionRequest $request, array $optionalArgs = [])
...
final class VersionsClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.dialogflow.cx.v3.Versions';
     ...
     *           $options = new VersionsClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * The async variant is {@see VersionsClient::compareVersionsAsync()} .
     *
     * @example samples/V3/VersionsClient/compare_versions.php
     *
     * @param CompareVersionsRequest $request     A request to house fields associated with the call.
     ...
     */
    public function compareVersions(CompareVersionsRequest $request, array $callOptions = []): CompareVersionsResponse
    {
        return $this->startApiCall('CompareVersions', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V3/VersionsClient/create_version.php
     *
     ...
     * }
     *
     * @return OperationResponse<Version>
     *
     * @throws ApiException Thrown if the API call fails.
     */
     ...
     *
     * @example samples/V3/VersionsClient/delete_version.php
     *
     ...
     *
     * @example samples/V3/VersionsClient/get_version.php
     *
     ...
     *
     * @example samples/V3/VersionsClient/list_versions.php
     *
     ...
     *
     * The async variant is {@see VersionsClient::loadVersionAsync()} .
     *
     * @example samples/V3/VersionsClient/load_version.php
     *
     * @param LoadVersionRequest $request     A request to house fields associated with the call.
     * @param array              $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function loadVersion(LoadVersionRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('LoadVersion', $request, $callOptions)->wait();
    }
     ...
     *
     * @example samples/V3/VersionsClient/update_version.php
     *
     ...
     *
     * @example samples/V3/VersionsClient/get_location.php
     *
     ...
     *
     * @example samples/V3/VersionsClient/list_locations.php
     *
