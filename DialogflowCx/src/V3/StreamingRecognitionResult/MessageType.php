...
namespace Google\Cloud\Dialogflow\Cx\V3\StreamingRecognitionResult;
 ...
 *
 * Protobuf type <code>google.cloud.dialogflow.cx.v3.StreamingRecognitionResult.MessageType</code>
 */
class MessageType
{
    /**
