 ...
 *
 * Generated from protobuf message <code>google.cloud.beyondcorp.appconnections.v1.CreateAppConnectionRequest</code>
 */
class CreateAppConnectionRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>string app_connection_id = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
    protected $app_connection_id = '';
    /**
     * Required. A BeyondCorp AppConnection resource.
     *
     * Generated from protobuf field <code>.google.cloud.beyondcorp.appconnections.v1.AppConnection app_connection = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                                                                                  * Must end with a number or a letter.
     *
     * @return \Google\Cloud\BeyondCorp\AppConnections\V1\CreateAppConnectionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\BeyondCorp\AppConnections\V1\AppConnection $appConnection, string $appConnectionId): self
    {
        return (new self())
            ->setParent($parent)
     ...
     * @return string
     */
    public function getAppConnectionId()
    {
        return $this->app_connection_id;
    }
     ...
     * @return $this
     */
    public function setAppConnectionId($var)
    {
        GPBUtil::checkString($var, True);
        $this->app_connection_id = $var;
