...
namespace Google\Cloud\BeyondCorp\AppConnections\V1\Client;
...
final class AppConnectionsServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.beyondcorp.appconnections.v1.AppConnectionsService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/app_connections_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/app_connections_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/app_connections_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/app_connections_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public static function appConnectionName(string $project, string $location, string $appConnection): string
    {
        return self::getPathTemplate('appConnection')->render([
            'project' => $project,
            'location' => $location,
     ...
     */
    public static function appConnectorName(string $project, string $location, string $appConnector): string
    {
        return self::getPathTemplate('appConnector')->render([
            'project' => $project,
            'location' => $location,
     ...
     */
    public static function appGatewayName(string $project, string $location, string $appGateway): string
    {
        return self::getPathTemplate('appGateway')->render([
            'project' => $project,
            'location' => $location,
     ...
     *           $options = new AppConnectionsServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
    ...
    {
        return $this->startApiCall('CreateAppConnection', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('DeleteAppConnection', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('GetAppConnection', $request, $callOptions)->wait();
    }
    ...
    {
        return $this->startApiCall('ListAppConnections', $request, $callOptions);
    }
    ...
    {
        return $this->startApiCall('UpdateAppConnection', $request, $callOptions)->wait();
    }
