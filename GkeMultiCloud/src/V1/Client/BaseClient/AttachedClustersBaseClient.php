 ...
 */
abstract class AttachedClustersBaseClient
{
     ...
     */
    public static function attachedClusterName(string $project, string $location, string $attachedCluster): string
    {
        return self::getPathTemplate('attachedCluster')->render([
            'project' => $project,
            'location' => $location,
     ...
     */
    public static function attachedServerConfigName(string $project, string $location): string
    {
        return self::getPathTemplate('attachedServerConfig')->render([
            'project' => $project,
            'location' => $location,
        ]);
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function getAttachedCluster(GetAttachedClusterRequest $request, array $callOptions = []): AttachedCluster
    {
        return $this->startApiCall('GetAttachedCluster', $request, $callOptions)->wait();
    }
