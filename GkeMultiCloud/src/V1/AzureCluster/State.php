...
namespace Google\Cloud\GkeMultiCloud\V1\AzureCluster;
 ...
 *
 * Protobuf type <code>google.cloud.gkemulticloud.v1.AzureCluster.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\GkeMultiCloud\V1\AzureCluster_State::class);
