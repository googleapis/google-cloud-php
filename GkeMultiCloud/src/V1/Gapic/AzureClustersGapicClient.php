...
class AzureClustersGapicClient
{
     ...
     * @throws ApiException if the remote call fails
     */
    public function generateAzureClusterAgentToken($azureCluster, $subjectToken, $subjectTokenType, $version, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GenerateAzureClusterAgentToken', GenerateAzureClusterAgentTokenResponse::class, $optionalArgs, $request)->wait();
    }
    ...
    public function getAzureJsonWebKeys($azureCluster, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAzureJsonWebKeys', AzureJsonWebKeys::class, $optionalArgs, $request)->wait();
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function getAzureOpenIdConfig($azureCluster, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('GetAzureOpenIdConfig', AzureOpenIdConfig::class, $optionalArgs, $request)->wait();
    }
