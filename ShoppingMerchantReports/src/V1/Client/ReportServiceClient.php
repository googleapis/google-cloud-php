 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/reports/v1/reports.proto
 * Updates to the above are reflected here through a refresh process.
 */

namespace Google\Shopping\Merchant\Reports\V1\Client;
...
final class ReportServiceClient
{
    ...
    private const SERVICE_NAME = 'google.shopping.merchant.reports.v1.ReportService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'gcpApiConfigPath' => __DIR__ . '/../resources/report_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     *           use Google\Shopping\Merchant\Reports\V1\ReportServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ReportServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ReportServiceClient/search.php
     *
