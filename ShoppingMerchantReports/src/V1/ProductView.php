 ...
 * query.
 *
 * Generated from protobuf message <code>google.shopping.merchant.reports.v1.ProductView</code>
 */
class ProductView extends \Google\Protobuf\Internal\Message
{
     ...
     * the merchant.
     *
     * Generated from protobuf field <code>.google.shopping.merchant.reports.v1.ProductView.ClickPotential click_potential = 29;</code>
     */
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Shopping\Merchant\Reports\V1\ProductView\ItemIssue::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Shopping\Merchant\Reports\V1\ProductView\ClickPotential::class);
