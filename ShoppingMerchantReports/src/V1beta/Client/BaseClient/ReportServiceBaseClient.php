 ...
 * https://github.com/googleapis/googleapis/blob/master/google/shopping/merchant/reports/v1beta/reports.proto
 * Updates to the above are reflected here through a refresh process.
 *
 * @experimental
 */

namespace Google\Shopping\Merchant\Reports\V1beta\Client\BaseClient;
 ...
 */
abstract class ReportServiceBaseClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../../resources/report_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../../resources/report_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../../resources/report_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../../resources/report_service_rest_client_config.php',
                ],
            ],
        ];
    }
