...
use Google\Cloud\Security\PrivateCA\V1beta1\KeyVersionSpec\KeyVersionOneof;
...
use Google\Cloud\Security\PrivateCA\V1beta1\ReusableConfigWrapper\ConfigValuesOneof;
...
use Google\Cloud\Security\PrivateCA\V1beta1\SubordinateConfig\SubordinateConfigOneof;
...
class CertificateAuthorityServiceClientTest extends GeneratedTest
{
    ...
    public function activateCertificateAuthorityTest()
    {
        ...
        $subordinateConfig = new SubordinateConfigOneof();
        $subordinateConfig->setCertificateAuthority('subordinateConfigCertificateAuthority-722261446');
        $subordinateConfig->setCertificateAuthority($subordinateConfig);
        $subordinateConfig = new SubordinateConfigOneof();
        $subordinateConfig->setPemIssuerChain(new SubordinateConfigChain());
        $subordinateConfig->setPemIssuerChain($subordinateConfig);
    ...
    public function createCertificateAuthorityTest()
    {
        ...
        $configValues = new ConfigValuesOneof();
        $configValues->setReusableConfig('reusableConfigReusableConfig424335738');
        $configReusableConfig->setReusableConfig($configValues);
        $configValues = new ConfigValuesOneof();
        $configValues->setReusableConfigValues(new ReusableConfigValues());
        $configReusableConfig->setReusableConfigValues($configValues);
        ...
        $keyVersion = new KeyVersionOneof();
        $keyVersion->setCloudKmsKeyVersion('keySpecCloudKmsKeyVersion170335183');
        $certificateAuthorityKeySpec->setCloudKmsKeyVersion($keyVersion);
        $keyVersion = new KeyVersionOneof();
        $keyVersion->setAlgorithm(SignHashAlgorithm::SIGN_HASH_ALGORITHM_UNSPECIFIED);
        $certificateAuthorityKeySpec->setAlgorithm($keyVersion);
