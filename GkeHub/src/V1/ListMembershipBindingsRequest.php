 ...
 *
 * Generated from protobuf message <code>google.cloud.gkehub.v1.ListMembershipBindingsRequest</code>
 */
class ListMembershipBindingsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent Membership for which the MembershipBindings will be
     ...
     *
     * @return \Google\Cloud\GkeHub\V1\ListMembershipBindingsRequest
     *
     * @experimental
     */
