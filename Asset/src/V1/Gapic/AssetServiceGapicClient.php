...
use Google\Cloud\Asset\V1\ExportIamPolicyAnalysisRequest;
...
class AssetServiceGapicClient
{
     ...
     * ```
     *
     * @param IamPolicyAnalysisQuery $analysisQuery The request query.
     * @param array                  $optionalArgs  {
     *                                              Optional.
     *
     ...
     *
     * @param IamPolicyAnalysisQuery        $analysisQuery The request query.
     * @param IamPolicyAnalysisOutputConfig $outputConfig  Output configuration indicating where the results will be output to.
     * @param array                         $optionalArgs  {
     *                                                     Optional.
     *
     *     @type RetrySettings|array $retrySettings
