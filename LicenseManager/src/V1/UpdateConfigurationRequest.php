 ...
 *
 * Generated from protobuf message <code>google.cloud.licensemanager.v1.UpdateConfigurationRequest</code>
 */
class UpdateConfigurationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.licensemanager.v1.Configuration configuration = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\LicenseManager\V1\Configuration $configuration Required. The resource being updated
     ...
     *                                                                     user does not provide a mask then all fields will be overwritten.
     *
     * @return \Google\Cloud\LicenseManager\V1\UpdateConfigurationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\LicenseManager\V1\Configuration $configuration, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
