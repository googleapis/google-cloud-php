 ...
 *
 * Generated from protobuf message <code>google.cloud.licensemanager.v1.ListConfigurationsRequest</code>
 */
class ListConfigurationsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. Parent value for ListConfigurationsRequest
     *                       Please see {@see LicenseManagerClient::locationName()} for help formatting this field.
     *
     * @return \Google\Cloud\LicenseManager\V1\ListConfigurationsRequest
     *
     * @experimental
     */
