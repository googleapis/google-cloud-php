 ...
 *
 * Generated from protobuf message <code>google.cloud.privilegedaccessmanager.v1.SearchEntitlementsRequest</code>
 */
class SearchEntitlementsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     * returned.
     *
     * Generated from protobuf field <code>.google.cloud.privilegedaccessmanager.v1.SearchEntitlementsRequest.CallerAccessType caller_access_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $caller_access_type = 0;
    /**
     ...
     * @return int
     */
    public function getCallerAccessType()
    {
        return $this->caller_access_type;
    }
     ...
     * @return $this
     */
    public function setCallerAccessType($var)
    {
        GPBUtil::checkEnum($var, \Google\Cloud\PrivilegedAccessManager\V1\SearchEntitlementsRequest\CallerAccessType::class);
        $this->caller_access_type = $var;
