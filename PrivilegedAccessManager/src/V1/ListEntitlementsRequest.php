 ...
 *
 * Generated from protobuf message <code>google.cloud.privilegedaccessmanager.v1.ListEntitlementsRequest</code>
 */
class ListEntitlementsRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent which owns the entitlement resources. Please see
     *                       {@see PrivilegedAccessManagerClient::organizationLocationName()} for help formatting this field.
     *
     * @return \Google\Cloud\PrivilegedAccessManager\V1\ListEntitlementsRequest
     *
     * @experimental
     */
