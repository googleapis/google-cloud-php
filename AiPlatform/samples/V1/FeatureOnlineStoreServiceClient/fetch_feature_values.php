 ...
 */
function fetch_feature_values_sample(string $formattedFeatureView): void
{
    // Create a client.
    ...
    try {
        /** @var FetchFeatureValuesResponse $response */
        $response = $featureOnlineStoreServiceClient->fetchFeatureValues($request);
...
function callSample(): void
{
    ...
    fetch_feature_values_sample($formattedFeatureView);
}
