        ...
        'google.cloud.aiplatform.v1.PredictionService' => [
            'DirectPredict' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}:directPredict',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'DirectRawPredict' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}:directRawPredict',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'Predict' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}:predict',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'RawPredict' => [
                ...
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}:rawPredict',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
