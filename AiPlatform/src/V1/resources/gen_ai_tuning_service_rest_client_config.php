...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.GenAiTuningService' => [
            'CancelTuningJob' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/tuningJobs/*}:cancel',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'CreateTuningJob' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/tuningJobs',
                'body' => 'tuning_job',
                'placeholders' => [
                    'parent' => [
                        'getters' => [
            ...
            'GetTuningJob' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/tuningJobs/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
