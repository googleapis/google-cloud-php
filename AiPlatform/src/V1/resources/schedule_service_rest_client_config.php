...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.ScheduleService' => [
            ...
            'PauseSchedule' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/schedules/*}:pause',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'ResumeSchedule' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/schedules/*}:resume',
                'body' => '*',
                'placeholders' => [
                    'name' => [
                        'getters' => [
            ...
            'UpdateSchedule' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{schedule.name=projects/*/locations/*/schedules/*}',
                'body' => 'schedule',
                'placeholders' => [
                    'schedule.name' => [
                        'getters' => [
