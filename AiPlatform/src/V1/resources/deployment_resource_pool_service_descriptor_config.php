        ...
        'google.cloud.aiplatform.v1.DeploymentResourcePoolService' => [
            'CreateDeploymentResourcePool' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => '\Google\Cloud\AIPlatform\V1\CreateDeploymentResourcePoolOperationMetadata',
            ...
            'ListDeploymentResourcePools' => [
                'pageStreaming' => [
                    ...
                    'resourcesGetMethod' => 'getDeploymentResourcePools',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\ListDeploymentResourcePoolsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'QueryDeployedModels' => [
                'pageStreaming' => [
                    ...
                    'requestPageSizeSetMethod' => 'setPageSize',
                    'responsePageTokenGetMethod' => 'getNextPageToken',
                    'resourcesGetMethod' => 'getDeployedModels',
                ],
                'callType' => \Google\ApiCore\Call::PAGINATED_CALL,
                'responseType' => 'Google\Cloud\AIPlatform\V1\QueryDeployedModelsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'deployment_resource_pool',
                        'fieldAccessors' => [
                            'getDeploymentResourcePool',
                        ],
                    ],
