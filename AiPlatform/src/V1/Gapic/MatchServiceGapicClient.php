...
use Google\Cloud\AIPlatform\V1\FindNeighborsRequest\Query;
 ...
 * \Google\Cloud\AIPlatform\V1\Client\MatchServiceClient} to use the new surface.
 */
class MatchServiceGapicClient
{
    use GapicClientTrait;

    /** The name of the service. */
    const SERVICE_NAME = 'google.cloud.aiplatform.v1.MatchService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../resources/match_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ . '/../resources/match_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/match_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/match_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function findNeighbors($indexEndpoint, array $optionalArgs = [])
    {
        ...
        if (isset($optionalArgs['queries'])) {
            $request->setQueries($optionalArgs['queries']);
        }

        if (isset($optionalArgs['returnFullDatapoint'])) {
            $request->setReturnFullDatapoint(
                $optionalArgs['returnFullDatapoint']
            );
        }
    ...
    public function readIndexDatapoints(
        ...
        if (isset($optionalArgs['ids'])) {
            $request->setIds($optionalArgs['ids']);
        }
        ...
        return $this->startCall(
            'ReadIndexDatapoints',
            ReadIndexDatapointsResponse::class,
            $optionalArgs,
            $request
        )->wait();
    }
     ...
     * $matchServiceClient = new MatchServiceClient();
     * try {
     *     $response = $matchServiceClient->getLocation();
     * } finally {
     *     $matchServiceClient->close();
     * }
     * ```
     ...
     *     $pagedResponse = $matchServiceClient->listLocations();
