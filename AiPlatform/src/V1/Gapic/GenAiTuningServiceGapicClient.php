...
class GenAiTuningServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../resources/gen_ai_tuning_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/gen_ai_tuning_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../resources/gen_ai_tuning_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/gen_ai_tuning_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getTuningJobNameTemplate()
    {
        if (self::$tuningJobNameTemplate == null) {
            self::$tuningJobNameTemplate = new PathTemplate(
     ...
     * @throws ApiException if the remote call fails
     */
    public function createTuningJob(
        $parent,
        $tuningJob,
        array $optionalArgs = []
    ) {
