...
class ModelGardenServiceGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../resources/model_garden_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../resources/model_garden_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/model_garden_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/model_garden_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    private static function getPublisherModelNameTemplate()
    {
        if (self::$publisherModelNameTemplate == null) {
            self::$publisherModelNameTemplate = new PathTemplate(
