 ...
 *
 * @method PromiseInterface<OperationResponse> batchMigrateResourcesAsync(BatchMigrateResourcesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> searchMigratableResourcesAsync(SearchMigratableResourcesRequest $request, array $optionalArgs = [])
...
final class MigrationServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.MigrationService';
     ...
     */
    public static function versionName(string $project, string $model, string $version): string
    {
     ...
     *           $options = new MigrationServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<BatchMigrateResourcesResponse>
     *
