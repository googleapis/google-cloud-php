 ...
 *
 * @method PromiseInterface<FindNeighborsResponse> findNeighborsAsync(FindNeighborsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<ReadIndexDatapointsResponse> readIndexDatapointsAsync(ReadIndexDatapointsRequest $request, array $optionalArgs = [])
 ...
 */
final class MatchServiceClient
{
     ...
     *           use Google\Cloud\AIPlatform\V1\MatchServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new MatchServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
