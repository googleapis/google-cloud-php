 ...
 */
abstract class ScheduleServiceBaseClient
{
     ...
     *
     * The async variant is {@see self::pauseScheduleAsync()} .
     *
     ...
     *
     * The async variant is {@see self::resumeScheduleAsync()} .
     *
     ...
     * or canceled.
     *
     * The async variant is {@see self::updateScheduleAsync()} .
     *
