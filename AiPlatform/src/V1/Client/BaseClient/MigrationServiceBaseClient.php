 ...
 * @internal
 *
 * @method PromiseInterface batchMigrateResourcesAsync(BatchMigrateResourcesRequest $request, array $optionalArgs = [])
 * @method PromiseInterface searchMigratableResourcesAsync(SearchMigratableResourcesRequest $request, array $optionalArgs = [])
