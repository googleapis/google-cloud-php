 ...
 * \Google\Cloud\AIPlatform\V1\ModelGardenServiceClient} for the stable
 * implementation
 *
 * @experimental
 *
 * @method PromiseInterface getPublisherModelAsync(GetPublisherModelRequest $request, array $optionalArgs = [])
 ...
 */
final class ModelGardenServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.aiplatform.v1.ModelGardenService';
     ...
     */
    public static function publisherModelName(string $publisher, string $model): string
    {
        return self::getPathTemplate('publisherModel')->render([
            'publisher' => $publisher,
            'model' => $model,
        ]);
    }
     ...
     *
     * @param GetPublisherModelRequest $request     A request to house fields associated with the call.
     ...
     */
    public function getPublisherModel(GetPublisherModelRequest $request, array $callOptions = []): PublisherModel
    {
        return $this->startApiCall('GetPublisherModel', $request, $callOptions)->wait();
    }
