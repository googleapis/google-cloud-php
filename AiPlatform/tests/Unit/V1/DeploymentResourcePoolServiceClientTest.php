 ...
 * @group gapic
 */
class DeploymentResourcePoolServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new DeploymentResourcePoolServiceClient($options);
    }

    /** @test */
    public function createDeploymentResourcePoolTest()
    {
        ...
        $incompleteOperation->setName('operations/createDeploymentResourcePoolTest');
        ...
        $completeOperation->setName('operations/createDeploymentResourcePoolTest');
        ...
        $response = $gapicClient->createDeploymentResourcePool($formattedParent, $deploymentResourcePool, $deploymentResourcePoolId);
    ...
    /** @test */
    public function createDeploymentResourcePoolExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function deleteDeploymentResourcePoolTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteDeploymentResourcePoolTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteDeploymentResourcePoolTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedName = $gapicClient->deploymentResourcePoolName('[PROJECT]', '[LOCATION]', '[DEPLOYMENT_RESOURCE_POOL]');
        $response = $gapicClient->deleteDeploymentResourcePool($formattedName);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    /** @test */
    public function deleteDeploymentResourcePoolExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function getDeploymentResourcePoolTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->deploymentResourcePoolName('[PROJECT]', '[LOCATION]', '[DEPLOYMENT_RESOURCE_POOL]');
        $response = $gapicClient->getDeploymentResourcePool($formattedName);
    ...
    /** @test */
    public function getDeploymentResourcePoolExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $formattedName = $gapicClient->deploymentResourcePoolName('[PROJECT]', '[LOCATION]', '[DEPLOYMENT_RESOURCE_POOL]');
        try {
            $gapicClient->getDeploymentResourcePool($formattedName);
    ...
    /** @test */
    public function listDeploymentResourcePoolsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $response = $gapicClient->listDeploymentResourcePools($formattedParent);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDeploymentResourcePools()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listDeploymentResourcePoolsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $formattedParent = $gapicClient->projectName('[PROJECT]');
        try {
            $gapicClient->listDeploymentResourcePools($formattedParent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function queryDeployedModelsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $response = $gapicClient->queryDeployedModels($deploymentResourcePool);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDeployedModels()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function queryDeployedModelsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $deploymentResourcePool = 'deploymentResourcePool-1160399437';
        try {
            $gapicClient->queryDeployedModels($deploymentResourcePool);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
