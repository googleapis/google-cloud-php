...
use Google\Cloud\AIPlatform\V1\ListEventsResponse;
use Google\Cloud\AIPlatform\V1\ListSessionsRequest;
use Google\Cloud\AIPlatform\V1\ListSessionsResponse;
...
class SessionServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function appendEventTest()
    {
        ...
        // Mock response
        $expectedResponse = new AppendEventResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->sessionName('[PROJECT]', '[LOCATION]', '[REASONING_ENGINE]', '[SESSION]');
        $event = new SessionEvent();
        $eventAuthor = 'eventAuthor-407198523';
        $event->setAuthor($eventAuthor);
        $eventInvocationId = 'eventInvocationId1932479877';
        $event->setInvocationId($eventInvocationId);
        $eventTimestamp = new Timestamp();
        $event->setTimestamp($eventTimestamp);
        $request = (new AppendEventRequest())->setName($formattedName)->setEvent($event);
        $response = $gapicClient->appendEvent($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/AppendEvent', $actualFuncCall);
    ...
    /** @test */
    public function appendEventExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new AppendEventRequest())->setName($formattedName)->setEvent($event);
        try {
            $gapicClient->appendEvent($request);
    ...
    public function createSessionTest()
    {
        ...
        $incompleteOperation->setName('operations/createSessionTest');
        ...
        $completeOperation->setName('operations/createSessionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        $formattedParent = $gapicClient->reasoningEngineName('[PROJECT]', '[LOCATION]', '[REASONING_ENGINE]');
        $session = new Session();
        $sessionUserId = 'sessionUserId-86125444';
        ...
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/CreateSession', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualApiRequestObject->getSession();
        $this->assertProtobufEquals($session, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/createSessionTest');
    ...
    public function deleteSessionTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteSessionTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteSessionTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/DeleteSession', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
        $expectedOperationsRequestObject->setName('operations/deleteSessionTest');
        $response->pollUntilComplete([
            'initialPollDelayMillis' => 1,
        ]);
        $this->assertTrue($response->isDone());
    ...
    public function getSessionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/GetSession', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listEventsTest()
    {
        ...
        // Mock response
        $nextPageToken = '';
        $sessionEventsElement = new SessionEvent();
        $sessionEvents = [$sessionEventsElement];
        $expectedResponse = new ListEventsResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setSessionEvents($sessionEvents);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->sessionName('[PROJECT]', '[LOCATION]', '[REASONING_ENGINE]', '[SESSION]');
        ...
        $this->assertEquals($expectedResponse->getSessionEvents()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/ListEvents', $actualFuncCall);
    ...
    public function listSessionsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/ListSessions', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function updateSessionTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.SessionService/UpdateSession', $actualFuncCall);
    ...
    /** @test */
    public function appendEventAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $event->setTimestamp($eventTimestamp);
        $request = (new AppendEventRequest())->setName($formattedName)->setEvent($event);
        $response = $gapicClient->appendEventAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
