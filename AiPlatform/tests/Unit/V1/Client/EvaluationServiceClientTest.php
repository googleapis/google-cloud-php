...
class EvaluationServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function evaluateInstancesTest()
    {
        ...
        // Mock response
        $expectedResponse = new EvaluateInstancesResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedLocation = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new EvaluateInstancesRequest())->setLocation($formattedLocation);
        $response = $gapicClient->evaluateInstances($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.aiplatform.v1.EvaluationService/EvaluateInstances', $actualFuncCall);
    ...
    /** @test */
    public function evaluateInstancesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new EvaluateInstancesRequest())->setLocation($formattedLocation);
        try {
            $gapicClient->evaluateInstances($request);
    ...
    /** @test */
    public function evaluateInstancesAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $formattedLocation = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new EvaluateInstancesRequest())->setLocation($formattedLocation);
        $response = $gapicClient->evaluateInstancesAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
