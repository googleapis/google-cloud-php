...
class PipelineServiceClientTest extends GeneratedTest
{
    ...
    public function batchCancelPipelineJobsTest()
    {
        ...
        $response = $gapicClient->batchCancelPipelineJobs($formattedParent, $formattedNames);
    ...
    public function batchDeletePipelineJobsTest()
    {
        ...
        $response = $gapicClient->batchDeletePipelineJobs($formattedParent, $formattedNames);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function createTrainingPipelineTest()
    {
        ...
        $parentModel = 'parentModel1400422228';
