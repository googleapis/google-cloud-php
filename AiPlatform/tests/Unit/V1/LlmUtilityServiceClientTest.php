...
use Google\Cloud\AIPlatform\V1\LlmUtilityServiceClient;
 ...
 * @group gapic
 */
class LlmUtilityServiceClientTest extends GeneratedTest
{
    ...
    private function createClient(array $options = [])
    {
        ...
        return new LlmUtilityServiceClient($options);
    }

    /** @test */
    public function computeTokensTest()
    {
        ...
        // Mock response
        $expectedResponse = new ComputeTokensResponse();
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedEndpoint = $gapicClient->endpointName('[PROJECT]', '[LOCATION]', '[ENDPOINT]');
        $instances = [];
        $response = $gapicClient->computeTokens($formattedEndpoint, $instances);
    ...
    /** @test */
    public function computeTokensExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $instances = [];
        try {
            $gapicClient->computeTokens($formattedEndpoint, $instances);
    ...
    /** @test */
    public function countTokensTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $this->assertTrue($transport->isExhausted());
        // Mock response
        $totalTokens = 730673909;
        $totalBillableCharacters = 1242495501;
        $expectedResponse = new CountTokensResponse();
        $expectedResponse->setTotalTokens($totalTokens);
    ...
    /** @test */
    public function countTokensExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
