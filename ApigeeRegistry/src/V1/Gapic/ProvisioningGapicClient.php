...
class ProvisioningGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../resources/provisioning_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ . '/../resources/provisioning_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../resources/provisioning_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../resources/provisioning_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *     $pagedResponse = $provisioningClient->listLocations();
