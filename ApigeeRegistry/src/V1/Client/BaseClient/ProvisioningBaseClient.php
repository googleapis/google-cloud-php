 ...
 * \Google\Cloud\ApigeeRegistry\V1\ProvisioningClient} for the stable
 * implementation
 *
 * @experimental
 *
 ...
 */
abstract class ProvisioningBaseClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.apigeeregistry.v1.Provisioning';
