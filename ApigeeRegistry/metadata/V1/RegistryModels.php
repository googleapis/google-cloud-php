...
key (	
value (	:8:ZÍAW
!apigeeregistry.googleapis.com/Api2projects/{project}/locations/{location}/apis/{api}"µ
...
key (	
value (	:8:tÍAq
(apigeeregistry.googleapis.com/ApiVersionEprojects/{project}/locations/{location}/apis/{api}/versions/{version}"ı
ApiSpec
name (	
filename (	
description (	
...
key (	
value (	:8:~ÍA{
%apigeeregistry.googleapis.com/ApiSpecRprojects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}"Ã
...
key (	
value (	:8:}ÍAz
+apigeeregistry.googleapis.com/ApiDeploymentKprojects/{project}/locations/{location}/apis/{api}/deployments/{deployment}"º
Artifact
name (	5
create_time (2.google.protobuf.TimestampB‚A5
update_time (2.google.protobuf.TimestampB‚A
