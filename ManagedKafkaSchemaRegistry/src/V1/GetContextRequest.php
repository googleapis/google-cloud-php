 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.schemaregistry.v1.GetContextRequest</code>
 */
class GetContextRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the context to return. Structured like:
     *                     `projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/contexts/{context}`
     *                     Please see {@see ManagedSchemaRegistryClient::schemaContextName()} for help formatting this field.
     *
     * @return \Google\Cloud\ManagedKafka\SchemaRegistry\V1\GetContextRequest
     *
     * @experimental
     */
