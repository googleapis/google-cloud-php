 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.schemaregistry.v1.DeleteSchemaModeRequest</code>
 */
class DeleteSchemaModeRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The resource name of subject to delete the mode for. The format
     *                     is
     *                     * projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/mode/{subject}
     *                     * projects/{project}/locations/{location}/schemaRegistries/{schema_registry}/contexts/{context}/mode/{subject}
     *                     Please see {@see ManagedSchemaRegistryClient::schemaModeName()} for help formatting this field.
     *
     * @return \Google\Cloud\ManagedKafka\SchemaRegistry\V1\DeleteSchemaModeRequest
     *
     * @experimental
     */
