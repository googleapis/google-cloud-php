...
class ManagedSchemaRegistryClientTest extends GeneratedTest
{
    ...
    public function checkCompatibilityTest()
    {
        ...
        $request = (new CheckCompatibilityRequest())->setName($name)->setSchema($schema);
    ...
    public function createVersionTest()
    {
        ...
        $schema = 'schema-907987551';
        $request = (new CreateVersionRequest())->setParent($formattedParent)->setSchema($schema);
    ...
    public function deleteSchemaConfigTest()
    {
        ...
        $request = (new DeleteSchemaConfigRequest())->setName($formattedName);
    ...
    public function deleteSchemaModeTest()
    {
        ...
        $request = (new DeleteSchemaModeRequest())->setName($formattedName);
    ...
    public function deleteSchemaRegistryTest()
    {
        ...
        $request = (new DeleteSchemaRegistryRequest())->setName($formattedName);
    ...
    public function deleteSubjectTest()
    {
        ...
        $request = (new DeleteSubjectRequest())->setName($formattedName);
    ...
    public function deleteVersionTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->schemaVersionName(
            '[PROJECT]',
            '[LOCATION]',
            '[SCHEMA_REGISTRY]',
            '[SUBJECT]',
    ...
    public function getSchemaConfigTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->schemaConfigName('[PROJECT]', '[LOCATION]', '[SCHEMA_REGISTRY]');
        $request = (new GetSchemaConfigRequest())->setName($formattedName);
    ...
    public function getSchemaModeTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->schemaModeName('[PROJECT]', '[LOCATION]', '[SCHEMA_REGISTRY]');
        $request = (new GetSchemaModeRequest())->setName($formattedName);
    ...
    public function getSchemaRegistryTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->schemaRegistryName('[PROJECT]', '[LOCATION]', '[SCHEMA_REGISTRY]');
        $request = (new GetSchemaRegistryRequest())->setName($formattedName);
    ...
    public function listReferencedSchemasTest()
    {
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->schemaVersionName(
            '[PROJECT]',
            '[LOCATION]',
            '[SCHEMA_REGISTRY]',
            '[SUBJECT]',
        ...
        $request = (new ListReferencedSchemasRequest())->setParent($formattedParent);
    ...
    public function listSchemaRegistriesTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $request = (new ListSchemaRegistriesRequest())->setParent($parent);
    ...
    public function listSchemaTypesTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $request = (new ListSchemaTypesRequest())->setParent($parent);
    ...
    public function listSchemaVersionsTest()
    {
        ...
        $request = (new ListSchemaVersionsRequest())->setParent($formattedParent);
    ...
    public function listSubjectsTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $request = (new ListSubjectsRequest())->setParent($parent);
    ...
    public function listSubjectsBySchemaIdTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $request = (new ListSubjectsBySchemaIdRequest())->setParent($parent);
    ...
    public function lookupVersionTest()
    {
        ...
        $formattedParent = $gapicClient->schemaSubjectName('[PROJECT]', '[LOCATION]', '[SCHEMA_REGISTRY]', '[SUBJECT]');
        $schema = 'schema-907987551';
        $request = (new LookupVersionRequest())->setParent($formattedParent)->setSchema($schema);
    ...
    public function updateSchemaConfigTest()
    {
        ...
        $request = (new UpdateSchemaConfigRequest())->setName($formattedName)->setCompatibility($compatibility);
    ...
    public function updateSchemaModeTest()
    {
        ...
        $formattedName = $gapicClient->schemaModeName('[PROJECT]', '[LOCATION]', '[SCHEMA_REGISTRY]');
        $mode = ModeType::NONE;
        $request = (new UpdateSchemaModeRequest())->setName($formattedName)->setMode($mode);
