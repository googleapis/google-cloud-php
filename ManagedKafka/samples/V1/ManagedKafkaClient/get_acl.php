...
// [START managedkafka_v1_generated_ManagedKafka_GetAcl_sync]
 ...
 *
 * @param string $formattedName The name of the acl to return.
 *                              Structured like:
 ...
 */
function get_acl_sample(string $formattedName): void
{
    // Create a client.
...
function callSample(): void
{
    ...
    get_acl_sample($formattedName);
}
// [END managedkafka_v1_generated_ManagedKafka_GetAcl_sync]
