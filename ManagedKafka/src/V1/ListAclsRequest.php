 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.v1.ListAclsRequest</code>
 */
class ListAclsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent cluster whose acls are to be listed.
     *                       Structured like
     ...
     *
     * @return \Google\Cloud\ManagedKafka\V1\ListAclsRequest
     *
     * @experimental
     */
