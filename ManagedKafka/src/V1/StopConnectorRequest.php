 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.v1.StopConnectorRequest</code>
 */
class StopConnectorRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the connector to stop.
     *                     Structured like:
     *                     projects/{project}/locations/{location}/connectClusters/{connectCluster}/connectors/{connector}
     *                     Please see {@see ManagedKafkaConnectClient::connectorName()} for help formatting this field.
     *
     * @return \Google\Cloud\ManagedKafka\V1\StopConnectorRequest
     *
     * @experimental
     */
