 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.v1.GetConnectorRequest</code>
 */
class GetConnectorRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the connector whose configuration to return.
     *                     Structured like:
     *                     projects/{project}/locations/{location}/connectClusters/{connectCluster}/connectors/{connector}
     *                     Please see {@see ManagedKafkaConnectClient::connectorName()} for help formatting this field.
     *
     * @return \Google\Cloud\ManagedKafka\V1\GetConnectorRequest
     *
     * @experimental
     */
