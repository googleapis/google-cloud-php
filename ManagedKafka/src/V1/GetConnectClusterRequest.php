 ...
 *
 * Generated from protobuf message <code>google.cloud.managedkafka.v1.GetConnectClusterRequest</code>
 */
class GetConnectClusterRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. The name of the Kafka Connect cluster whose configuration to
     *                     return. Structured like
     ...
     *
     * @return \Google\Cloud\ManagedKafka\V1\GetConnectClusterRequest
     *
     * @experimental
     */
