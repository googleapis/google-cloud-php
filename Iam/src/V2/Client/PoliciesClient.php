...
namespace Google\Cloud\Iam\V2\Client;
...
final class PoliciesClient
{
    ...
    private const SERVICE_NAME = 'google.iam.v2.Policies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/policies_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/policies_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/policies_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/policies_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *           $options = new PoliciesClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     * }
     *
     * @return OperationResponse<Policy>
     *
     * @throws ApiException Thrown if the API call fails.
     */
    public function createPolicy(CreatePolicyRequest $request, array $callOptions = []): OperationResponse
    {
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function deletePolicy(DeletePolicyRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('DeletePolicy', $request, $callOptions)->wait();
    }
     ...
     * @throws ApiException Thrown if the API call fails.
     */
    public function updatePolicy(UpdatePolicyRequest $request, array $callOptions = []): OperationResponse
    {
