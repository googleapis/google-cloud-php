 ...
 *
 * Generated from protobuf message <code>google.iam.v3.ListPrincipalAccessBoundaryPoliciesRequest</code>
 */
class ListPrincipalAccessBoundaryPoliciesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent resource, which owns the collection of principal
     *                       access boundary policies.
     *
     *                       Format:
     *                       `organizations/{organization_id}/locations/{location}`
     ...
     *
     * @return \Google\Cloud\Iam\V3\ListPrincipalAccessBoundaryPoliciesRequest
     *
     * @experimental
     */
