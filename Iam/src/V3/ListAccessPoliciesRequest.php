 ...
 *
 * Generated from protobuf message <code>google.iam.v3.ListAccessPoliciesRequest</code>
 */
class ListAccessPoliciesRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $parent Required. The parent resource, which owns the collection of access policy
     *                       resources.
     *
     *                       Format:
     *                       `projects/{project_id}/locations/{location}`
     ...
     *
     * @return \Google\Cloud\Iam\V3\ListAccessPoliciesRequest
     *
     * @experimental
     */
