 ...
 *
 * Generated from protobuf message <code>google.iam.v3.DeleteAccessPolicyRequest</code>
 */
class DeleteAccessPolicyRequest extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * @param string $name Required. The name of the access policy to delete.
     *
     *                     Format:
     *                     `projects/{project_id}/locations/{location}/accessPolicies/{access_policy_id}`
     *                     `projects/{project_number}/locations/{location}/accessPolicies/{access_policy_id}`
     ...
     *
     * @return \Google\Cloud\Iam\V3\DeleteAccessPolicyRequest
     *
     * @experimental
     */
