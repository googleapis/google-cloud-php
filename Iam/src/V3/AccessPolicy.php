 ...
 *
 * Generated from protobuf message <code>google.iam.v3.AccessPolicy</code>
 */
class AccessPolicy extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.iam.v3.AccessPolicyDetails details = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           Output only. The time when the access policy was most recently
     *           updated.
     *     @type \Google\Cloud\Iam\V3\AccessPolicyDetails $details
     *           Optional. The details for the access policy.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.iam.v3.AccessPolicyDetails details = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @return \Google\Cloud\Iam\V3\AccessPolicyDetails|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.iam.v3.AccessPolicyDetails details = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     * @param \Google\Cloud\Iam\V3\AccessPolicyDetails $var
     * @return $this
     */
    public function setDetails($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Iam\V3\AccessPolicyDetails::class);
        $this->details = $var;
