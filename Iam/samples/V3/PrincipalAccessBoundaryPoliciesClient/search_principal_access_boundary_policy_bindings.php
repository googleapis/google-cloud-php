 ...
 *
 * @param string $formattedName The name of the principal access boundary policy.
 *                              Format:
 ...
 */
function search_principal_access_boundary_policy_bindings_sample(string $formattedName): void
{
    // Create a client.
    ...
    try {
        ...
        $response = $principalAccessBoundaryPoliciesClient->searchPrincipalAccessBoundaryPolicyBindings(
            $request
        );
...
function callSample(): void
{
    ...
    search_principal_access_boundary_policy_bindings_sample($formattedName);
}
