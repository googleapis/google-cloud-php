...
// [START iam_v3_generated_PrincipalAccessBoundaryPolicies_UpdatePrincipalAccessBoundaryPolicy_sync]
 ...
 */
function update_principal_access_boundary_policy_sample(): void
{
    // Create a client.
    ...
    $request = (new UpdatePrincipalAccessBoundaryPolicyRequest())
        ->setPrincipalAccessBoundaryPolicy($principalAccessBoundaryPolicy);

    // Call the API and handle any network failures.
    try {
        /** @var OperationResponse $response */
        $response = $principalAccessBoundaryPoliciesClient->updatePrincipalAccessBoundaryPolicy($request);
...
// [END iam_v3_generated_PrincipalAccessBoundaryPolicies_UpdatePrincipalAccessBoundaryPolicy_sync]
