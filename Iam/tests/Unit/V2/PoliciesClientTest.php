...
namespace Google\Cloud\Iam\Tests\Unit\V2;
...
class PoliciesClientTest extends GeneratedTest
{
    ...
    public function createPolicyTest()
    {
        ...
        $policy = new Policy();
        $response = $gapicClient->createPolicy($parent, $policy);
    ...
    public function deletePolicyTest()
    {
        ...
        // Mock request
        $name = 'name3373707';
        $response = $gapicClient->deletePolicy($name);
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
    ...
    public function getPolicyTest()
    {
        ...
        // Mock request
        $name = 'name3373707';
        $response = $gapicClient->getPolicy($name);
    ...
    public function listPoliciesTest()
    {
        ...
        // Mock request
        $parent = 'parent-995424086';
        $response = $gapicClient->listPolicies($parent);
    ...
    public function listPoliciesExceptionTest()
    {
        ...
        $parent = 'parent-995424086';
        try {
            $gapicClient->listPolicies($parent);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
