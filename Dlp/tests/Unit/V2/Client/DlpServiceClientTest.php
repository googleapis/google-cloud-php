...
namespace Google\Cloud\Dlp\Tests\Unit\V2\Client;
...
use Google\Cloud\Dlp\V2\ListContentPoliciesResponse;
...
class DlpServiceClientTest extends GeneratedTest
{
    ...
    /** @test */
    public function createContentPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $expectedResponse = new ContentPolicy();
        $expectedResponse->setName($name);
        ...
        $contentPolicyRules = [];
        $contentPolicy->setRules($contentPolicyRules);
        $request = (new CreateContentPolicyRequest())->setParent($formattedParent)->setContentPolicy($contentPolicy);
        $response = $gapicClient->createContentPolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/CreateContentPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $actualValue = $actualRequestObject->getContentPolicy();
        $this->assertProtobufEquals($contentPolicy, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }

    /** @test */
    public function createContentPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new CreateContentPolicyRequest())->setParent($formattedParent)->setContentPolicy($contentPolicy);
        try {
            $gapicClient->createContentPolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function createDeidentifyTemplateTest()
    {
        ...
        $response = $gapicClient->createDeidentifyTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createDeidentifyTemplateExceptionTest()
    {
        ...
        $request = (new CreateDeidentifyTemplateRequest())
            ...
            ->setDeidentifyTemplate($deidentifyTemplate);
        try {
            $gapicClient->createDeidentifyTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function createDiscoveryConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $name = 'name3373707';
        $displayName = 'displayName1615086568';
        $expectedResponse = new DiscoveryConfig();
        $expectedResponse->setName($name);
        $expectedResponse->setDisplayName($displayName);
        $transport->addResponse($expectedResponse);
        // Mock request
        ...
        $response = $gapicClient->createDiscoveryConfig($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    /** @test */
    public function createDiscoveryConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new CreateDiscoveryConfigRequest())
            ...
            ->setDiscoveryConfig($discoveryConfig);
        try {
            $gapicClient->createDiscoveryConfig($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function createInspectTemplateTest()
    {
        ...
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setDescription($description);
        $expectedResponse->setAllowLimitedAvailabilityInfoTypes($allowLimitedAvailabilityInfoTypes);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->organizationLocationName('[ORGANIZATION]', '[LOCATION]');
        ...
        $response = $gapicClient->createInspectTemplate($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    public function createInspectTemplateExceptionTest()
    {
        ...
        $request = (new CreateInspectTemplateRequest())
            ...
            ->setInspectTemplate($inspectTemplate);
        try {
            $gapicClient->createInspectTemplate($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function createJobTriggerTest()
    {
        ...
        $displayName = 'displayName1615086568';
        $description = 'description-1724546052';
        $expectedResponse = new JobTrigger();
        $expectedResponse->setName($name);
        $expectedResponse->setDisplayName($displayName);
        $expectedResponse->setDescription($description);
        $transport->addResponse($expectedResponse);
    ...
    public function deidentifyContentTest()
    {
        ...
        $response = $gapicClient->deidentifyContent($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/DeidentifyContent', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function deidentifyContentExceptionTest()
    {
        ...
        $request = new DeidentifyContentRequest();
        try {
            $gapicClient->deidentifyContent($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function deleteContentPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->contentPolicyName('[PROJECT]', '[LOCATION]', '[CONTENT_POLICY]');
        $request = (new DeleteContentPolicyRequest())->setName($formattedName);
        $gapicClient->deleteContentPolicy($request);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/DeleteContentPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteContentPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function deleteDiscoveryConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function deleteDiscoveryConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function deleteFileStoreDataProfileTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/DeleteFileStoreDataProfile', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function deleteFileStoreDataProfileExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getContentPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock request
        $formattedName = $gapicClient->contentPolicyName('[PROJECT]', '[LOCATION]', '[CONTENT_POLICY]');
        $request = (new GetContentPolicyRequest())->setName($formattedName);
        $response = $gapicClient->getContentPolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/GetContentPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getContentPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new GetContentPolicyRequest())->setName($formattedName);
        try {
            $gapicClient->getContentPolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function getDiscoveryConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getDiscoveryConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function getFileStoreDataProfileTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $fileStoreLocation = 'fileStoreLocation-169306506';
        $locationType = 'locationType-1796591228';
        $fileStorePath = 'fileStorePath-1852775578';
        $fullResource = 'fullResource1559053246';
        $fileStoreIsEmpty = false;
        $expectedResponse = new FileStoreDataProfile();
        $expectedResponse->setName($name2);
        $expectedResponse->setProjectDataProfile($projectDataProfile);
        $expectedResponse->setProjectId($projectId);
        $expectedResponse->setFileStoreLocation($fileStoreLocation);
        $expectedResponse->setLocationType($locationType);
        $expectedResponse->setFileStorePath($fileStorePath);
        $expectedResponse->setFullResource($fullResource);
        $expectedResponse->setFileStoreIsEmpty($fileStoreIsEmpty);
        $transport->addResponse($expectedResponse);
        // Mock request
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/GetFileStoreDataProfile', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function getFileStoreDataProfileExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function getProjectDataProfileTest()
    {
        ...
        $name2 = 'name2-1052831874';
        $projectId = 'projectId-1969970175';
        $tableDataProfileCount = 330585909;
        $fileStoreDataProfileCount = 332405595;
        $expectedResponse = new ProjectDataProfile();
        $expectedResponse->setName($name2);
        $expectedResponse->setProjectId($projectId);
        $expectedResponse->setTableDataProfileCount($tableDataProfileCount);
        $expectedResponse->setFileStoreDataProfileCount($fileStoreDataProfileCount);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedName = $gapicClient->projectDataProfileName('[ORGANIZATION]', '[LOCATION]', '[PROJECT_DATA_PROFILE]');
    ...
    public function inspectContentTest()
    {
        ...
        $response = $gapicClient->inspectContent($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
    ...
    /** @test */
    public function listContentPoliciesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        // Mock response
        $nextPageToken = '';
        $contentPoliciesElement = new ContentPolicy();
        $contentPolicies = [$contentPoliciesElement];
        $expectedResponse = new ListContentPoliciesResponse();
        $expectedResponse->setNextPageToken($nextPageToken);
        $expectedResponse->setContentPolicies($contentPolicies);
        $transport->addResponse($expectedResponse);
        // Mock request
        $formattedParent = $gapicClient->locationName('[PROJECT]', '[LOCATION]');
        $request = (new ListContentPoliciesRequest())->setParent($formattedParent);
        $response = $gapicClient->listContentPolicies($request);
        $this->assertEquals($expectedResponse, $response->getPage()->getResponseObject());
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getContentPolicies()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/ListContentPolicies', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listContentPoliciesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new ListContentPoliciesRequest())->setParent($formattedParent);
        try {
            $gapicClient->listContentPolicies($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function listDiscoveryConfigsTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getDiscoveryConfigs()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    /** @test */
    public function listDiscoveryConfigsExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function listFileStoreDataProfilesTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getFileStoreDataProfiles()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/ListFileStoreDataProfiles', $actualFuncCall);
        $actualValue = $actualRequestObject->getParent();
        $this->assertProtobufEquals($formattedParent, $actualValue);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    /** @test */
    public function listFileStoreDataProfilesExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    public function listInfoTypesTest()
    {
        ...
        $response = $gapicClient->listInfoTypes($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/ListInfoTypes', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function listInfoTypesExceptionTest()
    {
        ...
        $request = new ListInfoTypesRequest();
        try {
            $gapicClient->listInfoTypes($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    public function listJobTriggersTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getJobTriggers()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function listStoredInfoTypesTest()
    {
        ...
        $resources = iterator_to_array($response->iterateAllElements());
        $this->assertSame(1, count($resources));
        $this->assertEquals($expectedResponse->getStoredInfoTypes()[0], $resources[0]);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
    ...
    public function redactImageTest()
    {
        ...
        $response = $gapicClient->redactImage($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/RedactImage', $actualFuncCall);
        $this->assertTrue($transport->isExhausted());
    }
    ...
    public function redactImageExceptionTest()
    {
        ...
        $request = new RedactImageRequest();
        try {
            $gapicClient->redactImage($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function updateContentPolicyTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $contentPolicyRules = [];
        $contentPolicy->setRules($contentPolicyRules);
        $request = (new UpdateContentPolicyRequest())->setName($formattedName)->setContentPolicy($contentPolicy);
        $response = $gapicClient->updateContentPolicy($request);
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.privacy.dlp.v2.DlpService/UpdateContentPolicy', $actualFuncCall);
        $actualValue = $actualRequestObject->getName();
        $this->assertProtobufEquals($formattedName, $actualValue);
        $actualValue = $actualRequestObject->getContentPolicy();
        $this->assertProtobufEquals($contentPolicy, $actualValue);
    ...
    /** @test */
    public function updateContentPolicyExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $request = (new UpdateContentPolicyRequest())->setName($formattedName)->setContentPolicy($contentPolicy);
        try {
            $gapicClient->updateContentPolicy($request);
            // If the $gapicClient method call did not throw, fail the test
            $this->fail('Expected an ApiException, but no exception was thrown.');
        } catch (ApiException $ex) {
            $this->assertEquals($status->code, $ex->getCode());
    ...
    /** @test */
    public function updateDiscoveryConfigTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function updateDiscoveryConfigExceptionTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
    ...
    /** @test */
    public function activateJobTriggerAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
