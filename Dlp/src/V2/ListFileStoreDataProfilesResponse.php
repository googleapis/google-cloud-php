 ...
 * project.
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2.ListFileStoreDataProfilesResponse</code>
 */
class ListFileStoreDataProfilesResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->file_store_data_profiles;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dlp\V2\FileStoreDataProfile::class);
        $this->file_store_data_profiles = $arr;
