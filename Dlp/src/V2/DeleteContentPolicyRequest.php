 ...
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2.DeleteContentPolicyRequest</code>
 */
class DeleteContentPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $name Required. Resource name of the ContentPolicy to be deleted, in the format:
     ...
     *
     * @return \Google\Cloud\Dlp\V2\DeleteContentPolicyRequest
     *
     * @experimental
     */
