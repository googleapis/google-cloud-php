 ...
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2.DiscoverySchemaModifiedCadence</code>
 */
class DiscoverySchemaModifiedCadence extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Dlp\V2\BigQuerySchemaModification::class);
        $this->types = $arr;
