...
use Google\Cloud\DiscoveryEngine\V1beta\Client\ServingConfigServiceClient;
...
use Google\Cloud\DiscoveryEngine\V1beta\ListServingConfigsResponse;
...
class ServingConfigServiceClientTest extends GeneratedTest
{
    ...
    public function getServingConfigTest()
    {
        ...
        // Mock request
        $formattedName = $gapicClient->servingConfigName('[PROJECT]', '[LOCATION]', '[DATA_STORE]', '[SERVING_CONFIG]');
    ...
    /** @test */
    public function getServingConfigAsyncTest()
    {
        $transport = $this->createTransport();
        $gapicClient = $this->createClient([
            'transport' => $transport,
        ...
        $formattedName = $gapicClient->servingConfigName('[PROJECT]', '[LOCATION]', '[DATA_STORE]', '[SERVING_CONFIG]');
        $request = (new GetServingConfigRequest())->setName($formattedName);
        $response = $gapicClient->getServingConfigAsync($request)->wait();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
