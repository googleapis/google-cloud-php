...
class SchemaServiceClientTest extends GeneratedTest
{
    ...
    public function createSchemaTest()
    {
        ...
        $incompleteOperation->setName('operations/createSchemaTest');
        ...
        $completeOperation->setName('operations/createSchemaTest');
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1.SchemaService/CreateSchema', $actualApiFuncCall);
    ...
    public function deleteSchemaTest()
    {
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/deleteSchemaTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/deleteSchemaTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.SchemaService/DeleteSchema', $actualApiFuncCall);
    ...
    public function getSchemaTest()
    {
        ...
        $this->assertSame('/google.cloud.discoveryengine.v1.SchemaService/GetSchema', $actualFuncCall);
    ...
    public function listSchemasTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.SchemaService/ListSchemas', $actualFuncCall);
    ...
    /** @test */
    public function updateSchemaTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        // Mock response
        $incompleteOperation = new Operation();
        $incompleteOperation->setName('operations/updateSchemaTest');
        $incompleteOperation->setDone(false);
        $transport->addResponse($incompleteOperation);
        $jsonSchema = 'jsonSchema-1150390056';
        $name = 'name3373707';
        ...
        $anyResponse->setValue($expectedResponse->serializeToString());
        $completeOperation = new Operation();
        $completeOperation->setName('operations/updateSchemaTest');
        $completeOperation->setDone(true);
        $completeOperation->setResponse($anyResponse);
        $operationsTransport->addResponse($completeOperation);
        // Mock request
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.discoveryengine.v1.SchemaService/UpdateSchema', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getSchema();
        $this->assertProtobufEquals($schema, $actualValue);
        $expectedOperationsRequestObject = new GetOperationRequest();
    ...
    /** @test */
    public function updateSchemaExceptionTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
    ...
    /** @test */
    public function createSchemaAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
