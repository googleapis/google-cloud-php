...
namespace Google\Cloud\DiscoveryEngine\V1beta\Project\ServiceTerms;
 ...
 *
 * Protobuf type <code>google.cloud.discoveryengine.v1beta.Project.ServiceTerms.State</code>
 */
class State
{
    /**
