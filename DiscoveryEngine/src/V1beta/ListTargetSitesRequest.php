 ...
 * method.
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.ListTargetSitesRequest</code>
 */
class ListTargetSitesRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * @param string $parent Required. The parent site search engine resource name, such as
     *                       `projects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}/siteSearchEngine`.
     *
     *                       If the caller does not have permission to list
     *                       [TargetSite][google.cloud.discoveryengine.v1beta.TargetSite]s under this
     ...
     *
     * @return \Google\Cloud\DiscoveryEngine\V1beta\ListTargetSitesRequest
     *
     * @experimental
     */
