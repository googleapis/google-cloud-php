...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1beta.DocumentService' => [
            'CreateDocument' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents',
                'body' => 'document',
                'additionalBindings' => [
                    [
                        'method' => 'post',
            ...
            'DeleteDocument' => [
                'method' => 'delete',
                'uriTemplate' => '/v1beta/{name=projects/*/locations/*/dataStores/*/branches/*/documents/*}',
                'additionalBindings' => [
                    [
                        'method' => 'delete',
                        'uriTemplate' => '/v1beta/{name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*}',
                    ],
                ],
                'placeholders' => [
                    'name' => [
            ...
            'ImportDocuments' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents:import',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/documents:import',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'PurgeDocuments' => [
                'method' => 'post',
                'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/dataStores/*/branches/*}/documents:purge',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1beta/{parent=projects/*/locations/*/collections/*/dataStores/*/branches/*}/documents:purge',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
            ...
            'UpdateDocument' => [
                'method' => 'patch',
                'uriTemplate' => '/v1beta/{document.name=projects/*/locations/*/dataStores/*/branches/*/documents/*}',
                'body' => 'document',
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1beta/{document.name=projects/*/locations/*/collections/*/dataStores/*/branches/*/documents/*}',
                        'body' => 'document',
                    ],
                ],
                'placeholders' => [
