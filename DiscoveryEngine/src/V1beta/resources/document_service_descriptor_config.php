...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1beta.DocumentService' => [
            'ImportDocuments' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\DiscoveryEngine\V1beta\ImportDocumentsResponse',
                    'metadataReturnType' => '\Google\Cloud\DiscoveryEngine\V1beta\ImportDocumentsMetadata',
            ...
            'PurgeDocuments' => [
                'longRunning' => [
                    'operationReturnType' => '\Google\Cloud\DiscoveryEngine\V1beta\PurgeDocumentsResponse',
                    'metadataReturnType' => '\Google\Cloud\DiscoveryEngine\V1beta\PurgeDocumentsMetadata',
                    'initialPollDelayMillis' => '500',
                    'pollDelayMultiplier' => '1.5',
                    'maxPollDelayMillis' => '5000',
                    'totalPollTimeoutMillis' => '300000',
            ...
            'CreateDocument' => [
                ...
                'responseType' => 'Google\Cloud\DiscoveryEngine\V1beta\Document',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
            ...
            'ListDocuments' => [
                ...
                'responseType' => 'Google\Cloud\DiscoveryEngine\V1beta\ListDocumentsResponse',
                'headerParams' => [
                    [
                        'keyName' => 'parent',
                        'fieldAccessors' => [
