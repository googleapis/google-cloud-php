 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.CreateSessionRequest</code>
 */
class CreateSessionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Session session = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @param \Google\Cloud\DiscoveryEngine\V1beta\Session $session Required. The session to create.
     *
     * @return \Google\Cloud\DiscoveryEngine\V1beta\CreateSessionRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\DiscoveryEngine\V1beta\Session $session): self
    {
        return (new self())
            ->setParent($parent)
            ->setSession($session);
