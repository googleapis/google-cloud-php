...
namespace Google\Cloud\DiscoveryEngine\V1beta\Engine;
 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1beta.Engine.ChatEngineConfig</code>
 */
class ChatEngineConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Engine.ChatEngineConfig.AgentCreationConfig agent_creation_config = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\DiscoveryEngine\V1beta\Engine\ChatEngineConfig\AgentCreationConfig $agent_creation_config
     *           The configurationt generate the Dialogflow agent that is associated to
     *           this Engine.
     *           Note that these configurations are one-time consumed by
     *           and passed to Dialogflow service. It means they cannot be retrieved using
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Engine.ChatEngineConfig.AgentCreationConfig agent_creation_config = 1;</code>
     * @return \Google\Cloud\DiscoveryEngine\V1beta\Engine\ChatEngineConfig\AgentCreationConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1beta.Engine.ChatEngineConfig.AgentCreationConfig agent_creation_config = 1;</code>
     * @param \Google\Cloud\DiscoveryEngine\V1beta\Engine\ChatEngineConfig\AgentCreationConfig $var
     * @return $this
     */
    public function setAgentCreationConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\DiscoveryEngine\V1beta\Engine\ChatEngineConfig\AgentCreationConfig::class);
