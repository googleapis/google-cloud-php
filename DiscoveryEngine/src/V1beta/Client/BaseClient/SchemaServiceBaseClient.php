 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1beta/schema_service.proto
...
use Google\Cloud\DiscoveryEngine\V1beta\DeleteSchemaRequest;
...
abstract class SchemaServiceBaseClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1beta.SchemaService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ . '/../../resources/schema_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../../resources/schema_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ . '/../../resources/schema_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../../resources/schema_service_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public static function projectLocationCollectionDataStoreName(
        ...
        return self::getPathTemplate(
            'projectLocationCollectionDataStore'
        )->render([
            'project' => $project,
            'location' => $location,
     ...
     * @experimental
     */
    public static function projectLocationDataStoreName(
        string $project,
        string $location,
        string $dataStore
    ): string {
