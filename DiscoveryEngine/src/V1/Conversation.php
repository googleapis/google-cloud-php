 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.Conversation</code>
 */
class Conversation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Conversation.State state = 2;</code>
     */
    protected $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DiscoveryEngine\V1\Conversation\State::class);
        $this->state = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\ConversationMessage::class);
        $this->messages = $arr;
