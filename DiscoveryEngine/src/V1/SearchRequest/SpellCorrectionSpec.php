 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.SearchRequest.SpellCorrectionSpec</code>
 */
class SpellCorrectionSpec extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\DiscoveryEngine\V1\SearchRequest\SpellCorrectionSpec\Mode::class);
        $this->mode = $var;
