 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/data_store_service.proto
...
final class DataStoreServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.DataStoreService';
     ...
     *
     * @example samples/V1/DataStoreServiceClient/create_data_store.php
     *
     ...
     *
     * @example samples/V1/DataStoreServiceClient/delete_data_store.php
     *
     ...
     *
     * @example samples/V1/DataStoreServiceClient/get_data_store.php
     *
     ...
     *
     * @example samples/V1/DataStoreServiceClient/list_data_stores.php
     *
     ...
     *
     * @example samples/V1/DataStoreServiceClient/update_data_store.php
     *
