 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/project_service.proto
...
final class ProjectServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.ProjectService';
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\ProjectServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ProjectServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ProjectServiceClient/provision_project.php
     *
