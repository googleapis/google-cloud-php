...
namespace Google\Cloud\DiscoveryEngine\V1\Client\BaseClient;
 ...
 */
abstract class ConversationalSearchServiceBaseClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' =>
                __DIR__ .
                '/../../resources/conversational_search_service_client_config.json',
            'descriptorsConfigPath' =>
                __DIR__ .
                '/../../resources/conversational_search_service_descriptor_config.php',
            'gcpApiConfigPath' =>
                __DIR__ .
                '/../../resources/conversational_search_service_grpc_config.json',
            'credentialsConfig' => [
            ...
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' =>
                        __DIR__ .
                        '/../../resources/conversational_search_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     *
     * The async variant is {@see self::converseConversationAsync()} .
     *
