 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/identity_mapping_store_service.proto
 ...
 *
 * @method PromiseInterface<IdentityMappingStore> createIdentityMappingStoreAsync(CreateIdentityMappingStoreRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> deleteIdentityMappingStoreAsync(DeleteIdentityMappingStoreRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<IdentityMappingStore> getIdentityMappingStoreAsync(GetIdentityMappingStoreRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> importIdentityMappingsAsync(ImportIdentityMappingsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listIdentityMappingStoresAsync(ListIdentityMappingStoresRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<PagedListResponse> listIdentityMappingsAsync(ListIdentityMappingsRequest $request, array $optionalArgs = [])
 * @method PromiseInterface<OperationResponse> purgeIdentityMappingsAsync(PurgeIdentityMappingsRequest $request, array $optionalArgs = [])
 */
final class IdentityMappingStoreServiceClient
{
    use GapicClientTrait;
    use ResourceHelperTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.IdentityMappingStoreService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/identity_mapping_store_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/identity_mapping_store_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/identity_mapping_store_service_grpc_config.json',
            'credentialsConfig' => [
     ...
     * {@see IdentityMappingStoreServiceClient::createIdentityMappingStoreAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/create_identity_mapping_store.php
     *
     * @param CreateIdentityMappingStoreRequest $request     A request to house fields associated with the call.
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::deleteIdentityMappingStoreAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/delete_identity_mapping_store.php
     *
     * @param DeleteIdentityMappingStoreRequest $request     A request to house fields associated with the call.
     * @param array                             $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::getIdentityMappingStoreAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/get_identity_mapping_store.php
     *
     * @param GetIdentityMappingStoreRequest $request     A request to house fields associated with the call.
     * @param array                          $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::importIdentityMappingsAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/import_identity_mappings.php
     *
     * @param ImportIdentityMappingsRequest $request     A request to house fields associated with the call.
     * @param array                         $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::listIdentityMappingStoresAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/list_identity_mapping_stores.php
     *
     * @param ListIdentityMappingStoresRequest $request     A request to house fields associated with the call.
     * @param array                            $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::listIdentityMappingsAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/list_identity_mappings.php
     *
     * @param ListIdentityMappingsRequest $request     A request to house fields associated with the call.
     * @param array                       $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
     ...
     *
     * The async variant is
     * {@see IdentityMappingStoreServiceClient::purgeIdentityMappingsAsync()} .
     *
     * @example samples/V1/IdentityMappingStoreServiceClient/purge_identity_mappings.php
     *
     * @param PurgeIdentityMappingsRequest $request     A request to house fields associated with the call.
     * @param array                        $callOptions {
     *     Optional.
     *
     *     @type RetrySettings|array $retrySettings
