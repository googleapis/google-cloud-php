 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/discoveryengine/v1/serving_config_service.proto
...
final class ServingConfigServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.discoveryengine.v1.ServingConfigService';
     ...
     *           use Google\Cloud\DiscoveryEngine\V1\ServingConfigServiceClient;
     *           $creds = new ServiceAccountCredentials($scopes, $json);
     *           $options = new ServingConfigServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
     ...
     *
     * @example samples/V1/ServingConfigServiceClient/update_serving_config.php
     *
