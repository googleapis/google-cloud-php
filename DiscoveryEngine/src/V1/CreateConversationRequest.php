 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.CreateConversationRequest</code>
 */
class CreateConversationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Conversation conversation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * @return \Google\Cloud\DiscoveryEngine\V1\CreateConversationRequest
     *
     * @experimental
     */
    public static function build(string $parent, \Google\Cloud\DiscoveryEngine\V1\Conversation $conversation): self
    {
        return (new self())
            ->setParent($parent)
