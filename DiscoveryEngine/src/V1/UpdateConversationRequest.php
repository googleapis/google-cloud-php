 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.UpdateConversationRequest</code>
 */
class UpdateConversationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.discoveryengine.v1.Conversation conversation = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    /**
     * @param \Google\Cloud\DiscoveryEngine\V1\Conversation $conversation Required. The Conversation to update.
     ...
     *                                                                    If not set or empty, all supported fields are updated.
     *
     * @return \Google\Cloud\DiscoveryEngine\V1\UpdateConversationRequest
     *
     * @experimental
     */
    public static function build(\Google\Cloud\DiscoveryEngine\V1\Conversation $conversation, \Google\Protobuf\FieldMask $updateMask): self
    {
        return (new self())
