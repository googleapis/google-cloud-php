 ...
 *
 * Generated from protobuf message <code>google.cloud.discoveryengine.v1.Answer.Reference.UnstructuredDocumentInfo</code>
 */
class UnstructuredDocumentInfo extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\DiscoveryEngine\V1\Answer\Reference\UnstructuredDocumentInfo\ChunkContent::class);
