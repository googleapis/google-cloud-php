...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1.ServingConfigService' => [
            'UpdateServingConfig' => [
                'method' => 'patch',
                'uriTemplate' => '/v1/{serving_config.name=projects/*/locations/*/dataStores/*/servingConfigs/*}',
                'body' => 'serving_config',
                'additionalBindings' => [
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{serving_config.name=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}',
                        'body' => 'serving_config',
                    ],
                    [
                        'method' => 'patch',
                        'uriTemplate' => '/v1/{serving_config.name=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}',
                        'body' => 'serving_config',
                    ],
                ],
                'placeholders' => [
