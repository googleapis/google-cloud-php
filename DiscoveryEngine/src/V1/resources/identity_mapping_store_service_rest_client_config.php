    ...
    'interfaces' => [
        'google.cloud.discoveryengine.v1.IdentityMappingStoreService' => [
            'CreateIdentityMappingStore' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{parent=projects/*/locations/*}/identityMappingStores',
            ...
            'DeleteIdentityMappingStore' => [
                'method' => 'delete',
                'uriTemplate' => '/v1/{name=projects/*/locations/*/identityMappingStores/*}',
                'placeholders' => [
                    'name' => [
                        'getters' => [
                            'getName',
            ...
            'ImportIdentityMappings' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:importIdentityMappings',
                'body' => '*',
                'placeholders' => [
            ...
            'ListIdentityMappings' => [
                'method' => 'get',
                'uriTemplate' => '/v1/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:listIdentityMappings',
                'placeholders' => [
                    'identity_mapping_store' => [
                        'getters' => [
                            'getIdentityMappingStore',
            ...
            'PurgeIdentityMappings' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{identity_mapping_store=projects/*/locations/*/identityMappingStores/*}:purgeIdentityMappings',
                'body' => '*',
                'placeholders' => [
                    'identity_mapping_store' => [
                        'getters' => [
