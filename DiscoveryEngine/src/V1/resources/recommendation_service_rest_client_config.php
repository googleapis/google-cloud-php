...
return [
    'interfaces' => [
        'google.cloud.discoveryengine.v1.RecommendationService' => [
            'Recommend' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:recommend',
                'body' => '*',
                'additionalBindings' => [
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{serving_config=projects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:recommend',
                        'body' => '*',
                    ],
                    [
                        'method' => 'post',
                        'uriTemplate' => '/v1/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfigs/*}:recommend',
                        'body' => '*',
                    ],
                ],
                'placeholders' => [
