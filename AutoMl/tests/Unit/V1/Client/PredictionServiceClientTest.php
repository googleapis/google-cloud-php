...
class PredictionServiceClientTest extends GeneratedTest
{
    ...
    public function batchPredictTest()
    {
        ...
        $response = $gapicClient->batchPredict($request);
    ...
    public function predictTest()
    {
        ...
        $request = (new PredictRequest())->setName($formattedName)->setPayload($payload);
    ...
    /** @test */
    public function batchPredictAsyncTest()
    {
        $operationsTransport = $this->createTransport();
        $operationsClient = new OperationsClient([
            'apiEndpoint' => '',
        ...
        $request = (new BatchPredictRequest())
            ...
            ->setInputConfig($inputConfig)
            ->setOutputConfig($outputConfig);
        $response = $gapicClient->batchPredictAsync($request)->wait();
        $this->assertFalse($response->isDone());
        $this->assertNull($response->getResult());
        $apiRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($apiRequests));
