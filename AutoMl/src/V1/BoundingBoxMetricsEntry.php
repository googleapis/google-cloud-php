 ...
 *
 * Generated from protobuf message <code>google.cloud.automl.v1.BoundingBoxMetricsEntry</code>
 */
class BoundingBoxMetricsEntry extends \Google\Protobuf\Internal\Message
{
     ...
     *           Output only. The mean average precision, most often close to au_prc.
     *     @type \Google\Cloud\AutoMl\V1\BoundingBoxMetricsEntry\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $confidence_metrics_entries
     *           Output only. Metrics for each label-match confidence_threshold from
     *           0.05,0.10,...,0.95,0.96,0.97,0.98,0.99. Precision-recall curve is
     *           derived from them.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1.BoundingBoxMetricsEntry.ConfidenceMetricsEntry confidence_metrics_entries = 3;</code>
     * @param \Google\Cloud\AutoMl\V1\BoundingBoxMetricsEntry\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
