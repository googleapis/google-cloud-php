 ...
 * \Google\Cloud\AutoMl\V1\PredictionServiceClient} for the stable implementation
 *
 * @experimental
 *
...
final class PredictionServiceClient
{
    ...
    private const SERVICE_NAME = 'google.cloud.automl.v1.PredictionService';
     ...
     */
    public function batchPredict(BatchPredictRequest $request, array $callOptions = []): OperationResponse
    {
        return $this->startApiCall('BatchPredict', $request, $callOptions)->wait();
    }
