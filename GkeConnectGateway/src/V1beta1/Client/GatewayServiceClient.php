...
namespace Google\Cloud\GkeConnect\Gateway\V1beta1\Client;
 ...
 * @experimental
 *
 * @method PromiseInterface deleteResourceAsync(HttpBody $request, array $optionalArgs = [])
 * @method PromiseInterface getResourceAsync(HttpBody $request, array $optionalArgs = [])
 * @method PromiseInterface patchResourceAsync(HttpBody $request, array $optionalArgs = [])
 * @method PromiseInterface postResourceAsync(HttpBody $request, array $optionalArgs = [])
 * @method PromiseInterface putResourceAsync(HttpBody $request, array $optionalArgs = [])
 */
final class GatewayServiceClient
{
    use GapicClientTrait;

    /** The name of the service. */
    private const SERVICE_NAME = 'google.cloud.gkeconnect.gateway.v1beta1.GatewayService';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/gateway_service_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/gateway_service_descriptor_config.php',
            'gcpApiConfigPath' => __DIR__ . '/../resources/gateway_service_grpc_config.json',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/gateway_service_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     * @experimental
     */
    public function deleteResource(HttpBody $request, array $callOptions = []): HttpBody
    {
        return $this->startApiCall('DeleteResource', $request, $callOptions)->wait();
    }
     ...
     * @experimental
     */
    public function getResource(HttpBody $request, array $callOptions = []): HttpBody
    {
     ...
     * @experimental
     */
    public function patchResource(HttpBody $request, array $callOptions = []): HttpBody
    {
        return $this->startApiCall('PatchResource', $request, $callOptions)->wait();
    }
     ...
     * @experimental
     */
    public function postResource(HttpBody $request, array $callOptions = []): HttpBody
    {
        return $this->startApiCall('PostResource', $request, $callOptions)->wait();
    }
     ...
     * @experimental
     */
    public function putResource(HttpBody $request, array $callOptions = []): HttpBody
    {
        return $this->startApiCall('PutResource', $request, $callOptions)->wait();
    }
}
