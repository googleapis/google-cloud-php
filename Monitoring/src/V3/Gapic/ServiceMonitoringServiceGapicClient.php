...
use Google\Monitoring\V3\CreateServiceLevelObjectiveRequest;
use Google\Monitoring\V3\CreateServiceRequest;
use Google\Monitoring\V3\DeleteServiceLevelObjectiveRequest;
use Google\Monitoring\V3\DeleteServiceRequest;
use Google\Monitoring\V3\GetServiceLevelObjectiveRequest;
use Google\Monitoring\V3\GetServiceRequest;
use Google\Monitoring\V3\ListServiceLevelObjectivesRequest;
use Google\Monitoring\V3\ListServiceLevelObjectivesResponse;
use Google\Monitoring\V3\ListServicesRequest;
use Google\Monitoring\V3\ListServicesResponse;
use Google\Monitoring\V3\Service;
use Google\Monitoring\V3\ServiceLevelObjective;
use Google\Monitoring\V3\ServiceLevelObjective\View;
use Google\Monitoring\V3\UpdateServiceLevelObjectiveRequest;
use Google\Monitoring\V3\UpdateServiceRequest;
...
class ServiceMonitoringServiceGapicClient
{
     ...
     *          For allowed values, use constants defined on {@see \Google\Monitoring\V3\ServiceLevelObjective\View}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
