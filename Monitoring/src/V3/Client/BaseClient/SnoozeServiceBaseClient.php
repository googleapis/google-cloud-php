 ...
 */
abstract class SnoozeServiceBaseClient
{
     ...
     * interval.
     *
     * The async variant is {@see self::createSnoozeAsync()} .
     *
     ...
     *
     * The async variant is {@see self::getSnoozeAsync()} .
     *
     ...
     *
     * The async variant is {@see self::listSnoozesAsync()} .
     *
     ...
     * given `Snooze` object.
     *
     * The async variant is {@see self::updateSnoozeAsync()} .
     *
