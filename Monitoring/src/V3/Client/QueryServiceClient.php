 ...
 *
 * @method PromiseInterface<PagedListResponse> queryTimeSeriesAsync(QueryTimeSeriesRequest $request, array $optionalArgs = [])
 */
final class QueryServiceClient
{
     ...
     *           $options = new QueryServiceClient(['credentials' => $creds]);
     *           ```
     *           {@see
